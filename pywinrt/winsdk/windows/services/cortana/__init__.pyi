...
class CortanaActionableInsights(_winrt.Object):
    ...
    def is_available_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
...
class CortanaPermissionsManager(_winrt.Object):
    ...
    def are_permissions_granted_async(self, permissions: typing.Iterable[CortanaPermission]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @staticmethod
    def get_default() -> typing.Optional[CortanaPermissionsManager]: ...
    def grant_permissions_async(self, permissions: typing.Iterable[CortanaPermission]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CortanaPermissionsChangeResult]]: ...
    def is_supported(self) -> _winrt.Boolean: ...
    def revoke_permissions_async(self, permissions: typing.Iterable[CortanaPermission]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CortanaPermissionsChangeResult]]: ...
