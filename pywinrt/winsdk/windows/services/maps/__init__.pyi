...
class EnhancedWaypoint(_winrt.Object, interfaces=[]):
    kind: WaypointKind
...
class MapLocation(_winrt.Object, interfaces=[]):
...
class MapLocationFinderResult(_winrt.Object, interfaces=[]):
...
class MapRoute(_winrt.Object, interfaces=[]):
...
class MapRouteDrivingOptions(_winrt.Object, interfaces=[]):
...
class MapRouteFinder(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def get_driving_route_from_enhanced_waypoints_async(waypoints: typing.Iterable[typing.Optional[EnhancedWaypoint]]) -> winsdk.windows.foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    @staticmethod
    def get_driving_route_from_enhanced_waypoints_async(waypoints: typing.Iterable[typing.Optional[EnhancedWaypoint]], options: typing.Optional[MapRouteDrivingOptions]) -> winsdk.windows.foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    @staticmethod
    def get_driving_route_from_waypoints_async(way_points: typing.Iterable[typing.Optional[winsdk.windows.devices.geolocation.Geopoint]]) -> winsdk.windows.foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    @staticmethod
    def get_driving_route_from_waypoints_async(way_points: typing.Iterable[typing.Optional[winsdk.windows.devices.geolocation.Geopoint]], optimization: MapRouteOptimization) -> winsdk.windows.foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    @staticmethod
    def get_driving_route_from_waypoints_async(way_points: typing.Iterable[typing.Optional[winsdk.windows.devices.geolocation.Geopoint]], optimization: MapRouteOptimization, restrictions: MapRouteRestrictions) -> winsdk.windows.foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    @staticmethod
    def get_driving_route_from_waypoints_async(way_points: typing.Iterable[typing.Optional[winsdk.windows.devices.geolocation.Geopoint]], optimization: MapRouteOptimization, restrictions: MapRouteRestrictions, heading_in_degrees: _winrt.Double) -> winsdk.windows.foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @staticmethod
    ...
    @staticmethod
    def get_walking_route_from_waypoints_async(way_points: typing.Iterable[typing.Optional[winsdk.windows.devices.geolocation.Geopoint]]) -> winsdk.windows.foundation.IAsyncOperation[MapRouteFinderResult]: ...

class MapRouteFinderResult(_winrt.Object, interfaces=[]):
...
class MapRouteLeg(_winrt.Object, interfaces=[]):
    bounding_box: typing.Optional[winsdk.windows.devices.geolocation.GeoboundingBox]
    estimated_duration: winsdk.windows.foundation.TimeSpan
    length_in_meters: _winrt.Double
...
class MapRouteManeuver(_winrt.Object, interfaces=[]):
    exit_number: str
...
class PlaceInfo(_winrt.Object, interfaces=[]):
    display_address: str
    display_name: str
...
class PlaceInfoCreateOptions(_winrt.Object, interfaces=[]):
    display_name: str
    display_address: str
    @staticmethod
