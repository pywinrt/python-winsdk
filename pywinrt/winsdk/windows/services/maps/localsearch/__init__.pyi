...
class LocalLocationFinder(_winrt.Object):
    ...
    @staticmethod
    def find_local_locations_async(search_term: str, search_area: typing.Optional[winsdk.windows.devices.geolocation.Geocircle], local_category: str, max_results: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LocalLocationFinderResult]]: ...
