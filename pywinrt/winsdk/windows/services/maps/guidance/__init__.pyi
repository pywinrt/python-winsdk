...
class GuidanceNavigator(_winrt.Object):
    ...
    def resume() -> None:
        ...
    def set_guidance_voice(voice_id: _winrt.Int32, voice_folder: str) -> None:
        ...
    def start_navigating(route: GuidanceRoute) -> None:
        ...
    def start_simulating(route: GuidanceRoute, speed_in_meters_per_second: _winrt.Int32) -> None:
        ...
    def start_tracking() -> None:
        ...
    def stop() -> None:
        ...
    def update_user_location(user_location: winsdk.windows.devices.geolocation.Geocoordinate) -> None:
        ...
    def update_user_location(user_location: winsdk.windows.devices.geolocation.Geocoordinate, position_override: winsdk.windows.devices.geolocation.BasicGeoposition) -> None:
        ...
    def add_destination_reached(handler: winsdk.windows.foundation.TypedEventHandler[GuidanceNavigator, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_destination_reached(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_guidance_updated(handler: winsdk.windows.foundation.TypedEventHandler[GuidanceNavigator, GuidanceUpdatedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_guidance_updated(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_reroute_failed(handler: winsdk.windows.foundation.TypedEventHandler[GuidanceNavigator, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_reroute_failed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_rerouted(handler: winsdk.windows.foundation.TypedEventHandler[GuidanceNavigator, GuidanceReroutedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_rerouted(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_rerouting(handler: winsdk.windows.foundation.TypedEventHandler[GuidanceNavigator, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_rerouting(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_user_location_lost(handler: winsdk.windows.foundation.TypedEventHandler[GuidanceNavigator, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_user_location_lost(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_user_location_restored(handler: winsdk.windows.foundation.TypedEventHandler[GuidanceNavigator, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_user_location_restored(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_audio_notification_requested(value: winsdk.windows.foundation.TypedEventHandler[GuidanceNavigator, GuidanceAudioNotificationRequestedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_audio_notification_requested(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
...
class GuidanceRoute(_winrt.Object):
    ...
    def can_create_from_map_route(map_route: winsdk.windows.services.maps.MapRoute) -> _winrt.Boolean:
        ...
    def convert_to_map_route() -> winsdk.windows.services.maps.MapRoute:
        ...
