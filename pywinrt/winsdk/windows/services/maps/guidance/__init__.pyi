...
class GuidanceAudioNotificationRequestedEventArgs(_winrt.Object, interfaces=[]):
...
class GuidanceMapMatchedCoordinate(_winrt.Object, interfaces=[]):
...
class GuidanceNavigator(_winrt.Object, interfaces=[]):
...
class GuidanceReroutedEventArgs(_winrt.Object, interfaces=[]):
    route: typing.Optional[GuidanceRoute]
    @staticmethod
    def _from(obj: _winrt.Object) -> GuidanceReroutedEventArgs: ...

class GuidanceRoadSegment(_winrt.Object, interfaces=[]):
    id: str
...
class GuidanceRoadSignpost(_winrt.Object, interfaces=[]):
...
class GuidanceRoute(_winrt.Object, interfaces=[]):
...
class GuidanceTelemetryCollector(_winrt.Object, interfaces=[]):
...
class GuidanceUpdatedEventArgs(_winrt.Object, interfaces=[]):
