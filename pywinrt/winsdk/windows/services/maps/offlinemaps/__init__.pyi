...
class OfflineMapPackage(_winrt.Object, interfaces=[]):
    display_name: str
...
class OfflineMapPackageQueryResult(_winrt.Object, interfaces=[]):
...
class OfflineMapPackageStartDownloadResult(_winrt.Object, interfaces=[]):
