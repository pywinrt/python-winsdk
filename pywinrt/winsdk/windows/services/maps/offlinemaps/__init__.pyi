...
class OfflineMapPackage(_winrt.Object):
    ...
    @staticmethod
    def find_packages_async(query_point: typing.Optional[winsdk.windows.devices.geolocation.Geopoint]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[OfflineMapPackageQueryResult]]: ...
    @staticmethod
    def find_packages_in_bounding_box_async(query_bounding_box: typing.Optional[winsdk.windows.devices.geolocation.GeoboundingBox]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[OfflineMapPackageQueryResult]]: ...
    @staticmethod
    def find_packages_in_geocircle_async(query_circle: typing.Optional[winsdk.windows.devices.geolocation.Geocircle]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[OfflineMapPackageQueryResult]]: ...
    def request_start_download_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[OfflineMapPackageStartDownloadResult]]: ...
