...
class StoreAvailability(_winrt.Object):
    ...
    @typing.overload
    def request_purchase_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorePurchaseResult]]: ...
    @typing.overload
    def request_purchase_async(self, store_purchase_properties: typing.Optional[StorePurchaseProperties]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorePurchaseResult]]: ...
...
class StoreContext(_winrt.Object):
    ...
    def acquire_store_license_for_optional_package_async(self, optional_package: typing.Optional[winsdk.windows.applicationmodel.Package]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreAcquireLicenseResult]]: ...
    def can_acquire_store_license_async(self, product_store_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreCanAcquireLicenseResult]]: ...
    def can_acquire_store_license_for_optional_package_async(self, optional_package: typing.Optional[winsdk.windows.applicationmodel.Package]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreCanAcquireLicenseResult]]: ...
    def download_and_install_store_packages_async(self, store_ids: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]]: ...
    def find_store_product_for_package_async(self, product_kinds: typing.Iterable[str], package: typing.Optional[winsdk.windows.applicationmodel.Package]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreProductResult]]: ...
    def get_app_and_optional_store_package_updates_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StorePackageUpdate]]]: ...
    def get_app_license_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreAppLicense]]: ...
    def get_associated_store_products_async(self, product_kinds: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreProductQueryResult]]: ...
    def get_associated_store_products_with_paging_async(self, product_kinds: typing.Iterable[str], max_items_to_retrieve_per_page: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreProductPagedQueryResult]]: ...
    def get_associated_store_queue_items_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StoreQueueItem]]]: ...
    def get_consumable_balance_remaining_async(self, product_store_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreConsumableResult]]: ...
    def get_customer_collections_id_async(self, service_ticket: str, publisher_user_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    def get_customer_purchase_id_async(self, service_ticket: str, publisher_user_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @staticmethod
    ...
    def get_store_product_for_current_app_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreProductResult]]: ...
    @typing.overload
    def get_store_products_async(self, product_kinds: typing.Iterable[str], store_ids: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreProductQueryResult]]: ...
    @typing.overload
    def get_store_products_async(self, product_kinds: typing.Iterable[str], store_ids: typing.Iterable[str], store_product_options: typing.Optional[StoreProductOptions]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreProductQueryResult]]: ...
    def get_store_queue_items_async(self, store_ids: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StoreQueueItem]]]: ...
    def get_user_collection_async(self, product_kinds: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreProductQueryResult]]: ...
    def get_user_collection_with_paging_async(self, product_kinds: typing.Iterable[str], max_items_to_retrieve_per_page: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreProductPagedQueryResult]]: ...
    def report_consumable_fulfillment_async(self, product_store_id: str, quantity: _winrt.UInt32, tracking_id: uuid.UUID) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreConsumableResult]]: ...
    def request_download_and_install_store_package_updates_async(self, store_package_updates: typing.Iterable[typing.Optional[StorePackageUpdate]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]]: ...
    @typing.overload
    def request_download_and_install_store_packages_async(self, store_ids: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]]: ...
    @typing.overload
    def request_download_and_install_store_packages_async(self, store_ids: typing.Iterable[str], store_package_install_options: typing.Optional[StorePackageInstallOptions]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]]: ...
    def request_download_store_package_updates_async(self, store_package_updates: typing.Iterable[typing.Optional[StorePackageUpdate]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]]: ...
    @typing.overload
    def request_purchase_async(self, store_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorePurchaseResult]]: ...
    @typing.overload
    def request_purchase_async(self, store_id: str, store_purchase_properties: typing.Optional[StorePurchaseProperties]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorePurchaseResult]]: ...
    def request_rate_and_review_app_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreRateAndReviewResult]]: ...
    def request_uninstall_store_package_async(self, package: typing.Optional[winsdk.windows.applicationmodel.Package]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreUninstallStorePackageResult]]: ...
    def request_uninstall_store_package_by_store_id_async(self, store_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreUninstallStorePackageResult]]: ...
    def set_install_order_for_associated_store_queue_items_async(self, items: typing.Iterable[typing.Optional[StoreQueueItem]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StoreQueueItem]]]: ...
    def try_silent_download_and_install_store_package_updates_async(self, store_package_updates: typing.Iterable[typing.Optional[StorePackageUpdate]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]]: ...
    def try_silent_download_store_package_updates_async(self, store_package_updates: typing.Iterable[typing.Optional[StorePackageUpdate]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]]: ...
    def uninstall_store_package_async(self, package: typing.Optional[winsdk.windows.applicationmodel.Package]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreUninstallStorePackageResult]]: ...
    def uninstall_store_package_by_store_id_async(self, store_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreUninstallStorePackageResult]]: ...
...
class StoreProduct(_winrt.Object):
    ...
    def get_is_any_sku_installed_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def request_purchase_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorePurchaseResult]]: ...
    @typing.overload
    def request_purchase_async(self, store_purchase_properties: typing.Optional[StorePurchaseProperties]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorePurchaseResult]]: ...
...
class StoreProductPagedQueryResult(_winrt.Object):
    ...
    def get_next_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreProductPagedQueryResult]]: ...
...
class StoreRequestHelper(_winrt.Object):
    ...
    @staticmethod
    def send_request_async(context: typing.Optional[StoreContext], request_kind: _winrt.UInt32, parameters_as_json: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StoreSendRequestResult]]: ...
...
class StoreSku(_winrt.Object):
    ...
    def get_is_installed_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def request_purchase_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorePurchaseResult]]: ...
    @typing.overload
    def request_purchase_async(self, store_purchase_properties: typing.Optional[StorePurchaseProperties]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorePurchaseResult]]: ...
