...
class TargetedContentAction(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> TargetedContentAction: ...
    def invoke_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...

class TargetedContentAvailabilityChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> TargetedContentAvailabilityChangedEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class TargetedContentChangedEventArgs(_winrt.Object, interfaces=[]):
    has_previous_content_expired: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> TargetedContentChangedEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class TargetedContentCollection(_winrt.Object, interfaces=[]):
...
class TargetedContentContainer(_winrt.Object, interfaces=[]):
...
class TargetedContentFile(_winrt.Object, interfaces=[winsdk.windows.storage.streams.IRandomAccessStreamReference]):
    @staticmethod
...
class TargetedContentImage(_winrt.Object, interfaces=[winsdk.windows.storage.streams.IRandomAccessStreamReference]):
...
class TargetedContentItem(_winrt.Object, interfaces=[]):
    collections: typing.Optional[winsdk.windows.foundation.collections.IVectorView[TargetedContentCollection]]
    path: str
    properties: typing.Optional[winsdk.windows.foundation.collections.IMapView[str, TargetedContentValue]]
...
class TargetedContentItemState(_winrt.Object, interfaces=[]):
...
class TargetedContentObject(_winrt.Object, interfaces=[]):
...
class TargetedContentStateChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> TargetedContentStateChangedEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class TargetedContentSubscription(_winrt.Object, interfaces=[]):
    id: str
    @staticmethod
...
class TargetedContentSubscriptionOptions(_winrt.Object, interfaces=[]):
...
class TargetedContentValue(_winrt.Object, interfaces=[]):
    ...
    booleans: typing.Optional[winsdk.windows.foundation.collections.IVectorView[_winrt.Boolean]]
    ...
    numbers: typing.Optional[winsdk.windows.foundation.collections.IVectorView[_winrt.Double]]
    path: str
    string: str
