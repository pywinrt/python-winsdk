...
class JsonArray(_winrt.Object, interfaces=[IJsonValue, winsdk.windows.foundation.collections.IVector[IJsonValue], winsdk.windows.foundation.collections.IIterable[IJsonValue], winsdk.windows.foundation.IStringable]):
    ...
    def get_many(self, start_index: _winrt.UInt32, items_size: _winrt.UInt32) -> typing.Tuple[_winrt.UInt32, typing.List[typing.Optional[IJsonValue]]]: ...
    ...
    def replace_all(self, items: typing.Sequence[typing.Optional[IJsonValue]]) -> None: ...
...
class JsonObject(_winrt.Object, interfaces=[IJsonValue, winsdk.windows.foundation.collections.IMap[str, IJsonValue], winsdk.windows.foundation.collections.IIterable[winsdk.windows.foundation.collections.IKeyValuePair[str, IJsonValue]], winsdk.windows.foundation.IStringable]):
    value_type: JsonValueType
    size: _winrt.UInt32
    @staticmethod
...
class JsonValue(_winrt.Object, interfaces=[IJsonValue, winsdk.windows.foundation.IStringable]):
    value_type: JsonValueType
    @staticmethod
...
class IJsonValue(typing.Protocol):
    value_type: JsonValueType
    @staticmethod
