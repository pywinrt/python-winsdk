...
class SelectableWordsSegmenter(_winrt.Object):
    ...
    def __init__(self, language: str) -> None:
        ...
    def get_token_at(text: str, start_index: _winrt.UInt32) -> SelectableWordSegment:
        ...
    def get_tokens(text: str) -> winsdk.windows.foundation.collections.IVectorView[SelectableWordSegment]:
        ...
    def tokenize(text: str, start_index: _winrt.UInt32, handler: SelectableWordSegmentsTokenizingHandler) -> None:
        ...
...
class SemanticTextQuery(_winrt.Object):
    ...
    def __init__(self, aqs_filter: str, filter_language: str) -> None:
        ...
    def find(content: str) -> winsdk.windows.foundation.collections.IVectorView[TextSegment]:
        ...
    def find_in_property(property_content: str, property_name: str) -> winsdk.windows.foundation.collections.IVectorView[TextSegment]:
        ...
...
class TextConversionGenerator(_winrt.Object):
    ...
    def __init__(self, language_tag: str) -> None:
        ...
    def get_candidates_async(input: str) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]:
        ...
    def get_candidates_async(input: str, max_candidates: _winrt.UInt32) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]:
        ...
...
class TextPredictionGenerator(_winrt.Object):
    ...
    def get_candidates_async(input: str, max_candidates: _winrt.UInt32) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]:
        ...
    def get_candidates_async(input: str, max_candidates: _winrt.UInt32, prediction_options: TextPredictionOptions, previous_strings: typing.Iterable[str]) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]:
        ...
    def get_next_word_candidates_async(max_candidates: _winrt.UInt32, previous_strings: typing.Iterable[str]) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]:
        ...
...
class TextReverseConversionGenerator(_winrt.Object):
    ...
    def __init__(self, language_tag: str) -> None:
        ...
    def convert_back_async(input: str) -> winsdk.windows.foundation.IAsyncOperation[str]:
        ...
    def get_phonemes_async(input: str) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[TextPhoneme]]:
        ...
...
class WordSegment(_winrt.Object):
    ...
    alternate_forms: winsdk.windows.foundation.collections.IVectorView[AlternateWordForm]
    source_text_segment: TextSegment
    text: str
...
class WordsSegmenter(_winrt.Object):
    ...
    def __init__(self, language: str) -> None:
        ...
    def get_token_at(text: str, start_index: _winrt.UInt32) -> WordSegment:
        ...
    def get_tokens(text: str) -> winsdk.windows.foundation.collections.IVectorView[WordSegment]:
        ...
    def tokenize(text: str, start_index: _winrt.UInt32, handler: WordSegmentsTokenizingHandler) -> None:
        ...
