...
class TextConversionGenerator(_winrt.Object):
    ...
    @typing.overload
    def get_candidates_async(self, input: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]]: ...
    @typing.overload
    def get_candidates_async(self, input: str, max_candidates: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]]: ...
...
class TextPredictionGenerator(_winrt.Object):
    ...
    def get_candidates_async(self, input: str, max_candidates: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]]: ...
    @typing.overload
    def get_candidates_async(self, input: str, max_candidates: _winrt.UInt32, prediction_options: TextPredictionOptions, previous_strings: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]]: ...
    def get_next_word_candidates_async(self, max_candidates: _winrt.UInt32, previous_strings: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]]: ...
...
class TextReverseConversionGenerator(_winrt.Object):
    ...
    def __init__(self, language_tag: str) -> None: ...
    def convert_back_async(self, input: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    def get_phonemes_async(self, input: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[TextPhoneme]]]: ...
...
SelectableWordSegmentsTokenizingHandler = typing.Callable[[typing.Iterable[typing.Optional[SelectableWordSegment]], typing.Iterable[typing.Optional[SelectableWordSegment]]], None]

WordSegmentsTokenizingHandler = typing.Callable[[typing.Iterable[typing.Optional[WordSegment]], typing.Iterable[typing.Optional[WordSegment]]], None]
