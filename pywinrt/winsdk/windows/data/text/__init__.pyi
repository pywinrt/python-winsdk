...
class SelectableWordsSegmenter(_winrt.Object):
    ...
    @typing.overload
    def get_token_at(self, text: str, start_index: _winrt.UInt32) -> SelectableWordSegment: ...
    @typing.overload
    def get_tokens(self, text: str) -> winsdk.windows.foundation.collections.IVectorView[SelectableWordSegment]: ...
    @typing.overload
    def tokenize(self, text: str, start_index: _winrt.UInt32, handler: SelectableWordSegmentsTokenizingHandler) -> None: ...
...
class SemanticTextQuery(_winrt.Object):
    ...
    @typing.overload
    def find(self, content: str) -> winsdk.windows.foundation.collections.IVectorView[TextSegment]: ...
    @typing.overload
    def find_in_property(self, property_content: str, property_name: str) -> winsdk.windows.foundation.collections.IVectorView[TextSegment]: ...
...
class WordsSegmenter(_winrt.Object):
    ...
    def __init__(self, language: str) -> None: ...
    @typing.overload
    def get_token_at(self, text: str, start_index: _winrt.UInt32) -> WordSegment: ...
    @typing.overload
    def get_tokens(self, text: str) -> winsdk.windows.foundation.collections.IVectorView[WordSegment]: ...
    @typing.overload
    def tokenize(self, text: str, start_index: _winrt.UInt32, handler: WordSegmentsTokenizingHandler) -> None: ...
