...
class AlternateWordForm(_winrt.Object, interfaces=[]):
    alternate_text: str
...
class SelectableWordSegment(_winrt.Object, interfaces=[]):
    source_text_segment: TextSegment
    text: str
    @staticmethod
    def _from(obj: _winrt.Object) -> SelectableWordSegment: ...

class SelectableWordsSegmenter(_winrt.Object, interfaces=[]):
...
class SemanticTextQuery(_winrt.Object, interfaces=[]):
    @staticmethod
...
class TextConversionGenerator(_winrt.Object, interfaces=[]):
...
class TextPhoneme(_winrt.Object, interfaces=[]):
    display_text: str
    reading_text: str
    @staticmethod
    def _from(obj: _winrt.Object) -> TextPhoneme: ...

class TextPredictionGenerator(_winrt.Object, interfaces=[]):
    language_available_but_not_installed: _winrt.Boolean
    resolved_language: str
...
class TextReverseConversionGenerator(_winrt.Object, interfaces=[]):
    language_available_but_not_installed: _winrt.Boolean
    resolved_language: str
    @staticmethod
...
class WordSegment(_winrt.Object, interfaces=[]):
...
class WordsSegmenter(_winrt.Object, interfaces=[]):
    resolved_language: str
    @staticmethod
