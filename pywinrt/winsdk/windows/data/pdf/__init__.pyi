...
class PdfDocument(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def load_from_file_async(file: typing.Optional[winsdk.windows.storage.IStorageFile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PdfDocument]]: ...
    @typing.overload
    @staticmethod
    def load_from_file_async(file: typing.Optional[winsdk.windows.storage.IStorageFile], password: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PdfDocument]]: ...
    @typing.overload
    @staticmethod
    def load_from_stream_async(input_stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PdfDocument]]: ...
    @typing.overload
    @staticmethod
    def load_from_stream_async(input_stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream], password: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PdfDocument]]: ...
