...
class PdfDocument(_winrt.Object, interfaces=[]):
...
class PdfPage(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class PdfPageDimensions(_winrt.Object, interfaces=[]):
...
class PdfPageRenderOptions(_winrt.Object, interfaces=[]):
