...
class LockApplicationHost(_winrt.Object, interfaces=[]):
    @staticmethod
...
class LockScreenBadge(_winrt.Object, interfaces=[]):
    automation_name: str
...
class LockScreenInfo(_winrt.Object, interfaces=[]):
...
class LockScreenUnlockingDeferral(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> LockScreenUnlockingDeferral: ...
    def complete(self) -> None: ...

class LockScreenUnlockingEventArgs(_winrt.Object, interfaces=[]):
