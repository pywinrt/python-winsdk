...
class PaymentAddress(_winrt.Object, interfaces=[]):
    sorting_code: str
    region: str
    recipient: str
    postal_code: str
...
class PaymentCanMakePaymentResult(_winrt.Object, interfaces=[]):
...
class PaymentCurrencyAmount(_winrt.Object, interfaces=[]):
    value: str
    currency_system: str
    currency: str
    @staticmethod
...
class PaymentDetails(_winrt.Object, interfaces=[]):
    ...
    @typing.overload
    def __init__(self, total: typing.Optional[PaymentItem], display_items: typing.Iterable[typing.Optional[PaymentItem]]) -> None: ...
    @typing.overload
    def __init__(self) -> None: ...

class PaymentDetailsModifier(_winrt.Object, interfaces=[]):
    ...
    @typing.overload
    def __init__(self, supported_method_ids: typing.Iterable[str], total: typing.Optional[PaymentItem], additional_display_items: typing.Iterable[typing.Optional[PaymentItem]]) -> None: ...
    @typing.overload
    def __init__(self, supported_method_ids: typing.Iterable[str], total: typing.Optional[PaymentItem], additional_display_items: typing.Iterable[typing.Optional[PaymentItem]], json_data: str) -> None: ...

class PaymentItem(_winrt.Object, interfaces=[]):
...
class PaymentMediator(_winrt.Object, interfaces=[]):
    @staticmethod
...
class PaymentMerchantInfo(_winrt.Object, interfaces=[]):
...
class PaymentMethodData(_winrt.Object, interfaces=[]):
    json_data: str
    supported_method_ids: typing.Optional[winsdk.windows.foundation.collections.IVectorView[str]]
    @staticmethod
...
class PaymentOptions(_winrt.Object, interfaces=[]):
...
class PaymentRequest(_winrt.Object, interfaces=[]):
    ...
    @typing.overload
    def __init__(self, details: typing.Optional[PaymentDetails], method_data: typing.Iterable[typing.Optional[PaymentMethodData]], merchant_info: typing.Optional[PaymentMerchantInfo], options: typing.Optional[PaymentOptions], id: str) -> None: ...
    @typing.overload
    def __init__(self, details: typing.Optional[PaymentDetails], method_data: typing.Iterable[typing.Optional[PaymentMethodData]]) -> None: ...
    @typing.overload
    def __init__(self, details: typing.Optional[PaymentDetails], method_data: typing.Iterable[typing.Optional[PaymentMethodData]], merchant_info: typing.Optional[PaymentMerchantInfo]) -> None: ...
    @typing.overload
    def __init__(self, details: typing.Optional[PaymentDetails], method_data: typing.Iterable[typing.Optional[PaymentMethodData]], merchant_info: typing.Optional[PaymentMerchantInfo], options: typing.Optional[PaymentOptions]) -> None: ...

class PaymentRequestChangedArgs(_winrt.Object, interfaces=[]):
...
class PaymentRequestChangedResult(_winrt.Object, interfaces=[]):
...
class PaymentRequestSubmitResult(_winrt.Object, interfaces=[]):
    response: typing.Optional[PaymentResponse]
    status: PaymentRequestStatus
    @staticmethod
    def _from(obj: _winrt.Object) -> PaymentRequestSubmitResult: ...

class PaymentResponse(_winrt.Object, interfaces=[]):
    payer_email: str
    payer_name: str
...
class PaymentShippingOption(_winrt.Object, interfaces=[]):
    tag: str
    label: str
...
class PaymentToken(_winrt.Object, interfaces=[]):
    json_details: str
