...
class PaymentMediator(_winrt.Object):
    ...
    def __init__(self) -> None: ...
    def can_make_payment_async(self, payment_request: typing.Optional[PaymentRequest]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PaymentCanMakePaymentResult]]: ...
    def get_supported_method_ids_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]]: ...
    @typing.overload
    def submit_payment_request_async(self, payment_request: typing.Optional[PaymentRequest]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PaymentRequestSubmitResult]]: ...
    @typing.overload
    def submit_payment_request_async(self, payment_request: typing.Optional[PaymentRequest], change_handler: typing.Optional[PaymentRequestChangedHandler]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PaymentRequestSubmitResult]]: ...
