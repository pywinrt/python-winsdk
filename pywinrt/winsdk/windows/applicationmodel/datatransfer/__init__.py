...
_ns_module = winsdk.system._import_ns_module("Windows.ApplicationModel.DataTransfer")
...
winsdk.system._mixin_mutable_mapping(DataPackagePropertySet)
DataPackagePropertySetView = _ns_module.DataPackagePropertySetView
winsdk.system._mixin_mapping(DataPackagePropertySetView)
