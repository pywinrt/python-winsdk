...
class Clipboard(_winrt.Object):
    ...
    @staticmethod
    def get_history_items_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ClipboardHistoryItemsResult]]: ...
    @staticmethod
...
class DataPackage(_winrt.Object):
    ...
    @typing.overload
    def set_storage_items(self, value: typing.Iterable[typing.Optional[winsdk.windows.storage.IStorageItem]]) -> None: ...
    @typing.overload
    def set_storage_items(self, value: typing.Iterable[typing.Optional[winsdk.windows.storage.IStorageItem]], read_only: _winrt.Boolean) -> None: ...
...
class DataPackageView(_winrt.Object):
    ...
    def get_application_link_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.Uri]]: ...
    def get_bitmap_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.RandomAccessStreamReference]]: ...
    def get_data_async(self, format_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Object]]: ...
    def get_html_format_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    def get_resource_map_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IMapView[str, winsdk.windows.storage.streams.RandomAccessStreamReference]]]: ...
    def get_rtf_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    def get_storage_items_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.storage.IStorageItem]]]: ...
    @typing.overload
    def get_text_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @typing.overload
    def get_text_async(self, format_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    def get_uri_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.Uri]]: ...
    def get_web_link_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.Uri]]: ...
    def report_operation_completed(self, value: DataPackageOperation) -> None: ...
    @typing.overload
    def request_access_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.enterprisedata.ProtectionPolicyEvaluationResult]]: ...
    @typing.overload
    def request_access_async(self, enterprise_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.enterprisedata.ProtectionPolicyEvaluationResult]]: ...
...
class ShareProvider(_winrt.Object):
    ...
    def __init__(self, title: str, display_icon: typing.Optional[winsdk.windows.storage.streams.RandomAccessStreamReference], background_color: winsdk.windows.ui.Color, handler: typing.Optional[ShareProviderHandler]) -> None: ...
...
class SharedStorageAccessManager(_winrt.Object):
    ...
    @staticmethod
    def redeem_token_for_file_async(token: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.StorageFile]]: ...
    @staticmethod
