...
class CoreDragDropManager(_winrt.Object, interfaces=[]):
...
class CoreDragInfo(_winrt.Object, interfaces=[]):
...
class CoreDragOperation(_winrt.Object, interfaces=[]):
...
class CoreDragUIOverride(_winrt.Object, interfaces=[]):
...
class CoreDropOperationTargetRequestedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
...
class ICoreDropOperationTarget(typing.Protocol):
    @staticmethod
