...
class CoreDragOperation(_winrt.Object):
    ...
    def start_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.applicationmodel.datatransfer.DataPackageOperation]]: ...
...
class ICoreDropOperationTarget(_winrt.Object):
    ...
    def drop_async(self, drag_info: typing.Optional[CoreDragInfo]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.applicationmodel.datatransfer.DataPackageOperation]]: ...
    def enter_async(self, drag_info: typing.Optional[CoreDragInfo], drag_u_i_override: typing.Optional[CoreDragUIOverride]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.applicationmodel.datatransfer.DataPackageOperation]]: ...
    def leave_async(self, drag_info: typing.Optional[CoreDragInfo]) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    def over_async(self, drag_info: typing.Optional[CoreDragInfo], drag_u_i_override: typing.Optional[CoreDragUIOverride]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.applicationmodel.datatransfer.DataPackageOperation]]: ...
