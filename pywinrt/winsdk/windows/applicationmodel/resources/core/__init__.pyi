...
class ResourceLayoutInfo:
    ...
    def __new__(cls: typing.Type[ResourceLayoutInfo], major_version: _winrt.UInt32, minor_version: _winrt.UInt32, resource_subtree_count: _winrt.UInt32, named_resource_count: _winrt.UInt32, checksum: _winrt.Int32) -> ResourceLayoutInfo: ...
