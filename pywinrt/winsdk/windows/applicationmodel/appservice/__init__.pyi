...
class AppServiceCatalog(_winrt.Object):
    ...
    @staticmethod
    def find_app_service_providers_async(app_service_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.applicationmodel.AppInfo]]]: ...
...
class AppServiceConnection(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def open_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AppServiceConnectionStatus]]: ...
    def open_remote_async(self, remote_system_connection_request: typing.Optional[winsdk.windows.system.remotesystems.RemoteSystemConnectionRequest]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AppServiceConnectionStatus]]: ...
    def send_message_async(self, message: typing.Optional[winsdk.windows.foundation.collections.ValueSet]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AppServiceResponse]]: ...
    @staticmethod
    def send_stateless_message_async(connection: typing.Optional[AppServiceConnection], connection_request: typing.Optional[winsdk.windows.system.remotesystems.RemoteSystemConnectionRequest], message: typing.Optional[winsdk.windows.foundation.collections.ValueSet]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StatelessAppServiceResponse]]: ...
...
class AppServiceRequest(_winrt.Object):
    ...
    def send_response_async(self, message: typing.Optional[winsdk.windows.foundation.collections.ValueSet]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AppServiceResponseStatus]]: ...
...
class AppServiceTriggerDetails(_winrt.Object):
    ...
    def check_caller_for_capability_async(self, capability_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
