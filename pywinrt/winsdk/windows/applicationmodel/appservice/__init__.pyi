...
class AppServiceClosedEventArgs(_winrt.Object, interfaces=[]):
    status: AppServiceClosedStatus
    @staticmethod
    def _from(obj: _winrt.Object) -> AppServiceClosedEventArgs: ...

class AppServiceConnection(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class AppServiceDeferral(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> AppServiceDeferral: ...
    def complete(self) -> None: ...

class AppServiceRequest(_winrt.Object, interfaces=[]):
...
class AppServiceRequestReceivedEventArgs(_winrt.Object, interfaces=[]):
...
class AppServiceResponse(_winrt.Object, interfaces=[]):
    message: typing.Optional[winsdk.windows.foundation.collections.ValueSet]
    status: AppServiceResponseStatus
    @staticmethod
    def _from(obj: _winrt.Object) -> AppServiceResponse: ...

class AppServiceTriggerDetails(_winrt.Object, interfaces=[]):
...
class StatelessAppServiceResponse(_winrt.Object, interfaces=[]):
    message: typing.Optional[winsdk.windows.foundation.collections.ValueSet]
