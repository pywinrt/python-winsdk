...
class SocialFeedChildItem(_winrt.Object, interfaces=[]):
...
class SocialFeedContent(_winrt.Object, interfaces=[]):
    title: str
    target_uri: typing.Optional[winsdk.windows.foundation.Uri]
    message: str
    @staticmethod
...
class SocialFeedItem(_winrt.Object, interfaces=[]):
    timestamp: winsdk.windows.foundation.DateTime
    target_uri: typing.Optional[winsdk.windows.foundation.Uri]
...
class SocialFeedSharedItem(_winrt.Object, interfaces=[]):
    timestamp: winsdk.windows.foundation.DateTime
...
class SocialItemThumbnail(_winrt.Object, interfaces=[]):
    target_uri: typing.Optional[winsdk.windows.foundation.Uri]
...
class SocialUserInfo(_winrt.Object, interfaces=[]):
    user_name: str
    target_uri: typing.Optional[winsdk.windows.foundation.Uri]
    remote_id: str
    display_name: str
