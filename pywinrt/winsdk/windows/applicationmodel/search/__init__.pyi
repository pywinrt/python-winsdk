...
class SearchQueryLinguisticDetails(_winrt.Object):
    ...
    def __new__(cls: typing.Type[SearchQueryLinguisticDetails], query_text_alternatives: typing.Iterable[str], query_text_composition_start: _winrt.UInt32, query_text_composition_length: _winrt.UInt32) -> SearchQueryLinguisticDetails:...
