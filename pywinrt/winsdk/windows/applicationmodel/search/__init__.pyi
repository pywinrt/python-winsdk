...
class LocalContentSuggestionSettings(_winrt.Object, interfaces=[]):
...
class SearchPaneQueryLinguisticDetails(_winrt.Object, interfaces=[]):
...
class SearchQueryLinguisticDetails(_winrt.Object, interfaces=[]):
    query_text_alternatives: typing.Optional[winsdk.windows.foundation.collections.IVectorView[str]]
    query_text_composition_length: _winrt.UInt32
    query_text_composition_start: _winrt.UInt32
    @staticmethod
...
class SearchSuggestionCollection(_winrt.Object, interfaces=[]):
    size: _winrt.UInt32
    @staticmethod
...
class SearchSuggestionsRequest(_winrt.Object, interfaces=[]):
...
class SearchSuggestionsRequestDeferral(_winrt.Object, interfaces=[]):
    @staticmethod
