...
class AppExtension(_winrt.Object):
    ...
    def get_extension_properties_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IPropertySet]]: ...
    def get_public_folder_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.StorageFolder]]: ...

class AppExtensionCatalog(_winrt.Object):
    @staticmethod
    def _from(obj: _winrt.Object) -> AppExtensionCatalog: ...
    def find_all_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[AppExtension]]]: ...
    @staticmethod
    def open(app_extension_name: str) -> typing.Optional[AppExtensionCatalog]: ...
    def request_remove_package_async(self, package_full_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
