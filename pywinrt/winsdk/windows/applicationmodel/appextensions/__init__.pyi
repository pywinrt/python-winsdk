...
class AppExtension(_winrt.Object, interfaces=[]):
...
class AppExtensionCatalog(_winrt.Object, interfaces=[]):
    @staticmethod
...
class AppExtensionPackageInstalledEventArgs(_winrt.Object, interfaces=[]):
...
class AppExtensionPackageStatusChangedEventArgs(_winrt.Object, interfaces=[]):
    app_extension_name: str
    package: typing.Optional[winsdk.windows.applicationmodel.Package]
    @staticmethod
    def _from(obj: _winrt.Object) -> AppExtensionPackageStatusChangedEventArgs: ...

class AppExtensionPackageUninstallingEventArgs(_winrt.Object, interfaces=[]):
    app_extension_name: str
    package: typing.Optional[winsdk.windows.applicationmodel.Package]
    @staticmethod
    def _from(obj: _winrt.Object) -> AppExtensionPackageUninstallingEventArgs: ...

class AppExtensionPackageUpdatedEventArgs(_winrt.Object, interfaces=[]):
    app_extension_name: str
    extensions: typing.Optional[winsdk.windows.foundation.collections.IVectorView[AppExtension]]
    package: typing.Optional[winsdk.windows.applicationmodel.Package]
    @staticmethod
...
class AppExtensionPackageUpdatingEventArgs(_winrt.Object, interfaces=[]):
    app_extension_name: str
    package: typing.Optional[winsdk.windows.applicationmodel.Package]
    @staticmethod
