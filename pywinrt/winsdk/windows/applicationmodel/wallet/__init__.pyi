...
class WalletBarcode(_winrt.Object, interfaces=[]):
...
class WalletItem(_winrt.Object, interfaces=[]):
    display_name: str
    display_message: str
    logo_text: str
...
class WalletItemCustomProperty(_winrt.Object, interfaces=[]):
    value: str
...
class WalletItemStore(_winrt.Object, interfaces=[]):
    @staticmethod
...
class WalletRelevantLocation(_winrt.Object, interfaces=[]):
...
class WalletTransaction(_winrt.Object, interfaces=[]):
...
class WalletVerb(_winrt.Object, interfaces=[]):
    name: str
    @staticmethod
