...
class ApplicationTrigger(IBackgroundTrigger, _winrt.Object):
    ...
    def __init__(self, ) -> None:
        ...
    def request_async() -> winsdk.windows.foundation.IAsyncOperation[ApplicationTriggerResult]:
        ...
    def request_async(arguments: winsdk.windows.foundation.collections.ValueSet) -> winsdk.windows.foundation.IAsyncOperation[ApplicationTriggerResult]:
        ...
...
class BackgroundTaskRegistration(IBackgroundTaskRegistration, IBackgroundTaskRegistration2, IBackgroundTaskRegistration3, _winrt.Object):
    ...
    def get_task_group(group_id: str) -> BackgroundTaskRegistrationGroup:
        ...
    def unregister(cancel_task: _winrt.Boolean) -> None:
        ...
    def add_completed(handler: BackgroundTaskCompletedEventHandler) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_completed(cookie: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_progress(handler: BackgroundTaskProgressEventHandler) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_progress(cookie: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
...
class BackgroundTaskRegistrationGroup(_winrt.Object):
    ...
    def __init__(self, id: str, name: str) -> None:
        ...
    def add_background_activated(handler: winsdk.windows.foundation.TypedEventHandler[BackgroundTaskRegistrationGroup, winsdk.windows.applicationmodel.activation.BackgroundActivatedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
...
class DeviceServicingTrigger(IBackgroundTrigger, _winrt.Object):
    ...
    def __init__(self, ) -> None:
        ...
    def request_async(device_id: str, expected_duration: winsdk.windows.foundation.TimeSpan) -> winsdk.windows.foundation.IAsyncOperation[DeviceTriggerResult]:
        ...
    def request_async(device_id: str, expected_duration: winsdk.windows.foundation.TimeSpan, arguments: str) -> winsdk.windows.foundation.IAsyncOperation[DeviceTriggerResult]:
        ...
...
class DeviceUseTrigger(IBackgroundTrigger, _winrt.Object):
    ...
    def __init__(self, ) -> None:
        ...
    def request_async(device_id: str) -> winsdk.windows.foundation.IAsyncOperation[DeviceTriggerResult]:
        ...
    def request_async(device_id: str, arguments: str) -> winsdk.windows.foundation.IAsyncOperation[DeviceTriggerResult]:
        ...
...
class MediaProcessingTrigger(IBackgroundTrigger, _winrt.Object):
    ...
    def __init__(self, ) -> None:
        ...
    def request_async() -> winsdk.windows.foundation.IAsyncOperation[MediaProcessingTriggerResult]:
        ...
    def request_async(arguments: winsdk.windows.foundation.collections.ValueSet) -> winsdk.windows.foundation.IAsyncOperation[MediaProcessingTriggerResult]:
        ...
...
class IBackgroundTaskInstance(_winrt.Object):
    ...
    def get_deferral() -> BackgroundTaskDeferral:
        ...
    def add_canceled(cancel_handler: BackgroundTaskCanceledEventHandler) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
...
class IBackgroundTaskInstance2(IBackgroundTaskInstance, _winrt.Object):
    ...
    task: BackgroundTaskRegistration
    trigger_details: _winrt.Object
    def get_throttle_count(counter: BackgroundTaskThrottleCounter) -> _winrt.UInt32:
        ...
    def get_deferral() -> BackgroundTaskDeferral:
        ...
    def add_canceled(cancel_handler: BackgroundTaskCanceledEventHandler) -> winsdk.windows.foundation.EventRegistrationToken:
