...
class ActivitySensorTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class ApplicationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class ApplicationTriggerDetails(_winrt.Object, interfaces=[]):
...
class AppointmentStoreNotificationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class BackgroundTaskBuilder(_winrt.Object, interfaces=[]):
...
class BackgroundTaskCompletedEventArgs(_winrt.Object, interfaces=[]):
    instance_id: uuid.UUID
    @staticmethod
    def _from(obj: _winrt.Object) -> BackgroundTaskCompletedEventArgs: ...
    def check_result(self) -> None: ...

class BackgroundTaskDeferral(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> BackgroundTaskDeferral: ...
    def complete(self) -> None: ...

class BackgroundTaskProgressEventArgs(_winrt.Object, interfaces=[]):
    instance_id: uuid.UUID
    progress: _winrt.UInt32
    @staticmethod
    def _from(obj: _winrt.Object) -> BackgroundTaskProgressEventArgs: ...

class BackgroundTaskRegistration(_winrt.Object, interfaces=[IBackgroundTaskRegistration, IBackgroundTaskRegistration2, IBackgroundTaskRegistration3]):
    name: str
    task_id: uuid.UUID
...
class BackgroundTaskRegistrationGroup(_winrt.Object, interfaces=[]):
...
class BluetoothLEAdvertisementPublisherTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class BluetoothLEAdvertisementWatcherTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class CachedFileUpdaterTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> CachedFileUpdaterTrigger: ...
    def __init__(self) -> None: ...

class CachedFileUpdaterTriggerDetails(_winrt.Object, interfaces=[]):
...
class ChatMessageNotificationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> ChatMessageNotificationTrigger: ...
    def __init__(self) -> None: ...

class ChatMessageReceivedNotificationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> ChatMessageReceivedNotificationTrigger: ...
    def __init__(self) -> None: ...

class CommunicationBlockingAppSetAsActiveTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> CommunicationBlockingAppSetAsActiveTrigger: ...
    def __init__(self) -> None: ...

class ContactStoreNotificationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> ContactStoreNotificationTrigger: ...
    def __init__(self) -> None: ...

class ContentPrefetchTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class ConversationalAgentTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> ConversationalAgentTrigger: ...
    def __init__(self) -> None: ...

class CustomSystemEventTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class DeviceConnectionChangeTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class DeviceManufacturerNotificationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class DeviceServicingTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class DeviceUseTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class DeviceWatcherTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> DeviceWatcherTrigger: ...

class EmailStoreNotificationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> EmailStoreNotificationTrigger: ...
    def __init__(self) -> None: ...

class GattCharacteristicNotificationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class GattServiceProviderTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class GattServiceProviderTriggerResult(_winrt.Object, interfaces=[]):
...
class GeovisitTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    monitoring_scope: winsdk.windows.devices.geolocation.VisitMonitoringScope
    @staticmethod
    def _from(obj: _winrt.Object) -> GeovisitTrigger: ...
    def __init__(self) -> None: ...

class LocationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class MaintenanceTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class MediaProcessingTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class MobileBroadbandDeviceServiceNotificationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> MobileBroadbandDeviceServiceNotificationTrigger: ...
    def __init__(self) -> None: ...

class MobileBroadbandPcoDataChangeTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> MobileBroadbandPcoDataChangeTrigger: ...
    def __init__(self) -> None: ...

class MobileBroadbandPinLockStateChangeTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> MobileBroadbandPinLockStateChangeTrigger: ...
    def __init__(self) -> None: ...

class MobileBroadbandRadioStateChangeTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> MobileBroadbandRadioStateChangeTrigger: ...
    def __init__(self) -> None: ...

class MobileBroadbandRegistrationStateChangeTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> MobileBroadbandRegistrationStateChangeTrigger: ...
    def __init__(self) -> None: ...

class NetworkOperatorDataUsageTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> NetworkOperatorDataUsageTrigger: ...
    def __init__(self) -> None: ...

class NetworkOperatorHotspotAuthenticationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> NetworkOperatorHotspotAuthenticationTrigger: ...
    def __init__(self) -> None: ...

class NetworkOperatorNotificationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class PaymentAppCanMakePaymentTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> PaymentAppCanMakePaymentTrigger: ...
    def __init__(self) -> None: ...

class PhoneTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    one_shot: _winrt.Boolean
...
class PushNotificationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class RcsEndUserMessageAvailableTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> RcsEndUserMessageAvailableTrigger: ...
    def __init__(self) -> None: ...

class RfcommConnectionTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class SecondaryAuthenticationFactorAuthenticationTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> SecondaryAuthenticationFactorAuthenticationTrigger: ...
    def __init__(self) -> None: ...

class SensorDataThresholdTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class SmartCardTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
...
class SmsMessageReceivedTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class SocketActivityTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    is_wake_from_low_power_supported: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> SocketActivityTrigger: ...
    def __init__(self) -> None: ...

class StorageLibraryChangeTrackerTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class StorageLibraryContentChangedTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class SystemCondition(_winrt.Object, interfaces=[IBackgroundCondition]):
...
class SystemTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    one_shot: _winrt.Boolean
...
class TetheringEntitlementCheckTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
    def _from(obj: _winrt.Object) -> TetheringEntitlementCheckTrigger: ...
    def __init__(self) -> None: ...

class TimeTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    freshness_time: _winrt.UInt32
    one_shot: _winrt.Boolean
    @staticmethod
...
class ToastNotificationActionTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class ToastNotificationHistoryChangedTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class UserNotificationChangedTrigger(_winrt.Object, interfaces=[IBackgroundTrigger]):
    @staticmethod
...
class IBackgroundTaskInstance2(typing.Protocol):
    instance_id: uuid.UUID
    progress: _winrt.UInt32
    suspended_count: _winrt.UInt32
    task: typing.Optional[BackgroundTaskRegistration]
...
class IBackgroundTaskInstance4(typing.Protocol):
...
class IBackgroundTaskRegistration(typing.Protocol):
    name: str
    task_id: uuid.UUID
    @staticmethod
...
class IBackgroundTaskRegistration2(typing.Protocol):
    trigger: typing.Optional[IBackgroundTrigger]
    name: str
    task_id: uuid.UUID
    @staticmethod
...
class IBackgroundTaskRegistration3(typing.Protocol):
    task_group: typing.Optional[BackgroundTaskRegistrationGroup]
    name: str
    task_id: uuid.UUID
    @staticmethod
...
class IBackgroundTrigger(typing.Protocol):
    @staticmethod
