...
class PackageInstallProgress:
    ...
    def __new__(cls: typing.Type[PackageInstallProgress], percent_complete: _winrt.UInt32) -> PackageInstallProgress: ...
...
class PackageVersion:
    ...
    def __new__(cls: typing.Type[PackageVersion], major: _winrt.UInt16, minor: _winrt.UInt16, build: _winrt.UInt16, revision: _winrt.UInt16) -> PackageVersion: ...
