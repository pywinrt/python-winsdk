...
class AppDisplayInfo(_winrt.Object, interfaces=[]):
    description: str
    display_name: str
    @staticmethod
...
class AppInfo(_winrt.Object, interfaces=[]):
...
class AppInstallerInfo(_winrt.Object, interfaces=[]):
...
class AppInstance(_winrt.Object, interfaces=[]):
...
class EnteredBackgroundEventArgs(_winrt.Object, interfaces=[IEnteredBackgroundEventArgs]):
    @staticmethod
    def _from(obj: _winrt.Object) -> EnteredBackgroundEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class LeavingBackgroundEventArgs(_winrt.Object, interfaces=[ILeavingBackgroundEventArgs]):
    @staticmethod
    def _from(obj: _winrt.Object) -> LeavingBackgroundEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class LimitedAccessFeatureRequestResult(_winrt.Object, interfaces=[]):
...
class Package(_winrt.Object, interfaces=[]):
...
class PackageCatalog(_winrt.Object, interfaces=[]):
    @staticmethod
    ...
    def remove_resource_packages_async(self, resource_packages: typing.Iterable[typing.Optional[Package]]) -> winsdk.windows.foundation.IAsyncOperation[PackageCatalogRemoveResourcePackagesResult]: ...
...
class PackageCatalogAddOptionalPackageResult(_winrt.Object, interfaces=[]):
    extended_error: winsdk.windows.foundation.HResult
    package: typing.Optional[Package]
    @staticmethod
    def _from(obj: _winrt.Object) -> PackageCatalogAddOptionalPackageResult: ...

class PackageCatalogAddResourcePackageResult(_winrt.Object, interfaces=[]):
    extended_error: winsdk.windows.foundation.HResult
...
class PackageCatalogRemoveOptionalPackagesResult(_winrt.Object, interfaces=[]):
    extended_error: winsdk.windows.foundation.HResult
...
class PackageCatalogRemoveResourcePackagesResult(_winrt.Object, interfaces=[]):
    extended_error: winsdk.windows.foundation.HResult
    packages_removed: typing.Optional[winsdk.windows.foundation.collections.IVectorView[Package]]
    @staticmethod
    def _from(obj: _winrt.Object) -> PackageCatalogRemoveResourcePackagesResult: ...

class PackageContentGroup(_winrt.Object, interfaces=[]):
...
class PackageContentGroupStagingEventArgs(_winrt.Object, interfaces=[]):
...
class PackageId(_winrt.Object, interfaces=[]):
...
class PackageInstallingEventArgs(_winrt.Object, interfaces=[]):
    activity_id: uuid.UUID
    error_code: winsdk.windows.foundation.HResult
    is_complete: _winrt.Boolean
    package: typing.Optional[Package]
...
class PackageStagingEventArgs(_winrt.Object, interfaces=[]):
    activity_id: uuid.UUID
    error_code: winsdk.windows.foundation.HResult
    is_complete: _winrt.Boolean
    package: typing.Optional[Package]
...
class PackageStatus(_winrt.Object, interfaces=[]):
...
class PackageStatusChangedEventArgs(_winrt.Object, interfaces=[]):
    package: typing.Optional[Package]
    @staticmethod
    def _from(obj: _winrt.Object) -> PackageStatusChangedEventArgs: ...

class PackageUninstallingEventArgs(_winrt.Object, interfaces=[]):
    activity_id: uuid.UUID
    error_code: winsdk.windows.foundation.HResult
    is_complete: _winrt.Boolean
    package: typing.Optional[Package]
...
class PackageUpdateAvailabilityResult(_winrt.Object, interfaces=[]):
    availability: PackageUpdateAvailability
    extended_error: winsdk.windows.foundation.HResult
    @staticmethod
    def _from(obj: _winrt.Object) -> PackageUpdateAvailabilityResult: ...

class PackageUpdatingEventArgs(_winrt.Object, interfaces=[]):
    activity_id: uuid.UUID
    error_code: winsdk.windows.foundation.HResult
    is_complete: _winrt.Boolean
    progress: _winrt.Double
...
class StartupTask(_winrt.Object, interfaces=[]):
...
class SuspendingDeferral(_winrt.Object, interfaces=[ISuspendingDeferral]):
    @staticmethod
    def _from(obj: _winrt.Object) -> SuspendingDeferral: ...
    def complete(self) -> None: ...

class SuspendingEventArgs(_winrt.Object, interfaces=[ISuspendingEventArgs]):
    suspending_operation: typing.Optional[SuspendingOperation]
    @staticmethod
    def _from(obj: _winrt.Object) -> SuspendingEventArgs: ...

class SuspendingOperation(_winrt.Object, interfaces=[ISuspendingOperation]):
...
class IEnteredBackgroundEventArgs(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> IEnteredBackgroundEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class ILeavingBackgroundEventArgs(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> ILeavingBackgroundEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class ISuspendingDeferral(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> ISuspendingDeferral: ...
    def complete(self) -> None: ...

class ISuspendingEventArgs(typing.Protocol):
    suspending_operation: typing.Optional[SuspendingOperation]
    @staticmethod
    def _from(obj: _winrt.Object) -> ISuspendingEventArgs: ...

class ISuspendingOperation(typing.Protocol):
    deadline: winsdk.windows.foundation.DateTime
    @staticmethod
