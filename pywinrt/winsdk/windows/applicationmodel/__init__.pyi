...
class Package(_winrt.Object):
    ...
    def check_update_availability_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PackageUpdateAvailabilityResult]]: ...
    ...
    def get_app_list_entries_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.applicationmodel.core.AppListEntry]]]: ...
    def get_content_group_async(self, name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PackageContentGroup]]: ...
    def get_content_groups_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVector[PackageContentGroup]]]: ...
    ...
    def set_in_use_async(self, in_use: _winrt.Boolean) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def stage_content_groups_async(self, names: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVector[PackageContentGroup]]]: ...
    @typing.overload
    def stage_content_groups_async(self, names: typing.Iterable[str], move_to_head_of_queue: _winrt.Boolean) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVector[PackageContentGroup]]]: ...
    def verify_content_integrity_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...

class PackageCatalog(_winrt.Object):
    @staticmethod
    def _from(obj: _winrt.Object) -> PackageCatalog: ...
    def add_optional_package_async(self, optional_package_family_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PackageCatalogAddOptionalPackageResult]]: ...
    def add_resource_package_async(self, resource_package_family_name: str, resource_i_d: str, options: AddResourcePackageOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[PackageCatalogAddResourcePackageResult, PackageInstallProgress]]: ...
    @staticmethod
    def open_for_current_package() -> typing.Optional[PackageCatalog]: ...
    @staticmethod
    def open_for_current_user() -> typing.Optional[PackageCatalog]: ...
    def remove_optional_packages_async(self, optional_package_family_names: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PackageCatalogRemoveOptionalPackagesResult]]: ...
    def remove_resource_packages_async(self, resource_packages: typing.Iterable[typing.Optional[Package]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PackageCatalogRemoveResourcePackagesResult]]: ...
...
class StartupTask(_winrt.Object):
    ...
    @staticmethod
    def get_async(task_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StartupTask]]: ...
    @staticmethod
    def get_for_current_package_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StartupTask]]]: ...
    def request_enable_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StartupTaskState]]: ...
