...
class EmailAttachment(_winrt.Object, interfaces=[]):
    file_name: str
...
class EmailConversation(_winrt.Object, interfaces=[]):
...
class EmailConversationBatch(_winrt.Object, interfaces=[]):
...
class EmailConversationReader(_winrt.Object, interfaces=[]):
    @staticmethod
...
class EmailFolder(_winrt.Object, interfaces=[]):
    remote_id: str
...
class EmailIrmInfo(_winrt.Object, interfaces=[]):
...
class EmailIrmTemplate(_winrt.Object, interfaces=[]):
    name: str
    id: str
    description: str
    @staticmethod
...
class EmailItemCounts(_winrt.Object, interfaces=[]):
...
class EmailMailbox(_winrt.Object, interfaces=[]):
    ...
    def try_forward_meeting_async(self, meeting: typing.Optional[EmailMessage], recipients: typing.Iterable[typing.Optional[EmailRecipient]], subject: str, forward_header_type: EmailMessageBodyKind, forward_header: str, comment: str) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]: ...
    ...
    def validate_certificates_async(self, certificates: typing.Iterable[typing.Optional[winsdk.windows.security.cryptography.certificates.Certificate]]) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailCertificateValidationStatus]]: ...
...
class EmailMailboxCapabilities(_winrt.Object, interfaces=[]):
...
class EmailMailboxChange(_winrt.Object, interfaces=[]):
...
class EmailMailboxChangeReader(_winrt.Object, interfaces=[]):
    @staticmethod
...
class EmailMailboxChangeTracker(_winrt.Object, interfaces=[]):
...
class EmailMailboxChangedDeferral(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> EmailMailboxChangedDeferral: ...
    def complete(self) -> None: ...

class EmailMailboxChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
...
class EmailMailboxCreateFolderResult(_winrt.Object, interfaces=[]):
    folder: typing.Optional[EmailFolder]
    status: EmailMailboxCreateFolderStatus
    @staticmethod
    def _from(obj: _winrt.Object) -> EmailMailboxCreateFolderResult: ...

class EmailMailboxPolicies(_winrt.Object, interfaces=[]):
...
class EmailMailboxSyncManager(_winrt.Object, interfaces=[]):
...
class EmailManagerForUser(_winrt.Object, interfaces=[]):
...
class EmailMeetingInfo(_winrt.Object, interfaces=[]):
    location: str
...
class EmailMessage(_winrt.Object, interfaces=[]):
    subject: str
    body: str
...
class EmailMessageBatch(_winrt.Object, interfaces=[]):
...
class EmailMessageReader(_winrt.Object, interfaces=[]):
    @staticmethod
...
class EmailQueryOptions(_winrt.Object, interfaces=[]):
...
class EmailQueryTextSearch(_winrt.Object, interfaces=[]):
    text: str
...
class EmailRecipient(_winrt.Object, interfaces=[]):
    name: str
    address: str
    @staticmethod
...
class EmailRecipientResolutionResult(_winrt.Object, interfaces=[]):
...
class EmailStore(_winrt.Object, interfaces=[]):
    @staticmethod
...
class EmailStoreNotificationTriggerDetails(_winrt.Object, interfaces=[]):
    @staticmethod
