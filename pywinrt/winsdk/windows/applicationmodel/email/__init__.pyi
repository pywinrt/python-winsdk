...
class EmailConversation(_winrt.Object):
    ...
    def find_messages_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailMessage]]:
        ...
    def find_messages_async(count: _winrt.UInt32) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailMessage]]:
        ...
...
class EmailConversationReader(_winrt.Object):
    ...
    def read_batch_async() -> winsdk.windows.foundation.IAsyncOperation[EmailConversationBatch]:
        ...
...
class EmailFolder(_winrt.Object):
    ...
    def create_folder_async(name: str) -> winsdk.windows.foundation.IAsyncOperation[EmailFolder]:
        ...
    def delete_async() -> winsdk.windows.foundation.IAsyncAction:
        ...
    def find_child_folders_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailFolder]]:
        ...
    ...
    def get_conversation_reader(options: EmailQueryOptions) -> EmailConversationReader:
        ...
    def get_message_async(id: str) -> winsdk.windows.foundation.IAsyncOperation[EmailMessage]:
        ...
    def get_message_counts_async() -> winsdk.windows.foundation.IAsyncOperation[EmailItemCounts]:
        ...
    def get_message_reader() -> EmailMessageReader:
        ...
    def get_message_reader(options: EmailQueryOptions) -> EmailMessageReader:
        ...
    def save_message_async(message: EmailMessage) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def try_move_async(new_parent_folder: EmailFolder) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def try_move_async(new_parent_folder: EmailFolder, new_folder_name: str) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def try_save_async() -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
...
class EmailMailbox(_winrt.Object):
    ...
    network_id: str
    def change_message_flag_state_async(message_id: str, flag_state: EmailFlagState) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def create_response_message_async(message_id: str, response_type: EmailMessageResponseKind, subject: str, response_header_type: EmailMessageBodyKind, response_header: str) -> winsdk.windows.foundation.IAsyncOperation[EmailMessage]:
        ...
    def delete_async() -> winsdk.windows.foundation.IAsyncAction:
        ...
    def delete_message_async(message_id: str) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def download_attachment_async(attachment_id: str) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def download_message_async(message_id: str) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def get_change_tracker(identity: str) -> EmailMailboxChangeTracker:
        ...
    def get_conversation_async(id: str) -> winsdk.windows.foundation.IAsyncOperation[EmailConversation]:
        ...
    def get_conversation_reader() -> EmailConversationReader:
        ...
    def get_conversation_reader(options: EmailQueryOptions) -> EmailConversationReader:
        ...
    def get_folder_async(id: str) -> winsdk.windows.foundation.IAsyncOperation[EmailFolder]:
        ...
    def get_message_async(id: str) -> winsdk.windows.foundation.IAsyncOperation[EmailMessage]:
        ...
    def get_message_reader() -> EmailMessageReader:
    ...
    def get_message_reader(options: EmailQueryOptions) -> EmailMessageReader:
        ...
    def get_special_folder_async(folder_type: EmailSpecialFolderKind) -> winsdk.windows.foundation.IAsyncOperation[EmailFolder]:
        ...
    def mark_folder_as_seen_async(folder_id: str) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def mark_folder_sync_enabled_async(folder_id: str, is_sync_enabled: _winrt.Boolean) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def mark_message_as_seen_async(message_id: str) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def mark_message_read_async(message_id: str, is_read: _winrt.Boolean) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def register_sync_manager_async() -> winsdk.windows.foundation.IAsyncAction:
        ...
    def resolve_recipients_async(recipients: typing.Iterable[str]) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailRecipientResolutionResult]]:
        ...
    def save_async() -> winsdk.windows.foundation.IAsyncAction:
        ...
    def save_draft_async(message: EmailMessage) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def send_message_async(message: EmailMessage) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def send_message_async(message: EmailMessage, smart_send: _winrt.Boolean) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def try_create_folder_async(parent_folder_id: str, name: str) -> winsdk.windows.foundation.IAsyncOperation[EmailMailboxCreateFolderResult]:
        ...
    def try_delete_folder_async(folder_id: str) -> winsdk.windows.foundation.IAsyncOperation[EmailMailboxDeleteFolderStatus]:
        ...
    def try_empty_folder_async(folder_id: str) -> winsdk.windows.foundation.IAsyncOperation[EmailMailboxEmptyFolderStatus]:
        ...
    def try_forward_meeting_async(meeting: EmailMessage, recipients: typing.Iterable[EmailRecipient], subject: str, forward_header_type: EmailMessageBodyKind, forward_header: str, comment: str) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def try_get_auto_reply_settings_async(requested_format: EmailMailboxAutoReplyMessageResponseKind) -> winsdk.windows.foundation.IAsyncOperation[EmailMailboxAutoReplySettings]:
        ...
    def try_move_folder_async(folder_id: str, new_parent_folder_id: str) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def try_move_folder_async(folder_id: str, new_parent_folder_id: str, new_folder_name: str) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def try_move_message_async(message_id: str, new_parent_folder_id: str) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def try_propose_new_time_for_meeting_async(meeting: EmailMessage, new_start_time: winsdk.windows.foundation.DateTime, new_duration: winsdk.windows.foundation.TimeSpan, subject: str, comment: str) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def try_set_auto_reply_settings_async(auto_reply_settings: EmailMailboxAutoReplySettings) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def try_update_meeting_response_async(meeting: EmailMessage, response: EmailMeetingResponseType, subject: str, comment: str, send_update: _winrt.Boolean) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def validate_certificates_async(certificates: typing.Iterable[winsdk.windows.security.cryptography.certificates.Certificate]) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailCertificateValidationStatus]]:
        ...
    def add_mailbox_changed(p_handler: winsdk.windows.foundation.TypedEventHandler[EmailMailbox, EmailMailboxChangedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_mailbox_changed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
...
class EmailMailboxChangeReader(_winrt.Object):
    ...
    def accept_changes_through(last_change_to_acknowledge: EmailMailboxChange) -> None:
        ...
    def read_batch_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailMailboxChange]]:
        ...
...
class EmailMailboxSyncManager(_winrt.Object):
    ...
    def sync_async() -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def add_sync_status_changed(handler: winsdk.windows.foundation.TypedEventHandler[EmailMailboxSyncManager, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
...
class EmailMessage(_winrt.Object):
    ...
    def __init__(self, ) -> None:
        ...
    def get_body_stream(type: EmailMessageBodyKind) -> winsdk.windows.storage.streams.IRandomAccessStreamReference:
        ...
    def set_body_stream(type: EmailMessageBodyKind, stream: winsdk.windows.storage.streams.IRandomAccessStreamReference) -> None:
        ...
...
class EmailMessageReader(_winrt.Object):
    ...
    def read_batch_async() -> winsdk.windows.foundation.IAsyncOperation[EmailMessageBatch]:
        ...
...
class EmailRecipientResolutionResult(_winrt.Object):
    ...
    def __init__(self, ) -> None:
        ...
    def set_public_keys(value: typing.Iterable[winsdk.windows.security.cryptography.certificates.Certificate]) -> None:
        ...

class EmailStore(_winrt.Object):
    ...
    def create_mailbox_async(account_name: str, account_address: str) -> winsdk.windows.foundation.IAsyncOperation[EmailMailbox]:
        ...
    def create_mailbox_async(account_name: str, account_address: str, user_data_account_id: str) -> winsdk.windows.foundation.IAsyncOperation[EmailMailbox]:
        ...
    def find_mailboxes_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailMailbox]]:
        ...
    def get_conversation_async(id: str) -> winsdk.windows.foundation.IAsyncOperation[EmailConversation]:
        ...
    def get_conversation_reader() -> EmailConversationReader:
    ...
    def get_folder_async(id: str) -> winsdk.windows.foundation.IAsyncOperation[EmailFolder]:
        ...
    def get_mailbox_async(id: str) -> winsdk.windows.foundation.IAsyncOperation[EmailMailbox]:
        ...
    def get_message_async(id: str) -> winsdk.windows.foundation.IAsyncOperation[EmailMessage]:
        ...
    def get_message_reader() -> EmailMessageReader:
