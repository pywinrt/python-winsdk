...
class EmailConversation(_winrt.Object):
    ...
    @typing.overload
    def find_messages_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailMessage]]]: ...
    @typing.overload
    def find_messages_async(self, count: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailMessage]]]: ...
...
class EmailConversationReader(_winrt.Object):
    ...
    def read_batch_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailConversationBatch]]: ...
...
class EmailFolder(_winrt.Object):
    ...
    def create_folder_async(self, name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailFolder]]: ...
    def delete_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    def find_child_folders_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailFolder]]]: ...
    @typing.overload
    ...
    def get_message_async(self, id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailMessage]]: ...
    def get_message_counts_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailItemCounts]]: ...
    @typing.overload
    ...
    @typing.overload
    def try_move_async(self, new_parent_folder: typing.Optional[EmailFolder]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_move_async(self, new_parent_folder: typing.Optional[EmailFolder], new_folder_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_save_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class EmailMailbox(_winrt.Object):
    ...
    def create_response_message_async(self, message_id: str, response_type: EmailMessageResponseKind, subject: str, response_header_type: EmailMessageBodyKind, response_header: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailMessage]]: ...
    def delete_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    ...
    def get_conversation_async(self, id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailConversation]]: ...
    @typing.overload
    def get_conversation_reader(self) -> typing.Optional[EmailConversationReader]: ...
    @typing.overload
    def get_conversation_reader(self, options: typing.Optional[EmailQueryOptions]) -> typing.Optional[EmailConversationReader]: ...
    def get_folder_async(self, id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailFolder]]: ...
    def get_message_async(self, id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailMessage]]: ...
    @typing.overload
    def get_message_reader(self) -> typing.Optional[EmailMessageReader]: ...
    @typing.overload
    def get_message_reader(self, options: typing.Optional[EmailQueryOptions]) -> typing.Optional[EmailMessageReader]: ...
    def get_special_folder_async(self, folder_type: EmailSpecialFolderKind) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailFolder]]: ...
    ...
    def resolve_recipients_async(self, recipients: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailRecipientResolutionResult]]]: ...
    ...
    def try_create_folder_async(self, parent_folder_id: str, name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailMailboxCreateFolderResult]]: ...
    def try_delete_folder_async(self, folder_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailMailboxDeleteFolderStatus]]: ...
    def try_empty_folder_async(self, folder_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailMailboxEmptyFolderStatus]]: ...
    def try_forward_meeting_async(self, meeting: typing.Optional[EmailMessage], recipients: typing.Iterable[typing.Optional[EmailRecipient]], subject: str, forward_header_type: EmailMessageBodyKind, forward_header: str, comment: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_get_auto_reply_settings_async(self, requested_format: EmailMailboxAutoReplyMessageResponseKind) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailMailboxAutoReplySettings]]: ...
    @typing.overload
    def try_move_folder_async(self, folder_id: str, new_parent_folder_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_move_folder_async(self, folder_id: str, new_parent_folder_id: str, new_folder_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_move_message_async(self, message_id: str, new_parent_folder_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_propose_new_time_for_meeting_async(self, meeting: typing.Optional[EmailMessage], new_start_time: winsdk.windows.foundation.DateTime, new_duration: winsdk.windows.foundation.TimeSpan, subject: str, comment: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_set_auto_reply_settings_async(self, auto_reply_settings: typing.Optional[EmailMailboxAutoReplySettings]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_update_meeting_response_async(self, meeting: typing.Optional[EmailMessage], response: EmailMeetingResponseType, subject: str, comment: str, send_update: _winrt.Boolean) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def validate_certificates_async(self, certificates: typing.Iterable[typing.Optional[winsdk.windows.security.cryptography.certificates.Certificate]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailCertificateValidationStatus]]]: ...
...
class EmailMailboxChangeReader(_winrt.Object):
    ...
    def read_batch_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailMailboxChange]]]: ...
...
class EmailManager(_winrt.Object):
    ...
    @staticmethod
    def request_store_async(access_type: EmailStoreAccessType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailStore]]: ...
    @staticmethod
...
class EmailManagerForUser(_winrt.Object):
    ...
    def request_store_async(self, access_type: EmailStoreAccessType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailStore]]: ...
...
class EmailMessageReader(_winrt.Object):
    ...
    def read_batch_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailMessageBatch]]: ...
...
class EmailRecipientResolutionResult(_winrt.Object):
    ...
    def __init__(self) -> None: ...
    def set_public_keys(self, value: typing.Iterable[typing.Optional[winsdk.windows.security.cryptography.certificates.Certificate]]) -> None: ...

class EmailStore(_winrt.Object):
    @staticmethod
    def _from(obj: _winrt.Object) -> EmailStore: ...
    @typing.overload
    def create_mailbox_async(self, account_name: str, account_address: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailMailbox]]: ...
    @typing.overload
    def create_mailbox_async(self, account_name: str, account_address: str, user_data_account_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailMailbox]]: ...
    def find_mailboxes_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[EmailMailbox]]]: ...
    def get_conversation_async(self, id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailConversation]]: ...
    @typing.overload
    def get_conversation_reader(self) -> typing.Optional[EmailConversationReader]: ...
    @typing.overload
    def get_conversation_reader(self, options: typing.Optional[EmailQueryOptions]) -> typing.Optional[EmailConversationReader]: ...
    def get_folder_async(self, id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailFolder]]: ...
    def get_mailbox_async(self, id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailMailbox]]: ...
    def get_message_async(self, id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[EmailMessage]]: ...
    @typing.overload
    def get_message_reader(self) -> typing.Optional[EmailMessageReader]: ...
    @typing.overload
