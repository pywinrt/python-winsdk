...
class AggregateContactManager(_winrt.Object):
    ...
    def find_raw_contacts_async(self, contact: typing.Optional[Contact]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[Contact]]]: ...
    ...
    def try_link_contacts_async(self, primary_contact: typing.Optional[Contact], secondary_contact: typing.Optional[Contact]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Contact]]: ...
    def try_set_preferred_source_for_picture_async(self, aggregate_contact: typing.Optional[Contact], raw_contact: typing.Optional[Contact]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class ContactAnnotationList(_winrt.Object):
    ...
    def find_annotations_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactAnnotation]]]: ...
    def find_annotations_by_remote_id_async(self, remote_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactAnnotation]]]: ...
    def get_annotation_async(self, annotation_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactAnnotation]]: ...
    def try_save_annotation_async(self, annotation: typing.Optional[ContactAnnotation]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...

class ContactAnnotationStore(_winrt.Object):
    @staticmethod
    def _from(obj: _winrt.Object) -> ContactAnnotationStore: ...
    @typing.overload
    def create_annotation_list_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactAnnotationList]]: ...
    @typing.overload
    def create_annotation_list_async(self, user_data_account_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactAnnotationList]]: ...
    ...
    def find_annotation_lists_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactAnnotationList]]]: ...
    def find_annotations_for_contact_async(self, contact: typing.Optional[Contact]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactAnnotation]]]: ...
    def find_annotations_for_contact_list_async(self, contact_list_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactAnnotation]]]: ...
    def find_contact_ids_by_email_async(self, email_address: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]]: ...
    def find_contact_ids_by_phone_number_async(self, phone_number: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]]: ...
    def get_annotation_list_async(self, annotation_list_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactAnnotationList]]: ...
...
class ContactChangeReader(_winrt.Object):
    ...
    def read_batch_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactChange]]]: ...
...
class ContactInformation(_winrt.Object):
    ...
    def get_thumbnail_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IRandomAccessStreamWithContentType]]: ...
...
class ContactList(_winrt.Object):
    ...
    def get_contact_async(self, contact_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Contact]]: ...
    def get_contact_from_remote_id_async(self, remote_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Contact]]: ...
    @typing.overload
    ...
    def get_me_contact_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Contact]]: ...
...
class ContactListLimitedWriteOperations(_winrt.Object):
    ...
    def try_create_or_update_contact_async(self, contact: typing.Optional[Contact]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_delete_contact_async(self, contact_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class ContactManager(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def convert_contact_to_v_card_async(contact: typing.Optional[Contact]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.RandomAccessStreamReference]]: ...
    @typing.overload
    @staticmethod
    def convert_contact_to_v_card_async(contact: typing.Optional[Contact], max_bytes: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.RandomAccessStreamReference]]: ...
    @staticmethod
    def convert_v_card_to_contact_async(v_card: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStreamReference]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Contact]]: ...
    @staticmethod
    ...
    @staticmethod
    def is_show_full_contact_card_supported_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @staticmethod
    def request_annotation_store_async(access_type: ContactAnnotationStoreAccessType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactAnnotationStore]]: ...
    @typing.overload
    @staticmethod
    def request_store_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactStore]]: ...
    @typing.overload
    @staticmethod
    def request_store_async(access_type: ContactStoreAccessType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactStore]]: ...
    @typing.overload
    @staticmethod
...
class ContactManagerForUser(_winrt.Object):
    ...
    @typing.overload
    def convert_contact_to_v_card_async(self, contact: typing.Optional[Contact]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.RandomAccessStreamReference]]: ...
    @typing.overload
    def convert_contact_to_v_card_async(self, contact: typing.Optional[Contact], max_bytes: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.RandomAccessStreamReference]]: ...
    def convert_v_card_to_contact_async(self, v_card: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStreamReference]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Contact]]: ...
    def request_annotation_store_async(self, access_type: ContactAnnotationStoreAccessType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactAnnotationStore]]: ...
    def request_store_async(self, access_type: ContactStoreAccessType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactStore]]: ...
...
class ContactPicker(_winrt.Object):
    ...
    @staticmethod
    def is_supported_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def pick_contact_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Contact]]: ...
    def pick_contacts_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVector[Contact]]]: ...
    def pick_multiple_contacts_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactInformation]]]: ...
    def pick_single_contact_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactInformation]]: ...
...
class ContactReader(_winrt.Object):
    ...
    def read_batch_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactBatch]]: ...
...
class ContactStore(_winrt.Object):
    ...
    @typing.overload
    def create_contact_list_async(self, display_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactList]]: ...
    @typing.overload
    def create_contact_list_async(self, display_name: str, user_data_account_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactList]]: ...
    def find_contact_lists_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactList]]]: ...
    @typing.overload
    def find_contacts_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[Contact]]]: ...
    @typing.overload
    def find_contacts_async(self, search_text: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[Contact]]]: ...
    def get_change_tracker(self, identity: str) -> typing.Optional[ContactChangeTracker]: ...
    def get_contact_async(self, contact_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Contact]]: ...
    def get_contact_list_async(self, contact_list_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ContactList]]: ...
    @typing.overload
    def get_contact_reader(self) -> typing.Optional[ContactReader]: ...
    @typing.overload
    def get_contact_reader(self, options: typing.Optional[ContactQueryOptions]) -> typing.Optional[ContactReader]: ...
...
class PinnedContactManager(_winrt.Object):
    ...
    def get_pinned_contact_ids_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PinnedContactIdsQueryResult]]: ...
    ...
    def request_pin_contact_async(self, contact: typing.Optional[Contact], surface: PinnedContactSurface) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def request_pin_contacts_async(self, contacts: typing.Iterable[typing.Optional[Contact]], surface: PinnedContactSurface) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def request_unpin_contact_async(self, contact: typing.Optional[Contact], surface: PinnedContactSurface) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
