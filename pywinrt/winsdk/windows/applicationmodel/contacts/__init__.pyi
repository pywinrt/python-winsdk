...
class AggregateContactManager(_winrt.Object):
    ...
    def find_raw_contacts_async(contact: Contact) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[Contact]]:
        ...
    def set_remote_identification_information_async(contact_list_id: str, remote_source_id: str, account_id: str) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def try_link_contacts_async(primary_contact: Contact, secondary_contact: Contact) -> winsdk.windows.foundation.IAsyncOperation[Contact]:
        ...
    def try_set_preferred_source_for_picture_async(aggregate_contact: Contact, raw_contact: Contact) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def unlink_raw_contact_async(contact: Contact) -> winsdk.windows.foundation.IAsyncAction:
        ...
...
class ContactAnnotationList(_winrt.Object):
    ...
    def delete_annotation_async(annotation: ContactAnnotation) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def delete_async() -> winsdk.windows.foundation.IAsyncAction:
        ...
    def find_annotations_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactAnnotation]]:
        ...
    def find_annotations_by_remote_id_async(remote_id: str) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactAnnotation]]:
        ...
    def get_annotation_async(annotation_id: str) -> winsdk.windows.foundation.IAsyncOperation[ContactAnnotation]:
        ...
    def try_save_annotation_async(annotation: ContactAnnotation) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...

class ContactAnnotationStore(_winrt.Object):
    ...
    def create_annotation_list_async() -> winsdk.windows.foundation.IAsyncOperation[ContactAnnotationList]:
        ...
    def create_annotation_list_async(user_data_account_id: str) -> winsdk.windows.foundation.IAsyncOperation[ContactAnnotationList]:
        ...
    def disable_annotation_async(annotation: ContactAnnotation) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def find_annotation_lists_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactAnnotationList]]:
        ...
    def find_annotations_for_contact_async(contact: Contact) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactAnnotation]]:
        ...
    def find_annotations_for_contact_list_async(contact_list_id: str) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactAnnotation]]:
        ...
    def find_contact_ids_by_email_async(email_address: str) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]:
        ...
    def find_contact_ids_by_phone_number_async(phone_number: str) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]:
        ...
    def get_annotation_list_async(annotation_list_id: str) -> winsdk.windows.foundation.IAsyncOperation[ContactAnnotationList]:
        ...
...
class ContactChangeReader(_winrt.Object):
    ...
    def accept_changes_through(last_change_to_accept: ContactChange) -> None:
        ...
    def read_batch_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactChange]]:
        ...
...
class ContactFieldFactory(IContactFieldFactory, IContactLocationFieldFactory, IContactInstantMessageFieldFactory, _winrt.Object):
    ...
    def create_instant_message(user_name: str, category: ContactFieldCategory) -> ContactInstantMessageField:
        ...
    def create_instant_message(user_name: str, category: ContactFieldCategory, service: str, display_text: str, verb: winsdk.windows.foundation.Uri) -> ContactInstantMessageField:
        ...
...
class ContactInformation(_winrt.Object):
    ...
    def get_thumbnail_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IRandomAccessStreamWithContentType]:
        ...
    def query_custom_fields(custom_name: str) -> winsdk.windows.foundation.collections.IVectorView[ContactField]:
        ...
...
class ContactList(_winrt.Object):
    ...
    def delete_async() -> winsdk.windows.foundation.IAsyncAction:
        ...
    def delete_contact_async(contact: Contact) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def get_change_tracker(identity: str) -> ContactChangeTracker:
        ...
    def get_contact_async(contact_id: str) -> winsdk.windows.foundation.IAsyncOperation[Contact]:
        ...
    def get_contact_from_remote_id_async(remote_id: str) -> winsdk.windows.foundation.IAsyncOperation[Contact]:
        ...
    def get_contact_reader() -> ContactReader:
        ...
    def get_contact_reader(options: ContactQueryOptions) -> ContactReader:
        ...
    def get_me_contact_async() -> winsdk.windows.foundation.IAsyncOperation[Contact]:
        ...
    ...
    def save_async() -> winsdk.windows.foundation.IAsyncAction:
        ...
    def save_contact_async(contact: Contact) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def add_contact_changed(value: winsdk.windows.foundation.TypedEventHandler[ContactList, ContactChangedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_contact_changed(value: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...

class ContactListLimitedWriteOperations(_winrt.Object):
    ...
    def try_create_or_update_contact_async(contact: Contact) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def try_delete_contact_async(contact_id: str) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
...
class ContactListSyncManager(_winrt.Object):
    ...
    def sync_async() -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def add_sync_status_changed(handler: winsdk.windows.foundation.TypedEventHandler[ContactListSyncManager, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
...
class ContactPanel(_winrt.Object):
    ...
    def close_panel() -> None:
        ...
    def add_closing(handler: winsdk.windows.foundation.TypedEventHandler[ContactPanel, ContactPanelClosingEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_closing(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_launch_full_app_requested(handler: winsdk.windows.foundation.TypedEventHandler[ContactPanel, ContactPanelLaunchFullAppRequestedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_launch_full_app_requested(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
...
class ContactPicker(_winrt.Object):
    ...
    def is_supported_async() -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def pick_contact_async() -> winsdk.windows.foundation.IAsyncOperation[Contact]:
        ...
    def pick_contacts_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVector[Contact]]:
        ...
    def pick_multiple_contacts_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactInformation]]:
        ...
    def pick_single_contact_async() -> winsdk.windows.foundation.IAsyncOperation[ContactInformation]:
        ...
...
class ContactReader(_winrt.Object):
    ...
    def get_matching_properties_with_match_reason(contact: Contact) -> winsdk.windows.foundation.collections.IVectorView[ContactMatchReason]:
        ...
    def read_batch_async() -> winsdk.windows.foundation.IAsyncOperation[ContactBatch]:
        ...
...
class ContactStore(_winrt.Object):
    ...
    change_tracker: ContactChangeTracker
    def create_contact_list_async(display_name: str) -> winsdk.windows.foundation.IAsyncOperation[ContactList]:
        ...
    def create_contact_list_async(display_name: str, user_data_account_id: str) -> winsdk.windows.foundation.IAsyncOperation[ContactList]:
        ...
    def find_contact_lists_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ContactList]]:
        ...
    def find_contacts_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[Contact]]:
        ...
    def find_contacts_async(search_text: str) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[Contact]]:
        ...
    def get_change_tracker(identity: str) -> ContactChangeTracker:
        ...
    def get_contact_async(contact_id: str) -> winsdk.windows.foundation.IAsyncOperation[Contact]:
        ...
    def get_contact_list_async(contact_list_id: str) -> winsdk.windows.foundation.IAsyncOperation[ContactList]:
        ...
    def get_contact_reader() -> ContactReader:
        ...
    def get_contact_reader(options: ContactQueryOptions) -> ContactReader:
    ...
    def get_me_contact_async() -> winsdk.windows.foundation.IAsyncOperation[Contact]:
        ...
    def add_contact_changed(value: winsdk.windows.foundation.TypedEventHandler[ContactStore, ContactChangedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_contact_changed(value: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
...
class PinnedContactManager(_winrt.Object):
    ...
    def get_for_user(user: winsdk.windows.system.User) -> PinnedContactManager:
        ...
    def get_pinned_contact_ids_async() -> winsdk.windows.foundation.IAsyncOperation[PinnedContactIdsQueryResult]:
        ...
    def is_contact_pinned(contact: Contact, surface: PinnedContactSurface) -> _winrt.Boolean:
        ...
    def is_pin_surface_supported(surface: PinnedContactSurface) -> _winrt.Boolean:
        ...
    def is_supported() -> _winrt.Boolean:
        ...
    def request_pin_contact_async(contact: Contact, surface: PinnedContactSurface) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def request_pin_contacts_async(contacts: typing.Iterable[Contact], surface: PinnedContactSurface) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def request_unpin_contact_async(contact: Contact, surface: PinnedContactSurface) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
