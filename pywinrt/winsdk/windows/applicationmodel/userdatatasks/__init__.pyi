...
class UserDataTask(_winrt.Object, interfaces=[]):
...
class UserDataTaskBatch(_winrt.Object, interfaces=[]):
...
class UserDataTaskList(_winrt.Object, interfaces=[]):
...
class UserDataTaskListLimitedWriteOperations(_winrt.Object, interfaces=[]):
    @staticmethod
    ...
    def try_create_or_update_task_async(self, user_data_task: typing.Optional[UserDataTask]) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]: ...
    def try_delete_task_async(self, user_data_task_id: str) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]: ...
    def try_skip_occurrence_async(self, user_data_task_id: str) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]: ...

class UserDataTaskListSyncManager(_winrt.Object, interfaces=[]):
...
class UserDataTaskManager(_winrt.Object, interfaces=[]):
...
class UserDataTaskQueryOptions(_winrt.Object, interfaces=[]):
...
class UserDataTaskReader(_winrt.Object, interfaces=[]):
    @staticmethod
...
class UserDataTaskRecurrenceProperties(_winrt.Object, interfaces=[]):
...
class UserDataTaskRegenerationProperties(_winrt.Object, interfaces=[]):
    until: typing.Optional[typing.Optional[winsdk.windows.foundation.DateTime]]
...
class UserDataTaskStore(_winrt.Object, interfaces=[]):
    @staticmethod
