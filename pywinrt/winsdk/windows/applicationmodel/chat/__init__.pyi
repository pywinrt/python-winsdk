...
class ChatConversation(_winrt.Object):
    subject: str
    ...
    @typing.overload
    def mark_messages_as_read_async(self, value: datetime.datetime) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
...
class ChatMessage(_winrt.Object):
    item_kind: ChatItemKind
