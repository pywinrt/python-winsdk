...
class AppListEntry(_winrt.Object):
    ...
    def launch_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def launch_for_user_async(self, user: typing.Optional[winsdk.windows.system.User]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class CoreApplication(_winrt.Object):
    ...
    @staticmethod
    def request_restart_async(launch_arguments: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AppRestartFailureReason]]: ...
    @staticmethod
    def request_restart_for_user_async(user: typing.Optional[winsdk.windows.system.User], launch_arguments: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AppRestartFailureReason]]: ...
    @staticmethod
