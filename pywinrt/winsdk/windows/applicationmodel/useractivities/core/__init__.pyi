...
class CoreUserActivityManager(_winrt.Object):
    ...
    @staticmethod
    def delete_user_activity_sessions_in_time_range_async(channel: typing.Optional[winsdk.windows.applicationmodel.useractivities.UserActivityChannel], start_time: datetime.datetime, end_time: datetime.datetime) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
