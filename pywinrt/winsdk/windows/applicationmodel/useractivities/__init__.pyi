...
class UserActivityChannel(_winrt.Object):
    ...
    def get_or_create_user_activity_async(self, activity_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[UserActivity]]: ...
    def get_recent_user_activities_async(self, max_unique_activities: _winrt.Int32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVector[UserActivitySessionHistoryItem]]]: ...
    def get_session_history_items_for_user_activity_async(self, activity_id: str, start_time: winsdk.windows.foundation.DateTime) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVector[UserActivitySessionHistoryItem]]]: ...
    @staticmethod
