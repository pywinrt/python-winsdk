...
class PhoneCallHistoryEntry(_winrt.Object, interfaces=[]):
...
class PhoneCallHistoryEntryAddress(_winrt.Object, interfaces=[]):
...
class PhoneCallHistoryEntryQueryOptions(_winrt.Object, interfaces=[]):
...
class PhoneCallHistoryEntryReader(_winrt.Object, interfaces=[]):
    @staticmethod
...
class PhoneCallHistoryManagerForUser(_winrt.Object, interfaces=[]):
...
class PhoneCallHistoryStore(_winrt.Object, interfaces=[]):
    @staticmethod
...
class PhoneCallInfo(_winrt.Object, interfaces=[]):
...
class PhoneCallStore(_winrt.Object, interfaces=[]):
    @staticmethod
...
class PhoneCallVideoCapabilities(_winrt.Object, interfaces=[]):
...
class PhoneCallsResult(_winrt.Object, interfaces=[]):
...
class PhoneDialOptions(_winrt.Object, interfaces=[]):
    number: str
...
class PhoneLine(_winrt.Object, interfaces=[]):
...
class PhoneLineCellularDetails(_winrt.Object, interfaces=[]):
...
class PhoneLineConfiguration(_winrt.Object, interfaces=[]):
...
class PhoneLineDialResult(_winrt.Object, interfaces=[]):
...
class PhoneLineTransportDevice(_winrt.Object, interfaces=[]):
    device_id: str
    transport: PhoneLineTransport
...
class PhoneLineWatcher(_winrt.Object, interfaces=[]):
...
class PhoneLineWatcherEventArgs(_winrt.Object, interfaces=[]):
    line_id: uuid.UUID
    @staticmethod
    def _from(obj: _winrt.Object) -> PhoneLineWatcherEventArgs: ...

class PhoneVoicemail(_winrt.Object, interfaces=[]):
...
class VoipCallCoordinator(_winrt.Object, interfaces=[]):
    @staticmethod
...
class VoipPhoneCall(_winrt.Object, interfaces=[]):
    start_time: winsdk.windows.foundation.DateTime
    contact_name: str
