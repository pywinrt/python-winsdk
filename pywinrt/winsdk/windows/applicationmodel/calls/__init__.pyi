...
class PhoneCall(_winrt.Object):
    ...
    def accept_incoming_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallOperationStatus]]: ...
    def change_audio_device(self, endpoint: PhoneCallAudioDevice) -> PhoneCallOperationStatus: ...
    def change_audio_device_async(self, endpoint: PhoneCallAudioDevice) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallOperationStatus]]: ...
    def end(self) -> PhoneCallOperationStatus: ...
    def end_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallOperationStatus]]: ...
    @staticmethod
    def get_from_id(call_id: str) -> typing.Optional[PhoneCall]: ...
    def get_phone_call_info(self) -> typing.Optional[PhoneCallInfo]: ...
    def get_phone_call_info_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallInfo]]: ...
    def hold(self) -> PhoneCallOperationStatus: ...
    def hold_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallOperationStatus]]: ...
    def mute(self) -> PhoneCallOperationStatus: ...
    def mute_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallOperationStatus]]: ...
    def reject_incoming(self) -> PhoneCallOperationStatus: ...
    def reject_incoming_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallOperationStatus]]: ...
    def resume_from_hold(self) -> PhoneCallOperationStatus: ...
    def resume_from_hold_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallOperationStatus]]: ...
    def send_dtmf_key(self, key: DtmfKey, dtmf_tone_audio_playback: DtmfToneAudioPlayback) -> PhoneCallOperationStatus: ...
    def send_dtmf_key_async(self, key: DtmfKey, dtmf_tone_audio_playback: DtmfToneAudioPlayback) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallOperationStatus]]: ...
    def unmute(self) -> PhoneCallOperationStatus: ...
    def unmute_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallOperationStatus]]: ...
...
class PhoneCallBlocking(_winrt.Object):
    ...
    @staticmethod
    def set_call_blocking_list_async(phone_number_list: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class PhoneCallHistoryEntryReader(_winrt.Object):
    ...
    def read_batch_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[PhoneCallHistoryEntry]]]: ...
...
class PhoneCallHistoryManager(_winrt.Object):
    ...
    @staticmethod
    def request_store_async(access_type: PhoneCallHistoryStoreAccessType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallHistoryStore]]: ...
...
class PhoneCallHistoryManagerForUser(_winrt.Object):
    ...
    def request_store_async(self, access_type: PhoneCallHistoryStoreAccessType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallHistoryStore]]: ...

class PhoneCallHistoryStore(_winrt.Object):
    @staticmethod
    def _from(obj: _winrt.Object) -> PhoneCallHistoryStore: ...
    def delete_entries_async(self, call_history_entries: typing.Iterable[typing.Optional[PhoneCallHistoryEntry]]) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    ...
    def get_entry_async(self, call_history_entry_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallHistoryEntry]]: ...
    @typing.overload
    ...
    def get_sources_unseen_count_async(self, source_ids: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.UInt32]]: ...
    def get_unseen_count_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.UInt32]]: ...
    def mark_all_as_seen_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    def mark_entries_as_seen_async(self, call_history_entries: typing.Iterable[typing.Optional[PhoneCallHistoryEntry]]) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
...
class PhoneCallManager(_winrt.Object):
    ...
    @staticmethod
    def request_store_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallStore]]: ...
    @staticmethod
...
class PhoneCallStore(_winrt.Object):
    ...
    def get_default_line_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[uuid.UUID]]: ...
    def is_emergency_phone_number_async(self, number: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class PhoneCallVideoCapabilitiesManager(_winrt.Object):
    ...
    @staticmethod
    def get_capabilities_async(phone_number: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallVideoCapabilities]]: ...
...
class PhoneLine(_winrt.Object):
    ...
    def dial_with_result_async(self, number: str, display_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneLineDialResult]]: ...
    def enable_text_reply(self, value: _winrt.Boolean) -> None: ...
    @staticmethod
    def from_id_async(line_id: uuid.UUID) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneLine]]: ...
    def get_all_active_phone_calls(self) -> typing.Optional[PhoneCallsResult]: ...
    def get_all_active_phone_calls_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhoneCallsResult]]: ...
    def is_immediate_dial_number_async(self, number: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class PhoneLineTransportDevice(_winrt.Object):
    ...
    def connect_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @staticmethod
...
class VoipCallCoordinator(_winrt.Object):
    ...
    @typing.overload
    def reserve_call_resources_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VoipPhoneCallResourceReservationStatus]]: ...
    @typing.overload
    def reserve_call_resources_async(self, task_entry_point: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VoipPhoneCallResourceReservationStatus]]: ...
