...
class VoiceCommandServiceConnection(_winrt.Object):
    ...
    def get_voice_command_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VoiceCommand]]: ...
    ...
    def request_confirmation_async(self, response: typing.Optional[VoiceCommandResponse]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VoiceCommandConfirmationResult]]: ...
    def request_disambiguation_async(self, response: typing.Optional[VoiceCommandResponse]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VoiceCommandDisambiguationResult]]: ...
