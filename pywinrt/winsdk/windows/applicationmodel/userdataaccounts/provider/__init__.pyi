...
class UserDataAccountPartnerAccountInfo(_winrt.Object, interfaces=[]):
...
class UserDataAccountProviderAddAccountOperation(_winrt.Object, interfaces=[IUserDataAccountProviderOperation]):
...
class UserDataAccountProviderResolveErrorsOperation(_winrt.Object, interfaces=[IUserDataAccountProviderOperation]):
    kind: UserDataAccountProviderOperationKind
...
class UserDataAccountProviderSettingsOperation(_winrt.Object, interfaces=[IUserDataAccountProviderOperation]):
    kind: UserDataAccountProviderOperationKind
    user_data_account_id: str
    @staticmethod
...
class IUserDataAccountProviderOperation(typing.Protocol):
    kind: UserDataAccountProviderOperationKind
    @staticmethod
