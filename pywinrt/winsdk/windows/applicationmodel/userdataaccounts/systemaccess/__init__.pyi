...
class DeviceAccountConfiguration(_winrt.Object, interfaces=[]):
    email_address: str
    domain: str
...
class UserDataAccountSystemAccessManager(_winrt.Object):
    ...
    @staticmethod
    def add_and_show_device_accounts_async(accounts: typing.Iterable[typing.Optional[DeviceAccountConfiguration]]) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]: ...
    @staticmethod
