...
class UserDataAccountSystemAccessManager(_winrt.Object):
    ...
    @staticmethod
    def add_and_show_device_accounts_async(accounts: typing.Iterable[typing.Optional[DeviceAccountConfiguration]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[str]]]: ...
    @staticmethod
    def create_device_account_async(account: typing.Optional[DeviceAccountConfiguration]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @staticmethod
    def delete_device_account_async(account_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    @staticmethod
    def get_device_account_configuration_async(account_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[DeviceAccountConfiguration]]: ...
    @staticmethod
