...
class UserDataAccount(_winrt.Object, interfaces=[]):
...
class UserDataAccountManagerForUser(_winrt.Object, interfaces=[]):
...
class UserDataAccountStore(_winrt.Object, interfaces=[]):
    @staticmethod
...
class UserDataAccountStoreChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
