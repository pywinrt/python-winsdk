...
class AppointmentCalendarCancelMeetingRequest(_winrt.Object, interfaces=[]):
...
class AppointmentCalendarCancelMeetingRequestEventArgs(_winrt.Object, interfaces=[]):
...
class AppointmentCalendarCreateOrUpdateAppointmentRequest(_winrt.Object, interfaces=[]):
...
class AppointmentCalendarCreateOrUpdateAppointmentRequestEventArgs(_winrt.Object, interfaces=[]):
...
class AppointmentCalendarForwardMeetingRequest(_winrt.Object, interfaces=[]):
    appointment_calendar_local_id: str
    appointment_local_id: str
    appointment_original_start_time: typing.Optional[typing.Optional[winsdk.windows.foundation.DateTime]]
    comment: str
...
class AppointmentCalendarForwardMeetingRequestEventArgs(_winrt.Object, interfaces=[]):
...
class AppointmentCalendarProposeNewTimeForMeetingRequest(_winrt.Object, interfaces=[]):
    appointment_calendar_local_id: str
    appointment_local_id: str
    appointment_original_start_time: typing.Optional[typing.Optional[winsdk.windows.foundation.DateTime]]
    comment: str
...
class AppointmentCalendarProposeNewTimeForMeetingRequestEventArgs(_winrt.Object, interfaces=[]):
...
class AppointmentCalendarSyncManagerSyncRequest(_winrt.Object, interfaces=[]):
    appointment_calendar_local_id: str
    @staticmethod
...
class AppointmentCalendarSyncManagerSyncRequestEventArgs(_winrt.Object, interfaces=[]):
...
class AppointmentCalendarUpdateMeetingResponseRequest(_winrt.Object, interfaces=[]):
    appointment_calendar_local_id: str
    appointment_local_id: str
    appointment_original_start_time: typing.Optional[typing.Optional[winsdk.windows.foundation.DateTime]]
    comment: str
...
class AppointmentCalendarUpdateMeetingResponseRequestEventArgs(_winrt.Object, interfaces=[]):
...
class AppointmentDataProviderConnection(_winrt.Object, interfaces=[]):
    @staticmethod
...
class AppointmentDataProviderTriggerDetails(_winrt.Object, interfaces=[]):
