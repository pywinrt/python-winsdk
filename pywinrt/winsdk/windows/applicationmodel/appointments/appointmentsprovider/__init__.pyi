...
class AddAppointmentOperation(_winrt.Object, interfaces=[]):
...
class RemoveAppointmentOperation(_winrt.Object, interfaces=[]):
    appointment_id: str
...
class ReplaceAppointmentOperation(_winrt.Object, interfaces=[]):
    appointment_id: str
    appointment_information: typing.Optional[winsdk.windows.applicationmodel.appointments.Appointment]
    instance_start_date: typing.Optional[typing.Optional[winsdk.windows.foundation.DateTime]]
    source_package_family_name: str
