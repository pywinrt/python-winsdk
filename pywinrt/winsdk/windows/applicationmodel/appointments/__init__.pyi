...
class AppointmentCalendar(_winrt.Object):
    ...
    def delete_appointment_instance_async(self, local_id: str, instance_start_time: datetime.datetime) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    ...
    def try_propose_new_time_for_meeting_async(self, meeting: typing.Optional[Appointment], new_start_time: datetime.datetime, new_duration: datetime.timedelta, subject: str, comment: str) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]: ...
...
class AppointmentManager(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def show_appointment_details_async(appointment_id: str, instance_start_date: datetime.datetime) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def show_remove_appointment_async(appointment_id: str, selection: winsdk.windows.foundation.Rect, preferred_placement: winsdk.windows.ui.popups.Placement, instance_start_date: datetime.datetime) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]: ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def show_time_frame_async(time_to_show: datetime.datetime, duration: datetime.timedelta) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
...
class AppointmentManagerForUser(_winrt.Object):
    ...
    @typing.overload
    def show_appointment_details_async(self, appointment_id: str, instance_start_date: datetime.datetime) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    ...
    @typing.overload
    def show_remove_appointment_async(self, appointment_id: str, selection: winsdk.windows.foundation.Rect, preferred_placement: winsdk.windows.ui.popups.Placement, instance_start_date: datetime.datetime) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]: ...
    @typing.overload
    ...
    def show_time_frame_async(self, time_to_show: datetime.datetime, duration: datetime.timedelta) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
...
class AppointmentStore(_winrt.Object):
    ...
    @typing.overload
    def show_appointment_details_async(self, local_id: str, instance_start_date: datetime.datetime) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    def show_edit_new_appointment_async(self, appointment: typing.Optional[Appointment]) -> winsdk.windows.foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    @typing.overload
    def show_remove_appointment_async(self, local_id: str, selection: winsdk.windows.foundation.Rect, preferred_placement: winsdk.windows.ui.popups.Placement, instance_start_date: datetime.datetime) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]: ...
    @typing.overload
