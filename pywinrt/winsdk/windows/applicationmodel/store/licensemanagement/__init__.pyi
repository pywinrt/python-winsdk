...
class LicenseManager(_winrt.Object):
    ...
    @staticmethod
    def get_satisfaction_infos_async(content_ids: typing.Iterable[str], key_ids: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LicenseSatisfactionResult]]: ...
    @staticmethod
