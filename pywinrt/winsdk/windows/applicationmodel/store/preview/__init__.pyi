...
class StoreConfiguration(_winrt.Object):
    ...
    @staticmethod
    def filter_unsupported_system_features_async(system_features: typing.Iterable[StoreSystemFeature]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StoreSystemFeature]]]: ...
    @staticmethod
    ...
    @staticmethod
    def get_store_log_data_async(options: StoreLogOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IRandomAccessStreamReference]]: ...
    @staticmethod
...
class StorePreview(_winrt.Object):
    ...
    @staticmethod
    def load_add_on_product_infos_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StorePreviewProductInfo]]]: ...
    @staticmethod
    def request_product_purchase_by_product_id_and_sku_id_async(product_id: str, sku_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorePreviewPurchaseResults]]: ...
...
class WebAuthenticationCoreManagerHelper(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def request_token_with_u_i_element_hosting_async(request: typing.Optional[winsdk.windows.security.authentication.web.core.WebTokenRequest], ui_element: typing.Optional[winsdk.windows.ui.xaml.UIElement]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.authentication.web.core.WebTokenRequestResult]]: ...
    @typing.overload
    @staticmethod
    def request_token_with_u_i_element_hosting_async(request: typing.Optional[winsdk.windows.security.authentication.web.core.WebTokenRequest], web_account: typing.Optional[winsdk.windows.security.credentials.WebAccount], ui_element: typing.Optional[winsdk.windows.ui.xaml.UIElement]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.authentication.web.core.WebTokenRequestResult]]: ...
