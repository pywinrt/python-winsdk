...
class StoreConfiguration(_winrt.Object):
    ...
    purchase_prompting_policy: typing.Optional[_winrt.UInt32]
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def get_enterprise_store_web_account_id_for_user(user: winsdk.windows.system.User) -> str: ...
    @typing.overload
    @staticmethod
    def get_purchase_prompting_policy_for_user(user: winsdk.windows.system.User) -> typing.Optional[_winrt.UInt32]: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def get_store_web_account_id_for_user(user: winsdk.windows.system.User) -> str: ...
    @typing.overload
    @staticmethod
    def has_store_web_account() -> _winrt.Boolean: ...
    @typing.overload
    @staticmethod
    def has_store_web_account_for_user(user: winsdk.windows.system.User) -> _winrt.Boolean: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def is_store_web_account_id_for_user(user: winsdk.windows.system.User, web_account_id: str) -> _winrt.Boolean: ...
    @typing.overload
    @staticmethod
    def pin_to_desktop(app_package_family_name: str) -> None: ...
    @typing.overload
    @staticmethod
    def pin_to_desktop_for_user(user: winsdk.windows.system.User, app_package_family_name: str) -> None: ...
    @typing.overload
    @staticmethod
    def set_enterprise_store_web_account_id(web_account_id: str) -> None: ...
    @typing.overload
    @staticmethod
    def set_enterprise_store_web_account_id_for_user(user: winsdk.windows.system.User, web_account_id: str) -> None: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def set_purchase_prompting_policy_for_user(user: winsdk.windows.system.User, value: typing.Optional[_winrt.UInt32]) -> None: ...
    @typing.overload
    @staticmethod
    def set_store_web_account_id(web_account_id: str) -> None: ...
    @typing.overload
    @staticmethod
    def set_store_web_account_id_for_user(user: winsdk.windows.system.User, web_account_id: str) -> None: ...
    @typing.overload
    @staticmethod
    def set_system_configuration(catalog_hardware_manufacturer_id: str, catalog_store_content_modifier_id: str, system_configuration_expiration: winsdk.windows.foundation.DateTime, catalog_hardware_descriptor: str) -> None: ...
    @typing.overload
    @staticmethod
    def should_restrict_to_enterprise_store_only() -> _winrt.Boolean: ...
    @typing.overload
    @staticmethod
    def should_restrict_to_enterprise_store_only_for_user(user: winsdk.windows.system.User) -> _winrt.Boolean: ...
...
class StorePreviewProductInfo(_winrt.Object):
    ...
    product_id: str
    product_type: str
    sku_info_list: winsdk.windows.foundation.collections.IVectorView[StorePreviewSkuInfo]
    title: str
    @staticmethod
...
class WebAuthenticationCoreManagerHelper(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def request_token_with_u_i_element_hosting_async(request: winsdk.windows.security.authentication.web.core.WebTokenRequest, ui_element: winsdk.windows.ui.xaml.UIElement) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.authentication.web.core.WebTokenRequestResult]: ...
    @typing.overload
    @staticmethod
    def request_token_with_u_i_element_hosting_async(request: winsdk.windows.security.authentication.web.core.WebTokenRequest, web_account: winsdk.windows.security.credentials.WebAccount, ui_element: winsdk.windows.ui.xaml.UIElement) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.authentication.web.core.WebTokenRequestResult]: ...
