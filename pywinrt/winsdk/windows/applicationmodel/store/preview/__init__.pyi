...
class DeliveryOptimizationSettings(_winrt.Object, interfaces=[]):
...
class StoreHardwareManufacturerInfo(_winrt.Object, interfaces=[]):
...
class StorePreviewProductInfo(_winrt.Object, interfaces=[]):
    description: str
    product_id: str
    product_type: str
