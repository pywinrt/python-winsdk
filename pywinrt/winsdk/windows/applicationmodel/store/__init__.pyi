...
class CurrentApp(_winrt.Object):
    ...
    @staticmethod
    def get_app_purchase_campaign_id_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @staticmethod
    def get_app_receipt_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @staticmethod
    def get_customer_collections_id_async(service_ticket: str, publisher_user_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @staticmethod
    def get_customer_purchase_id_async(service_ticket: str, publisher_user_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @staticmethod
    def get_product_receipt_async(product_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @staticmethod
    def get_unfulfilled_consumables_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[UnfulfilledConsumable]]]: ...
    @staticmethod
    def load_listing_information_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ListingInformation]]: ...
    @staticmethod
    def load_listing_information_by_keywords_async(keywords: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ListingInformation]]: ...
    @staticmethod
    def load_listing_information_by_product_ids_async(product_ids: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ListingInformation]]: ...
    @staticmethod
    def report_consumable_fulfillment_async(product_id: str, transaction_id: uuid.UUID) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[FulfillmentResult]]: ...
    @staticmethod
    def report_product_fulfillment(product_id: str) -> None: ...
    @staticmethod
    def request_app_purchase_async(include_receipt: _winrt.Boolean) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @typing.overload
    @staticmethod
    def request_product_purchase_async(product_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PurchaseResults]]: ...
    @typing.overload
    @staticmethod
    def request_product_purchase_async(product_id: str, include_receipt: _winrt.Boolean) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @typing.overload
    @staticmethod
    def request_product_purchase_async(product_id: str, offer_id: str, display_properties: typing.Optional[ProductPurchaseDisplayProperties]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PurchaseResults]]: ...
