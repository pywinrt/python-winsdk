...
class LicenseInformation(_winrt.Object, interfaces=[]):
...
class ListingInformation(_winrt.Object, interfaces=[]):
...
class ProductLicense(_winrt.Object, interfaces=[]):
    expiration_date: winsdk.windows.foundation.DateTime
    is_active: _winrt.Boolean
    product_id: str
...
class ProductListing(_winrt.Object, interfaces=[]):
    formatted_price: str
    name: str
    product_id: str
    formatted_base_price: str
...
class ProductPurchaseDisplayProperties(_winrt.Object, interfaces=[]):
    name: str
...
class PurchaseResults(_winrt.Object, interfaces=[]):
    offer_id: str
    receipt_xml: str
...
class UnfulfilledConsumable(_winrt.Object, interfaces=[]):
    offer_id: str
    product_id: str
    transaction_id: uuid.UUID
    @staticmethod
