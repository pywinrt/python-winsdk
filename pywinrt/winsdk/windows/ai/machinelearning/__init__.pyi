...
class LearningModel(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def load_from_storage_file_async(model_file: typing.Optional[winsdk.windows.storage.IStorageFile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LearningModel]]: ...
    @typing.overload
    @staticmethod
    def load_from_storage_file_async(model_file: typing.Optional[winsdk.windows.storage.IStorageFile], operator_provider: typing.Optional[ILearningModelOperatorProvider]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LearningModel]]: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def load_from_stream_async(model_stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStreamReference]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LearningModel]]: ...
    @typing.overload
    @staticmethod
    def load_from_stream_async(model_stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStreamReference], operator_provider: typing.Optional[ILearningModelOperatorProvider]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LearningModel]]: ...
...
class LearningModelSession(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def evaluate_async(self, bindings: typing.Optional[LearningModelBinding], correlation_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LearningModelEvaluationResult]]: ...
    ...
    def evaluate_features_async(self, features: winsdk.windows.foundation.collections.IMap[str, _winrt.Object], correlation_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LearningModelEvaluationResult]]: ...
