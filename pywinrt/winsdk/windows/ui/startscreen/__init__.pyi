...
class JumpList(_winrt.Object, interfaces=[]):
...
class JumpListItem(_winrt.Object, interfaces=[]):
...
class SecondaryTile(_winrt.Object, interfaces=[]):
    short_name: str
    logo: typing.Optional[winsdk.windows.foundation.Uri]
    tile_id: str
...
class SecondaryTileVisualElements(_winrt.Object, interfaces=[]):
...
class StartScreenManager(_winrt.Object, interfaces=[]):
...
class TileMixedRealityModel(_winrt.Object, interfaces=[]):
...
class VisualElementsRequest(_winrt.Object, interfaces=[]):
...
class VisualElementsRequestDeferral(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> VisualElementsRequestDeferral: ...
    def complete(self) -> None: ...

class VisualElementsRequestedEventArgs(_winrt.Object, interfaces=[]):
