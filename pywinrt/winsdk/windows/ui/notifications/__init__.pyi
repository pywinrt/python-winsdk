...
class BadgeUpdater(_winrt.Object):
    ...
    def clear(self) -> None: ...
    @typing.overload
    def start_periodic_update(self, badge_content: winsdk.windows.foundation.Uri, requested_interval: PeriodicUpdateRecurrence) -> None: ...
    @typing.overload
    def start_periodic_update(self, badge_content: winsdk.windows.foundation.Uri, start_time: winsdk.windows.foundation.DateTime, requested_interval: PeriodicUpdateRecurrence) -> None: ...
    @typing.overload
...
class NotificationBinding(_winrt.Object):
    ...
    @typing.overload
    def get_text_elements(self) -> winsdk.windows.foundation.collections.IVectorView[AdaptiveNotificationText]: ...
...
class TileFlyoutUpdater(_winrt.Object):
    ...
    def clear(self) -> None: ...
    @typing.overload
    def start_periodic_update(self, tile_flyout_content: winsdk.windows.foundation.Uri, requested_interval: PeriodicUpdateRecurrence) -> None: ...
    @typing.overload
    def start_periodic_update(self, tile_flyout_content: winsdk.windows.foundation.Uri, start_time: winsdk.windows.foundation.DateTime, requested_interval: PeriodicUpdateRecurrence) -> None: ...
    @typing.overload
    def stop_periodic_update(self) -> None: ...
    @typing.overload
...
class TileUpdater(_winrt.Object):
    ...
    @typing.overload
    def get_scheduled_tile_notifications(self) -> winsdk.windows.foundation.collections.IVectorView[ScheduledTileNotification]: ...
    @typing.overload
    def remove_from_schedule(self, scheduled_tile: ScheduledTileNotification) -> None: ...
    @typing.overload
    def start_periodic_update(self, tile_content: winsdk.windows.foundation.Uri, requested_interval: PeriodicUpdateRecurrence) -> None: ...
    @typing.overload
    def start_periodic_update(self, tile_content: winsdk.windows.foundation.Uri, start_time: winsdk.windows.foundation.DateTime, requested_interval: PeriodicUpdateRecurrence) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def start_periodic_update_batch(self, tile_contents: typing.Iterable[winsdk.windows.foundation.Uri], start_time: winsdk.windows.foundation.DateTime, requested_interval: PeriodicUpdateRecurrence) -> None: ...
    @typing.overload
    def stop_periodic_update(self) -> None: ...
    @typing.overload
...
class ToastCollectionManager(_winrt.Object):
    ...
    @typing.overload
    def save_toast_collection_async(self, collection: ToastCollection) -> winsdk.windows.foundation.IAsyncAction: ...
...
class ToastNotificationHistory(_winrt.Object):
    ...
    @typing.overload
    def get_history(self) -> winsdk.windows.foundation.collections.IVectorView[ToastNotification]: ...
    @typing.overload
    def get_history(self, application_id: str) -> winsdk.windows.foundation.collections.IVectorView[ToastNotification]: ...
    @typing.overload
...
class ToastNotifier(_winrt.Object):
    ...
    @typing.overload
    def get_scheduled_toast_notifications(self) -> winsdk.windows.foundation.collections.IVectorView[ScheduledToastNotification]: ...
    @typing.overload
