...
class AdaptiveNotificationText(_winrt.Object, interfaces=[IAdaptiveNotificationContent]):
...
class BadgeNotification(_winrt.Object, interfaces=[]):
    expiration_time: typing.Optional[typing.Optional[winsdk.windows.foundation.DateTime]]
    content: typing.Optional[winsdk.windows.data.xml.dom.XmlDocument]
    @staticmethod
    def _from(obj: _winrt.Object) -> BadgeNotification: ...
    def __init__(self, content: typing.Optional[winsdk.windows.data.xml.dom.XmlDocument]) -> None: ...
...
class BadgeUpdateManagerForUser(_winrt.Object, interfaces=[]):
...
class BadgeUpdater(_winrt.Object, interfaces=[]):
    @staticmethod
    ...
    @typing.overload
    def start_periodic_update(self, badge_content: typing.Optional[winsdk.windows.foundation.Uri], start_time: winsdk.windows.foundation.DateTime, requested_interval: PeriodicUpdateRecurrence) -> None: ...
...
class Notification(_winrt.Object, interfaces=[]):
...
class NotificationBinding(_winrt.Object, interfaces=[]):
    template: str
    language: str
    hints: typing.Optional[winsdk.windows.foundation.collections.IMap[str, str]]
    @staticmethod
...
class NotificationData(_winrt.Object, interfaces=[]):
    ...
    @typing.overload
    def __init__(self, initial_values: typing.Iterable[typing.Optional[winsdk.windows.foundation.collections.IKeyValuePair[str, str]]], sequence_number: _winrt.UInt32) -> None: ...
    @typing.overload
    def __init__(self, initial_values: typing.Iterable[typing.Optional[winsdk.windows.foundation.collections.IKeyValuePair[str, str]]]) -> None: ...
    @typing.overload
    def __init__(self) -> None: ...

class NotificationVisual(_winrt.Object, interfaces=[]):
    language: str
...
class ScheduledTileNotification(_winrt.Object, interfaces=[]):
    tag: str
    id: str
    expiration_time: typing.Optional[typing.Optional[winsdk.windows.foundation.DateTime]]
    content: typing.Optional[winsdk.windows.data.xml.dom.XmlDocument]
    ...
    def __init__(self, content: typing.Optional[winsdk.windows.data.xml.dom.XmlDocument], delivery_time: winsdk.windows.foundation.DateTime) -> None: ...

class ScheduledToastNotification(_winrt.Object, interfaces=[]):
    id: str
    content: typing.Optional[winsdk.windows.data.xml.dom.XmlDocument]
    delivery_time: winsdk.windows.foundation.DateTime
    maximum_snooze_count: _winrt.UInt32
    snooze_interval: typing.Optional[typing.Optional[winsdk.windows.foundation.TimeSpan]]
    tag: str
    ...
    def __init__(self, content: typing.Optional[winsdk.windows.data.xml.dom.XmlDocument], delivery_time: winsdk.windows.foundation.DateTime) -> None: ...
    @typing.overload
    def __init__(self, content: typing.Optional[winsdk.windows.data.xml.dom.XmlDocument], delivery_time: winsdk.windows.foundation.DateTime, snooze_interval: winsdk.windows.foundation.TimeSpan, maximum_snooze_count: _winrt.UInt32) -> None: ...

class ScheduledToastNotificationShowingEventArgs(_winrt.Object, interfaces=[]):
...
class ShownTileNotification(_winrt.Object, interfaces=[]):
    arguments: str
    @staticmethod
    def _from(obj: _winrt.Object) -> ShownTileNotification: ...

class TileFlyoutNotification(_winrt.Object, interfaces=[]):
    expiration_time: typing.Optional[typing.Optional[winsdk.windows.foundation.DateTime]]
    content: typing.Optional[winsdk.windows.data.xml.dom.XmlDocument]
    @staticmethod
...
class TileFlyoutUpdater(_winrt.Object, interfaces=[]):
    ...
    @typing.overload
    def start_periodic_update(self, tile_flyout_content: typing.Optional[winsdk.windows.foundation.Uri], start_time: winsdk.windows.foundation.DateTime, requested_interval: PeriodicUpdateRecurrence) -> None: ...
    def stop_periodic_update(self) -> None: ...
    def update(self, notification: typing.Optional[TileFlyoutNotification]) -> None: ...

class TileNotification(_winrt.Object, interfaces=[]):
    tag: str
    expiration_time: typing.Optional[typing.Optional[winsdk.windows.foundation.DateTime]]
    content: typing.Optional[winsdk.windows.data.xml.dom.XmlDocument]
    @staticmethod
...
class TileUpdateManagerForUser(_winrt.Object, interfaces=[]):
    user: typing.Optional[winsdk.windows.system.User]
    @staticmethod
...
class TileUpdater(_winrt.Object, interfaces=[]):
    setting: NotificationSetting
    @staticmethod
    ...
    @typing.overload
    def start_periodic_update(self, tile_content: typing.Optional[winsdk.windows.foundation.Uri], start_time: winsdk.windows.foundation.DateTime, requested_interval: PeriodicUpdateRecurrence) -> None: ...
    @typing.overload
    def start_periodic_update_batch(self, tile_contents: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], requested_interval: PeriodicUpdateRecurrence) -> None: ...
    @typing.overload
    def start_periodic_update_batch(self, tile_contents: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], start_time: winsdk.windows.foundation.DateTime, requested_interval: PeriodicUpdateRecurrence) -> None: ...
    def stop_periodic_update(self) -> None: ...
    def update(self, notification: typing.Optional[TileNotification]) -> None: ...

class ToastActivatedEventArgs(_winrt.Object, interfaces=[]):
    arguments: str
...
class ToastCollection(_winrt.Object, interfaces=[]):
    launch_args: str
    ...
    def __init__(self, collection_id: str, display_name: str, launch_args: str, icon_uri: typing.Optional[winsdk.windows.foundation.Uri]) -> None: ...

class ToastCollectionManager(_winrt.Object, interfaces=[]):
    app_id: str
    user: typing.Optional[winsdk.windows.system.User]
    @staticmethod
...
class ToastNotificationActionTriggerDetail(_winrt.Object, interfaces=[]):
    argument: str
    user_input: typing.Optional[winsdk.windows.foundation.collections.ValueSet]
    @staticmethod
    def _from(obj: _winrt.Object) -> ToastNotificationActionTriggerDetail: ...

class ToastNotificationHistory(_winrt.Object, interfaces=[]):
    @staticmethod
...
class ToastNotificationHistoryChangedTriggerDetail(_winrt.Object, interfaces=[]):
...
class ToastNotificationManagerForUser(_winrt.Object, interfaces=[]):
    history: typing.Optional[ToastNotificationHistory]
    user: typing.Optional[winsdk.windows.system.User]
    @staticmethod
...
class ToastNotifier(_winrt.Object, interfaces=[]):
    setting: NotificationSetting
    @staticmethod
...
class UserNotification(_winrt.Object, interfaces=[]):
...
class UserNotificationChangedEventArgs(_winrt.Object, interfaces=[]):
...
class IAdaptiveNotificationContent(typing.Protocol):
    hints: typing.Optional[winsdk.windows.foundation.collections.IMap[str, str]]
    kind: AdaptiveNotificationContentKind
    @staticmethod
