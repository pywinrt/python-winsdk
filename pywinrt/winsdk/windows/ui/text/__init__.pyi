...
class ContentLinkInfo(_winrt.Object, interfaces=[]):
...
class FontWeights(_winrt.Object, interfaces=[]):
    black: FontWeight
    bold: FontWeight
...
class RichEditTextDocument(_winrt.Object, interfaces=[ITextDocument]):
...
class RichEditTextRange(_winrt.Object, interfaces=[ITextRange]):
...
class ITextCharacterFormat(typing.Protocol):
...
class ITextDocument(typing.Protocol):
    caret_type: CaretType
    default_tab_stop: _winrt.Single
    selection: typing.Optional[ITextSelection]
    undo_limit: _winrt.UInt32
...
class ITextParagraphFormat(typing.Protocol):
...
class ITextRange(typing.Protocol):
    character: _winrt.Char16
    character_format: typing.Optional[ITextCharacterFormat]
    end_position: _winrt.Int32
    formatted_text: typing.Optional[ITextRange]
