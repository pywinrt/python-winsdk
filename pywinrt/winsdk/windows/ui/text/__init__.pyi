...
class RichEditTextDocument(ITextDocument, _winrt.Object):
    ...
    @typing.overload
    def get_range(self, start_position: _winrt.Int32, end_position: _winrt.Int32) -> ITextRange: ...
    @typing.overload
    def get_range_from_point(self, point: winsdk.windows.foundation.Point, options: PointOptions) -> ITextRange: ...
    @typing.overload
    def get_text(self, options: TextGetOptions) -> str: ...
    @typing.overload
    def load_from_stream(self, options: TextSetOptions, value: winsdk.windows.storage.streams.IRandomAccessStream) -> None: ...
    @typing.overload
    def redo(self) -> None: ...
    @typing.overload
    def save_to_stream(self, options: TextGetOptions, value: winsdk.windows.storage.streams.IRandomAccessStream) -> None: ...
    @typing.overload
...
class RichEditTextRange(ITextRange, _winrt.Object):
    ...
    def get_text(self, options: TextGetOptions) -> str: ...
    @typing.overload
    def get_text_via_stream(self, options: TextGetOptions, value: winsdk.windows.storage.streams.IRandomAccessStream) -> None: ...
    @typing.overload
    def in_range(self, range: ITextRange) -> _winrt.Boolean: ...
    @typing.overload
    def in_story(self, range: ITextRange) -> _winrt.Boolean: ...
    @typing.overload
    def insert_image(self, width: _winrt.Int32, height: _winrt.Int32, ascent: _winrt.Int32, vertical_align: VerticalCharacterAlignment, alternate_text: str, value: winsdk.windows.storage.streams.IRandomAccessStream) -> None: ...
    @typing.overload
    def is_equal(self, range: ITextRange) -> _winrt.Boolean: ...
    @typing.overload
    ...
    def set_text(self, options: TextSetOptions, value: str) -> None: ...
    @typing.overload
    def set_text_via_stream(self, options: TextSetOptions, value: winsdk.windows.storage.streams.IRandomAccessStream) -> None: ...
    @typing.overload
...
class ITextCharacterFormat(_winrt.Object):
    ...
    @typing.overload
    def is_equal(self, format: ITextCharacterFormat) -> _winrt.Boolean: ...
    @typing.overload
...
class ITextParagraphFormat(_winrt.Object):
    ...
    @typing.overload
    def is_equal(self, format: ITextParagraphFormat) -> _winrt.Boolean: ...
    @typing.overload
