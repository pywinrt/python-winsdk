...
class InkAnalysisInkBullet(_winrt.Object, interfaces=[IInkAnalysisNode]):
    recognized_text: str
...
class InkAnalysisInkDrawing(_winrt.Object, interfaces=[IInkAnalysisNode]):
...
class InkAnalysisInkWord(_winrt.Object, interfaces=[IInkAnalysisNode]):
    recognized_text: str
...
class InkAnalysisLine(_winrt.Object, interfaces=[IInkAnalysisNode]):
...
class InkAnalysisListItem(_winrt.Object, interfaces=[IInkAnalysisNode]):
    recognized_text: str
    bounding_rect: winsdk.windows.foundation.Rect
    children: typing.Optional[winsdk.windows.foundation.collections.IVectorView[IInkAnalysisNode]]
    id: _winrt.UInt32
...
class InkAnalysisNode(_winrt.Object, interfaces=[IInkAnalysisNode]):
    bounding_rect: winsdk.windows.foundation.Rect
    children: typing.Optional[winsdk.windows.foundation.collections.IVectorView[IInkAnalysisNode]]
    id: _winrt.UInt32
    kind: InkAnalysisNodeKind
...
class InkAnalysisParagraph(_winrt.Object, interfaces=[IInkAnalysisNode]):
    bounding_rect: winsdk.windows.foundation.Rect
    children: typing.Optional[winsdk.windows.foundation.collections.IVectorView[IInkAnalysisNode]]
    id: _winrt.UInt32
    kind: InkAnalysisNodeKind
...
class InkAnalysisResult(_winrt.Object, interfaces=[]):
    status: InkAnalysisStatus
    @staticmethod
    def _from(obj: _winrt.Object) -> InkAnalysisResult: ...

class InkAnalysisRoot(_winrt.Object, interfaces=[IInkAnalysisNode]):
    bounding_rect: winsdk.windows.foundation.Rect
    children: typing.Optional[winsdk.windows.foundation.collections.IVectorView[IInkAnalysisNode]]
    id: _winrt.UInt32
    kind: InkAnalysisNodeKind
...
class InkAnalysisWritingRegion(_winrt.Object, interfaces=[IInkAnalysisNode]):
    bounding_rect: winsdk.windows.foundation.Rect
    children: typing.Optional[winsdk.windows.foundation.collections.IVectorView[IInkAnalysisNode]]
    id: _winrt.UInt32
    kind: InkAnalysisNodeKind
...
class InkAnalyzer(_winrt.Object, interfaces=[]):
    ...
    def add_data_for_strokes(self, strokes: typing.Iterable[typing.Optional[winsdk.windows.ui.input.inking.InkStroke]]) -> None: ...
...
class IInkAnalysisNode(typing.Protocol):
    bounding_rect: winsdk.windows.foundation.Rect
    children: typing.Optional[winsdk.windows.foundation.collections.IVectorView[IInkAnalysisNode]]
    id: _winrt.UInt32
    kind: InkAnalysisNodeKind
...
class IInkAnalyzerFactory(typing.Protocol):
    @staticmethod
