...
class InkManager(IInkRecognizerContainer, IInkStrokeContainer, _winrt.Object):
    ...
    def load_async(self, input_stream: typing.Optional[winsdk.windows.storage.streams.IInputStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncActionWithProgress[_winrt.UInt64]]: ...
    ...
    @typing.overload
    def recognize_async(self, recognition_target: InkRecognitionTarget) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[InkRecognitionResult]]]: ...
    @typing.overload
    def recognize_async(self, stroke_collection: typing.Optional[InkStrokeContainer], recognition_target: InkRecognitionTarget) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[InkRecognitionResult]]]: ...
    def save_async(self, output_stream: typing.Optional[winsdk.windows.storage.streams.IOutputStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.UInt32, _winrt.UInt32]]: ...
...
class InkStrokeContainer(IInkStrokeContainer, _winrt.Object):
    ...
    def save_async(self, output_stream: typing.Optional[winsdk.windows.storage.streams.IOutputStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.UInt32, _winrt.UInt32]]: ...
    @typing.overload
    def save_async(self, output_stream: typing.Optional[winsdk.windows.storage.streams.IOutputStream], ink_persistence_format: InkPersistenceFormat) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.UInt32, _winrt.UInt32]]: ...
    def select_with_line(self, from_: winsdk.windows.foundation.Point, to: winsdk.windows.foundation.Point) -> winsdk.windows.foundation.Rect: ...
    def select_with_poly_line(self, polyline: typing.Iterable[winsdk.windows.foundation.Point]) -> winsdk.windows.foundation.Rect: ...
    def update_recognition_results(self, recognition_results: winsdk.windows.foundation.collections.IVectorView[InkRecognitionResult]) -> None: ...
