...
class InkDrawingAttributes(_winrt.Object, interfaces=[]):
...
class InkDrawingAttributesPencilProperties(_winrt.Object, interfaces=[]):
    opacity: _winrt.Double
    @staticmethod
    def _from(obj: _winrt.Object) -> InkDrawingAttributesPencilProperties: ...

class InkInputConfiguration(_winrt.Object, interfaces=[]):
...
class InkInputProcessingConfiguration(_winrt.Object, interfaces=[]):
...
class InkManager(_winrt.Object, interfaces=[IInkRecognizerContainer, IInkStrokeContainer]):
...
class InkModelerAttributes(_winrt.Object, interfaces=[]):
...
class InkPoint(_winrt.Object, interfaces=[]):
...
class InkPresenter(_winrt.Object, interfaces=[]):
...
class InkPresenterProtractor(_winrt.Object, interfaces=[IInkPresenterStencil]):
...
class InkPresenterRuler(_winrt.Object, interfaces=[IInkPresenterStencil]):
    width: _winrt.Double
...
class InkRecognitionResult(_winrt.Object, interfaces=[]):
    bounding_rect: winsdk.windows.foundation.Rect
    @staticmethod
...
class InkRecognizer(_winrt.Object, interfaces=[]):
    name: str
    @staticmethod
    def _from(obj: _winrt.Object) -> InkRecognizer: ...

class InkRecognizerContainer(_winrt.Object, interfaces=[IInkRecognizerContainer]):
    @staticmethod
...
class InkStroke(_winrt.Object, interfaces=[]):
...
class InkStrokeBuilder(_winrt.Object, interfaces=[]):
    @staticmethod
    ...
    @typing.overload
    def create_stroke_from_ink_points(self, ink_points: typing.Iterable[typing.Optional[InkPoint]], transform: winsdk.windows.foundation.numerics.Matrix3x2) -> typing.Optional[InkStroke]: ...
    @typing.overload
    def create_stroke_from_ink_points(self, ink_points: typing.Iterable[typing.Optional[InkPoint]], transform: winsdk.windows.foundation.numerics.Matrix3x2, stroke_started_time: typing.Optional[winsdk.windows.foundation.DateTime], stroke_duration: typing.Optional[winsdk.windows.foundation.TimeSpan]) -> typing.Optional[InkStroke]: ...
    def end_stroke(self, pointer_point: typing.Optional[winsdk.windows.ui.input.PointerPoint]) -> typing.Optional[InkStroke]: ...
    def set_default_drawing_attributes(self, drawing_attributes: typing.Optional[InkDrawingAttributes]) -> None: ...

class InkStrokeContainer(_winrt.Object, interfaces=[IInkStrokeContainer]):
    bounding_rect: winsdk.windows.foundation.Rect
    @staticmethod
    def _from(obj: _winrt.Object) -> InkStrokeContainer: ...
    def __init__(self) -> None: ...
    def add_stroke(self, stroke: typing.Optional[InkStroke]) -> None: ...
    def add_strokes(self, strokes: typing.Iterable[typing.Optional[InkStroke]]) -> None: ...
    def can_paste_from_clipboard(self) -> _winrt.Boolean: ...
    def clear(self) -> None: ...
    def copy_selected_to_clipboard(self) -> None: ...
    def delete_selected(self) -> winsdk.windows.foundation.Rect: ...
...
class InkStrokeInput(_winrt.Object, interfaces=[]):
...
class InkStrokeRenderingSegment(_winrt.Object, interfaces=[]):
...
class InkStrokesCollectedEventArgs(_winrt.Object, interfaces=[]):
...
class InkStrokesErasedEventArgs(_winrt.Object, interfaces=[]):
    strokes: typing.Optional[winsdk.windows.foundation.collections.IVectorView[InkStroke]]
    @staticmethod
    def _from(obj: _winrt.Object) -> InkStrokesErasedEventArgs: ...

class InkSynchronizer(_winrt.Object, interfaces=[]):
    @staticmethod
...
class InkUnprocessedInput(_winrt.Object, interfaces=[]):
    ink_presenter: typing.Optional[InkPresenter]
    @staticmethod
...
class PenAndInkSettings(_winrt.Object, interfaces=[]):
...
class IInkPointFactory(typing.Protocol):
    @staticmethod
...
class IInkPresenterRulerFactory(typing.Protocol):
    @staticmethod
...
class IInkPresenterStencil(typing.Protocol):
    background_color: winsdk.windows.ui.Color
    foreground_color: winsdk.windows.ui.Color
    is_visible: _winrt.Boolean
    kind: InkPresenterStencilKind
...
class IInkRecognizerContainer(typing.Protocol):
    @staticmethod
...
class IInkStrokeContainer(typing.Protocol):
    bounding_rect: winsdk.windows.foundation.Rect
    @staticmethod
