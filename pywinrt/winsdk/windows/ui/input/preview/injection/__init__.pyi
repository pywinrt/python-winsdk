...
class InjectedInputPoint:
    ...
    def __new__(cls: typing.Type[InjectedInputPoint], position_x: _winrt.Int32, position_y: _winrt.Int32) -> InjectedInputPoint: ...
...
class InjectedInputPointerInfo:
    ...
    def __new__(cls: typing.Type[InjectedInputPointerInfo], pointer_id: _winrt.UInt32, pointer_options: InjectedInputPointerOptions, pixel_location: InjectedInputPoint, time_offset_in_milliseconds: _winrt.UInt32, performance_count: _winrt.UInt64) -> InjectedInputPointerInfo: ...
...
class InjectedInputRectangle:
    ...
    bottom: _winrt.Int32
    right: _winrt.Int32
    def __new__(cls: typing.Type[InjectedInputRectangle], left: _winrt.Int32, top: _winrt.Int32, bottom: _winrt.Int32, right: _winrt.Int32) -> InjectedInputRectangle: ...
