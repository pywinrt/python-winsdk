...
class InjectedInputPoint:
    position_x: _winrt.Int32
    position_y: _winrt.Int32
    def __init__(self, position_x: _winrt.Int32, position_y: _winrt.Int32) -> None: ...
...
class InjectedInputPointerInfo:
    ...
    time_offset_in_milliseconds: _winrt.UInt32
    performance_count: _winrt.UInt64
    def __init__(self, pointer_id: _winrt.UInt32, pointer_options: InjectedInputPointerOptions, pixel_location: InjectedInputPoint, time_offset_in_milliseconds: _winrt.UInt32, performance_count: _winrt.UInt64) -> None: ...
...
class InjectedInputRectangle:
    ...
    bottom: _winrt.Int32
    right: _winrt.Int32
    def __init__(self, left: _winrt.Int32, top: _winrt.Int32, bottom: _winrt.Int32, right: _winrt.Int32) -> None: ...

class InjectedInputGamepadInfo(_winrt.Object, interfaces=[]):
    ...
    @staticmethod
    def _from(obj: _winrt.Object) -> InjectedInputGamepadInfo: ...
    @typing.overload
    def __init__(self, reading: winsdk.windows.gaming.input.GamepadReading) -> None: ...
    @typing.overload
    def __init__(self) -> None: ...

class InjectedInputKeyboardInfo(_winrt.Object, interfaces=[]):
    virtual_key: _winrt.UInt16
    scan_code: _winrt.UInt16
    key_options: InjectedInputKeyOptions
    @staticmethod
    def _from(obj: _winrt.Object) -> InjectedInputKeyboardInfo: ...
    def __init__(self) -> None: ...

class InjectedInputMouseInfo(_winrt.Object, interfaces=[]):
    time_offset_in_milliseconds: _winrt.UInt32
    mouse_options: InjectedInputMouseOptions
    mouse_data: _winrt.UInt32
    delta_y: _winrt.Int32
    delta_x: _winrt.Int32
    @staticmethod
    def _from(obj: _winrt.Object) -> InjectedInputMouseInfo: ...
    def __init__(self) -> None: ...

class InjectedInputPenInfo(_winrt.Object, interfaces=[]):
    tilt_y: _winrt.Int32
    tilt_x: _winrt.Int32
    rotation: _winrt.Double
    pressure: _winrt.Double
    pointer_info: InjectedInputPointerInfo
    pen_parameters: InjectedInputPenParameters
    pen_buttons: InjectedInputPenButtons
    @staticmethod
    def _from(obj: _winrt.Object) -> InjectedInputPenInfo: ...
    def __init__(self) -> None: ...

class InjectedInputTouchInfo(_winrt.Object, interfaces=[]):
    touch_parameters: InjectedInputTouchParameters
    pressure: _winrt.Double
    pointer_info: InjectedInputPointerInfo
    orientation: _winrt.Int32
    contact: InjectedInputRectangle
    @staticmethod
    def _from(obj: _winrt.Object) -> InjectedInputTouchInfo: ...
    def __init__(self) -> None: ...

class InputInjector(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> InputInjector: ...
    ...
    def inject_keyboard_input(self, input: typing.Iterable[typing.Optional[InjectedInputKeyboardInfo]]) -> None: ...
    def inject_mouse_input(self, input: typing.Iterable[typing.Optional[InjectedInputMouseInfo]]) -> None: ...
    ...
    def inject_touch_input(self, input: typing.Iterable[typing.Optional[InjectedInputTouchInfo]]) -> None: ...
    @staticmethod
