...
class CrossSlideThresholds:
    ...
    def __new__(cls: typing.Type[CrossSlideThresholds], selection_start: _winrt.Single, speed_bump_start: _winrt.Single, speed_bump_end: _winrt.Single, rearrange_start: _winrt.Single) -> CrossSlideThresholds: ...
...
class ManipulationDelta:
    ...
    def __new__(cls: typing.Type[ManipulationDelta], translation: winsdk.windows.foundation.Point, scale: _winrt.Single, rotation: _winrt.Single, expansion: _winrt.Single) -> ManipulationDelta: ...

class ManipulationVelocities:
    linear: winsdk.windows.foundation.Point
    angular: _winrt.Single
    expansion: _winrt.Single
    def __new__(cls: typing.Type[ManipulationVelocities], linear: winsdk.windows.foundation.Point, angular: _winrt.Single, expansion: _winrt.Single) -> ManipulationVelocities: ...
