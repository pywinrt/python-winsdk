...
class CoreAppWindowPreview(_winrt.Object, interfaces=[]):
    @staticmethod
...
class SystemNavigationCloseRequestedPreviewEventArgs(_winrt.Object, interfaces=[]):
    handled: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> SystemNavigationCloseRequestedPreviewEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class SystemNavigationManagerPreview(_winrt.Object, interfaces=[]):
    @staticmethod
