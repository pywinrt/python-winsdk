...
class CorePhysicalKeyStatus:
    ...
    def __new__(cls: typing.Type[CorePhysicalKeyStatus], repeat_count: _winrt.UInt32, scan_code: _winrt.UInt32, is_extended_key: _winrt.Boolean, is_menu_key_down: _winrt.Boolean, was_key_down: _winrt.Boolean, is_key_released: _winrt.Boolean) -> CorePhysicalKeyStatus: ...

class CoreProximityEvaluation:
    score: _winrt.Int32
    adjusted_point: winsdk.windows.foundation.Point
    def __new__(cls: typing.Type[CoreProximityEvaluation], score: _winrt.Int32, adjusted_point: winsdk.windows.foundation.Point) -> CoreProximityEvaluation: ...
...
class CoreCursor(_winrt.Object):
    ...
    def __new__(cls: typing.Type[CoreCursor], type: CoreCursorType, id: _winrt.UInt32) -> CoreCursor:...
