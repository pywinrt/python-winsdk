...
class AcceleratorKeyEventArgs(_winrt.Object, interfaces=[ICoreWindowEventArgs]):
...
class AutomationProviderRequestedEventArgs(_winrt.Object, interfaces=[ICoreWindowEventArgs]):
    automation_provider: typing.Optional[_winrt.Object]
    handled: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> AutomationProviderRequestedEventArgs: ...

class BackRequestedEventArgs(_winrt.Object, interfaces=[]):
    handled: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> BackRequestedEventArgs: ...

class CharacterReceivedEventArgs(_winrt.Object, interfaces=[ICoreWindowEventArgs]):
...
class ClosestInteractiveBoundsRequestedEventArgs(_winrt.Object, interfaces=[]):
...
class CoreAcceleratorKeys(_winrt.Object, interfaces=[ICoreAcceleratorKeys]):
    @staticmethod
...
class CoreComponentInputSource(_winrt.Object, interfaces=[ICoreInputSourceBase, ICorePointerInputSource, ICorePointerInputSource2]):
...
class CoreCursor(_winrt.Object, interfaces=[]):
    id: _winrt.UInt32
    type: CoreCursorType
    @staticmethod
...
class CoreDispatcher(_winrt.Object, interfaces=[ICoreAcceleratorKeys]):
...
class CoreIndependentInputSource(_winrt.Object, interfaces=[ICoreInputSourceBase, ICorePointerInputSource, ICorePointerInputSource2, ICorePointerRedirector]):
    is_input_enabled: _winrt.Boolean
    dispatcher: typing.Optional[CoreDispatcher]
    pointer_cursor: typing.Optional[CoreCursor]
    has_capture: _winrt.Boolean
...
class CoreIndependentInputSourceController(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class CoreWindow(_winrt.Object, interfaces=[ICoreWindow, ICorePointerRedirector]):
    pointer_position: winsdk.windows.foundation.Point
    pointer_cursor: typing.Optional[CoreCursor]
...
class CoreWindowEventArgs(_winrt.Object, interfaces=[ICoreWindowEventArgs]):
    handled: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> CoreWindowEventArgs: ...

class CoreWindowResizeManager(_winrt.Object, interfaces=[]):
...
class IdleDispatchedHandlerArgs(_winrt.Object, interfaces=[]):
    is_dispatcher_idle: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> IdleDispatchedHandlerArgs: ...

class InputEnabledEventArgs(_winrt.Object, interfaces=[ICoreWindowEventArgs]):
    handled: _winrt.Boolean
    input_enabled: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> InputEnabledEventArgs: ...

class KeyEventArgs(_winrt.Object, interfaces=[ICoreWindowEventArgs]):
    handled: _winrt.Boolean
    key_status: CorePhysicalKeyStatus
    virtual_key: winsdk.windows.system.VirtualKey
    device_id: str
...
class PointerEventArgs(_winrt.Object, interfaces=[ICoreWindowEventArgs]):
    handled: _winrt.Boolean
...
class SystemNavigationManager(_winrt.Object, interfaces=[]):
...
class TouchHitTestingEventArgs(_winrt.Object, interfaces=[ICoreWindowEventArgs]):
    handled: _winrt.Boolean
...
class VisibilityChangedEventArgs(_winrt.Object, interfaces=[ICoreWindowEventArgs]):
    handled: _winrt.Boolean
    visible: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> VisibilityChangedEventArgs: ...

class WindowActivatedEventArgs(_winrt.Object, interfaces=[ICoreWindowEventArgs]):
    handled: _winrt.Boolean
    window_activation_state: CoreWindowActivationState
    @staticmethod
    def _from(obj: _winrt.Object) -> WindowActivatedEventArgs: ...

class WindowSizeChangedEventArgs(_winrt.Object, interfaces=[ICoreWindowEventArgs]):
    handled: _winrt.Boolean
    size: winsdk.windows.foundation.Size
    @staticmethod
    def _from(obj: _winrt.Object) -> WindowSizeChangedEventArgs: ...

class ICoreAcceleratorKeys(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> ICoreAcceleratorKeys: ...
    def add_accelerator_key_activated(self, handler: winsdk.windows.foundation.TypedEventHandler[CoreDispatcher, AcceleratorKeyEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken: ...
    def remove_accelerator_key_activated(self, cookie: winsdk.windows.foundation.EventRegistrationToken) -> None: ...

class ICoreInputSourceBase(typing.Protocol):
    dispatcher: typing.Optional[CoreDispatcher]
    is_input_enabled: _winrt.Boolean
    @staticmethod
...
class ICorePointerInputSource(typing.Protocol):
    has_capture: _winrt.Boolean
    pointer_cursor: typing.Optional[CoreCursor]
    pointer_position: winsdk.windows.foundation.Point
    @staticmethod
...
class ICorePointerInputSource2(typing.Protocol):
    dispatcher_queue: typing.Optional[winsdk.windows.system.DispatcherQueue]
    has_capture: _winrt.Boolean
    pointer_cursor: typing.Optional[CoreCursor]
    pointer_position: winsdk.windows.foundation.Point
...
class ICorePointerRedirector(typing.Protocol):
    @staticmethod
...
class ICoreWindow(typing.Protocol):
    automation_host_provider: typing.Optional[_winrt.Object]
    bounds: winsdk.windows.foundation.Rect
    custom_properties: typing.Optional[winsdk.windows.foundation.collections.IPropertySet]
    dispatcher: typing.Optional[CoreDispatcher]
...
class ICoreWindowEventArgs(typing.Protocol):
    handled: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> ICoreWindowEventArgs: ...

class IInitializeWithCoreWindow(typing.Protocol):
    @staticmethod
