...
class ApplicationView(_winrt.Object):
    ...
    def try_consolidate_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_enter_full_screen_mode(self) -> _winrt.Boolean: ...
    @typing.overload
    def try_enter_view_mode_async(self, view_mode: ApplicationViewMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_enter_view_mode_async(self, view_mode: ApplicationViewMode, view_mode_preferences: typing.Optional[ViewModePreferences]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class ApplicationViewSwitcher(_winrt.Object):
    ...
    @staticmethod
    def prepare_for_custom_animated_switch_async(to_view_id: _winrt.Int32, from_view_id: _winrt.Int32, options: ApplicationViewSwitchingOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def try_show_as_standalone_async(view_id: _winrt.Int32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    @staticmethod
    def try_show_as_standalone_async(view_id: _winrt.Int32, size_preference: ViewSizePreference) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    @staticmethod
    def try_show_as_standalone_async(view_id: _winrt.Int32, size_preference: ViewSizePreference, anchor_view_id: _winrt.Int32, anchor_size_preference: ViewSizePreference) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    @staticmethod
    def try_show_as_view_mode_async(view_id: _winrt.Int32, view_mode: ApplicationViewMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    @staticmethod
    def try_show_as_view_mode_async(view_id: _winrt.Int32, view_mode: ApplicationViewMode, view_mode_preferences: typing.Optional[ViewModePreferences]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class ProjectionManager(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def request_start_projecting_async(projection_view_id: _winrt.Int32, anchor_view_id: _winrt.Int32, selection: winsdk.windows.foundation.Rect) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    @staticmethod
    def request_start_projecting_async(projection_view_id: _winrt.Int32, anchor_view_id: _winrt.Int32, selection: winsdk.windows.foundation.Rect, preffered_placement: winsdk.windows.ui.popups.Placement) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    @staticmethod
