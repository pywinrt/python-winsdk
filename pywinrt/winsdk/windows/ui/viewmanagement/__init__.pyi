...
class AccessibilitySettings(_winrt.Object, interfaces=[]):
...
class ActivationViewSwitcher(_winrt.Object, interfaces=[]):
    @staticmethod
...
class ApplicationView(_winrt.Object, interfaces=[]):
    title: str
...
class ApplicationViewConsolidatedEventArgs(_winrt.Object, interfaces=[]):
...
class ApplicationViewScaling(_winrt.Object, interfaces=[]):
...
class ApplicationViewTitleBar(_winrt.Object, interfaces=[]):
...
class ApplicationViewTransferContext(_winrt.Object, interfaces=[]):
...
class InputPane(_winrt.Object, interfaces=[]):
...
class InputPaneVisibilityEventArgs(_winrt.Object, interfaces=[]):
...
class UISettings(_winrt.Object, interfaces=[]):
...
class UISettingsAnimationsEnabledChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> UISettingsAnimationsEnabledChangedEventArgs: ...

class UISettingsAutoHideScrollBarsChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> UISettingsAutoHideScrollBarsChangedEventArgs: ...

class UISettingsMessageDurationChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> UISettingsMessageDurationChangedEventArgs: ...

class UIViewSettings(_winrt.Object, interfaces=[]):
...
class ViewModePreferences(_winrt.Object, interfaces=[]):
