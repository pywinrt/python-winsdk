...
class ActivationViewSwitcher(_winrt.Object):
    ...
    @typing.overload
    def show_as_standalone_async(self, view_id: _winrt.Int32) -> winsdk.windows.foundation.IAsyncAction: ...
    @typing.overload
    def show_as_standalone_async(self, view_id: _winrt.Int32, size_preference: ViewSizePreference) -> winsdk.windows.foundation.IAsyncAction: ...
...
class ApplicationView(_winrt.Object):
    ...
    @typing.overload
    def get_display_regions(self) -> winsdk.windows.foundation.collections.IVectorView[winsdk.windows.ui.windowmanagement.DisplayRegion]: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    def try_enter_view_mode_async(self, view_mode: ApplicationViewMode, view_mode_preferences: ViewModePreferences) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]: ...
    @typing.overload
