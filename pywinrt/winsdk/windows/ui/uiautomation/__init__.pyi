...
class AutomationConnection(_winrt.Object, interfaces=[]):
...
class AutomationConnectionBoundObject(_winrt.Object, interfaces=[]):
    connection: typing.Optional[AutomationConnection]
    @staticmethod
    def _from(obj: _winrt.Object) -> AutomationConnectionBoundObject: ...

class AutomationElement(_winrt.Object, interfaces=[]):
    app_user_model_id: str
    executable_file_name: str
    is_remote_system: _winrt.Boolean
    @staticmethod
...
class AutomationTextRange(_winrt.Object, interfaces=[]):
    @staticmethod
