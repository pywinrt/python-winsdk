...
class AutomationRemoteOperationResult(_winrt.Object, interfaces=[]):
...
class CoreAutomationRemoteOperation(_winrt.Object, interfaces=[]):
    @staticmethod
...
class CoreAutomationRemoteOperationContext(_winrt.Object, interfaces=[]):
    @staticmethod
...
class RemoteAutomationClientSession(_winrt.Object, interfaces=[]):
...
class RemoteAutomationConnectionRequestedEventArgs(_winrt.Object, interfaces=[]):
    local_pipe_name: str
    remote_process_id: _winrt.UInt32
    @staticmethod
    def _from(obj: _winrt.Object) -> RemoteAutomationConnectionRequestedEventArgs: ...

class RemoteAutomationDisconnectedEventArgs(_winrt.Object, interfaces=[]):
    local_pipe_name: str
    @staticmethod
...
class RemoteAutomationWindow(_winrt.Object, interfaces=[]):
...
class ICoreAutomationConnectionBoundObjectProvider(typing.Protocol):
    is_com_threading_required: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> ICoreAutomationConnectionBoundObjectProvider: ...

class ICoreAutomationRemoteOperationExtensionProvider(typing.Protocol):
    @staticmethod
