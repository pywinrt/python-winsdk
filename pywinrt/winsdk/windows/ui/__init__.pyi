...
class ColorHelper(_winrt.Object, interfaces=[]):
    @staticmethod
...
class Colors(_winrt.Object, interfaces=[]):
    alice_blue: Color
    antique_white: Color
    aqua: Color
    aquamarine: Color
...
class UIContentRoot(_winrt.Object, interfaces=[]):
    u_i_context: typing.Optional[UIContext]
    @staticmethod
    def _from(obj: _winrt.Object) -> UIContentRoot: ...

class UIContext(_winrt.Object, interfaces=[]):
    @staticmethod
