...
class Color:
    ...
    g: _winrt.UInt8
    b: _winrt.UInt8
    def __new__(cls: typing.Type[Color], a: _winrt.UInt8, r: _winrt.UInt8, g: _winrt.UInt8, b: _winrt.UInt8) -> Color: ...

class WindowId:
    value: _winrt.UInt64
    def __new__(cls: typing.Type[WindowId], value: _winrt.UInt64) -> WindowId: ...
