...
class SettingsCommand(_winrt.Object):
    ...
    def __new__(cls: typing.Type[SettingsCommand], settings_command_id: typing.Optional[_winrt.Object], label: str, handler: typing.Optional[winsdk.windows.ui.popups.UICommandInvokedHandler]) -> SettingsCommand:...
