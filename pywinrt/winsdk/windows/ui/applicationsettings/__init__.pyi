...
class AccountsSettingsPane(_winrt.Object):
    ...
    def show_manage_accounts_for_user_async(user: winsdk.windows.system.User) -> winsdk.windows.foundation.IAsyncAction:
        ...
    def add_account_commands_requested(handler: winsdk.windows.foundation.TypedEventHandler[AccountsSettingsPane, AccountsSettingsPaneCommandsRequestedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_account_commands_requested(cookie: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
