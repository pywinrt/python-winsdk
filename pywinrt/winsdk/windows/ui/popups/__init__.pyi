...
class MessageDialog(_winrt.Object, interfaces=[]):
    title: str
...
class PopupMenu(_winrt.Object, interfaces=[]):
    commands: typing.Optional[winsdk.windows.foundation.collections.IVector[IUICommand]]
    @staticmethod
...
class UICommand(_winrt.Object, interfaces=[IUICommand]):
    label: str
...
class UICommandSeparator(_winrt.Object, interfaces=[IUICommand]):
    label: str
    invoked: typing.Optional[UICommandInvokedHandler]
    id: typing.Optional[_winrt.Object]
    @staticmethod
...
class IUICommand(typing.Protocol):
    id: typing.Optional[_winrt.Object]
    invoked: typing.Optional[UICommandInvokedHandler]
    label: str
    @staticmethod
