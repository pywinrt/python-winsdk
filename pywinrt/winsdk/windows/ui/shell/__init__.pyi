...
class SecurityAppManager(_winrt.Object):
    ...
    def register(self, kind: SecurityAppKind, display_name: str, details_uri: typing.Optional[winsdk.windows.foundation.Uri], register_per_user: _winrt.Boolean) -> _winrt.Guid: ...
    def unregister(self, kind: SecurityAppKind, guid_registration: _winrt.Guid) -> None: ...
    def update_state(self, kind: SecurityAppKind, guid_registration: _winrt.Guid, state: SecurityAppState, substatus: SecurityAppSubstatus, details_uri: typing.Optional[winsdk.windows.foundation.Uri]) -> None: ...
