...
class SysStorageProviderEventReceivedEventArgs(_winrt.Object, interfaces=[]):
    json: str
    @staticmethod
    def _from(obj: _winrt.Object) -> SysStorageProviderEventReceivedEventArgs: ...
    def __init__(self, json: str) -> None: ...

class ISysStorageProviderEventSource(typing.Protocol):
    @staticmethod
...
class ISysStorageProviderHandlerFactory(typing.Protocol):
    @staticmethod
...
class ISysStorageProviderHttpRequestProvider(typing.Protocol):
    @staticmethod
