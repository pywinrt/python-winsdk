...
class AnalyticsInfo(_winrt.Object):
    ...
    @staticmethod
    def get_system_properties_async(attribute_names: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IMapView[str, str]]]: ...
