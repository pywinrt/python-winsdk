...
class AnalyticsVersionInfo(_winrt.Object, interfaces=[]):
    device_family: str
...
class HardwareToken(_winrt.Object, interfaces=[]):
...
class SystemIdentificationInfo(_winrt.Object, interfaces=[]):
    id: typing.Optional[winsdk.windows.storage.streams.IBuffer]
...
class UnsupportedAppRequirement(_winrt.Object, interfaces=[]):
