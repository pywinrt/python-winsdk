...
class DiagnosticInvoker(_winrt.Object):
    ...
    def run_diagnostic_action_async(self, context: typing.Optional[winsdk.windows.data.json.JsonObject]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DiagnosticActionResult, DiagnosticActionState]]: ...
    def run_diagnostic_action_from_string_async(self, context: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DiagnosticActionResult, DiagnosticActionState]]: ...
