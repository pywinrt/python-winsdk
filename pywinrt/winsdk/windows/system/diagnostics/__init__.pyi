...
class DiagnosticInvoker(_winrt.Object):
    ...
    def get_for_user(user: winsdk.windows.system.User) -> DiagnosticInvoker:
        ...
    def run_diagnostic_action_async(context: winsdk.windows.data.json.JsonObject) -> winsdk.windows.foundation.IAsyncOperationWithProgress[DiagnosticActionResult, DiagnosticActionState]:
        ...
    def run_diagnostic_action_from_string_async(context: str) -> winsdk.windows.foundation.IAsyncOperationWithProgress[DiagnosticActionResult, DiagnosticActionState]:
        ...
...
class ProcessDiagnosticInfo(_winrt.Object):
    ...
    def get_app_diagnostic_infos() -> winsdk.windows.foundation.collections.IVector[winsdk.windows.system.AppDiagnosticInfo]:
        ...
