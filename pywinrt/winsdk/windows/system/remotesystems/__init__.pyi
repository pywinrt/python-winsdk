...
class RemoteSystem(_winrt.Object):
    ...
    @staticmethod
    def find_by_host_name_async(host_name: typing.Optional[winsdk.windows.networking.HostName]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[RemoteSystem]]: ...
    def get_capability_supported_async(self, capability_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @staticmethod
    def is_authorization_kind_enabled(kind: RemoteSystemAuthorizationKind) -> _winrt.Boolean: ...
    @staticmethod
    def request_access_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[RemoteSystemAccessStatus]]: ...
...
class RemoteSystemAppRegistration(_winrt.Object):
    ...
    def save_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class RemoteSystemSession(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def send_invitation_async(self, invitee: typing.Optional[RemoteSystem]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class RemoteSystemSessionController(_winrt.Object):
    ...
    def create_session_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[RemoteSystemSessionCreationResult]]: ...
    def remove_participant_async(self, p_participant: typing.Optional[RemoteSystemSessionParticipant]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class RemoteSystemSessionInfo(_winrt.Object):
    ...
    def join_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[RemoteSystemSessionJoinResult]]: ...
...
class RemoteSystemSessionMessageChannel(_winrt.Object):
    ...
    def broadcast_value_set_async(self, message_data: typing.Optional[winsdk.windows.foundation.collections.ValueSet]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def send_value_set_async(self, message_data: typing.Optional[winsdk.windows.foundation.collections.ValueSet], participant: typing.Optional[RemoteSystemSessionParticipant]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def send_value_set_to_participants_async(self, message_data: typing.Optional[winsdk.windows.foundation.collections.ValueSet], participants: typing.Iterable[typing.Optional[RemoteSystemSessionParticipant]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
