...
class AccessListEntryView(_winrt.Object, interfaces=[winsdk.windows.foundation.collections.IVectorView[AccessListEntry], winsdk.windows.foundation.collections.IIterable[AccessListEntry]]):
    size: _winrt.UInt32
    @staticmethod
...
class ItemRemovedEventArgs(_winrt.Object, interfaces=[]):
...
class StorageItemAccessList(_winrt.Object, interfaces=[IStorageItemAccessList]):
...
class StorageItemMostRecentlyUsedList(_winrt.Object, interfaces=[IStorageItemAccessList]):
    entries: typing.Optional[AccessListEntryView]
    maximum_items_allowed: _winrt.UInt32
    @staticmethod
...
class IStorageItemAccessList(typing.Protocol):
    entries: typing.Optional[AccessListEntryView]
    maximum_items_allowed: _winrt.UInt32
    @staticmethod
