...
class FileInformationFactory(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[FileInformationFactory], query_result: typing.Optional[winsdk.windows.storage.search.IStorageQueryResultBase], mode: winsdk.windows.storage.fileproperties.ThumbnailMode, requested_thumbnail_size: _winrt.UInt32) -> FileInformationFactory:...
    @typing.overload
    def __new__(cls: typing.Type[FileInformationFactory], query_result: typing.Optional[winsdk.windows.storage.search.IStorageQueryResultBase], mode: winsdk.windows.storage.fileproperties.ThumbnailMode, requested_thumbnail_size: _winrt.UInt32, thumbnail_options: winsdk.windows.storage.fileproperties.ThumbnailOptions) -> FileInformationFactory:...
    @typing.overload
    def __new__(cls: typing.Type[FileInformationFactory], query_result: typing.Optional[winsdk.windows.storage.search.IStorageQueryResultBase], mode: winsdk.windows.storage.fileproperties.ThumbnailMode, requested_thumbnail_size: _winrt.UInt32, thumbnail_options: winsdk.windows.storage.fileproperties.ThumbnailOptions, delay_load: _winrt.Boolean) -> FileInformationFactory:...
    @typing.overload
