...
class Buffer(_winrt.Object, interfaces=[IBuffer]):
...
class DataReader(_winrt.Object, interfaces=[IDataReader, winsdk.windows.foundation.IClosable]):
...
class DataReaderLoadOperation(_winrt.Object, interfaces=[winsdk.windows.foundation.IAsyncOperation[_winrt.UInt32], winsdk.windows.foundation.IAsyncInfo]):
...
class DataWriter(_winrt.Object, interfaces=[IDataWriter, winsdk.windows.foundation.IClosable]):
    unicode_encoding: UnicodeEncoding
    byte_order: ByteOrder
...
class DataWriterStoreOperation(_winrt.Object, interfaces=[winsdk.windows.foundation.IAsyncOperation[_winrt.UInt32], winsdk.windows.foundation.IAsyncInfo]):
    error_code: winsdk.windows.foundation.HResult
    id: _winrt.UInt32
    status: winsdk.windows.foundation.AsyncStatus
    completed: typing.Optional[winsdk.windows.foundation.AsyncOperationCompletedHandler[_winrt.UInt32]]
...
class FileInputStream(_winrt.Object, interfaces=[IInputStream, winsdk.windows.foundation.IClosable]):
    @staticmethod
...
class FileOutputStream(_winrt.Object, interfaces=[IOutputStream, winsdk.windows.foundation.IClosable]):
    @staticmethod
...
class FileRandomAccessStream(_winrt.Object, interfaces=[IRandomAccessStream, IOutputStream, winsdk.windows.foundation.IClosable, IInputStream]):
    size: _winrt.UInt64
...
class InMemoryRandomAccessStream(_winrt.Object, interfaces=[IRandomAccessStream, IOutputStream, winsdk.windows.foundation.IClosable, IInputStream]):
    size: _winrt.UInt64
    can_read: _winrt.Boolean
    can_write: _winrt.Boolean
    position: _winrt.UInt64
...
class InputStreamOverStream(_winrt.Object, interfaces=[IInputStream, winsdk.windows.foundation.IClosable]):
    @staticmethod
    def _from(obj: _winrt.Object) -> InputStreamOverStream: ...
    def close(self) -> None: ...
    def read_async(self, buffer: typing.Optional[IBuffer], count: _winrt.UInt32, options: InputStreamOptions) -> winsdk.windows.foundation.IAsyncOperationWithProgress[IBuffer, _winrt.UInt32]: ...

class OutputStreamOverStream(_winrt.Object, interfaces=[IOutputStream, winsdk.windows.foundation.IClosable]):
    @staticmethod
...
class RandomAccessStreamOverStream(_winrt.Object, interfaces=[IRandomAccessStream, IOutputStream, winsdk.windows.foundation.IClosable, IInputStream]):
    size: _winrt.UInt64
    can_read: _winrt.Boolean
    can_write: _winrt.Boolean
    position: _winrt.UInt64
...
class RandomAccessStreamReference(_winrt.Object, interfaces=[IRandomAccessStreamReference]):
    @staticmethod
...
class IBuffer(typing.Protocol):
    capacity: _winrt.UInt32
    length: _winrt.UInt32
    @staticmethod
    def _from(obj: _winrt.Object) -> IBuffer: ...

class IContentTypeProvider(typing.Protocol):
    content_type: str
    @staticmethod
    def _from(obj: _winrt.Object) -> IContentTypeProvider: ...

class IDataReader(typing.Protocol):
    byte_order: ByteOrder
    input_stream_options: InputStreamOptions
    unconsumed_buffer_length: _winrt.UInt32
    unicode_encoding: UnicodeEncoding
...
class IDataWriter(typing.Protocol):
    byte_order: ByteOrder
    unicode_encoding: UnicodeEncoding
    unstored_buffer_length: _winrt.UInt32
    @staticmethod
...
class IInputStream(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> IInputStream: ...
    def read_async(self, buffer: typing.Optional[IBuffer], count: _winrt.UInt32, options: InputStreamOptions) -> winsdk.windows.foundation.IAsyncOperationWithProgress[IBuffer, _winrt.UInt32]: ...
    def close(self) -> None: ...

class IInputStreamReference(typing.Protocol):
    @staticmethod
...
class IOutputStream(typing.Protocol):
    @staticmethod
...
class IPropertySetSerializer(typing.Protocol):
    @staticmethod
...
class IRandomAccessStream(typing.Protocol):
    can_read: _winrt.Boolean
    can_write: _winrt.Boolean
    position: _winrt.UInt64
    size: _winrt.UInt64
...
class IRandomAccessStreamReference(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> IRandomAccessStreamReference: ...
    def open_read_async(self) -> winsdk.windows.foundation.IAsyncOperation[IRandomAccessStreamWithContentType]: ...

class IRandomAccessStreamWithContentType(typing.Protocol):
    can_read: _winrt.Boolean
    can_write: _winrt.Boolean
    position: _winrt.UInt64
    size: _winrt.UInt64
