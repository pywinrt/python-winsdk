...
class FileInputStream(IInputStream, winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def read_async(self, buffer: typing.Optional[IBuffer], count: _winrt.UInt32, options: InputStreamOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[IBuffer, _winrt.UInt32]]: ...
...
class FileOutputStream(IOutputStream, winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def flush_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def write_async(self, buffer: typing.Optional[IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.UInt32, _winrt.UInt32]]: ...
...
class FileRandomAccessStream(IRandomAccessStream, IOutputStream, winsdk.windows.foundation.IClosable, IInputStream, _winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def open_async(file_path: str, access_mode: winsdk.windows.storage.FileAccessMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IRandomAccessStream]]: ...
    @typing.overload
    @staticmethod
    def open_async(file_path: str, access_mode: winsdk.windows.storage.FileAccessMode, sharing_options: winsdk.windows.storage.StorageOpenOptions, open_disposition: FileOpenDisposition) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IRandomAccessStream]]: ...
    @typing.overload
    @staticmethod
    def open_for_user_async(user: typing.Optional[winsdk.windows.system.User], file_path: str, access_mode: winsdk.windows.storage.FileAccessMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IRandomAccessStream]]: ...
    @typing.overload
    @staticmethod
    def open_for_user_async(user: typing.Optional[winsdk.windows.system.User], file_path: str, access_mode: winsdk.windows.storage.FileAccessMode, sharing_options: winsdk.windows.storage.StorageOpenOptions, open_disposition: FileOpenDisposition) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IRandomAccessStream]]: ...
    @typing.overload
    @staticmethod
    def open_transacted_write_async(file_path: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.StorageStreamTransaction]]: ...
    @typing.overload
    @staticmethod
    def open_transacted_write_async(file_path: str, open_options: winsdk.windows.storage.StorageOpenOptions, open_disposition: FileOpenDisposition) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.StorageStreamTransaction]]: ...
    @typing.overload
    @staticmethod
    def open_transacted_write_for_user_async(user: typing.Optional[winsdk.windows.system.User], file_path: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.StorageStreamTransaction]]: ...
    @typing.overload
    @staticmethod
    def open_transacted_write_for_user_async(user: typing.Optional[winsdk.windows.system.User], file_path: str, open_options: winsdk.windows.storage.StorageOpenOptions, open_disposition: FileOpenDisposition) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.StorageStreamTransaction]]: ...
    def read_async(self, buffer: typing.Optional[IBuffer], count: _winrt.UInt32, options: InputStreamOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[IBuffer, _winrt.UInt32]]: ...
...
class RandomAccessStream(_winrt.Object):
    ...
    @staticmethod
    def copy_and_close_async(source: typing.Optional[IInputStream], destination: typing.Optional[IOutputStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.UInt64, _winrt.UInt64]]: ...
    @typing.overload
    @staticmethod
    def copy_async(source: typing.Optional[IInputStream], destination: typing.Optional[IOutputStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.UInt64, _winrt.UInt64]]: ...
    @typing.overload
    @staticmethod
    def copy_async(source: typing.Optional[IInputStream], destination: typing.Optional[IOutputStream], bytes_to_copy: _winrt.UInt64) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.UInt64, _winrt.UInt64]]: ...
...
class RandomAccessStreamReference(IRandomAccessStreamReference, _winrt.Object):
    ...
    def open_read_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IRandomAccessStreamWithContentType]]: ...
...
class IInputStreamReference(_winrt.Object):
    ...
    def open_sequential_read_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IInputStream]]: ...
