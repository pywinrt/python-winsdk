...
class Compressor(_winrt.Object, interfaces=[winsdk.windows.storage.streams.IOutputStream, winsdk.windows.foundation.IClosable]):
    @staticmethod
...
class Decompressor(_winrt.Object, interfaces=[winsdk.windows.storage.streams.IInputStream, winsdk.windows.foundation.IClosable]):
    @staticmethod
