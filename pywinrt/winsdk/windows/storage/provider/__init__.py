...
_ns_module = winsdk.system._import_ns_module("Windows.Storage.Provider")
...
_ns_module._register_CachedFileOptions(CachedFileOptions)
_ns_module._register_CachedFileTarget(CachedFileTarget)
_ns_module._register_FileUpdateStatus(FileUpdateStatus)
_ns_module._register_ReadActivationMode(ReadActivationMode)
_ns_module._register_StorageProviderHardlinkPolicy(StorageProviderHardlinkPolicy)
_ns_module._register_StorageProviderHydrationPolicy(StorageProviderHydrationPolicy)
_ns_module._register_StorageProviderHydrationPolicyModifier(StorageProviderHydrationPolicyModifier)
_ns_module._register_StorageProviderInSyncPolicy(StorageProviderInSyncPolicy)
