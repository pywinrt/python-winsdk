...
class CachedFileUpdaterUI(_winrt.Object, interfaces=[]):
    title: str
    u_i_status: UIStatus
...
class FileUpdateRequest(_winrt.Object, interfaces=[]):
...
class FileUpdateRequestDeferral(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> FileUpdateRequestDeferral: ...
    def complete(self) -> None: ...

class FileUpdateRequestedEventArgs(_winrt.Object, interfaces=[]):
    request: typing.Optional[FileUpdateRequest]
    @staticmethod
    def _from(obj: _winrt.Object) -> FileUpdateRequestedEventArgs: ...

class StorageProviderError(_winrt.Object, interfaces=[]):
...
class StorageProviderErrorCommand(_winrt.Object, interfaces=[]):
...
class StorageProviderFileTypeInfo(_winrt.Object, interfaces=[]):
    file_extension: str
    icon_resource: str
    @staticmethod
...
class StorageProviderGetContentInfoForPathResult(_winrt.Object, interfaces=[]):
...
class StorageProviderGetPathForContentUriResult(_winrt.Object, interfaces=[]):
    status: StorageProviderUriSourceStatus
    path: str
    @staticmethod
...
class StorageProviderItemProperties(_winrt.Object):
    ...
    @staticmethod
    def set_async(item: typing.Optional[winsdk.windows.storage.IStorageItem], item_properties: typing.Iterable[typing.Optional[StorageProviderItemProperty]]) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...

class StorageProviderItemProperty(_winrt.Object, interfaces=[]):
    value: str
    id: _winrt.Int32
    icon_resource: str
    @staticmethod
...
class StorageProviderItemPropertyDefinition(_winrt.Object, interfaces=[]):
    id: _winrt.Int32
...
class StorageProviderStatus(_winrt.Object, interfaces=[]):
    ...
    @typing.overload
    def __init__(self, state: StorageProviderState, message: str, error_messages: typing.Iterable[typing.Optional[StorageProviderError]]) -> None: ...

class StorageProviderSyncRootInfo(_winrt.Object, interfaces=[]):
    version: str
...
class IStorageProviderHandlerFactory(typing.Protocol):
    @staticmethod
...
class IStorageProviderItemPropertySource(typing.Protocol):
    @staticmethod
...
class IStorageProviderPropertyCapabilities(typing.Protocol):
    @staticmethod
...
class IStorageProviderStatusSource(typing.Protocol):
    @staticmethod
...
class IStorageProviderUriSource(typing.Protocol):
    @staticmethod
