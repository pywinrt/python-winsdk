...
class BasicProperties(IStorageItemExtraProperties, _winrt.Object):
    ...
    def retrieve_properties_async(self, properties_to_retrieve: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IMap[str, _winrt.Object]]]: ...
    @typing.overload
...
class GeotagHelper(_winrt.Object):
    ...
    @staticmethod
    def get_geotag_async(file: typing.Optional[winsdk.windows.storage.IStorageFile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.geolocation.Geopoint]]: ...
    @staticmethod
...
class StorageItemContentProperties(IStorageItemExtraProperties, _winrt.Object):
    ...
    def get_document_properties_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[DocumentProperties]]: ...
    def get_image_properties_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ImageProperties]]: ...
    def get_music_properties_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MusicProperties]]: ...
    def get_video_properties_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VideoProperties]]: ...
    def retrieve_properties_async(self, properties_to_retrieve: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IMap[str, _winrt.Object]]]: ...
    @typing.overload
    def save_properties_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    @typing.overload
