...
class ContentIndexer(_winrt.Object):
    ...
    def retrieve_properties_async(self, content_id: str, properties_to_retrieve: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IMapView[str, _winrt.Object]]]: ...
...
class ContentIndexerQuery(_winrt.Object):
    ...
    @typing.overload
    def get_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[IIndexableContent]]]: ...
    @typing.overload
    def get_async(self, start_index: _winrt.UInt32, max_items: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[IIndexableContent]]]: ...
    def get_count_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.UInt32]]: ...
    @typing.overload
    def get_properties_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.foundation.collections.IMapView[str, _winrt.Object]]]]: ...
    @typing.overload
    def get_properties_async(self, start_index: _winrt.UInt32, max_items: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.foundation.collections.IMapView[str, _winrt.Object]]]]: ...
...
class StorageFileQueryResult(IStorageQueryResultBase, _winrt.Object):
    ...
    def find_start_index_async(self, value: typing.Optional[_winrt.Object]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.UInt32]]: ...
    ...
    @typing.overload
    def get_files_async(self, start_index: _winrt.UInt32, max_number_of_items: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.storage.StorageFile]]]: ...
    def get_item_count_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.UInt32]]: ...
...
class StorageFolderQueryResult(IStorageQueryResultBase, _winrt.Object):
    ...
    @typing.overload
    def get_folders_async(self, start_index: _winrt.UInt32, max_number_of_items: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.storage.StorageFolder]]]: ...
    def get_item_count_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.UInt32]]: ...
    def add_contents_changed(self, handler: winsdk.windows.foundation.TypedEventHandler[IStorageQueryResultBase, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken: ...
    def remove_contents_changed(self, event_cookie: winsdk.windows.foundation.EventRegistrationToken) -> None: ...
    def add_options_changed(self, changed_handler: winsdk.windows.foundation.TypedEventHandler[IStorageQueryResultBase, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken: ...
...
class StorageItemQueryResult(IStorageQueryResultBase, _winrt.Object):
    ...
    @typing.overload
    def get_items_async(self, start_index: _winrt.UInt32, max_number_of_items: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.storage.IStorageItem]]]: ...
    def add_contents_changed(self, handler: winsdk.windows.foundation.TypedEventHandler[IStorageQueryResultBase, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken: ...
    def remove_contents_changed(self, event_cookie: winsdk.windows.foundation.EventRegistrationToken) -> None: ...
    def add_options_changed(self, changed_handler: winsdk.windows.foundation.TypedEventHandler[IStorageQueryResultBase, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken: ...
    def remove_options_changed(self, event_cookie: winsdk.windows.foundation.EventRegistrationToken) -> None: ...
...
class IStorageFolderQueryOperations(_winrt.Object):
    ...
    @typing.overload
    def get_files_async(self, query: CommonFileQuery) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.storage.StorageFile]]]: ...
    @typing.overload
    def get_files_async(self, query: CommonFileQuery, start_index: _winrt.UInt32, max_items_to_retrieve: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.storage.StorageFile]]]: ...
    @typing.overload
    def get_folders_async(self, query: CommonFolderQuery) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.storage.StorageFolder]]]: ...
    @typing.overload
    def get_folders_async(self, query: CommonFolderQuery, start_index: _winrt.UInt32, max_items_to_retrieve: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.storage.StorageFolder]]]: ...
    def get_indexed_state_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IndexedState]]: ...
