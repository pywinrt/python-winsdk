...
class ApplicationData(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    @staticmethod
    def get_for_user_async(user: typing.Optional[winsdk.windows.system.User]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ApplicationData]]: ...
...
class CachedFileManager(_winrt.Object):
    ...
    @staticmethod
    def complete_updates_async(file: typing.Optional[IStorageFile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.provider.FileUpdateStatus]]: ...
    @staticmethod
...
class DownloadsFolder(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def create_file_async(desired_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @typing.overload
    @staticmethod
    def create_file_async(desired_name: str, option: CreationCollisionOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @typing.overload
    @staticmethod
    def create_file_for_user_async(user: typing.Optional[winsdk.windows.system.User], desired_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @typing.overload
    @staticmethod
    def create_file_for_user_async(user: typing.Optional[winsdk.windows.system.User], desired_name: str, option: CreationCollisionOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @typing.overload
    @staticmethod
    def create_folder_async(desired_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    @typing.overload
    @staticmethod
    def create_folder_async(desired_name: str, option: CreationCollisionOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    @typing.overload
    @staticmethod
    def create_folder_for_user_async(user: typing.Optional[winsdk.windows.system.User], desired_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    @typing.overload
    @staticmethod
    def create_folder_for_user_async(user: typing.Optional[winsdk.windows.system.User], desired_name: str, option: CreationCollisionOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
...
class FileIO(_winrt.Object):
    ...
    @staticmethod
    def read_buffer_async(file: typing.Optional[IStorageFile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IBuffer]]: ...
    @typing.overload
    @staticmethod
    def read_lines_async(file: typing.Optional[IStorageFile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVector[str]]]: ...
    @typing.overload
    @staticmethod
    def read_lines_async(file: typing.Optional[IStorageFile], encoding: winsdk.windows.storage.streams.UnicodeEncoding) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVector[str]]]: ...
    @typing.overload
    @staticmethod
    def read_text_async(file: typing.Optional[IStorageFile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @typing.overload
    @staticmethod
    def read_text_async(file: typing.Optional[IStorageFile], encoding: winsdk.windows.storage.streams.UnicodeEncoding) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @staticmethod
...
class KnownFolders(_winrt.Object):
    ...
    @staticmethod
    def get_folder_async(folder_id: KnownFolderId) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    @staticmethod
    def get_folder_for_user_async(user: typing.Optional[winsdk.windows.system.User], folder_id: KnownFolderId) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    @staticmethod
    def request_access_async(folder_id: KnownFolderId) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[KnownFoldersAccessStatus]]: ...
    @staticmethod
    def request_access_for_user_async(user: typing.Optional[winsdk.windows.system.User], folder_id: KnownFolderId) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[KnownFoldersAccessStatus]]: ...
...
class PathIO(_winrt.Object):
    ...
    @staticmethod
    def read_buffer_async(absolute_path: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IBuffer]]: ...
    @typing.overload
    @staticmethod
    def read_lines_async(absolute_path: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVector[str]]]: ...
    @typing.overload
    @staticmethod
    def read_lines_async(absolute_path: str, encoding: winsdk.windows.storage.streams.UnicodeEncoding) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVector[str]]]: ...
    @typing.overload
    @staticmethod
    def read_text_async(absolute_path: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @typing.overload
    @staticmethod
    def read_text_async(absolute_path: str, encoding: winsdk.windows.storage.streams.UnicodeEncoding) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @staticmethod
...
class StorageFile(IStorageFile, winsdk.windows.storage.streams.IInputStreamReference, winsdk.windows.storage.streams.IRandomAccessStreamReference, IStorageItem, IStorageItemProperties, IStorageItemProperties2, IStorageItem2, IStorageItemPropertiesWithProvider, IStorageFilePropertiesWithAvailability, IStorageFile2, _winrt.Object):
    ...
    @typing.overload
    def copy_async(self, destination_folder: typing.Optional[IStorageFolder]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @typing.overload
    def copy_async(self, destination_folder: typing.Optional[IStorageFolder], desired_new_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @typing.overload
    def copy_async(self, destination_folder: typing.Optional[IStorageFolder], desired_new_name: str, option: NameCollisionOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @staticmethod
    def create_streamed_file_async(display_name_with_extension: str, data_requested: typing.Optional[StreamedFileDataRequestedHandler], thumbnail: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStreamReference]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @staticmethod
    def create_streamed_file_from_uri_async(display_name_with_extension: str, uri: typing.Optional[winsdk.windows.foundation.Uri], thumbnail: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStreamReference]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @typing.overload
    ...
    def get_basic_properties_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.fileproperties.BasicProperties]]: ...
    @staticmethod
    def get_file_from_application_uri_async(uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @staticmethod
    def get_file_from_path_async(path: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @staticmethod
    def get_file_from_path_for_user_async(user: typing.Optional[winsdk.windows.system.User], path: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    def get_parent_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    @typing.overload
    def get_scaled_image_as_thumbnail_async(self, mode: winsdk.windows.storage.fileproperties.ThumbnailMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.fileproperties.StorageItemThumbnail]]: ...
    @typing.overload
    def get_scaled_image_as_thumbnail_async(self, mode: winsdk.windows.storage.fileproperties.ThumbnailMode, requested_size: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.fileproperties.StorageItemThumbnail]]: ...
    @typing.overload
    def get_scaled_image_as_thumbnail_async(self, mode: winsdk.windows.storage.fileproperties.ThumbnailMode, requested_size: _winrt.UInt32, options: winsdk.windows.storage.fileproperties.ThumbnailOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.fileproperties.StorageItemThumbnail]]: ...
    @typing.overload
    def get_thumbnail_async(self, mode: winsdk.windows.storage.fileproperties.ThumbnailMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.fileproperties.StorageItemThumbnail]]: ...
    @typing.overload
    def get_thumbnail_async(self, mode: winsdk.windows.storage.fileproperties.ThumbnailMode, requested_size: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.fileproperties.StorageItemThumbnail]]: ...
    @typing.overload
    def get_thumbnail_async(self, mode: winsdk.windows.storage.fileproperties.ThumbnailMode, requested_size: _winrt.UInt32, options: winsdk.windows.storage.fileproperties.ThumbnailOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.fileproperties.StorageItemThumbnail]]: ...
    ...
    @typing.overload
    def open_async(self, access_mode: FileAccessMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IRandomAccessStream]]: ...
    @typing.overload
    def open_async(self, access_mode: FileAccessMode, options: StorageOpenOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IRandomAccessStream]]: ...
    def open_read_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IRandomAccessStreamWithContentType]]: ...
    def open_sequential_read_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IInputStream]]: ...
    @typing.overload
    def open_transacted_write_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageStreamTransaction]]: ...
    @typing.overload
    def open_transacted_write_async(self, options: StorageOpenOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageStreamTransaction]]: ...
    @typing.overload
    ...
    @staticmethod
    def replace_with_streamed_file_async(file_to_replace: typing.Optional[IStorageFile], data_requested: typing.Optional[StreamedFileDataRequestedHandler], thumbnail: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStreamReference]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @staticmethod
    def replace_with_streamed_file_from_uri_async(file_to_replace: typing.Optional[IStorageFile], uri: typing.Optional[winsdk.windows.foundation.Uri], thumbnail: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStreamReference]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
...
class StorageFolder(IStorageFolder, IStorageItem, winsdk.windows.storage.search.IStorageFolderQueryOperations, IStorageItemProperties, IStorageItemProperties2, IStorageItem2, IStorageFolder2, IStorageItemPropertiesWithProvider, _winrt.Object):
    ...
    @typing.overload
    def create_file_async(self, desired_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @typing.overload
    def create_file_async(self, desired_name: str, options: CreationCollisionOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @typing.overload
    ...
    @typing.overload
    def create_folder_async(self, desired_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    @typing.overload
    def create_folder_async(self, desired_name: str, options: CreationCollisionOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    @typing.overload
    ...
    def delete_async(self, option: StorageDeleteOption) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    def get_basic_properties_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.fileproperties.BasicProperties]]: ...
    def get_file_async(self, name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFile]]: ...
    @typing.overload
    def get_files_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StorageFile]]]: ...
    @typing.overload
    def get_files_async(self, query: winsdk.windows.storage.search.CommonFileQuery) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StorageFile]]]: ...
    @typing.overload
    def get_files_async(self, query: winsdk.windows.storage.search.CommonFileQuery, start_index: _winrt.UInt32, max_items_to_retrieve: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StorageFile]]]: ...
    def get_folder_async(self, name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    @staticmethod
    def get_folder_from_path_async(path: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    @staticmethod
    def get_folder_from_path_for_user_async(user: typing.Optional[winsdk.windows.system.User], path: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    @typing.overload
    def get_folders_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StorageFolder]]]: ...
    @typing.overload
    def get_folders_async(self, query: winsdk.windows.storage.search.CommonFolderQuery) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StorageFolder]]]: ...
    @typing.overload
    def get_folders_async(self, query: winsdk.windows.storage.search.CommonFolderQuery, start_index: _winrt.UInt32, max_items_to_retrieve: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StorageFolder]]]: ...
    def get_indexed_state_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.search.IndexedState]]: ...
    def get_item_async(self, name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IStorageItem]]: ...
    @typing.overload
    def get_items_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[IStorageItem]]]: ...
    @typing.overload
    def get_items_async(self, start_index: _winrt.UInt32, max_items_to_retrieve: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[IStorageItem]]]: ...
    def get_parent_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    @typing.overload
    def get_scaled_image_as_thumbnail_async(self, mode: winsdk.windows.storage.fileproperties.ThumbnailMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.fileproperties.StorageItemThumbnail]]: ...
    @typing.overload
    ...
    def try_get_item_async(self, name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IStorageItem]]: ...
...
class StorageLibrary(_winrt.Object):
    ...
    def are_folder_suggestions_available_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @staticmethod
    def get_library_async(library_id: KnownLibraryId) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageLibrary]]: ...
    @staticmethod
    def get_library_for_user_async(user: typing.Optional[winsdk.windows.system.User], library_id: KnownLibraryId) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageLibrary]]: ...
    def request_add_folder_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[StorageFolder]]: ...
    def request_remove_folder_async(self, folder: typing.Optional[StorageFolder]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class StorageLibraryChange(_winrt.Object):
    ...
    def get_storage_item_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IStorageItem]]: ...
    def is_of_type(self, type: StorageItemTypes) -> _winrt.Boolean: ...
...
class StorageLibraryChangeReader(_winrt.Object):
    ...
    def read_batch_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[StorageLibraryChange]]]: ...
...
class StorageProvider(_winrt.Object):
    ...
    def is_property_supported_for_partial_file_async(self, property_canonical_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
