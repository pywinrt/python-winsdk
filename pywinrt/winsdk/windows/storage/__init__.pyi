...
class AppDataPaths(_winrt.Object, interfaces=[]):
    cookies: str
    desktop: str
    documents: str
    favorites: str
...
class ApplicationData(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class ApplicationDataCompositeValue(_winrt.Object, interfaces=[winsdk.windows.foundation.collections.IPropertySet, winsdk.windows.foundation.collections.IObservableMap[str, _winrt.Object], winsdk.windows.foundation.collections.IMap[str, _winrt.Object], winsdk.windows.foundation.collections.IIterable[winsdk.windows.foundation.collections.IKeyValuePair[str, _winrt.Object]]]):
    size: _winrt.UInt32
    @staticmethod
...
class ApplicationDataContainer(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class ApplicationDataContainerSettings(_winrt.Object, interfaces=[winsdk.windows.foundation.collections.IPropertySet, winsdk.windows.foundation.collections.IObservableMap[str, _winrt.Object], winsdk.windows.foundation.collections.IMap[str, _winrt.Object], winsdk.windows.foundation.collections.IIterable[winsdk.windows.foundation.collections.IKeyValuePair[str, _winrt.Object]]]):
    size: _winrt.UInt32
    @staticmethod
...
class SetVersionDeferral(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> SetVersionDeferral: ...
    def complete(self) -> None: ...

class SetVersionRequest(_winrt.Object, interfaces=[]):
...
class StorageFolder(_winrt.Object, interfaces=[IStorageFolder, IStorageItem, winsdk.windows.storage.search.IStorageFolderQueryOperations, IStorageItemProperties, IStorageItemProperties2, IStorageItem2, IStorageFolder2, IStorageItemPropertiesWithProvider]):
    attributes: FileAttributes
    date_created: winsdk.windows.foundation.DateTime
    name: str
    path: str
...
class StorageLibrary(_winrt.Object, interfaces=[]):
...
class StorageLibraryChange(_winrt.Object, interfaces=[]):
...
class StorageLibraryChangeReader(_winrt.Object, interfaces=[]):
    @staticmethod
...
class StorageLibraryChangeTracker(_winrt.Object, interfaces=[]):
    @staticmethod
...
class StorageStreamTransaction(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class StreamedFileDataRequest(_winrt.Object, interfaces=[winsdk.windows.storage.streams.IOutputStream, winsdk.windows.foundation.IClosable, IStreamedFileDataRequest]):
    @staticmethod
...
class SystemAudioProperties(_winrt.Object, interfaces=[]):
    encoding_bitrate: str
    @staticmethod
    def _from(obj: _winrt.Object) -> SystemAudioProperties: ...

class SystemDataPaths(_winrt.Object, interfaces=[]):
    fonts: str
    program_data: str
    public: str
    public_desktop: str
...
class SystemGPSProperties(_winrt.Object, interfaces=[]):
    latitude_decimal: str
    longitude_decimal: str
    @staticmethod
    def _from(obj: _winrt.Object) -> SystemGPSProperties: ...

class SystemImageProperties(_winrt.Object, interfaces=[]):
    horizontal_size: str
    vertical_size: str
    @staticmethod
    def _from(obj: _winrt.Object) -> SystemImageProperties: ...

class SystemMediaProperties(_winrt.Object, interfaces=[]):
    duration: str
    producer: str
    publisher: str
    sub_title: str
...
class SystemMusicProperties(_winrt.Object, interfaces=[]):
    album_artist: str
    album_title: str
    artist: str
    composer: str
...
class SystemPhotoProperties(_winrt.Object, interfaces=[]):
...
class SystemVideoProperties(_winrt.Object, interfaces=[]):
    director: str
    frame_height: str
    frame_width: str
    orientation: str
...
class UserDataPaths(_winrt.Object, interfaces=[]):
    camera_roll: str
    cookies: str
    desktop: str
    documents: str
...
class IStorageFile(typing.Protocol):
    content_type: str
    file_type: str
    attributes: FileAttributes
    date_created: winsdk.windows.foundation.DateTime
...
class IStorageFile2(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> IStorageFile2: ...
    def open_async(self, access_mode: FileAccessMode, options: StorageOpenOptions) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IRandomAccessStream]: ...
    def open_transacted_write_async(self, options: StorageOpenOptions) -> winsdk.windows.foundation.IAsyncOperation[StorageStreamTransaction]: ...

class IStorageFilePropertiesWithAvailability(typing.Protocol):
    is_available: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> IStorageFilePropertiesWithAvailability: ...

class IStorageFolder(typing.Protocol):
    attributes: FileAttributes
    date_created: winsdk.windows.foundation.DateTime
    name: str
    path: str
...
class IStorageFolder2(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> IStorageFolder2: ...
    def try_get_item_async(self, name: str) -> winsdk.windows.foundation.IAsyncOperation[IStorageItem]: ...

class IStorageItem(typing.Protocol):
    attributes: FileAttributes
    date_created: winsdk.windows.foundation.DateTime
    name: str
    path: str
...
class IStorageItem2(typing.Protocol):
    attributes: FileAttributes
    date_created: winsdk.windows.foundation.DateTime
    name: str
    path: str
...
class IStorageItemProperties(typing.Protocol):
    display_name: str
    display_type: str
    folder_relative_id: str
    properties: typing.Optional[winsdk.windows.storage.fileproperties.StorageItemContentProperties]
...
class IStorageItemProperties2(typing.Protocol):
    display_name: str
    display_type: str
    folder_relative_id: str
    properties: typing.Optional[winsdk.windows.storage.fileproperties.StorageItemContentProperties]
...
class IStorageItemPropertiesWithProvider(typing.Protocol):
    provider: typing.Optional[StorageProvider]
    display_name: str
    display_type: str
    folder_relative_id: str
...
class IStreamedFileDataRequest(typing.Protocol):
    @staticmethod
