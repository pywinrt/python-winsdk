...
class ESim(_winrt.Object):
    ...
    def delete_profile_async(self, profile_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ESimOperationResult]]: ...
    @typing.overload
    ...
    @typing.overload
    def discover_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ESimDiscoverResult]]: ...
    @typing.overload
    def discover_async(self, server_address: str, matching_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ESimDiscoverResult]]: ...
    def download_profile_metadata_async(self, activation_code: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ESimDownloadProfileMetadataResult]]: ...
    def get_profiles(self) -> typing.Optional[winsdk.windows.foundation.collections.IVectorView[ESimProfile]]: ...
    def reset_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ESimOperationResult]]: ...
...
class ESimProfile(_winrt.Object):
    ...
    def disable_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ESimOperationResult]]: ...
    def enable_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ESimOperationResult]]: ...
    def set_nickname_async(self, new_nickname: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ESimOperationResult]]: ...
...
class ESimProfileMetadata(_winrt.Object):
    ...
    @typing.overload
    def confirm_install_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[ESimOperationResult, ESimProfileInstallProgress]]: ...
    @typing.overload
    def confirm_install_async(self, confirmation_code: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[ESimOperationResult, ESimProfileInstallProgress]]: ...
    def deny_install_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ESimOperationResult]]: ...
    def postpone_install_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ESimOperationResult]]: ...
...
class HotspotAuthenticationContext(_winrt.Object):
    ...
    def issue_credentials_async(self, user_name: str, password: str, extra_parameters: str, mark_as_manual_connect_on_failure: _winrt.Boolean) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[HotspotCredentialsAuthenticationResult]]: ...
...
class MobileBroadbandDeviceServiceCommandSession(_winrt.Object):
    ...
    def send_query_command_async(self, command_id: _winrt.UInt32, data: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandDeviceServiceCommandResult]]: ...
    def send_set_command_async(self, command_id: _winrt.UInt32, data: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandDeviceServiceCommandResult]]: ...
...
class MobileBroadbandModem(_winrt.Object):
    ...
    def get_current_configuration_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandModemConfiguration]]: ...
    @staticmethod
    ...
    def get_is_passthrough_enabled_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def reset_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    def set_is_passthrough_enabled_async(self, value: _winrt.Boolean) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandModemStatus]]: ...
    def try_get_pco_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandPco]]: ...
...
class MobileBroadbandNetwork(_winrt.Object):
    ...
    def get_cells_info_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandCellsInfo]]: ...
    def get_voice_call_support_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class MobileBroadbandPin(_winrt.Object):
    ...
    def change_async(self, current_pin: str, new_pin: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandPinOperationResult]]: ...
    def disable_async(self, current_pin: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandPinOperationResult]]: ...
    def enable_async(self, current_pin: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandPinOperationResult]]: ...
    def enter_async(self, current_pin: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandPinOperationResult]]: ...
    def unblock_async(self, pin_unblock_key: str, new_pin: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandPinOperationResult]]: ...
...
class MobileBroadbandSarManager(_winrt.Object):
    ...
    def get_is_transmitting_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def revert_sar_to_hardware_control_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    def set_configuration_async(self, antennas: typing.Iterable[typing.Optional[MobileBroadbandAntennaSar]]) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
...
class MobileBroadbandSlotManager(_winrt.Object):
    ...
    def set_current_slot_async(self, slot_index: _winrt.Int32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandModemStatus]]: ...
...
class MobileBroadbandUicc(_winrt.Object):
    ...
    def get_uicc_apps_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandUiccAppsResult]]: ...
...
class MobileBroadbandUiccApp(_winrt.Object):
    ...
    def get_record_details_async(self, uicc_file_path: typing.Iterable[_winrt.UInt32]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandUiccAppRecordDetailsResult]]: ...
    def read_record_async(self, uicc_file_path: typing.Iterable[_winrt.UInt32], record_index: _winrt.Int32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MobileBroadbandUiccAppReadRecordResult]]: ...
...
class NetworkOperatorTetheringAccessPointConfiguration(_winrt.Object):
    ...
    def is_band_supported_async(self, band: TetheringWiFiBand) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class NetworkOperatorTetheringManager(_winrt.Object):
    ...
    def start_tethering_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[NetworkOperatorTetheringOperationResult]]: ...
    def stop_tethering_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[NetworkOperatorTetheringOperationResult]]: ...
...
class ProvisioningAgent(_winrt.Object):
    ...
    def provision_from_xml_document_async(self, provisioning_xml_document: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ProvisionFromXmlDocumentResults]]: ...
...
class UssdSession(_winrt.Object):
    ...
    def send_message_and_get_reply_async(self, message: typing.Optional[UssdMessage]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[UssdReply]]: ...
