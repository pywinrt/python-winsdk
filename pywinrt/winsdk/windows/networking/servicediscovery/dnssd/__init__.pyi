...
class DnssdRegistrationResult(_winrt.Object, interfaces=[winsdk.windows.foundation.IStringable]):
...
class DnssdServiceInstance(_winrt.Object, interfaces=[winsdk.windows.foundation.IStringable]):
...
class DnssdServiceInstanceCollection(_winrt.Object, interfaces=[winsdk.windows.foundation.collections.IVectorView[DnssdServiceInstance], winsdk.windows.foundation.collections.IIterable[DnssdServiceInstance]]):
    size: _winrt.UInt32
    @staticmethod
...
class DnssdServiceWatcher(_winrt.Object, interfaces=[]):
