...
class DnssdServiceInstance(_winrt.Object):
    ...
    def __new__(cls: typing.Type[DnssdServiceInstance], dnssd_service_instance_name: str, host_name: typing.Optional[winsdk.windows.networking.HostName], port: _winrt.UInt16) -> DnssdServiceInstance:...
    @typing.overload
