...
class BackgroundDownloader(_winrt.Object, interfaces=[IBackgroundTransferBase]):
    ...
    @staticmethod
    def request_unconstrained_downloads_async(operations: typing.Iterable[typing.Optional[DownloadOperation]]) -> winsdk.windows.foundation.IAsyncOperation[UnconstrainedTransferRequestResult]: ...
    def set_request_header(self, header_name: str, header_value: str) -> None: ...

class BackgroundTransferCompletionGroup(_winrt.Object, interfaces=[]):
...
class BackgroundTransferCompletionGroupTriggerDetails(_winrt.Object, interfaces=[]):
...
class BackgroundTransferContentPart(_winrt.Object, interfaces=[]):
    @staticmethod
...
class BackgroundTransferGroup(_winrt.Object, interfaces=[]):
...
class BackgroundTransferRangesDownloadedEventArgs(_winrt.Object, interfaces=[]):
...
class BackgroundUploader(_winrt.Object, interfaces=[IBackgroundTransferBase]):
    server_credential: typing.Optional[winsdk.windows.security.credentials.PasswordCredential]
    proxy_credential: typing.Optional[winsdk.windows.security.credentials.PasswordCredential]
    method: str
    group: str
    ...
    @typing.overload
    def create_upload_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], parts: typing.Iterable[typing.Optional[BackgroundTransferContentPart]]) -> winsdk.windows.foundation.IAsyncOperation[UploadOperation]: ...
    @typing.overload
    def create_upload_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], parts: typing.Iterable[typing.Optional[BackgroundTransferContentPart]], sub_type: str) -> winsdk.windows.foundation.IAsyncOperation[UploadOperation]: ...
    @typing.overload
    def create_upload_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], parts: typing.Iterable[typing.Optional[BackgroundTransferContentPart]], sub_type: str, boundary: str) -> winsdk.windows.foundation.IAsyncOperation[UploadOperation]: ...
    ...
    @staticmethod
    def request_unconstrained_uploads_async(operations: typing.Iterable[typing.Optional[UploadOperation]]) -> winsdk.windows.foundation.IAsyncOperation[UnconstrainedTransferRequestResult]: ...
    def set_request_header(self, header_name: str, header_value: str) -> None: ...
...
class DownloadOperation(_winrt.Object, interfaces=[IBackgroundTransferOperation, IBackgroundTransferOperationPriority]):
    cost_policy: BackgroundTransferCostPolicy
...
class ResponseInformation(_winrt.Object, interfaces=[]):
...
class UnconstrainedTransferRequestResult(_winrt.Object, interfaces=[]):
    is_unconstrained: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> UnconstrainedTransferRequestResult: ...

class UploadOperation(_winrt.Object, interfaces=[IBackgroundTransferOperation, IBackgroundTransferOperationPriority]):
    cost_policy: BackgroundTransferCostPolicy
    group: str
    guid: uuid.UUID
    method: str
...
class IBackgroundTransferBase(typing.Protocol):
    cost_policy: BackgroundTransferCostPolicy
    group: str
    method: str
    proxy_credential: typing.Optional[winsdk.windows.security.credentials.PasswordCredential]
...
class IBackgroundTransferContentPartFactory(typing.Protocol):
    @staticmethod
...
class IBackgroundTransferOperation(typing.Protocol):
    cost_policy: BackgroundTransferCostPolicy
    group: str
    guid: uuid.UUID
    method: str
...
class IBackgroundTransferOperationPriority(typing.Protocol):
    priority: BackgroundTransferPriority
    @staticmethod
