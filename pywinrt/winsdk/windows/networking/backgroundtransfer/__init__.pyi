...
class BackgroundDownloadProgress:
    ...
    def __new__(cls: typing.Type[BackgroundDownloadProgress], bytes_received: _winrt.UInt64, total_bytes_to_receive: _winrt.UInt64, status: BackgroundTransferStatus, has_response_changed: _winrt.Boolean, has_restarted: _winrt.Boolean) -> BackgroundDownloadProgress: ...

class BackgroundTransferFileRange:
    offset: _winrt.UInt64
    length: _winrt.UInt64
    def __new__(cls: typing.Type[BackgroundTransferFileRange], offset: _winrt.UInt64, length: _winrt.UInt64) -> BackgroundTransferFileRange: ...
...
class BackgroundUploadProgress:
    ...
    has_response_changed: _winrt.Boolean
    has_restarted: _winrt.Boolean
    def __new__(cls: typing.Type[BackgroundUploadProgress], bytes_received: _winrt.UInt64, bytes_sent: _winrt.UInt64, total_bytes_to_receive: _winrt.UInt64, total_bytes_to_send: _winrt.UInt64, status: BackgroundTransferStatus, has_response_changed: _winrt.Boolean, has_restarted: _winrt.Boolean) -> BackgroundUploadProgress: ...
...
class ContentPrefetcher(_winrt.Object):
    ...
    last_successful_prefetch_time: typing.Optional[typing.Optional[datetime.datetime]]
    @staticmethod
