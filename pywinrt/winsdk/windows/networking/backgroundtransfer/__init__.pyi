...
class BackgroundDownloader(IBackgroundTransferBase, _winrt.Object):
    ...
    def create_download_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], result_file: typing.Optional[winsdk.windows.storage.IStorageFile], request_body_stream: typing.Optional[winsdk.windows.storage.streams.IInputStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[DownloadOperation]]: ...
    @typing.overload
    @staticmethod
    def get_current_downloads_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[DownloadOperation]]]: ...
    @typing.overload
    @staticmethod
    def get_current_downloads_async(group: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[DownloadOperation]]]: ...
    @staticmethod
    def get_current_downloads_for_transfer_group_async(group: typing.Optional[BackgroundTransferGroup]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[DownloadOperation]]]: ...
    @staticmethod
    def request_unconstrained_downloads_async(operations: typing.Iterable[typing.Optional[DownloadOperation]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[UnconstrainedTransferRequestResult]]: ...
...
class BackgroundUploader(IBackgroundTransferBase, _winrt.Object):
    ...
    @typing.overload
    def create_upload_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], parts: typing.Iterable[typing.Optional[BackgroundTransferContentPart]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[UploadOperation]]: ...
    @typing.overload
    def create_upload_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], parts: typing.Iterable[typing.Optional[BackgroundTransferContentPart]], sub_type: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[UploadOperation]]: ...
    @typing.overload
    def create_upload_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], parts: typing.Iterable[typing.Optional[BackgroundTransferContentPart]], sub_type: str, boundary: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[UploadOperation]]: ...
    def create_upload_from_stream_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], source_stream: typing.Optional[winsdk.windows.storage.streams.IInputStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[UploadOperation]]: ...
    @typing.overload
    @staticmethod
    def get_current_uploads_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[UploadOperation]]]: ...
    @typing.overload
    @staticmethod
    def get_current_uploads_async(group: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[UploadOperation]]]: ...
    @staticmethod
    def get_current_uploads_for_transfer_group_async(group: typing.Optional[BackgroundTransferGroup]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[UploadOperation]]]: ...
    @staticmethod
    def request_unconstrained_uploads_async(operations: typing.Iterable[typing.Optional[UploadOperation]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[UnconstrainedTransferRequestResult]]: ...
    def set_request_header(self, header_name: str, header_value: str) -> None: ...
...
class DownloadOperation(IBackgroundTransferOperation, IBackgroundTransferOperationPriority, _winrt.Object):
    ...
    def attach_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DownloadOperation, DownloadOperation]]: ...
    ...
    def set_request_header(self, header_name: str, header_value: str) -> None: ...
    def start_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DownloadOperation, DownloadOperation]]: ...
...
class UploadOperation(IBackgroundTransferOperation, IBackgroundTransferOperationPriority, _winrt.Object):
    ...
    def attach_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[UploadOperation, UploadOperation]]: ...
    def get_response_information(self) -> typing.Optional[ResponseInformation]: ...
    def get_result_stream_at(self, position: _winrt.UInt64) -> typing.Optional[winsdk.windows.storage.streams.IInputStream]: ...
    def make_current_in_transfer_group(self) -> None: ...
    def remove_request_header(self, header_name: str) -> None: ...
    def set_request_header(self, header_name: str, header_value: str) -> None: ...
    def start_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[UploadOperation, UploadOperation]]: ...
