...
class AttributedNetworkUsage(_winrt.Object, interfaces=[]):
    attribution_id: str
...
class CellularApnContext(_winrt.Object, interfaces=[]):
    user_name: str
    provider_id: str
    password: str
...
class ConnectionCost(_winrt.Object, interfaces=[]):
...
class ConnectionProfile(_winrt.Object, interfaces=[]):
...
class ConnectionProfileFilter(_winrt.Object, interfaces=[]):
    service_provider_guid: typing.Optional[typing.Optional[uuid.UUID]]
    network_cost_type: NetworkCostType
    is_wwan_connection_profile: _winrt.Boolean
    is_wlan_connection_profile: _winrt.Boolean
...
class ConnectionSession(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
    connection_profile: typing.Optional[ConnectionProfile]
    @staticmethod
    def _from(obj: _winrt.Object) -> ConnectionSession: ...
    def close(self) -> None: ...

class ConnectivityInterval(_winrt.Object, interfaces=[]):
...
class DataPlanStatus(_winrt.Object, interfaces=[]):
...
class LanIdentifierData(_winrt.Object, interfaces=[]):
    type: _winrt.UInt32
...
class NetworkAdapter(_winrt.Object, interfaces=[]):
...
class NetworkItem(_winrt.Object, interfaces=[]):
    network_id: uuid.UUID
    @staticmethod
    def _from(obj: _winrt.Object) -> NetworkItem: ...
    def get_network_types(self) -> NetworkTypes: ...

class NetworkSecuritySettings(_winrt.Object, interfaces=[]):
...
class NetworkStateChangeEventDetails(_winrt.Object, interfaces=[]):
...
class NetworkUsage(_winrt.Object, interfaces=[]):
    bytes_received: _winrt.UInt64
    bytes_sent: _winrt.UInt64
    connection_duration: winsdk.windows.foundation.TimeSpan
    @staticmethod
...
class ProviderNetworkUsage(_winrt.Object, interfaces=[]):
    bytes_received: _winrt.UInt64
    bytes_sent: _winrt.UInt64
    provider_id: str
    @staticmethod
...
class ProxyConfiguration(_winrt.Object, interfaces=[]):
...
class RoutePolicy(_winrt.Object, interfaces=[]):
    connection_profile: typing.Optional[ConnectionProfile]
...
class WlanConnectionProfileDetails(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> WlanConnectionProfileDetails: ...
    def get_connected_ssid(self) -> str: ...

class WwanConnectionProfileDetails(_winrt.Object, interfaces=[]):
    access_point_name: str
