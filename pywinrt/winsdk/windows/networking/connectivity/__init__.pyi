...
class ConnectionProfile(_winrt.Object):
    ...
    def get_attributed_network_usage_async(self, start_time: winsdk.windows.foundation.DateTime, end_time: winsdk.windows.foundation.DateTime, states: NetworkUsageStates) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[AttributedNetworkUsage]]]: ...
    def get_connection_cost(self) -> typing.Optional[ConnectionCost]: ...
    def get_connectivity_intervals_async(self, start_time: winsdk.windows.foundation.DateTime, end_time: winsdk.windows.foundation.DateTime, states: NetworkUsageStates) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ConnectivityInterval]]]: ...
    ...
    def get_network_usage_async(self, start_time: winsdk.windows.foundation.DateTime, end_time: winsdk.windows.foundation.DateTime, granularity: DataUsageGranularity, states: NetworkUsageStates) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[NetworkUsage]]]: ...
    def get_provider_network_usage_async(self, start_time: winsdk.windows.foundation.DateTime, end_time: winsdk.windows.foundation.DateTime, states: NetworkUsageStates) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ProviderNetworkUsage]]]: ...
    def get_signal_bars(self) -> typing.Optional[typing.Optional[_winrt.UInt8]]: ...
    def try_delete_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ConnectionProfileDeleteStatus]]: ...
...
class ConnectivityManager(_winrt.Object):
    ...
    @staticmethod
    def acquire_connection_async(cellular_apn_context: typing.Optional[CellularApnContext]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ConnectionSession]]: ...
    @staticmethod
...
class NetworkAdapter(_winrt.Object):
    ...
    def get_connected_profile_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ConnectionProfile]]: ...

class NetworkInformation(_winrt.Object):
    @staticmethod
    def _from(obj: _winrt.Object) -> NetworkInformation: ...
    @staticmethod
    def find_connection_profiles_async(p_profile_filter: typing.Optional[ConnectionProfileFilter]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[ConnectionProfile]]]: ...
    @staticmethod
    ...
    @staticmethod
    def get_proxy_configuration_async(uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ProxyConfiguration]]: ...
    @staticmethod
    def get_sorted_endpoint_pairs(destination_list: typing.Iterable[typing.Optional[winsdk.windows.networking.EndpointPair]], sort_options: winsdk.windows.networking.HostNameSortOptions) -> typing.Optional[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.networking.EndpointPair]]: ...
    @staticmethod
