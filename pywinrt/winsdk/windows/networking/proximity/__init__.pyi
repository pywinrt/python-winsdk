...
class ConnectionRequestedEventArgs(_winrt.Object, interfaces=[]):
...
class PeerInformation(_winrt.Object, interfaces=[]):
    display_name: str
    discovery_data: typing.Optional[winsdk.windows.storage.streams.IBuffer]
    id: str
...
class PeerWatcher(_winrt.Object, interfaces=[]):
...
class ProximityDevice(_winrt.Object, interfaces=[]):
...
class ProximityMessage(_winrt.Object, interfaces=[]):
...
class TriggeredConnectionStateChangedEventArgs(_winrt.Object, interfaces=[]):
    id: _winrt.UInt32
