...
class ControlChannelTrigger(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class DatagramSocket(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class DatagramSocketControl(_winrt.Object, interfaces=[]):
...
class DatagramSocketInformation(_winrt.Object, interfaces=[]):
...
class DatagramSocketMessageReceivedEventArgs(_winrt.Object, interfaces=[]):
    local_address: typing.Optional[winsdk.windows.networking.HostName]
    remote_address: typing.Optional[winsdk.windows.networking.HostName]
    remote_port: str
    @staticmethod
...
class MessageWebSocket(_winrt.Object, interfaces=[IWebSocket, winsdk.windows.foundation.IClosable]):
...
class MessageWebSocketControl(_winrt.Object, interfaces=[IWebSocketControl, IWebSocketControl2]):
...
class MessageWebSocketInformation(_winrt.Object, interfaces=[IWebSocketInformation, IWebSocketInformation2]):
...
class MessageWebSocketMessageReceivedEventArgs(_winrt.Object, interfaces=[]):
    message_type: SocketMessageType
...
class ServerMessageWebSocket(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class ServerMessageWebSocketControl(_winrt.Object, interfaces=[]):
    message_type: SocketMessageType
    @staticmethod
    def _from(obj: _winrt.Object) -> ServerMessageWebSocketControl: ...

class ServerMessageWebSocketInformation(_winrt.Object, interfaces=[]):
    bandwidth_statistics: BandwidthStatistics
    local_address: typing.Optional[winsdk.windows.networking.HostName]
    protocol: str
    @staticmethod
...
class ServerStreamWebSocket(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class ServerStreamWebSocketInformation(_winrt.Object, interfaces=[]):
    bandwidth_statistics: BandwidthStatistics
    local_address: typing.Optional[winsdk.windows.networking.HostName]
    protocol: str
    @staticmethod
...
class SocketActivityContext(_winrt.Object, interfaces=[]):
...
class SocketActivityInformation(_winrt.Object, interfaces=[]):
...
class SocketActivityTriggerDetails(_winrt.Object, interfaces=[]):
...
class StreamSocket(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class StreamSocketControl(_winrt.Object, interfaces=[]):
    quality_of_service: SocketQualityOfService
    outbound_unicast_hop_limit: _winrt.UInt8
    outbound_buffer_size_in_bytes: _winrt.UInt32
...
class StreamSocketInformation(_winrt.Object, interfaces=[]):
    bandwidth_statistics: BandwidthStatistics
    local_address: typing.Optional[winsdk.windows.networking.HostName]
    local_port: str
...
class StreamSocketListener(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class StreamSocketListenerConnectionReceivedEventArgs(_winrt.Object, interfaces=[]):
    socket: typing.Optional[StreamSocket]
    @staticmethod
    def _from(obj: _winrt.Object) -> StreamSocketListenerConnectionReceivedEventArgs: ...

class StreamSocketListenerControl(_winrt.Object, interfaces=[]):
    quality_of_service: SocketQualityOfService
    outbound_unicast_hop_limit: _winrt.UInt8
    outbound_buffer_size_in_bytes: _winrt.UInt32
    no_delay: _winrt.Boolean
...
class StreamSocketListenerInformation(_winrt.Object, interfaces=[]):
    local_port: str
    @staticmethod
    def _from(obj: _winrt.Object) -> StreamSocketListenerInformation: ...

class StreamWebSocket(_winrt.Object, interfaces=[IWebSocket, winsdk.windows.foundation.IClosable]):
...
class StreamWebSocketControl(_winrt.Object, interfaces=[IWebSocketControl, IWebSocketControl2]):
    no_delay: _winrt.Boolean
    desired_unsolicited_pong_interval: winsdk.windows.foundation.TimeSpan
    client_certificate: typing.Optional[winsdk.windows.security.cryptography.certificates.Certificate]
    actual_unsolicited_pong_interval: winsdk.windows.foundation.TimeSpan
...
class StreamWebSocketInformation(_winrt.Object, interfaces=[IWebSocketInformation, IWebSocketInformation2]):
    bandwidth_statistics: BandwidthStatistics
    local_address: typing.Optional[winsdk.windows.networking.HostName]
    protocol: str
    server_certificate: typing.Optional[winsdk.windows.security.cryptography.certificates.Certificate]
...
class WebSocketClosedEventArgs(_winrt.Object, interfaces=[]):
    code: _winrt.UInt16
    reason: str
    @staticmethod
...
class WebSocketKeepAlive(_winrt.Object, interfaces=[winsdk.windows.applicationmodel.background.IBackgroundTask]):
    @staticmethod
...
class WebSocketServerCustomValidationRequestedEventArgs(_winrt.Object, interfaces=[]):
    server_certificate: typing.Optional[winsdk.windows.security.cryptography.certificates.Certificate]
    server_certificate_error_severity: SocketSslErrorSeverity
    server_certificate_errors: typing.Optional[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.security.cryptography.certificates.ChainValidationResult]]
    server_intermediate_certificates: typing.Optional[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.security.cryptography.certificates.Certificate]]
...
class IControlChannelTriggerEventDetails(typing.Protocol):
...
class IControlChannelTriggerResetEventDetails(typing.Protocol):
...
class IWebSocket(typing.Protocol):
    output_stream: typing.Optional[winsdk.windows.storage.streams.IOutputStream]
    @staticmethod
...
class IWebSocketControl(typing.Protocol):
    outbound_buffer_size_in_bytes: _winrt.UInt32
    proxy_credential: typing.Optional[winsdk.windows.security.credentials.PasswordCredential]
    server_credential: typing.Optional[winsdk.windows.security.credentials.PasswordCredential]
    supported_protocols: typing.Optional[winsdk.windows.foundation.collections.IVector[str]]
...
class IWebSocketControl2(typing.Protocol):
    ignorable_server_certificate_errors: typing.Optional[winsdk.windows.foundation.collections.IVector[winsdk.windows.security.cryptography.certificates.ChainValidationResult]]
    outbound_buffer_size_in_bytes: _winrt.UInt32
    proxy_credential: typing.Optional[winsdk.windows.security.credentials.PasswordCredential]
    server_credential: typing.Optional[winsdk.windows.security.credentials.PasswordCredential]
...
class IWebSocketInformation(typing.Protocol):
    bandwidth_statistics: BandwidthStatistics
    local_address: typing.Optional[winsdk.windows.networking.HostName]
    protocol: str
    @staticmethod
...
class IWebSocketInformation2(typing.Protocol):
    server_certificate: typing.Optional[winsdk.windows.security.cryptography.certificates.Certificate]
    server_certificate_error_severity: SocketSslErrorSeverity
    server_certificate_errors: typing.Optional[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.security.cryptography.certificates.ChainValidationResult]]
    server_intermediate_certificates: typing.Optional[winsdk.windows.foundation.collections.IVectorView[winsdk.windows.security.cryptography.certificates.Certificate]]
