...
class BandwidthStatistics:
    ...
    def __new__(cls: typing.Type[BandwidthStatistics], outbound_bits_per_second: _winrt.UInt64, inbound_bits_per_second: _winrt.UInt64, outbound_bits_per_second_instability: _winrt.UInt64, inbound_bits_per_second_instability: _winrt.UInt64, outbound_bandwidth_peaked: _winrt.Boolean, inbound_bandwidth_peaked: _winrt.Boolean) -> BandwidthStatistics: ...
...
class RoundTripTimeStatistics:
    ...
    min: _winrt.UInt32
    sum: _winrt.UInt32
    def __new__(cls: typing.Type[RoundTripTimeStatistics], variance: _winrt.UInt32, max: _winrt.UInt32, min: _winrt.UInt32, sum: _winrt.UInt32) -> RoundTripTimeStatistics: ...
...
class ControlChannelTrigger(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[ControlChannelTrigger], channel_id: str, server_keep_alive_interval_in_minutes: _winrt.UInt32) -> ControlChannelTrigger:...
    @typing.overload
    def __new__(cls: typing.Type[ControlChannelTrigger], channel_id: str, server_keep_alive_interval_in_minutes: _winrt.UInt32, resource_request_type: ControlChannelTriggerResourceType) -> ControlChannelTrigger:...
    def close(self) -> None: ...
...
class DatagramSocket(_winrt.Object):
    ...
    @typing.overload
    def enable_transfer_ownership(self, task_id: _winrt.Guid) -> None: ...
    @typing.overload
    def enable_transfer_ownership(self, task_id: _winrt.Guid, connected_standby_action: SocketActivityConnectedStandbyAction) -> None: ...
    @typing.overload
    @staticmethod
