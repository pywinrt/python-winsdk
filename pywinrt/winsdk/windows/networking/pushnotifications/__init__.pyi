...
class PushNotificationChannel(_winrt.Object, interfaces=[]):
...
class PushNotificationChannelManagerForUser(_winrt.Object, interfaces=[]):
...
class PushNotificationChannelsRevokedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> PushNotificationChannelsRevokedEventArgs: ...

class PushNotificationReceivedEventArgs(_winrt.Object, interfaces=[]):
...
class RawNotification(_winrt.Object, interfaces=[]):
    content: str
    channel_id: str
