...
class VpnChannel(_winrt.Object):
    ...
    @typing.overload
    def request_credentials_async(self, cred_type: VpnCredentialType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VpnCredential]]: ...
    @typing.overload
    def request_credentials_async(self, cred_type: VpnCredentialType, cred_options: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VpnCredential]]: ...
    @typing.overload
    def request_credentials_async(self, cred_type: VpnCredentialType, cred_options: _winrt.UInt32, certificate: typing.Optional[winsdk.windows.security.cryptography.certificates.Certificate]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VpnCredential]]: ...
    ...
    @typing.overload
    def start_with_traffic_filter(self, assigned_client_ipv4_addresses: typing.Iterable[typing.Optional[winsdk.windows.networking.HostName]], assigned_client_ipv6_addresses: typing.Iterable[typing.Optional[winsdk.windows.networking.HostName]], vpninterface_id: typing.Optional[VpnInterfaceId], assigned_routes: typing.Optional[VpnRouteAssignment], assigned_namespace: typing.Optional[VpnDomainNameAssignment], mtu_size: _winrt.UInt32, max_frame_size: _winrt.UInt32, reserved: _winrt.Boolean, transports: typing.Iterable[typing.Optional[_winrt.Object]], assigned_traffic_filters: typing.Optional[VpnTrafficFilterAssignment]) -> None: ...
    @typing.overload
...
class VpnDomainNameInfo(_winrt.Object):
    ...
    def __init__(self, name: str, name_type: VpnDomainNameType, dns_server_list: typing.Iterable[typing.Optional[winsdk.windows.networking.HostName]], proxy_server_list: typing.Iterable[typing.Optional[winsdk.windows.networking.HostName]]) -> None: ...
...
class VpnManagementAgent(_winrt.Object):
    ...
    def __init__(self) -> None: ...
    def add_profile_from_object_async(self, profile: typing.Optional[IVpnProfile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VpnManagementErrorStatus]]: ...
    def add_profile_from_xml_async(self, xml: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VpnManagementErrorStatus]]: ...
    def connect_profile_async(self, profile: typing.Optional[IVpnProfile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VpnManagementErrorStatus]]: ...
    def connect_profile_with_password_credential_async(self, profile: typing.Optional[IVpnProfile], password_credential: typing.Optional[winsdk.windows.security.credentials.PasswordCredential]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VpnManagementErrorStatus]]: ...
    def delete_profile_async(self, profile: typing.Optional[IVpnProfile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VpnManagementErrorStatus]]: ...
    def disconnect_profile_async(self, profile: typing.Optional[IVpnProfile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VpnManagementErrorStatus]]: ...
    def get_profiles_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[IVpnProfile]]]: ...
    def update_profile_from_object_async(self, profile: typing.Optional[IVpnProfile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VpnManagementErrorStatus]]: ...
    def update_profile_from_xml_async(self, xml: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[VpnManagementErrorStatus]]: ...
...
class IVpnDomainNameInfoFactory(_winrt.Object):
    ...
    def create_vpn_domain_name_info(self, name: str, name_type: VpnDomainNameType, dns_server_list: typing.Iterable[typing.Optional[winsdk.windows.networking.HostName]], proxy_server_list: typing.Iterable[typing.Optional[winsdk.windows.networking.HostName]]) -> typing.Optional[VpnDomainNameInfo]: ...
