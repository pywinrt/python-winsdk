...
class SyndicationAttribute(_winrt.Object, interfaces=[]):
    value: str
    namespace: str
    name: str
    @staticmethod
...
class SyndicationCategory(_winrt.Object, interfaces=[ISyndicationNode]):
    term: str
    scheme: str
    label: str
    node_value: str
...
class SyndicationClient(_winrt.Object, interfaces=[ISyndicationClient]):
...
class SyndicationContent(_winrt.Object, interfaces=[ISyndicationText, ISyndicationNode]):
...
class SyndicationFeed(_winrt.Object, interfaces=[ISyndicationNode]):
...
class SyndicationGenerator(_winrt.Object, interfaces=[ISyndicationNode]):
    version: str
...
class SyndicationItem(_winrt.Object, interfaces=[ISyndicationNode]):
    title: typing.Optional[ISyndicationText]
...
class SyndicationLink(_winrt.Object, interfaces=[ISyndicationNode]):
    uri: typing.Optional[winsdk.windows.foundation.Uri]
    title: str
...
class SyndicationNode(_winrt.Object, interfaces=[ISyndicationNode]):
    node_value: str
    node_namespace: str
    node_name: str
    language: str
...
class SyndicationPerson(_winrt.Object, interfaces=[ISyndicationNode]):
    node_value: str
    node_namespace: str
    node_name: str
    language: str
...
class SyndicationText(_winrt.Object, interfaces=[ISyndicationText, ISyndicationNode]):
    node_value: str
    node_namespace: str
    node_name: str
    language: str
...
class ISyndicationClient(typing.Protocol):
    bypass_cache_on_retrieve: _winrt.Boolean
    max_response_buffer_size: _winrt.UInt32
    proxy_credential: typing.Optional[winsdk.windows.security.credentials.PasswordCredential]
    server_credential: typing.Optional[winsdk.windows.security.credentials.PasswordCredential]
...
class ISyndicationNode(typing.Protocol):
    attribute_extensions: typing.Optional[winsdk.windows.foundation.collections.IVector[SyndicationAttribute]]
    base_uri: typing.Optional[winsdk.windows.foundation.Uri]
    element_extensions: typing.Optional[winsdk.windows.foundation.collections.IVector[ISyndicationNode]]
    language: str
...
class ISyndicationText(typing.Protocol):
    text: str
    type: str
    xml: typing.Optional[winsdk.windows.data.xml.dom.XmlDocument]
    attribute_extensions: typing.Optional[winsdk.windows.foundation.collections.IVector[SyndicationAttribute]]
