...
class RetrievalProgress:
    ...
    def __new__(cls: typing.Type[RetrievalProgress], bytes_retrieved: _winrt.UInt32, total_bytes_to_retrieve: _winrt.UInt32) -> RetrievalProgress: ...
...
class TransferProgress:
    ...
    bytes_retrieved: _winrt.UInt32
    total_bytes_to_retrieve: _winrt.UInt32
    def __new__(cls: typing.Type[TransferProgress], bytes_sent: _winrt.UInt32, total_bytes_to_send: _winrt.UInt32, bytes_retrieved: _winrt.UInt32, total_bytes_to_retrieve: _winrt.UInt32) -> TransferProgress: ...
...
class SyndicationLink(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SyndicationLink], uri: typing.Optional[winsdk.windows.foundation.Uri], relationship: str, title: str, media_type: str, length: _winrt.UInt32) -> SyndicationLink:...
    @typing.overload
