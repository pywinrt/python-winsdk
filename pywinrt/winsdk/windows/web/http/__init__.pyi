...
class HttpBufferContent(IHttpContent, winsdk.windows.foundation.IClosable, winsdk.windows.foundation.IStringable, _winrt.Object):
    ...
    def __init__(self, content: winsdk.windows.storage.streams.IBuffer, offset: _winrt.UInt32, count: _winrt.UInt32) -> None:
        ...
    def buffer_all_async() -> winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.UInt64, _winrt.UInt64]:
        ...
    def close() -> None:
        ...
    def read_as_buffer_async() -> winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.storage.streams.IBuffer, _winrt.UInt64]:
        ...
    def read_as_input_stream_async() -> winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.storage.streams.IInputStream, _winrt.UInt64]:
        ...
    def read_as_string_async() -> winsdk.windows.foundation.IAsyncOperationWithProgress[str, _winrt.UInt64]:
        ...
    def to_string() -> str:
        ...
    def try_compute_length() -> typing.Tuple[_winrt.Boolean, _winrt.UInt64]:
        ...
    def write_to_stream_async(output_stream: winsdk.windows.storage.streams.IOutputStream) -> winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.UInt64, _winrt.UInt64]:
        ...
...
class HttpClient(winsdk.windows.foundation.IClosable, winsdk.windows.foundation.IStringable, _winrt.Object):
    ...
    def close() -> None:
        ...
    def delete_async(uri: winsdk.windows.foundation.Uri) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]:
        ...
    def get_async(uri: winsdk.windows.foundation.Uri) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]:
        ...
    def get_async(uri: winsdk.windows.foundation.Uri, completion_option: HttpCompletionOption) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]:
        ...
    def get_buffer_async(uri: winsdk.windows.foundation.Uri) -> winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.storage.streams.IBuffer, HttpProgress]:
        ...
    def get_input_stream_async(uri: winsdk.windows.foundation.Uri) -> winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.storage.streams.IInputStream, HttpProgress]:
        ...
    def get_string_async(uri: winsdk.windows.foundation.Uri) -> winsdk.windows.foundation.IAsyncOperationWithProgress[str, HttpProgress]:
        ...
    def post_async(uri: winsdk.windows.foundation.Uri, content: IHttpContent) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]:
        ...
    def put_async(uri: winsdk.windows.foundation.Uri, content: IHttpContent) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]:
        ...
    def send_request_async(request: HttpRequestMessage) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]:
        ...
    def send_request_async(request: HttpRequestMessage, completion_option: HttpCompletionOption) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]:
        ...
    def to_string() -> str:
        ...
    def try_delete_async(uri: winsdk.windows.foundation.Uri) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]:
        ...
    def try_get_async(uri: winsdk.windows.foundation.Uri) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]:
        ...
    def try_get_async(uri: winsdk.windows.foundation.Uri, completion_option: HttpCompletionOption) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]:
        ...
    def try_get_buffer_async(uri: winsdk.windows.foundation.Uri) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpGetBufferResult, HttpProgress]:
        ...
    def try_get_input_stream_async(uri: winsdk.windows.foundation.Uri) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpGetInputStreamResult, HttpProgress]:
        ...
    def try_get_string_async(uri: winsdk.windows.foundation.Uri) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpGetStringResult, HttpProgress]:
        ...
    def try_post_async(uri: winsdk.windows.foundation.Uri, content: IHttpContent) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]:
        ...
    def try_put_async(uri: winsdk.windows.foundation.Uri, content: IHttpContent) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]:
        ...
    def try_send_request_async(request: HttpRequestMessage) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]:
        ...
    def try_send_request_async(request: HttpRequestMessage, completion_option: HttpCompletionOption) -> winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]:
        ...
...
class HttpCookieCollection(winsdk.windows.foundation.collections.IVectorView[HttpCookie], winsdk.windows.foundation.collections.IIterable[HttpCookie], _winrt.Object):
    ...
    size: _winrt.UInt32
    def first() -> winsdk.windows.foundation.collections.IIterator[HttpCookie]:
        ...
    def get_at(index: _winrt.UInt32) -> HttpCookie:
        ...
    def get_many(start_index: _winrt.UInt32, items_size: _winrt.UInt32) -> typing.Tuple[_winrt.UInt32, typing.List[HttpCookie]]:
        ...
    def index_of(value: HttpCookie) -> typing.Tuple[_winrt.Boolean, _winrt.UInt32]:
        ...
...
class HttpCookieManager(_winrt.Object):
    ...
    def delete_cookie(cookie: HttpCookie) -> None:
        ...
    def get_cookies(uri: winsdk.windows.foundation.Uri) -> HttpCookieCollection:
        ...
    def set_cookie(cookie: HttpCookie) -> _winrt.Boolean:
        ...
    def set_cookie(cookie: HttpCookie, third_party: _winrt.Boolean) -> _winrt.Boolean:
        ...
...
class HttpMultipartContent(IHttpContent, winsdk.windows.foundation.IClosable, winsdk.windows.foundation.collections.IIterable[IHttpContent], winsdk.windows.foundation.IStringable, _winrt.Object):
    ...
    def close() -> None:
        ...
    def first() -> winsdk.windows.foundation.collections.IIterator[IHttpContent]:
        ...
    def read_as_buffer_async() -> winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.storage.streams.IBuffer, _winrt.UInt64]:
        ...
    def read_as_input_stream_async() -> winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.storage.streams.IInputStream, _winrt.UInt64]:
