...
class HttpBufferContent(IHttpContent, winsdk.windows.foundation.IClosable, winsdk.windows.foundation.IStringable, _winrt.Object):
    ...
    def buffer_all_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.UInt64, _winrt.UInt64]]: ...
    def close(self) -> None: ...
    def read_as_buffer_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.storage.streams.IBuffer, _winrt.UInt64]]: ...
    def read_as_input_stream_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.storage.streams.IInputStream, _winrt.UInt64]]: ...
    def read_as_string_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[str, _winrt.UInt64]]: ...
    def to_string(self) -> str: ...
    def try_compute_length(self, ) -> typing.Tuple[_winrt.Boolean, _winrt.UInt64]: ...
    def write_to_stream_async(self, output_stream: typing.Optional[winsdk.windows.storage.streams.IOutputStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.UInt64, _winrt.UInt64]]: ...
...
class HttpClient(winsdk.windows.foundation.IClosable, winsdk.windows.foundation.IStringable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def delete_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]]: ...
    @typing.overload
    def get_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]]: ...
    @typing.overload
    def get_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], completion_option: HttpCompletionOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]]: ...
    def get_buffer_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.storage.streams.IBuffer, HttpProgress]]: ...
    def get_input_stream_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.storage.streams.IInputStream, HttpProgress]]: ...
    def get_string_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[str, HttpProgress]]: ...
    def post_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], content: typing.Optional[IHttpContent]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]]: ...
    def put_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], content: typing.Optional[IHttpContent]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]]: ...
    @typing.overload
    def send_request_async(self, request: typing.Optional[HttpRequestMessage]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]]: ...
    @typing.overload
    def send_request_async(self, request: typing.Optional[HttpRequestMessage], completion_option: HttpCompletionOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]]: ...
    def to_string(self) -> str: ...
    def try_delete_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]]: ...
    @typing.overload
    def try_get_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]]: ...
    @typing.overload
    def try_get_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], completion_option: HttpCompletionOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]]: ...
    def try_get_buffer_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpGetBufferResult, HttpProgress]]: ...
    def try_get_input_stream_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpGetInputStreamResult, HttpProgress]]: ...
    def try_get_string_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpGetStringResult, HttpProgress]]: ...
    def try_post_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], content: typing.Optional[IHttpContent]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]]: ...
    def try_put_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], content: typing.Optional[IHttpContent]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]]: ...
    @typing.overload
    def try_send_request_async(self, request: typing.Optional[HttpRequestMessage]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]]: ...
    @typing.overload
    def try_send_request_async(self, request: typing.Optional[HttpRequestMessage], completion_option: HttpCompletionOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]]: ...
...
class HttpCookieCollection(winsdk.windows.foundation.collections.IVectorView[HttpCookie], winsdk.windows.foundation.collections.IIterable[HttpCookie], _winrt.Object):
    ...
    def get_many(self, start_index: _winrt.UInt32, items_size: _winrt.UInt32) -> typing.Tuple[_winrt.UInt32, typing.List[typing.Optional[HttpCookie]]]: ...
...
class HttpFormUrlEncodedContent(IHttpContent, winsdk.windows.foundation.IClosable, winsdk.windows.foundation.IStringable, _winrt.Object):
    ...
    def __init__(self, content: typing.Iterable[typing.Optional[winsdk.windows.foundation.collections.IKeyValuePair[str, str]]]) -> None: ...
    def buffer_all_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.UInt64, _winrt.UInt64]]: ...
    def close(self) -> None: ...
    def read_as_buffer_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.storage.streams.IBuffer, _winrt.UInt64]]: ...
    def read_as_input_stream_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.storage.streams.IInputStream, _winrt.UInt64]]: ...
