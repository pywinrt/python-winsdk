...
class HttpProgress:
    ...
    def __new__(cls: typing.Type[HttpProgress], stage: HttpProgressStage, bytes_sent: _winrt.UInt64, total_bytes_to_send: _winrt.UInt64, bytes_received: _winrt.UInt64, total_bytes_to_receive: _winrt.UInt64, retries: _winrt.UInt32) -> HttpProgress: ...
...
class HttpBufferContent(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[HttpBufferContent], content: typing.Optional[winsdk.windows.storage.streams.IBuffer], offset: _winrt.UInt32, count: _winrt.UInt32) -> HttpBufferContent:...
