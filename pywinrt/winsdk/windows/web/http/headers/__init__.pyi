...
class HttpContentCodingWithQualityHeaderValue(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[HttpContentCodingWithQualityHeaderValue], content_coding: str, quality: _winrt.Double) -> HttpContentCodingWithQualityHeaderValue:...
    @staticmethod
...
class HttpContentRangeHeaderValue(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[HttpContentRangeHeaderValue], length: _winrt.UInt64) -> HttpContentRangeHeaderValue:...
    @typing.overload
    def __new__(cls: typing.Type[HttpContentRangeHeaderValue], from_: _winrt.UInt64, to: _winrt.UInt64) -> HttpContentRangeHeaderValue:...
    @typing.overload
    def __new__(cls: typing.Type[HttpContentRangeHeaderValue], from_: _winrt.UInt64, to: _winrt.UInt64, length: _winrt.UInt64) -> HttpContentRangeHeaderValue:...
    @staticmethod
...
class HttpLanguageRangeWithQualityHeaderValue(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[HttpLanguageRangeWithQualityHeaderValue], language_range: str, quality: _winrt.Double) -> HttpLanguageRangeWithQualityHeaderValue:...
    @staticmethod
...
class HttpMediaTypeWithQualityHeaderValue(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[HttpMediaTypeWithQualityHeaderValue], media_type: str, quality: _winrt.Double) -> HttpMediaTypeWithQualityHeaderValue:...
    @staticmethod
