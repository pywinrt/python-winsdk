...
class HttpBaseProtocolFilter(IHttpFilter, winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def send_request_async(self, request: typing.Optional[winsdk.windows.web.http.HttpRequestMessage]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[winsdk.windows.web.http.HttpResponseMessage, winsdk.windows.web.http.HttpProgress]]: ...
