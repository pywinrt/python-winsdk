...
class HttpBaseProtocolFilter(_winrt.Object, interfaces=[IHttpFilter, winsdk.windows.foundation.IClosable]):
...
class HttpCacheControl(_winrt.Object, interfaces=[]):
    write_behavior: HttpCacheWriteBehavior
    read_behavior: HttpCacheReadBehavior
    @staticmethod
    def _from(obj: _winrt.Object) -> HttpCacheControl: ...

class HttpServerCustomValidationRequestedEventArgs(_winrt.Object, interfaces=[]):
...
class IHttpFilter(typing.Protocol):
    @staticmethod
