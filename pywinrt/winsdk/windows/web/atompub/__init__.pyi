...
class AtomPubClient(_winrt.Object, interfaces=[winsdk.windows.web.syndication.ISyndicationClient]):
...
class ResourceCollection(_winrt.Object, interfaces=[winsdk.windows.web.syndication.ISyndicationNode]):
...
class ServiceDocument(_winrt.Object, interfaces=[winsdk.windows.web.syndication.ISyndicationNode]):
...
class Workspace(_winrt.Object, interfaces=[winsdk.windows.web.syndication.ISyndicationNode]):
