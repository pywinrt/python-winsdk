...
class WebError(winsdk.system.Object):
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> WebError: ...
    @staticmethod
    def get_status(hresult: winsdk.system.Int32, /) -> WebErrorStatus: ...

class IUriToStreamResolver(winsdk.system.Object):
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> IUriToStreamResolver: ...
    def uri_to_stream_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri], /) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IInputStream]: ...
