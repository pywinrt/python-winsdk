...
class IUriToStreamResolver(_winrt.Object):
    ...
    def uri_to_stream_async(self, uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IInputStream]]: ...
