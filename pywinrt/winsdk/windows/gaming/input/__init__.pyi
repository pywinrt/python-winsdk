...
class ArcadeStick(IGameController, IGameControllerBatteryInfo, _winrt.Object):
    ...
    headset: Headset
    is_wireless: _winrt.Boolean
    user: winsdk.windows.system.User
    arcade_sticks: winsdk.windows.foundation.collections.IVectorView[ArcadeStick]
    ...
    def try_get_battery_report() -> winsdk.windows.devices.power.BatteryReport:
        ...
    def add_headset_connected(value: winsdk.windows.foundation.TypedEventHandler[IGameController, Headset]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_headset_connected(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_headset_disconnected(value: winsdk.windows.foundation.TypedEventHandler[IGameController, Headset]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_headset_disconnected(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_user_changed(value: winsdk.windows.foundation.TypedEventHandler[IGameController, winsdk.windows.system.UserChangedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_user_changed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
...
class FlightStick(IGameController, IGameControllerBatteryInfo, _winrt.Object):
    ...
    hat_switch_kind: GameControllerSwitchKind
    headset: Headset
    is_wireless: _winrt.Boolean
    user: winsdk.windows.system.User
    flight_sticks: winsdk.windows.foundation.collections.IVectorView[FlightStick]
...
class Gamepad(IGameController, IGameControllerBatteryInfo, _winrt.Object):
    ...
    headset: Headset
    is_wireless: _winrt.Boolean
    user: winsdk.windows.system.User
    vibration: GamepadVibration
    gamepads: winsdk.windows.foundation.collections.IVectorView[Gamepad]
...
class Headset(IGameControllerBatteryInfo, _winrt.Object):
    ...
...
class RacingWheel(IGameController, IGameControllerBatteryInfo, _winrt.Object):
    ...
    headset: Headset
    is_wireless: _winrt.Boolean
    user: winsdk.windows.system.User
    ...
    wheel_motor: winsdk.windows.gaming.input.forcefeedback.ForceFeedbackMotor
    racing_wheels: winsdk.windows.foundation.collections.IVectorView[RacingWheel]
...
class RawGameController(IGameController, IGameControllerBatteryInfo, _winrt.Object):
    ...
    headset: Headset
    is_wireless: _winrt.Boolean
    user: winsdk.windows.system.User
    ...
    force_feedback_motors: winsdk.windows.foundation.collections.IVectorView[winsdk.windows.gaming.input.forcefeedback.ForceFeedbackMotor]
    hardware_product_id: _winrt.UInt16
    hardware_vendor_id: _winrt.UInt16
    switch_count: _winrt.Int32
    display_name: str
    non_roamable_id: str
    simple_haptics_controllers: winsdk.windows.foundation.collections.IVectorView[winsdk.windows.devices.haptics.SimpleHapticsController]
    raw_game_controllers: winsdk.windows.foundation.collections.IVectorView[RawGameController]
    def from_game_controller(game_controller: IGameController) -> RawGameController:
        ...
    def get_button_label(button_index: _winrt.Int32) -> GameControllerButtonLabel:
        ...
    def get_current_reading(button_array_size: _winrt.UInt32, switch_array_size: _winrt.UInt32, axis_array_size: _winrt.UInt32) -> typing.Tuple[_winrt.UInt64, typing.List[_winrt.Boolean], typing.List[GameControllerSwitchPosition], typing.List[_winrt.Double]]:
        ...
    def get_switch_kind(switch_index: _winrt.Int32) -> GameControllerSwitchKind:
        ...
    def try_get_battery_report() -> winsdk.windows.devices.power.BatteryReport:
        ...
    def add_headset_connected(value: winsdk.windows.foundation.TypedEventHandler[IGameController, Headset]) -> winsdk.windows.foundation.EventRegistrationToken:
...
class UINavigationController(IGameController, IGameControllerBatteryInfo, _winrt.Object):
    ...
    headset: Headset
    is_wireless: _winrt.Boolean
    user: winsdk.windows.system.User
    u_i_navigation_controllers: winsdk.windows.foundation.collections.IVectorView[UINavigationController]
