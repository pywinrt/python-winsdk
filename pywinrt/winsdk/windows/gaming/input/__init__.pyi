...
class ArcadeStickReading:
    ...
    def __new__(cls: typing.Type[ArcadeStickReading], timestamp: winsdk.system.UInt64, buttons: ArcadeStickButtons) -> ArcadeStickReading: ...

class FlightStickReading:
    timestamp: winsdk.system.UInt64
    buttons: FlightStickButtons
    hat_switch: GameControllerSwitchPosition
    roll: winsdk.system.Double
    pitch: winsdk.system.Double
    yaw: winsdk.system.Double
    throttle: winsdk.system.Double
    def __new__(cls: typing.Type[FlightStickReading], timestamp: winsdk.system.UInt64, buttons: FlightStickButtons, hat_switch: GameControllerSwitchPosition, roll: winsdk.system.Double, pitch: winsdk.system.Double, yaw: winsdk.system.Double, throttle: winsdk.system.Double) -> FlightStickReading: ...
...
class GamepadReading:
    ...
    def __new__(cls: typing.Type[GamepadReading], timestamp: winsdk.system.UInt64, buttons: GamepadButtons, left_trigger: winsdk.system.Double, right_trigger: winsdk.system.Double, left_thumbstick_x: winsdk.system.Double, left_thumbstick_y: winsdk.system.Double, right_thumbstick_x: winsdk.system.Double, right_thumbstick_y: winsdk.system.Double) -> GamepadReading: ...

class GamepadVibration:
    left_motor: winsdk.system.Double
    right_motor: winsdk.system.Double
    left_trigger: winsdk.system.Double
    right_trigger: winsdk.system.Double
    def __new__(cls: typing.Type[GamepadVibration], left_motor: winsdk.system.Double, right_motor: winsdk.system.Double, left_trigger: winsdk.system.Double, right_trigger: winsdk.system.Double) -> GamepadVibration: ...

class RacingWheelReading:
    timestamp: winsdk.system.UInt64
    buttons: RacingWheelButtons
    pattern_shifter_gear: winsdk.system.Int32
    wheel: winsdk.system.Double
    throttle: winsdk.system.Double
    brake: winsdk.system.Double
    clutch: winsdk.system.Double
    handbrake: winsdk.system.Double
    def __new__(cls: typing.Type[RacingWheelReading], timestamp: winsdk.system.UInt64, buttons: RacingWheelButtons, pattern_shifter_gear: winsdk.system.Int32, wheel: winsdk.system.Double, throttle: winsdk.system.Double, brake: winsdk.system.Double, clutch: winsdk.system.Double, handbrake: winsdk.system.Double) -> RacingWheelReading: ...

class UINavigationReading:
    timestamp: winsdk.system.UInt64
    required_buttons: RequiredUINavigationButtons
    optional_buttons: OptionalUINavigationButtons
    def __new__(cls: typing.Type[UINavigationReading], timestamp: winsdk.system.UInt64, required_buttons: RequiredUINavigationButtons, optional_buttons: OptionalUINavigationButtons) -> UINavigationReading: ...

class ArcadeStick(winsdk.system.Object):
    headset: typing.Optional[Headset]
    is_wireless: winsdk.system.Boolean
    user: typing.Optional[winsdk.windows.system.User]
    arcade_sticks: typing.ClassVar[typing.Optional[winsdk.windows.foundation.collections.IVectorView[ArcadeStick]]]
    @staticmethod
    def _from(obj: winsdk.system.Object) -> ArcadeStick: ...
    @staticmethod
...
class FlightStick(winsdk.system.Object):
    hat_switch_kind: GameControllerSwitchKind
    headset: typing.Optional[Headset]
    is_wireless: winsdk.system.Boolean
    user: typing.Optional[winsdk.windows.system.User]
    flight_sticks: typing.ClassVar[typing.Optional[winsdk.windows.foundation.collections.IVectorView[FlightStick]]]
    @staticmethod
    def _from(obj: winsdk.system.Object) -> FlightStick: ...
    @staticmethod
...
class Gamepad(winsdk.system.Object):
    headset: typing.Optional[Headset]
    is_wireless: winsdk.system.Boolean
    user: typing.Optional[winsdk.windows.system.User]
    vibration: GamepadVibration
    gamepads: typing.ClassVar[typing.Optional[winsdk.windows.foundation.collections.IVectorView[Gamepad]]]
    @staticmethod
    def _from(obj: winsdk.system.Object) -> Gamepad: ...
    @staticmethod
...
class Headset(winsdk.system.Object):
    capture_device_id: str
    render_device_id: str
    @staticmethod
    def _from(obj: winsdk.system.Object) -> Headset: ...
    def try_get_battery_report(self) -> typing.Optional[winsdk.windows.devices.power.BatteryReport]: ...

class RacingWheel(winsdk.system.Object):
    headset: typing.Optional[Headset]
    is_wireless: winsdk.system.Boolean
    user: typing.Optional[winsdk.windows.system.User]
    has_clutch: winsdk.system.Boolean
    has_handbrake: winsdk.system.Boolean
    has_pattern_shifter: winsdk.system.Boolean
    max_pattern_shifter_gear: winsdk.system.Int32
    max_wheel_angle: winsdk.system.Double
    wheel_motor: typing.Optional[winsdk.windows.gaming.input.forcefeedback.ForceFeedbackMotor]
    racing_wheels: typing.ClassVar[typing.Optional[winsdk.windows.foundation.collections.IVectorView[RacingWheel]]]
    @staticmethod
    def _from(obj: winsdk.system.Object) -> RacingWheel: ...
    @staticmethod
...
class RawGameController(winsdk.system.Object):
    headset: typing.Optional[Headset]
    is_wireless: winsdk.system.Boolean
    user: typing.Optional[winsdk.windows.system.User]
    axis_count: winsdk.system.Int32
    button_count: winsdk.system.Int32
    ...
    switch_count: winsdk.system.Int32
    display_name: str
    non_roamable_id: str
    ...
    raw_game_controllers: typing.ClassVar[typing.Optional[winsdk.windows.foundation.collections.IVectorView[RawGameController]]]
    @staticmethod
    def _from(obj: winsdk.system.Object) -> RawGameController: ...
    @staticmethod
    def from_game_controller(game_controller: typing.Optional[IGameController]) -> typing.Optional[RawGameController]: ...
    def get_button_label(self, button_index: winsdk.system.Int32) -> GameControllerButtonLabel: ...
    def get_current_reading(self, button_array: winsdk.system.Array[winsdk.system.Boolean], switch_array: winsdk.system.Array[GameControllerSwitchPosition], axis_array: winsdk.system.Array[winsdk.system.Double]) -> winsdk.system.UInt64: ...
    def get_switch_kind(self, switch_index: winsdk.system.Int32) -> GameControllerSwitchKind: ...
    def try_get_battery_report(self) -> typing.Optional[winsdk.windows.devices.power.BatteryReport]: ...
    def add_headset_connected(self, value: winsdk.windows.foundation.TypedEventHandler[IGameController, Headset]) -> winsdk.windows.foundation.EventRegistrationToken: ...
    def remove_headset_connected(self, token: winsdk.windows.foundation.EventRegistrationToken) -> None: ...
    def add_headset_disconnected(self, value: winsdk.windows.foundation.TypedEventHandler[IGameController, Headset]) -> winsdk.windows.foundation.EventRegistrationToken: ...
...
class UINavigationController(winsdk.system.Object):
    headset: typing.Optional[Headset]
    is_wireless: winsdk.system.Boolean
    user: typing.Optional[winsdk.windows.system.User]
    u_i_navigation_controllers: typing.ClassVar[typing.Optional[winsdk.windows.foundation.collections.IVectorView[UINavigationController]]]
    @staticmethod
    def _from(obj: winsdk.system.Object) -> UINavigationController: ...
    @staticmethod
...
class IGameController(winsdk.system.Object):
    headset: typing.Optional[Headset]
    is_wireless: winsdk.system.Boolean
    user: typing.Optional[winsdk.windows.system.User]
    @staticmethod
    def _from(obj: winsdk.system.Object) -> IGameController: ...
    def add_headset_connected(self, value: winsdk.windows.foundation.TypedEventHandler[IGameController, Headset]) -> winsdk.windows.foundation.EventRegistrationToken: ...
    def remove_headset_connected(self, token: winsdk.windows.foundation.EventRegistrationToken) -> None: ...
    def add_headset_disconnected(self, value: winsdk.windows.foundation.TypedEventHandler[IGameController, Headset]) -> winsdk.windows.foundation.EventRegistrationToken: ...
    def remove_headset_disconnected(self, token: winsdk.windows.foundation.EventRegistrationToken) -> None: ...
...
class IGameControllerBatteryInfo(winsdk.system.Object):
    @staticmethod
    def _from(obj: winsdk.system.Object) -> IGameControllerBatteryInfo: ...
    def try_get_battery_report(self) -> typing.Optional[winsdk.windows.devices.power.BatteryReport]: ...
