...
class ConstantForceEffect(_winrt.Object):
    ...
    def set_parameters_with_envelope(self, vector: winsdk.windows.foundation.numerics.Vector3, attack_gain: _winrt.Single, sustain_gain: _winrt.Single, release_gain: _winrt.Single, start_delay: datetime.timedelta, attack_duration: datetime.timedelta, sustain_duration: datetime.timedelta, release_duration: datetime.timedelta, repeat_count: _winrt.UInt32) -> None: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
...
class PeriodicForceEffect(_winrt.Object):
    ...
    def set_parameters(self, vector: winsdk.windows.foundation.numerics.Vector3, frequency: _winrt.Single, phase: _winrt.Single, bias: _winrt.Single, duration: datetime.timedelta) -> None: ...
