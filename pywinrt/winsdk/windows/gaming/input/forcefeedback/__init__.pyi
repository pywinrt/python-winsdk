...
class ForceFeedbackMotor(_winrt.Object):
    ...
    def load_effect_async(self, effect: typing.Optional[IForceFeedbackEffect]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ForceFeedbackLoadEffectResult]]: ...
    def pause_all_effects(self) -> None: ...
    def resume_all_effects(self) -> None: ...
    def stop_all_effects(self) -> None: ...
    def try_disable_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_enable_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_reset_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_unload_effect_async(self, effect: typing.Optional[IForceFeedbackEffect]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
