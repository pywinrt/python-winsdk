...
class GameSaveBlobGetResult(_winrt.Object, interfaces=[]):
...
class GameSaveBlobInfo(_winrt.Object, interfaces=[]):
    name: str
    size: _winrt.UInt32
    @staticmethod
    def _from(obj: _winrt.Object) -> GameSaveBlobInfo: ...

class GameSaveBlobInfoGetResult(_winrt.Object, interfaces=[]):
    status: GameSaveErrorStatus
...
class GameSaveBlobInfoQuery(_winrt.Object, interfaces=[]):
    @staticmethod
...
class GameSaveContainer(_winrt.Object, interfaces=[]):
    name: str
...
class GameSaveContainerInfo(_winrt.Object, interfaces=[]):
    display_name: str
...
class GameSaveContainerInfoGetResult(_winrt.Object, interfaces=[]):
    status: GameSaveErrorStatus
...
class GameSaveContainerInfoQuery(_winrt.Object, interfaces=[]):
    @staticmethod
...
class GameSaveOperationResult(_winrt.Object, interfaces=[]):
    status: GameSaveErrorStatus
    @staticmethod
    def _from(obj: _winrt.Object) -> GameSaveOperationResult: ...

class GameSaveProvider(_winrt.Object, interfaces=[]):
...
class GameSaveProviderGetResult(_winrt.Object, interfaces=[]):
    status: GameSaveErrorStatus
