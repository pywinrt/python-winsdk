...
class CurrencyFormatter(_winrt.Object, interfaces=[INumberParser, INumberFormatter2, INumberFormatter, INumberFormatterOptions, ISignificantDigitsOption, INumberRounderOption, ISignedZeroOption]):
    currency: str
...
class DecimalFormatter(_winrt.Object, interfaces=[INumberFormatterOptions, INumberFormatter, INumberFormatter2, INumberParser, ISignificantDigitsOption, INumberRounderOption, ISignedZeroOption]):
    is_decimal_point_always_displayed: _winrt.Boolean
    integer_digits: _winrt.Int32
    is_grouped: _winrt.Boolean
    numeral_system: str
...
class IncrementNumberRounder(_winrt.Object, interfaces=[INumberRounder]):
...
class NumeralSystemTranslator(_winrt.Object, interfaces=[]):
    numeral_system: str
    languages: typing.Optional[winsdk.windows.foundation.collections.IVectorView[str]]
    resolved_language: str
    @staticmethod
...
class PercentFormatter(_winrt.Object, interfaces=[INumberFormatterOptions, INumberFormatter, INumberFormatter2, INumberParser, ISignificantDigitsOption, INumberRounderOption, ISignedZeroOption]):
    is_decimal_point_always_displayed: _winrt.Boolean
    integer_digits: _winrt.Int32
    is_grouped: _winrt.Boolean
    numeral_system: str
...
class PermilleFormatter(_winrt.Object, interfaces=[INumberFormatterOptions, INumberFormatter, INumberFormatter2, INumberParser, ISignificantDigitsOption, INumberRounderOption, ISignedZeroOption]):
    is_decimal_point_always_displayed: _winrt.Boolean
    integer_digits: _winrt.Int32
    is_grouped: _winrt.Boolean
    numeral_system: str
...
class SignificantDigitsNumberRounder(_winrt.Object, interfaces=[INumberRounder]):
...
class INumberFormatter(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> INumberFormatter: ...
    def format(self, value: _winrt.Double) -> str: ...

class INumberFormatter2(typing.Protocol):
    @staticmethod
...
class INumberFormatterOptions(typing.Protocol):
    fraction_digits: _winrt.Int32
    geographic_region: str
    integer_digits: _winrt.Int32
    is_decimal_point_always_displayed: _winrt.Boolean
...
class INumberParser(typing.Protocol):
    @staticmethod
...
class INumberRounder(typing.Protocol):
    @staticmethod
...
class INumberRounderOption(typing.Protocol):
    number_rounder: typing.Optional[INumberRounder]
    @staticmethod
    def _from(obj: _winrt.Object) -> INumberRounderOption: ...

class ISignedZeroOption(typing.Protocol):
    is_zero_signed: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> ISignedZeroOption: ...

class ISignificantDigitsOption(typing.Protocol):
    significant_digits: _winrt.Int32
    @staticmethod
