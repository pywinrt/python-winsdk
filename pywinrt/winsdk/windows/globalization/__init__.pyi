...
class Calendar(_winrt.Object, interfaces=[]):
    year: _winrt.Int32
    second: _winrt.Int32
    period: _winrt.Int32
...
class CurrencyAmount(_winrt.Object, interfaces=[]):
    amount: str
    currency: str
    @staticmethod
...
class GeographicRegion(_winrt.Object, interfaces=[]):
    code: str
...
class Language(_winrt.Object, interfaces=[]):
    display_name: str
    language_tag: str
    native_name: str
    script: str
