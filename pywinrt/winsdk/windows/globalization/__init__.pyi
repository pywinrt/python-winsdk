...
class ApplicationLanguages(winsdk.system.Object):
    ...
    manifest_languages: typing.ClassVar[typing.Optional[winsdk.windows.foundation.collections.IVectorView[str]]]
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> ApplicationLanguages: ...
    @staticmethod
...
class Calendar(winsdk.system.Object):
    year: winsdk.system.Int32
    second: winsdk.system.Int32
    period: winsdk.system.Int32
    nanosecond: winsdk.system.Int32
    month: winsdk.system.Int32
    minute: winsdk.system.Int32
    numeral_system: str
    era: winsdk.system.Int32
    hour: winsdk.system.Int32
    day: winsdk.system.Int32
    first_second_in_this_minute: winsdk.system.Int32
    first_year_in_this_era: winsdk.system.Int32
    is_daylight_saving_time: winsdk.system.Boolean
    languages: typing.Optional[winsdk.windows.foundation.collections.IVectorView[str]]
    last_day_in_this_month: winsdk.system.Int32
    last_era: winsdk.system.Int32
    last_hour_in_this_period: winsdk.system.Int32
    last_minute_in_this_hour: winsdk.system.Int32
    last_month_in_this_year: winsdk.system.Int32
    last_second_in_this_minute: winsdk.system.Int32
    last_year_in_this_era: winsdk.system.Int32
    day_of_week: DayOfWeek
    first_day_in_this_month: winsdk.system.Int32
    last_period_in_this_day: winsdk.system.Int32
    first_era: winsdk.system.Int32
    number_of_days_in_this_month: winsdk.system.Int32
    number_of_eras: winsdk.system.Int32
    number_of_hours_in_this_period: winsdk.system.Int32
    number_of_minutes_in_this_hour: winsdk.system.Int32
    first_hour_in_this_period: winsdk.system.Int32
    number_of_months_in_this_year: winsdk.system.Int32
    number_of_periods_in_this_day: winsdk.system.Int32
    number_of_seconds_in_this_minute: winsdk.system.Int32
    number_of_years_in_this_era: winsdk.system.Int32
    first_minute_in_this_hour: winsdk.system.Int32
    resolved_language: str
    first_month_in_this_year: winsdk.system.Int32
    first_period_in_this_day: winsdk.system.Int32
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> Calendar: ...
    @typing.overload
    ...
    def add_days(self, days: winsdk.system.Int32, /) -> None: ...
    def add_eras(self, eras: winsdk.system.Int32, /) -> None: ...
    def add_hours(self, hours: winsdk.system.Int32, /) -> None: ...
    def add_minutes(self, minutes: winsdk.system.Int32, /) -> None: ...
    def add_months(self, months: winsdk.system.Int32, /) -> None: ...
    def add_nanoseconds(self, nanoseconds: winsdk.system.Int32, /) -> None: ...
    def add_periods(self, periods: winsdk.system.Int32, /) -> None: ...
    def add_seconds(self, seconds: winsdk.system.Int32, /) -> None: ...
    def add_weeks(self, weeks: winsdk.system.Int32, /) -> None: ...
    def add_years(self, years: winsdk.system.Int32, /) -> None: ...
    ...
    def compare(self, other: typing.Optional[Calendar], /) -> winsdk.system.Int32: ...
    def compare_date_time(self, other: datetime.datetime, /) -> winsdk.system.Int32: ...
    def copy_to(self, other: typing.Optional[Calendar], /) -> None: ...
    def day_as_padded_string(self, min_digits: winsdk.system.Int32, /) -> str: ...
    def day_as_string(self) -> str: ...
    @typing.overload
    def day_of_week_as_solo_string(self) -> str: ...
    @typing.overload
    def day_of_week_as_solo_string(self, ideal_length: winsdk.system.Int32, /) -> str: ...
    @typing.overload
    def day_of_week_as_string(self) -> str: ...
    @typing.overload
    def day_of_week_as_string(self, ideal_length: winsdk.system.Int32, /) -> str: ...
    @typing.overload
    def era_as_string(self) -> str: ...
    @typing.overload
    def era_as_string(self, ideal_length: winsdk.system.Int32, /) -> str: ...
    def get_calendar_system(self) -> str: ...
    def get_clock(self) -> str: ...
    def get_date_time(self) -> datetime.datetime: ...
    def get_time_zone(self) -> str: ...
    def hour_as_padded_string(self, min_digits: winsdk.system.Int32, /) -> str: ...
    def hour_as_string(self) -> str: ...
    def minute_as_padded_string(self, min_digits: winsdk.system.Int32, /) -> str: ...
    def minute_as_string(self) -> str: ...
    def month_as_numeric_string(self) -> str: ...
    def month_as_padded_numeric_string(self, min_digits: winsdk.system.Int32, /) -> str: ...
    @typing.overload
    def month_as_solo_string(self) -> str: ...
    @typing.overload
    def month_as_solo_string(self, ideal_length: winsdk.system.Int32, /) -> str: ...
    @typing.overload
    def month_as_string(self) -> str: ...
    @typing.overload
    def month_as_string(self, ideal_length: winsdk.system.Int32, /) -> str: ...
    def nanosecond_as_padded_string(self, min_digits: winsdk.system.Int32, /) -> str: ...
    def nanosecond_as_string(self) -> str: ...
    @typing.overload
    def period_as_string(self) -> str: ...
    @typing.overload
    def period_as_string(self, ideal_length: winsdk.system.Int32, /) -> str: ...
    def second_as_padded_string(self, min_digits: winsdk.system.Int32, /) -> str: ...
    ...
    @typing.overload
    def time_zone_as_string(self, ideal_length: winsdk.system.Int32, /) -> str: ...
    def year_as_padded_string(self, min_digits: winsdk.system.Int32, /) -> str: ...
    def year_as_string(self) -> str: ...
    def year_as_truncated_string(self, remaining_digits: winsdk.system.Int32, /) -> str: ...

class CalendarIdentifiers(winsdk.system.Object):
    ...
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> CalendarIdentifiers: ...

class ClockIdentifiers(winsdk.system.Object):
    twelve_hour: typing.ClassVar[str]
    twenty_four_hour: typing.ClassVar[str]
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> ClockIdentifiers: ...

class CurrencyAmount(winsdk.system.Object):
    amount: str
    currency: str
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> CurrencyAmount: ...
    def __new__(cls: typing.Type[CurrencyAmount], amount: str, currency: str) -> CurrencyAmount:...

class CurrencyIdentifiers(winsdk.system.Object):
    ...
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> CurrencyIdentifiers: ...

class GeographicRegion(winsdk.system.Object):
    code: str
    ...
    native_name: str
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> GeographicRegion: ...
    @typing.overload
    ...
    @staticmethod
    def is_supported(geographic_region_code: str, /) -> winsdk.system.Boolean: ...

class JapanesePhoneme(winsdk.system.Object):
    display_text: str
    is_phrase_start: winsdk.system.Boolean
    yomi_text: str
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> JapanesePhoneme: ...

class JapanesePhoneticAnalyzer(winsdk.system.Object):
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> JapanesePhoneticAnalyzer: ...
    @typing.overload
    @staticmethod
    def get_words(input: str, /) -> typing.Optional[winsdk.windows.foundation.collections.IVectorView[JapanesePhoneme]]: ...
    @typing.overload
    @staticmethod
    def get_words(input: str, mono_ruby: winsdk.system.Boolean, /) -> typing.Optional[winsdk.windows.foundation.collections.IVectorView[JapanesePhoneme]]: ...

class Language(winsdk.system.Object):
    display_name: str
    language_tag: str
    native_name: str
    script: str
    ...
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> Language: ...
    ...
    @staticmethod
    def is_well_formed(language_tag: str, /) -> winsdk.system.Boolean: ...
    @staticmethod
    def try_set_input_method_language_tag(language_tag: str, /) -> winsdk.system.Boolean: ...

class NumeralSystemIdentifiers(winsdk.system.Object):
    ...
    @staticmethod
    def _from(obj: winsdk.system.Object, /) -> NumeralSystemIdentifiers: ...
