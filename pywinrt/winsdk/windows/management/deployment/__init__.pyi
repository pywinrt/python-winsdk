...
class PackageManager(_winrt.Object):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def add_package_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], deployment_options: DeploymentOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def add_package_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], deployment_options: DeploymentOptions, target_volume: typing.Optional[PackageVolume]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def add_package_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], deployment_options: DeploymentOptions, target_volume: typing.Optional[PackageVolume], optional_package_family_names: typing.Iterable[str], external_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def add_package_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], options: DeploymentOptions, target_volume: typing.Optional[PackageVolume], optional_package_family_names: typing.Iterable[str], package_uris_to_install: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], related_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def add_package_by_app_installer_file_async(self, app_installer_file_uri: typing.Optional[winsdk.windows.foundation.Uri], options: AddPackageByAppInstallerOptions, target_volume: typing.Optional[PackageVolume]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def add_package_by_uri_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], options: typing.Optional[AddPackageOptions]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def add_package_volume_async(self, package_store_path: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PackageVolume]]: ...
    def cleanup_package_for_user_async(self, package_name: str, user_security_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def clear_package_status(self, package_full_name: str, status: PackageStatus) -> None: ...
    def deprovision_package_for_all_users_async(self, package_family_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    ...
    def get_package_volumes_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[PackageVolume]]]: ...
    def move_package_to_volume_async(self, package_full_name: str, deployment_options: DeploymentOptions, target_volume: typing.Optional[PackageVolume]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def provision_package_for_all_users_async(self, package_family_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def provision_package_for_all_users_async(self, main_package_family_name: str, options: typing.Optional[PackageAllUserProvisioningOptions]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def register_package_async(self, manifest_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], deployment_options: DeploymentOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def register_package_async(self, manifest_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], deployment_options: DeploymentOptions, app_data_volume: typing.Optional[PackageVolume]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def register_package_by_family_name_async(self, main_package_family_name: str, dependency_package_family_names: typing.Iterable[str], deployment_options: DeploymentOptions, app_data_volume: typing.Optional[PackageVolume], optional_package_family_names: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def register_package_by_full_name_async(self, main_package_full_name: str, dependency_package_full_names: typing.Iterable[str], deployment_options: DeploymentOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def register_package_by_uri_async(self, manifest_uri: typing.Optional[winsdk.windows.foundation.Uri], options: typing.Optional[RegisterPackageOptions]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def register_packages_by_full_name_async(self, package_full_names: typing.Iterable[str], options: typing.Optional[RegisterPackageOptions]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def remove_package_async(self, package_full_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def remove_package_async(self, package_full_name: str, removal_options: RemovalOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def remove_package_volume_async(self, volume: typing.Optional[PackageVolume]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def request_add_package_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], deployment_options: DeploymentOptions, target_volume: typing.Optional[PackageVolume], optional_package_family_names: typing.Iterable[str], related_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def request_add_package_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], deployment_options: DeploymentOptions, target_volume: typing.Optional[PackageVolume], optional_package_family_names: typing.Iterable[str], related_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], package_uris_to_install: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def request_add_package_by_app_installer_file_async(self, app_installer_file_uri: typing.Optional[winsdk.windows.foundation.Uri], options: AddPackageByAppInstallerOptions, target_volume: typing.Optional[PackageVolume]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    ...
    def set_package_volume_offline_async(self, package_volume: typing.Optional[PackageVolume]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def set_package_volume_online_async(self, package_volume: typing.Optional[PackageVolume]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def stage_package_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def stage_package_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], deployment_options: DeploymentOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def stage_package_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], deployment_options: DeploymentOptions, target_volume: typing.Optional[PackageVolume]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def stage_package_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], deployment_options: DeploymentOptions, target_volume: typing.Optional[PackageVolume], optional_package_family_names: typing.Iterable[str], external_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def stage_package_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], options: DeploymentOptions, target_volume: typing.Optional[PackageVolume], optional_package_family_names: typing.Iterable[str], package_uris_to_install: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], related_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def stage_package_by_uri_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], options: typing.Optional[StagePackageOptions]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def stage_user_data_async(self, package_full_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    @typing.overload
    def stage_user_data_async(self, package_full_name: str, deployment_options: DeploymentOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
    def update_package_async(self, package_uri: typing.Optional[winsdk.windows.foundation.Uri], dependency_package_uris: typing.Iterable[typing.Optional[winsdk.windows.foundation.Uri]], deployment_options: DeploymentOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[DeploymentResult, DeploymentProgress]]: ...
...
class PackageVolume(_winrt.Object):
    ...
    def get_available_space_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.UInt64]]: ...
