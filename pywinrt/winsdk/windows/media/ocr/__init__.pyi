...
class OcrEngine(_winrt.Object):
    ...
    def recognize_async(self, bitmap: typing.Optional[winsdk.windows.graphics.imaging.SoftwareBitmap]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[OcrResult]]: ...
    @staticmethod
