...
class AudioCaptureEffectsManager(_winrt.Object, interfaces=[]):
    @staticmethod
...
class AudioEffect(_winrt.Object, interfaces=[]):
    audio_effect_type: AudioEffectType
    @staticmethod
    def _from(obj: _winrt.Object) -> AudioEffect: ...

class AudioEffectDefinition(_winrt.Object, interfaces=[IAudioEffectDefinition]):
    ...
    @typing.overload
    def __init__(self, activatable_class_id: str, props: typing.Optional[winsdk.windows.foundation.collections.IPropertySet]) -> None: ...
...
class AudioRenderEffectsManager(_winrt.Object, interfaces=[]):
...
class CompositeVideoFrameContext(_winrt.Object, interfaces=[]):
...
class ProcessAudioFrameContext(_winrt.Object, interfaces=[]):
...
class ProcessVideoFrameContext(_winrt.Object, interfaces=[]):
    input_frame: typing.Optional[winsdk.windows.media.VideoFrame]
    output_frame: typing.Optional[winsdk.windows.media.VideoFrame]
    @staticmethod
    def _from(obj: _winrt.Object) -> ProcessVideoFrameContext: ...

class VideoCompositorDefinition(_winrt.Object, interfaces=[IVideoCompositorDefinition]):
    activatable_class_id: str
    properties: typing.Optional[winsdk.windows.foundation.collections.IPropertySet]
    @staticmethod
...
class VideoEffectDefinition(_winrt.Object, interfaces=[IVideoEffectDefinition]):
    activatable_class_id: str
    properties: typing.Optional[winsdk.windows.foundation.collections.IPropertySet]
    @staticmethod
...
class VideoTransformEffectDefinition(_winrt.Object, interfaces=[IVideoEffectDefinition]):
    activatable_class_id: str
    properties: typing.Optional[winsdk.windows.foundation.collections.IPropertySet]
...
class VideoTransformSphericalProjection(_winrt.Object, interfaces=[]):
...
class IAudioEffectDefinition(typing.Protocol):
    activatable_class_id: str
    properties: typing.Optional[winsdk.windows.foundation.collections.IPropertySet]
    @staticmethod
    def _from(obj: _winrt.Object) -> IAudioEffectDefinition: ...

class IBasicAudioEffect(typing.Protocol):
...
class IBasicVideoEffect(typing.Protocol):
...
class IVideoCompositor(typing.Protocol):
    time_independent: _winrt.Boolean
    @staticmethod
...
class IVideoCompositorDefinition(typing.Protocol):
    activatable_class_id: str
    properties: typing.Optional[winsdk.windows.foundation.collections.IPropertySet]
    @staticmethod
    def _from(obj: _winrt.Object) -> IVideoCompositorDefinition: ...

class IVideoEffectDefinition(typing.Protocol):
    activatable_class_id: str
    properties: typing.Optional[winsdk.windows.foundation.collections.IPropertySet]
    @staticmethod
