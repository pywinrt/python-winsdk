...
_ns_module = winsdk.system._import_ns_module("Windows.Media.Core")
...
_ns_module._register_AudioDecoderDegradation(AudioDecoderDegradation)
_ns_module._register_AudioDecoderDegradationReason(AudioDecoderDegradationReason)
_ns_module._register_CodecCategory(CodecCategory)
_ns_module._register_CodecKind(CodecKind)
_ns_module._register_FaceDetectionMode(FaceDetectionMode)
_ns_module._register_MediaDecoderStatus(MediaDecoderStatus)
_ns_module._register_MediaSourceState(MediaSourceState)
_ns_module._register_MediaSourceStatus(MediaSourceStatus)
_ns_module._register_MediaStreamSourceClosedReason(MediaStreamSourceClosedReason)
_ns_module._register_MediaStreamSourceErrorStatus(MediaStreamSourceErrorStatus)
_ns_module._register_MediaTrackKind(MediaTrackKind)
_ns_module._register_MseAppendMode(MseAppendMode)
_ns_module._register_MseEndOfStreamStatus(MseEndOfStreamStatus)
_ns_module._register_MseReadyState(MseReadyState)
_ns_module._register_SceneAnalysisRecommendation(SceneAnalysisRecommendation)
_ns_module._register_TimedMetadataKind(TimedMetadataKind)
_ns_module._register_TimedMetadataTrackErrorCode(TimedMetadataTrackErrorCode)
_ns_module._register_TimedTextBoutenPosition(TimedTextBoutenPosition)
_ns_module._register_TimedTextBoutenType(TimedTextBoutenType)
_ns_module._register_TimedTextDisplayAlignment(TimedTextDisplayAlignment)
_ns_module._register_TimedTextFlowDirection(TimedTextFlowDirection)
_ns_module._register_TimedTextFontStyle(TimedTextFontStyle)
_ns_module._register_TimedTextLineAlignment(TimedTextLineAlignment)
_ns_module._register_TimedTextRubyAlign(TimedTextRubyAlign)
_ns_module._register_TimedTextRubyPosition(TimedTextRubyPosition)
_ns_module._register_TimedTextRubyReserve(TimedTextRubyReserve)
_ns_module._register_TimedTextScrollMode(TimedTextScrollMode)
_ns_module._register_TimedTextUnit(TimedTextUnit)
_ns_module._register_TimedTextWeight(TimedTextWeight)
_ns_module._register_TimedTextWrapping(TimedTextWrapping)
_ns_module._register_TimedTextWritingMode(TimedTextWritingMode)
_ns_module._register_VideoStabilizationEffectEnabledChangedReason(VideoStabilizationEffectEnabledChangedReason)
...
winsdk.system._mixin_mutable_mapping(MediaStreamSamplePropertySet)
