...
class CodecQuery(_winrt.Object):
    ...
    def __init__(self) -> None: ...
    def find_all_async(self, kind: CodecKind, category: CodecCategory, sub_type: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[CodecInfo]]]: ...
...
class LowLightFusion(_winrt.Object):
    ...
    @staticmethod
    def fuse_async(frame_set: typing.Iterable[typing.Optional[winsdk.windows.graphics.imaging.SoftwareBitmap]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[LowLightFusionResult, _winrt.Double]]: ...
...
class MediaStreamSample(_winrt.Object):
    ...
    @staticmethod
    def create_from_stream_async(stream: typing.Optional[winsdk.windows.storage.streams.IInputStream], count: _winrt.UInt32, timestamp: winsdk.windows.foundation.TimeSpan) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MediaStreamSample]]: ...
