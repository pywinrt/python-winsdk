...
class CurrentSessionChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> CurrentSessionChangedEventArgs: ...

class GlobalSystemMediaTransportControlsSession(_winrt.Object, interfaces=[]):
...
class GlobalSystemMediaTransportControlsSessionManager(_winrt.Object, interfaces=[]):
    @staticmethod
...
class GlobalSystemMediaTransportControlsSessionMediaProperties(_winrt.Object, interfaces=[]):
    album_artist: str
    album_title: str
...
class GlobalSystemMediaTransportControlsSessionPlaybackControls(_winrt.Object, interfaces=[]):
...
class GlobalSystemMediaTransportControlsSessionPlaybackInfo(_winrt.Object, interfaces=[]):
...
class GlobalSystemMediaTransportControlsSessionTimelineProperties(_winrt.Object, interfaces=[]):
...
class MediaPropertiesChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> MediaPropertiesChangedEventArgs: ...

class PlaybackInfoChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> PlaybackInfoChangedEventArgs: ...

class SessionsChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> SessionsChangedEventArgs: ...

class TimelinePropertiesChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
