...
class AudioBuffer(_winrt.Object, interfaces=[winsdk.windows.foundation.IMemoryBuffer, winsdk.windows.foundation.IClosable]):
...
class AudioFrame(_winrt.Object, interfaces=[IMediaFrame, winsdk.windows.foundation.IClosable]):
...
class AutoRepeatModeChangeRequestedEventArgs(_winrt.Object, interfaces=[]):
    requested_auto_repeat_mode: MediaPlaybackAutoRepeatMode
    @staticmethod
    def _from(obj: _winrt.Object) -> AutoRepeatModeChangeRequestedEventArgs: ...

class ImageDisplayProperties(_winrt.Object, interfaces=[]):
    title: str
    subtitle: str
    @staticmethod
    def _from(obj: _winrt.Object) -> ImageDisplayProperties: ...

class MediaExtensionManager(_winrt.Object, interfaces=[]):
    @staticmethod
...
class MediaProcessingTriggerDetails(_winrt.Object, interfaces=[]):
...
class MediaTimelineController(_winrt.Object, interfaces=[]):
...
class MediaTimelineControllerFailedEventArgs(_winrt.Object, interfaces=[]):
    extended_error: winsdk.windows.foundation.HResult
    @staticmethod
    def _from(obj: _winrt.Object) -> MediaTimelineControllerFailedEventArgs: ...

class MusicDisplayProperties(_winrt.Object, interfaces=[]):
    title: str
    artist: str
    album_artist: str
...
class PlaybackPositionChangeRequestedEventArgs(_winrt.Object, interfaces=[]):
...
class SystemMediaTransportControlsButtonPressedEventArgs(_winrt.Object, interfaces=[]):
    button: SystemMediaTransportControlsButton
    @staticmethod
    def _from(obj: _winrt.Object) -> SystemMediaTransportControlsButtonPressedEventArgs: ...

class SystemMediaTransportControlsDisplayUpdater(_winrt.Object, interfaces=[]):
...
class SystemMediaTransportControlsPropertyChangedEventArgs(_winrt.Object, interfaces=[]):
...
class SystemMediaTransportControlsTimelineProperties(_winrt.Object, interfaces=[]):
...
class VideoDisplayProperties(_winrt.Object, interfaces=[]):
    title: str
    subtitle: str
    genres: typing.Optional[winsdk.windows.foundation.collections.IVector[str]]
    @staticmethod
...
class VideoFrame(_winrt.Object, interfaces=[IMediaFrame, winsdk.windows.foundation.IClosable]):
    system_relative_time: typing.Optional[typing.Optional[winsdk.windows.foundation.TimeSpan]]
    relative_time: typing.Optional[typing.Optional[winsdk.windows.foundation.TimeSpan]]
    is_discontinuous: _winrt.Boolean
    duration: typing.Optional[typing.Optional[winsdk.windows.foundation.TimeSpan]]
...
class IMediaExtension(typing.Protocol):
    @staticmethod
...
class IMediaFrame(typing.Protocol):
    duration: typing.Optional[typing.Optional[winsdk.windows.foundation.TimeSpan]]
    extended_properties: typing.Optional[winsdk.windows.foundation.collections.IPropertySet]
    is_discontinuous: _winrt.Boolean
    is_read_only: _winrt.Boolean
...
class IMediaMarker(typing.Protocol):
...
class IMediaMarkers(typing.Protocol):
