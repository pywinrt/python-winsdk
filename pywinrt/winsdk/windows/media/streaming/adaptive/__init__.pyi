...
class AdaptiveMediaSource(winsdk.windows.media.core.IMediaSource, winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def create_from_stream_async(stream: typing.Optional[winsdk.windows.storage.streams.IInputStream], uri: typing.Optional[winsdk.windows.foundation.Uri], content_type: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AdaptiveMediaSourceCreationResult]]: ...
    @typing.overload
    @staticmethod
    def create_from_stream_async(stream: typing.Optional[winsdk.windows.storage.streams.IInputStream], uri: typing.Optional[winsdk.windows.foundation.Uri], content_type: str, http_client: typing.Optional[winsdk.windows.web.http.HttpClient]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AdaptiveMediaSourceCreationResult]]: ...
    @typing.overload
    @staticmethod
    def create_from_uri_async(uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AdaptiveMediaSourceCreationResult]]: ...
    @typing.overload
    @staticmethod
    def create_from_uri_async(uri: typing.Optional[winsdk.windows.foundation.Uri], http_client: typing.Optional[winsdk.windows.web.http.HttpClient]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AdaptiveMediaSourceCreationResult]]: ...
