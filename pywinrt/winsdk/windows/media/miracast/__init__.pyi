...
class MiracastReceiver(_winrt.Object):
    ...
    def create_session_async(self, view: typing.Optional[winsdk.windows.applicationmodel.core.CoreApplicationView]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MiracastReceiverSession]]: ...
    ...
    def disconnect_all_and_apply_settings_async(self, settings: typing.Optional[MiracastReceiverSettings]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MiracastReceiverApplySettingsResult]]: ...
    def get_current_settings(self) -> typing.Optional[MiracastReceiverSettings]: ...
    def get_current_settings_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MiracastReceiverSettings]]: ...
    ...
    def get_status_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MiracastReceiverStatus]]: ...
...
class MiracastReceiverSession(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def start_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MiracastReceiverSessionStartResult]]: ...
...
class MiracastReceiverStreamControl(_winrt.Object):
    ...
    def get_video_stream_settings_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MiracastReceiverVideoStreamSettings]]: ...
