...
class MiracastReceiver(_winrt.Object, interfaces=[]):
    @staticmethod
...
class MiracastReceiverApplySettingsResult(_winrt.Object, interfaces=[]):
...
class MiracastReceiverConnection(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class MiracastReceiverConnectionCreatedEventArgs(_winrt.Object, interfaces=[]):
...
class MiracastReceiverCursorImageChannel(_winrt.Object, interfaces=[]):
...
class MiracastReceiverCursorImageChannelSettings(_winrt.Object, interfaces=[]):
    max_image_size: winsdk.windows.graphics.SizeInt32
    is_enabled: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> MiracastReceiverCursorImageChannelSettings: ...

class MiracastReceiverDisconnectedEventArgs(_winrt.Object, interfaces=[]):
    connection: typing.Optional[MiracastReceiverConnection]
    @staticmethod
    def _from(obj: _winrt.Object) -> MiracastReceiverDisconnectedEventArgs: ...

class MiracastReceiverGameControllerDevice(_winrt.Object, interfaces=[]):
...
class MiracastReceiverInputDevices(_winrt.Object, interfaces=[]):
...
class MiracastReceiverKeyboardDevice(_winrt.Object, interfaces=[]):
    transmit_input: _winrt.Boolean
    is_requested_by_transmitter: _winrt.Boolean
    is_transmitting_input: _winrt.Boolean
    @staticmethod
...
class MiracastReceiverMediaSourceCreatedEventArgs(_winrt.Object, interfaces=[]):
    connection: typing.Optional[MiracastReceiverConnection]
...
class MiracastReceiverSession(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class MiracastReceiverSessionStartResult(_winrt.Object, interfaces=[]):
    extended_error: winsdk.windows.foundation.HResult
    status: MiracastReceiverSessionStartStatus
    @staticmethod
    def _from(obj: _winrt.Object) -> MiracastReceiverSessionStartResult: ...

class MiracastReceiverSettings(_winrt.Object, interfaces=[]):
...
class MiracastReceiverStatus(_winrt.Object, interfaces=[]):
...
class MiracastReceiverStreamControl(_winrt.Object, interfaces=[]):
...
class MiracastReceiverVideoStreamSettings(_winrt.Object, interfaces=[]):
...
class MiracastTransmitter(_winrt.Object, interfaces=[]):
    name: str
