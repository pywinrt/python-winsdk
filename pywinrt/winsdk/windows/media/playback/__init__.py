...
winsdk.system._mixin_sequence(MediaPlaybackAudioTrackList)
...
winsdk.system._mixin_sequence(MediaPlaybackTimedMetadataTrackList)
MediaPlaybackVideoTrackList = _ns_module.MediaPlaybackVideoTrackList
winsdk.system._mixin_sequence(MediaPlaybackVideoTrackList)
