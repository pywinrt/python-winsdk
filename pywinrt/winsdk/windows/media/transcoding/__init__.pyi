...
class MediaTranscoder(_winrt.Object):
    ...
    def prepare_file_transcode_async(self, source: typing.Optional[winsdk.windows.storage.IStorageFile], destination: typing.Optional[winsdk.windows.storage.IStorageFile], profile: typing.Optional[winsdk.windows.media.mediaproperties.MediaEncodingProfile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PrepareTranscodeResult]]: ...
    def prepare_media_stream_source_transcode_async(self, source: typing.Optional[winsdk.windows.media.core.IMediaSource], destination: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream], profile: typing.Optional[winsdk.windows.media.mediaproperties.MediaEncodingProfile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PrepareTranscodeResult]]: ...
    def prepare_stream_transcode_async(self, source: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream], destination: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream], profile: typing.Optional[winsdk.windows.media.mediaproperties.MediaEncodingProfile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PrepareTranscodeResult]]: ...
...
class PrepareTranscodeResult(_winrt.Object):
    ...
    def transcode_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncActionWithProgress[_winrt.Double]]: ...
