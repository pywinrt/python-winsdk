...
class DialApp(_winrt.Object, interfaces=[]):
    app_name: str
    @staticmethod
...
class DialAppStateDetails(_winrt.Object, interfaces=[]):
    full_xml: str
    state: DialAppState
    @staticmethod
    def _from(obj: _winrt.Object) -> DialAppStateDetails: ...

class DialDevice(_winrt.Object, interfaces=[]):
    id: str
    friendly_name: str
...
class DialDevicePicker(_winrt.Object, interfaces=[]):
...
class DialDevicePickerFilter(_winrt.Object, interfaces=[]):
