...
class PhotoImportFindItemsResult(_winrt.Object):
    ...
    def import_items_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[PhotoImportImportItemsResult, PhotoImportProgress]]: ...
...
class PhotoImportImportItemsResult(_winrt.Object):
    ...
    def delete_imported_items_from_source_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[PhotoImportDeleteImportedItemsFromSourceResult, _winrt.Double]]: ...
...
class PhotoImportManager(_winrt.Object):
    ...
    @staticmethod
    def find_all_sources_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[PhotoImportSource]]]: ...
    @staticmethod
...
class PhotoImportOperation(_winrt.Object):
    continue_deleting_imported_items_from_source_async: typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[PhotoImportDeleteImportedItemsFromSourceResult, _winrt.Double]]
    continue_finding_items_async: typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[PhotoImportFindItemsResult, _winrt.UInt32]]
    continue_importing_items_async: typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[PhotoImportImportItemsResult, PhotoImportProgress]]
    session: typing.Optional[PhotoImportSession]
...
class PhotoImportSession(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def find_items_async(self, content_type_filter: PhotoImportContentTypeFilter, item_selection_mode: PhotoImportItemSelectionMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[PhotoImportFindItemsResult, _winrt.UInt32]]: ...
...
class PhotoImportSource(_winrt.Object):
    ...
    @staticmethod
    def from_folder_async(source_root_folder: typing.Optional[winsdk.windows.storage.IStorageFolder]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhotoImportSource]]: ...
    @staticmethod
    def from_id_async(source_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PhotoImportSource]]: ...
