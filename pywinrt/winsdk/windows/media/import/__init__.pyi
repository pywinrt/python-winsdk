...
class PhotoImportDeleteImportedItemsFromSourceResult(_winrt.Object, interfaces=[]):
...
class PhotoImportFindItemsResult(_winrt.Object, interfaces=[]):
...
class PhotoImportImportItemsResult(_winrt.Object, interfaces=[]):
    has_succeeded: _winrt.Boolean
...
class PhotoImportItem(_winrt.Object, interfaces=[]):
...
class PhotoImportItemImportedEventArgs(_winrt.Object, interfaces=[]):
...
class PhotoImportOperation(_winrt.Object, interfaces=[]):
...
class PhotoImportSelectionChangedEventArgs(_winrt.Object, interfaces=[]):
    is_selection_empty: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> PhotoImportSelectionChangedEventArgs: ...

class PhotoImportSession(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class PhotoImportSidecar(_winrt.Object, interfaces=[]):
    date: winsdk.windows.foundation.DateTime
    name: str
    size_in_bytes: _winrt.UInt64
    @staticmethod
...
class PhotoImportSource(_winrt.Object, interfaces=[]):
...
class PhotoImportStorageMedium(_winrt.Object, interfaces=[]):
...
class PhotoImportVideoSegment(_winrt.Object, interfaces=[]):
    date: winsdk.windows.foundation.DateTime
    name: str
    sibling: typing.Optional[PhotoImportSidecar]
    sidecars: typing.Optional[winsdk.windows.foundation.collections.IVectorView[PhotoImportSidecar]]
