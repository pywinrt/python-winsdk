...
class BackgroundAudioTrack(_winrt.Object, interfaces=[]):
...
class EmbeddedAudioTrack(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> EmbeddedAudioTrack: ...
    def get_audio_encoding_properties(self) -> typing.Optional[winsdk.windows.media.mediaproperties.AudioEncodingProperties]: ...

class MediaClip(_winrt.Object, interfaces=[]):
...
class MediaComposition(_winrt.Object, interfaces=[]):
...
class MediaOverlay(_winrt.Object, interfaces=[]):
...
class MediaOverlayLayer(_winrt.Object, interfaces=[]):
