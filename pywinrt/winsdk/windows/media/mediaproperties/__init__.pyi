...
class AudioEncodingProperties(_winrt.Object, interfaces=[IMediaEncodingProperties]):
...
class ContainerEncodingProperties(_winrt.Object, interfaces=[IMediaEncodingProperties]):
    subtype: str
    properties: typing.Optional[MediaPropertySet]
    type: str
    @staticmethod
...
class ImageEncodingProperties(_winrt.Object, interfaces=[IMediaEncodingProperties]):
    width: _winrt.UInt32
...
class MediaEncodingProfile(_winrt.Object, interfaces=[]):
...
class MediaPropertySet(_winrt.Object, interfaces=[winsdk.windows.foundation.collections.IMap[uuid.UUID, _winrt.Object], winsdk.windows.foundation.collections.IIterable[winsdk.windows.foundation.collections.IKeyValuePair[uuid.UUID, _winrt.Object]]]):
    size: _winrt.UInt32
    @staticmethod
...
class MediaRatio(_winrt.Object, interfaces=[]):
...
class TimedMetadataEncodingProperties(_winrt.Object, interfaces=[IMediaEncodingProperties]):
    subtype: str
    properties: typing.Optional[MediaPropertySet]
    type: str
    @staticmethod
...
class VideoEncodingProperties(_winrt.Object, interfaces=[IMediaEncodingProperties]):
    subtype: str
    type: str
    properties: typing.Optional[MediaPropertySet]
    width: _winrt.UInt32
...
class IMediaEncodingProperties(typing.Protocol):
    properties: typing.Optional[MediaPropertySet]
    subtype: str
    type: str
    @staticmethod
