...
class NDClient(_winrt.Object):
    ...
    def close(self) -> None: ...
    def license_fetch_async(self, license_fetch_descriptor: typing.Optional[INDLicenseFetchDescriptor]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[INDLicenseFetchResult]]: ...
    ...
    def start_async(self, content_url: typing.Optional[winsdk.windows.foundation.Uri], start_async_options: _winrt.UInt32, registration_custom_data: typing.Optional[INDCustomData], license_fetch_descriptor: typing.Optional[INDLicenseFetchDescriptor]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[INDStartResult]]: ...
...
class NDTCPMessenger(INDMessenger, _winrt.Object):
    ...
    def send_license_fetch_request_async(self, session_i_d_bytes: typing.Sequence[_winrt.UInt8], challenge_data_bytes: typing.Sequence[_winrt.UInt8]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[INDSendResult]]: ...
    def send_proximity_detection_response_async(self, pd_type: NDProximityDetectionType, transmitter_channel_bytes: typing.Sequence[_winrt.UInt8], session_i_d_bytes: typing.Sequence[_winrt.UInt8], response_data_bytes: typing.Sequence[_winrt.UInt8]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[INDSendResult]]: ...
    def send_proximity_detection_start_async(self, pd_type: NDProximityDetectionType, transmitter_channel_bytes: typing.Sequence[_winrt.UInt8], session_i_d_bytes: typing.Sequence[_winrt.UInt8], challenge_data_bytes: typing.Sequence[_winrt.UInt8]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[INDSendResult]]: ...
    def send_registration_request_async(self, session_i_d_bytes: typing.Sequence[_winrt.UInt8], challenge_data_bytes: typing.Sequence[_winrt.UInt8]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[INDSendResult]]: ...
