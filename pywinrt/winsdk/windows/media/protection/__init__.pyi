...
class ComponentLoadFailedEventArgs(_winrt.Object, interfaces=[]):
...
class HdcpSession(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
    @staticmethod
...
class MediaProtectionManager(_winrt.Object, interfaces=[]):
...
class MediaProtectionPMPServer(_winrt.Object, interfaces=[]):
    properties: typing.Optional[winsdk.windows.foundation.collections.IPropertySet]
    @staticmethod
...
class MediaProtectionServiceCompletion(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> MediaProtectionServiceCompletion: ...
    def complete(self, success: _winrt.Boolean) -> None: ...

class ProtectionCapabilities(_winrt.Object, interfaces=[]):
    @staticmethod
...
class RevocationAndRenewalInformation(_winrt.Object, interfaces=[]):
...
class RevocationAndRenewalItem(_winrt.Object, interfaces=[]):
    header_hash: str
    name: str
    public_key_hash: str
...
class ServiceRequestedEventArgs(_winrt.Object, interfaces=[]):
    completion: typing.Optional[MediaProtectionServiceCompletion]
...
class IMediaProtectionServiceRequest(typing.Protocol):
