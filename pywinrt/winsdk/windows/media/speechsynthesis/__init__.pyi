...
class SpeechSynthesizer(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close() -> None:
        ...
    def synthesize_ssml_to_stream_async(ssml: str) -> winsdk.windows.foundation.IAsyncOperation[SpeechSynthesisStream]:
        ...
    def synthesize_text_to_stream_async(text: str) -> winsdk.windows.foundation.IAsyncOperation[SpeechSynthesisStream]:
        ...
