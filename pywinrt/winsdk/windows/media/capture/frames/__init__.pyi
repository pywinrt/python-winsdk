...
class MediaFrameReader(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def start_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MediaFrameReaderStartStatus]]: ...
...
class MediaFrameSourceController(_winrt.Object):
    ...
    def get_property_async(self, property_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MediaFrameSourceGetPropertyResult]]: ...
    def get_property_by_extended_id_async(self, extended_property_id: typing.Sequence[_winrt.UInt8], max_property_value_size: typing.Optional[_winrt.UInt32]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MediaFrameSourceGetPropertyResult]]: ...
    def set_property_async(self, property_id: str, property_value: typing.Optional[_winrt.Object]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MediaFrameSourceSetPropertyStatus]]: ...
    def set_property_by_extended_id_async(self, extended_property_id: typing.Sequence[_winrt.UInt8], property_value: typing.Sequence[_winrt.UInt8]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MediaFrameSourceSetPropertyStatus]]: ...
...
class MediaFrameSourceGroup(_winrt.Object):
    ...
    @staticmethod
    def find_all_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[MediaFrameSourceGroup]]]: ...
    @staticmethod
    def from_id_async(id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MediaFrameSourceGroup]]: ...
    @staticmethod
...
class MultiSourceMediaFrameReader(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def start_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MultiSourceMediaFrameReaderStartStatus]]: ...
    def stop_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
