...
class WhiteBalanceGain:
    ...
    g: _winrt.Double
    b: _winrt.Double
    def __new__(cls: typing.Type[WhiteBalanceGain], r: _winrt.Double, g: _winrt.Double, b: _winrt.Double) -> WhiteBalanceGain: ...
...
class MediaCapture(_winrt.Object):
    ...
    def get_encoder_property(self, media_stream_type: MediaStreamType, property_id: _winrt.Guid) -> typing.Optional[_winrt.Object]: ...
    @typing.overload
    ...
    def set_encoder_property(self, media_stream_type: MediaStreamType, property_id: _winrt.Guid, property_value: typing.Optional[_winrt.Object]) -> None: ...
...
class MediaCapturePauseResult(_winrt.Object):
...
class MediaCaptureRelativePanelWatcher(_winrt.Object):
...
class MediaCaptureStopResult(_winrt.Object):
    last_frame: typing.Optional[winsdk.windows.media.VideoFrame]
    record_duration: datetime.timedelta
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
