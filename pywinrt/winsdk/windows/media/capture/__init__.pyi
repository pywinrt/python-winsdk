...
class AdvancedCapturedPhoto(_winrt.Object, interfaces=[]):
...
class AdvancedPhotoCapture(_winrt.Object, interfaces=[]):
    @staticmethod
    ...
    @typing.overload
    def capture_async(self, context: typing.Optional[_winrt.Object]) -> winsdk.windows.foundation.IAsyncOperation[AdvancedCapturedPhoto]: ...
...
class AppCapture(_winrt.Object, interfaces=[]):
...
class CameraCaptureUI(_winrt.Object, interfaces=[]):
...
class CameraCaptureUIPhotoCaptureSettings(_winrt.Object, interfaces=[]):
...
class CameraCaptureUIVideoCaptureSettings(_winrt.Object, interfaces=[]):
...
class CapturedFrame(_winrt.Object, interfaces=[winsdk.windows.storage.streams.IRandomAccessStreamWithContentType, winsdk.windows.storage.streams.IContentTypeProvider, winsdk.windows.storage.streams.IRandomAccessStream, winsdk.windows.storage.streams.IOutputStream, winsdk.windows.foundation.IClosable, winsdk.windows.storage.streams.IInputStream]):
...
class CapturedFrameControlValues(_winrt.Object, interfaces=[]):
...
class CapturedPhoto(_winrt.Object, interfaces=[]):
    frame: typing.Optional[CapturedFrame]
    thumbnail: typing.Optional[CapturedFrame]
    @staticmethod
    def _from(obj: _winrt.Object) -> CapturedPhoto: ...

class LowLagMediaRecording(_winrt.Object, interfaces=[]):
    @staticmethod
...
class LowLagPhotoCapture(_winrt.Object, interfaces=[]):
    @staticmethod
...
class LowLagPhotoSequenceCapture(_winrt.Object, interfaces=[]):
    @staticmethod
...
class MediaCapture(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
    ...
    def create_multi_source_frame_reader_async(self, input_sources: typing.Iterable[typing.Optional[winsdk.windows.media.capture.frames.MediaFrameSource]]) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.media.capture.frames.MultiSourceMediaFrameReader]: ...
...
class MediaCaptureDeviceExclusiveControlStatusChangedEventArgs(_winrt.Object, interfaces=[]):
    device_id: str
...
class MediaCaptureFailedEventArgs(_winrt.Object, interfaces=[]):
    code: _winrt.UInt32
    message: str
    @staticmethod
    def _from(obj: _winrt.Object) -> MediaCaptureFailedEventArgs: ...

class MediaCaptureFocusChangedEventArgs(_winrt.Object, interfaces=[]):
...
class MediaCaptureInitializationSettings(_winrt.Object, interfaces=[]):
    video_device_id: str
...
class MediaCapturePauseResult(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class MediaCaptureRelativePanelWatcher(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class MediaCaptureSettings(_winrt.Object, interfaces=[]):
    audio_device_id: str
    photo_capture_source: PhotoCaptureSource
    streaming_capture_mode: StreamingCaptureMode
...
class MediaCaptureStopResult(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
    last_frame: typing.Optional[winsdk.windows.media.VideoFrame]
    record_duration: winsdk.windows.foundation.TimeSpan
    @staticmethod
...
class MediaCaptureVideoProfile(_winrt.Object, interfaces=[]):
    id: str
...
class MediaCaptureVideoProfileMediaDescription(_winrt.Object, interfaces=[]):
...
class OptionalReferencePhotoCapturedEventArgs(_winrt.Object, interfaces=[]):
    context: typing.Optional[_winrt.Object]
    frame: typing.Optional[CapturedFrame]
    @staticmethod
    def _from(obj: _winrt.Object) -> OptionalReferencePhotoCapturedEventArgs: ...

class PhotoCapturedEventArgs(_winrt.Object, interfaces=[]):
...
class PhotoConfirmationCapturedEventArgs(_winrt.Object, interfaces=[]):
    capture_time_offset: winsdk.windows.foundation.TimeSpan
    frame: typing.Optional[CapturedFrame]
    @staticmethod
    def _from(obj: _winrt.Object) -> PhotoConfirmationCapturedEventArgs: ...

class VideoStreamConfiguration(_winrt.Object, interfaces=[]):
