...
class SpeechContinuousRecognitionCompletedEventArgs(_winrt.Object, interfaces=[]):
    status: SpeechRecognitionResultStatus
    @staticmethod
    def _from(obj: _winrt.Object) -> SpeechContinuousRecognitionCompletedEventArgs: ...

class SpeechContinuousRecognitionResultGeneratedEventArgs(_winrt.Object, interfaces=[]):
...
class SpeechContinuousRecognitionSession(_winrt.Object, interfaces=[]):
...
class SpeechRecognitionCompilationResult(_winrt.Object, interfaces=[]):
    status: SpeechRecognitionResultStatus
    @staticmethod
    def _from(obj: _winrt.Object) -> SpeechRecognitionCompilationResult: ...

class SpeechRecognitionGrammarFileConstraint(_winrt.Object, interfaces=[ISpeechRecognitionConstraint]):
    tag: str
...
class SpeechRecognitionHypothesis(_winrt.Object, interfaces=[]):
    text: str
    @staticmethod
    def _from(obj: _winrt.Object) -> SpeechRecognitionHypothesis: ...

class SpeechRecognitionHypothesisGeneratedEventArgs(_winrt.Object, interfaces=[]):
...
class SpeechRecognitionListConstraint(_winrt.Object, interfaces=[ISpeechRecognitionConstraint]):
    tag: str
    probability: SpeechRecognitionConstraintProbability
    is_enabled: _winrt.Boolean
    type: SpeechRecognitionConstraintType
...
class SpeechRecognitionQualityDegradingEventArgs(_winrt.Object, interfaces=[]):
    problem: SpeechRecognitionAudioProblem
    @staticmethod
    def _from(obj: _winrt.Object) -> SpeechRecognitionQualityDegradingEventArgs: ...

class SpeechRecognitionResult(_winrt.Object, interfaces=[]):
...
class SpeechRecognitionSemanticInterpretation(_winrt.Object, interfaces=[]):
...
class SpeechRecognitionTopicConstraint(_winrt.Object, interfaces=[ISpeechRecognitionConstraint]):
    tag: str
    probability: SpeechRecognitionConstraintProbability
    is_enabled: _winrt.Boolean
    type: SpeechRecognitionConstraintType
...
class SpeechRecognitionVoiceCommandDefinitionConstraint(_winrt.Object, interfaces=[ISpeechRecognitionConstraint]):
    tag: str
    probability: SpeechRecognitionConstraintProbability
    is_enabled: _winrt.Boolean
    type: SpeechRecognitionConstraintType
...
class SpeechRecognizer(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class SpeechRecognizerStateChangedEventArgs(_winrt.Object, interfaces=[]):
    state: SpeechRecognizerState
    @staticmethod
    def _from(obj: _winrt.Object) -> SpeechRecognizerStateChangedEventArgs: ...

class SpeechRecognizerTimeouts(_winrt.Object, interfaces=[]):
...
class SpeechRecognizerUIOptions(_winrt.Object, interfaces=[]):
...
class ISpeechRecognitionConstraint(typing.Protocol):
    is_enabled: _winrt.Boolean
    probability: SpeechRecognitionConstraintProbability
    tag: str
    type: SpeechRecognitionConstraintType
