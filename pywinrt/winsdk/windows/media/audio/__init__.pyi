...
class AudioDeviceInputNode(_winrt.Object, interfaces=[IAudioInputNode, IAudioNode, winsdk.windows.foundation.IClosable, IAudioInputNode2]):
...
class AudioDeviceOutputNode(_winrt.Object, interfaces=[IAudioNode, winsdk.windows.foundation.IClosable, IAudioNodeWithListener]):
    device: typing.Optional[winsdk.windows.devices.enumeration.DeviceInformation]
    outgoing_gain: _winrt.Double
    consume_input: _winrt.Boolean
    effect_definitions: typing.Optional[winsdk.windows.foundation.collections.IVector[winsdk.windows.media.effects.IAudioEffectDefinition]]
...
class AudioFileInputNode(_winrt.Object, interfaces=[IAudioInputNode, IAudioNode, winsdk.windows.foundation.IClosable, IAudioInputNode2]):
...
class AudioFileOutputNode(_winrt.Object, interfaces=[IAudioNode, winsdk.windows.foundation.IClosable]):
...
class AudioFrameCompletedEventArgs(_winrt.Object, interfaces=[]):
    frame: typing.Optional[winsdk.windows.media.AudioFrame]
    @staticmethod
    def _from(obj: _winrt.Object) -> AudioFrameCompletedEventArgs: ...

class AudioFrameInputNode(_winrt.Object, interfaces=[IAudioInputNode, IAudioNode, winsdk.windows.foundation.IClosable, IAudioInputNode2]):
    playback_speed_factor: _winrt.Double
...
class AudioFrameOutputNode(_winrt.Object, interfaces=[IAudioNode, winsdk.windows.foundation.IClosable]):
    outgoing_gain: _winrt.Double
    consume_input: _winrt.Boolean
    effect_definitions: typing.Optional[winsdk.windows.foundation.collections.IVector[winsdk.windows.media.effects.IAudioEffectDefinition]]
    encoding_properties: typing.Optional[winsdk.windows.media.mediaproperties.AudioEncodingProperties]
...
class AudioGraph(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class AudioGraphBatchUpdater(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
    @staticmethod
    def _from(obj: _winrt.Object) -> AudioGraphBatchUpdater: ...
    def close(self) -> None: ...

class AudioGraphConnection(_winrt.Object, interfaces=[]):
    gain: _winrt.Double
    destination: typing.Optional[IAudioNode]
    @staticmethod
    def _from(obj: _winrt.Object) -> AudioGraphConnection: ...

class AudioGraphSettings(_winrt.Object, interfaces=[]):
...
class AudioGraphUnrecoverableErrorOccurredEventArgs(_winrt.Object, interfaces=[]):
    error: AudioGraphUnrecoverableError
    @staticmethod
    def _from(obj: _winrt.Object) -> AudioGraphUnrecoverableErrorOccurredEventArgs: ...

class AudioNodeEmitter(_winrt.Object, interfaces=[]):
...
class AudioNodeEmitterConeProperties(_winrt.Object, interfaces=[]):
...
class AudioNodeEmitterDecayModel(_winrt.Object, interfaces=[]):
...
class AudioNodeEmitterNaturalDecayModelProperties(_winrt.Object, interfaces=[]):
...
class AudioNodeEmitterShape(_winrt.Object, interfaces=[]):
...
class AudioNodeListener(_winrt.Object, interfaces=[]):
...
class AudioPlaybackConnection(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
    device_id: str
...
class AudioPlaybackConnectionOpenResult(_winrt.Object, interfaces=[]):
...
class AudioStateMonitor(_winrt.Object, interfaces=[]):
...
class AudioSubmixNode(_winrt.Object, interfaces=[IAudioInputNode, IAudioNode, winsdk.windows.foundation.IClosable, IAudioInputNode2]):
    outgoing_connections: typing.Optional[winsdk.windows.foundation.collections.IVectorView[AudioGraphConnection]]
    emitter: typing.Optional[AudioNodeEmitter]
    outgoing_gain: _winrt.Double
    consume_input: _winrt.Boolean
...
class CreateAudioDeviceInputNodeResult(_winrt.Object, interfaces=[]):
...
class CreateAudioDeviceOutputNodeResult(_winrt.Object, interfaces=[]):
...
class CreateAudioFileInputNodeResult(_winrt.Object, interfaces=[]):
...
class CreateAudioFileOutputNodeResult(_winrt.Object, interfaces=[]):
...
class CreateAudioGraphResult(_winrt.Object, interfaces=[]):
...
class CreateMediaSourceAudioInputNodeResult(_winrt.Object, interfaces=[]):
...
class EchoEffectDefinition(_winrt.Object, interfaces=[winsdk.windows.media.effects.IAudioEffectDefinition]):
...
class EqualizerBand(_winrt.Object, interfaces=[]):
    gain: _winrt.Double
...
class EqualizerEffectDefinition(_winrt.Object, interfaces=[winsdk.windows.media.effects.IAudioEffectDefinition]):
...
class FrameInputNodeQuantumStartedEventArgs(_winrt.Object, interfaces=[]):
    required_samples: _winrt.Int32
    @staticmethod
    def _from(obj: _winrt.Object) -> FrameInputNodeQuantumStartedEventArgs: ...

class LimiterEffectDefinition(_winrt.Object, interfaces=[winsdk.windows.media.effects.IAudioEffectDefinition]):
...
class MediaSourceAudioInputNode(_winrt.Object, interfaces=[IAudioInputNode2, IAudioInputNode, IAudioNode, winsdk.windows.foundation.IClosable]):
    outgoing_connections: typing.Optional[winsdk.windows.foundation.collections.IVectorView[AudioGraphConnection]]
    emitter: typing.Optional[AudioNodeEmitter]
    outgoing_gain: _winrt.Double
    consume_input: _winrt.Boolean
...
class ReverbEffectDefinition(_winrt.Object, interfaces=[winsdk.windows.media.effects.IAudioEffectDefinition]):
...
class SetDefaultSpatialAudioFormatResult(_winrt.Object, interfaces=[]):
    status: SetDefaultSpatialAudioFormatStatus
    @staticmethod
    def _from(obj: _winrt.Object) -> SetDefaultSpatialAudioFormatResult: ...

class SpatialAudioDeviceConfiguration(_winrt.Object, interfaces=[]):
...
class SpatialAudioFormatConfiguration(_winrt.Object, interfaces=[]):
...
class IAudioInputNode(typing.Protocol):
    outgoing_connections: typing.Optional[winsdk.windows.foundation.collections.IVectorView[AudioGraphConnection]]
    consume_input: _winrt.Boolean
    effect_definitions: typing.Optional[winsdk.windows.foundation.collections.IVector[winsdk.windows.media.effects.IAudioEffectDefinition]]
    encoding_properties: typing.Optional[winsdk.windows.media.mediaproperties.AudioEncodingProperties]
...
class IAudioInputNode2(typing.Protocol):
    emitter: typing.Optional[AudioNodeEmitter]
    consume_input: _winrt.Boolean
    effect_definitions: typing.Optional[winsdk.windows.foundation.collections.IVector[winsdk.windows.media.effects.IAudioEffectDefinition]]
    encoding_properties: typing.Optional[winsdk.windows.media.mediaproperties.AudioEncodingProperties]
...
class IAudioNode(typing.Protocol):
    consume_input: _winrt.Boolean
    effect_definitions: typing.Optional[winsdk.windows.foundation.collections.IVector[winsdk.windows.media.effects.IAudioEffectDefinition]]
    encoding_properties: typing.Optional[winsdk.windows.media.mediaproperties.AudioEncodingProperties]
    outgoing_gain: _winrt.Double
...
class IAudioNodeWithListener(typing.Protocol):
    listener: typing.Optional[AudioNodeListener]
    consume_input: _winrt.Boolean
    effect_definitions: typing.Optional[winsdk.windows.foundation.collections.IVector[winsdk.windows.media.effects.IAudioEffectDefinition]]
    encoding_properties: typing.Optional[winsdk.windows.media.mediaproperties.AudioEncodingProperties]
