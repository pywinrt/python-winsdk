...
class AudioFileOutputNode(IAudioNode, winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def disable_effects_by_definition(self, definition: typing.Optional[winsdk.windows.media.effects.IAudioEffectDefinition]) -> None: ...
    def enable_effects_by_definition(self, definition: typing.Optional[winsdk.windows.media.effects.IAudioEffectDefinition]) -> None: ...
    def finalize_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.media.transcoding.TranscodeFailureReason]]: ...
    def reset(self) -> None: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
...
class AudioGraph(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    @staticmethod
    def create_async(settings: typing.Optional[AudioGraphSettings]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CreateAudioGraphResult]]: ...
    def create_batch_updater(self) -> typing.Optional[AudioGraphBatchUpdater]: ...
    @typing.overload
    def create_device_input_node_async(self, category: winsdk.windows.media.capture.MediaCategory) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CreateAudioDeviceInputNodeResult]]: ...
    @typing.overload
    def create_device_input_node_async(self, category: winsdk.windows.media.capture.MediaCategory, encoding_properties: typing.Optional[winsdk.windows.media.mediaproperties.AudioEncodingProperties]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CreateAudioDeviceInputNodeResult]]: ...
    @typing.overload
    def create_device_input_node_async(self, category: winsdk.windows.media.capture.MediaCategory, encoding_properties: typing.Optional[winsdk.windows.media.mediaproperties.AudioEncodingProperties], device: typing.Optional[winsdk.windows.devices.enumeration.DeviceInformation]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CreateAudioDeviceInputNodeResult]]: ...
    @typing.overload
    def create_device_input_node_async(self, category: winsdk.windows.media.capture.MediaCategory, encoding_properties: typing.Optional[winsdk.windows.media.mediaproperties.AudioEncodingProperties], device: typing.Optional[winsdk.windows.devices.enumeration.DeviceInformation], emitter: typing.Optional[AudioNodeEmitter]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CreateAudioDeviceInputNodeResult]]: ...
    def create_device_output_node_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CreateAudioDeviceOutputNodeResult]]: ...
    @typing.overload
    def create_file_input_node_async(self, file: typing.Optional[winsdk.windows.storage.IStorageFile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CreateAudioFileInputNodeResult]]: ...
    @typing.overload
    def create_file_input_node_async(self, file: typing.Optional[winsdk.windows.storage.IStorageFile], emitter: typing.Optional[AudioNodeEmitter]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CreateAudioFileInputNodeResult]]: ...
    @typing.overload
    def create_file_output_node_async(self, file: typing.Optional[winsdk.windows.storage.IStorageFile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CreateAudioFileOutputNodeResult]]: ...
    @typing.overload
    def create_file_output_node_async(self, file: typing.Optional[winsdk.windows.storage.IStorageFile], file_encoding_profile: typing.Optional[winsdk.windows.media.mediaproperties.MediaEncodingProfile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CreateAudioFileOutputNodeResult]]: ...
    @typing.overload
    ...
    @typing.overload
    def create_media_source_audio_input_node_async(self, media_source: typing.Optional[winsdk.windows.media.core.MediaSource]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CreateMediaSourceAudioInputNodeResult]]: ...
    @typing.overload
    def create_media_source_audio_input_node_async(self, media_source: typing.Optional[winsdk.windows.media.core.MediaSource], emitter: typing.Optional[AudioNodeEmitter]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CreateMediaSourceAudioInputNodeResult]]: ...
    @typing.overload
...
class AudioPlaybackConnection(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def open_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AudioPlaybackConnectionOpenResult]]: ...
    def start(self) -> None: ...
...
class SpatialAudioDeviceConfiguration(_winrt.Object):
    ...
    def set_default_spatial_audio_format_async(self, subtype: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SetDefaultSpatialAudioFormatResult]]: ...
