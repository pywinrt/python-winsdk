...
class CastingConnection(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class CastingConnectionErrorOccurredEventArgs(_winrt.Object, interfaces=[]):
    error_status: CastingConnectionErrorStatus
    message: str
    @staticmethod
    def _from(obj: _winrt.Object) -> CastingConnectionErrorOccurredEventArgs: ...

class CastingDevice(_winrt.Object, interfaces=[]):
    friendly_name: str
...
class CastingDevicePicker(_winrt.Object, interfaces=[]):
...
class CastingDevicePickerFilter(_winrt.Object, interfaces=[]):
