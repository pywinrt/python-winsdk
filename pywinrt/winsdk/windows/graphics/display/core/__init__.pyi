...
class HdmiDisplayInformation(_winrt.Object):
    ...
    def get_for_current_view() -> HdmiDisplayInformation:
        ...
    def get_supported_display_modes() -> winsdk.windows.foundation.collections.IVectorView[HdmiDisplayMode]:
        ...
    def request_set_current_display_mode_async(mode: HdmiDisplayMode) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def request_set_current_display_mode_async(mode: HdmiDisplayMode, hdr_option: HdmiDisplayHdrOption) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def request_set_current_display_mode_async(mode: HdmiDisplayMode, hdr_option: HdmiDisplayHdrOption, hdr_metadata: HdmiDisplayHdr2086Metadata) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def set_default_display_mode_async() -> winsdk.windows.foundation.IAsyncAction:
        ...
    def add_display_modes_changed(value: winsdk.windows.foundation.TypedEventHandler[HdmiDisplayInformation, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_display_modes_changed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
...
class HdmiDisplayMode(_winrt.Object):
    ...
    def is_equal(mode: HdmiDisplayMode) -> _winrt.Boolean:
        ...
