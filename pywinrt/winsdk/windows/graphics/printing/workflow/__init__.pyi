...
class PrintWorkflowBackgroundSetupRequestedEventArgs(_winrt.Object):
    ...
    def get_user_print_ticket_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.graphics.printing.printticket.WorkflowPrintTicket]]: ...
...
class PrintWorkflowPdlSourceContent(_winrt.Object):
    ...
    def get_content_file_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.StorageFile]]: ...
...
class PrintWorkflowSourceContent(_winrt.Object):
    ...
    def get_job_print_ticket_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.graphics.printing.printticket.WorkflowPrintTicket]]: ...
...
class PrintWorkflowUILauncher(_winrt.Object):
    ...
    def launch_and_complete_u_i_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PrintWorkflowUICompletionStatus]]: ...
