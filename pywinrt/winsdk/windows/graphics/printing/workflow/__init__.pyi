...
class PrintWorkflowBackgroundSession(_winrt.Object, interfaces=[]):
...
class PrintWorkflowBackgroundSetupRequestedEventArgs(_winrt.Object, interfaces=[]):
...
class PrintWorkflowConfiguration(_winrt.Object, interfaces=[]):
    job_title: str
    session_id: str
...
class PrintWorkflowForegroundSession(_winrt.Object, interfaces=[]):
    status: PrintWorkflowSessionStatus
    @staticmethod
...
class PrintWorkflowForegroundSetupRequestedEventArgs(_winrt.Object, interfaces=[]):
    configuration: typing.Optional[PrintWorkflowConfiguration]
    @staticmethod
...
class PrintWorkflowJobActivatedEventArgs(_winrt.Object, interfaces=[winsdk.windows.applicationmodel.activation.IActivatedEventArgs, winsdk.windows.applicationmodel.activation.IActivatedEventArgsWithUser]):
...
class PrintWorkflowJobBackgroundSession(_winrt.Object, interfaces=[]):
    status: PrintWorkflowSessionStatus
    @staticmethod
...
class PrintWorkflowJobNotificationEventArgs(_winrt.Object, interfaces=[]):
    configuration: typing.Optional[PrintWorkflowConfiguration]
...
class PrintWorkflowJobStartingEventArgs(_winrt.Object, interfaces=[]):
    configuration: typing.Optional[PrintWorkflowConfiguration]
...
class PrintWorkflowJobTriggerDetails(_winrt.Object, interfaces=[]):
...
class PrintWorkflowJobUISession(_winrt.Object, interfaces=[]):
    status: PrintWorkflowSessionStatus
    @staticmethod
...
class PrintWorkflowObjectModelSourceFileContent(_winrt.Object, interfaces=[]):
    @staticmethod
...
class PrintWorkflowObjectModelTargetPackage(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> PrintWorkflowObjectModelTargetPackage: ...

class PrintWorkflowPdlConverter(_winrt.Object, interfaces=[]):
    @staticmethod
...
class PrintWorkflowPdlDataAvailableEventArgs(_winrt.Object, interfaces=[]):
    configuration: typing.Optional[PrintWorkflowConfiguration]
    printer_job: typing.Optional[PrintWorkflowPrinterJob]
...
class PrintWorkflowPdlModificationRequestedEventArgs(_winrt.Object, interfaces=[]):
    configuration: typing.Optional[PrintWorkflowConfiguration]
    printer_job: typing.Optional[PrintWorkflowPrinterJob]
    source_content: typing.Optional[PrintWorkflowPdlSourceContent]
    ...
    def create_job_on_printer_with_attributes(self, job_attributes: typing.Iterable[typing.Optional[winsdk.windows.foundation.collections.IKeyValuePair[str, winsdk.windows.devices.printers.IppAttributeValue]]], target_content_type: str) -> typing.Optional[PrintWorkflowPdlTargetStream]: ...
...
class PrintWorkflowPdlSourceContent(_winrt.Object, interfaces=[]):
    content_type: str
    @staticmethod
...
class PrintWorkflowPdlTargetStream(_winrt.Object, interfaces=[]):
    @staticmethod
...
class PrintWorkflowPrinterJob(_winrt.Object, interfaces=[]):
    job_id: _winrt.Int32
    printer: typing.Optional[winsdk.windows.devices.printers.IppPrintDevice]
    @staticmethod
    ...
    def set_job_attributes(self, job_attributes: typing.Iterable[typing.Optional[winsdk.windows.foundation.collections.IKeyValuePair[str, winsdk.windows.devices.printers.IppAttributeValue]]]) -> typing.Optional[winsdk.windows.devices.printers.IppSetAttributesResult]: ...
...
class PrintWorkflowSourceContent(_winrt.Object, interfaces=[]):
    @staticmethod
...
class PrintWorkflowSpoolStreamContent(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> PrintWorkflowSpoolStreamContent: ...
    def get_input_stream(self) -> typing.Optional[winsdk.windows.storage.streams.IInputStream]: ...

class PrintWorkflowStreamTarget(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> PrintWorkflowStreamTarget: ...
    def get_output_stream(self) -> typing.Optional[winsdk.windows.storage.streams.IOutputStream]: ...

class PrintWorkflowSubmittedEventArgs(_winrt.Object, interfaces=[]):
...
class PrintWorkflowSubmittedOperation(_winrt.Object, interfaces=[]):
    configuration: typing.Optional[PrintWorkflowConfiguration]
...
class PrintWorkflowTarget(_winrt.Object, interfaces=[]):
...
class PrintWorkflowTriggerDetails(_winrt.Object, interfaces=[]):
...
class PrintWorkflowUIActivatedEventArgs(_winrt.Object, interfaces=[winsdk.windows.applicationmodel.activation.IActivatedEventArgsWithUser, winsdk.windows.applicationmodel.activation.IActivatedEventArgs]):
    kind: winsdk.windows.applicationmodel.activation.ActivationKind
    previous_execution_state: winsdk.windows.applicationmodel.activation.ApplicationExecutionState
    splash_screen: typing.Optional[winsdk.windows.applicationmodel.activation.SplashScreen]
    user: typing.Optional[winsdk.windows.system.User]
...
class PrintWorkflowUILauncher(_winrt.Object, interfaces=[]):
    @staticmethod
...
class PrintWorkflowXpsDataAvailableEventArgs(_winrt.Object, interfaces=[]):
    operation: typing.Optional[PrintWorkflowSubmittedOperation]
    @staticmethod
