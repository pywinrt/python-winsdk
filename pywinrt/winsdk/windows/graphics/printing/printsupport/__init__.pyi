...
class PrintSupportExtensionSession(_winrt.Object, interfaces=[]):
...
class PrintSupportExtensionTriggerDetails(_winrt.Object, interfaces=[]):
    session: typing.Optional[PrintSupportExtensionSession]
    @staticmethod
    def _from(obj: _winrt.Object) -> PrintSupportExtensionTriggerDetails: ...

class PrintSupportPrintDeviceCapabilitiesChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
...
class PrintSupportPrintTicketValidationRequestedEventArgs(_winrt.Object, interfaces=[]):
...
class PrintSupportSessionInfo(_winrt.Object, interfaces=[]):
    printer: typing.Optional[winsdk.windows.devices.printers.IppPrintDevice]
...
class PrintSupportSettingsActivatedEventArgs(_winrt.Object, interfaces=[winsdk.windows.applicationmodel.activation.IActivatedEventArgs, winsdk.windows.applicationmodel.activation.IActivatedEventArgsWithUser]):
...
class PrintSupportSettingsUISession(_winrt.Object, interfaces=[]):
    document_title: str
