...
class PrintManager(_winrt.Object, interfaces=[]):
    @staticmethod
...
class PrintPageInfo(_winrt.Object, interfaces=[]):
    page_size: winsdk.windows.foundation.Size
...
class PrintPageRange(_winrt.Object, interfaces=[]):
...
class PrintPageRangeOptions(_winrt.Object, interfaces=[]):
...
class PrintTask(_winrt.Object, interfaces=[]):
...
class PrintTaskCompletedEventArgs(_winrt.Object, interfaces=[]):
    completion: PrintTaskCompletion
    @staticmethod
    def _from(obj: _winrt.Object) -> PrintTaskCompletedEventArgs: ...

class PrintTaskOptions(_winrt.Object, interfaces=[IPrintTaskOptionsCore, IPrintTaskOptionsCoreProperties, IPrintTaskOptionsCoreUIConfiguration]):
...
class PrintTaskProgressingEventArgs(_winrt.Object, interfaces=[]):
    document_page_count: _winrt.UInt32
    @staticmethod
    def _from(obj: _winrt.Object) -> PrintTaskProgressingEventArgs: ...

class PrintTaskRequest(_winrt.Object, interfaces=[]):
...
class PrintTaskRequestedDeferral(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> PrintTaskRequestedDeferral: ...
    def complete(self) -> None: ...

class PrintTaskRequestedEventArgs(_winrt.Object, interfaces=[]):
    request: typing.Optional[PrintTaskRequest]
    @staticmethod
    def _from(obj: _winrt.Object) -> PrintTaskRequestedEventArgs: ...

class PrintTaskSourceRequestedArgs(_winrt.Object, interfaces=[]):
    deadline: winsdk.windows.foundation.DateTime
    @staticmethod
...
class PrintTaskSourceRequestedDeferral(_winrt.Object, interfaces=[]):
    @staticmethod
...
class IPrintDocumentSource(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> IPrintDocumentSource: ...

class IPrintTaskOptionsCore(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> IPrintTaskOptionsCore: ...
    def get_page_description(self, job_page_number: _winrt.UInt32) -> PrintPageDescription: ...

class IPrintTaskOptionsCoreProperties(typing.Protocol):
    binding: PrintBinding
    collation: PrintCollation
    color_mode: PrintColorMode
    duplex: PrintDuplex
...
class IPrintTaskOptionsCoreUIConfiguration(typing.Protocol):
    displayed_options: typing.Optional[winsdk.windows.foundation.collections.IVector[str]]
    @staticmethod
