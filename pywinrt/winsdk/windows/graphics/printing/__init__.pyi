...
class PrintPageDescription:
    ...
    dpi_x: _winrt.UInt32
    dpi_y: _winrt.UInt32
    def __init__(self, page_size: winsdk.windows.foundation.Size, imageable_rect: winsdk.windows.foundation.Rect, dpi_x: _winrt.UInt32, dpi_y: _winrt.UInt32) -> None: ...
...
class PrintManager(_winrt.Object):
    ...
    def show_print_u_i_async() -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def add_print_task_requested(event_handler: winsdk.windows.foundation.TypedEventHandler[PrintManager, PrintTaskRequestedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_print_task_requested(event_cookie: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
...
class PrintPageRange(_winrt.Object):
    ...
    def __init__(self, first_page: _winrt.Int32, last_page: _winrt.Int32) -> None:
        ...
    def __init__(self, page: _winrt.Int32) -> None:
        ...
...
class PrintTask(_winrt.Object):
    ...
    properties: winsdk.windows.applicationmodel.datatransfer.DataPackagePropertySet
    ...
    def add_completed(event_handler: winsdk.windows.foundation.TypedEventHandler[PrintTask, PrintTaskCompletedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_completed(event_cookie: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_previewing(event_handler: winsdk.windows.foundation.TypedEventHandler[PrintTask, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_previewing(event_cookie: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_progressing(event_handler: winsdk.windows.foundation.TypedEventHandler[PrintTask, PrintTaskProgressingEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_progressing(event_cookie: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_submitting(event_handler: winsdk.windows.foundation.TypedEventHandler[PrintTask, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
...
class PrintTaskOptions(IPrintTaskOptionsCore, IPrintTaskOptionsCoreProperties, IPrintTaskOptionsCoreUIConfiguration, _winrt.Object):
    ...
    bordering: PrintBordering
    page_range_options: PrintPageRangeOptions
    custom_page_ranges: winsdk.windows.foundation.collections.IVector[PrintPageRange]
    ...
    def get_page_description(job_page_number: _winrt.UInt32) -> PrintPageDescription:
        ...
    def get_page_print_ticket(print_page_info: PrintPageInfo) -> winsdk.windows.storage.streams.IRandomAccessStream:
        ...
