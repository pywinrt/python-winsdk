...
class PrintTicketCapabilities(_winrt.Object, interfaces=[]):
...
class PrintTicketFeature(_winrt.Object, interfaces=[]):
    display_name: str
    name: str
...
class PrintTicketOption(_winrt.Object, interfaces=[]):
    display_name: str
    name: str
    xml_namespace: str
    xml_node: typing.Optional[winsdk.windows.data.xml.dom.IXmlNode]
...
class PrintTicketParameterDefinition(_winrt.Object, interfaces=[]):
...
class PrintTicketParameterInitializer(_winrt.Object, interfaces=[]):
...
class PrintTicketValue(_winrt.Object, interfaces=[]):
...
class WorkflowPrintTicket(_winrt.Object, interfaces=[]):
    document_binding_feature: typing.Optional[PrintTicketFeature]
    document_collate_feature: typing.Optional[PrintTicketFeature]
    document_duplex_feature: typing.Optional[PrintTicketFeature]
    document_hole_punch_feature: typing.Optional[PrintTicketFeature]
...
class WorkflowPrintTicketValidationResult(_winrt.Object, interfaces=[]):
