...
class Print3DManager(_winrt.Object):
    ...
    @staticmethod
    def show_print_u_i_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class Printing3D3MFPackage(_winrt.Object):
    ...
    @staticmethod
    def load_async(value: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Printing3D3MFPackage]]: ...
    def load_model_from_package_async(self, value: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Printing3DModel]]: ...
    def save_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IRandomAccessStream]]: ...
...
class Printing3DMesh(_winrt.Object):
    ...
    def verify_async(self, value: Printing3DMeshVerificationMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Printing3DMeshVerificationResult]]: ...
...
class Printing3DModel(_winrt.Object):
    ...
    def repair_with_progress_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.Boolean, _winrt.Double]]: ...
    @typing.overload
    def try_partial_repair_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_partial_repair_async(self, max_wait_time: winsdk.windows.foundation.TimeSpan) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_reduce_faces_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.Boolean, _winrt.Double]]: ...
    @typing.overload
    def try_reduce_faces_async(self, printing3_d_face_reduction_options: typing.Optional[Printing3DFaceReductionOptions]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.Boolean, _winrt.Double]]: ...
    @typing.overload
    def try_reduce_faces_async(self, printing3_d_face_reduction_options: typing.Optional[Printing3DFaceReductionOptions], max_wait: winsdk.windows.foundation.TimeSpan) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[_winrt.Boolean, _winrt.Double]]: ...
