...
class Print3DManager(_winrt.Object, interfaces=[]):
    @staticmethod
...
class Print3DTask(_winrt.Object, interfaces=[]):
...
class Print3DTaskCompletedEventArgs(_winrt.Object, interfaces=[]):
...
class Print3DTaskRequest(_winrt.Object, interfaces=[]):
    @staticmethod
...
class Print3DTaskRequestedEventArgs(_winrt.Object, interfaces=[]):
    request: typing.Optional[Print3DTaskRequest]
    @staticmethod
    def _from(obj: _winrt.Object) -> Print3DTaskRequestedEventArgs: ...

class Print3DTaskSourceChangedEventArgs(_winrt.Object, interfaces=[]):
    source: typing.Optional[Printing3D3MFPackage]
    @staticmethod
    def _from(obj: _winrt.Object) -> Print3DTaskSourceChangedEventArgs: ...

class Print3DTaskSourceRequestedArgs(_winrt.Object, interfaces=[]):
    @staticmethod
...
class Printing3D3MFPackage(_winrt.Object, interfaces=[]):
...
class Printing3DBaseMaterial(_winrt.Object, interfaces=[]):
    name: str
...
class Printing3DBaseMaterialGroup(_winrt.Object, interfaces=[]):
...
class Printing3DColorMaterial(_winrt.Object, interfaces=[]):
    value: _winrt.UInt32
...
class Printing3DColorMaterialGroup(_winrt.Object, interfaces=[]):
...
class Printing3DComponent(_winrt.Object, interfaces=[]):
...
class Printing3DComponentWithMatrix(_winrt.Object, interfaces=[]):
...
class Printing3DCompositeMaterial(_winrt.Object, interfaces=[]):
...
class Printing3DCompositeMaterialGroup(_winrt.Object, interfaces=[]):
...
class Printing3DFaceReductionOptions(_winrt.Object, interfaces=[]):
...
class Printing3DMaterial(_winrt.Object, interfaces=[]):
...
class Printing3DMesh(_winrt.Object, interfaces=[]):
...
class Printing3DMeshVerificationResult(_winrt.Object, interfaces=[]):
...
class Printing3DModel(_winrt.Object, interfaces=[]):
    version: str
...
class Printing3DModelTexture(_winrt.Object, interfaces=[]):
...
class Printing3DMultiplePropertyMaterial(_winrt.Object, interfaces=[]):
    material_indices: typing.Optional[winsdk.windows.foundation.collections.IVector[_winrt.UInt32]]
    @staticmethod
    def _from(obj: _winrt.Object) -> Printing3DMultiplePropertyMaterial: ...
    def __init__(self) -> None: ...

class Printing3DMultiplePropertyMaterialGroup(_winrt.Object, interfaces=[]):
    material_group_id: _winrt.UInt32
...
class Printing3DTexture2CoordMaterial(_winrt.Object, interfaces=[]):
    v: _winrt.Double
    u: _winrt.Double
...
class Printing3DTexture2CoordMaterialGroup(_winrt.Object, interfaces=[]):
    material_group_id: _winrt.UInt32
...
class Printing3DTextureResource(_winrt.Object, interfaces=[]):
