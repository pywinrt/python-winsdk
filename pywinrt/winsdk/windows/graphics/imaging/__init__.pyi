...
class BitmapBounds:
    ...
    def __new__(cls: typing.Type[BitmapBounds], x: _winrt.UInt32, y: _winrt.UInt32, width: _winrt.UInt32, height: _winrt.UInt32) -> BitmapBounds: ...
...
class BitmapPlaneDescription:
    ...
    height: _winrt.Int32
    stride: _winrt.Int32
    def __new__(cls: typing.Type[BitmapPlaneDescription], start_index: _winrt.Int32, width: _winrt.Int32, height: _winrt.Int32, stride: _winrt.Int32) -> BitmapPlaneDescription: ...

class BitmapSize:
    width: _winrt.UInt32
    height: _winrt.UInt32
    def __new__(cls: typing.Type[BitmapSize], width: _winrt.UInt32, height: _winrt.UInt32) -> BitmapSize: ...

class BitmapBuffer(_winrt.Object):
...
class BitmapDecoder(_winrt.Object):
    ...
    bmp_decoder_id: _winrt.Guid
    gif_decoder_id: _winrt.Guid
    ico_decoder_id: _winrt.Guid
    jpeg_decoder_id: _winrt.Guid
    jpeg_x_r_decoder_id: _winrt.Guid
    png_decoder_id: _winrt.Guid
    tiff_decoder_id: _winrt.Guid
    heif_decoder_id: _winrt.Guid
    webp_decoder_id: _winrt.Guid
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def create_async(decoder_id: _winrt.Guid, stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream]) -> winsdk.windows.foundation.IAsyncOperation[BitmapDecoder]: ...
    @staticmethod
...
class BitmapEncoder(_winrt.Object):
    ...
    bmp_encoder_id: _winrt.Guid
    gif_encoder_id: _winrt.Guid
    jpeg_encoder_id: _winrt.Guid
    jpeg_x_r_encoder_id: _winrt.Guid
    png_encoder_id: _winrt.Guid
    tiff_encoder_id: _winrt.Guid
    heif_encoder_id: _winrt.Guid
    @staticmethod
    def _from(obj: _winrt.Object) -> BitmapEncoder: ...
    @typing.overload
    @staticmethod
    def create_async(encoder_id: _winrt.Guid, stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream]) -> winsdk.windows.foundation.IAsyncOperation[BitmapEncoder]: ...
    @typing.overload
    @staticmethod
    def create_async(encoder_id: _winrt.Guid, stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream], encoding_options: typing.Iterable[winsdk.windows.foundation.collections.IKeyValuePair[str, BitmapTypedValue]]) -> winsdk.windows.foundation.IAsyncOperation[BitmapEncoder]: ...
    @staticmethod
    ...
    @typing.overload
    def go_to_next_frame_async(self, encoding_options: typing.Iterable[winsdk.windows.foundation.collections.IKeyValuePair[str, BitmapTypedValue]]) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
...
class BitmapFrame(_winrt.Object):
    bitmap_alpha_mode: BitmapAlphaMode
    bitmap_pixel_format: BitmapPixelFormat
    bitmap_properties: typing.Optional[BitmapPropertiesView]
    dpi_x: _winrt.Double
...
class BitmapProperties(_winrt.Object):
    @staticmethod
    ...
    def set_properties_async(self, properties_to_set: typing.Iterable[winsdk.windows.foundation.collections.IKeyValuePair[str, BitmapTypedValue]]) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...

class BitmapPropertiesView(_winrt.Object):
    @staticmethod
    def _from(obj: _winrt.Object) -> BitmapPropertiesView: ...
    def get_properties_async(self, properties_to_retrieve: typing.Iterable[str]) -> winsdk.windows.foundation.IAsyncOperation[BitmapPropertySet]: ...

class BitmapPropertySet(_winrt.Object, typing.MutableMapping[str, BitmapTypedValue]):
    size: _winrt.UInt32
...
class BitmapTypedValue(_winrt.Object):
    ...
    def __new__(cls: typing.Type[BitmapTypedValue], value: typing.Optional[_winrt.Object], type: winsdk.windows.foundation.PropertyType) -> BitmapTypedValue:...

class ImageStream(_winrt.Object):
    content_type: str
    size: _winrt.UInt64
...
class SoftwareBitmap(_winrt.Object):
    dpi_y: _winrt.Double
    dpi_x: _winrt.Double
    bitmap_alpha_mode: BitmapAlphaMode
    bitmap_pixel_format: BitmapPixelFormat
    ...
    @typing.overload
    def __new__(cls: typing.Type[SoftwareBitmap], format: BitmapPixelFormat, width: _winrt.Int32, height: _winrt.Int32) -> SoftwareBitmap:...
    @typing.overload
    def __new__(cls: typing.Type[SoftwareBitmap], format: BitmapPixelFormat, width: _winrt.Int32, height: _winrt.Int32, alpha: BitmapAlphaMode) -> SoftwareBitmap:...
    def close(self) -> None: ...
    @typing.overload
    @staticmethod
...
class IBitmapFrameWithSoftwareBitmap(_winrt.Object):
    bitmap_alpha_mode: BitmapAlphaMode
    bitmap_pixel_format: BitmapPixelFormat
    bitmap_properties: typing.Optional[BitmapPropertiesView]
    dpi_x: _winrt.Double
