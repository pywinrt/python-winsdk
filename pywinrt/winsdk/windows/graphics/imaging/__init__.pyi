...
class BitmapDecoder(IBitmapFrame, IBitmapFrameWithSoftwareBitmap, _winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def create_async(stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BitmapDecoder]]: ...
    @typing.overload
    @staticmethod
    def create_async(decoder_id: uuid.UUID, stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BitmapDecoder]]: ...
    @staticmethod
    ...
    def get_frame_async(self, frame_index: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BitmapFrame]]: ...
    @typing.overload
    def get_pixel_data_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PixelDataProvider]]: ...
    @typing.overload
    def get_pixel_data_async(self, pixel_format: BitmapPixelFormat, alpha_mode: BitmapAlphaMode, transform: typing.Optional[BitmapTransform], exif_orientation_mode: ExifOrientationMode, color_management_mode: ColorManagementMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PixelDataProvider]]: ...
    def get_preview_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ImageStream]]: ...
    @typing.overload
    def get_software_bitmap_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SoftwareBitmap]]: ...
    @typing.overload
    def get_software_bitmap_async(self, pixel_format: BitmapPixelFormat, alpha_mode: BitmapAlphaMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SoftwareBitmap]]: ...
    @typing.overload
    def get_software_bitmap_async(self, pixel_format: BitmapPixelFormat, alpha_mode: BitmapAlphaMode, transform: typing.Optional[BitmapTransform], exif_orientation_mode: ExifOrientationMode, color_management_mode: ColorManagementMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SoftwareBitmap]]: ...
    def get_thumbnail_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ImageStream]]: ...
...
class BitmapEncoder(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def create_async(encoder_id: uuid.UUID, stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BitmapEncoder]]: ...
    @typing.overload
    @staticmethod
    def create_async(encoder_id: uuid.UUID, stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream], encoding_options: typing.Iterable[typing.Optional[winsdk.windows.foundation.collections.IKeyValuePair[str, BitmapTypedValue]]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BitmapEncoder]]: ...
    @staticmethod
    def create_for_in_place_property_encoding_async(bitmap_decoder: typing.Optional[BitmapDecoder]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BitmapEncoder]]: ...
    @staticmethod
    def create_for_transcoding_async(stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream], bitmap_decoder: typing.Optional[BitmapDecoder]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BitmapEncoder]]: ...
...
class BitmapProperties(IBitmapPropertiesView, _winrt.Object):
    ...
    def get_properties_async(self, properties_to_retrieve: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BitmapPropertySet]]: ...
...
class SoftwareBitmap(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def create_copy_from_surface_async(surface: typing.Optional[winsdk.windows.graphics.directx.direct3d11.IDirect3DSurface]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SoftwareBitmap]]: ...
    @typing.overload
    @staticmethod
    def create_copy_from_surface_async(surface: typing.Optional[winsdk.windows.graphics.directx.direct3d11.IDirect3DSurface], alpha: BitmapAlphaMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SoftwareBitmap]]: ...
