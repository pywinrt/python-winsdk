...
class BitmapEncoder(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def create_async(encoder_id: uuid.UUID, stream: typing.Optional[winsdk.windows.storage.streams.IRandomAccessStream], encoding_options: typing.Iterable[winsdk.windows.foundation.collections.IKeyValuePair[str, BitmapTypedValue]]) -> winsdk.windows.foundation.IAsyncOperation[BitmapEncoder]: ...
    @staticmethod
