...
class SpatialSurfaceInfo(_winrt.Object, interfaces=[]):
    id: uuid.UUID
...
class SpatialSurfaceMesh(_winrt.Object, interfaces=[]):
...
class SpatialSurfaceMeshBuffer(_winrt.Object, interfaces=[]):
...
class SpatialSurfaceMeshOptions(_winrt.Object, interfaces=[]):
...
class SpatialSurfaceObserver(_winrt.Object, interfaces=[]):
    @staticmethod
