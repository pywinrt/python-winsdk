...
class SpatialSurfaceInfo(_winrt.Object):
    ...
    @typing.overload
    def try_compute_latest_mesh_async(self, max_triangles_per_cubic_meter: _winrt.Double) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SpatialSurfaceMesh]]: ...
    @typing.overload
    def try_compute_latest_mesh_async(self, max_triangles_per_cubic_meter: _winrt.Double, options: typing.Optional[SpatialSurfaceMeshOptions]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SpatialSurfaceMesh]]: ...
...
class SpatialSurfaceObserver(_winrt.Object):
    ...
    @staticmethod
    def request_access_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.perception.spatial.SpatialPerceptionAccessStatus]]: ...
    def set_bounding_volume(self, bounds: typing.Optional[winsdk.windows.perception.spatial.SpatialBoundingVolume]) -> None: ...
    def set_bounding_volumes(self, bounds: typing.Iterable[typing.Optional[winsdk.windows.perception.spatial.SpatialBoundingVolume]]) -> None: ...
