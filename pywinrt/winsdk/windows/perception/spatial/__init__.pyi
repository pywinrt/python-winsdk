...
class SpatialAnchorExporter(_winrt.Object):
    ...
    def get_anchor_export_sufficiency_async(self, anchor: typing.Optional[SpatialAnchor], purpose: SpatialAnchorExportPurpose) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SpatialAnchorExportSufficiency]]: ...
    @staticmethod
    def get_default() -> typing.Optional[SpatialAnchorExporter]: ...
    @staticmethod
    def request_access_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SpatialPerceptionAccessStatus]]: ...
    def try_export_anchor_async(self, anchor: typing.Optional[SpatialAnchor], purpose: SpatialAnchorExportPurpose, stream: typing.Optional[winsdk.windows.storage.streams.IOutputStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...

class SpatialAnchorManager(_winrt.Object):
    @staticmethod
    def _from(obj: _winrt.Object) -> SpatialAnchorManager: ...
    @staticmethod
    def request_store_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SpatialAnchorStore]]: ...
...
class SpatialAnchorTransferManager(_winrt.Object):
    ...
    def request_access_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SpatialPerceptionAccessStatus]]: ...
    @staticmethod
    def try_export_anchors_async(anchors: typing.Iterable[typing.Optional[winsdk.windows.foundation.collections.IKeyValuePair[str, SpatialAnchor]]], stream: typing.Optional[winsdk.windows.storage.streams.IOutputStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @staticmethod
    def try_import_anchors_async(stream: typing.Optional[winsdk.windows.storage.streams.IInputStream]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IMapView[str, SpatialAnchor]]]: ...
...
class SpatialStageFrameOfReference(_winrt.Object):
    ...
    @staticmethod
    def request_new_stage_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SpatialStageFrameOfReference]]: ...
