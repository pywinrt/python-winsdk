...
class EyesPose(_winrt.Object):
    ...
    gaze: typing.Optional[winsdk.windows.perception.spatial.SpatialRay]
    is_calibration_valid: _winrt.Boolean
    update_timestamp: winsdk.windows.perception.PerceptionTimestamp
...
class HandMeshObserver(_winrt.Object):
    ...
    source: winsdk.windows.ui.input.spatial.SpatialInteractionSource
    triangle_index_count: _winrt.UInt32
    vertex_count: _winrt.UInt32
    def get_triangle_indices(indices_size: _winrt.UInt32) -> typing.List[_winrt.UInt16]:
        ...
...
class HandMeshVertexState(_winrt.Object):
    ...
    update_timestamp: winsdk.windows.perception.PerceptionTimestamp
    def get_vertices(vertices_size: _winrt.UInt32) -> typing.List[HandMeshVertex]:
        ...
...
class HandPose(_winrt.Object):
    ...
    def get_relative_joint(joint: HandJointKind, reference_joint: HandJointKind) -> JointPose:
        ...
    def get_relative_joints(joints: typing.Sequence[HandJointKind], reference_joints: typing.Sequence[HandJointKind], joint_poses_size: _winrt.UInt32) -> typing.List[JointPose]:
        ...
    def try_get_joint(coordinate_system: winsdk.windows.perception.spatial.SpatialCoordinateSystem, joint: HandJointKind) -> typing.Tuple[_winrt.Boolean, JointPose]:
        ...
    def try_get_joints(coordinate_system: winsdk.windows.perception.spatial.SpatialCoordinateSystem, joints: typing.Sequence[HandJointKind], joint_poses_size: _winrt.UInt32) -> typing.Tuple[_winrt.Boolean, typing.List[JointPose]]:
        ...
