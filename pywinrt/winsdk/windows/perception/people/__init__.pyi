...
class JointPose:
    ...
    def __new__(cls: typing.Type[JointPose], orientation: winsdk.windows.foundation.numerics.Quaternion, position: winsdk.windows.foundation.numerics.Vector3, radius: _winrt.Single, accuracy: JointPoseAccuracy) -> JointPose: ...
