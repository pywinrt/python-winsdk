...
class EyesPose(_winrt.Object, interfaces=[]):
...
class HandMeshObserver(_winrt.Object, interfaces=[]):
...
class HandMeshVertexState(_winrt.Object, interfaces=[]):
...
class HandPose(_winrt.Object, interfaces=[]):
    @staticmethod
...
class HeadPose(_winrt.Object, interfaces=[]):
