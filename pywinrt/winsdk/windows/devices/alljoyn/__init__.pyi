...
class AllJoynAboutDataView(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def get_data_by_session_port_async(unique_name: str, bus_attachment: typing.Optional[AllJoynBusAttachment], session_port: _winrt.UInt16) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AllJoynAboutDataView]]: ...
    @typing.overload
    @staticmethod
    def get_data_by_session_port_async(unique_name: str, bus_attachment: typing.Optional[AllJoynBusAttachment], session_port: _winrt.UInt16, language: typing.Optional[winsdk.windows.globalization.Language]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AllJoynAboutDataView]]: ...
...
class AllJoynBusAttachment(_winrt.Object):
    ...
    @typing.overload
    def get_about_data_async(self, service_info: typing.Optional[AllJoynServiceInfo]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AllJoynAboutDataView]]: ...
    @typing.overload
    def get_about_data_async(self, service_info: typing.Optional[AllJoynServiceInfo], language: typing.Optional[winsdk.windows.globalization.Language]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AllJoynAboutDataView]]: ...
    @staticmethod
    ...
    def ping_async(self, unique_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Int32]]: ...
...
class AllJoynServiceInfo(_winrt.Object):
    ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AllJoynServiceInfo]]: ...
...
class AllJoynSession(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def get_from_service_info_async(service_info: typing.Optional[AllJoynServiceInfo]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AllJoynSession]]: ...
    @typing.overload
    @staticmethod
    def get_from_service_info_async(service_info: typing.Optional[AllJoynServiceInfo], bus_attachment: typing.Optional[AllJoynBusAttachment]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[AllJoynSession]]: ...
    def remove_member_async(self, unique_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Int32]]: ...
