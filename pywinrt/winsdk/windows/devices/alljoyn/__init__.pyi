...
class AllJoynBusAttachment(_winrt.Object):
    ...
    @typing.overload
    def get_about_data_async(self, service_info: AllJoynServiceInfo) -> winsdk.windows.foundation.IAsyncOperation[AllJoynAboutDataView]: ...
    @typing.overload
    def get_about_data_async(self, service_info: AllJoynServiceInfo, language: winsdk.windows.globalization.Language) -> winsdk.windows.foundation.IAsyncOperation[AllJoynAboutDataView]: ...
    @typing.overload
    @staticmethod
...
class AllJoynBusObject(_winrt.Object):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def add_producer(self, producer: IAllJoynProducer) -> None: ...
    @typing.overload
    def start(self) -> None: ...
    @typing.overload
    def stop(self) -> None: ...
...
class IAllJoynProducer(_winrt.Object):
    ...
    @typing.overload
    def set_bus_object(self, bus_object: AllJoynBusObject) -> None: ...
