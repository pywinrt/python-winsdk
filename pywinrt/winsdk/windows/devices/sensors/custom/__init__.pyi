...
class CustomSensor(_winrt.Object, interfaces=[]):
...
class CustomSensorReading(_winrt.Object, interfaces=[]):
...
class CustomSensorReadingChangedEventArgs(_winrt.Object, interfaces=[]):
