...
class GpioChangeCount:
    ...
    def __new__(cls: typing.Type[GpioChangeCount], count: _winrt.UInt64, relative_time: datetime.timedelta) -> GpioChangeCount: ...
...
class GpioChangeReader(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[GpioChangeReader], pin: typing.Optional[GpioPin], min_capacity: _winrt.Int32) -> GpioChangeReader:...
    def clear(self) -> None: ...
    def close(self) -> None: ...
