...
class GpioChangeCounter(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class GpioChangeReader(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
    polarity: GpioChangePolarity
...
class GpioController(_winrt.Object, interfaces=[]):
...
class GpioPin(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class GpioPinValueChangedEventArgs(_winrt.Object, interfaces=[]):
    edge: GpioPinEdge
    @staticmethod
