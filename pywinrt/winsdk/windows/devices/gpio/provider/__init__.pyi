...
class GpioPinProviderValueChangedEventArgs(_winrt.Object, interfaces=[]):
...
class IGpioControllerProvider(typing.Protocol):
...
class IGpioPinProvider(typing.Protocol):
...
class IGpioProvider(typing.Protocol):
    @staticmethod
