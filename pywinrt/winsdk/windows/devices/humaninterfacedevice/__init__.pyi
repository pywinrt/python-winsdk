...
class HidDevice(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    @staticmethod
    def from_id_async(device_id: str, access_mode: winsdk.windows.storage.FileAccessMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[HidDevice]]: ...
    ...
    @typing.overload
    def get_feature_report_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[HidFeatureReport]]: ...
    @typing.overload
    def get_feature_report_async(self, report_id: _winrt.UInt16) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[HidFeatureReport]]: ...
    @typing.overload
    def get_input_report_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[HidInputReport]]: ...
    @typing.overload
    def get_input_report_async(self, report_id: _winrt.UInt16) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[HidInputReport]]: ...
    ...
    def send_feature_report_async(self, feature_report: typing.Optional[HidFeatureReport]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.UInt32]]: ...
    def send_output_report_async(self, output_report: typing.Optional[HidOutputReport]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.UInt32]]: ...
