...
class BarcodeScanner(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def check_health_async(self, level: UnifiedPosHealthCheckLevel) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    def claim_scanner_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ClaimedBarcodeScanner]]: ...
    def close(self) -> None: ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BarcodeScanner]]: ...
    @staticmethod
    def get_default_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BarcodeScanner]]: ...
    @typing.overload
    @staticmethod
    ...
    def get_supported_symbologies_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[_winrt.UInt32]]]: ...
    def is_profile_supported(self, profile: str) -> _winrt.Boolean: ...
    def is_symbology_supported_async(self, barcode_symbology: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def retrieve_statistics_async(self, statistics_categories: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IBuffer]]: ...
...
class CashDrawer(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def check_health_async(self, level: UnifiedPosHealthCheckLevel) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    def claim_drawer_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ClaimedCashDrawer]]: ...
    def close(self) -> None: ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CashDrawer]]: ...
    @staticmethod
    def get_default_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CashDrawer]]: ...
    @typing.overload
    @staticmethod
    def get_device_selector() -> str: ...
    @typing.overload
    @staticmethod
    def get_device_selector(connection_types: PosConnectionTypes) -> str: ...
    def get_statistics_async(self, statistics_categories: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
...
class CashDrawerCloseAlarm(_winrt.Object):
    ...
    def start_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class ClaimedBarcodeScanner(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def get_symbology_attributes_async(self, barcode_symbology: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BarcodeSymbologyAttributes]]: ...
    ...
    def set_symbology_attributes_async(self, barcode_symbology: _winrt.UInt32, attributes: typing.Optional[BarcodeSymbologyAttributes]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def show_video_preview_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    ...
    def update_statistics_async(self, statistics: typing.Iterable[typing.Optional[winsdk.windows.foundation.collections.IKeyValuePair[str, str]]]) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
...
class ClaimedCashDrawer(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def disable_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def enable_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def open_drawer_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def reset_statistics_async(self, statistics_categories: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def retain_device_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def update_statistics_async(self, statistics: typing.Iterable[typing.Optional[winsdk.windows.foundation.collections.IKeyValuePair[str, str]]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class ClaimedLineDisplay(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def check_health_async(self, level: UnifiedPosHealthCheckLevel) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    def check_power_status_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LineDisplayPowerStatus]]: ...
    def close(self) -> None: ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ClaimedLineDisplay]]: ...
    ...
    def get_statistics_async(self, statistics_categories: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    def retain_device(self) -> None: ...
    def try_clear_descriptors_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_create_window_async(self, viewport: winsdk.windows.foundation.Rect, window_size: winsdk.windows.foundation.Size) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LineDisplayWindow]]: ...
    def try_set_descriptor_async(self, descriptor: _winrt.UInt32, descriptor_state: LineDisplayDescriptorState) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_store_storage_file_bitmap_async(self, bitmap: typing.Optional[winsdk.windows.storage.StorageFile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LineDisplayStoredBitmap]]: ...
    @typing.overload
    def try_store_storage_file_bitmap_async(self, bitmap: typing.Optional[winsdk.windows.storage.StorageFile], horizontal_alignment: LineDisplayHorizontalAlignment, vertical_alignment: LineDisplayVerticalAlignment) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LineDisplayStoredBitmap]]: ...
    @typing.overload
    def try_store_storage_file_bitmap_async(self, bitmap: typing.Optional[winsdk.windows.storage.StorageFile], horizontal_alignment: LineDisplayHorizontalAlignment, vertical_alignment: LineDisplayVerticalAlignment, width_in_pixels: _winrt.Int32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LineDisplayStoredBitmap]]: ...
    def try_update_attributes_async(self, attributes: typing.Optional[LineDisplayAttributes]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class ClaimedMagneticStripeReader(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def reset_statistics_async(self, statistics_categories: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    def retain_device(self) -> None: ...
    def retrieve_device_authentication_data_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IBuffer]]: ...
...
class ClaimedSlipPrinter(ICommonClaimedPosPrinterStation, _winrt.Object):
    ...
    def insert_slip_async(self, timeout: winsdk.windows.foundation.TimeSpan) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def open_jaws(self) -> None: ...
    def remove_slip_async(self, timeout: winsdk.windows.foundation.TimeSpan) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def validate_data(self, data: str) -> _winrt.Boolean: ...

class JournalPrintJob(IPosPrinterJob, _winrt.Object):
    @staticmethod
    def _from(obj: _winrt.Object) -> JournalPrintJob: ...
    def execute_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class LineDisplay(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def check_power_status_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LineDisplayPowerStatus]]: ...
    def claim_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ClaimedLineDisplay]]: ...
    def close(self) -> None: ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LineDisplay]]: ...
    @staticmethod
    def get_default_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[LineDisplay]]: ...
    @typing.overload
    @staticmethod
    def get_device_selector() -> str: ...
    @typing.overload
...
class LineDisplayCursor(_winrt.Object):
    ...
    def try_update_attributes_async(self, attributes: typing.Optional[LineDisplayCursorAttributes]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class LineDisplayCustomGlyphs(_winrt.Object):
    ...
    def try_redefine_async(self, glyph_code: _winrt.UInt32, glyph_data: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class LineDisplayMarquee(_winrt.Object):
    ...
    def try_start_scrolling_async(self, direction: LineDisplayScrollDirection) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_stop_scrolling_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class LineDisplayStoredBitmap(_winrt.Object):
    ...
    def try_delete_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class LineDisplayWindow(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def read_character_at_cursor_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.UInt32]]: ...
    def try_clear_text_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_display_storage_file_bitmap_at_cursor_async(self, bitmap: typing.Optional[winsdk.windows.storage.StorageFile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_display_storage_file_bitmap_at_cursor_async(self, bitmap: typing.Optional[winsdk.windows.storage.StorageFile], horizontal_alignment: LineDisplayHorizontalAlignment, vertical_alignment: LineDisplayVerticalAlignment) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_display_storage_file_bitmap_at_cursor_async(self, bitmap: typing.Optional[winsdk.windows.storage.StorageFile], horizontal_alignment: LineDisplayHorizontalAlignment, vertical_alignment: LineDisplayVerticalAlignment, width_in_pixels: _winrt.Int32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_display_storage_file_bitmap_at_point_async(self, bitmap: typing.Optional[winsdk.windows.storage.StorageFile], offset_in_pixels: winsdk.windows.foundation.Point) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_display_storage_file_bitmap_at_point_async(self, bitmap: typing.Optional[winsdk.windows.storage.StorageFile], offset_in_pixels: winsdk.windows.foundation.Point, width_in_pixels: _winrt.Int32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_display_stored_bitmap_at_cursor_async(self, bitmap: typing.Optional[LineDisplayStoredBitmap]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_display_text_async(self, text: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_display_text_async(self, text: str, display_attribute: LineDisplayTextAttribute) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_display_text_async(self, text: str, display_attribute: LineDisplayTextAttribute, start_position: winsdk.windows.foundation.Point) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_refresh_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def try_scroll_text_async(self, direction: LineDisplayScrollDirection, number_of_columns_or_rows: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class MagneticStripeReader(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def check_health_async(self, level: UnifiedPosHealthCheckLevel) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    def claim_reader_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ClaimedMagneticStripeReader]]: ...
    def close(self) -> None: ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MagneticStripeReader]]: ...
    @staticmethod
    def get_default_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MagneticStripeReader]]: ...
    @typing.overload
    @staticmethod
    def get_device_selector() -> str: ...
    @typing.overload
...
class PosPrinter(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def check_health_async(self, level: UnifiedPosHealthCheckLevel) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    def claim_printer_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ClaimedPosPrinter]]: ...
    def close(self) -> None: ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PosPrinter]]: ...
    @staticmethod
    def get_default_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PosPrinter]]: ...
    @typing.overload
    @staticmethod
    def get_device_selector() -> str: ...
    @typing.overload
