...
class IppAttributeError(_winrt.Object, interfaces=[]):
...
class IppAttributeValue(_winrt.Object, interfaces=[]):
...
class IppIntegerRange(_winrt.Object, interfaces=[]):
    end: _winrt.Int32
    start: _winrt.Int32
    @staticmethod
...
class IppPrintDevice(_winrt.Object, interfaces=[]):
    printer_name: str
...
class IppResolution(_winrt.Object, interfaces=[]):
    height: _winrt.Int32
...
class IppSetAttributesResult(_winrt.Object, interfaces=[]):
...
class IppTextWithLanguage(_winrt.Object, interfaces=[]):
    language: str
    value: str
    @staticmethod
...
class Print3DDevice(_winrt.Object, interfaces=[]):
...
class PrintSchema(_winrt.Object, interfaces=[]):
    @staticmethod
