...
class IppIntegerRange(_winrt.Object):
    ...
    def __new__(cls: typing.Type[IppIntegerRange], start: _winrt.Int32, end: _winrt.Int32) -> IppIntegerRange:...
...
class IppResolution(_winrt.Object):
    ...
    def __new__(cls: typing.Type[IppResolution], width: _winrt.Int32, height: _winrt.Int32, unit: IppResolutionUnit) -> IppResolution:...
