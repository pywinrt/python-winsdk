...
class Print3DWorkflow(_winrt.Object, interfaces=[]):
...
class Print3DWorkflowPrintRequestedEventArgs(_winrt.Object, interfaces=[]):
...
class Print3DWorkflowPrinterChangedEventArgs(_winrt.Object, interfaces=[]):
    new_device_id: str
    @staticmethod
