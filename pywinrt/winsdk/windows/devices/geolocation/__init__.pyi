...
class BasicGeoposition:
    ...
    def __new__(cls: typing.Type[BasicGeoposition], latitude: _winrt.Double, longitude: _winrt.Double, altitude: _winrt.Double) -> BasicGeoposition: ...
...
class GeoboundingBox(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[GeoboundingBox], northwest_corner: BasicGeoposition, southeast_corner: BasicGeoposition, altitude_reference_system: AltitudeReferenceSystem, spatial_reference_id: _winrt.UInt32) -> GeoboundingBox:...
    @typing.overload
    @staticmethod
...
class Geocircle(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[Geocircle], position: BasicGeoposition, radius: _winrt.Double) -> Geocircle:...
    @typing.overload
    def __new__(cls: typing.Type[Geocircle], position: BasicGeoposition, radius: _winrt.Double, altitude_reference_system: AltitudeReferenceSystem) -> Geocircle:...
    @typing.overload
    def __new__(cls: typing.Type[Geocircle], position: BasicGeoposition, radius: _winrt.Double, altitude_reference_system: AltitudeReferenceSystem, spatial_reference_id: _winrt.UInt32) -> Geocircle:...
...
class Geopath(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[Geopath], positions: typing.Iterable[BasicGeoposition], altitude_reference_system: AltitudeReferenceSystem, spatial_reference_id: _winrt.UInt32) -> Geopath:...
...
class Geopoint(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[Geopoint], position: BasicGeoposition, altitude_reference_system: AltitudeReferenceSystem, spatial_reference_id: _winrt.UInt32) -> Geopoint:...
