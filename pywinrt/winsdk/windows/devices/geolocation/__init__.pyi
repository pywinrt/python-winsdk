...
class CivicAddress(_winrt.Object, interfaces=[]):
    city: str
    country: str
    postal_code: str
    state: str
...
class GeoboundingBox(_winrt.Object, interfaces=[IGeoshape]):
...
class Geocircle(_winrt.Object, interfaces=[IGeoshape]):
    center: BasicGeoposition
...
class Geocoordinate(_winrt.Object, interfaces=[]):
...
class GeocoordinateSatelliteData(_winrt.Object, interfaces=[]):
...
class Geolocator(_winrt.Object, interfaces=[]):
...
class Geopath(_winrt.Object, interfaces=[IGeoshape]):
...
class Geopoint(_winrt.Object, interfaces=[IGeoshape]):
...
class Geoposition(_winrt.Object, interfaces=[]):
...
class Geovisit(_winrt.Object, interfaces=[]):
...
class GeovisitMonitor(_winrt.Object, interfaces=[]):
...
class GeovisitStateChangedEventArgs(_winrt.Object, interfaces=[]):
    visit: typing.Optional[Geovisit]
    @staticmethod
    def _from(obj: _winrt.Object) -> GeovisitStateChangedEventArgs: ...

class GeovisitTriggerDetails(_winrt.Object, interfaces=[]):
    @staticmethod
...
class PositionChangedEventArgs(_winrt.Object, interfaces=[]):
    position: typing.Optional[Geoposition]
    @staticmethod
    def _from(obj: _winrt.Object) -> PositionChangedEventArgs: ...

class StatusChangedEventArgs(_winrt.Object, interfaces=[]):
    status: PositionStatus
    @staticmethod
    def _from(obj: _winrt.Object) -> StatusChangedEventArgs: ...

class VenueData(_winrt.Object, interfaces=[]):
    id: str
    level: str
    @staticmethod
    def _from(obj: _winrt.Object) -> VenueData: ...

class IGeoshape(typing.Protocol):
    altitude_reference_system: AltitudeReferenceSystem
    geoshape_type: GeoshapeType
    spatial_reference_id: _winrt.UInt32
    @staticmethod
