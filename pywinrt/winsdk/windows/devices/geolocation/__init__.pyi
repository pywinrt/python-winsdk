...
class Geolocator(_winrt.Object):
    ...
    @typing.overload
    def get_geoposition_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Geoposition]]: ...
    @typing.overload
    def get_geoposition_async(self, maximum_age: winsdk.windows.foundation.TimeSpan, timeout: winsdk.windows.foundation.TimeSpan) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Geoposition]]: ...
    @typing.overload
    @staticmethod
    def get_geoposition_history_async(start_time: winsdk.windows.foundation.DateTime) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[Geoposition]]]: ...
    @typing.overload
    @staticmethod
    def get_geoposition_history_async(start_time: winsdk.windows.foundation.DateTime, duration: winsdk.windows.foundation.TimeSpan) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[Geoposition]]]: ...
    @staticmethod
    def request_access_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GeolocationAccessStatus]]: ...
...
class GeovisitMonitor(_winrt.Object):
    ...
    def __init__(self) -> None: ...
    @staticmethod
    def get_last_report_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[Geovisit]]: ...
