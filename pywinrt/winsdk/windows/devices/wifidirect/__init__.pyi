...
class WiFiDirectDevice(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WiFiDirectDevice]]: ...
    @typing.overload
    @staticmethod
    def from_id_async(device_id: str, connection_parameters: typing.Optional[WiFiDirectConnectionParameters]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WiFiDirectDevice]]: ...
