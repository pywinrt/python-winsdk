...
class WiFiDirectService(_winrt.Object):
    ...
    @staticmethod
    def _from(obj: _winrt.Object) -> WiFiDirectService: ...
    @typing.overload
    def connect_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WiFiDirectServiceSession]]: ...
    @typing.overload
    def connect_async(self, pin: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WiFiDirectServiceSession]]: ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WiFiDirectService]]: ...
    def get_provisioning_info_async(self, selected_configuration_method: WiFiDirectServiceConfigurationMethod) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WiFiDirectServiceProvisioningInfo]]: ...
    @typing.overload
    @staticmethod
...
class WiFiDirectServiceAdvertiser(_winrt.Object):
    ...
    @staticmethod
    def _from(obj: _winrt.Object) -> WiFiDirectServiceAdvertiser: ...
    def __init__(self, service_name: str) -> None: ...
    @typing.overload
    def connect_async(self, device_info: typing.Optional[winsdk.windows.devices.enumeration.DeviceInformation]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WiFiDirectServiceSession]]: ...
    @typing.overload
    def connect_async(self, device_info: typing.Optional[winsdk.windows.devices.enumeration.DeviceInformation], pin: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WiFiDirectServiceSession]]: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
    def add_advertisement_status_changed(self, handler: winsdk.windows.foundation.TypedEventHandler[WiFiDirectServiceAdvertiser, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken: ...
...
class WiFiDirectServiceAutoAcceptSessionConnectedEventArgs(_winrt.Object):
    ...
    session_info: typing.Optional[winsdk.windows.storage.streams.IBuffer]
    @staticmethod
    def _from(obj: _winrt.Object) -> WiFiDirectServiceAutoAcceptSessionConnectedEventArgs: ...
...
class WiFiDirectServiceProvisioningInfo(_winrt.Object):
    ...
    @staticmethod
    def _from(obj: _winrt.Object) -> WiFiDirectServiceProvisioningInfo: ...
...
class WiFiDirectServiceRemotePortAddedEventArgs(_winrt.Object):
    ...
    @staticmethod
    def _from(obj: _winrt.Object) -> WiFiDirectServiceRemotePortAddedEventArgs: ...
...
class WiFiDirectServiceSession(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    @staticmethod
    def _from(obj: _winrt.Object) -> WiFiDirectServiceSession: ...
    def add_datagram_socket_async(self, value: typing.Optional[winsdk.windows.networking.sockets.DatagramSocket]) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    def add_stream_socket_listener_async(self, value: typing.Optional[winsdk.windows.networking.sockets.StreamSocketListener]) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    def close(self) -> None: ...
    ...
    def add_session_status_changed(self, handler: winsdk.windows.foundation.TypedEventHandler[WiFiDirectServiceSession, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken: ...
...
class WiFiDirectServiceSessionDeferredEventArgs(_winrt.Object):
    deferred_session_info: typing.Optional[winsdk.windows.storage.streams.IBuffer]
    @staticmethod
    def _from(obj: _winrt.Object) -> WiFiDirectServiceSessionDeferredEventArgs: ...
...
class WiFiDirectServiceSessionRequest(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    session_info: typing.Optional[winsdk.windows.storage.streams.IBuffer]
    @staticmethod
    def _from(obj: _winrt.Object) -> WiFiDirectServiceSessionRequest: ...
    def close(self) -> None: ...

class WiFiDirectServiceSessionRequestedEventArgs(_winrt.Object):
    @staticmethod
    def _from(obj: _winrt.Object) -> WiFiDirectServiceSessionRequestedEventArgs: ...
