...
class WiFiDirectService(_winrt.Object, interfaces=[]):
...
class WiFiDirectServiceAdvertiser(_winrt.Object, interfaces=[]):
...
class WiFiDirectServiceAutoAcceptSessionConnectedEventArgs(_winrt.Object, interfaces=[]):
...
class WiFiDirectServiceProvisioningInfo(_winrt.Object, interfaces=[]):
...
class WiFiDirectServiceRemotePortAddedEventArgs(_winrt.Object, interfaces=[]):
...
class WiFiDirectServiceSession(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class WiFiDirectServiceSessionDeferredEventArgs(_winrt.Object, interfaces=[]):
    deferred_session_info: typing.Optional[winsdk.windows.storage.streams.IBuffer]
    @staticmethod
    def _from(obj: _winrt.Object) -> WiFiDirectServiceSessionDeferredEventArgs: ...

class WiFiDirectServiceSessionRequest(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class WiFiDirectServiceSessionRequestedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
