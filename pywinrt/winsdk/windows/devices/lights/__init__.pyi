...
class Lamp(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class LampArray(_winrt.Object, interfaces=[]):
    is_enabled: _winrt.Boolean
...
class LampAvailabilityChangedEventArgs(_winrt.Object, interfaces=[]):
    is_available: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> LampAvailabilityChangedEventArgs: ...

class LampInfo(_winrt.Object, interfaces=[]):
