...
class LampArrayBitmapEffect(_winrt.Object):
    ...
    def __new__(cls: typing.Type[LampArrayBitmapEffect], lamp_array: typing.Optional[winsdk.windows.devices.lights.LampArray], lamp_indexes: typing.Sequence[_winrt.Int32]) -> LampArrayBitmapEffect:...
...
class LampArrayBlinkEffect(_winrt.Object):
    ...
    def __new__(cls: typing.Type[LampArrayBlinkEffect], lamp_array: typing.Optional[winsdk.windows.devices.lights.LampArray], lamp_indexes: typing.Sequence[_winrt.Int32]) -> LampArrayBlinkEffect:...
...
class LampArrayColorRampEffect(_winrt.Object):
    ...
    def __new__(cls: typing.Type[LampArrayColorRampEffect], lamp_array: typing.Optional[winsdk.windows.devices.lights.LampArray], lamp_indexes: typing.Sequence[_winrt.Int32]) -> LampArrayColorRampEffect:...
...
class LampArrayCustomEffect(_winrt.Object):
    ...
    def __new__(cls: typing.Type[LampArrayCustomEffect], lamp_array: typing.Optional[winsdk.windows.devices.lights.LampArray], lamp_indexes: typing.Sequence[_winrt.Int32]) -> LampArrayCustomEffect:...
...
class LampArraySolidEffect(_winrt.Object):
    ...
    def __new__(cls: typing.Type[LampArraySolidEffect], lamp_array: typing.Optional[winsdk.windows.devices.lights.LampArray], lamp_indexes: typing.Sequence[_winrt.Int32]) -> LampArraySolidEffect:...
