...
class SmartCardChallengeContext(_winrt.Object):
    ...
    @typing.overload
    def provision_async(self, response: typing.Optional[winsdk.windows.storage.streams.IBuffer], format_card: _winrt.Boolean, new_card_id: _winrt.Guid) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
...
class SmartCardProvisioning(_winrt.Object):
    ...
    def get_id_async(self) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Guid]: ...
    ...
    @typing.overload
    @staticmethod
    def request_attested_virtual_smart_card_creation_async(friendly_name: str, administrative_key: typing.Optional[winsdk.windows.storage.streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy], card_id: _winrt.Guid) -> winsdk.windows.foundation.IAsyncOperation[SmartCardProvisioning]: ...
    ...
    @typing.overload
    @staticmethod
    def request_virtual_smart_card_creation_async(friendly_name: str, administrative_key: typing.Optional[winsdk.windows.storage.streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy], card_id: _winrt.Guid) -> winsdk.windows.foundation.IAsyncOperation[SmartCardProvisioning]: ...
    @staticmethod
