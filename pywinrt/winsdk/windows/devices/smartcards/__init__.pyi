...
class SmartCard(_winrt.Object):
    ...
    def connect_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardConnection]]: ...
    def get_answer_to_reset_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IBuffer]]: ...
    def get_status_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardStatus]]: ...
...
class SmartCardAppletIdGroupRegistration(_winrt.Object):
    ...
    def request_activation_policy_change_async(self, policy: SmartCardAppletIdGroupActivationPolicy) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardActivationPolicyChangeResult]]: ...
    def set_automatic_response_apdus_async(self, apdus: typing.Iterable[typing.Optional[SmartCardAutomaticResponseApdu]]) -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
...
class SmartCardChallengeContext(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def verify_response_async(self, response: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class SmartCardConnection(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def transmit_async(self, command: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IBuffer]]: ...
...
class SmartCardCryptogramGenerator(_winrt.Object):
    ...
    def create_cryptogram_material_storage_key_async(self, prompting_behavior: SmartCardUnlockPromptingBehavior, storage_key_name: str, algorithm: SmartCardCryptogramStorageKeyAlgorithm, capabilities: SmartCardCryptogramStorageKeyCapabilities) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]]: ...
    def delete_cryptogram_material_package_async(self, material_package_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]]: ...
    def delete_cryptogram_material_storage_key_async(self, storage_key_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]]: ...
    def get_all_cryptogram_material_characteristics_async(self, prompting_behavior: SmartCardUnlockPromptingBehavior, material_package_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult]]: ...
    @typing.overload
    def get_all_cryptogram_material_package_characteristics_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult]]: ...
    @typing.overload
    def get_all_cryptogram_material_package_characteristics_async(self, storage_key_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult]]: ...
    def get_all_cryptogram_storage_key_characteristics_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult]]: ...
    @staticmethod
    def get_smart_card_cryptogram_generator_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGenerator]]: ...
    def import_cryptogram_material_package_async(self, format: SmartCardCryptogramMaterialPackageFormat, storage_key_name: str, material_package_name: str, cryptogram_material_package: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]]: ...
    @staticmethod
    def is_supported() -> _winrt.Boolean: ...
    def request_cryptogram_material_storage_key_info_async(self, prompting_behavior: SmartCardUnlockPromptingBehavior, storage_key_name: str, format: winsdk.windows.security.cryptography.core.CryptographicPublicKeyBlobType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramStorageKeyInfo]]: ...
    def request_unlock_cryptogram_material_for_use_async(self, prompting_behavior: SmartCardUnlockPromptingBehavior) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]]: ...
    def try_prove_possession_of_cryptogram_material_package_async(self, prompting_behavior: SmartCardUnlockPromptingBehavior, response_format: SmartCardCryptogramMaterialPackageConfirmationResponseFormat, material_package_name: str, material_name: str, challenge: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramMaterialPossessionProof]]: ...
    def validate_request_apdu_async(self, prompting_behavior: SmartCardUnlockPromptingBehavior, apdu_to_validate: typing.Optional[winsdk.windows.storage.streams.IBuffer], cryptogram_placement_steps: typing.Iterable[typing.Optional[SmartCardCryptogramPlacementStep]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]]: ...
...
class SmartCardEmulator(_winrt.Object):
    ...
    @staticmethod
    def get_applet_id_group_registrations_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[SmartCardAppletIdGroupRegistration]]]: ...
    @staticmethod
    def get_default_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardEmulator]]: ...
    def is_host_card_emulation_supported(self) -> _winrt.Boolean: ...
    @staticmethod
    def is_supported() -> _winrt.Boolean: ...
    @staticmethod
    def register_applet_id_group_async(applet_id_group: typing.Optional[SmartCardAppletIdGroup]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardAppletIdGroupRegistration]]: ...
    def start(self) -> None: ...
    @staticmethod
...
class SmartCardEmulatorApduReceivedEventArgs(_winrt.Object):
    ...
    @typing.overload
    def try_respond_async(self, response_apdu: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_respond_async(self, response_apdu: typing.Optional[winsdk.windows.storage.streams.IBuffer], next_state: typing.Optional[_winrt.UInt32]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_respond_with_cryptograms_async(self, response_template: typing.Optional[winsdk.windows.storage.streams.IBuffer], cryptogram_placement_steps: typing.Iterable[typing.Optional[SmartCardCryptogramPlacementStep]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]]: ...
    @typing.overload
    def try_respond_with_cryptograms_async(self, response_template: typing.Optional[winsdk.windows.storage.streams.IBuffer], cryptogram_placement_steps: typing.Iterable[typing.Optional[SmartCardCryptogramPlacementStep]], next_state: typing.Optional[_winrt.UInt32]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]]: ...
...
class SmartCardProvisioning(_winrt.Object):
    ...
    @staticmethod
    def from_smart_card_async(card: typing.Optional[SmartCard]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardProvisioning]]: ...
    def get_authority_key_container_name_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    def get_challenge_context_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardChallengeContext]]: ...
    def get_id_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[uuid.UUID]]: ...
    def get_name_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[str]]: ...
    @typing.overload
    @staticmethod
    def request_attested_virtual_smart_card_creation_async(friendly_name: str, administrative_key: typing.Optional[winsdk.windows.storage.streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardProvisioning]]: ...
    @typing.overload
    @staticmethod
    def request_attested_virtual_smart_card_creation_async(friendly_name: str, administrative_key: typing.Optional[winsdk.windows.storage.streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy], card_id: uuid.UUID) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardProvisioning]]: ...
    def request_pin_change_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    def request_pin_reset_async(self, handler: typing.Optional[SmartCardPinResetHandler]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    @staticmethod
    def request_virtual_smart_card_creation_async(friendly_name: str, administrative_key: typing.Optional[winsdk.windows.storage.streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardProvisioning]]: ...
    @typing.overload
    @staticmethod
    def request_virtual_smart_card_creation_async(friendly_name: str, administrative_key: typing.Optional[winsdk.windows.storage.streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy], card_id: uuid.UUID) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardProvisioning]]: ...
    @staticmethod
    def request_virtual_smart_card_deletion_async(card: typing.Optional[SmartCard]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
...
class SmartCardReader(_winrt.Object):
    ...
    def find_all_cards_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[SmartCard]]]: ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardReader]]: ...
    @typing.overload
    @staticmethod
    ...
    def get_status_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmartCardReaderStatus]]: ...
...
class SmartCardTriggerDetails(_winrt.Object):
    ...
    @typing.overload
    def try_launch_current_app_async(self, arguments: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
    @typing.overload
    def try_launch_current_app_async(self, arguments: str, behavior: SmartCardLaunchBehavior) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
