...
class BluetoothLEAdvertisementPublisherTriggerDetails(_winrt.Object, interfaces=[]):
...
class BluetoothLEAdvertisementWatcherTriggerDetails(_winrt.Object, interfaces=[]):
...
class GattCharacteristicNotificationTriggerDetails(_winrt.Object, interfaces=[]):
...
class GattServiceProviderConnection(_winrt.Object, interfaces=[]):
...
class GattServiceProviderTriggerDetails(_winrt.Object, interfaces=[]):
    connection: typing.Optional[GattServiceProviderConnection]
    @staticmethod
    def _from(obj: _winrt.Object) -> GattServiceProviderTriggerDetails: ...

class RfcommConnectionTriggerDetails(_winrt.Object, interfaces=[]):
...
class RfcommInboundConnectionInformation(_winrt.Object, interfaces=[]):
...
class RfcommOutboundConnectionInformation(_winrt.Object, interfaces=[]):
