...
class RfcommDeviceService(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[RfcommDeviceService]]: ...
    @staticmethod
    ...
    @typing.overload
    def get_sdp_raw_attributes_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IMapView[_winrt.UInt32, winsdk.windows.storage.streams.IBuffer]]]: ...
    @typing.overload
    def get_sdp_raw_attributes_async(self, cache_mode: winsdk.windows.devices.bluetooth.BluetoothCacheMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IMapView[_winrt.UInt32, winsdk.windows.storage.streams.IBuffer]]]: ...
...
class RfcommServiceProvider(_winrt.Object):
    ...
    @staticmethod
    def create_async(service_id: typing.Optional[RfcommServiceId]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[RfcommServiceProvider]]: ...
    @typing.overload
