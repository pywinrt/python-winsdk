...
class BluetoothLEAdvertisement(_winrt.Object):
    ...
    service_uuids: typing.Optional[winsdk.windows.foundation.collections.IVector[_winrt.Guid]]
    @staticmethod
...
class BluetoothLEAdvertisementBytePattern(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEAdvertisementBytePattern], data_type: _winrt.UInt8, offset: _winrt.Int16, data: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> BluetoothLEAdvertisementBytePattern:...
...
class BluetoothLEAdvertisementDataSection(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEAdvertisementDataSection], data_type: _winrt.UInt8, data: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> BluetoothLEAdvertisementDataSection:...
...
class BluetoothLEManufacturerData(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEManufacturerData], company_id: _winrt.UInt16, data: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> BluetoothLEManufacturerData:...
