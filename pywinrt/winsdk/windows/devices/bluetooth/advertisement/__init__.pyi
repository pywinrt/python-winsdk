...
class BluetoothLEAdvertisement(_winrt.Object):
    ...
    data_sections: winsdk.windows.foundation.collections.IVector[BluetoothLEAdvertisementDataSection]
    manufacturer_data: winsdk.windows.foundation.collections.IVector[BluetoothLEManufacturerData]
    service_uuids: winsdk.windows.foundation.collections.IVector[uuid.UUID]
    def __init__(self, ) -> None:
        ...
    def get_manufacturer_data_by_company_id(company_id: _winrt.UInt16) -> winsdk.windows.foundation.collections.IVectorView[BluetoothLEManufacturerData]:
        ...
    def get_sections_by_type(type: _winrt.UInt8) -> winsdk.windows.foundation.collections.IVectorView[BluetoothLEAdvertisementDataSection]:
        ...
...
class BluetoothLEAdvertisementBytePattern(_winrt.Object):
    ...
    def __init__(self, ) -> None:
        ...
    def __init__(self, data_type: _winrt.UInt8, offset: _winrt.Int16, data: winsdk.windows.storage.streams.IBuffer) -> None:
        ...
...
class BluetoothLEAdvertisementDataSection(_winrt.Object):
    ...
    def __init__(self, ) -> None:
        ...
    def __init__(self, data_type: _winrt.UInt8, data: winsdk.windows.storage.streams.IBuffer) -> None:
        ...
...
class BluetoothLEAdvertisementFilter(_winrt.Object):
    ...
    byte_patterns: winsdk.windows.foundation.collections.IVector[BluetoothLEAdvertisementBytePattern]
    def __init__(self, ) -> None:
        ...
...
class BluetoothLEAdvertisementPublisher(_winrt.Object):
    ...
    def __init__(self, ) -> None:
        ...
    def __init__(self, advertisement: BluetoothLEAdvertisement) -> None:
        ...
    def start() -> None:
        ...
    def stop() -> None:
        ...
    def add_status_changed(handler: winsdk.windows.foundation.TypedEventHandler[BluetoothLEAdvertisementPublisher, BluetoothLEAdvertisementPublisherStatusChangedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
...
class BluetoothLEAdvertisementReceivedEventArgs(_winrt.Object):
    ...
    transmit_power_level_in_d_bm: typing.Optional[_winrt.Int16]
...
class BluetoothLEAdvertisementWatcher(_winrt.Object):
    ...
    def __init__(self, ) -> None:
        ...
    def __init__(self, advertisement_filter: BluetoothLEAdvertisementFilter) -> None:
        ...
    def start() -> None:
        ...
    def stop() -> None:
        ...
    def add_received(handler: winsdk.windows.foundation.TypedEventHandler[BluetoothLEAdvertisementWatcher, BluetoothLEAdvertisementReceivedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_received(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_stopped(handler: winsdk.windows.foundation.TypedEventHandler[BluetoothLEAdvertisementWatcher, BluetoothLEAdvertisementWatcherStoppedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
...
class BluetoothLEManufacturerData(_winrt.Object):
    ...
    def __init__(self, ) -> None:
        ...
    def __init__(self, company_id: _winrt.UInt16, data: winsdk.windows.storage.streams.IBuffer) -> None:
        ...
