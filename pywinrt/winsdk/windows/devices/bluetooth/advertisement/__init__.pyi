...
class BluetoothLEAdvertisement(_winrt.Object, interfaces=[]):
    local_name: str
...
class BluetoothLEAdvertisementBytePattern(_winrt.Object, interfaces=[]):
    offset: _winrt.Int16
...
class BluetoothLEAdvertisementDataSection(_winrt.Object, interfaces=[]):
    data_type: _winrt.UInt8
    data: typing.Optional[winsdk.windows.storage.streams.IBuffer]
    @staticmethod
...
class BluetoothLEAdvertisementFilter(_winrt.Object, interfaces=[]):
...
class BluetoothLEAdvertisementPublisher(_winrt.Object, interfaces=[]):
    advertisement: typing.Optional[BluetoothLEAdvertisement]
...
class BluetoothLEAdvertisementPublisherStatusChangedEventArgs(_winrt.Object, interfaces=[]):
...
class BluetoothLEAdvertisementReceivedEventArgs(_winrt.Object, interfaces=[]):
    advertisement: typing.Optional[BluetoothLEAdvertisement]
...
class BluetoothLEAdvertisementWatcher(_winrt.Object, interfaces=[]):
...
class BluetoothLEAdvertisementWatcherStoppedEventArgs(_winrt.Object, interfaces=[]):
    error: winsdk.windows.devices.bluetooth.BluetoothError
    @staticmethod
    def _from(obj: _winrt.Object) -> BluetoothLEAdvertisementWatcherStoppedEventArgs: ...

class BluetoothLEManufacturerData(_winrt.Object, interfaces=[]):
    data: typing.Optional[winsdk.windows.storage.streams.IBuffer]
