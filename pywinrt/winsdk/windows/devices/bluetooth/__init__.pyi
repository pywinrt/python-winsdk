...
class BluetoothAdapter(_winrt.Object):
    ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BluetoothAdapter]]: ...
    @staticmethod
    def get_default_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BluetoothAdapter]]: ...
    @staticmethod
    def get_device_selector() -> str: ...
    def get_radio_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.radios.Radio]]: ...
...
class BluetoothDevice(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    @staticmethod
    def from_bluetooth_address_async(address: _winrt.UInt64) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BluetoothDevice]]: ...
    @staticmethod
    def from_host_name_async(host_name: typing.Optional[winsdk.windows.networking.HostName]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BluetoothDevice]]: ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BluetoothDevice]]: ...
    @staticmethod
    def get_device_selector() -> str: ...
    @staticmethod
    ...
    @typing.overload
    def get_rfcomm_services_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.rfcomm.RfcommDeviceServicesResult]]: ...
    @typing.overload
    def get_rfcomm_services_async(self, cache_mode: BluetoothCacheMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.rfcomm.RfcommDeviceServicesResult]]: ...
    @typing.overload
    def get_rfcomm_services_for_id_async(self, service_id: typing.Optional[winsdk.windows.devices.bluetooth.rfcomm.RfcommServiceId]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.rfcomm.RfcommDeviceServicesResult]]: ...
    @typing.overload
    def get_rfcomm_services_for_id_async(self, service_id: typing.Optional[winsdk.windows.devices.bluetooth.rfcomm.RfcommServiceId], cache_mode: BluetoothCacheMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.rfcomm.RfcommDeviceServicesResult]]: ...
...
class BluetoothLEDevice(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def from_bluetooth_address_async(bluetooth_address: _winrt.UInt64) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BluetoothLEDevice]]: ...
    @typing.overload
    @staticmethod
    def from_bluetooth_address_async(bluetooth_address: _winrt.UInt64, bluetooth_address_type: BluetoothAddressType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BluetoothLEDevice]]: ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[BluetoothLEDevice]]: ...
    ...
    @typing.overload
    def get_gatt_services_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.genericattributeprofile.GattDeviceServicesResult]]: ...
    @typing.overload
    def get_gatt_services_async(self, cache_mode: BluetoothCacheMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.genericattributeprofile.GattDeviceServicesResult]]: ...
    @typing.overload
    def get_gatt_services_for_uuid_async(self, service_uuid: uuid.UUID) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.genericattributeprofile.GattDeviceServicesResult]]: ...
    @typing.overload
    def get_gatt_services_for_uuid_async(self, service_uuid: uuid.UUID, cache_mode: BluetoothCacheMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.genericattributeprofile.GattDeviceServicesResult]]: ...
    def request_access_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.enumeration.DeviceAccessStatus]]: ...
