...
class BluetoothAdapter(_winrt.Object):
    ...
    def get_device_selector() -> str:
        ...
    def get_radio_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.radios.Radio]:
        ...
...
class BluetoothDevice(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def get_device_selector_from_pairing_state(pairing_state: _winrt.Boolean) -> str:
        ...
    def get_rfcomm_services_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.rfcomm.RfcommDeviceServicesResult]:
        ...
    def get_rfcomm_services_async(cache_mode: BluetoothCacheMode) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.rfcomm.RfcommDeviceServicesResult]:
        ...
    def get_rfcomm_services_for_id_async(service_id: winsdk.windows.devices.bluetooth.rfcomm.RfcommServiceId) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.rfcomm.RfcommDeviceServicesResult]:
        ...
    def get_rfcomm_services_for_id_async(service_id: winsdk.windows.devices.bluetooth.rfcomm.RfcommServiceId, cache_mode: BluetoothCacheMode) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.rfcomm.RfcommDeviceServicesResult]:
        ...
    def request_access_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.enumeration.DeviceAccessStatus]:
        ...
    def add_connection_status_changed(handler: winsdk.windows.foundation.TypedEventHandler[BluetoothDevice, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_connection_status_changed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_name_changed(handler: winsdk.windows.foundation.TypedEventHandler[BluetoothDevice, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_name_changed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_sdp_records_changed(handler: winsdk.windows.foundation.TypedEventHandler[BluetoothDevice, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_sdp_records_changed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
...
class BluetoothLEDevice(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def get_device_selector_from_pairing_state(pairing_state: _winrt.Boolean) -> str:
        ...
    def get_gatt_service(service_uuid: uuid.UUID) -> winsdk.windows.devices.bluetooth.genericattributeprofile.GattDeviceService:
        ...
    def get_gatt_services_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.genericattributeprofile.GattDeviceServicesResult]:
        ...
    def get_gatt_services_async(cache_mode: BluetoothCacheMode) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.genericattributeprofile.GattDeviceServicesResult]:
        ...
    def get_gatt_services_for_uuid_async(service_uuid: uuid.UUID) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.genericattributeprofile.GattDeviceServicesResult]:
        ...
    def get_gatt_services_for_uuid_async(service_uuid: uuid.UUID, cache_mode: BluetoothCacheMode) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.genericattributeprofile.GattDeviceServicesResult]:
        ...
    def request_access_async() -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.enumeration.DeviceAccessStatus]:
        ...
    def request_preferred_connection_parameters(preferred_connection_parameters: BluetoothLEPreferredConnectionParameters) -> BluetoothLEPreferredConnectionParametersRequest:
        ...
    def add_connection_status_changed(handler: winsdk.windows.foundation.TypedEventHandler[BluetoothLEDevice, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_connection_status_changed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_gatt_services_changed(handler: winsdk.windows.foundation.TypedEventHandler[BluetoothLEDevice, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_gatt_services_changed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_name_changed(handler: winsdk.windows.foundation.TypedEventHandler[BluetoothLEDevice, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_name_changed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_connection_parameters_changed(handler: winsdk.windows.foundation.TypedEventHandler[BluetoothLEDevice, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_connection_parameters_changed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_connection_phy_changed(handler: winsdk.windows.foundation.TypedEventHandler[BluetoothLEDevice, _winrt.Object]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_connection_phy_changed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
