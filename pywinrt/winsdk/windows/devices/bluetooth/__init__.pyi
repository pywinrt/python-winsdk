...
class BluetoothLEDevice(_winrt.Object):
    ...
    @staticmethod
    def get_device_selector_from_pairing_state(pairing_state: _winrt.Boolean) -> str: ...
    def get_gatt_service(self, service_uuid: _winrt.Guid) -> typing.Optional[winsdk.windows.devices.bluetooth.genericattributeprofile.GattDeviceService]: ...
    @typing.overload
    ...
    @typing.overload
    def get_gatt_services_for_uuid_async(self, service_uuid: _winrt.Guid) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.genericattributeprofile.GattDeviceServicesResult]: ...
    @typing.overload
    def get_gatt_services_for_uuid_async(self, service_uuid: _winrt.Guid, cache_mode: BluetoothCacheMode) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.bluetooth.genericattributeprofile.GattDeviceServicesResult]: ...
    def request_access_async(self) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.enumeration.DeviceAccessStatus]: ...
