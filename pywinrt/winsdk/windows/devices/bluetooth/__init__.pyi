...
class BluetoothAdapter(_winrt.Object, interfaces=[]):
...
class BluetoothClassOfDevice(_winrt.Object, interfaces=[]):
...
class BluetoothDevice(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
    bluetooth_address: _winrt.UInt64
...
class BluetoothDeviceId(_winrt.Object, interfaces=[]):
    id: str
...
class BluetoothLEAppearance(_winrt.Object, interfaces=[]):
...
class BluetoothLEConnectionParameters(_winrt.Object, interfaces=[]):
...
class BluetoothLEConnectionPhy(_winrt.Object, interfaces=[]):
...
class BluetoothLEConnectionPhyInfo(_winrt.Object, interfaces=[]):
...
class BluetoothLEDevice(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
    bluetooth_address: _winrt.UInt64
    connection_status: BluetoothConnectionStatus
    device_id: str
...
class BluetoothLEPreferredConnectionParameters(_winrt.Object, interfaces=[]):
    connection_latency: _winrt.UInt16
    link_timeout: _winrt.UInt16
...
class BluetoothLEPreferredConnectionParametersRequest(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class BluetoothSignalStrengthFilter(_winrt.Object, interfaces=[]):
