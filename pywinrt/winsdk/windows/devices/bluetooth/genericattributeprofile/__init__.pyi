...
class GattCharacteristic(_winrt.Object):
    ...
    @typing.overload
    def get_descriptors_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattDescriptorsResult]]: ...
    @typing.overload
    def get_descriptors_async(self, cache_mode: winsdk.windows.devices.bluetooth.BluetoothCacheMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattDescriptorsResult]]: ...
    @typing.overload
    def get_descriptors_for_uuid_async(self, descriptor_uuid: uuid.UUID) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattDescriptorsResult]]: ...
    @typing.overload
    def get_descriptors_for_uuid_async(self, descriptor_uuid: uuid.UUID, cache_mode: winsdk.windows.devices.bluetooth.BluetoothCacheMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattDescriptorsResult]]: ...
    def read_client_characteristic_configuration_descriptor_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattReadClientCharacteristicConfigurationDescriptorResult]]: ...
    @typing.overload
    def read_value_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattReadResult]]: ...
    @typing.overload
    def read_value_async(self, cache_mode: winsdk.windows.devices.bluetooth.BluetoothCacheMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattReadResult]]: ...
    def write_client_characteristic_configuration_descriptor_async(self, client_characteristic_configuration_descriptor_value: GattClientCharacteristicConfigurationDescriptorValue) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattCommunicationStatus]]: ...
    def write_client_characteristic_configuration_descriptor_with_result_async(self, client_characteristic_configuration_descriptor_value: GattClientCharacteristicConfigurationDescriptorValue) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattWriteResult]]: ...
    @typing.overload
    def write_value_async(self, value: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattCommunicationStatus]]: ...
    @typing.overload
    def write_value_async(self, value: typing.Optional[winsdk.windows.storage.streams.IBuffer], write_option: GattWriteOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattCommunicationStatus]]: ...
    @typing.overload
    def write_value_with_result_async(self, value: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattWriteResult]]: ...
    @typing.overload
    def write_value_with_result_async(self, value: typing.Optional[winsdk.windows.storage.streams.IBuffer], write_option: GattWriteOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattWriteResult]]: ...
...
class GattDeviceService(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattDeviceService]]: ...
    @typing.overload
    @staticmethod
    def from_id_async(device_id: str, sharing_mode: GattSharingMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattDeviceService]]: ...
    ...
    @typing.overload
    def get_characteristics_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattCharacteristicsResult]]: ...
    @typing.overload
    def get_characteristics_async(self, cache_mode: winsdk.windows.devices.bluetooth.BluetoothCacheMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattCharacteristicsResult]]: ...
    @typing.overload
    def get_characteristics_for_uuid_async(self, characteristic_uuid: uuid.UUID) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattCharacteristicsResult]]: ...
    @typing.overload
    def get_characteristics_for_uuid_async(self, characteristic_uuid: uuid.UUID, cache_mode: winsdk.windows.devices.bluetooth.BluetoothCacheMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattCharacteristicsResult]]: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    def get_included_services_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattDeviceServicesResult]]: ...
    @typing.overload
    def get_included_services_async(self, cache_mode: winsdk.windows.devices.bluetooth.BluetoothCacheMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattDeviceServicesResult]]: ...
    @typing.overload
    def get_included_services_for_uuid_async(self, service_uuid: uuid.UUID) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattDeviceServicesResult]]: ...
    @typing.overload
    def get_included_services_for_uuid_async(self, service_uuid: uuid.UUID, cache_mode: winsdk.windows.devices.bluetooth.BluetoothCacheMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattDeviceServicesResult]]: ...
    def open_async(self, sharing_mode: GattSharingMode) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattOpenStatus]]: ...
    def request_access_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.devices.enumeration.DeviceAccessStatus]]: ...
...
class GattLocalCharacteristic(_winrt.Object):
    ...
    def create_descriptor_async(self, descriptor_uuid: uuid.UUID, parameters: typing.Optional[GattLocalDescriptorParameters]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattLocalDescriptorResult]]: ...
    @typing.overload
    def notify_value_async(self, value: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[GattClientNotificationResult]]]: ...
    @typing.overload
    def notify_value_async(self, value: typing.Optional[winsdk.windows.storage.streams.IBuffer], subscribed_client: typing.Optional[GattSubscribedClient]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattClientNotificationResult]]: ...
...
class GattLocalService(_winrt.Object):
    ...
    def create_characteristic_async(self, characteristic_uuid: uuid.UUID, parameters: typing.Optional[GattLocalCharacteristicParameters]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattLocalCharacteristicResult]]: ...
...
class GattReadRequestedEventArgs(_winrt.Object):
    ...
    def get_request_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattReadRequest]]: ...
...
class GattReliableWriteTransaction(_winrt.Object):
    ...
    def __init__(self) -> None: ...
    def commit_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattCommunicationStatus]]: ...
    def commit_with_result_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattWriteResult]]: ...
...
class GattServiceProvider(_winrt.Object):
    ...
    @staticmethod
    def create_async(service_uuid: uuid.UUID) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattServiceProviderResult]]: ...
    @typing.overload
...
class GattSession(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    @staticmethod
    def from_device_id_async(device_id: typing.Optional[winsdk.windows.devices.bluetooth.BluetoothDeviceId]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattSession]]: ...
...
class GattWriteRequestedEventArgs(_winrt.Object):
    ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...
    def get_request_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[GattWriteRequest]]: ...
