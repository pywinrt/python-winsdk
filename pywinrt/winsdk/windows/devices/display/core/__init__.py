...
_ns_module = winsdk.system._import_ns_module("Windows.Devices.Display.Core")
...
_ns_module._register_DisplayBitsPerChannel(DisplayBitsPerChannel)
_ns_module._register_DisplayDeviceCapability(DisplayDeviceCapability)
_ns_module._register_DisplayManagerOptions(DisplayManagerOptions)
_ns_module._register_DisplayManagerResult(DisplayManagerResult)
_ns_module._register_DisplayModeQueryOptions(DisplayModeQueryOptions)
_ns_module._register_DisplayPathScaling(DisplayPathScaling)
_ns_module._register_DisplayPathStatus(DisplayPathStatus)
_ns_module._register_DisplayPresentStatus(DisplayPresentStatus)
_ns_module._register_DisplayRotation(DisplayRotation)
_ns_module._register_DisplayScanoutOptions(DisplayScanoutOptions)
_ns_module._register_DisplaySourceStatus(DisplaySourceStatus)
_ns_module._register_DisplayStateApplyOptions(DisplayStateApplyOptions)
_ns_module._register_DisplayStateFunctionalizeOptions(DisplayStateFunctionalizeOptions)
_ns_module._register_DisplayStateOperationStatus(DisplayStateOperationStatus)
_ns_module._register_DisplayTargetPersistence(DisplayTargetPersistence)
_ns_module._register_DisplayTaskSignalKind(DisplayTaskSignalKind)
_ns_module._register_DisplayWireFormatColorSpace(DisplayWireFormatColorSpace)
_ns_module._register_DisplayWireFormatEotf(DisplayWireFormatEotf)
_ns_module._register_DisplayWireFormatHdrMetadata(DisplayWireFormatHdrMetadata)
_ns_module._register_DisplayWireFormatPixelEncoding(DisplayWireFormatPixelEncoding)
