...
class DisplayAdapter(_winrt.Object, interfaces=[]):
...
class DisplayDevice(_winrt.Object, interfaces=[]):
    @staticmethod
...
class DisplayFence(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> DisplayFence: ...

class DisplayManager(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
    @staticmethod
    ...
    def try_acquire_targets_and_create_empty_state(self, targets: typing.Iterable[typing.Optional[DisplayTarget]]) -> typing.Optional[DisplayManagerResultWithState]: ...
    def try_acquire_targets_and_create_substate(self, existing_state: typing.Optional[DisplayState], targets: typing.Iterable[typing.Optional[DisplayTarget]]) -> typing.Optional[DisplayManagerResultWithState]: ...
    def try_acquire_targets_and_read_current_state(self, targets: typing.Iterable[typing.Optional[DisplayTarget]]) -> typing.Optional[DisplayManagerResultWithState]: ...
...
class DisplayManagerChangedEventArgs(_winrt.Object, interfaces=[]):
    handled: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> DisplayManagerChangedEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class DisplayManagerDisabledEventArgs(_winrt.Object, interfaces=[]):
    handled: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> DisplayManagerDisabledEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class DisplayManagerEnabledEventArgs(_winrt.Object, interfaces=[]):
    handled: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> DisplayManagerEnabledEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class DisplayManagerPathsFailedOrInvalidatedEventArgs(_winrt.Object, interfaces=[]):
    handled: _winrt.Boolean
    @staticmethod
    def _from(obj: _winrt.Object) -> DisplayManagerPathsFailedOrInvalidatedEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class DisplayManagerResultWithState(_winrt.Object, interfaces=[]):
...
class DisplayModeInfo(_winrt.Object, interfaces=[]):
...
class DisplayPath(_winrt.Object, interfaces=[]):
...
class DisplayPrimaryDescription(_winrt.Object, interfaces=[]):
    ...
    @staticmethod
    def create_with_properties(extra_properties: typing.Iterable[typing.Optional[winsdk.windows.foundation.collections.IKeyValuePair[uuid.UUID, _winrt.Object]]], width: _winrt.UInt32, height: _winrt.UInt32, pixel_format: winsdk.windows.graphics.directx.DirectXPixelFormat, color_space: winsdk.windows.graphics.directx.DirectXColorSpace, is_stereo: _winrt.Boolean, multisample_description: winsdk.windows.graphics.directx.direct3d11.Direct3DMultisampleDescription) -> typing.Optional[DisplayPrimaryDescription]: ...

class DisplayScanout(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> DisplayScanout: ...

class DisplaySource(_winrt.Object, interfaces=[]):
...
class DisplayState(_winrt.Object, interfaces=[]):
...
class DisplayStateOperationResult(_winrt.Object, interfaces=[]):
    extended_error_code: winsdk.windows.foundation.HResult
    status: DisplayStateOperationStatus
    @staticmethod
    def _from(obj: _winrt.Object) -> DisplayStateOperationResult: ...

class DisplaySurface(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> DisplaySurface: ...

class DisplayTarget(_winrt.Object, interfaces=[]):
...
class DisplayTask(_winrt.Object, interfaces=[]):
    @staticmethod
...
class DisplayTaskPool(_winrt.Object, interfaces=[]):
    @staticmethod
...
class DisplayTaskResult(_winrt.Object, interfaces=[]):
...
class DisplayView(_winrt.Object, interfaces=[]):
...
class DisplayWireFormat(_winrt.Object, interfaces=[]):
    ...
    @staticmethod
    def create_with_properties(extra_properties: typing.Iterable[typing.Optional[winsdk.windows.foundation.collections.IKeyValuePair[uuid.UUID, _winrt.Object]]], pixel_encoding: DisplayWireFormatPixelEncoding, bits_per_channel: _winrt.Int32, color_space: DisplayWireFormatColorSpace, eotf: DisplayWireFormatEotf, hdr_metadata: DisplayWireFormatHdrMetadata) -> typing.Optional[DisplayWireFormat]: ...
