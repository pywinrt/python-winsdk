...
class SimpleHapticsController(_winrt.Object, interfaces=[]):
    id: str
...
class SimpleHapticsControllerFeedback(_winrt.Object, interfaces=[]):
...
class VibrationDevice(_winrt.Object, interfaces=[]):
    id: str
