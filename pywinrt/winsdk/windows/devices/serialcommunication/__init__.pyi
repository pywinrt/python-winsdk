...
class SerialDevice(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def get_device_selector_from_usb_vid_pid(vendor_id: _winrt.UInt16, product_id: _winrt.UInt16) -> str:
        ...
    def add_error_received(report_handler: winsdk.windows.foundation.TypedEventHandler[SerialDevice, ErrorReceivedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_error_received(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
    def add_pin_changed(report_handler: winsdk.windows.foundation.TypedEventHandler[SerialDevice, PinChangedEventArgs]) -> winsdk.windows.foundation.EventRegistrationToken:
        ...
    def remove_pin_changed(token: winsdk.windows.foundation.EventRegistrationToken) -> None:
        ...
