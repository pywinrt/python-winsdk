...
class ErrorReceivedEventArgs(_winrt.Object, interfaces=[]):
    error: SerialError
    @staticmethod
    def _from(obj: _winrt.Object) -> ErrorReceivedEventArgs: ...

class PinChangedEventArgs(_winrt.Object, interfaces=[]):
    pin_change: SerialPinChange
    @staticmethod
    def _from(obj: _winrt.Object) -> PinChangedEventArgs: ...

class SerialDevice(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
