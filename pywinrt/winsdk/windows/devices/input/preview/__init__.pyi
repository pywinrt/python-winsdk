...
class GazeDevicePreview(_winrt.Object, interfaces=[]):
...
class GazeDeviceWatcherAddedPreviewEventArgs(_winrt.Object, interfaces=[]):
    device: typing.Optional[GazeDevicePreview]
    @staticmethod
    def _from(obj: _winrt.Object) -> GazeDeviceWatcherAddedPreviewEventArgs: ...

class GazeDeviceWatcherPreview(_winrt.Object, interfaces=[]):
    @staticmethod
...
class GazeDeviceWatcherRemovedPreviewEventArgs(_winrt.Object, interfaces=[]):
    device: typing.Optional[GazeDevicePreview]
    @staticmethod
    def _from(obj: _winrt.Object) -> GazeDeviceWatcherRemovedPreviewEventArgs: ...

class GazeDeviceWatcherUpdatedPreviewEventArgs(_winrt.Object, interfaces=[]):
    device: typing.Optional[GazeDevicePreview]
    @staticmethod
    def _from(obj: _winrt.Object) -> GazeDeviceWatcherUpdatedPreviewEventArgs: ...

class GazeEnteredPreviewEventArgs(_winrt.Object, interfaces=[]):
...
class GazeExitedPreviewEventArgs(_winrt.Object, interfaces=[]):
    handled: _winrt.Boolean
    current_point: typing.Optional[GazePointPreview]
    @staticmethod
    def _from(obj: _winrt.Object) -> GazeExitedPreviewEventArgs: ...

class GazeInputSourcePreview(_winrt.Object, interfaces=[]):
    @staticmethod
...
class GazeMovedPreviewEventArgs(_winrt.Object, interfaces=[]):
    handled: _winrt.Boolean
    current_point: typing.Optional[GazePointPreview]
    @staticmethod
...
class GazePointPreview(_winrt.Object, interfaces=[]):
