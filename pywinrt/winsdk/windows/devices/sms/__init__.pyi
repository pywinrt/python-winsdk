...
class SmsEncodedLength:
    ...
    def __new__(cls: typing.Type[SmsEncodedLength], segment_count: _winrt.UInt32, character_count_last_segment: _winrt.UInt32, characters_per_segment: _winrt.UInt32, byte_count_last_segment: _winrt.UInt32, bytes_per_segment: _winrt.UInt32) -> SmsEncodedLength: ...
