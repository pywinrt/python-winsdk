...
class SmsDevice2(_winrt.Object):
    ...
    def send_message_and_get_result_async(self, message: typing.Optional[ISmsMessageBase]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SmsSendMessageResult]]: ...
