...
class SpiController(_winrt.Object):
    ...
    @staticmethod
    def get_controllers_async(provider: typing.Optional[winsdk.windows.devices.spi.provider.ISpiProvider]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[SpiController]]]: ...
    @staticmethod
    def get_default_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SpiController]]: ...
...
class SpiDevice(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    @staticmethod
    def from_id_async(bus_id: str, settings: typing.Optional[SpiConnectionSettings]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SpiDevice]]: ...
    @staticmethod
...
class ISpiDeviceStatics(_winrt.Object):
    ...
    def from_id_async(self, bus_id: str, settings: typing.Optional[SpiConnectionSettings]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[SpiDevice]]: ...
