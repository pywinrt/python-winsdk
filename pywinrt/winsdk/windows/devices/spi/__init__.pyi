...
class SpiBusInfo(_winrt.Object, interfaces=[]):
...
class SpiConnectionSettings(_winrt.Object, interfaces=[]):
...
class SpiController(_winrt.Object, interfaces=[]):
    @staticmethod
...
class SpiDevice(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
...
class ISpiDeviceStatics(typing.Protocol):
    @staticmethod
