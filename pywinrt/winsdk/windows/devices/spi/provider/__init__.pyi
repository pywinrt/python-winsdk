...
class ProviderSpiConnectionSettings(_winrt.Object, interfaces=[]):
...
class ISpiControllerProvider(typing.Protocol):
    @staticmethod
...
class ISpiDeviceProvider(typing.Protocol):
...
class ISpiProvider(typing.Protocol):
    @staticmethod
