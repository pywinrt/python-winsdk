...
class PnpObject(_winrt.Object, interfaces=[]):
    id: str
...
class PnpObjectCollection(_winrt.Object, interfaces=[winsdk.windows.foundation.collections.IVectorView[PnpObject], winsdk.windows.foundation.collections.IIterable[PnpObject]]):
    size: _winrt.UInt32
    @staticmethod
...
class PnpObjectUpdate(_winrt.Object, interfaces=[]):
    id: str
    properties: typing.Optional[winsdk.windows.foundation.collections.IMapView[str, _winrt.Object]]
    type: PnpObjectType
    @staticmethod
...
class PnpObjectWatcher(_winrt.Object, interfaces=[]):
