...
class PerceptionControlGroup(_winrt.Object, interfaces=[]):
...
class PerceptionCorrelation(_winrt.Object, interfaces=[]):
...
class PerceptionCorrelationGroup(_winrt.Object, interfaces=[]):
    ...
    def __init__(self, relative_locations: typing.Iterable[typing.Optional[PerceptionCorrelation]]) -> None: ...

class PerceptionFaceAuthenticationGroup(_winrt.Object, interfaces=[]):
    frame_provider_ids: typing.Optional[winsdk.windows.foundation.collections.IVectorView[str]]
    @staticmethod
...
class PerceptionFrame(_winrt.Object, interfaces=[]):
...
class PerceptionFrameProviderInfo(_winrt.Object, interfaces=[]):
    id: str
...
class PerceptionPropertyChangeRequest(_winrt.Object, interfaces=[]):
...
class PerceptionVideoFrameAllocator(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable]):
    @staticmethod
...
class IPerceptionFrameProvider(typing.Protocol):
...
class IPerceptionFrameProviderManager(typing.Protocol):
    @staticmethod
