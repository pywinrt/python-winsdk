...
class PerceptionColorFrameSource(_winrt.Object):
    ...
    @staticmethod
    def find_all_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[PerceptionColorFrameSource]]]: ...
    @staticmethod
    def from_id_async(id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PerceptionColorFrameSource]]: ...
    def is_correlated_with(self, target_id: str) -> _winrt.Boolean: ...
    def open_reader(self) -> typing.Optional[PerceptionColorFrameReader]: ...
    @staticmethod
    def request_access_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PerceptionFrameSourceAccessStatus]]: ...
    def try_get_depth_correlated_camera_intrinsics_async(self, correlated_depth_frame_source: typing.Optional[PerceptionDepthFrameSource]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PerceptionDepthCorrelatedCameraIntrinsics]]: ...
    def try_get_depth_correlated_coordinate_mapper_async(self, target_source_id: str, correlated_depth_frame_source: typing.Optional[PerceptionDepthFrameSource]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PerceptionDepthCorrelatedCoordinateMapper]]: ...
    def try_get_transform_to(self, target_id: str) -> typing.Tuple[_winrt.Boolean, winsdk.windows.foundation.numerics.Matrix4x4]: ...
    def try_set_video_profile_async(self, control_session: typing.Optional[PerceptionControlSession], profile: typing.Optional[PerceptionVideoProfile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PerceptionFrameSourcePropertyChangeResult]]: ...
...
class PerceptionControlSession(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def try_set_property_async(self, name: str, value: typing.Optional[_winrt.Object]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PerceptionFrameSourcePropertyChangeResult]]: ...
...
class PerceptionDepthFrameSource(_winrt.Object):
    ...
    @staticmethod
    def find_all_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[PerceptionDepthFrameSource]]]: ...
    @staticmethod
    def from_id_async(id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PerceptionDepthFrameSource]]: ...
    def is_correlated_with(self, target_id: str) -> _winrt.Boolean: ...
    def open_reader(self) -> typing.Optional[PerceptionDepthFrameReader]: ...
    @staticmethod
    def request_access_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PerceptionFrameSourceAccessStatus]]: ...
    def try_get_depth_correlated_camera_intrinsics_async(self, target: typing.Optional[PerceptionDepthFrameSource]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PerceptionDepthCorrelatedCameraIntrinsics]]: ...
    def try_get_depth_correlated_coordinate_mapper_async(self, target_id: str, depth_frame_source_to_map_with: typing.Optional[PerceptionDepthFrameSource]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PerceptionDepthCorrelatedCoordinateMapper]]: ...
    def try_get_transform_to(self, target_id: str) -> typing.Tuple[_winrt.Boolean, winsdk.windows.foundation.numerics.Matrix4x4]: ...
    def try_set_video_profile_async(self, control_session: typing.Optional[PerceptionControlSession], profile: typing.Optional[PerceptionVideoProfile]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PerceptionFrameSourcePropertyChangeResult]]: ...
...
class PerceptionInfraredFrameSource(_winrt.Object):
    ...
    @staticmethod
    def find_all_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[PerceptionInfraredFrameSource]]]: ...
    @staticmethod
    def from_id_async(id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PerceptionInfraredFrameSource]]: ...
    def is_correlated_with(self, target_id: str) -> _winrt.Boolean: ...
