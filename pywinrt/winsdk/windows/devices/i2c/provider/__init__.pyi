...
class ProviderI2cConnectionSettings(_winrt.Object, interfaces=[]):
...
class II2cControllerProvider(typing.Protocol):
    @staticmethod
...
class II2cDeviceProvider(typing.Protocol):
    device_id: str
    @staticmethod
...
class II2cProvider(typing.Protocol):
    @staticmethod
