...
class I2cController(_winrt.Object):
    ...
    @staticmethod
    def get_controllers_async(provider: typing.Optional[winsdk.windows.devices.i2c.provider.II2cProvider]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[I2cController]]]: ...
    @staticmethod
    def get_default_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[I2cController]]: ...
...
class I2cDevice(winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    @staticmethod
    def from_id_async(device_id: str, settings: typing.Optional[I2cConnectionSettings]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[I2cDevice]]: ...
    @typing.overload
    @staticmethod
...
class II2cDeviceStatics(_winrt.Object):
    ...
    def from_id_async(self, device_id: str, settings: typing.Optional[I2cConnectionSettings]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[I2cDevice]]: ...
    @typing.overload
