...
class PwmController(_winrt.Object):
    ...
    @staticmethod
    def from_id_async(device_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PwmController]]: ...
    @staticmethod
    def get_controllers_async(provider: typing.Optional[winsdk.windows.devices.pwm.provider.IPwmProvider]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.foundation.collections.IVectorView[PwmController]]]: ...
    @staticmethod
    def get_default_async() -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[PwmController]]: ...
    @typing.overload
    @staticmethod
