...
class Deferral(_winrt.Object, interfaces=[IClosable]):
    @staticmethod
...
class MemoryBuffer(_winrt.Object, interfaces=[IMemoryBuffer, IClosable]):
    @staticmethod
...
class Uri(_winrt.Object, interfaces=[IStringable]):
    absolute_uri: str
    display_uri: str
    domain: str
    extension: str
...
class WwwFormUrlDecoder(_winrt.Object, interfaces=[winsdk.windows.foundation.collections.IVectorView[IWwwFormUrlDecoderEntry], winsdk.windows.foundation.collections.IIterable[IWwwFormUrlDecoderEntry]]):
    size: _winrt.UInt32
    @staticmethod
...
class WwwFormUrlDecoderEntry(_winrt.Object, interfaces=[IWwwFormUrlDecoderEntry]):
    name: str
    value: str
    @staticmethod
    def _from(obj: _winrt.Object) -> WwwFormUrlDecoderEntry: ...

class IAsyncAction(typing.Protocol):
...
class IAsyncActionWithProgress(typing.Protocol[TProgress]):
...
class IAsyncInfo(typing.Protocol):
    error_code: HResult
    id: _winrt.UInt32
    status: AsyncStatus
    @staticmethod
...
class IAsyncOperationWithProgress(typing.Protocol[TResult, TProgress]):
...
class IAsyncOperation(typing.Protocol[TResult]):
...
class IClosable(typing.Protocol):
...
class IGetActivationFactory(typing.Protocol):
    @staticmethod
...
class IMemoryBuffer(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> IMemoryBuffer: ...
    def create_reference(self) -> typing.Optional[IMemoryBufferReference]: ...
    def close(self) -> None: ...

class IMemoryBufferReference(typing.Protocol):
...
class IPropertyValue(typing.Protocol):
...
class IReferenceArray(typing.Protocol[T]):
...
class IReference(typing.Protocol[T]):
    value: typing.Optional[T]
    is_numeric_scalar: _winrt.Boolean
    type: PropertyType
    if sys.version_info >= (3, 9):
...
class IWwwFormUrlDecoderEntry(typing.Protocol):
    name: str
    value: str
    @staticmethod
