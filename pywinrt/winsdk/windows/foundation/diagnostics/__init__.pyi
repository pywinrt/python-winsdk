...
class ErrorDetails(_winrt.Object):
    ...
    @staticmethod
    def create_from_h_result_async(error_code: _winrt.Int32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[ErrorDetails]]: ...
...
class FileLoggingSession(IFileLoggingSession, winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def close_and_save_to_file_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.StorageFile]]: ...
...
class LoggingSession(ILoggingSession, winsdk.windows.foundation.IClosable, _winrt.Object):
    ...
    def close(self) -> None: ...
    def remove_logging_channel(self, logging_channel: typing.Optional[ILoggingChannel]) -> None: ...
    def save_to_file_async(self, folder: typing.Optional[winsdk.windows.storage.IStorageFolder], file_name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.StorageFile]]: ...
