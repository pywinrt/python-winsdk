...
class ErrorDetails(_winrt.Object, interfaces=[]):
    description: str
...
class FileLoggingSession(_winrt.Object, interfaces=[IFileLoggingSession, winsdk.windows.foundation.IClosable]):
    name: str
    @staticmethod
...
class LogFileGeneratedEventArgs(_winrt.Object, interfaces=[]):
    file: typing.Optional[winsdk.windows.storage.StorageFile]
    @staticmethod
    def _from(obj: _winrt.Object) -> LogFileGeneratedEventArgs: ...

class LoggingActivity(_winrt.Object, interfaces=[winsdk.windows.foundation.IClosable, ILoggingTarget]):
    id: uuid.UUID
    name: str
...
class LoggingChannel(_winrt.Object, interfaces=[ILoggingChannel, winsdk.windows.foundation.IClosable, ILoggingTarget]):
...
class LoggingChannelOptions(_winrt.Object, interfaces=[]):
    group: uuid.UUID
    @staticmethod
...
class LoggingFields(_winrt.Object, interfaces=[]):
    @staticmethod
...
class LoggingOptions(_winrt.Object, interfaces=[]):
    task: _winrt.Int16
    tags: _winrt.Int32
...
class LoggingSession(_winrt.Object, interfaces=[ILoggingSession, winsdk.windows.foundation.IClosable]):
    name: str
    @staticmethod
...
class RuntimeBrokerErrorSettings(_winrt.Object, interfaces=[IErrorReportingSettings]):
    @staticmethod
...
class TracingStatusChangedEventArgs(_winrt.Object, interfaces=[]):
    enabled: _winrt.Boolean
    trace_level: CausalityTraceLevel
    @staticmethod
    def _from(obj: _winrt.Object) -> TracingStatusChangedEventArgs: ...

class IErrorReportingSettings(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> IErrorReportingSettings: ...
    def get_error_options(self) -> ErrorOptions: ...
    def set_error_options(self, value: ErrorOptions) -> None: ...

class IFileLoggingSession(typing.Protocol):
    name: str
    @staticmethod
...
class ILoggingChannel(typing.Protocol):
    enabled: _winrt.Boolean
    level: LoggingLevel
    name: str
    @staticmethod
...
class ILoggingSession(typing.Protocol):
    name: str
    @staticmethod
...
class ILoggingTarget(typing.Protocol):
    @staticmethod
