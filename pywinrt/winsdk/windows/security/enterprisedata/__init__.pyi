...
class FileUnprotectOptions(_winrt.Object):
    ...
    def __init__(self, audit: _winrt.Boolean) -> None: ...
...
class ProtectionPolicyAuditInfo(_winrt.Object):
    ...
    @typing.overload
    def __init__(self, action: ProtectionPolicyAuditAction, data_description: str, source_description: str, target_description: str) -> None: ...
    @typing.overload
    def __init__(self, action: ProtectionPolicyAuditAction, data_description: str) -> None: ...
...
class ProtectionPolicyManager(_winrt.Object):
    ...
    @staticmethod
    def has_content_been_revoked_since(identity: str, since: winsdk.windows.foundation.DateTime) -> _winrt.Boolean: ...
    @staticmethod
