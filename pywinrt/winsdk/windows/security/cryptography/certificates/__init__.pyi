...
class Certificate(_winrt.Object):
    ...
    def __init__(self, cert_blob: winsdk.windows.storage.streams.IBuffer) -> None:
        ...
    def build_chain_async(certificates: typing.Iterable[Certificate]) -> winsdk.windows.foundation.IAsyncOperation[CertificateChain]:
        ...
    def build_chain_async(certificates: typing.Iterable[Certificate], parameters: ChainBuildingParameters) -> winsdk.windows.foundation.IAsyncOperation[CertificateChain]:
        ...
    def get_certificate_blob() -> winsdk.windows.storage.streams.IBuffer:
        ...
    def get_hash_value() -> _winrt.UInt8:
        ...
    def get_hash_value(hash_algorithm_name: str) -> _winrt.UInt8:
        ...

class CertificateChain(_winrt.Object):
    ...
    def get_certificates(include_root: _winrt.Boolean) -> winsdk.windows.foundation.collections.IVectorView[Certificate]:
        ...
...
class CmsDetachedSignature(_winrt.Object):
    ...
    def generate_signature_async(data: winsdk.windows.storage.streams.IInputStream, signers: typing.Iterable[CmsSignerInfo], certificates: typing.Iterable[Certificate]) -> winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IBuffer]:
        ...
    def verify_signature_async(data: winsdk.windows.storage.streams.IInputStream) -> winsdk.windows.foundation.IAsyncOperation[SignatureValidationResult]:
        ...
...
class UserCertificateStore(_winrt.Object):
    ...
    name: str
    def request_add_async(certificate: Certificate) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
    def request_delete_async(certificate: Certificate) -> winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]:
        ...
