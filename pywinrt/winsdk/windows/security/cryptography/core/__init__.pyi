...
class CryptographicEngine(_winrt.Object):
    ...
    @staticmethod
    def decrypt_async(key: typing.Optional[CryptographicKey], data: typing.Optional[winsdk.windows.storage.streams.IBuffer], iv: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IBuffer]]: ...
    @staticmethod
    ...
    @staticmethod
    def sign_async(key: typing.Optional[CryptographicKey], data: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IBuffer]]: ...
    @staticmethod
    ...
    @staticmethod
    def sign_hashed_data_async(key: typing.Optional[CryptographicKey], data: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IBuffer]]: ...
    @staticmethod
...
class PersistedKeyProvider(_winrt.Object):
    ...
    @staticmethod
    def open_key_pair_from_certificate_async(certificate: typing.Optional[winsdk.windows.security.cryptography.certificates.Certificate], hash_algorithm_name: str, padding: CryptographicPadding) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[CryptographicKey]]: ...
    @staticmethod
