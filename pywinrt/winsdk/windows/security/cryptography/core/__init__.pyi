...
class AsymmetricKeyAlgorithmProvider(_winrt.Object, interfaces=[]):
    algorithm_name: str
    @staticmethod
...
class CryptographicHash(_winrt.Object, interfaces=[]):
    @staticmethod
...
class CryptographicKey(_winrt.Object, interfaces=[]):
...
class EncryptedAndAuthenticatedData(_winrt.Object, interfaces=[]):
...
class HashAlgorithmProvider(_winrt.Object, interfaces=[]):
    algorithm_name: str
...
class KeyDerivationAlgorithmProvider(_winrt.Object, interfaces=[]):
    algorithm_name: str
    @staticmethod
...
class KeyDerivationParameters(_winrt.Object, interfaces=[]):
...
class MacAlgorithmProvider(_winrt.Object, interfaces=[]):
    algorithm_name: str
...
class SymmetricKeyAlgorithmProvider(_winrt.Object, interfaces=[]):
    algorithm_name: str
