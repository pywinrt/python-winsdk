...
class WebAuthenticationBroker(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def authenticate_async(options: WebAuthenticationOptions, request_uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WebAuthenticationResult]]: ...
    @typing.overload
    @staticmethod
    def authenticate_async(options: WebAuthenticationOptions, request_uri: typing.Optional[winsdk.windows.foundation.Uri], callback_uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WebAuthenticationResult]]: ...
    @typing.overload
    @staticmethod
    def authenticate_silently_async(request_uri: typing.Optional[winsdk.windows.foundation.Uri]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WebAuthenticationResult]]: ...
    @typing.overload
    @staticmethod
    def authenticate_silently_async(request_uri: typing.Optional[winsdk.windows.foundation.Uri], options: WebAuthenticationOptions) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WebAuthenticationResult]]: ...
    @staticmethod
