...
class WebAuthenticationCoreManager(_winrt.Object):
    ...
    @staticmethod
    def find_account_async(provider: typing.Optional[winsdk.windows.security.credentials.WebAccountProvider], web_account_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.credentials.WebAccount]]: ...
    @typing.overload
    @staticmethod
    def find_account_provider_async(web_account_provider_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.credentials.WebAccountProvider]]: ...
    @typing.overload
    @staticmethod
    def find_account_provider_async(web_account_provider_id: str, authority: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.credentials.WebAccountProvider]]: ...
    @typing.overload
    @staticmethod
    def find_account_provider_async(web_account_provider_id: str, authority: str, user: typing.Optional[winsdk.windows.system.User]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.credentials.WebAccountProvider]]: ...
    @typing.overload
    @staticmethod
    def find_all_accounts_async(provider: typing.Optional[winsdk.windows.security.credentials.WebAccountProvider]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[FindAllAccountsResult]]: ...
    @typing.overload
    @staticmethod
    def find_all_accounts_async(provider: typing.Optional[winsdk.windows.security.credentials.WebAccountProvider], client_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[FindAllAccountsResult]]: ...
    @typing.overload
    @staticmethod
    def find_system_account_provider_async(web_account_provider_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.credentials.WebAccountProvider]]: ...
    @typing.overload
    @staticmethod
    def find_system_account_provider_async(web_account_provider_id: str, authority: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.credentials.WebAccountProvider]]: ...
    @typing.overload
    @staticmethod
    def find_system_account_provider_async(web_account_provider_id: str, authority: str, user: typing.Optional[winsdk.windows.system.User]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.security.credentials.WebAccountProvider]]: ...
    @typing.overload
    @staticmethod
    def get_token_silently_async(request: typing.Optional[WebTokenRequest]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WebTokenRequestResult]]: ...
    @typing.overload
    @staticmethod
    def get_token_silently_async(request: typing.Optional[WebTokenRequest], web_account: typing.Optional[winsdk.windows.security.credentials.WebAccount]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WebTokenRequestResult]]: ...
    @typing.overload
    @staticmethod
    def request_token_async(request: typing.Optional[WebTokenRequest]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WebTokenRequestResult]]: ...
    @typing.overload
    @staticmethod
    def request_token_async(request: typing.Optional[WebTokenRequest], web_account: typing.Optional[winsdk.windows.security.credentials.WebAccount]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[WebTokenRequestResult]]: ...
