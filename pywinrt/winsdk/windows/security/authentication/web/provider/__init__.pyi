...
class WebAccountClientView(_winrt.Object, interfaces=[]):
...
class WebAccountProviderAddAccountOperation(_winrt.Object, interfaces=[IWebAccountProviderOperation]):
...
class WebAccountProviderDeleteAccountOperation(_winrt.Object, interfaces=[IWebAccountProviderOperation, IWebAccountProviderBaseReportOperation]):
...
class WebAccountProviderGetTokenSilentOperation(_winrt.Object, interfaces=[IWebAccountProviderTokenOperation, IWebAccountProviderOperation, IWebAccountProviderSilentReportOperation, IWebAccountProviderBaseReportOperation]):
    kind: WebAccountProviderOperationKind
...
class WebAccountProviderManageAccountOperation(_winrt.Object, interfaces=[IWebAccountProviderOperation]):
    web_account: typing.Optional[winsdk.windows.security.credentials.WebAccount]
    kind: WebAccountProviderOperationKind
    @staticmethod
...
class WebAccountProviderRequestTokenOperation(_winrt.Object, interfaces=[IWebAccountProviderTokenOperation, IWebAccountProviderOperation, IWebAccountProviderUIReportOperation, IWebAccountProviderBaseReportOperation]):
    kind: WebAccountProviderOperationKind
    cache_expiration_time: winsdk.windows.foundation.DateTime
    provider_request: typing.Optional[WebProviderTokenRequest]
    provider_responses: typing.Optional[winsdk.windows.foundation.collections.IVector[WebProviderTokenResponse]]
...
class WebAccountProviderRetrieveCookiesOperation(_winrt.Object, interfaces=[IWebAccountProviderOperation, IWebAccountProviderBaseReportOperation]):
    kind: WebAccountProviderOperationKind
...
class WebAccountProviderSignOutAccountOperation(_winrt.Object, interfaces=[IWebAccountProviderOperation, IWebAccountProviderBaseReportOperation]):
    kind: WebAccountProviderOperationKind
    application_callback_uri: typing.Optional[winsdk.windows.foundation.Uri]
    client_id: str
    web_account: typing.Optional[winsdk.windows.security.credentials.WebAccount]
...
class WebAccountProviderTriggerDetails(_winrt.Object, interfaces=[IWebAccountProviderTokenObjects, IWebAccountProviderTokenObjects2]):
...
class WebProviderTokenRequest(_winrt.Object, interfaces=[]):
    application_callback_uri: typing.Optional[winsdk.windows.foundation.Uri]
...
class WebProviderTokenResponse(_winrt.Object, interfaces=[]):
...
class IWebAccountProviderBaseReportOperation(typing.Protocol):
    @staticmethod
    def _from(obj: _winrt.Object) -> IWebAccountProviderBaseReportOperation: ...
    def report_completed(self) -> None: ...
    def report_error(self, value: typing.Optional[winsdk.windows.security.authentication.web.core.WebProviderError]) -> None: ...

class IWebAccountProviderOperation(typing.Protocol):
    kind: WebAccountProviderOperationKind
    @staticmethod
    def _from(obj: _winrt.Object) -> IWebAccountProviderOperation: ...

class IWebAccountProviderSilentReportOperation(typing.Protocol):
    @staticmethod
...
class IWebAccountProviderTokenObjects(typing.Protocol):
    operation: typing.Optional[IWebAccountProviderOperation]
    @staticmethod
    def _from(obj: _winrt.Object) -> IWebAccountProviderTokenObjects: ...

class IWebAccountProviderTokenObjects2(typing.Protocol):
    user: typing.Optional[winsdk.windows.system.User]
    operation: typing.Optional[IWebAccountProviderOperation]
    @staticmethod
    def _from(obj: _winrt.Object) -> IWebAccountProviderTokenObjects2: ...

class IWebAccountProviderTokenOperation(typing.Protocol):
    cache_expiration_time: winsdk.windows.foundation.DateTime
    provider_request: typing.Optional[WebProviderTokenRequest]
    provider_responses: typing.Optional[winsdk.windows.foundation.collections.IVector[WebProviderTokenResponse]]
    kind: WebAccountProviderOperationKind
...
class IWebAccountProviderUIReportOperation(typing.Protocol):
    @staticmethod
