...
class SecondaryAuthenticationFactorAuthentication(_winrt.Object, interfaces=[]):
...
class SecondaryAuthenticationFactorAuthenticationResult(_winrt.Object, interfaces=[]):
...
class SecondaryAuthenticationFactorAuthenticationStageChangedEventArgs(_winrt.Object, interfaces=[]):
...
class SecondaryAuthenticationFactorAuthenticationStageInfo(_winrt.Object, interfaces=[]):
    device_id: str
...
class SecondaryAuthenticationFactorInfo(_winrt.Object, interfaces=[]):
    device_configuration_data: typing.Optional[winsdk.windows.storage.streams.IBuffer]
...
class SecondaryAuthenticationFactorRegistration(_winrt.Object, interfaces=[]):
    @staticmethod
...
class SecondaryAuthenticationFactorRegistrationResult(_winrt.Object, interfaces=[]):
