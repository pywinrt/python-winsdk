...
class SecondaryAuthenticationFactorAuthentication(_winrt.Object):
    ...
    @typing.overload
    def finish_authentication_async(self, device_hmac: winsdk.windows.storage.streams.IBuffer, session_hmac: winsdk.windows.storage.streams.IBuffer) -> winsdk.windows.foundation.IAsyncOperation[SecondaryAuthenticationFactorFinishAuthenticationStatus]: ...
    @typing.overload
    @staticmethod
...
class SecondaryAuthenticationFactorRegistration(_winrt.Object):
    ...
    @typing.overload
    def finish_registering_device_async(self, device_configuration_data: winsdk.windows.storage.streams.IBuffer) -> winsdk.windows.foundation.IAsyncAction: ...
    @typing.overload
    @staticmethod
