...
class MicrosoftAccountMultiFactorAuthenticationManager(_winrt.Object, interfaces=[]):
...
class MicrosoftAccountMultiFactorGetSessionsResult(_winrt.Object, interfaces=[]):
...
class MicrosoftAccountMultiFactorOneTimeCodedInfo(_winrt.Object, interfaces=[]):
    code: str
    service_response: MicrosoftAccountMultiFactorServiceResponse
...
class MicrosoftAccountMultiFactorSessionInfo(_winrt.Object, interfaces=[]):
...
class MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo(_winrt.Object, interfaces=[]):
    service_response: MicrosoftAccountMultiFactorServiceResponse
    sessions: typing.Optional[winsdk.windows.foundation.collections.IVectorView[MicrosoftAccountMultiFactorSessionInfo]]
