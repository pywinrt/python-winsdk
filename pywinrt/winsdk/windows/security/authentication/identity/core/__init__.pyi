...
class MicrosoftAccountMultiFactorAuthenticationManager(_winrt.Object):
    ...
    @typing.overload
    def approve_session_async(self, session_authentiction_status: MicrosoftAccountMultiFactorSessionAuthenticationStatus, authentication_session_info: MicrosoftAccountMultiFactorSessionInfo) -> winsdk.windows.foundation.IAsyncOperation[MicrosoftAccountMultiFactorServiceResponse]: ...
    @typing.overload
    ...
    @typing.overload
    def deny_session_async(self, authentication_session_info: MicrosoftAccountMultiFactorSessionInfo) -> winsdk.windows.foundation.IAsyncOperation[MicrosoftAccountMultiFactorServiceResponse]: ...
    @typing.overload
