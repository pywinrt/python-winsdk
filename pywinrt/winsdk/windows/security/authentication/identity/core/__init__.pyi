...
class MicrosoftAccountMultiFactorAuthenticationManager(_winrt.Object):
    ...
    def add_device_async(self, user_account_id: str, authentication_token: str, wns_channel_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MicrosoftAccountMultiFactorServiceResponse]]: ...
    @typing.overload
    def approve_session_async(self, session_authentiction_status: MicrosoftAccountMultiFactorSessionAuthenticationStatus, authentication_session_info: typing.Optional[MicrosoftAccountMultiFactorSessionInfo]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MicrosoftAccountMultiFactorServiceResponse]]: ...
    @typing.overload
    def approve_session_async(self, session_authentiction_status: MicrosoftAccountMultiFactorSessionAuthenticationStatus, user_account_id: str, session_id: str, session_authentication_type: MicrosoftAccountMultiFactorAuthenticationType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MicrosoftAccountMultiFactorServiceResponse]]: ...
    @typing.overload
    def deny_session_async(self, authentication_session_info: typing.Optional[MicrosoftAccountMultiFactorSessionInfo]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MicrosoftAccountMultiFactorServiceResponse]]: ...
    @typing.overload
    def deny_session_async(self, user_account_id: str, session_id: str, session_authentication_type: MicrosoftAccountMultiFactorAuthenticationType) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MicrosoftAccountMultiFactorServiceResponse]]: ...
    def get_one_time_pass_code_async(self, user_account_id: str, code_length: _winrt.UInt32) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MicrosoftAccountMultiFactorOneTimeCodedInfo]]: ...
    def get_sessions_and_unregistered_accounts_async(self, user_account_id_list: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo]]: ...
    def get_sessions_async(self, user_account_id_list: typing.Iterable[str]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MicrosoftAccountMultiFactorGetSessionsResult]]: ...
    def remove_device_async(self, user_account_id: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MicrosoftAccountMultiFactorServiceResponse]]: ...
    def update_wns_channel_async(self, user_account_id: str, channel_uri: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[MicrosoftAccountMultiFactorServiceResponse]]: ...
