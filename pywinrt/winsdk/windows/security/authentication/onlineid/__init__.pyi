...
class OnlineIdAuthenticator(_winrt.Object, interfaces=[]):
    ...
    @typing.overload
    def authenticate_user_async(self, requests: typing.Iterable[typing.Optional[OnlineIdServiceTicketRequest]], credential_prompt_type: CredentialPromptType) -> typing.Optional[UserAuthenticationOperation]: ...
    def sign_out_user_async(self) -> typing.Optional[SignOutUserOperation]: ...

class OnlineIdServiceTicket(_winrt.Object, interfaces=[]):
...
class OnlineIdServiceTicketRequest(_winrt.Object, interfaces=[]):
    policy: str
    service: str
    @staticmethod
...
class OnlineIdSystemAuthenticatorForUser(_winrt.Object, interfaces=[]):
    application_id: uuid.UUID
...
class OnlineIdSystemIdentity(_winrt.Object, interfaces=[]):
    id: str
    ticket: typing.Optional[OnlineIdServiceTicket]
    @staticmethod
    def _from(obj: _winrt.Object) -> OnlineIdSystemIdentity: ...

class OnlineIdSystemTicketResult(_winrt.Object, interfaces=[]):
...
class SignOutUserOperation(_winrt.Object, interfaces=[winsdk.windows.foundation.IAsyncAction, winsdk.windows.foundation.IAsyncInfo]):
...
class UserAuthenticationOperation(_winrt.Object, interfaces=[winsdk.windows.foundation.IAsyncOperation[UserIdentity], winsdk.windows.foundation.IAsyncInfo]):
    error_code: winsdk.windows.foundation.HResult
    id: _winrt.UInt32
    status: winsdk.windows.foundation.AsyncStatus
...
class UserIdentity(_winrt.Object, interfaces=[]):
    first_name: str
    id: str
