...
class OnlineIdSystemAuthenticatorForUser(_winrt.Object):
    ...
    def get_ticket_async(self, request: typing.Optional[OnlineIdServiceTicketRequest]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[OnlineIdSystemTicketResult]]: ...
