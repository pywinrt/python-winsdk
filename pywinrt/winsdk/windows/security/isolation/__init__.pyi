...
class IsolatedWindowsEnvironmentCreateProgress:
    ...
    def __new__(cls: typing.Type[IsolatedWindowsEnvironmentCreateProgress], state: IsolatedWindowsEnvironmentProgressState, percent_complete: _winrt.UInt32) -> IsolatedWindowsEnvironmentCreateProgress: ...
...
class IsolatedWindowsEnvironment(_winrt.Object):
    ...
    @typing.overload
    def post_message_to_receiver_async(self, receiver_id: _winrt.Guid, message: typing.Iterable[_winrt.Object]) -> winsdk.windows.foundation.IAsyncOperation[IsolatedWindowsEnvironmentPostMessageResult]: ...
    @typing.overload
    def post_message_to_receiver_async(self, receiver_id: _winrt.Guid, message: typing.Iterable[_winrt.Object], telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters]) -> winsdk.windows.foundation.IAsyncOperation[IsolatedWindowsEnvironmentPostMessageResult]: ...
    def register_message_receiver(self, receiver_id: _winrt.Guid, message_received_callback: typing.Optional[MessageReceivedCallback]) -> None: ...
    @typing.overload
    ...
    def unregister_message_receiver(self, receiver_id: _winrt.Guid) -> None: ...
...
class IsolatedWindowsHostMessenger(_winrt.Object):
    ...
    @staticmethod
    def get_file_id(file_path: str) -> _winrt.Guid: ...
    @staticmethod
    def post_message_to_receiver(receiver_id: _winrt.Guid, message: winsdk.windows.foundation.collections.IVectorView[_winrt.Object]) -> None: ...
    @staticmethod
    def register_host_message_receiver(receiver_id: _winrt.Guid, host_message_received_callback: typing.Optional[HostMessageReceivedCallback]) -> None: ...
    @staticmethod
    def unregister_host_message_receiver(receiver_id: _winrt.Guid) -> None: ...

HostMessageReceivedCallback = typing.Callable[[_winrt.Guid, winsdk.windows.foundation.collections.IVectorView[_winrt.Object]], None]

MessageReceivedCallback = typing.Callable[[_winrt.Guid, winsdk.windows.foundation.collections.IVectorView[_winrt.Object]], None]
