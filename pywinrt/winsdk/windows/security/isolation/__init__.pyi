...
class IsolatedWindowsEnvironment(_winrt.Object):
    ...
    @typing.overload
    @staticmethod
    def create_async(options: typing.Optional[IsolatedWindowsEnvironmentOptions]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[IsolatedWindowsEnvironmentCreateResult, IsolatedWindowsEnvironmentCreateProgress]]: ...
    @typing.overload
    @staticmethod
    def create_async(options: typing.Optional[IsolatedWindowsEnvironmentOptions], telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperationWithProgress[IsolatedWindowsEnvironmentCreateResult, IsolatedWindowsEnvironmentCreateProgress]]: ...
    @staticmethod
    ...
    @typing.overload
    def launch_file_with_u_i_async(self, app_exe_path: str, arguments_template: str, file_path: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IsolatedWindowsEnvironmentLaunchFileResult]]: ...
    @typing.overload
    def launch_file_with_u_i_async(self, app_exe_path: str, arguments_template: str, file_path: str, telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IsolatedWindowsEnvironmentLaunchFileResult]]: ...
    @typing.overload
    def post_message_to_receiver_async(self, receiver_id: uuid.UUID, message: typing.Iterable[typing.Optional[_winrt.Object]]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IsolatedWindowsEnvironmentPostMessageResult]]: ...
    @typing.overload
    def post_message_to_receiver_async(self, receiver_id: uuid.UUID, message: typing.Iterable[typing.Optional[_winrt.Object]], telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IsolatedWindowsEnvironmentPostMessageResult]]: ...
    ...
    @typing.overload
    def share_file_async(self, file_path: str, options: typing.Optional[IsolatedWindowsEnvironmentShareFileRequestOptions]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IsolatedWindowsEnvironmentShareFileResult]]: ...
    @typing.overload
    def share_file_async(self, file_path: str, options: typing.Optional[IsolatedWindowsEnvironmentShareFileRequestOptions], telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IsolatedWindowsEnvironmentShareFileResult]]: ...
    @typing.overload
    def share_folder_async(self, host_folder: str, request_options: typing.Optional[IsolatedWindowsEnvironmentShareFolderRequestOptions]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IsolatedWindowsEnvironmentShareFolderResult]]: ...
    @typing.overload
    def share_folder_async(self, host_folder: str, request_options: typing.Optional[IsolatedWindowsEnvironmentShareFolderRequestOptions], telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IsolatedWindowsEnvironmentShareFolderResult]]: ...
    @typing.overload
    def start_process_silently_async(self, host_exe_path: str, arguments: str, activator: IsolatedWindowsEnvironmentActivator) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IsolatedWindowsEnvironmentStartProcessResult]]: ...
    @typing.overload
    def start_process_silently_async(self, host_exe_path: str, arguments: str, activator: IsolatedWindowsEnvironmentActivator, telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[IsolatedWindowsEnvironmentStartProcessResult]]: ...
    @typing.overload
...
class IsolatedWindowsEnvironmentUserInfo(_winrt.Object):
    ...
    def try_wait_for_sign_in_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[_winrt.Boolean]]: ...
