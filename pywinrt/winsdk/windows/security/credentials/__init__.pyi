...
class KeyCredential(_winrt.Object):
    ...
    def get_attestation_async(self) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[KeyCredentialAttestationResult]]: ...
    def request_sign_async(self, data: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[KeyCredentialOperationResult]]: ...
    @typing.overload
...
class KeyCredentialManager(_winrt.Object):
    ...
    @staticmethod
    def open_async(name: str) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[KeyCredentialRetrievalResult]]: ...
    @staticmethod
    def renew_attestation_async() -> typing.Optional[winsdk.windows.foundation.IAsyncAction]: ...
    @staticmethod
    def request_create_async(name: str, option: KeyCredentialCreationOption) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[KeyCredentialRetrievalResult]]: ...
...
class WebAccount(IWebAccount, _winrt.Object):
    ...
    def get_picture_async(self, desized_size: WebAccountPictureSize) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IRandomAccessStream]]: ...
    @typing.overload
