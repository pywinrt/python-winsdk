...
class UserDataProtectionManager(_winrt.Object):
    ...
    def get_storage_item_protection_info_async(self, storage_item: typing.Optional[winsdk.windows.storage.IStorageItem]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[UserDataStorageItemProtectionInfo]]: ...
    def is_continued_data_availability_expected(self, availability: UserDataAvailability) -> _winrt.Boolean: ...
    def protect_buffer_async(self, unprotected_buffer: typing.Optional[winsdk.windows.storage.streams.IBuffer], availability: UserDataAvailability) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[winsdk.windows.storage.streams.IBuffer]]: ...
    def protect_storage_item_async(self, storage_item: typing.Optional[winsdk.windows.storage.IStorageItem], availability: UserDataAvailability) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[UserDataStorageItemProtectionStatus]]: ...
    @staticmethod
    ...
    def unprotect_buffer_async(self, protected_buffer: typing.Optional[winsdk.windows.storage.streams.IBuffer]) -> typing.Optional[winsdk.windows.foundation.IAsyncOperation[UserDataBufferUnprotectResult]]: ...
