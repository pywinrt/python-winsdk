...
class UserDataAvailabilityStateChangedEventArgs(_winrt.Object, interfaces=[]):
    @staticmethod
    def _from(obj: _winrt.Object) -> UserDataAvailabilityStateChangedEventArgs: ...
    def get_deferral(self) -> typing.Optional[winsdk.windows.foundation.Deferral]: ...

class UserDataBufferUnprotectResult(_winrt.Object, interfaces=[]):
...
class UserDataProtectionManager(_winrt.Object, interfaces=[]):
    @staticmethod
...
class UserDataStorageItemProtectionInfo(_winrt.Object, interfaces=[]):
