...
namespace py::cpp::Windows::UI::Notifications::Management
{
    ...
    static PyType_Slot type_slots_UserNotificationListener_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_UserNotificationListener_Meta },
        { }
    };

    static PyType_Spec type_spec_UserNotificationListener_Meta =
    {
        "_winsdk_Windows_UI_Notifications_Management.UserNotificationListener_Meta",
...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_Notifications_Management(void) noexcept
{
    ...
    state->type_UserNotificationListener = py::register_python_type(module.get(), type_name_UserNotificationListener, &type_spec_UserNotificationListener, bases.get(), reinterpret_cast<PyTypeObject*>(type_UserNotificationListener_Meta.get()));
