...
namespace py::cpp::Windows::ApplicationModel::Calls
{
    ...
    static PyObject* register_CellularDtmfMode(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_DtmfKey(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DtmfToneAudioPlayback(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneAudioRoutingEndpoint(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneCallAudioDevice(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneCallHistoryEntryMedia(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneCallHistoryEntryOtherAppReadAccess(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneCallHistoryEntryQueryDesiredMedia(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneCallHistoryEntryRawAddressKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneCallHistorySourceIdKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneCallHistoryStoreAccessType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneCallMedia(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneCallOperationStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneCallStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneLineNetworkOperatorDisplayTextLocation(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneLineOperationStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneLineTransport(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneLineWatcherStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneNetworkState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneSimState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PhoneVoicemailType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_TransportDeviceAudioRoutingStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_VoipPhoneCallMedia(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_VoipPhoneCallRejectReason(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_VoipPhoneCallResourceReservationStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_VoipPhoneCallState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_CallAnswerEventArgs = "CallAnswerEventArgs";
    ...
    constexpr const char* const type_name_CallRejectEventArgs = "CallRejectEventArgs";
    ...
    constexpr const char* const type_name_CallStateChangeEventArgs = "CallStateChangeEventArgs";
    ...
    constexpr const char* const type_name_MuteChangeEventArgs = "MuteChangeEventArgs";
    ...
    // ----- PhoneCall class --------------------
    constexpr const char* const type_name_PhoneCall = "PhoneCall";
    ...
    constexpr const char* const type_name_PhoneCallBlocking = "PhoneCallBlocking";
    ...
    constexpr const char* const type_name_PhoneCallHistoryEntry = "PhoneCallHistoryEntry";
    ...
    constexpr const char* const type_name_PhoneCallHistoryEntryAddress = "PhoneCallHistoryEntryAddress";
    ...
    constexpr const char* const type_name_PhoneCallHistoryEntryQueryOptions = "PhoneCallHistoryEntryQueryOptions";
    ...
    constexpr const char* const type_name_PhoneCallHistoryEntryReader = "PhoneCallHistoryEntryReader";
    ...
    constexpr const char* const type_name_PhoneCallHistoryManager = "PhoneCallHistoryManager";
    ...
    constexpr const char* const type_name_PhoneCallHistoryManagerForUser = "PhoneCallHistoryManagerForUser";
    ...
    constexpr const char* const type_name_PhoneCallHistoryStore = "PhoneCallHistoryStore";
    ...
    // ----- PhoneCallInfo class --------------------
    constexpr const char* const type_name_PhoneCallInfo = "PhoneCallInfo";
    ...
    constexpr const char* const type_name_PhoneCallManager = "PhoneCallManager";
    ...
    constexpr const char* const type_name_PhoneCallStore = "PhoneCallStore";
    ...
    constexpr const char* const type_name_PhoneCallVideoCapabilities = "PhoneCallVideoCapabilities";
    ...
    constexpr const char* const type_name_PhoneCallVideoCapabilitiesManager = "PhoneCallVideoCapabilitiesManager";
    ...
    constexpr const char* const type_name_PhoneCallsResult = "PhoneCallsResult";
    ...
    constexpr const char* const type_name_PhoneDialOptions = "PhoneDialOptions";
    ...
    // ----- PhoneLine class --------------------
    constexpr const char* const type_name_PhoneLine = "PhoneLine";
    ...
    constexpr const char* const type_name_PhoneLineCellularDetails = "PhoneLineCellularDetails";
    ...
    constexpr const char* const type_name_PhoneLineConfiguration = "PhoneLineConfiguration";
    ...
    constexpr const char* const type_name_PhoneLineDialResult = "PhoneLineDialResult";
    ...
    constexpr const char* const type_name_PhoneLineTransportDevice = "PhoneLineTransportDevice";
    ...
    constexpr const char* const type_name_PhoneLineWatcher = "PhoneLineWatcher";
    ...
    constexpr const char* const type_name_PhoneLineWatcherEventArgs = "PhoneLineWatcherEventArgs";
    ...
    constexpr const char* const type_name_PhoneVoicemail = "PhoneVoicemail";
    ...
    constexpr const char* const type_name_VoipCallCoordinator = "VoipCallCoordinator";
    ...
    // ----- VoipPhoneCall class --------------------
    constexpr const char* const type_name_VoipPhoneCall = "VoipPhoneCall";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_Calls(void) noexcept
{
    ...
    state->type_CallAnswerEventArgs = py::register_python_type(module.get(), type_name_CallAnswerEventArgs, &type_spec_CallAnswerEventArgs, bases.get());
    if (!state->type_CallAnswerEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CallAnswerEventArgs);

    state->type_CallRejectEventArgs = py::register_python_type(module.get(), type_name_CallRejectEventArgs, &type_spec_CallRejectEventArgs, bases.get());
    if (!state->type_CallRejectEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CallRejectEventArgs);

    state->type_CallStateChangeEventArgs = py::register_python_type(module.get(), type_name_CallStateChangeEventArgs, &type_spec_CallStateChangeEventArgs, bases.get());
    ...
    Py_INCREF(state->type_MuteChangeEventArgs);

    state->type_PhoneCall = py::register_python_type(module.get(), type_name_PhoneCall, &type_spec_PhoneCall, bases.get());
    if (!state->type_PhoneCall)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCall);

    state->type_PhoneCallBlocking = py::register_python_type(module.get(), type_name_PhoneCallBlocking, &type_spec_PhoneCallBlocking, nullptr);
    if (!state->type_PhoneCallBlocking)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallBlocking);

    state->type_PhoneCallHistoryEntry = py::register_python_type(module.get(), type_name_PhoneCallHistoryEntry, &type_spec_PhoneCallHistoryEntry, bases.get());
    if (!state->type_PhoneCallHistoryEntry)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallHistoryEntry);

    state->type_PhoneCallHistoryEntryAddress = py::register_python_type(module.get(), type_name_PhoneCallHistoryEntryAddress, &type_spec_PhoneCallHistoryEntryAddress, bases.get());
    if (!state->type_PhoneCallHistoryEntryAddress)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallHistoryEntryAddress);

    state->type_PhoneCallHistoryEntryQueryOptions = py::register_python_type(module.get(), type_name_PhoneCallHistoryEntryQueryOptions, &type_spec_PhoneCallHistoryEntryQueryOptions, bases.get());
    if (!state->type_PhoneCallHistoryEntryQueryOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallHistoryEntryQueryOptions);

    state->type_PhoneCallHistoryEntryReader = py::register_python_type(module.get(), type_name_PhoneCallHistoryEntryReader, &type_spec_PhoneCallHistoryEntryReader, bases.get());
    if (!state->type_PhoneCallHistoryEntryReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallHistoryEntryReader);

    state->type_PhoneCallHistoryManager = py::register_python_type(module.get(), type_name_PhoneCallHistoryManager, &type_spec_PhoneCallHistoryManager, nullptr);
    if (!state->type_PhoneCallHistoryManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallHistoryManager);

    state->type_PhoneCallHistoryManagerForUser = py::register_python_type(module.get(), type_name_PhoneCallHistoryManagerForUser, &type_spec_PhoneCallHistoryManagerForUser, bases.get());
    if (!state->type_PhoneCallHistoryManagerForUser)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallHistoryManagerForUser);

    state->type_PhoneCallHistoryStore = py::register_python_type(module.get(), type_name_PhoneCallHistoryStore, &type_spec_PhoneCallHistoryStore, bases.get());
    if (!state->type_PhoneCallHistoryStore)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallHistoryStore);

    state->type_PhoneCallInfo = py::register_python_type(module.get(), type_name_PhoneCallInfo, &type_spec_PhoneCallInfo, bases.get());
    if (!state->type_PhoneCallInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallInfo);

    state->type_PhoneCallManager = py::register_python_type(module.get(), type_name_PhoneCallManager, &type_spec_PhoneCallManager, nullptr);
    if (!state->type_PhoneCallManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallManager);

    state->type_PhoneCallStore = py::register_python_type(module.get(), type_name_PhoneCallStore, &type_spec_PhoneCallStore, bases.get());
    if (!state->type_PhoneCallStore)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallStore);

    state->type_PhoneCallVideoCapabilities = py::register_python_type(module.get(), type_name_PhoneCallVideoCapabilities, &type_spec_PhoneCallVideoCapabilities, bases.get());
    if (!state->type_PhoneCallVideoCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallVideoCapabilities);

    state->type_PhoneCallVideoCapabilitiesManager = py::register_python_type(module.get(), type_name_PhoneCallVideoCapabilitiesManager, &type_spec_PhoneCallVideoCapabilitiesManager, nullptr);
    if (!state->type_PhoneCallVideoCapabilitiesManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallVideoCapabilitiesManager);

    state->type_PhoneCallsResult = py::register_python_type(module.get(), type_name_PhoneCallsResult, &type_spec_PhoneCallsResult, bases.get());
    if (!state->type_PhoneCallsResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneCallsResult);

    state->type_PhoneDialOptions = py::register_python_type(module.get(), type_name_PhoneDialOptions, &type_spec_PhoneDialOptions, bases.get());
    if (!state->type_PhoneDialOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneDialOptions);

    state->type_PhoneLine = py::register_python_type(module.get(), type_name_PhoneLine, &type_spec_PhoneLine, bases.get());
    if (!state->type_PhoneLine)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneLine);

    state->type_PhoneLineCellularDetails = py::register_python_type(module.get(), type_name_PhoneLineCellularDetails, &type_spec_PhoneLineCellularDetails, bases.get());
    if (!state->type_PhoneLineCellularDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneLineCellularDetails);

    state->type_PhoneLineConfiguration = py::register_python_type(module.get(), type_name_PhoneLineConfiguration, &type_spec_PhoneLineConfiguration, bases.get());
    if (!state->type_PhoneLineConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneLineConfiguration);

    state->type_PhoneLineDialResult = py::register_python_type(module.get(), type_name_PhoneLineDialResult, &type_spec_PhoneLineDialResult, bases.get());
    if (!state->type_PhoneLineDialResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneLineDialResult);

    state->type_PhoneLineTransportDevice = py::register_python_type(module.get(), type_name_PhoneLineTransportDevice, &type_spec_PhoneLineTransportDevice, bases.get());
    if (!state->type_PhoneLineTransportDevice)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneLineTransportDevice);

    state->type_PhoneLineWatcher = py::register_python_type(module.get(), type_name_PhoneLineWatcher, &type_spec_PhoneLineWatcher, bases.get());
    if (!state->type_PhoneLineWatcher)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneLineWatcher);

    state->type_PhoneLineWatcherEventArgs = py::register_python_type(module.get(), type_name_PhoneLineWatcherEventArgs, &type_spec_PhoneLineWatcherEventArgs, bases.get());
    if (!state->type_PhoneLineWatcherEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneLineWatcherEventArgs);

    state->type_PhoneVoicemail = py::register_python_type(module.get(), type_name_PhoneVoicemail, &type_spec_PhoneVoicemail, bases.get());
    if (!state->type_PhoneVoicemail)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PhoneVoicemail);

    state->type_VoipCallCoordinator = py::register_python_type(module.get(), type_name_VoipCallCoordinator, &type_spec_VoipCallCoordinator, bases.get());
    if (!state->type_VoipCallCoordinator)
    {
        return nullptr;
    }

    Py_INCREF(state->type_VoipCallCoordinator);

    state->type_VoipPhoneCall = py::register_python_type(module.get(), type_name_VoipPhoneCall, &type_spec_VoipPhoneCall, bases.get());
    if (!state->type_VoipPhoneCall)
    {
        return nullptr;
    }

    Py_INCREF(state->type_VoipPhoneCall);
