...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::XboxLive::XboxLiveEndpointPairCreationBehaviors> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::XboxLive::XboxLiveEndpointPairCreationStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::XboxLive::XboxLiveEndpointPairState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::XboxLive::XboxLiveNetworkAccessKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::XboxLive::XboxLiveQualityOfServiceMeasurementStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::XboxLive::XboxLiveQualityOfServiceMetric> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::XboxLive::XboxLiveSocketKind> = "i";
