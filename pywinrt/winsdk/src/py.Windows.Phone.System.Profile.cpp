...
namespace py::cpp::Windows::Phone::System::Profile
{
    ...
    static PyType_Slot type_slots_RetailMode_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_RetailMode_Meta },
        { }
    };

    static PyType_Spec type_spec_RetailMode_Meta =
    {
        "_winsdk_Windows_Phone_System_Profile.RetailMode_Meta",
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Phone_System_Profile(void) noexcept
{
    ...
    state->type_RetailMode = py::register_python_type(module.get(), type_name_RetailMode, &type_spec_RetailMode, nullptr, reinterpret_cast<PyTypeObject*>(type_RetailMode_Meta.get()));
