...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Bluetooth::BluetoothAddressType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Bluetooth::BluetoothCacheMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Bluetooth::BluetoothConnectionStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Bluetooth::BluetoothError> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Bluetooth::BluetoothLEPreferredConnectionParametersRequestStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Bluetooth::BluetoothMajorClass> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Bluetooth::BluetoothMinorClass> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Bluetooth::BluetoothServiceCapabilities> = "I";
