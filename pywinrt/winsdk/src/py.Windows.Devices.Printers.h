...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Printers::IppAttributeErrorReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Printers::IppAttributeValueKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Printers::IppResolutionUnit> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Printers::PageConfigurationSource> = "i";
