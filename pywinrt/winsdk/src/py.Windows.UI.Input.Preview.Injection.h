...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Preview::Injection::InjectedInputButtonChangeKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Preview::Injection::InjectedInputKeyOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Preview::Injection::InjectedInputMouseOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Preview::Injection::InjectedInputPenButtons> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Preview::Injection::InjectedInputPenParameters> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Preview::Injection::InjectedInputPointerOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Preview::Injection::InjectedInputShortcut> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Preview::Injection::InjectedInputTouchParameters> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Preview::Injection::InjectedInputVisualizationMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Preview::Injection::InjectedInputPoint> = "T{i:position_x:i:position_y:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Preview::Injection::InjectedInputPointerInfo> = "T{I:pointer_id:I:pointer_options:T{i:position_x:i:position_y:}:pixel_location:I:time_offset_in_milliseconds:Q:performance_count:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Preview::Injection::InjectedInputRectangle> = "T{i:left:i:top:i:bottom:i:right:}";
