...
PyMODINIT_FUNC PyInit__winsdk_Windows_Perception(void) noexcept
{
    ...
    state->type_PerceptionTimestamp = py::register_python_type(module.get(), type_name_PerceptionTimestamp, &type_spec_PerceptionTimestamp, bases.get(), nullptr);
    if (!state->type_PerceptionTimestamp)
    {
        return nullptr;
    }

    state->type_PerceptionTimestampHelper = py::register_python_type(module.get(), type_name_PerceptionTimestampHelper, &type_spec_PerceptionTimestampHelper, nullptr, nullptr);
