...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::SerialCommunication::SerialError> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::SerialCommunication::SerialHandshake> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::SerialCommunication::SerialParity> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::SerialCommunication::SerialPinChange> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::SerialCommunication::SerialStopBitCount> = "i";
