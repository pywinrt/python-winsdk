...
namespace py::cpp::Windows::Devices::AllJoyn
{
    ...
    static PyType_Slot type_slots_AllJoynStatus_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_AllJoynStatus_Meta },
        { }
    };

    static PyType_Spec type_spec_AllJoynStatus_Meta =
    {
        "_winsdk_Windows_Devices_AllJoyn.AllJoynStatus_Meta",
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_AllJoyn(void) noexcept
{
    ...
    state->type_AllJoynAboutData = py::register_python_type(module.get(), type_name_AllJoynAboutData, &type_spec_AllJoynAboutData, bases.get(), nullptr);
    if (!state->type_AllJoynAboutData)
    {
        return nullptr;
    }

    state->type_AllJoynAboutDataView = py::register_python_type(module.get(), type_name_AllJoynAboutDataView, &type_spec_AllJoynAboutDataView, bases.get(), nullptr);
    if (!state->type_AllJoynAboutDataView)
    {
        return nullptr;
    }

    state->type_AllJoynAcceptSessionJoinerEventArgs = py::register_python_type(module.get(), type_name_AllJoynAcceptSessionJoinerEventArgs, &type_spec_AllJoynAcceptSessionJoinerEventArgs, bases.get(), nullptr);
    if (!state->type_AllJoynAcceptSessionJoinerEventArgs)
    {
        return nullptr;
    }

    state->type_AllJoynAuthenticationCompleteEventArgs = py::register_python_type(module.get(), type_name_AllJoynAuthenticationCompleteEventArgs, &type_spec_AllJoynAuthenticationCompleteEventArgs, bases.get(), nullptr);
    if (!state->type_AllJoynAuthenticationCompleteEventArgs)
    {
        return nullptr;
    }

    state->type_AllJoynBusAttachment = py::register_python_type(module.get(), type_name_AllJoynBusAttachment, &type_spec_AllJoynBusAttachment, bases.get(), nullptr);
    if (!state->type_AllJoynBusAttachment)
    {
        return nullptr;
    }

    state->type_AllJoynBusAttachmentStateChangedEventArgs = py::register_python_type(module.get(), type_name_AllJoynBusAttachmentStateChangedEventArgs, &type_spec_AllJoynBusAttachmentStateChangedEventArgs, bases.get(), nullptr);
    if (!state->type_AllJoynBusAttachmentStateChangedEventArgs)
    {
        return nullptr;
    }

    state->type_AllJoynBusObject = py::register_python_type(module.get(), type_name_AllJoynBusObject, &type_spec_AllJoynBusObject, bases.get(), nullptr);
    if (!state->type_AllJoynBusObject)
    {
        return nullptr;
    }

    state->type_AllJoynBusObjectStoppedEventArgs = py::register_python_type(module.get(), type_name_AllJoynBusObjectStoppedEventArgs, &type_spec_AllJoynBusObjectStoppedEventArgs, bases.get(), nullptr);
    if (!state->type_AllJoynBusObjectStoppedEventArgs)
    {
        return nullptr;
    }

    state->type_AllJoynCredentials = py::register_python_type(module.get(), type_name_AllJoynCredentials, &type_spec_AllJoynCredentials, bases.get(), nullptr);
    if (!state->type_AllJoynCredentials)
    {
        return nullptr;
    }

    state->type_AllJoynCredentialsRequestedEventArgs = py::register_python_type(module.get(), type_name_AllJoynCredentialsRequestedEventArgs, &type_spec_AllJoynCredentialsRequestedEventArgs, bases.get(), nullptr);
    if (!state->type_AllJoynCredentialsRequestedEventArgs)
    {
        return nullptr;
    }

    state->type_AllJoynCredentialsVerificationRequestedEventArgs = py::register_python_type(module.get(), type_name_AllJoynCredentialsVerificationRequestedEventArgs, &type_spec_AllJoynCredentialsVerificationRequestedEventArgs, bases.get(), nullptr);
    if (!state->type_AllJoynCredentialsVerificationRequestedEventArgs)
    {
        return nullptr;
    }

    state->type_AllJoynMessageInfo = py::register_python_type(module.get(), type_name_AllJoynMessageInfo, &type_spec_AllJoynMessageInfo, bases.get(), nullptr);
    if (!state->type_AllJoynMessageInfo)
    {
        return nullptr;
    }

    state->type_AllJoynProducerStoppedEventArgs = py::register_python_type(module.get(), type_name_AllJoynProducerStoppedEventArgs, &type_spec_AllJoynProducerStoppedEventArgs, bases.get(), nullptr);
    if (!state->type_AllJoynProducerStoppedEventArgs)
    {
        return nullptr;
    }

    state->type_AllJoynServiceInfo = py::register_python_type(module.get(), type_name_AllJoynServiceInfo, &type_spec_AllJoynServiceInfo, bases.get(), nullptr);
    if (!state->type_AllJoynServiceInfo)
    {
        return nullptr;
    }

    state->type_AllJoynServiceInfoRemovedEventArgs = py::register_python_type(module.get(), type_name_AllJoynServiceInfoRemovedEventArgs, &type_spec_AllJoynServiceInfoRemovedEventArgs, bases.get(), nullptr);
    if (!state->type_AllJoynServiceInfoRemovedEventArgs)
    {
        return nullptr;
    }

    state->type_AllJoynSession = py::register_python_type(module.get(), type_name_AllJoynSession, &type_spec_AllJoynSession, bases.get(), nullptr);
    if (!state->type_AllJoynSession)
    {
        return nullptr;
    }

    state->type_AllJoynSessionJoinedEventArgs = py::register_python_type(module.get(), type_name_AllJoynSessionJoinedEventArgs, &type_spec_AllJoynSessionJoinedEventArgs, bases.get(), nullptr);
    if (!state->type_AllJoynSessionJoinedEventArgs)
    {
        return nullptr;
    }

    state->type_AllJoynSessionLostEventArgs = py::register_python_type(module.get(), type_name_AllJoynSessionLostEventArgs, &type_spec_AllJoynSessionLostEventArgs, bases.get(), nullptr);
    if (!state->type_AllJoynSessionLostEventArgs)
    {
        return nullptr;
    }

    state->type_AllJoynSessionMemberAddedEventArgs = py::register_python_type(module.get(), type_name_AllJoynSessionMemberAddedEventArgs, &type_spec_AllJoynSessionMemberAddedEventArgs, bases.get(), nullptr);
    if (!state->type_AllJoynSessionMemberAddedEventArgs)
    {
        return nullptr;
    }

    state->type_AllJoynSessionMemberRemovedEventArgs = py::register_python_type(module.get(), type_name_AllJoynSessionMemberRemovedEventArgs, &type_spec_AllJoynSessionMemberRemovedEventArgs, bases.get(), nullptr);
    ...
    state->type_AllJoynStatus = py::register_python_type(module.get(), type_name_AllJoynStatus, &type_spec_AllJoynStatus, nullptr, reinterpret_cast<PyTypeObject*>(type_AllJoynStatus_Meta.get()));
    if (!state->type_AllJoynStatus)
    {
        return nullptr;
    }

    state->type_AllJoynWatcherStoppedEventArgs = py::register_python_type(module.get(), type_name_AllJoynWatcherStoppedEventArgs, &type_spec_AllJoynWatcherStoppedEventArgs, bases.get(), nullptr);
    if (!state->type_AllJoynWatcherStoppedEventArgs)
    {
        return nullptr;
    }

    state->type_IAllJoynAcceptSessionJoiner = py::register_python_type(module.get(), type_name_IAllJoynAcceptSessionJoiner, &type_spec_IAllJoynAcceptSessionJoiner, bases.get(), nullptr);
    if (!state->type_IAllJoynAcceptSessionJoiner)
    {
        return nullptr;
    }

    state->type_IAllJoynProducer = py::register_python_type(module.get(), type_name_IAllJoynProducer, &type_spec_IAllJoynProducer, bases.get(), nullptr);
