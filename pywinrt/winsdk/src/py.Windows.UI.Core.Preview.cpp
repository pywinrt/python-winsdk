...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_Core_Preview(void) noexcept
{
    ...
    state->type_CoreAppWindowPreview = py::register_python_type(module.get(), type_name_CoreAppWindowPreview, &type_spec_CoreAppWindowPreview, bases.get(), nullptr);
    if (!state->type_CoreAppWindowPreview)
    {
        return nullptr;
    }

    state->type_SystemNavigationCloseRequestedPreviewEventArgs = py::register_python_type(module.get(), type_name_SystemNavigationCloseRequestedPreviewEventArgs, &type_spec_SystemNavigationCloseRequestedPreviewEventArgs, bases.get(), nullptr);
    if (!state->type_SystemNavigationCloseRequestedPreviewEventArgs)
    {
        return nullptr;
    }

    state->type_SystemNavigationManagerPreview = py::register_python_type(module.get(), type_name_SystemNavigationManagerPreview, &type_spec_SystemNavigationManagerPreview, bases.get(), nullptr);
