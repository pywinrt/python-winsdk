...
winrt::Windows::UI::Color py::converter<winrt::Windows::UI::Color>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Color or dict");
    ...
    if (!py_A) {
        PyErr_SetString(PyExc_KeyError, "A");
        throw python_exception();
    }
    ...
    if (!py_G) {
        PyErr_SetString(PyExc_KeyError, "G");
        throw python_exception();
    }
    ...
    if (!py_B) {
        PyErr_SetString(PyExc_KeyError, "B");
        throw python_exception();
    }
...
winrt::Windows::UI::WindowId py::converter<winrt::Windows::UI::WindowId>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::WindowId or dict");
        throw python_exception();
    }
...
PyMODINIT_FUNC
PyInit__winsdk_Windows_UI (void) noexcept
{
