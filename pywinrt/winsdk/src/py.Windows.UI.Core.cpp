...
winrt::Windows::UI::Core::CorePhysicalKeyStatus py::converter<winrt::Windows::UI::Core::CorePhysicalKeyStatus>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Core::CorePhysicalKeyStatus or dict");
    ...
    if (!py_RepeatCount) {
        PyErr_SetString(PyExc_KeyError, "RepeatCount");
        throw python_exception();
    }
    ...
    if (!py_ScanCode) {
        PyErr_SetString(PyExc_KeyError, "ScanCode");
        throw python_exception();
    }
    ...
    if (!py_IsExtendedKey) {
        PyErr_SetString(PyExc_KeyError, "IsExtendedKey");
        throw python_exception();
    }
    ...
    if (!py_IsMenuKeyDown) {
        PyErr_SetString(PyExc_KeyError, "IsMenuKeyDown");
        throw python_exception();
    }
    ...
    if (!py_WasKeyDown) {
        PyErr_SetString(PyExc_KeyError, "WasKeyDown");
        throw python_exception();
    }
    ...
    if (!py_IsKeyReleased) {
        PyErr_SetString(PyExc_KeyError, "IsKeyReleased");
        throw python_exception();
    }
...
winrt::Windows::UI::Core::CoreProximityEvaluation py::converter<winrt::Windows::UI::Core::CoreProximityEvaluation>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Core::CoreProximityEvaluation or dict");
        throw python_exception();
    }
    ...
    if (!py_Score) {
        PyErr_SetString(PyExc_KeyError, "Score");
        throw python_exception();
    }
    ...
    if (!py_AdjustedPoint) {
        PyErr_SetString(PyExc_KeyError, "AdjustedPoint");
        throw python_exception();
    }
