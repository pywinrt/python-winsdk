...
namespace py::cpp::Windows::UI::Core
{
    ...
    static PyObject* register_AppViewBackButtonVisibility(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_CoreAcceleratorKeyEventType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreCursorType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreDispatcherPriority(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreIndependentInputFilters(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreInputDeviceTypes(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreProcessEventsOption(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreProximityEvaluationScore(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreVirtualKeyStates(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreWindowActivationMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreWindowActivationState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreWindowFlowDirection(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_AcceleratorKeyEventArgs = "AcceleratorKeyEventArgs";
    ...
    constexpr const char* const type_name_AutomationProviderRequestedEventArgs = "AutomationProviderRequestedEventArgs";
    ...
    constexpr const char* const type_name_BackRequestedEventArgs = "BackRequestedEventArgs";
    ...
    constexpr const char* const type_name_CharacterReceivedEventArgs = "CharacterReceivedEventArgs";
    ...
    constexpr const char* const type_name_ClosestInteractiveBoundsRequestedEventArgs = "ClosestInteractiveBoundsRequestedEventArgs";
    ...
    constexpr const char* const type_name_CoreAcceleratorKeys = "CoreAcceleratorKeys";
    ...
    constexpr const char* const type_name_CoreComponentInputSource = "CoreComponentInputSource";
    ...
    // ----- CoreCursor class --------------------
    constexpr const char* const type_name_CoreCursor = "CoreCursor";
    ...
    constexpr const char* const type_name_CoreDispatcher = "CoreDispatcher";
    ...
    constexpr const char* const type_name_CoreIndependentInputSource = "CoreIndependentInputSource";
    ...
    constexpr const char* const type_name_CoreIndependentInputSourceController = "CoreIndependentInputSourceController";
    ...
    // ----- CoreWindow class --------------------
    constexpr const char* const type_name_CoreWindow = "CoreWindow";
    ...
    constexpr const char* const type_name_CoreWindowResizeManager = "CoreWindowResizeManager";
    ...
    constexpr const char* const type_name_IdleDispatchedHandlerArgs = "IdleDispatchedHandlerArgs";
    ...
    constexpr const char* const type_name_InputEnabledEventArgs = "InputEnabledEventArgs";
    ...
    // ----- KeyEventArgs class --------------------
    constexpr const char* const type_name_KeyEventArgs = "KeyEventArgs";
    ...
    constexpr const char* const type_name_PointerEventArgs = "PointerEventArgs";
    ...
    constexpr const char* const type_name_SystemNavigationManager = "SystemNavigationManager";
    ...
    constexpr const char* const type_name_TouchHitTestingEventArgs = "TouchHitTestingEventArgs";
    ...
    constexpr const char* const type_name_VisibilityChangedEventArgs = "VisibilityChangedEventArgs";
    ...
    constexpr const char* const type_name_WindowActivatedEventArgs = "WindowActivatedEventArgs";
    ...
    constexpr const char* const type_name_WindowSizeChangedEventArgs = "WindowSizeChangedEventArgs";
    ...
    constexpr const char* const type_name_ICoreAcceleratorKeys = "ICoreAcceleratorKeys";
    ...
    constexpr const char* const type_name_ICoreInputSourceBase = "ICoreInputSourceBase";
    ...
    constexpr const char* const type_name_ICorePointerInputSource = "ICorePointerInputSource";
    ...
    constexpr const char* const type_name_ICorePointerInputSource2 = "ICorePointerInputSource2";
    ...
    constexpr const char* const type_name_ICorePointerRedirector = "ICorePointerRedirector";
    ...
    constexpr const char* const type_name_ICoreWindow = "ICoreWindow";
    ...
    constexpr const char* const type_name_ICoreWindowEventArgs = "ICoreWindowEventArgs";
    ...
    constexpr const char* const type_name_IInitializeWithCoreWindow = "IInitializeWithCoreWindow";
    ...
    constexpr const char* const type_name_CorePhysicalKeyStatus = "CorePhysicalKeyStatus";
    ...
    constexpr const char* const type_name_CoreProximityEvaluation = "CoreProximityEvaluation";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_Core(void) noexcept
{
    ...
    state->type_AcceleratorKeyEventArgs = py::register_python_type(module.get(), type_name_AcceleratorKeyEventArgs, &type_spec_AcceleratorKeyEventArgs, bases.get());
    if (!state->type_AcceleratorKeyEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AcceleratorKeyEventArgs);

    state->type_AutomationProviderRequestedEventArgs = py::register_python_type(module.get(), type_name_AutomationProviderRequestedEventArgs, &type_spec_AutomationProviderRequestedEventArgs, bases.get());
    if (!state->type_AutomationProviderRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AutomationProviderRequestedEventArgs);

    state->type_BackRequestedEventArgs = py::register_python_type(module.get(), type_name_BackRequestedEventArgs, &type_spec_BackRequestedEventArgs, bases.get());
    if (!state->type_BackRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BackRequestedEventArgs);

    state->type_CharacterReceivedEventArgs = py::register_python_type(module.get(), type_name_CharacterReceivedEventArgs, &type_spec_CharacterReceivedEventArgs, bases.get());
    if (!state->type_CharacterReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CharacterReceivedEventArgs);

    state->type_ClosestInteractiveBoundsRequestedEventArgs = py::register_python_type(module.get(), type_name_ClosestInteractiveBoundsRequestedEventArgs, &type_spec_ClosestInteractiveBoundsRequestedEventArgs, bases.get());
    if (!state->type_ClosestInteractiveBoundsRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClosestInteractiveBoundsRequestedEventArgs);

    state->type_CoreAcceleratorKeys = py::register_python_type(module.get(), type_name_CoreAcceleratorKeys, &type_spec_CoreAcceleratorKeys, bases.get());
    if (!state->type_CoreAcceleratorKeys)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreAcceleratorKeys);

    state->type_CoreComponentInputSource = py::register_python_type(module.get(), type_name_CoreComponentInputSource, &type_spec_CoreComponentInputSource, bases.get());
    if (!state->type_CoreComponentInputSource)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreComponentInputSource);

    state->type_CoreCursor = py::register_python_type(module.get(), type_name_CoreCursor, &type_spec_CoreCursor, bases.get());
    if (!state->type_CoreCursor)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreCursor);

    state->type_CoreDispatcher = py::register_python_type(module.get(), type_name_CoreDispatcher, &type_spec_CoreDispatcher, bases.get());
    if (!state->type_CoreDispatcher)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreDispatcher);

    state->type_CoreIndependentInputSource = py::register_python_type(module.get(), type_name_CoreIndependentInputSource, &type_spec_CoreIndependentInputSource, bases.get());
    if (!state->type_CoreIndependentInputSource)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreIndependentInputSource);

    state->type_CoreIndependentInputSourceController = py::register_python_type(module.get(), type_name_CoreIndependentInputSourceController, &type_spec_CoreIndependentInputSourceController, bases.get());
    if (!state->type_CoreIndependentInputSourceController)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreIndependentInputSourceController);

    state->type_CoreWindow = py::register_python_type(module.get(), type_name_CoreWindow, &type_spec_CoreWindow, bases.get());
    ...
    Py_INCREF(state->type_CoreWindowResizeManager);

    state->type_IdleDispatchedHandlerArgs = py::register_python_type(module.get(), type_name_IdleDispatchedHandlerArgs, &type_spec_IdleDispatchedHandlerArgs, bases.get());
    if (!state->type_IdleDispatchedHandlerArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IdleDispatchedHandlerArgs);

    state->type_InputEnabledEventArgs = py::register_python_type(module.get(), type_name_InputEnabledEventArgs, &type_spec_InputEnabledEventArgs, bases.get());
    if (!state->type_InputEnabledEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InputEnabledEventArgs);

    state->type_KeyEventArgs = py::register_python_type(module.get(), type_name_KeyEventArgs, &type_spec_KeyEventArgs, bases.get());
    if (!state->type_KeyEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_KeyEventArgs);

    state->type_PointerEventArgs = py::register_python_type(module.get(), type_name_PointerEventArgs, &type_spec_PointerEventArgs, bases.get());
    if (!state->type_PointerEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PointerEventArgs);

    state->type_SystemNavigationManager = py::register_python_type(module.get(), type_name_SystemNavigationManager, &type_spec_SystemNavigationManager, bases.get());
    if (!state->type_SystemNavigationManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemNavigationManager);

    state->type_TouchHitTestingEventArgs = py::register_python_type(module.get(), type_name_TouchHitTestingEventArgs, &type_spec_TouchHitTestingEventArgs, bases.get());
    if (!state->type_TouchHitTestingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_TouchHitTestingEventArgs);

    state->type_VisibilityChangedEventArgs = py::register_python_type(module.get(), type_name_VisibilityChangedEventArgs, &type_spec_VisibilityChangedEventArgs, bases.get());
    if (!state->type_VisibilityChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_VisibilityChangedEventArgs);

    state->type_WindowActivatedEventArgs = py::register_python_type(module.get(), type_name_WindowActivatedEventArgs, &type_spec_WindowActivatedEventArgs, bases.get());
    if (!state->type_WindowActivatedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WindowActivatedEventArgs);

    state->type_WindowSizeChangedEventArgs = py::register_python_type(module.get(), type_name_WindowSizeChangedEventArgs, &type_spec_WindowSizeChangedEventArgs, bases.get());
    if (!state->type_WindowSizeChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WindowSizeChangedEventArgs);

    state->type_ICoreAcceleratorKeys = py::register_python_type(module.get(), type_name_ICoreAcceleratorKeys, &type_spec_ICoreAcceleratorKeys, bases.get());
    if (!state->type_ICoreAcceleratorKeys)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICoreAcceleratorKeys);

    state->type_ICoreInputSourceBase = py::register_python_type(module.get(), type_name_ICoreInputSourceBase, &type_spec_ICoreInputSourceBase, bases.get());
    if (!state->type_ICoreInputSourceBase)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICoreInputSourceBase);

    state->type_ICorePointerInputSource = py::register_python_type(module.get(), type_name_ICorePointerInputSource, &type_spec_ICorePointerInputSource, bases.get());
    if (!state->type_ICorePointerInputSource)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICorePointerInputSource);

    state->type_ICorePointerInputSource2 = py::register_python_type(module.get(), type_name_ICorePointerInputSource2, &type_spec_ICorePointerInputSource2, bases.get());
    if (!state->type_ICorePointerInputSource2)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICorePointerInputSource2);

    state->type_ICorePointerRedirector = py::register_python_type(module.get(), type_name_ICorePointerRedirector, &type_spec_ICorePointerRedirector, bases.get());
    if (!state->type_ICorePointerRedirector)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICorePointerRedirector);

    state->type_ICoreWindow = py::register_python_type(module.get(), type_name_ICoreWindow, &type_spec_ICoreWindow, bases.get());
    if (!state->type_ICoreWindow)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICoreWindow);

    state->type_ICoreWindowEventArgs = py::register_python_type(module.get(), type_name_ICoreWindowEventArgs, &type_spec_ICoreWindowEventArgs, bases.get());
    if (!state->type_ICoreWindowEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICoreWindowEventArgs);

    state->type_IInitializeWithCoreWindow = py::register_python_type(module.get(), type_name_IInitializeWithCoreWindow, &type_spec_IInitializeWithCoreWindow, bases.get());
    if (!state->type_IInitializeWithCoreWindow)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IInitializeWithCoreWindow);

    state->type_CorePhysicalKeyStatus = py::register_python_type(module.get(), type_name_CorePhysicalKeyStatus, &type_spec_CorePhysicalKeyStatus, bases.get());
    if (!state->type_CorePhysicalKeyStatus)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CorePhysicalKeyStatus);

    state->type_CoreProximityEvaluation = py::register_python_type(module.get(), type_name_CoreProximityEvaluation, &type_spec_CoreProximityEvaluation, bases.get());
    if (!state->type_CoreProximityEvaluation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreProximityEvaluation);
