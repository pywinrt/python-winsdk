...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::HumanInterfaceDevice::HidCollectionType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::HumanInterfaceDevice::HidReportType> = "i";
