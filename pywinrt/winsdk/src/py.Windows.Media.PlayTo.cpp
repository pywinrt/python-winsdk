...
namespace py::cpp::Windows::Media::PlayTo
{
    struct module_state
    {
        PyObject* type_PlayToConnectionError;
        PyObject* type_PlayToConnectionState;
    ...
    static PyObject* register_PlayToConnectionError(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);

        if (state->type_PlayToConnectionError)
        {
        ...
        state->type_PlayToConnectionError = type;
        Py_INCREF(state->type_PlayToConnectionError);


        Py_RETURN_NONE;
    }

    static PyObject* register_PlayToConnectionState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);

        if (state->type_PlayToConnectionState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PlayToConnectionState = type;
        Py_INCREF(state->type_PlayToConnectionState);
    ...
    constexpr const char* const type_name_CurrentTimeChangeRequestedEventArgs = "CurrentTimeChangeRequestedEventArgs";
    ...
    constexpr const char* const type_name_MuteChangeRequestedEventArgs = "MuteChangeRequestedEventArgs";
    ...
    constexpr const char* const type_name_PlayToConnection = "PlayToConnection";
    ...
    constexpr const char* const type_name_PlayToConnectionErrorEventArgs = "PlayToConnectionErrorEventArgs";
    ...
    constexpr const char* const type_name_PlayToConnectionStateChangedEventArgs = "PlayToConnectionStateChangedEventArgs";
    ...
    constexpr const char* const type_name_PlayToConnectionTransferredEventArgs = "PlayToConnectionTransferredEventArgs";
    ...
    // ----- PlayToManager class --------------------
    constexpr const char* const type_name_PlayToManager = "PlayToManager";
    ...
    constexpr const char* const type_name_PlayToReceiver = "PlayToReceiver";
    ...
    // ----- PlayToSource class --------------------
    constexpr const char* const type_name_PlayToSource = "PlayToSource";
    ...
    constexpr const char* const type_name_PlayToSourceDeferral = "PlayToSourceDeferral";
    ...
    constexpr const char* const type_name_PlayToSourceRequest = "PlayToSourceRequest";
    ...
    constexpr const char* const type_name_PlayToSourceRequestedEventArgs = "PlayToSourceRequestedEventArgs";
    ...
    constexpr const char* const type_name_PlayToSourceSelectedEventArgs = "PlayToSourceSelectedEventArgs";
    ...
    constexpr const char* const type_name_SourceChangeRequestedEventArgs = "SourceChangeRequestedEventArgs";
    ...
    constexpr const char* const type_name_VolumeChangeRequestedEventArgs = "VolumeChangeRequestedEventArgs";
    ...
    static PyMethodDef module_methods[] = {
        {"_register_PlayToConnectionError", register_PlayToConnectionError, METH_O, "registers type"},
        {"_register_PlayToConnectionState", register_PlayToConnectionState, METH_O, "registers type"},
        {}};
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_PlayToConnectionError);
        Py_VISIT(state->type_PlayToConnectionState);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_PlayToConnectionError);
        Py_CLEAR(state->type_PlayToConnectionState);
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Media_PlayTo(void) noexcept
{
    ...
    state->type_CurrentTimeChangeRequestedEventArgs = py::register_python_type(module.get(), type_name_CurrentTimeChangeRequestedEventArgs, &type_spec_CurrentTimeChangeRequestedEventArgs, bases.get());
    if (!state->type_CurrentTimeChangeRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CurrentTimeChangeRequestedEventArgs);

    state->type_MuteChangeRequestedEventArgs = py::register_python_type(module.get(), type_name_MuteChangeRequestedEventArgs, &type_spec_MuteChangeRequestedEventArgs, bases.get());
    if (!state->type_MuteChangeRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MuteChangeRequestedEventArgs);

    state->type_PlayToConnection = py::register_python_type(module.get(), type_name_PlayToConnection, &type_spec_PlayToConnection, bases.get());
    if (!state->type_PlayToConnection)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlayToConnection);

    state->type_PlayToConnectionErrorEventArgs = py::register_python_type(module.get(), type_name_PlayToConnectionErrorEventArgs, &type_spec_PlayToConnectionErrorEventArgs, bases.get());
    if (!state->type_PlayToConnectionErrorEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlayToConnectionErrorEventArgs);

    state->type_PlayToConnectionStateChangedEventArgs = py::register_python_type(module.get(), type_name_PlayToConnectionStateChangedEventArgs, &type_spec_PlayToConnectionStateChangedEventArgs, bases.get());
    if (!state->type_PlayToConnectionStateChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlayToConnectionStateChangedEventArgs);

    state->type_PlayToConnectionTransferredEventArgs = py::register_python_type(module.get(), type_name_PlayToConnectionTransferredEventArgs, &type_spec_PlayToConnectionTransferredEventArgs, bases.get());
    if (!state->type_PlayToConnectionTransferredEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlayToConnectionTransferredEventArgs);

    state->type_PlayToManager = py::register_python_type(module.get(), type_name_PlayToManager, &type_spec_PlayToManager, bases.get());
    if (!state->type_PlayToManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlayToManager);

    state->type_PlayToReceiver = py::register_python_type(module.get(), type_name_PlayToReceiver, &type_spec_PlayToReceiver, bases.get());
    if (!state->type_PlayToReceiver)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlayToReceiver);

    state->type_PlayToSource = py::register_python_type(module.get(), type_name_PlayToSource, &type_spec_PlayToSource, bases.get());
    if (!state->type_PlayToSource)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlayToSource);

    state->type_PlayToSourceDeferral = py::register_python_type(module.get(), type_name_PlayToSourceDeferral, &type_spec_PlayToSourceDeferral, bases.get());
    if (!state->type_PlayToSourceDeferral)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlayToSourceDeferral);

    state->type_PlayToSourceRequest = py::register_python_type(module.get(), type_name_PlayToSourceRequest, &type_spec_PlayToSourceRequest, bases.get());
    if (!state->type_PlayToSourceRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlayToSourceRequest);

    state->type_PlayToSourceRequestedEventArgs = py::register_python_type(module.get(), type_name_PlayToSourceRequestedEventArgs, &type_spec_PlayToSourceRequestedEventArgs, bases.get());
    if (!state->type_PlayToSourceRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlayToSourceRequestedEventArgs);

    state->type_PlayToSourceSelectedEventArgs = py::register_python_type(module.get(), type_name_PlayToSourceSelectedEventArgs, &type_spec_PlayToSourceSelectedEventArgs, bases.get());
    if (!state->type_PlayToSourceSelectedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlayToSourceSelectedEventArgs);
    ...
    state->type_SourceChangeRequestedEventArgs = py::register_python_type(module.get(), type_name_SourceChangeRequestedEventArgs, &type_spec_SourceChangeRequestedEventArgs, bases.get());
    if (!state->type_SourceChangeRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SourceChangeRequestedEventArgs);

    state->type_VolumeChangeRequestedEventArgs = py::register_python_type(module.get(), type_name_VolumeChangeRequestedEventArgs, &type_spec_VolumeChangeRequestedEventArgs, bases.get());
    if (!state->type_VolumeChangeRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_VolumeChangeRequestedEventArgs);


    return module.detach();
}

PyObject* py::py_type<winrt::Windows::Media::PlayTo::PlayToConnectionError>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::PlayTo;
    ...
    auto python_type = state->type_PlayToConnectionError;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::PlayTo::PlayToConnectionError is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::PlayTo::PlayToConnectionState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::PlayTo;
    ...
    auto python_type = state->type_PlayToConnectionState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::PlayTo::PlayToConnectionState is not registered");
        return nullptr;
    }
