...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::OptionDetails::PrintOptionStates> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::OptionDetails::PrintOptionType> = "i";
