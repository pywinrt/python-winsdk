...
namespace py::cpp::Windows::Devices::I2c
{
    ...
    static PyObject* register_I2cBusSpeed(PyObject* module, PyObject* type) noexcept
    {
    ...
    static PyObject* register_I2cSharingMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_I2cTransferStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_I2c(void) noexcept
{
    ...
    state->type_I2cConnectionSettings = py::register_python_type(module.get(), type_name_I2cConnectionSettings, &type_spec_I2cConnectionSettings, bases.get(), nullptr);
    if (!state->type_I2cConnectionSettings)
    {
        return nullptr;
    }

    state->type_I2cController = py::register_python_type(module.get(), type_name_I2cController, &type_spec_I2cController, bases.get(), nullptr);
    if (!state->type_I2cController)
    {
        return nullptr;
    }

    state->type_I2cDevice = py::register_python_type(module.get(), type_name_I2cDevice, &type_spec_I2cDevice, bases.get(), nullptr);
    if (!state->type_I2cDevice)
    {
        return nullptr;
    }

    state->type_II2cDeviceStatics = py::register_python_type(module.get(), type_name_II2cDeviceStatics, &type_spec_II2cDeviceStatics, bases.get(), nullptr);
    if (!state->type_II2cDeviceStatics)
    {
        return nullptr;
    }

    state->type_I2cTransferResult = py::register_python_type(module.get(), type_name_I2cTransferResult, &type_spec_I2cTransferResult, bases.get(), nullptr);
