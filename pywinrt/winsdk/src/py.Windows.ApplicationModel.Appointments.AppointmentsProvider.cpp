...
namespace py::cpp::Windows::ApplicationModel::Appointments::AppointmentsProvider
{
    ...
    static PyType_Slot type_slots_AppointmentsProviderLaunchActionVerbs_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_AppointmentsProviderLaunchActionVerbs_Meta },
        { }
    };

    static PyType_Spec type_spec_AppointmentsProviderLaunchActionVerbs_Meta =
    {
        "_winsdk_Windows_ApplicationModel_Appointments_AppointmentsProvider.AppointmentsProviderLaunchActionVerbs_Meta",
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_Appointments_AppointmentsProvider(void) noexcept
{
    ...
    state->type_AddAppointmentOperation = py::register_python_type(module.get(), type_name_AddAppointmentOperation, &type_spec_AddAppointmentOperation, bases.get(), nullptr);
    ...
    state->type_AppointmentsProviderLaunchActionVerbs = py::register_python_type(module.get(), type_name_AppointmentsProviderLaunchActionVerbs, &type_spec_AppointmentsProviderLaunchActionVerbs, nullptr, reinterpret_cast<PyTypeObject*>(type_AppointmentsProviderLaunchActionVerbs_Meta.get()));
    if (!state->type_AppointmentsProviderLaunchActionVerbs)
    {
        return nullptr;
    }

    state->type_RemoveAppointmentOperation = py::register_python_type(module.get(), type_name_RemoveAppointmentOperation, &type_spec_RemoveAppointmentOperation, bases.get(), nullptr);
    if (!state->type_RemoveAppointmentOperation)
    {
        return nullptr;
    }

    state->type_ReplaceAppointmentOperation = py::register_python_type(module.get(), type_name_ReplaceAppointmentOperation, &type_spec_ReplaceAppointmentOperation, bases.get(), nullptr);
