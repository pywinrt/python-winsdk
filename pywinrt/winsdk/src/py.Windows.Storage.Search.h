...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Search::CommonFileQuery> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Search::CommonFolderQuery> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Search::DateStackOption> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Search::FolderDepth> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Search::IndexedState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Search::IndexerOption> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Search::SortEntry> = "T{P:property_name:?:ascending_order:}";
