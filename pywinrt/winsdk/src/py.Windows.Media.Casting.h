...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Casting::CastingConnectionErrorStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Casting::CastingConnectionState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Casting::CastingPlaybackTypes> = "I";
