...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Cryptography::Core::Capi1KdfTargetAlgorithm> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Cryptography::Core::CryptographicPadding> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Cryptography::Core::CryptographicPrivateKeyBlobType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Cryptography::Core::CryptographicPublicKeyBlobType> = "i";
