...
namespace py::cpp::Windows::Devices::Sms
{
    ...
    static PyType_Slot _type_slots_DeleteSmsMessageOperation[] = 
    {
        ...
        { Py_am_await, reinterpret_cast<unaryfunc>(_await_DeleteSmsMessageOperation) },
        { },
    };
    ...
    static PyType_Slot _type_slots_DeleteSmsMessagesOperation[] = 
    {
        ...
        { Py_am_await, reinterpret_cast<unaryfunc>(_await_DeleteSmsMessagesOperation) },
        { },
    };
    ...
    static PyType_Slot _type_slots_GetSmsDeviceOperation[] = 
    {
        ...
        { Py_am_await, reinterpret_cast<unaryfunc>(_await_GetSmsDeviceOperation) },
        { },
    };
    ...
    static PyType_Slot _type_slots_GetSmsMessageOperation[] = 
    {
        ...
        { Py_am_await, reinterpret_cast<unaryfunc>(_await_GetSmsMessageOperation) },
        { },
    };
    ...
    static PyType_Slot _type_slots_GetSmsMessagesOperation[] = 
    {
        ...
        { Py_am_await, reinterpret_cast<unaryfunc>(_await_GetSmsMessagesOperation) },
        { },
    };
    ...
    static PyType_Slot _type_slots_SendSmsMessageOperation[] = 
    {
        ...
        { Py_am_await, reinterpret_cast<unaryfunc>(_await_SendSmsMessageOperation) },
        { },
    };
    ...
    // ----- SmsDevice2 class --------------------
    constexpr const char* const type_name_SmsDevice2 = "SmsDevice2";
    ...
    // ----- SmsFilterRule class --------------------
    constexpr const char* const type_name_SmsFilterRule = "SmsFilterRule";
    ...
    constexpr const char* const type_name_SmsFilterRules = "SmsFilterRules";
    ...
    constexpr const char* const type_name_SmsMessageRegistration = "SmsMessageRegistration";
    ...
    static PyType_Slot type_slots_SmsMessageRegistration_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_SmsMessageRegistration_Meta },
        { }
    };

    static PyType_Spec type_spec_SmsMessageRegistration_Meta =
    {
        "_winsdk_Windows_Devices_Sms.SmsMessageRegistration_Meta",
    ...
    constexpr const char* const type_name_SmsSendMessageResult = "SmsSendMessageResult";
    ...
    constexpr const char* const type_name_SmsStatusMessage = "SmsStatusMessage";
    ...
    constexpr const char* const type_name_SmsTextMessage2 = "SmsTextMessage2";
    ...
    constexpr const char* const type_name_SmsVoicemailMessage = "SmsVoicemailMessage";
    ...
    // ----- SmsWapMessage class --------------------
    constexpr const char* const type_name_SmsWapMessage = "SmsWapMessage";
    ...
    constexpr const char* const type_name_SmsEncodedLength = "SmsEncodedLength";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Sms(void) noexcept
{
    ...
    state->type_DeleteSmsMessageOperation = py::register_python_type(module.get(), type_name_DeleteSmsMessageOperation, &type_spec_DeleteSmsMessageOperation, bases.get(), nullptr);
    if (!state->type_DeleteSmsMessageOperation)
    {
        return nullptr;
    }

    state->type_DeleteSmsMessagesOperation = py::register_python_type(module.get(), type_name_DeleteSmsMessagesOperation, &type_spec_DeleteSmsMessagesOperation, bases.get(), nullptr);
    if (!state->type_DeleteSmsMessagesOperation)
    {
        return nullptr;
    }

    state->type_GetSmsDeviceOperation = py::register_python_type(module.get(), type_name_GetSmsDeviceOperation, &type_spec_GetSmsDeviceOperation, bases.get(), nullptr);
    if (!state->type_GetSmsDeviceOperation)
    {
        return nullptr;
    }

    state->type_GetSmsMessageOperation = py::register_python_type(module.get(), type_name_GetSmsMessageOperation, &type_spec_GetSmsMessageOperation, bases.get(), nullptr);
    if (!state->type_GetSmsMessageOperation)
    {
        return nullptr;
    }

    state->type_GetSmsMessagesOperation = py::register_python_type(module.get(), type_name_GetSmsMessagesOperation, &type_spec_GetSmsMessagesOperation, bases.get(), nullptr);
    if (!state->type_GetSmsMessagesOperation)
    {
        return nullptr;
    }

    state->type_SendSmsMessageOperation = py::register_python_type(module.get(), type_name_SendSmsMessageOperation, &type_spec_SendSmsMessageOperation, bases.get(), nullptr);
    if (!state->type_SendSmsMessageOperation)
    {
        return nullptr;
    }

    state->type_SmsAppMessage = py::register_python_type(module.get(), type_name_SmsAppMessage, &type_spec_SmsAppMessage, bases.get(), nullptr);
    if (!state->type_SmsAppMessage)
    {
        return nullptr;
    }

    state->type_SmsBinaryMessage = py::register_python_type(module.get(), type_name_SmsBinaryMessage, &type_spec_SmsBinaryMessage, bases.get(), nullptr);
    if (!state->type_SmsBinaryMessage)
    {
        return nullptr;
    }

    state->type_SmsBroadcastMessage = py::register_python_type(module.get(), type_name_SmsBroadcastMessage, &type_spec_SmsBroadcastMessage, bases.get(), nullptr);
    if (!state->type_SmsBroadcastMessage)
    {
        return nullptr;
    }

    state->type_SmsDevice = py::register_python_type(module.get(), type_name_SmsDevice, &type_spec_SmsDevice, bases.get(), nullptr);
    if (!state->type_SmsDevice)
    {
        return nullptr;
    }

    state->type_SmsDevice2 = py::register_python_type(module.get(), type_name_SmsDevice2, &type_spec_SmsDevice2, bases.get(), nullptr);
    if (!state->type_SmsDevice2)
    {
        return nullptr;
    }

    state->type_SmsDeviceMessageStore = py::register_python_type(module.get(), type_name_SmsDeviceMessageStore, &type_spec_SmsDeviceMessageStore, bases.get(), nullptr);
    if (!state->type_SmsDeviceMessageStore)
    {
        return nullptr;
    }

    state->type_SmsFilterRule = py::register_python_type(module.get(), type_name_SmsFilterRule, &type_spec_SmsFilterRule, bases.get(), nullptr);
    if (!state->type_SmsFilterRule)
    {
        return nullptr;
    }

    state->type_SmsFilterRules = py::register_python_type(module.get(), type_name_SmsFilterRules, &type_spec_SmsFilterRules, bases.get(), nullptr);
    if (!state->type_SmsFilterRules)
    {
        return nullptr;
    }

    state->type_SmsMessageReceivedEventArgs = py::register_python_type(module.get(), type_name_SmsMessageReceivedEventArgs, &type_spec_SmsMessageReceivedEventArgs, bases.get(), nullptr);
    if (!state->type_SmsMessageReceivedEventArgs)
    {
        return nullptr;
    }

    state->type_SmsMessageReceivedTriggerDetails = py::register_python_type(module.get(), type_name_SmsMessageReceivedTriggerDetails, &type_spec_SmsMessageReceivedTriggerDetails, bases.get(), nullptr);
    ...
    state->type_SmsMessageRegistration = py::register_python_type(module.get(), type_name_SmsMessageRegistration, &type_spec_SmsMessageRegistration, bases.get(), reinterpret_cast<PyTypeObject*>(type_SmsMessageRegistration_Meta.get()));
    if (!state->type_SmsMessageRegistration)
    {
        return nullptr;
    }

    state->type_SmsReceivedEventDetails = py::register_python_type(module.get(), type_name_SmsReceivedEventDetails, &type_spec_SmsReceivedEventDetails, bases.get(), nullptr);
    if (!state->type_SmsReceivedEventDetails)
    {
        return nullptr;
    }

    state->type_SmsSendMessageResult = py::register_python_type(module.get(), type_name_SmsSendMessageResult, &type_spec_SmsSendMessageResult, bases.get(), nullptr);
    if (!state->type_SmsSendMessageResult)
    {
        return nullptr;
    }

    state->type_SmsStatusMessage = py::register_python_type(module.get(), type_name_SmsStatusMessage, &type_spec_SmsStatusMessage, bases.get(), nullptr);
    if (!state->type_SmsStatusMessage)
    {
        return nullptr;
    }

    state->type_SmsTextMessage = py::register_python_type(module.get(), type_name_SmsTextMessage, &type_spec_SmsTextMessage, bases.get(), nullptr);
    if (!state->type_SmsTextMessage)
    {
        return nullptr;
    }

    state->type_SmsTextMessage2 = py::register_python_type(module.get(), type_name_SmsTextMessage2, &type_spec_SmsTextMessage2, bases.get(), nullptr);
    if (!state->type_SmsTextMessage2)
    {
        return nullptr;
    }

    state->type_SmsVoicemailMessage = py::register_python_type(module.get(), type_name_SmsVoicemailMessage, &type_spec_SmsVoicemailMessage, bases.get(), nullptr);
    if (!state->type_SmsVoicemailMessage)
    {
        return nullptr;
    }

    state->type_SmsWapMessage = py::register_python_type(module.get(), type_name_SmsWapMessage, &type_spec_SmsWapMessage, bases.get(), nullptr);
    if (!state->type_SmsWapMessage)
    {
        return nullptr;
    }

    state->type_ISmsBinaryMessage = py::register_python_type(module.get(), type_name_ISmsBinaryMessage, &type_spec_ISmsBinaryMessage, bases.get(), nullptr);
    if (!state->type_ISmsBinaryMessage)
    {
        return nullptr;
    }

    state->type_ISmsDevice = py::register_python_type(module.get(), type_name_ISmsDevice, &type_spec_ISmsDevice, bases.get(), nullptr);
    if (!state->type_ISmsDevice)
    {
        return nullptr;
    }

    state->type_ISmsMessage = py::register_python_type(module.get(), type_name_ISmsMessage, &type_spec_ISmsMessage, bases.get(), nullptr);
    if (!state->type_ISmsMessage)
    {
        return nullptr;
    }

    state->type_ISmsMessageBase = py::register_python_type(module.get(), type_name_ISmsMessageBase, &type_spec_ISmsMessageBase, bases.get(), nullptr);
    if (!state->type_ISmsMessageBase)
    {
        return nullptr;
    }

    state->type_ISmsTextMessage = py::register_python_type(module.get(), type_name_ISmsTextMessage, &type_spec_ISmsTextMessage, bases.get(), nullptr);
    if (!state->type_ISmsTextMessage)
    {
        return nullptr;
    }

    state->type_SmsEncodedLength = py::register_python_type(module.get(), type_name_SmsEncodedLength, &type_spec_SmsEncodedLength, bases.get(), nullptr);
