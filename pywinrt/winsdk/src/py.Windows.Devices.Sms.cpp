...
namespace py::cpp::Windows::Devices::Sms
{
    ...
    static PyObject* register_CellularClass(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_SmsBroadcastType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SmsDataFormat(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SmsDeviceStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SmsEncoding(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SmsFilterActionType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SmsGeographicalScope(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SmsMessageClass(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SmsModemErrorCode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Sms(void) noexcept
{
    ...
    Py_INCREF(state->type_SmsFilterRule);

    state->type_SmsFilterRules = py::register_python_type(module.get(), type_name_SmsFilterRules, &type_spec_SmsFilterRules, bases.get());
    ...
    Py_INCREF(state->type_SmsMessageReceivedTriggerDetails);

    state->type_SmsMessageRegistration = py::register_python_type(module.get(), type_name_SmsMessageRegistration, &type_spec_SmsMessageRegistration, bases.get());
    ...
    Py_INCREF(state->type_SmsSendMessageResult);

    state->type_SmsStatusMessage = py::register_python_type(module.get(), type_name_SmsStatusMessage, &type_spec_SmsStatusMessage, bases.get());
    ...
    Py_INCREF(state->type_SmsTextMessage2);

    state->type_SmsVoicemailMessage = py::register_python_type(module.get(), type_name_SmsVoicemailMessage, &type_spec_SmsVoicemailMessage, bases.get());
    if (!state->type_SmsVoicemailMessage)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SmsVoicemailMessage);

    state->type_SmsWapMessage = py::register_python_type(module.get(), type_name_SmsWapMessage, &type_spec_SmsWapMessage, bases.get());
    ...
    Py_INCREF(state->type_SmsEncodedLength);
