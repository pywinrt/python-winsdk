...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::NumberFormatting::CurrencyFormatterMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::NumberFormatting::RoundingAlgorithm> = "i";
