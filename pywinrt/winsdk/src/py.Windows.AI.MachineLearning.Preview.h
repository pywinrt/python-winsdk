...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::AI::MachineLearning::Preview::FeatureElementKindPreview> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::AI::MachineLearning::Preview::LearningModelDeviceKindPreview> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::AI::MachineLearning::Preview::LearningModelFeatureKindPreview> = "i";
