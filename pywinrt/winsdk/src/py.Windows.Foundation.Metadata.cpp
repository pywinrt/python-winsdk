...
namespace py::cpp::Windows::Foundation::Metadata
{
    ...
    static PyObject* register_AttributeTargets(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_CompositionType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DeprecationType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_FeatureStage(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_GCPressureAmount(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MarshalingType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_Platform(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ThreadingModel(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Foundation_Metadata(void) noexcept
{
    ...
    state->type_ApiInformation = py::register_python_type(module.get(), type_name_ApiInformation, &type_spec_ApiInformation, nullptr);
    if (!state->type_ApiInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ApiInformation);
