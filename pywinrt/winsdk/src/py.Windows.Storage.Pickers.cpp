...
namespace py::cpp::Windows::Storage::Pickers
{
    ...
    static PyObject* register_PickerLocationId(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_PickerViewMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_FileExtensionVector = "FileExtensionVector";
    ...
    static PyObject* FileExtensionVector_GetMany(py::wrapper::Windows::Storage::Pickers::FileExtensionVector* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Storage.Pickers.FileExtensionVector", L"GetMany", 2))
            {
    ...
    constexpr const char* const type_name_FileOpenPicker = "FileOpenPicker";
    ...
    constexpr const char* const type_name_FilePickerFileTypesOrderedMap = "FilePickerFileTypesOrderedMap";
    ...
    static PyType_Slot _type_slots_FilePickerFileTypesOrderedMap[] = 
    {
        ...
        { Py_sq_contains, _map_contains_FilePickerFileTypesOrderedMap },
    ...
    constexpr const char* const type_name_FilePickerSelectedFilesArray = "FilePickerSelectedFilesArray";
    ...
    static PyObject* FilePickerSelectedFilesArray_GetMany(py::wrapper::Windows::Storage::Pickers::FilePickerSelectedFilesArray* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Storage.Pickers.FilePickerSelectedFilesArray", L"GetMany", 2))
            {
                PyErr_SetString(PyExc_AttributeError, "method 2 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    static PyObject* FilePickerSelectedFilesArray_get_insert(PyObject* self) noexcept
    {
        return PyObject_GetAttrString(self, "insert_at");
    }
    ...
    constexpr const char* const type_name_FileSavePicker = "FileSavePicker";
    ...
    // ----- FolderPicker class --------------------
    constexpr const char* const type_name_FolderPicker = "FolderPicker";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Storage_Pickers(void) noexcept
{
    ...
    state->type_FileExtensionVector = py::register_python_type(module.get(), type_name_FileExtensionVector, &type_spec_FileExtensionVector, mutable_sequence_bases.get());
    if (!state->type_FileExtensionVector)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FileExtensionVector);

    state->type_FileOpenPicker = py::register_python_type(module.get(), type_name_FileOpenPicker, &type_spec_FileOpenPicker, bases.get());
    if (!state->type_FileOpenPicker)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FileOpenPicker);

    state->type_FilePickerFileTypesOrderedMap = py::register_python_type(module.get(), type_name_FilePickerFileTypesOrderedMap, &type_spec_FilePickerFileTypesOrderedMap, mutable_mapping_bases.get());
    if (!state->type_FilePickerFileTypesOrderedMap)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FilePickerFileTypesOrderedMap);

    state->type_FilePickerSelectedFilesArray = py::register_python_type(module.get(), type_name_FilePickerSelectedFilesArray, &type_spec_FilePickerSelectedFilesArray, sequence_bases.get());
    if (!state->type_FilePickerSelectedFilesArray)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FilePickerSelectedFilesArray);

    state->type_FileSavePicker = py::register_python_type(module.get(), type_name_FileSavePicker, &type_spec_FileSavePicker, bases.get());
    if (!state->type_FileSavePicker)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FileSavePicker);

    state->type_FolderPicker = py::register_python_type(module.get(), type_name_FolderPicker, &type_spec_FolderPicker, bases.get());
    if (!state->type_FolderPicker)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FolderPicker);
