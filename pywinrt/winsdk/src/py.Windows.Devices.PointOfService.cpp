...
namespace py::cpp::Windows::Devices::PointOfService
{
    ...
    static PyObject* register_BarcodeScannerStatus(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_BarcodeSymbologyDecodeLengthKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CashDrawerStatusKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LineDisplayCursorType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LineDisplayDescriptorState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LineDisplayHorizontalAlignment(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LineDisplayMarqueeFormat(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LineDisplayPowerStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LineDisplayScrollDirection(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LineDisplayTextAttribute(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LineDisplayTextAttributeGranularity(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LineDisplayVerticalAlignment(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MagneticStripeReaderAuthenticationLevel(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MagneticStripeReaderAuthenticationProtocol(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MagneticStripeReaderErrorReportingType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MagneticStripeReaderStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MagneticStripeReaderTrackErrorType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MagneticStripeReaderTrackIds(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosConnectionTypes(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterAlignment(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterBarcodeTextPosition(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterCartridgeSensors(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterColorCapabilities(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterColorCartridge(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterLineDirection(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterLineStyle(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterMapMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterMarkFeedCapabilities(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterMarkFeedKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterPrintSide(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterRotation(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterRuledLineCapabilities(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PosPrinterStatusKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_UnifiedPosErrorReason(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_UnifiedPosErrorSeverity(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_UnifiedPosHealthCheckLevel(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_UnifiedPosPowerReportingType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_BarcodeScanner = "BarcodeScanner";
    ...
    constexpr const char* const type_name_BarcodeScannerCapabilities = "BarcodeScannerCapabilities";
    ...
    constexpr const char* const type_name_BarcodeScannerDataReceivedEventArgs = "BarcodeScannerDataReceivedEventArgs";
    ...
    constexpr const char* const type_name_BarcodeScannerErrorOccurredEventArgs = "BarcodeScannerErrorOccurredEventArgs";
    ...
    constexpr const char* const type_name_BarcodeScannerImagePreviewReceivedEventArgs = "BarcodeScannerImagePreviewReceivedEventArgs";
    ...
    constexpr const char* const type_name_BarcodeScannerReport = "BarcodeScannerReport";
    ...
    constexpr const char* const type_name_BarcodeScannerStatusUpdatedEventArgs = "BarcodeScannerStatusUpdatedEventArgs";
    ...
    constexpr const char* const type_name_BarcodeSymbologies = "BarcodeSymbologies";
    ...
    constexpr const char* const type_name_BarcodeSymbologyAttributes = "BarcodeSymbologyAttributes";
    ...
    // ----- CashDrawer class --------------------
    constexpr const char* const type_name_CashDrawer = "CashDrawer";
    ...
    constexpr const char* const type_name_CashDrawerCapabilities = "CashDrawerCapabilities";
    ...
    constexpr const char* const type_name_CashDrawerCloseAlarm = "CashDrawerCloseAlarm";
    ...
    constexpr const char* const type_name_CashDrawerClosedEventArgs = "CashDrawerClosedEventArgs";
    ...
    constexpr const char* const type_name_CashDrawerEventSource = "CashDrawerEventSource";
    ...
    constexpr const char* const type_name_CashDrawerOpenedEventArgs = "CashDrawerOpenedEventArgs";
    ...
    constexpr const char* const type_name_CashDrawerStatus = "CashDrawerStatus";
    ...
    constexpr const char* const type_name_CashDrawerStatusUpdatedEventArgs = "CashDrawerStatusUpdatedEventArgs";
    ...
    constexpr const char* const type_name_ClaimedBarcodeScanner = "ClaimedBarcodeScanner";
    ...
    constexpr const char* const type_name_ClaimedBarcodeScannerClosedEventArgs = "ClaimedBarcodeScannerClosedEventArgs";
    ...
    constexpr const char* const type_name_ClaimedCashDrawer = "ClaimedCashDrawer";
    ...
    constexpr const char* const type_name_ClaimedCashDrawerClosedEventArgs = "ClaimedCashDrawerClosedEventArgs";
    ...
    constexpr const char* const type_name_ClaimedJournalPrinter = "ClaimedJournalPrinter";
    ...
    constexpr const char* const type_name_ClaimedLineDisplay = "ClaimedLineDisplay";
    ...
    constexpr const char* const type_name_ClaimedLineDisplayClosedEventArgs = "ClaimedLineDisplayClosedEventArgs";
    ...
    constexpr const char* const type_name_ClaimedMagneticStripeReader = "ClaimedMagneticStripeReader";
    ...
    constexpr const char* const type_name_ClaimedMagneticStripeReaderClosedEventArgs = "ClaimedMagneticStripeReaderClosedEventArgs";
    ...
    constexpr const char* const type_name_ClaimedPosPrinter = "ClaimedPosPrinter";
    ...
    constexpr const char* const type_name_ClaimedPosPrinterClosedEventArgs = "ClaimedPosPrinterClosedEventArgs";
    ...
    constexpr const char* const type_name_ClaimedReceiptPrinter = "ClaimedReceiptPrinter";
    ...
    constexpr const char* const type_name_ClaimedSlipPrinter = "ClaimedSlipPrinter";
    ...
    constexpr const char* const type_name_JournalPrintJob = "JournalPrintJob";
    ...
    constexpr const char* const type_name_JournalPrinterCapabilities = "JournalPrinterCapabilities";
    ...
    // ----- LineDisplay class --------------------
    constexpr const char* const type_name_LineDisplay = "LineDisplay";
    ...
    constexpr const char* const type_name_LineDisplayAttributes = "LineDisplayAttributes";
    ...
    constexpr const char* const type_name_LineDisplayCapabilities = "LineDisplayCapabilities";
    ...
    constexpr const char* const type_name_LineDisplayCursor = "LineDisplayCursor";
    ...
    constexpr const char* const type_name_LineDisplayCursorAttributes = "LineDisplayCursorAttributes";
    ...
    constexpr const char* const type_name_LineDisplayCustomGlyphs = "LineDisplayCustomGlyphs";
    ...
    constexpr const char* const type_name_LineDisplayMarquee = "LineDisplayMarquee";
    ...
    constexpr const char* const type_name_LineDisplayStatisticsCategorySelector = "LineDisplayStatisticsCategorySelector";
    ...
    constexpr const char* const type_name_LineDisplayStatusUpdatedEventArgs = "LineDisplayStatusUpdatedEventArgs";
    ...
    constexpr const char* const type_name_LineDisplayStoredBitmap = "LineDisplayStoredBitmap";
    ...
    constexpr const char* const type_name_LineDisplayWindow = "LineDisplayWindow";
    ...
    constexpr const char* const type_name_MagneticStripeReader = "MagneticStripeReader";
    ...
    constexpr const char* const type_name_MagneticStripeReaderAamvaCardDataReceivedEventArgs = "MagneticStripeReaderAamvaCardDataReceivedEventArgs";
    ...
    constexpr const char* const type_name_MagneticStripeReaderBankCardDataReceivedEventArgs = "MagneticStripeReaderBankCardDataReceivedEventArgs";
    ...
    constexpr const char* const type_name_MagneticStripeReaderCapabilities = "MagneticStripeReaderCapabilities";
    ...
    constexpr const char* const type_name_MagneticStripeReaderCardTypes = "MagneticStripeReaderCardTypes";
    ...
    constexpr const char* const type_name_MagneticStripeReaderEncryptionAlgorithms = "MagneticStripeReaderEncryptionAlgorithms";
    ...
    constexpr const char* const type_name_MagneticStripeReaderErrorOccurredEventArgs = "MagneticStripeReaderErrorOccurredEventArgs";
    ...
    constexpr const char* const type_name_MagneticStripeReaderReport = "MagneticStripeReaderReport";
    ...
    constexpr const char* const type_name_MagneticStripeReaderStatusUpdatedEventArgs = "MagneticStripeReaderStatusUpdatedEventArgs";
    ...
    constexpr const char* const type_name_MagneticStripeReaderTrackData = "MagneticStripeReaderTrackData";
    ...
    constexpr const char* const type_name_MagneticStripeReaderVendorSpecificCardDataReceivedEventArgs = "MagneticStripeReaderVendorSpecificCardDataReceivedEventArgs";
    ...
    // ----- PosPrinter class --------------------
    constexpr const char* const type_name_PosPrinter = "PosPrinter";
    ...
    constexpr const char* const type_name_PosPrinterCapabilities = "PosPrinterCapabilities";
    ...
    constexpr const char* const type_name_PosPrinterCharacterSetIds = "PosPrinterCharacterSetIds";
    ...
    constexpr const char* const type_name_PosPrinterFontProperty = "PosPrinterFontProperty";
    ...
    constexpr const char* const type_name_PosPrinterPrintOptions = "PosPrinterPrintOptions";
    ...
    constexpr const char* const type_name_PosPrinterReleaseDeviceRequestedEventArgs = "PosPrinterReleaseDeviceRequestedEventArgs";
    ...
    constexpr const char* const type_name_PosPrinterStatus = "PosPrinterStatus";
    ...
    constexpr const char* const type_name_PosPrinterStatusUpdatedEventArgs = "PosPrinterStatusUpdatedEventArgs";
    ...
    constexpr const char* const type_name_ReceiptPrintJob = "ReceiptPrintJob";
    ...
    constexpr const char* const type_name_ReceiptPrinterCapabilities = "ReceiptPrinterCapabilities";
    ...
    // ----- SlipPrintJob class --------------------
    constexpr const char* const type_name_SlipPrintJob = "SlipPrintJob";
    ...
    constexpr const char* const type_name_SlipPrinterCapabilities = "SlipPrinterCapabilities";
    ...
    constexpr const char* const type_name_UnifiedPosErrorData = "UnifiedPosErrorData";
    ...
    constexpr const char* const type_name_ICashDrawerEventSourceEventArgs = "ICashDrawerEventSourceEventArgs";
    ...
    constexpr const char* const type_name_ICommonClaimedPosPrinterStation = "ICommonClaimedPosPrinterStation";
    ...
    constexpr const char* const type_name_ICommonPosPrintStationCapabilities = "ICommonPosPrintStationCapabilities";
    ...
    constexpr const char* const type_name_ICommonReceiptSlipCapabilities = "ICommonReceiptSlipCapabilities";
    ...
    constexpr const char* const type_name_IPosPrinterJob = "IPosPrinterJob";
    ...
    constexpr const char* const type_name_IReceiptOrSlipJob = "IReceiptOrSlipJob";
    ...
    // ----- SizeUInt32 struct --------------------
    constexpr const char* const type_name_SizeUInt32 = "SizeUInt32";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_PointOfService(void) noexcept
{
    ...
    state->type_BarcodeScanner = py::register_python_type(module.get(), type_name_BarcodeScanner, &type_spec_BarcodeScanner, bases.get());
    if (!state->type_BarcodeScanner)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BarcodeScanner);

    state->type_BarcodeScannerCapabilities = py::register_python_type(module.get(), type_name_BarcodeScannerCapabilities, &type_spec_BarcodeScannerCapabilities, bases.get());
    if (!state->type_BarcodeScannerCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BarcodeScannerCapabilities);

    state->type_BarcodeScannerDataReceivedEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerDataReceivedEventArgs, &type_spec_BarcodeScannerDataReceivedEventArgs, bases.get());
    if (!state->type_BarcodeScannerDataReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BarcodeScannerDataReceivedEventArgs);

    state->type_BarcodeScannerErrorOccurredEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerErrorOccurredEventArgs, &type_spec_BarcodeScannerErrorOccurredEventArgs, bases.get());
    if (!state->type_BarcodeScannerErrorOccurredEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BarcodeScannerErrorOccurredEventArgs);

    state->type_BarcodeScannerImagePreviewReceivedEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerImagePreviewReceivedEventArgs, &type_spec_BarcodeScannerImagePreviewReceivedEventArgs, bases.get());
    if (!state->type_BarcodeScannerImagePreviewReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BarcodeScannerImagePreviewReceivedEventArgs);

    state->type_BarcodeScannerReport = py::register_python_type(module.get(), type_name_BarcodeScannerReport, &type_spec_BarcodeScannerReport, bases.get());
    if (!state->type_BarcodeScannerReport)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BarcodeScannerReport);

    state->type_BarcodeScannerStatusUpdatedEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerStatusUpdatedEventArgs, &type_spec_BarcodeScannerStatusUpdatedEventArgs, bases.get());
    if (!state->type_BarcodeScannerStatusUpdatedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BarcodeScannerStatusUpdatedEventArgs);

    state->type_BarcodeSymbologies = py::register_python_type(module.get(), type_name_BarcodeSymbologies, &type_spec_BarcodeSymbologies, nullptr);
    if (!state->type_BarcodeSymbologies)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BarcodeSymbologies);

    state->type_BarcodeSymbologyAttributes = py::register_python_type(module.get(), type_name_BarcodeSymbologyAttributes, &type_spec_BarcodeSymbologyAttributes, bases.get());
    if (!state->type_BarcodeSymbologyAttributes)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BarcodeSymbologyAttributes);

    state->type_CashDrawer = py::register_python_type(module.get(), type_name_CashDrawer, &type_spec_CashDrawer, bases.get());
    if (!state->type_CashDrawer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CashDrawer);

    state->type_CashDrawerCapabilities = py::register_python_type(module.get(), type_name_CashDrawerCapabilities, &type_spec_CashDrawerCapabilities, bases.get());
    if (!state->type_CashDrawerCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CashDrawerCapabilities);

    state->type_CashDrawerCloseAlarm = py::register_python_type(module.get(), type_name_CashDrawerCloseAlarm, &type_spec_CashDrawerCloseAlarm, bases.get());
    if (!state->type_CashDrawerCloseAlarm)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CashDrawerCloseAlarm);

    state->type_CashDrawerClosedEventArgs = py::register_python_type(module.get(), type_name_CashDrawerClosedEventArgs, &type_spec_CashDrawerClosedEventArgs, bases.get());
    if (!state->type_CashDrawerClosedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CashDrawerClosedEventArgs);

    state->type_CashDrawerEventSource = py::register_python_type(module.get(), type_name_CashDrawerEventSource, &type_spec_CashDrawerEventSource, bases.get());
    if (!state->type_CashDrawerEventSource)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CashDrawerEventSource);

    state->type_CashDrawerOpenedEventArgs = py::register_python_type(module.get(), type_name_CashDrawerOpenedEventArgs, &type_spec_CashDrawerOpenedEventArgs, bases.get());
    if (!state->type_CashDrawerOpenedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CashDrawerOpenedEventArgs);

    state->type_CashDrawerStatus = py::register_python_type(module.get(), type_name_CashDrawerStatus, &type_spec_CashDrawerStatus, bases.get());
    if (!state->type_CashDrawerStatus)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CashDrawerStatus);

    state->type_CashDrawerStatusUpdatedEventArgs = py::register_python_type(module.get(), type_name_CashDrawerStatusUpdatedEventArgs, &type_spec_CashDrawerStatusUpdatedEventArgs, bases.get());
    if (!state->type_CashDrawerStatusUpdatedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CashDrawerStatusUpdatedEventArgs);

    state->type_ClaimedBarcodeScanner = py::register_python_type(module.get(), type_name_ClaimedBarcodeScanner, &type_spec_ClaimedBarcodeScanner, bases.get());
    if (!state->type_ClaimedBarcodeScanner)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedBarcodeScanner);

    state->type_ClaimedBarcodeScannerClosedEventArgs = py::register_python_type(module.get(), type_name_ClaimedBarcodeScannerClosedEventArgs, &type_spec_ClaimedBarcodeScannerClosedEventArgs, bases.get());
    if (!state->type_ClaimedBarcodeScannerClosedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedBarcodeScannerClosedEventArgs);

    state->type_ClaimedCashDrawer = py::register_python_type(module.get(), type_name_ClaimedCashDrawer, &type_spec_ClaimedCashDrawer, bases.get());
    if (!state->type_ClaimedCashDrawer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedCashDrawer);

    state->type_ClaimedCashDrawerClosedEventArgs = py::register_python_type(module.get(), type_name_ClaimedCashDrawerClosedEventArgs, &type_spec_ClaimedCashDrawerClosedEventArgs, bases.get());
    if (!state->type_ClaimedCashDrawerClosedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedCashDrawerClosedEventArgs);

    state->type_ClaimedJournalPrinter = py::register_python_type(module.get(), type_name_ClaimedJournalPrinter, &type_spec_ClaimedJournalPrinter, bases.get());
    if (!state->type_ClaimedJournalPrinter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedJournalPrinter);

    state->type_ClaimedLineDisplay = py::register_python_type(module.get(), type_name_ClaimedLineDisplay, &type_spec_ClaimedLineDisplay, bases.get());
    if (!state->type_ClaimedLineDisplay)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedLineDisplay);

    state->type_ClaimedLineDisplayClosedEventArgs = py::register_python_type(module.get(), type_name_ClaimedLineDisplayClosedEventArgs, &type_spec_ClaimedLineDisplayClosedEventArgs, bases.get());
    if (!state->type_ClaimedLineDisplayClosedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedLineDisplayClosedEventArgs);

    state->type_ClaimedMagneticStripeReader = py::register_python_type(module.get(), type_name_ClaimedMagneticStripeReader, &type_spec_ClaimedMagneticStripeReader, bases.get());
    if (!state->type_ClaimedMagneticStripeReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedMagneticStripeReader);

    state->type_ClaimedMagneticStripeReaderClosedEventArgs = py::register_python_type(module.get(), type_name_ClaimedMagneticStripeReaderClosedEventArgs, &type_spec_ClaimedMagneticStripeReaderClosedEventArgs, bases.get());
    if (!state->type_ClaimedMagneticStripeReaderClosedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedMagneticStripeReaderClosedEventArgs);

    state->type_ClaimedPosPrinter = py::register_python_type(module.get(), type_name_ClaimedPosPrinter, &type_spec_ClaimedPosPrinter, bases.get());
    if (!state->type_ClaimedPosPrinter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedPosPrinter);

    state->type_ClaimedPosPrinterClosedEventArgs = py::register_python_type(module.get(), type_name_ClaimedPosPrinterClosedEventArgs, &type_spec_ClaimedPosPrinterClosedEventArgs, bases.get());
    if (!state->type_ClaimedPosPrinterClosedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedPosPrinterClosedEventArgs);

    state->type_ClaimedReceiptPrinter = py::register_python_type(module.get(), type_name_ClaimedReceiptPrinter, &type_spec_ClaimedReceiptPrinter, bases.get());
    if (!state->type_ClaimedReceiptPrinter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedReceiptPrinter);

    state->type_ClaimedSlipPrinter = py::register_python_type(module.get(), type_name_ClaimedSlipPrinter, &type_spec_ClaimedSlipPrinter, bases.get());
    if (!state->type_ClaimedSlipPrinter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClaimedSlipPrinter);

    state->type_JournalPrintJob = py::register_python_type(module.get(), type_name_JournalPrintJob, &type_spec_JournalPrintJob, bases.get());
    if (!state->type_JournalPrintJob)
    {
        return nullptr;
    }

    Py_INCREF(state->type_JournalPrintJob);

    state->type_JournalPrinterCapabilities = py::register_python_type(module.get(), type_name_JournalPrinterCapabilities, &type_spec_JournalPrinterCapabilities, bases.get());
    if (!state->type_JournalPrinterCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_JournalPrinterCapabilities);

    state->type_LineDisplay = py::register_python_type(module.get(), type_name_LineDisplay, &type_spec_LineDisplay, bases.get());
    if (!state->type_LineDisplay)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LineDisplay);

    state->type_LineDisplayAttributes = py::register_python_type(module.get(), type_name_LineDisplayAttributes, &type_spec_LineDisplayAttributes, bases.get());
    if (!state->type_LineDisplayAttributes)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LineDisplayAttributes);

    state->type_LineDisplayCapabilities = py::register_python_type(module.get(), type_name_LineDisplayCapabilities, &type_spec_LineDisplayCapabilities, bases.get());
    if (!state->type_LineDisplayCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LineDisplayCapabilities);

    state->type_LineDisplayCursor = py::register_python_type(module.get(), type_name_LineDisplayCursor, &type_spec_LineDisplayCursor, bases.get());
    if (!state->type_LineDisplayCursor)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LineDisplayCursor);

    state->type_LineDisplayCursorAttributes = py::register_python_type(module.get(), type_name_LineDisplayCursorAttributes, &type_spec_LineDisplayCursorAttributes, bases.get());
    if (!state->type_LineDisplayCursorAttributes)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LineDisplayCursorAttributes);

    state->type_LineDisplayCustomGlyphs = py::register_python_type(module.get(), type_name_LineDisplayCustomGlyphs, &type_spec_LineDisplayCustomGlyphs, bases.get());
    if (!state->type_LineDisplayCustomGlyphs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LineDisplayCustomGlyphs);

    state->type_LineDisplayMarquee = py::register_python_type(module.get(), type_name_LineDisplayMarquee, &type_spec_LineDisplayMarquee, bases.get());
    if (!state->type_LineDisplayMarquee)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LineDisplayMarquee);

    state->type_LineDisplayStatisticsCategorySelector = py::register_python_type(module.get(), type_name_LineDisplayStatisticsCategorySelector, &type_spec_LineDisplayStatisticsCategorySelector, bases.get());
    if (!state->type_LineDisplayStatisticsCategorySelector)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LineDisplayStatisticsCategorySelector);

    state->type_LineDisplayStatusUpdatedEventArgs = py::register_python_type(module.get(), type_name_LineDisplayStatusUpdatedEventArgs, &type_spec_LineDisplayStatusUpdatedEventArgs, bases.get());
    if (!state->type_LineDisplayStatusUpdatedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LineDisplayStatusUpdatedEventArgs);

    state->type_LineDisplayStoredBitmap = py::register_python_type(module.get(), type_name_LineDisplayStoredBitmap, &type_spec_LineDisplayStoredBitmap, bases.get());
    if (!state->type_LineDisplayStoredBitmap)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LineDisplayStoredBitmap);

    state->type_LineDisplayWindow = py::register_python_type(module.get(), type_name_LineDisplayWindow, &type_spec_LineDisplayWindow, bases.get());
    if (!state->type_LineDisplayWindow)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LineDisplayWindow);

    state->type_MagneticStripeReader = py::register_python_type(module.get(), type_name_MagneticStripeReader, &type_spec_MagneticStripeReader, bases.get());
    if (!state->type_MagneticStripeReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagneticStripeReader);

    state->type_MagneticStripeReaderAamvaCardDataReceivedEventArgs = py::register_python_type(module.get(), type_name_MagneticStripeReaderAamvaCardDataReceivedEventArgs, &type_spec_MagneticStripeReaderAamvaCardDataReceivedEventArgs, bases.get());
    if (!state->type_MagneticStripeReaderAamvaCardDataReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagneticStripeReaderAamvaCardDataReceivedEventArgs);

    state->type_MagneticStripeReaderBankCardDataReceivedEventArgs = py::register_python_type(module.get(), type_name_MagneticStripeReaderBankCardDataReceivedEventArgs, &type_spec_MagneticStripeReaderBankCardDataReceivedEventArgs, bases.get());
    if (!state->type_MagneticStripeReaderBankCardDataReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagneticStripeReaderBankCardDataReceivedEventArgs);

    state->type_MagneticStripeReaderCapabilities = py::register_python_type(module.get(), type_name_MagneticStripeReaderCapabilities, &type_spec_MagneticStripeReaderCapabilities, bases.get());
    if (!state->type_MagneticStripeReaderCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagneticStripeReaderCapabilities);

    state->type_MagneticStripeReaderCardTypes = py::register_python_type(module.get(), type_name_MagneticStripeReaderCardTypes, &type_spec_MagneticStripeReaderCardTypes, nullptr);
    if (!state->type_MagneticStripeReaderCardTypes)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagneticStripeReaderCardTypes);

    state->type_MagneticStripeReaderEncryptionAlgorithms = py::register_python_type(module.get(), type_name_MagneticStripeReaderEncryptionAlgorithms, &type_spec_MagneticStripeReaderEncryptionAlgorithms, nullptr);
    if (!state->type_MagneticStripeReaderEncryptionAlgorithms)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagneticStripeReaderEncryptionAlgorithms);

    state->type_MagneticStripeReaderErrorOccurredEventArgs = py::register_python_type(module.get(), type_name_MagneticStripeReaderErrorOccurredEventArgs, &type_spec_MagneticStripeReaderErrorOccurredEventArgs, bases.get());
    if (!state->type_MagneticStripeReaderErrorOccurredEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagneticStripeReaderErrorOccurredEventArgs);

    state->type_MagneticStripeReaderReport = py::register_python_type(module.get(), type_name_MagneticStripeReaderReport, &type_spec_MagneticStripeReaderReport, bases.get());
    if (!state->type_MagneticStripeReaderReport)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagneticStripeReaderReport);

    state->type_MagneticStripeReaderStatusUpdatedEventArgs = py::register_python_type(module.get(), type_name_MagneticStripeReaderStatusUpdatedEventArgs, &type_spec_MagneticStripeReaderStatusUpdatedEventArgs, bases.get());
    if (!state->type_MagneticStripeReaderStatusUpdatedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagneticStripeReaderStatusUpdatedEventArgs);

    state->type_MagneticStripeReaderTrackData = py::register_python_type(module.get(), type_name_MagneticStripeReaderTrackData, &type_spec_MagneticStripeReaderTrackData, bases.get());
    if (!state->type_MagneticStripeReaderTrackData)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagneticStripeReaderTrackData);

    state->type_MagneticStripeReaderVendorSpecificCardDataReceivedEventArgs = py::register_python_type(module.get(), type_name_MagneticStripeReaderVendorSpecificCardDataReceivedEventArgs, &type_spec_MagneticStripeReaderVendorSpecificCardDataReceivedEventArgs, bases.get());
    if (!state->type_MagneticStripeReaderVendorSpecificCardDataReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagneticStripeReaderVendorSpecificCardDataReceivedEventArgs);

    state->type_PosPrinter = py::register_python_type(module.get(), type_name_PosPrinter, &type_spec_PosPrinter, bases.get());
    if (!state->type_PosPrinter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PosPrinter);

    state->type_PosPrinterCapabilities = py::register_python_type(module.get(), type_name_PosPrinterCapabilities, &type_spec_PosPrinterCapabilities, bases.get());
    if (!state->type_PosPrinterCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PosPrinterCapabilities);

    state->type_PosPrinterCharacterSetIds = py::register_python_type(module.get(), type_name_PosPrinterCharacterSetIds, &type_spec_PosPrinterCharacterSetIds, nullptr);
    if (!state->type_PosPrinterCharacterSetIds)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PosPrinterCharacterSetIds);

    state->type_PosPrinterFontProperty = py::register_python_type(module.get(), type_name_PosPrinterFontProperty, &type_spec_PosPrinterFontProperty, bases.get());
    if (!state->type_PosPrinterFontProperty)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PosPrinterFontProperty);

    state->type_PosPrinterPrintOptions = py::register_python_type(module.get(), type_name_PosPrinterPrintOptions, &type_spec_PosPrinterPrintOptions, bases.get());
    if (!state->type_PosPrinterPrintOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PosPrinterPrintOptions);

    state->type_PosPrinterReleaseDeviceRequestedEventArgs = py::register_python_type(module.get(), type_name_PosPrinterReleaseDeviceRequestedEventArgs, &type_spec_PosPrinterReleaseDeviceRequestedEventArgs, bases.get());
    if (!state->type_PosPrinterReleaseDeviceRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PosPrinterReleaseDeviceRequestedEventArgs);

    state->type_PosPrinterStatus = py::register_python_type(module.get(), type_name_PosPrinterStatus, &type_spec_PosPrinterStatus, bases.get());
    if (!state->type_PosPrinterStatus)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PosPrinterStatus);

    state->type_PosPrinterStatusUpdatedEventArgs = py::register_python_type(module.get(), type_name_PosPrinterStatusUpdatedEventArgs, &type_spec_PosPrinterStatusUpdatedEventArgs, bases.get());
    if (!state->type_PosPrinterStatusUpdatedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PosPrinterStatusUpdatedEventArgs);

    state->type_ReceiptPrintJob = py::register_python_type(module.get(), type_name_ReceiptPrintJob, &type_spec_ReceiptPrintJob, bases.get());
    if (!state->type_ReceiptPrintJob)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ReceiptPrintJob);

    state->type_ReceiptPrinterCapabilities = py::register_python_type(module.get(), type_name_ReceiptPrinterCapabilities, &type_spec_ReceiptPrinterCapabilities, bases.get());
    if (!state->type_ReceiptPrinterCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ReceiptPrinterCapabilities);

    state->type_SlipPrintJob = py::register_python_type(module.get(), type_name_SlipPrintJob, &type_spec_SlipPrintJob, bases.get());
    if (!state->type_SlipPrintJob)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SlipPrintJob);

    state->type_SlipPrinterCapabilities = py::register_python_type(module.get(), type_name_SlipPrinterCapabilities, &type_spec_SlipPrinterCapabilities, bases.get());
    if (!state->type_SlipPrinterCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SlipPrinterCapabilities);

    state->type_UnifiedPosErrorData = py::register_python_type(module.get(), type_name_UnifiedPosErrorData, &type_spec_UnifiedPosErrorData, bases.get());
    if (!state->type_UnifiedPosErrorData)
    {
        return nullptr;
    }

    Py_INCREF(state->type_UnifiedPosErrorData);

    state->type_ICashDrawerEventSourceEventArgs = py::register_python_type(module.get(), type_name_ICashDrawerEventSourceEventArgs, &type_spec_ICashDrawerEventSourceEventArgs, bases.get());
    if (!state->type_ICashDrawerEventSourceEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICashDrawerEventSourceEventArgs);

    state->type_ICommonClaimedPosPrinterStation = py::register_python_type(module.get(), type_name_ICommonClaimedPosPrinterStation, &type_spec_ICommonClaimedPosPrinterStation, bases.get());
    if (!state->type_ICommonClaimedPosPrinterStation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICommonClaimedPosPrinterStation);

    state->type_ICommonPosPrintStationCapabilities = py::register_python_type(module.get(), type_name_ICommonPosPrintStationCapabilities, &type_spec_ICommonPosPrintStationCapabilities, bases.get());
    if (!state->type_ICommonPosPrintStationCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICommonPosPrintStationCapabilities);

    state->type_ICommonReceiptSlipCapabilities = py::register_python_type(module.get(), type_name_ICommonReceiptSlipCapabilities, &type_spec_ICommonReceiptSlipCapabilities, bases.get());
    if (!state->type_ICommonReceiptSlipCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICommonReceiptSlipCapabilities);

    state->type_IPosPrinterJob = py::register_python_type(module.get(), type_name_IPosPrinterJob, &type_spec_IPosPrinterJob, bases.get());
    if (!state->type_IPosPrinterJob)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IPosPrinterJob);

    state->type_IReceiptOrSlipJob = py::register_python_type(module.get(), type_name_IReceiptOrSlipJob, &type_spec_IReceiptOrSlipJob, bases.get());
    if (!state->type_IReceiptOrSlipJob)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IReceiptOrSlipJob);

    state->type_SizeUInt32 = py::register_python_type(module.get(), type_name_SizeUInt32, &type_spec_SizeUInt32, bases.get());
    if (!state->type_SizeUInt32)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SizeUInt32);
