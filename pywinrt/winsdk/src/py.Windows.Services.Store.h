...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Store::StoreCanLicenseStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Store::StoreConsumableStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Store::StoreDurationUnit> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Store::StorePackageUpdateState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Store::StorePurchaseStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Store::StoreQueueItemExtendedState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Store::StoreQueueItemKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Store::StoreQueueItemState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Store::StoreRateAndReviewStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Store::StoreUninstallStorePackageStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Store::StorePackageUpdateStatus> = "T{P:package_family_name:Q:package_download_size_in_bytes:Q:package_bytes_downloaded:d:package_download_progress:d:total_download_progress:i:package_update_state:}";
