...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Payments::PaymentCanMakePaymentResultStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Payments::PaymentOptionPresence> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Payments::PaymentRequestChangeKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Payments::PaymentRequestCompletionStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Payments::PaymentRequestStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Payments::PaymentShippingType> = "i";
