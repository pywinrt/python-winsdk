...
namespace py::cpp::Windows::Web::Http::Headers
{
    ...
    static PyGetSetDef _getset_HttpRequestHeaderCollection[] = {
        ...
        { "from", reinterpret_cast<getter>(HttpRequestHeaderCollection_get_From), reinterpret_cast<setter>(HttpRequestHeaderCollection_put_From), nullptr, nullptr },
...
PyMODINIT_FUNC
PyInit__winsdk_Windows_Web_Http_Headers (void) noexcept
{
