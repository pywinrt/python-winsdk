...
namespace py::cpp::Windows::Web::Http::Headers
{
    ...
    static PyType_Slot _type_slots_HttpCacheDirectiveHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpCacheDirectiveHeaderValueCollection },
    ...
    static PyType_Slot _type_slots_HttpChallengeHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpChallengeHeaderValueCollection },
    ...
    static PyType_Slot _type_slots_HttpConnectionOptionHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpConnectionOptionHeaderValueCollection },
    ...
    static PyType_Slot _type_slots_HttpContentCodingHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpContentCodingHeaderValueCollection },
    ...
    static PyType_Slot _type_slots_HttpContentCodingWithQualityHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpContentCodingWithQualityHeaderValueCollection },
    ...
    static PyType_Slot _type_slots_HttpCookiePairHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpCookiePairHeaderValueCollection },
    ...
    static PyType_Slot _type_slots_HttpExpectationHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpExpectationHeaderValueCollection },
    ...
    static PyType_Slot _type_slots_HttpLanguageHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpLanguageHeaderValueCollection },
    ...
    static PyType_Slot _type_slots_HttpLanguageRangeWithQualityHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpLanguageRangeWithQualityHeaderValueCollection },
    ...
    static PyType_Slot _type_slots_HttpMediaTypeWithQualityHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpMediaTypeWithQualityHeaderValueCollection },
    ...
    static PyType_Slot _type_slots_HttpMethodHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpMethodHeaderValueCollection },
    ...
    static PyType_Slot _type_slots_HttpProductInfoHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpProductInfoHeaderValueCollection },
    ...
    static PyType_Slot _type_slots_HttpTransferCodingHeaderValueCollection[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_HttpTransferCodingHeaderValueCollection },
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Web_Http_Headers(void) noexcept
{
    ...
    state->type_HttpCacheDirectiveHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpCacheDirectiveHeaderValueCollection, &type_spec_HttpCacheDirectiveHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
    if (!state->type_HttpCacheDirectiveHeaderValueCollection)
    {
        return nullptr;
    }

    state->type_HttpChallengeHeaderValue = py::register_python_type(module.get(), type_name_HttpChallengeHeaderValue, &type_spec_HttpChallengeHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpChallengeHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpChallengeHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpChallengeHeaderValueCollection, &type_spec_HttpChallengeHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
    if (!state->type_HttpChallengeHeaderValueCollection)
    {
        return nullptr;
    }

    state->type_HttpConnectionOptionHeaderValue = py::register_python_type(module.get(), type_name_HttpConnectionOptionHeaderValue, &type_spec_HttpConnectionOptionHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpConnectionOptionHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpConnectionOptionHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpConnectionOptionHeaderValueCollection, &type_spec_HttpConnectionOptionHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
    if (!state->type_HttpConnectionOptionHeaderValueCollection)
    {
        return nullptr;
    }

    state->type_HttpContentCodingHeaderValue = py::register_python_type(module.get(), type_name_HttpContentCodingHeaderValue, &type_spec_HttpContentCodingHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpContentCodingHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpContentCodingHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpContentCodingHeaderValueCollection, &type_spec_HttpContentCodingHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
    if (!state->type_HttpContentCodingHeaderValueCollection)
    {
        return nullptr;
    }

    state->type_HttpContentCodingWithQualityHeaderValue = py::register_python_type(module.get(), type_name_HttpContentCodingWithQualityHeaderValue, &type_spec_HttpContentCodingWithQualityHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpContentCodingWithQualityHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpContentCodingWithQualityHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpContentCodingWithQualityHeaderValueCollection, &type_spec_HttpContentCodingWithQualityHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
    if (!state->type_HttpContentCodingWithQualityHeaderValueCollection)
    {
        return nullptr;
    }

    state->type_HttpContentDispositionHeaderValue = py::register_python_type(module.get(), type_name_HttpContentDispositionHeaderValue, &type_spec_HttpContentDispositionHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpContentDispositionHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpContentHeaderCollection = py::register_python_type(module.get(), type_name_HttpContentHeaderCollection, &type_spec_HttpContentHeaderCollection, mutable_mapping_bases.get(), nullptr);
    if (!state->type_HttpContentHeaderCollection)
    {
        return nullptr;
    }

    state->type_HttpContentRangeHeaderValue = py::register_python_type(module.get(), type_name_HttpContentRangeHeaderValue, &type_spec_HttpContentRangeHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpContentRangeHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpCookiePairHeaderValue = py::register_python_type(module.get(), type_name_HttpCookiePairHeaderValue, &type_spec_HttpCookiePairHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpCookiePairHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpCookiePairHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpCookiePairHeaderValueCollection, &type_spec_HttpCookiePairHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
    if (!state->type_HttpCookiePairHeaderValueCollection)
    {
        return nullptr;
    }

    state->type_HttpCredentialsHeaderValue = py::register_python_type(module.get(), type_name_HttpCredentialsHeaderValue, &type_spec_HttpCredentialsHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpCredentialsHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpDateOrDeltaHeaderValue = py::register_python_type(module.get(), type_name_HttpDateOrDeltaHeaderValue, &type_spec_HttpDateOrDeltaHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpDateOrDeltaHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpExpectationHeaderValue = py::register_python_type(module.get(), type_name_HttpExpectationHeaderValue, &type_spec_HttpExpectationHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpExpectationHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpExpectationHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpExpectationHeaderValueCollection, &type_spec_HttpExpectationHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
    if (!state->type_HttpExpectationHeaderValueCollection)
    {
        return nullptr;
    }

    state->type_HttpLanguageHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpLanguageHeaderValueCollection, &type_spec_HttpLanguageHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
    if (!state->type_HttpLanguageHeaderValueCollection)
    {
        return nullptr;
    }

    state->type_HttpLanguageRangeWithQualityHeaderValue = py::register_python_type(module.get(), type_name_HttpLanguageRangeWithQualityHeaderValue, &type_spec_HttpLanguageRangeWithQualityHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpLanguageRangeWithQualityHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpLanguageRangeWithQualityHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpLanguageRangeWithQualityHeaderValueCollection, &type_spec_HttpLanguageRangeWithQualityHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
    if (!state->type_HttpLanguageRangeWithQualityHeaderValueCollection)
    {
        return nullptr;
    }

    state->type_HttpMediaTypeHeaderValue = py::register_python_type(module.get(), type_name_HttpMediaTypeHeaderValue, &type_spec_HttpMediaTypeHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpMediaTypeHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpMediaTypeWithQualityHeaderValue = py::register_python_type(module.get(), type_name_HttpMediaTypeWithQualityHeaderValue, &type_spec_HttpMediaTypeWithQualityHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpMediaTypeWithQualityHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpMediaTypeWithQualityHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpMediaTypeWithQualityHeaderValueCollection, &type_spec_HttpMediaTypeWithQualityHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
    if (!state->type_HttpMediaTypeWithQualityHeaderValueCollection)
    {
        return nullptr;
    }

    state->type_HttpMethodHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpMethodHeaderValueCollection, &type_spec_HttpMethodHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
    if (!state->type_HttpMethodHeaderValueCollection)
    {
        return nullptr;
    }

    state->type_HttpNameValueHeaderValue = py::register_python_type(module.get(), type_name_HttpNameValueHeaderValue, &type_spec_HttpNameValueHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpNameValueHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpProductHeaderValue = py::register_python_type(module.get(), type_name_HttpProductHeaderValue, &type_spec_HttpProductHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpProductHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpProductInfoHeaderValue = py::register_python_type(module.get(), type_name_HttpProductInfoHeaderValue, &type_spec_HttpProductInfoHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpProductInfoHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpProductInfoHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpProductInfoHeaderValueCollection, &type_spec_HttpProductInfoHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
    if (!state->type_HttpProductInfoHeaderValueCollection)
    {
        return nullptr;
    }

    state->type_HttpRequestHeaderCollection = py::register_python_type(module.get(), type_name_HttpRequestHeaderCollection, &type_spec_HttpRequestHeaderCollection, mutable_mapping_bases.get(), nullptr);
    if (!state->type_HttpRequestHeaderCollection)
    {
        return nullptr;
    }

    state->type_HttpResponseHeaderCollection = py::register_python_type(module.get(), type_name_HttpResponseHeaderCollection, &type_spec_HttpResponseHeaderCollection, mutable_mapping_bases.get(), nullptr);
    if (!state->type_HttpResponseHeaderCollection)
    {
        return nullptr;
    }

    state->type_HttpTransferCodingHeaderValue = py::register_python_type(module.get(), type_name_HttpTransferCodingHeaderValue, &type_spec_HttpTransferCodingHeaderValue, bases.get(), nullptr);
    if (!state->type_HttpTransferCodingHeaderValue)
    {
        return nullptr;
    }

    state->type_HttpTransferCodingHeaderValueCollection = py::register_python_type(module.get(), type_name_HttpTransferCodingHeaderValueCollection, &type_spec_HttpTransferCodingHeaderValueCollection, mutable_sequence_bases.get(), nullptr);
