...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::AI::MachineLearning::LearningModelDeviceKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::AI::MachineLearning::LearningModelFeatureKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::AI::MachineLearning::LearningModelPixelRange> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::AI::MachineLearning::TensorKind> = "i";
