...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Perception::PerceptionFrameSourceAccessStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Perception::PerceptionFrameSourcePropertyChangeStatus> = "i";
