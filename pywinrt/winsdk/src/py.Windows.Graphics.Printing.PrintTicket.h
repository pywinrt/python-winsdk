...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintTicket::PrintTicketFeatureSelectionType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintTicket::PrintTicketParameterDataType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintTicket::PrintTicketValueType> = "i";
