...
namespace py::cpp::Windows::ApplicationModel::DataTransfer::DragDrop::Core
{
    ...
    static PyObject* register_CoreDragUIContentMode(PyObject* module, PyObject* type)
    {
    ...
    constexpr const char* const type_name_CoreDragDropManager = "CoreDragDropManager";
    ...
    // ----- CoreDragInfo class --------------------
    constexpr const char* const type_name_CoreDragInfo = "CoreDragInfo";
    ...
    constexpr const char* const type_name_CoreDragOperation = "CoreDragOperation";
    ...
    constexpr const char* const type_name_CoreDragUIOverride = "CoreDragUIOverride";
    ...
    constexpr const char* const type_name_CoreDropOperationTargetRequestedEventArgs = "CoreDropOperationTargetRequestedEventArgs";
    ...
    constexpr const char* const type_name_ICoreDropOperationTarget = "ICoreDropOperationTarget";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_DataTransfer_DragDrop_Core(void) noexcept
{
    ...
    state->type_CoreDragDropManager = py::register_python_type(module.get(), type_name_CoreDragDropManager, &type_spec_CoreDragDropManager, bases.get());
    if (!state->type_CoreDragDropManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreDragDropManager);

    state->type_CoreDragInfo = py::register_python_type(module.get(), type_name_CoreDragInfo, &type_spec_CoreDragInfo, bases.get());
    if (!state->type_CoreDragInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreDragInfo);

    state->type_CoreDragOperation = py::register_python_type(module.get(), type_name_CoreDragOperation, &type_spec_CoreDragOperation, bases.get());
    if (!state->type_CoreDragOperation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreDragOperation);

    state->type_CoreDragUIOverride = py::register_python_type(module.get(), type_name_CoreDragUIOverride, &type_spec_CoreDragUIOverride, bases.get());
    if (!state->type_CoreDragUIOverride)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreDragUIOverride);

    state->type_CoreDropOperationTargetRequestedEventArgs = py::register_python_type(module.get(), type_name_CoreDropOperationTargetRequestedEventArgs, &type_spec_CoreDropOperationTargetRequestedEventArgs, bases.get());
    if (!state->type_CoreDropOperationTargetRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreDropOperationTargetRequestedEventArgs);

    state->type_ICoreDropOperationTarget = py::register_python_type(module.get(), type_name_ICoreDropOperationTarget, &type_spec_ICoreDropOperationTarget, bases.get());
    if (!state->type_ICoreDropOperationTarget)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICoreDropOperationTarget);
