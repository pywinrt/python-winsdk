...
winrt::Windows::ApplicationModel::Resources::Core::ResourceLayoutInfo py::converter<winrt::Windows::ApplicationModel::Resources::Core::ResourceLayoutInfo>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::ApplicationModel::Resources::Core::ResourceLayoutInfo or dict");
    ...
    if (!py_MajorVersion) {
        PyErr_SetString(PyExc_KeyError, "MajorVersion");
        throw python_exception();
    }
    ...
    if (!py_MinorVersion) {
        PyErr_SetString(PyExc_KeyError, "MinorVersion");
        throw python_exception();
    }
    ...
    if (!py_ResourceSubtreeCount) {
        PyErr_SetString(PyExc_KeyError, "ResourceSubtreeCount");
        throw python_exception();
    }
    ...
    if (!py_NamedResourceCount) {
        PyErr_SetString(PyExc_KeyError, "NamedResourceCount");
        throw python_exception();
    }
    ...
    if (!py_Checksum) {
        PyErr_SetString(PyExc_KeyError, "Checksum");
        throw python_exception();
    }
