...
namespace py::cpp::Windows::UI::ApplicationSettings
{
    ...
    static PyObject* register_WebAccountAction(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_AccountsSettingsPane = "AccountsSettingsPane";
    ...
    constexpr const char* const type_name_AccountsSettingsPaneCommandsRequestedEventArgs = "AccountsSettingsPaneCommandsRequestedEventArgs";
    ...
    constexpr const char* const type_name_AccountsSettingsPaneEventDeferral = "AccountsSettingsPaneEventDeferral";
    ...
    constexpr const char* const type_name_CredentialCommand = "CredentialCommand";
    ...
    constexpr const char* const type_name_SettingsCommand = "SettingsCommand";
    ...
    constexpr const char* const type_name_WebAccountInvokedArgs = "WebAccountInvokedArgs";
    ...
    constexpr const char* const type_name_WebAccountProviderCommand = "WebAccountProviderCommand";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_ApplicationSettings(void) noexcept
{
    ...
    state->type_AccountsSettingsPane = py::register_python_type(module.get(), type_name_AccountsSettingsPane, &type_spec_AccountsSettingsPane, bases.get());
    if (!state->type_AccountsSettingsPane)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AccountsSettingsPane);

    state->type_AccountsSettingsPaneCommandsRequestedEventArgs = py::register_python_type(module.get(), type_name_AccountsSettingsPaneCommandsRequestedEventArgs, &type_spec_AccountsSettingsPaneCommandsRequestedEventArgs, bases.get());
    if (!state->type_AccountsSettingsPaneCommandsRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AccountsSettingsPaneCommandsRequestedEventArgs);

    state->type_AccountsSettingsPaneEventDeferral = py::register_python_type(module.get(), type_name_AccountsSettingsPaneEventDeferral, &type_spec_AccountsSettingsPaneEventDeferral, bases.get());
    if (!state->type_AccountsSettingsPaneEventDeferral)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AccountsSettingsPaneEventDeferral);

    state->type_CredentialCommand = py::register_python_type(module.get(), type_name_CredentialCommand, &type_spec_CredentialCommand, bases.get());
    if (!state->type_CredentialCommand)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CredentialCommand);

    state->type_SettingsCommand = py::register_python_type(module.get(), type_name_SettingsCommand, &type_spec_SettingsCommand, bases.get());
    ...
    Py_INCREF(state->type_WebAccountCommand);

    state->type_WebAccountInvokedArgs = py::register_python_type(module.get(), type_name_WebAccountInvokedArgs, &type_spec_WebAccountInvokedArgs, bases.get());
    if (!state->type_WebAccountInvokedArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WebAccountInvokedArgs);

    state->type_WebAccountProviderCommand = py::register_python_type(module.get(), type_name_WebAccountProviderCommand, &type_spec_WebAccountProviderCommand, bases.get());
    if (!state->type_WebAccountProviderCommand)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WebAccountProviderCommand);
