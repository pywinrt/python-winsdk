...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::GraphicsTrustStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::HdcpProtection> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::HdcpSetProtectionResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::ProtectionCapabilityResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::RenewalStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::RevocationAndRenewalReasons> = "I";
