...
namespace py::cpp::Windows::ApplicationModel::VoiceCommands
{
    ...
    static PyType_Slot type_slots_VoiceCommandDefinitionManager_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_VoiceCommandDefinitionManager_Meta },
        { }
    };

    static PyType_Spec type_spec_VoiceCommandDefinitionManager_Meta =
    {
        "_winsdk_Windows_ApplicationModel_VoiceCommands.VoiceCommandDefinitionManager_Meta",
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_VoiceCommandResponse_Meta },
        { }
    };

    static PyType_Spec type_spec_VoiceCommandResponse_Meta =
    {
        "_winsdk_Windows_ApplicationModel_VoiceCommands.VoiceCommandResponse_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_VoiceCommands(void) noexcept
{
    ...
    state->type_VoiceCommand = py::register_python_type(module.get(), type_name_VoiceCommand, &type_spec_VoiceCommand, bases.get(), nullptr);
    if (!state->type_VoiceCommand)
    {
        return nullptr;
    }

    state->type_VoiceCommandCompletedEventArgs = py::register_python_type(module.get(), type_name_VoiceCommandCompletedEventArgs, &type_spec_VoiceCommandCompletedEventArgs, bases.get(), nullptr);
    if (!state->type_VoiceCommandCompletedEventArgs)
    {
        return nullptr;
    }

    state->type_VoiceCommandConfirmationResult = py::register_python_type(module.get(), type_name_VoiceCommandConfirmationResult, &type_spec_VoiceCommandConfirmationResult, bases.get(), nullptr);
    if (!state->type_VoiceCommandConfirmationResult)
    {
        return nullptr;
    }

    state->type_VoiceCommandContentTile = py::register_python_type(module.get(), type_name_VoiceCommandContentTile, &type_spec_VoiceCommandContentTile, bases.get(), nullptr);
    if (!state->type_VoiceCommandContentTile)
    {
        return nullptr;
    }

    state->type_VoiceCommandDefinition = py::register_python_type(module.get(), type_name_VoiceCommandDefinition, &type_spec_VoiceCommandDefinition, bases.get(), nullptr);
    ...
    state->type_VoiceCommandDefinitionManager = py::register_python_type(module.get(), type_name_VoiceCommandDefinitionManager, &type_spec_VoiceCommandDefinitionManager, nullptr, reinterpret_cast<PyTypeObject*>(type_VoiceCommandDefinitionManager_Meta.get()));
    if (!state->type_VoiceCommandDefinitionManager)
    {
        return nullptr;
    }

    state->type_VoiceCommandDisambiguationResult = py::register_python_type(module.get(), type_name_VoiceCommandDisambiguationResult, &type_spec_VoiceCommandDisambiguationResult, bases.get(), nullptr);
    ...
    state->type_VoiceCommandResponse = py::register_python_type(module.get(), type_name_VoiceCommandResponse, &type_spec_VoiceCommandResponse, bases.get(), reinterpret_cast<PyTypeObject*>(type_VoiceCommandResponse_Meta.get()));
    if (!state->type_VoiceCommandResponse)
    {
        return nullptr;
    }

    state->type_VoiceCommandServiceConnection = py::register_python_type(module.get(), type_name_VoiceCommandServiceConnection, &type_spec_VoiceCommandServiceConnection, bases.get(), nullptr);
    if (!state->type_VoiceCommandServiceConnection)
    {
        return nullptr;
    }

    state->type_VoiceCommandUserMessage = py::register_python_type(module.get(), type_name_VoiceCommandUserMessage, &type_spec_VoiceCommandUserMessage, bases.get(), nullptr);
