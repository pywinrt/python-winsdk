...
namespace py::cpp::Windows::UI::Input::Preview::Injection
{
    ...
    static PyObject* register_InjectedInputButtonChangeKind(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_InjectedInputKeyOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InjectedInputMouseOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InjectedInputPenButtons(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InjectedInputPenParameters(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InjectedInputPointerOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InjectedInputShortcut(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InjectedInputTouchParameters(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InjectedInputVisualizationMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_InjectedInputGamepadInfo = "InjectedInputGamepadInfo";
    ...
    constexpr const char* const type_name_InjectedInputKeyboardInfo = "InjectedInputKeyboardInfo";
    ...
    constexpr const char* const type_name_InjectedInputMouseInfo = "InjectedInputMouseInfo";
    ...
    constexpr const char* const type_name_InjectedInputPenInfo = "InjectedInputPenInfo";
    ...
    constexpr const char* const type_name_InjectedInputTouchInfo = "InjectedInputTouchInfo";
    ...
    // ----- InputInjector class --------------------
    constexpr const char* const type_name_InputInjector = "InputInjector";
    ...
    constexpr const char* const type_name_InjectedInputPoint = "InjectedInputPoint";
    ...
    constexpr const char* const type_name_InjectedInputPointerInfo = "InjectedInputPointerInfo";
    ...
    constexpr const char* const type_name_InjectedInputRectangle = "InjectedInputRectangle";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_Input_Preview_Injection(void) noexcept
{
    ...
    state->type_InjectedInputGamepadInfo = py::register_python_type(module.get(), type_name_InjectedInputGamepadInfo, &type_spec_InjectedInputGamepadInfo, bases.get());
    if (!state->type_InjectedInputGamepadInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InjectedInputGamepadInfo);

    state->type_InjectedInputKeyboardInfo = py::register_python_type(module.get(), type_name_InjectedInputKeyboardInfo, &type_spec_InjectedInputKeyboardInfo, bases.get());
    if (!state->type_InjectedInputKeyboardInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InjectedInputKeyboardInfo);

    state->type_InjectedInputMouseInfo = py::register_python_type(module.get(), type_name_InjectedInputMouseInfo, &type_spec_InjectedInputMouseInfo, bases.get());
    if (!state->type_InjectedInputMouseInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InjectedInputMouseInfo);

    state->type_InjectedInputPenInfo = py::register_python_type(module.get(), type_name_InjectedInputPenInfo, &type_spec_InjectedInputPenInfo, bases.get());
    if (!state->type_InjectedInputPenInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InjectedInputPenInfo);

    state->type_InjectedInputTouchInfo = py::register_python_type(module.get(), type_name_InjectedInputTouchInfo, &type_spec_InjectedInputTouchInfo, bases.get());
    if (!state->type_InjectedInputTouchInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InjectedInputTouchInfo);

    state->type_InputInjector = py::register_python_type(module.get(), type_name_InputInjector, &type_spec_InputInjector, bases.get());
    if (!state->type_InputInjector)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InputInjector);

    state->type_InjectedInputPoint = py::register_python_type(module.get(), type_name_InjectedInputPoint, &type_spec_InjectedInputPoint, bases.get());
    if (!state->type_InjectedInputPoint)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InjectedInputPoint);

    state->type_InjectedInputPointerInfo = py::register_python_type(module.get(), type_name_InjectedInputPointerInfo, &type_spec_InjectedInputPointerInfo, bases.get());
    if (!state->type_InjectedInputPointerInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InjectedInputPointerInfo);

    state->type_InjectedInputRectangle = py::register_python_type(module.get(), type_name_InjectedInputRectangle, &type_spec_InjectedInputRectangle, bases.get());
    if (!state->type_InjectedInputRectangle)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InjectedInputRectangle);
