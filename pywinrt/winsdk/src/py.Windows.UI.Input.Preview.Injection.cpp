...
winrt::Windows::UI::Input::Preview::Injection::InjectedInputPoint py::converter<winrt::Windows::UI::Input::Preview::Injection::InjectedInputPoint>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Input::Preview::Injection::InjectedInputPoint or dict");
    ...
    if (!py_PositionX) {
        PyErr_SetString(PyExc_KeyError, "PositionX");
        throw python_exception();
    }
    ...
    if (!py_PositionY) {
        PyErr_SetString(PyExc_KeyError, "PositionY");
        throw python_exception();
    }
...
winrt::Windows::UI::Input::Preview::Injection::InjectedInputPointerInfo py::converter<winrt::Windows::UI::Input::Preview::Injection::InjectedInputPointerInfo>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Input::Preview::Injection::InjectedInputPointerInfo or dict");
        throw python_exception();
    }
    ...
    if (!py_PointerId) {
        PyErr_SetString(PyExc_KeyError, "PointerId");
        throw python_exception();
    }
    ...
    if (!py_PointerOptions) {
        PyErr_SetString(PyExc_KeyError, "PointerOptions");
        throw python_exception();
    }
    ...
    if (!py_PixelLocation) {
        PyErr_SetString(PyExc_KeyError, "PixelLocation");
        throw python_exception();
    }
    ...
    if (!py_TimeOffsetInMilliseconds) {
        PyErr_SetString(PyExc_KeyError, "TimeOffsetInMilliseconds");
        throw python_exception();
    }
    ...
    if (!py_PerformanceCount) {
        PyErr_SetString(PyExc_KeyError, "PerformanceCount");
        throw python_exception();
    }
...
winrt::Windows::UI::Input::Preview::Injection::InjectedInputRectangle py::converter<winrt::Windows::UI::Input::Preview::Injection::InjectedInputRectangle>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Input::Preview::Injection::InjectedInputRectangle or dict");
        throw python_exception();
    }
