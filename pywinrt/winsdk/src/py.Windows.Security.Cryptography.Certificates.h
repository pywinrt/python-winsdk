...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Cryptography::Certificates::CertificateChainPolicy> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Cryptography::Certificates::ChainValidationResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Cryptography::Certificates::EnrollKeyUsages> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Cryptography::Certificates::ExportOption> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Cryptography::Certificates::InstallOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Cryptography::Certificates::KeyProtectionLevel> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Cryptography::Certificates::KeySize> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Cryptography::Certificates::SignatureValidationResult> = "i";
