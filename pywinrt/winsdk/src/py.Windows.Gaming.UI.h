...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::UI::GameChatMessageOrigin> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::UI::GameChatOverlayPosition> = "i";
