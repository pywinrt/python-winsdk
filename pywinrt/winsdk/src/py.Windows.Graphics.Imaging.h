...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::BitmapAlphaMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::BitmapBufferAccessMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::BitmapFlip> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::BitmapInterpolationMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::BitmapPixelFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::BitmapRotation> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::ColorManagementMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::ExifOrientationMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::JpegSubsamplingMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::PngFilterMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::TiffCompressionMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::BitmapBounds> = "T{I:x:I:y:I:width:I:height:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::BitmapPlaneDescription> = "T{i:start_index:i:width:i:height:i:stride:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Imaging::BitmapSize> = "T{I:width:I:height:}";
