...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Custom::DeviceAccessMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Custom::DeviceSharingMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Custom::IOControlAccessMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Custom::IOControlBufferingMethod> = "i";
