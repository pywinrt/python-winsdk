...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::SpeechRecognition::SpeechContinuousRecognitionMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::SpeechRecognition::SpeechRecognitionAudioProblem> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::SpeechRecognition::SpeechRecognitionConfidence> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::SpeechRecognition::SpeechRecognitionConstraintProbability> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::SpeechRecognition::SpeechRecognitionConstraintType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::SpeechRecognition::SpeechRecognitionResultStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::SpeechRecognition::SpeechRecognitionScenario> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::SpeechRecognition::SpeechRecognizerState> = "i";
