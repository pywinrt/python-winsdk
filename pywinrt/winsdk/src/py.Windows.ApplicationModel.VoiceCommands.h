...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::VoiceCommands::VoiceCommandCompletionReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::VoiceCommands::VoiceCommandContentTileType> = "i";
