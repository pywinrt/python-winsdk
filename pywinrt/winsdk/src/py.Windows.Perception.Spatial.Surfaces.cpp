...
namespace py::cpp::Windows::Perception::Spatial::Surfaces
{
    ...
    static PyType_Slot type_slots_SpatialSurfaceMeshOptions_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_SpatialSurfaceMeshOptions_Meta },
        { }
    };

    static PyType_Spec type_spec_SpatialSurfaceMeshOptions_Meta =
    {
        "_winsdk_Windows_Perception_Spatial_Surfaces.SpatialSurfaceMeshOptions_Meta",
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Perception_Spatial_Surfaces(void) noexcept
{
    ...
    state->type_SpatialSurfaceInfo = py::register_python_type(module.get(), type_name_SpatialSurfaceInfo, &type_spec_SpatialSurfaceInfo, bases.get(), nullptr);
    if (!state->type_SpatialSurfaceInfo)
    {
        return nullptr;
    }

    state->type_SpatialSurfaceMesh = py::register_python_type(module.get(), type_name_SpatialSurfaceMesh, &type_spec_SpatialSurfaceMesh, bases.get(), nullptr);
    if (!state->type_SpatialSurfaceMesh)
    {
        return nullptr;
    }

    state->type_SpatialSurfaceMeshBuffer = py::register_python_type(module.get(), type_name_SpatialSurfaceMeshBuffer, &type_spec_SpatialSurfaceMeshBuffer, bases.get(), nullptr);
    ...
    state->type_SpatialSurfaceMeshOptions = py::register_python_type(module.get(), type_name_SpatialSurfaceMeshOptions, &type_spec_SpatialSurfaceMeshOptions, bases.get(), reinterpret_cast<PyTypeObject*>(type_SpatialSurfaceMeshOptions_Meta.get()));
    if (!state->type_SpatialSurfaceMeshOptions)
    {
        return nullptr;
    }

    state->type_SpatialSurfaceObserver = py::register_python_type(module.get(), type_name_SpatialSurfaceObserver, &type_spec_SpatialSurfaceObserver, bases.get(), nullptr);
