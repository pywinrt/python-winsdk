...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Radios::RadioAccessStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Radios::RadioKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Radios::RadioState> = "i";
