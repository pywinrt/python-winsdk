...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Editing::MediaTrimmingPreference> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Editing::VideoFramePrecision> = "i";
