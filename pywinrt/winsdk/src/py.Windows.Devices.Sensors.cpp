...
namespace py::cpp::Windows::Devices::Sensors
{
    ...
    static PyObject* register_AccelerometerReadingType(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_ActivitySensorReadingConfidence(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ActivityType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_HumanEngagement(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_HumanPresence(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MagnetometerAccuracy(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PedometerStepKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SensorOptimizationGoal(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SensorReadingType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SensorType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SimpleOrientation(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    // ----- Accelerometer class --------------------
    constexpr const char* const type_name_Accelerometer = "Accelerometer";
    ...
    constexpr const char* const type_name_AccelerometerDataThreshold = "AccelerometerDataThreshold";
    ...
    constexpr const char* const type_name_AccelerometerReading = "AccelerometerReading";
    ...
    constexpr const char* const type_name_AccelerometerReadingChangedEventArgs = "AccelerometerReadingChangedEventArgs";
    ...
    constexpr const char* const type_name_AccelerometerShakenEventArgs = "AccelerometerShakenEventArgs";
    ...
    constexpr const char* const type_name_ActivitySensor = "ActivitySensor";
    ...
    constexpr const char* const type_name_ActivitySensorReading = "ActivitySensorReading";
    ...
    constexpr const char* const type_name_ActivitySensorReadingChangeReport = "ActivitySensorReadingChangeReport";
    ...
    constexpr const char* const type_name_ActivitySensorReadingChangedEventArgs = "ActivitySensorReadingChangedEventArgs";
    ...
    constexpr const char* const type_name_ActivitySensorTriggerDetails = "ActivitySensorTriggerDetails";
    ...
    // ----- Altimeter class --------------------
    constexpr const char* const type_name_Altimeter = "Altimeter";
    ...
    constexpr const char* const type_name_AltimeterReading = "AltimeterReading";
    ...
    constexpr const char* const type_name_AltimeterReadingChangedEventArgs = "AltimeterReadingChangedEventArgs";
    ...
    // ----- Barometer class --------------------
    constexpr const char* const type_name_Barometer = "Barometer";
    ...
    constexpr const char* const type_name_BarometerDataThreshold = "BarometerDataThreshold";
    ...
    constexpr const char* const type_name_BarometerReading = "BarometerReading";
    ...
    constexpr const char* const type_name_BarometerReadingChangedEventArgs = "BarometerReadingChangedEventArgs";
    ...
    // ----- Compass class --------------------
    constexpr const char* const type_name_Compass = "Compass";
    ...
    constexpr const char* const type_name_CompassDataThreshold = "CompassDataThreshold";
    ...
    constexpr const char* const type_name_CompassReading = "CompassReading";
    ...
    constexpr const char* const type_name_CompassReadingChangedEventArgs = "CompassReadingChangedEventArgs";
    ...
    // ----- Gyrometer class --------------------
    constexpr const char* const type_name_Gyrometer = "Gyrometer";
    ...
    constexpr const char* const type_name_GyrometerDataThreshold = "GyrometerDataThreshold";
    ...
    constexpr const char* const type_name_GyrometerReading = "GyrometerReading";
    ...
    constexpr const char* const type_name_GyrometerReadingChangedEventArgs = "GyrometerReadingChangedEventArgs";
    ...
    constexpr const char* const type_name_HingeAngleReading = "HingeAngleReading";
    ...
    constexpr const char* const type_name_HingeAngleSensor = "HingeAngleSensor";
    ...
    constexpr const char* const type_name_HingeAngleSensorReadingChangedEventArgs = "HingeAngleSensorReadingChangedEventArgs";
    ...
    constexpr const char* const type_name_HumanPresenceFeatures = "HumanPresenceFeatures";
    ...
    static void _dealloc_HumanPresenceFeatures(py::wrapper::Windows::Devices::Sensors::HumanPresenceFeatures* self)
    {
        auto tp = Py_TYPE(self);
        self->obj = nullptr;
        tp->tp_free(self);
    ...
    {
        { Py_tp_new, _new_HumanPresenceFeatures },
        { Py_tp_dealloc, _dealloc_HumanPresenceFeatures },
        { Py_tp_methods, _methods_HumanPresenceFeatures },
        { Py_tp_getset, _getset_HumanPresenceFeatures },
        { },
    };
    ...
    constexpr const char* const type_name_HumanPresenceSensor = "HumanPresenceSensor";
    ...
    static void _dealloc_HumanPresenceSensor(py::wrapper::Windows::Devices::Sensors::HumanPresenceSensor* self)
    {
        auto tp = Py_TYPE(self);
        self->obj = nullptr;
        tp->tp_free(self);
    ...
    {
        { Py_tp_new, _new_HumanPresenceSensor },
        { Py_tp_dealloc, _dealloc_HumanPresenceSensor },
        { Py_tp_methods, _methods_HumanPresenceSensor },
        { Py_tp_getset, _getset_HumanPresenceSensor },
        { },
    };
    ...
    constexpr const char* const type_name_HumanPresenceSensorReading = "HumanPresenceSensorReading";
    ...
    static void _dealloc_HumanPresenceSensorReading(py::wrapper::Windows::Devices::Sensors::HumanPresenceSensorReading* self)
    {
        auto tp = Py_TYPE(self);
        self->obj = nullptr;
        tp->tp_free(self);
    ...
    {
        { Py_tp_new, _new_HumanPresenceSensorReading },
        { Py_tp_dealloc, _dealloc_HumanPresenceSensorReading },
        { Py_tp_methods, _methods_HumanPresenceSensorReading },
        { Py_tp_getset, _getset_HumanPresenceSensorReading },
        { },
    };
    ...
    constexpr const char* const type_name_HumanPresenceSensorReadingChangedEventArgs = "HumanPresenceSensorReadingChangedEventArgs";
    ...
    static void _dealloc_HumanPresenceSensorReadingChangedEventArgs(py::wrapper::Windows::Devices::Sensors::HumanPresenceSensorReadingChangedEventArgs* self)
    {
        auto tp = Py_TYPE(self);
        self->obj = nullptr;
        tp->tp_free(self);
    ...
    {
        { Py_tp_new, _new_HumanPresenceSensorReadingChangedEventArgs },
        { Py_tp_dealloc, _dealloc_HumanPresenceSensorReadingChangedEventArgs },
        { Py_tp_methods, _methods_HumanPresenceSensorReadingChangedEventArgs },
        { Py_tp_getset, _getset_HumanPresenceSensorReadingChangedEventArgs },
        { },
    };
    ...
    constexpr const char* const type_name_HumanPresenceSettings = "HumanPresenceSettings";
    ...
    static void _dealloc_HumanPresenceSettings(py::wrapper::Windows::Devices::Sensors::HumanPresenceSettings* self)
    {
        auto tp = Py_TYPE(self);
        self->obj = nullptr;
        tp->tp_free(self);
    ...
    {
        { Py_tp_new, _new_HumanPresenceSettings },
        { Py_tp_dealloc, _dealloc_HumanPresenceSettings },
        { Py_tp_methods, _methods_HumanPresenceSettings },
        { Py_tp_getset, _getset_HumanPresenceSettings },
        { },
    };
    ...
    // ----- Inclinometer class --------------------
    constexpr const char* const type_name_Inclinometer = "Inclinometer";
    ...
    constexpr const char* const type_name_InclinometerDataThreshold = "InclinometerDataThreshold";
    ...
    constexpr const char* const type_name_InclinometerReading = "InclinometerReading";
    ...
    constexpr const char* const type_name_InclinometerReadingChangedEventArgs = "InclinometerReadingChangedEventArgs";
    ...
    // ----- LightSensor class --------------------
    constexpr const char* const type_name_LightSensor = "LightSensor";
    ...
    constexpr const char* const type_name_LightSensorDataThreshold = "LightSensorDataThreshold";
    ...
    constexpr const char* const type_name_LightSensorReading = "LightSensorReading";
    ...
    constexpr const char* const type_name_LightSensorReadingChangedEventArgs = "LightSensorReadingChangedEventArgs";
    ...
    // ----- Magnetometer class --------------------
    constexpr const char* const type_name_Magnetometer = "Magnetometer";
    ...
    constexpr const char* const type_name_MagnetometerDataThreshold = "MagnetometerDataThreshold";
    ...
    constexpr const char* const type_name_MagnetometerReading = "MagnetometerReading";
    ...
    constexpr const char* const type_name_MagnetometerReadingChangedEventArgs = "MagnetometerReadingChangedEventArgs";
    ...
    constexpr const char* const type_name_OrientationSensor = "OrientationSensor";
    ...
    constexpr const char* const type_name_OrientationSensorReading = "OrientationSensorReading";
    ...
    constexpr const char* const type_name_OrientationSensorReadingChangedEventArgs = "OrientationSensorReadingChangedEventArgs";
    ...
    // ----- Pedometer class --------------------
    constexpr const char* const type_name_Pedometer = "Pedometer";
    ...
    constexpr const char* const type_name_PedometerDataThreshold = "PedometerDataThreshold";
    ...
    constexpr const char* const type_name_PedometerReading = "PedometerReading";
    ...
    constexpr const char* const type_name_PedometerReadingChangedEventArgs = "PedometerReadingChangedEventArgs";
    ...
    constexpr const char* const type_name_ProximitySensor = "ProximitySensor";
    ...
    constexpr const char* const type_name_ProximitySensorDataThreshold = "ProximitySensorDataThreshold";
    ...
    constexpr const char* const type_name_ProximitySensorDisplayOnOffController = "ProximitySensorDisplayOnOffController";
    ...
    constexpr const char* const type_name_ProximitySensorReading = "ProximitySensorReading";
    ...
    constexpr const char* const type_name_ProximitySensorReadingChangedEventArgs = "ProximitySensorReadingChangedEventArgs";
    ...
    constexpr const char* const type_name_SensorDataThresholdTriggerDetails = "SensorDataThresholdTriggerDetails";
    ...
    constexpr const char* const type_name_SensorQuaternion = "SensorQuaternion";
    ...
    constexpr const char* const type_name_SensorRotationMatrix = "SensorRotationMatrix";
    ...
    constexpr const char* const type_name_SimpleOrientationSensor = "SimpleOrientationSensor";
    ...
    constexpr const char* const type_name_SimpleOrientationSensorOrientationChangedEventArgs = "SimpleOrientationSensorOrientationChangedEventArgs";
    ...
    constexpr const char* const type_name_ISensorDataThreshold = "ISensorDataThreshold";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Sensors(void) noexcept
{
    ...
    state->type_Accelerometer = py::register_python_type(module.get(), type_name_Accelerometer, &type_spec_Accelerometer, bases.get());
    if (!state->type_Accelerometer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Accelerometer);

    state->type_AccelerometerDataThreshold = py::register_python_type(module.get(), type_name_AccelerometerDataThreshold, &type_spec_AccelerometerDataThreshold, bases.get());
    if (!state->type_AccelerometerDataThreshold)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AccelerometerDataThreshold);

    state->type_AccelerometerReading = py::register_python_type(module.get(), type_name_AccelerometerReading, &type_spec_AccelerometerReading, bases.get());
    if (!state->type_AccelerometerReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AccelerometerReading);

    state->type_AccelerometerReadingChangedEventArgs = py::register_python_type(module.get(), type_name_AccelerometerReadingChangedEventArgs, &type_spec_AccelerometerReadingChangedEventArgs, bases.get());
    if (!state->type_AccelerometerReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AccelerometerReadingChangedEventArgs);

    state->type_AccelerometerShakenEventArgs = py::register_python_type(module.get(), type_name_AccelerometerShakenEventArgs, &type_spec_AccelerometerShakenEventArgs, bases.get());
    if (!state->type_AccelerometerShakenEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AccelerometerShakenEventArgs);

    state->type_ActivitySensor = py::register_python_type(module.get(), type_name_ActivitySensor, &type_spec_ActivitySensor, bases.get());
    if (!state->type_ActivitySensor)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ActivitySensor);

    state->type_ActivitySensorReading = py::register_python_type(module.get(), type_name_ActivitySensorReading, &type_spec_ActivitySensorReading, bases.get());
    if (!state->type_ActivitySensorReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ActivitySensorReading);

    state->type_ActivitySensorReadingChangeReport = py::register_python_type(module.get(), type_name_ActivitySensorReadingChangeReport, &type_spec_ActivitySensorReadingChangeReport, bases.get());
    if (!state->type_ActivitySensorReadingChangeReport)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ActivitySensorReadingChangeReport);

    state->type_ActivitySensorReadingChangedEventArgs = py::register_python_type(module.get(), type_name_ActivitySensorReadingChangedEventArgs, &type_spec_ActivitySensorReadingChangedEventArgs, bases.get());
    if (!state->type_ActivitySensorReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ActivitySensorReadingChangedEventArgs);

    state->type_ActivitySensorTriggerDetails = py::register_python_type(module.get(), type_name_ActivitySensorTriggerDetails, &type_spec_ActivitySensorTriggerDetails, bases.get());
    if (!state->type_ActivitySensorTriggerDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ActivitySensorTriggerDetails);

    state->type_Altimeter = py::register_python_type(module.get(), type_name_Altimeter, &type_spec_Altimeter, bases.get());
    if (!state->type_Altimeter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Altimeter);

    state->type_AltimeterReading = py::register_python_type(module.get(), type_name_AltimeterReading, &type_spec_AltimeterReading, bases.get());
    if (!state->type_AltimeterReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AltimeterReading);

    state->type_AltimeterReadingChangedEventArgs = py::register_python_type(module.get(), type_name_AltimeterReadingChangedEventArgs, &type_spec_AltimeterReadingChangedEventArgs, bases.get());
    if (!state->type_AltimeterReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AltimeterReadingChangedEventArgs);

    state->type_Barometer = py::register_python_type(module.get(), type_name_Barometer, &type_spec_Barometer, bases.get());
    if (!state->type_Barometer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Barometer);

    state->type_BarometerDataThreshold = py::register_python_type(module.get(), type_name_BarometerDataThreshold, &type_spec_BarometerDataThreshold, bases.get());
    if (!state->type_BarometerDataThreshold)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BarometerDataThreshold);

    state->type_BarometerReading = py::register_python_type(module.get(), type_name_BarometerReading, &type_spec_BarometerReading, bases.get());
    if (!state->type_BarometerReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BarometerReading);

    state->type_BarometerReadingChangedEventArgs = py::register_python_type(module.get(), type_name_BarometerReadingChangedEventArgs, &type_spec_BarometerReadingChangedEventArgs, bases.get());
    if (!state->type_BarometerReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BarometerReadingChangedEventArgs);

    state->type_Compass = py::register_python_type(module.get(), type_name_Compass, &type_spec_Compass, bases.get());
    if (!state->type_Compass)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Compass);

    state->type_CompassDataThreshold = py::register_python_type(module.get(), type_name_CompassDataThreshold, &type_spec_CompassDataThreshold, bases.get());
    if (!state->type_CompassDataThreshold)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CompassDataThreshold);

    state->type_CompassReading = py::register_python_type(module.get(), type_name_CompassReading, &type_spec_CompassReading, bases.get());
    if (!state->type_CompassReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CompassReading);

    state->type_CompassReadingChangedEventArgs = py::register_python_type(module.get(), type_name_CompassReadingChangedEventArgs, &type_spec_CompassReadingChangedEventArgs, bases.get());
    if (!state->type_CompassReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CompassReadingChangedEventArgs);

    state->type_Gyrometer = py::register_python_type(module.get(), type_name_Gyrometer, &type_spec_Gyrometer, bases.get());
    if (!state->type_Gyrometer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Gyrometer);

    state->type_GyrometerDataThreshold = py::register_python_type(module.get(), type_name_GyrometerDataThreshold, &type_spec_GyrometerDataThreshold, bases.get());
    if (!state->type_GyrometerDataThreshold)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GyrometerDataThreshold);

    state->type_GyrometerReading = py::register_python_type(module.get(), type_name_GyrometerReading, &type_spec_GyrometerReading, bases.get());
    if (!state->type_GyrometerReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GyrometerReading);

    state->type_GyrometerReadingChangedEventArgs = py::register_python_type(module.get(), type_name_GyrometerReadingChangedEventArgs, &type_spec_GyrometerReadingChangedEventArgs, bases.get());
    if (!state->type_GyrometerReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GyrometerReadingChangedEventArgs);

    state->type_HingeAngleReading = py::register_python_type(module.get(), type_name_HingeAngleReading, &type_spec_HingeAngleReading, bases.get());
    if (!state->type_HingeAngleReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HingeAngleReading);

    state->type_HingeAngleSensor = py::register_python_type(module.get(), type_name_HingeAngleSensor, &type_spec_HingeAngleSensor, bases.get());
    if (!state->type_HingeAngleSensor)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HingeAngleSensor);

    state->type_HingeAngleSensorReadingChangedEventArgs = py::register_python_type(module.get(), type_name_HingeAngleSensorReadingChangedEventArgs, &type_spec_HingeAngleSensorReadingChangedEventArgs, bases.get());
    if (!state->type_HingeAngleSensorReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HingeAngleSensorReadingChangedEventArgs);

    state->type_HumanPresenceFeatures = py::register_python_type(module.get(), type_name_HumanPresenceFeatures, &type_spec_HumanPresenceFeatures, bases.get());
    if (!state->type_HumanPresenceFeatures)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HumanPresenceFeatures);

    state->type_HumanPresenceSensor = py::register_python_type(module.get(), type_name_HumanPresenceSensor, &type_spec_HumanPresenceSensor, bases.get());
    if (!state->type_HumanPresenceSensor)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HumanPresenceSensor);

    state->type_HumanPresenceSensorReading = py::register_python_type(module.get(), type_name_HumanPresenceSensorReading, &type_spec_HumanPresenceSensorReading, bases.get());
    if (!state->type_HumanPresenceSensorReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HumanPresenceSensorReading);

    state->type_HumanPresenceSensorReadingChangedEventArgs = py::register_python_type(module.get(), type_name_HumanPresenceSensorReadingChangedEventArgs, &type_spec_HumanPresenceSensorReadingChangedEventArgs, bases.get());
    if (!state->type_HumanPresenceSensorReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HumanPresenceSensorReadingChangedEventArgs);

    state->type_HumanPresenceSettings = py::register_python_type(module.get(), type_name_HumanPresenceSettings, &type_spec_HumanPresenceSettings, bases.get());
    if (!state->type_HumanPresenceSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HumanPresenceSettings);

    state->type_Inclinometer = py::register_python_type(module.get(), type_name_Inclinometer, &type_spec_Inclinometer, bases.get());
    if (!state->type_Inclinometer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Inclinometer);

    state->type_InclinometerDataThreshold = py::register_python_type(module.get(), type_name_InclinometerDataThreshold, &type_spec_InclinometerDataThreshold, bases.get());
    if (!state->type_InclinometerDataThreshold)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InclinometerDataThreshold);

    state->type_InclinometerReading = py::register_python_type(module.get(), type_name_InclinometerReading, &type_spec_InclinometerReading, bases.get());
    if (!state->type_InclinometerReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InclinometerReading);

    state->type_InclinometerReadingChangedEventArgs = py::register_python_type(module.get(), type_name_InclinometerReadingChangedEventArgs, &type_spec_InclinometerReadingChangedEventArgs, bases.get());
    if (!state->type_InclinometerReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InclinometerReadingChangedEventArgs);

    state->type_LightSensor = py::register_python_type(module.get(), type_name_LightSensor, &type_spec_LightSensor, bases.get());
    if (!state->type_LightSensor)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LightSensor);

    state->type_LightSensorDataThreshold = py::register_python_type(module.get(), type_name_LightSensorDataThreshold, &type_spec_LightSensorDataThreshold, bases.get());
    if (!state->type_LightSensorDataThreshold)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LightSensorDataThreshold);

    state->type_LightSensorReading = py::register_python_type(module.get(), type_name_LightSensorReading, &type_spec_LightSensorReading, bases.get());
    if (!state->type_LightSensorReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LightSensorReading);

    state->type_LightSensorReadingChangedEventArgs = py::register_python_type(module.get(), type_name_LightSensorReadingChangedEventArgs, &type_spec_LightSensorReadingChangedEventArgs, bases.get());
    if (!state->type_LightSensorReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LightSensorReadingChangedEventArgs);

    state->type_Magnetometer = py::register_python_type(module.get(), type_name_Magnetometer, &type_spec_Magnetometer, bases.get());
    if (!state->type_Magnetometer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Magnetometer);

    state->type_MagnetometerDataThreshold = py::register_python_type(module.get(), type_name_MagnetometerDataThreshold, &type_spec_MagnetometerDataThreshold, bases.get());
    if (!state->type_MagnetometerDataThreshold)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagnetometerDataThreshold);

    state->type_MagnetometerReading = py::register_python_type(module.get(), type_name_MagnetometerReading, &type_spec_MagnetometerReading, bases.get());
    if (!state->type_MagnetometerReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagnetometerReading);

    state->type_MagnetometerReadingChangedEventArgs = py::register_python_type(module.get(), type_name_MagnetometerReadingChangedEventArgs, &type_spec_MagnetometerReadingChangedEventArgs, bases.get());
    if (!state->type_MagnetometerReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MagnetometerReadingChangedEventArgs);

    state->type_OrientationSensor = py::register_python_type(module.get(), type_name_OrientationSensor, &type_spec_OrientationSensor, bases.get());
    if (!state->type_OrientationSensor)
    {
        return nullptr;
    }

    Py_INCREF(state->type_OrientationSensor);

    state->type_OrientationSensorReading = py::register_python_type(module.get(), type_name_OrientationSensorReading, &type_spec_OrientationSensorReading, bases.get());
    if (!state->type_OrientationSensorReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_OrientationSensorReading);

    state->type_OrientationSensorReadingChangedEventArgs = py::register_python_type(module.get(), type_name_OrientationSensorReadingChangedEventArgs, &type_spec_OrientationSensorReadingChangedEventArgs, bases.get());
    if (!state->type_OrientationSensorReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_OrientationSensorReadingChangedEventArgs);

    state->type_Pedometer = py::register_python_type(module.get(), type_name_Pedometer, &type_spec_Pedometer, bases.get());
    if (!state->type_Pedometer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Pedometer);

    state->type_PedometerDataThreshold = py::register_python_type(module.get(), type_name_PedometerDataThreshold, &type_spec_PedometerDataThreshold, bases.get());
    if (!state->type_PedometerDataThreshold)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PedometerDataThreshold);

    state->type_PedometerReading = py::register_python_type(module.get(), type_name_PedometerReading, &type_spec_PedometerReading, bases.get());
    if (!state->type_PedometerReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PedometerReading);

    state->type_PedometerReadingChangedEventArgs = py::register_python_type(module.get(), type_name_PedometerReadingChangedEventArgs, &type_spec_PedometerReadingChangedEventArgs, bases.get());
    if (!state->type_PedometerReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PedometerReadingChangedEventArgs);

    state->type_ProximitySensor = py::register_python_type(module.get(), type_name_ProximitySensor, &type_spec_ProximitySensor, bases.get());
    if (!state->type_ProximitySensor)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ProximitySensor);

    state->type_ProximitySensorDataThreshold = py::register_python_type(module.get(), type_name_ProximitySensorDataThreshold, &type_spec_ProximitySensorDataThreshold, bases.get());
    if (!state->type_ProximitySensorDataThreshold)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ProximitySensorDataThreshold);

    state->type_ProximitySensorDisplayOnOffController = py::register_python_type(module.get(), type_name_ProximitySensorDisplayOnOffController, &type_spec_ProximitySensorDisplayOnOffController, bases.get());
    if (!state->type_ProximitySensorDisplayOnOffController)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ProximitySensorDisplayOnOffController);

    state->type_ProximitySensorReading = py::register_python_type(module.get(), type_name_ProximitySensorReading, &type_spec_ProximitySensorReading, bases.get());
    if (!state->type_ProximitySensorReading)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ProximitySensorReading);

    state->type_ProximitySensorReadingChangedEventArgs = py::register_python_type(module.get(), type_name_ProximitySensorReadingChangedEventArgs, &type_spec_ProximitySensorReadingChangedEventArgs, bases.get());
    if (!state->type_ProximitySensorReadingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ProximitySensorReadingChangedEventArgs);

    state->type_SensorDataThresholdTriggerDetails = py::register_python_type(module.get(), type_name_SensorDataThresholdTriggerDetails, &type_spec_SensorDataThresholdTriggerDetails, bases.get());
    if (!state->type_SensorDataThresholdTriggerDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SensorDataThresholdTriggerDetails);

    state->type_SensorQuaternion = py::register_python_type(module.get(), type_name_SensorQuaternion, &type_spec_SensorQuaternion, bases.get());
    if (!state->type_SensorQuaternion)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SensorQuaternion);

    state->type_SensorRotationMatrix = py::register_python_type(module.get(), type_name_SensorRotationMatrix, &type_spec_SensorRotationMatrix, bases.get());
    if (!state->type_SensorRotationMatrix)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SensorRotationMatrix);

    state->type_SimpleOrientationSensor = py::register_python_type(module.get(), type_name_SimpleOrientationSensor, &type_spec_SimpleOrientationSensor, bases.get());
    if (!state->type_SimpleOrientationSensor)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SimpleOrientationSensor);

    state->type_SimpleOrientationSensorOrientationChangedEventArgs = py::register_python_type(module.get(), type_name_SimpleOrientationSensorOrientationChangedEventArgs, &type_spec_SimpleOrientationSensorOrientationChangedEventArgs, bases.get());
    if (!state->type_SimpleOrientationSensorOrientationChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SimpleOrientationSensorOrientationChangedEventArgs);

    state->type_ISensorDataThreshold = py::register_python_type(module.get(), type_name_ISensorDataThreshold, &type_spec_ISensorDataThreshold, bases.get());
    if (!state->type_ISensorDataThreshold)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ISensorDataThreshold);
