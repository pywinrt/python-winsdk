...
winrt::Windows::Graphics::Imaging::BitmapBounds py::converter<winrt::Windows::Graphics::Imaging::BitmapBounds>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Graphics::Imaging::BitmapBounds or dict");
...
winrt::Windows::Graphics::Imaging::BitmapPlaneDescription py::converter<winrt::Windows::Graphics::Imaging::BitmapPlaneDescription>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Graphics::Imaging::BitmapPlaneDescription or dict");
        throw python_exception();
    }
    ...
    if (!py_StartIndex) {
        PyErr_SetString(PyExc_KeyError, "StartIndex");
        throw python_exception();
    }
...
winrt::Windows::Graphics::Imaging::BitmapSize py::converter<winrt::Windows::Graphics::Imaging::BitmapSize>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Graphics::Imaging::BitmapSize or dict");
        throw python_exception();
    }
...
PyMODINIT_FUNC
PyInit__winsdk_Windows_Graphics_Imaging (void) noexcept
{
