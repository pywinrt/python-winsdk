...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintBinding> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintBordering> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintCollation> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintColorMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintDuplex> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintHolePunch> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintMediaSize> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintMediaType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintOrientation> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintQuality> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintStaple> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintTaskCompletion> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::PrintPageDescription> = "T{T{f:width:f:height:}:page_size:T{f:x:f:y:f:width:f:height:}:imageable_rect:I:dpi_x:I:dpi_y:}";
