...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::AudioBufferAccessMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::AudioProcessing> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::MediaPlaybackAutoRepeatMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::MediaPlaybackStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::MediaPlaybackType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::MediaTimelineControllerState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::SoundLevel> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::SystemMediaTransportControlsButton> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::SystemMediaTransportControlsProperty> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::MediaTimeRange> = "T{T{q:duration:}:start:T{q:duration:}:end:}";
