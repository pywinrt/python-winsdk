...
PyMODINIT_FUNC PyInit__winsdk_Windows_Web_UI_Interop(void) noexcept
{
    ...
    state->type_WebViewControl = py::register_python_type(module.get(), type_name_WebViewControl, &type_spec_WebViewControl, bases.get(), nullptr);
    if (!state->type_WebViewControl)
    {
        return nullptr;
    }

    state->type_WebViewControlAcceleratorKeyPressedEventArgs = py::register_python_type(module.get(), type_name_WebViewControlAcceleratorKeyPressedEventArgs, &type_spec_WebViewControlAcceleratorKeyPressedEventArgs, bases.get(), nullptr);
    if (!state->type_WebViewControlAcceleratorKeyPressedEventArgs)
    {
        return nullptr;
    }

    state->type_WebViewControlMoveFocusRequestedEventArgs = py::register_python_type(module.get(), type_name_WebViewControlMoveFocusRequestedEventArgs, &type_spec_WebViewControlMoveFocusRequestedEventArgs, bases.get(), nullptr);
    if (!state->type_WebViewControlMoveFocusRequestedEventArgs)
    {
        return nullptr;
    }

    state->type_WebViewControlProcess = py::register_python_type(module.get(), type_name_WebViewControlProcess, &type_spec_WebViewControlProcess, bases.get(), nullptr);
    if (!state->type_WebViewControlProcess)
    {
        return nullptr;
    }

    state->type_WebViewControlProcessOptions = py::register_python_type(module.get(), type_name_WebViewControlProcessOptions, &type_spec_WebViewControlProcessOptions, bases.get(), nullptr);
