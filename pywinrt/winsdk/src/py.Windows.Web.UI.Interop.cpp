...
namespace py::cpp::Windows::Web::UI::Interop
{
    ...
    static PyObject* register_WebViewControlAcceleratorKeyRoutingStage(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_WebViewControlMoveFocusReason(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_WebViewControlProcessCapabilityState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_WebViewControl = "WebViewControl";
    ...
    constexpr const char* const type_name_WebViewControlAcceleratorKeyPressedEventArgs = "WebViewControlAcceleratorKeyPressedEventArgs";
    ...
    constexpr const char* const type_name_WebViewControlMoveFocusRequestedEventArgs = "WebViewControlMoveFocusRequestedEventArgs";
    ...
    constexpr const char* const type_name_WebViewControlProcess = "WebViewControlProcess";
    ...
    constexpr const char* const type_name_WebViewControlProcessOptions = "WebViewControlProcessOptions";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Web_UI_Interop(void) noexcept
{
    ...
    state->type_WebViewControl = py::register_python_type(module.get(), type_name_WebViewControl, &type_spec_WebViewControl, bases.get());
    if (!state->type_WebViewControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WebViewControl);

    state->type_WebViewControlAcceleratorKeyPressedEventArgs = py::register_python_type(module.get(), type_name_WebViewControlAcceleratorKeyPressedEventArgs, &type_spec_WebViewControlAcceleratorKeyPressedEventArgs, bases.get());
    if (!state->type_WebViewControlAcceleratorKeyPressedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WebViewControlAcceleratorKeyPressedEventArgs);

    state->type_WebViewControlMoveFocusRequestedEventArgs = py::register_python_type(module.get(), type_name_WebViewControlMoveFocusRequestedEventArgs, &type_spec_WebViewControlMoveFocusRequestedEventArgs, bases.get());
    if (!state->type_WebViewControlMoveFocusRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WebViewControlMoveFocusRequestedEventArgs);

    state->type_WebViewControlProcess = py::register_python_type(module.get(), type_name_WebViewControlProcess, &type_spec_WebViewControlProcess, bases.get());
    if (!state->type_WebViewControlProcess)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WebViewControlProcess);

    state->type_WebViewControlProcessOptions = py::register_python_type(module.get(), type_name_WebViewControlProcessOptions, &type_spec_WebViewControlProcessOptions, bases.get());
    if (!state->type_WebViewControlProcessOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WebViewControlProcessOptions);
