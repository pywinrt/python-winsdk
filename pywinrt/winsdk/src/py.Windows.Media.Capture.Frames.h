...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Capture::Frames::MediaFrameReaderAcquisitionMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Capture::Frames::MediaFrameReaderStartStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Capture::Frames::MediaFrameSourceGetPropertyStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Capture::Frames::MediaFrameSourceKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Capture::Frames::MediaFrameSourceSetPropertyStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Capture::Frames::MultiSourceMediaFrameReaderStartStatus> = "i";
