...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Authentication::OnlineId::CredentialPromptType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Authentication::OnlineId::OnlineIdSystemTicketStatus> = "i";
