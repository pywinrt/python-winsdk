...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::Geofencing::GeofenceMonitorStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::Geofencing::GeofenceRemovalReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::Geofencing::GeofenceState> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::Geofencing::MonitoredGeofenceStates> = "I";
