...
namespace py::cpp::Windows::System::Diagnostics::DevicePortal
{
    ...
    static PyObject* register_DevicePortalConnectionClosedReason(PyObject* module, PyObject* type)
    {
    ...
    constexpr const char* const type_name_DevicePortalConnection = "DevicePortalConnection";
    ...
    constexpr const char* const type_name_DevicePortalConnectionClosedEventArgs = "DevicePortalConnectionClosedEventArgs";
    ...
    constexpr const char* const type_name_DevicePortalConnectionRequestReceivedEventArgs = "DevicePortalConnectionRequestReceivedEventArgs";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_System_Diagnostics_DevicePortal(void) noexcept
{
    ...
    state->type_DevicePortalConnection = py::register_python_type(module.get(), type_name_DevicePortalConnection, &type_spec_DevicePortalConnection, bases.get());
    if (!state->type_DevicePortalConnection)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DevicePortalConnection);

    state->type_DevicePortalConnectionClosedEventArgs = py::register_python_type(module.get(), type_name_DevicePortalConnectionClosedEventArgs, &type_spec_DevicePortalConnectionClosedEventArgs, bases.get());
    if (!state->type_DevicePortalConnectionClosedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DevicePortalConnectionClosedEventArgs);

    state->type_DevicePortalConnectionRequestReceivedEventArgs = py::register_python_type(module.get(), type_name_DevicePortalConnectionRequestReceivedEventArgs, &type_spec_DevicePortalConnectionRequestReceivedEventArgs, bases.get());
    if (!state->type_DevicePortalConnectionRequestReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DevicePortalConnectionRequestReceivedEventArgs);
