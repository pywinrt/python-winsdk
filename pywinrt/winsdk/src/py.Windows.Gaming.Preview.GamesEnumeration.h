...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Preview::GamesEnumeration::GameListCategory> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Preview::GamesEnumeration::GameListEntryLaunchableState> = "i";
