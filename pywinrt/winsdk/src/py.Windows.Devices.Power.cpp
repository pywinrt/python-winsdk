...
namespace py::cpp::Windows::Devices::Power
{
    ...
    static PyType_Slot type_slots_Battery_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_Battery_Meta },
        { }
    };

    static PyType_Spec type_spec_Battery_Meta =
    {
        "_winsdk_Windows_Devices_Power.Battery_Meta",
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Power(void) noexcept
{
    ...
    state->type_Battery = py::register_python_type(module.get(), type_name_Battery, &type_spec_Battery, bases.get(), reinterpret_cast<PyTypeObject*>(type_Battery_Meta.get()));
    if (!state->type_Battery)
    {
        return nullptr;
    }

    state->type_BatteryReport = py::register_python_type(module.get(), type_name_BatteryReport, &type_spec_BatteryReport, bases.get(), nullptr);
