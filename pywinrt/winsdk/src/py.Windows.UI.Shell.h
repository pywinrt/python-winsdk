...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Shell::SecurityAppKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Shell::SecurityAppState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Shell::SecurityAppSubstatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Shell::ShareWindowCommand> = "i";
