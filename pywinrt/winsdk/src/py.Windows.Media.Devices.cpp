...
namespace py::cpp::Windows::Media::Devices
{
    ...
    static PyObject* register_AdvancedPhotoMode(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_AudioDeviceRole(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AutoFocusRange(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CameraOcclusionKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CameraStreamState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CaptureSceneMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CaptureUse(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ColorTemperaturePreset(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DigitalWindowMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_FocusMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_FocusPreset(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_HdrVideoMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InfraredTorchMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_IsoSpeedPreset(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ManualFocusDistance(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MediaCaptureFocusState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MediaCaptureOptimization(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MediaCapturePauseBehavior(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_OpticalImageStabilizationMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RegionOfInterestType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SendCommandStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_VideoDeviceControllerGetDevicePropertyStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_VideoDeviceControllerSetDevicePropertyStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_VideoTemporalDenoisingMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ZoomTransitionMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_AdvancedPhotoCaptureSettings = "AdvancedPhotoCaptureSettings";
    ...
    constexpr const char* const type_name_AdvancedPhotoControl = "AdvancedPhotoControl";
    ...
    constexpr const char* const type_name_AudioDeviceController = "AudioDeviceController";
    ...
    constexpr const char* const type_name_AudioDeviceModule = "AudioDeviceModule";
    ...
    constexpr const char* const type_name_AudioDeviceModuleNotificationEventArgs = "AudioDeviceModuleNotificationEventArgs";
    ...
    constexpr const char* const type_name_AudioDeviceModulesManager = "AudioDeviceModulesManager";
    ...
    constexpr const char* const type_name_CameraOcclusionState = "CameraOcclusionState";
    ...
    constexpr const char* const type_name_CameraOcclusionStateChangedEventArgs = "CameraOcclusionStateChangedEventArgs";
    ...
    constexpr const char* const type_name_DefaultAudioCaptureDeviceChangedEventArgs = "DefaultAudioCaptureDeviceChangedEventArgs";
    ...
    constexpr const char* const type_name_DefaultAudioRenderDeviceChangedEventArgs = "DefaultAudioRenderDeviceChangedEventArgs";
    ...
    constexpr const char* const type_name_DigitalWindowBounds = "DigitalWindowBounds";
    ...
    constexpr const char* const type_name_DigitalWindowCapability = "DigitalWindowCapability";
    ...
    constexpr const char* const type_name_DigitalWindowControl = "DigitalWindowControl";
    ...
    constexpr const char* const type_name_ExposureCompensationControl = "ExposureCompensationControl";
    ...
    constexpr const char* const type_name_ExposureControl = "ExposureControl";
    ...
    constexpr const char* const type_name_ExposurePriorityVideoControl = "ExposurePriorityVideoControl";
    ...
    // ----- FlashControl class --------------------
    constexpr const char* const type_name_FlashControl = "FlashControl";
    ...
    // ----- FocusControl class --------------------
    constexpr const char* const type_name_FocusControl = "FocusControl";
    ...
    // ----- FocusSettings class --------------------
    constexpr const char* const type_name_FocusSettings = "FocusSettings";
    ...
    constexpr const char* const type_name_HdrVideoControl = "HdrVideoControl";
    ...
    constexpr const char* const type_name_InfraredTorchControl = "InfraredTorchControl";
    ...
    constexpr const char* const type_name_IsoSpeedControl = "IsoSpeedControl";
    ...
    constexpr const char* const type_name_LowLagPhotoSequenceControl = "LowLagPhotoSequenceControl";
    ...
    // ----- MediaDevice class --------------------
    constexpr const char* const type_name_MediaDevice = "MediaDevice";
    ...
    constexpr const char* const type_name_MediaDeviceControl = "MediaDeviceControl";
    ...
    constexpr const char* const type_name_MediaDeviceControlCapabilities = "MediaDeviceControlCapabilities";
    ...
    constexpr const char* const type_name_ModuleCommandResult = "ModuleCommandResult";
    ...
    constexpr const char* const type_name_OpticalImageStabilizationControl = "OpticalImageStabilizationControl";
    ...
    constexpr const char* const type_name_PanelBasedOptimizationControl = "PanelBasedOptimizationControl";
    ...
    constexpr const char* const type_name_PhotoConfirmationControl = "PhotoConfirmationControl";
    ...
    constexpr const char* const type_name_RegionOfInterest = "RegionOfInterest";
    ...
    constexpr const char* const type_name_RegionsOfInterestControl = "RegionsOfInterestControl";
    ...
    constexpr const char* const type_name_SceneModeControl = "SceneModeControl";
    ...
    // ----- TorchControl class --------------------
    constexpr const char* const type_name_TorchControl = "TorchControl";
    ...
    constexpr const char* const type_name_VideoDeviceController = "VideoDeviceController";
    ...
    constexpr const char* const type_name_VideoDeviceControllerGetDevicePropertyResult = "VideoDeviceControllerGetDevicePropertyResult";
    ...
    constexpr const char* const type_name_VideoTemporalDenoisingControl = "VideoTemporalDenoisingControl";
    ...
    constexpr const char* const type_name_WhiteBalanceControl = "WhiteBalanceControl";
    ...
    // ----- ZoomControl class --------------------
    constexpr const char* const type_name_ZoomControl = "ZoomControl";
    ...
    // ----- ZoomSettings class --------------------
    constexpr const char* const type_name_ZoomSettings = "ZoomSettings";
    ...
    constexpr const char* const type_name_IDefaultAudioDeviceChangedEventArgs = "IDefaultAudioDeviceChangedEventArgs";
    ...
    constexpr const char* const type_name_IMediaDeviceController = "IMediaDeviceController";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Media_Devices(void) noexcept
{
    ...
    state->type_AdvancedPhotoCaptureSettings = py::register_python_type(module.get(), type_name_AdvancedPhotoCaptureSettings, &type_spec_AdvancedPhotoCaptureSettings, bases.get());
    if (!state->type_AdvancedPhotoCaptureSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AdvancedPhotoCaptureSettings);

    state->type_AdvancedPhotoControl = py::register_python_type(module.get(), type_name_AdvancedPhotoControl, &type_spec_AdvancedPhotoControl, bases.get());
    if (!state->type_AdvancedPhotoControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AdvancedPhotoControl);

    state->type_AudioDeviceController = py::register_python_type(module.get(), type_name_AudioDeviceController, &type_spec_AudioDeviceController, bases.get());
    if (!state->type_AudioDeviceController)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AudioDeviceController);

    state->type_AudioDeviceModule = py::register_python_type(module.get(), type_name_AudioDeviceModule, &type_spec_AudioDeviceModule, bases.get());
    if (!state->type_AudioDeviceModule)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AudioDeviceModule);

    state->type_AudioDeviceModuleNotificationEventArgs = py::register_python_type(module.get(), type_name_AudioDeviceModuleNotificationEventArgs, &type_spec_AudioDeviceModuleNotificationEventArgs, bases.get());
    if (!state->type_AudioDeviceModuleNotificationEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AudioDeviceModuleNotificationEventArgs);

    state->type_AudioDeviceModulesManager = py::register_python_type(module.get(), type_name_AudioDeviceModulesManager, &type_spec_AudioDeviceModulesManager, bases.get());
    ...
    Py_INCREF(state->type_CameraOcclusionInfo);

    state->type_CameraOcclusionState = py::register_python_type(module.get(), type_name_CameraOcclusionState, &type_spec_CameraOcclusionState, bases.get());
    if (!state->type_CameraOcclusionState)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CameraOcclusionState);

    state->type_CameraOcclusionStateChangedEventArgs = py::register_python_type(module.get(), type_name_CameraOcclusionStateChangedEventArgs, &type_spec_CameraOcclusionStateChangedEventArgs, bases.get());
    if (!state->type_CameraOcclusionStateChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CameraOcclusionStateChangedEventArgs);

    state->type_DefaultAudioCaptureDeviceChangedEventArgs = py::register_python_type(module.get(), type_name_DefaultAudioCaptureDeviceChangedEventArgs, &type_spec_DefaultAudioCaptureDeviceChangedEventArgs, bases.get());
    if (!state->type_DefaultAudioCaptureDeviceChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DefaultAudioCaptureDeviceChangedEventArgs);

    state->type_DefaultAudioRenderDeviceChangedEventArgs = py::register_python_type(module.get(), type_name_DefaultAudioRenderDeviceChangedEventArgs, &type_spec_DefaultAudioRenderDeviceChangedEventArgs, bases.get());
    ...
    Py_INCREF(state->type_DigitalWindowBounds);

    state->type_DigitalWindowCapability = py::register_python_type(module.get(), type_name_DigitalWindowCapability, &type_spec_DigitalWindowCapability, bases.get());
    if (!state->type_DigitalWindowCapability)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DigitalWindowCapability);

    state->type_DigitalWindowControl = py::register_python_type(module.get(), type_name_DigitalWindowControl, &type_spec_DigitalWindowControl, bases.get());
    if (!state->type_DigitalWindowControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DigitalWindowControl);

    state->type_ExposureCompensationControl = py::register_python_type(module.get(), type_name_ExposureCompensationControl, &type_spec_ExposureCompensationControl, bases.get());
    if (!state->type_ExposureCompensationControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ExposureCompensationControl);

    state->type_ExposureControl = py::register_python_type(module.get(), type_name_ExposureControl, &type_spec_ExposureControl, bases.get());
    if (!state->type_ExposureControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ExposureControl);

    state->type_ExposurePriorityVideoControl = py::register_python_type(module.get(), type_name_ExposurePriorityVideoControl, &type_spec_ExposurePriorityVideoControl, bases.get());
    if (!state->type_ExposurePriorityVideoControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ExposurePriorityVideoControl);

    state->type_FlashControl = py::register_python_type(module.get(), type_name_FlashControl, &type_spec_FlashControl, bases.get());
    if (!state->type_FlashControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FlashControl);

    state->type_FocusControl = py::register_python_type(module.get(), type_name_FocusControl, &type_spec_FocusControl, bases.get());
    if (!state->type_FocusControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FocusControl);

    state->type_FocusSettings = py::register_python_type(module.get(), type_name_FocusSettings, &type_spec_FocusSettings, bases.get());
    if (!state->type_FocusSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FocusSettings);

    state->type_HdrVideoControl = py::register_python_type(module.get(), type_name_HdrVideoControl, &type_spec_HdrVideoControl, bases.get());
    if (!state->type_HdrVideoControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HdrVideoControl);

    state->type_InfraredTorchControl = py::register_python_type(module.get(), type_name_InfraredTorchControl, &type_spec_InfraredTorchControl, bases.get());
    if (!state->type_InfraredTorchControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InfraredTorchControl);

    state->type_IsoSpeedControl = py::register_python_type(module.get(), type_name_IsoSpeedControl, &type_spec_IsoSpeedControl, bases.get());
    ...
    Py_INCREF(state->type_LowLagPhotoControl);

    state->type_LowLagPhotoSequenceControl = py::register_python_type(module.get(), type_name_LowLagPhotoSequenceControl, &type_spec_LowLagPhotoSequenceControl, bases.get());
    if (!state->type_LowLagPhotoSequenceControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LowLagPhotoSequenceControl);

    state->type_MediaDevice = py::register_python_type(module.get(), type_name_MediaDevice, &type_spec_MediaDevice, nullptr);
    if (!state->type_MediaDevice)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MediaDevice);

    state->type_MediaDeviceControl = py::register_python_type(module.get(), type_name_MediaDeviceControl, &type_spec_MediaDeviceControl, bases.get());
    if (!state->type_MediaDeviceControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MediaDeviceControl);

    state->type_MediaDeviceControlCapabilities = py::register_python_type(module.get(), type_name_MediaDeviceControlCapabilities, &type_spec_MediaDeviceControlCapabilities, bases.get());
    if (!state->type_MediaDeviceControlCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MediaDeviceControlCapabilities);

    state->type_ModuleCommandResult = py::register_python_type(module.get(), type_name_ModuleCommandResult, &type_spec_ModuleCommandResult, bases.get());
    if (!state->type_ModuleCommandResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ModuleCommandResult);

    state->type_OpticalImageStabilizationControl = py::register_python_type(module.get(), type_name_OpticalImageStabilizationControl, &type_spec_OpticalImageStabilizationControl, bases.get());
    if (!state->type_OpticalImageStabilizationControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_OpticalImageStabilizationControl);

    state->type_PanelBasedOptimizationControl = py::register_python_type(module.get(), type_name_PanelBasedOptimizationControl, &type_spec_PanelBasedOptimizationControl, bases.get());
    if (!state->type_PanelBasedOptimizationControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PanelBasedOptimizationControl);

    state->type_PhotoConfirmationControl = py::register_python_type(module.get(), type_name_PhotoConfirmationControl, &type_spec_PhotoConfirmationControl, bases.get());
    ...
    Py_INCREF(state->type_RegionOfInterest);

    state->type_RegionsOfInterestControl = py::register_python_type(module.get(), type_name_RegionsOfInterestControl, &type_spec_RegionsOfInterestControl, bases.get());
    if (!state->type_RegionsOfInterestControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RegionsOfInterestControl);

    state->type_SceneModeControl = py::register_python_type(module.get(), type_name_SceneModeControl, &type_spec_SceneModeControl, bases.get());
    if (!state->type_SceneModeControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SceneModeControl);

    state->type_TorchControl = py::register_python_type(module.get(), type_name_TorchControl, &type_spec_TorchControl, bases.get());
    if (!state->type_TorchControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_TorchControl);

    state->type_VideoDeviceController = py::register_python_type(module.get(), type_name_VideoDeviceController, &type_spec_VideoDeviceController, bases.get());
    if (!state->type_VideoDeviceController)
    {
        return nullptr;
    }

    Py_INCREF(state->type_VideoDeviceController);

    state->type_VideoDeviceControllerGetDevicePropertyResult = py::register_python_type(module.get(), type_name_VideoDeviceControllerGetDevicePropertyResult, &type_spec_VideoDeviceControllerGetDevicePropertyResult, bases.get());
    if (!state->type_VideoDeviceControllerGetDevicePropertyResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_VideoDeviceControllerGetDevicePropertyResult);

    state->type_VideoTemporalDenoisingControl = py::register_python_type(module.get(), type_name_VideoTemporalDenoisingControl, &type_spec_VideoTemporalDenoisingControl, bases.get());
    if (!state->type_VideoTemporalDenoisingControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_VideoTemporalDenoisingControl);

    state->type_WhiteBalanceControl = py::register_python_type(module.get(), type_name_WhiteBalanceControl, &type_spec_WhiteBalanceControl, bases.get());
    if (!state->type_WhiteBalanceControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WhiteBalanceControl);

    state->type_ZoomControl = py::register_python_type(module.get(), type_name_ZoomControl, &type_spec_ZoomControl, bases.get());
    if (!state->type_ZoomControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ZoomControl);

    state->type_ZoomSettings = py::register_python_type(module.get(), type_name_ZoomSettings, &type_spec_ZoomSettings, bases.get());
    if (!state->type_ZoomSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ZoomSettings);

    state->type_IDefaultAudioDeviceChangedEventArgs = py::register_python_type(module.get(), type_name_IDefaultAudioDeviceChangedEventArgs, &type_spec_IDefaultAudioDeviceChangedEventArgs, bases.get());
    if (!state->type_IDefaultAudioDeviceChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IDefaultAudioDeviceChangedEventArgs);

    state->type_IMediaDeviceController = py::register_python_type(module.get(), type_name_IMediaDeviceController, &type_spec_IMediaDeviceController, bases.get());
    if (!state->type_IMediaDeviceController)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IMediaDeviceController);
