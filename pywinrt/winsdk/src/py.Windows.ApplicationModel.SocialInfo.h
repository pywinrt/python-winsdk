...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::SocialInfo::SocialFeedItemStyle> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::SocialInfo::SocialFeedKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::SocialInfo::SocialFeedUpdateMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::SocialInfo::SocialItemBadgeStyle> = "i";
