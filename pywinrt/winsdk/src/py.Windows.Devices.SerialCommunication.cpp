...
namespace py::cpp::Windows::Devices::SerialCommunication
{
    ...
    static PyObject* register_SerialError(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_SerialHandshake(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SerialParity(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SerialPinChange(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SerialStopBitCount(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_ErrorReceivedEventArgs = "ErrorReceivedEventArgs";
    ...
    constexpr const char* const type_name_PinChangedEventArgs = "PinChangedEventArgs";
    ...
    // ----- SerialDevice class --------------------
    constexpr const char* const type_name_SerialDevice = "SerialDevice";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_SerialCommunication(void) noexcept
{
    ...
    state->type_ErrorReceivedEventArgs = py::register_python_type(module.get(), type_name_ErrorReceivedEventArgs, &type_spec_ErrorReceivedEventArgs, bases.get());
    if (!state->type_ErrorReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ErrorReceivedEventArgs);

    state->type_PinChangedEventArgs = py::register_python_type(module.get(), type_name_PinChangedEventArgs, &type_spec_PinChangedEventArgs, bases.get());
    if (!state->type_PinChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PinChangedEventArgs);

    state->type_SerialDevice = py::register_python_type(module.get(), type_name_SerialDevice, &type_spec_SerialDevice, bases.get());
    if (!state->type_SerialDevice)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SerialDevice);
