...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Profile::PlatformDataCollectionLevel> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Profile::SystemIdentificationSource> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Profile::SystemOutOfBoxExperienceState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Profile::UnsupportedAppRequirementReasons> = "I";
