...
namespace py::cpp::Windows::Foundation::Numerics
{
    ...
    // ----- Matrix3x2 struct --------------------
    constexpr const char* const type_name_Matrix3x2 = "Matrix3x2";
    ...
    // ----- Matrix4x4 struct --------------------
    constexpr const char* const type_name_Matrix4x4 = "Matrix4x4";
    ...
    // ----- Plane struct --------------------
    constexpr const char* const type_name_Plane = "Plane";
    ...
    // ----- Quaternion struct --------------------
    constexpr const char* const type_name_Quaternion = "Quaternion";
    ...
    // ----- Rational struct --------------------
    constexpr const char* const type_name_Rational = "Rational";
    ...
    // ----- Vector2 struct --------------------
    constexpr const char* const type_name_Vector2 = "Vector2";
    ...
    // ----- Vector3 struct --------------------
    constexpr const char* const type_name_Vector3 = "Vector3";
    ...
    // ----- Vector4 struct --------------------
    constexpr const char* const type_name_Vector4 = "Vector4";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Foundation_Numerics(void) noexcept
{
    ...
    state->type_Matrix3x2 = py::register_python_type(module.get(), type_name_Matrix3x2, &type_spec_Matrix3x2, bases.get());
    if (!state->type_Matrix3x2)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Matrix3x2);

    state->type_Matrix4x4 = py::register_python_type(module.get(), type_name_Matrix4x4, &type_spec_Matrix4x4, bases.get());
    if (!state->type_Matrix4x4)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Matrix4x4);

    state->type_Plane = py::register_python_type(module.get(), type_name_Plane, &type_spec_Plane, bases.get());
    if (!state->type_Plane)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Plane);

    state->type_Quaternion = py::register_python_type(module.get(), type_name_Quaternion, &type_spec_Quaternion, bases.get());
    if (!state->type_Quaternion)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Quaternion);

    state->type_Rational = py::register_python_type(module.get(), type_name_Rational, &type_spec_Rational, bases.get());
    if (!state->type_Rational)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Rational);

    state->type_Vector2 = py::register_python_type(module.get(), type_name_Vector2, &type_spec_Vector2, bases.get());
    if (!state->type_Vector2)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Vector2);

    state->type_Vector3 = py::register_python_type(module.get(), type_name_Vector3, &type_spec_Vector3, bases.get());
    if (!state->type_Vector3)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Vector3);

    state->type_Vector4 = py::register_python_type(module.get(), type_name_Vector4, &type_spec_Vector4, bases.get());
    if (!state->type_Vector4)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Vector4);
