...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Miracast::MiracastReceiverApplySettingsStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Miracast::MiracastReceiverAuthorizationMethod> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Miracast::MiracastReceiverDisconnectReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Miracast::MiracastReceiverGameControllerDeviceUsageMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Miracast::MiracastReceiverListeningStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Miracast::MiracastReceiverSessionStartStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Miracast::MiracastReceiverWiFiStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Miracast::MiracastTransmitterAuthorizationStatus> = "i";
