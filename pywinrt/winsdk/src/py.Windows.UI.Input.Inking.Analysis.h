...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::Analysis::InkAnalysisDrawingKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::Analysis::InkAnalysisNodeKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::Analysis::InkAnalysisStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::Analysis::InkAnalysisStrokeKind> = "i";
