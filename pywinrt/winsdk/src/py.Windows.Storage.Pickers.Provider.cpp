...
namespace py::cpp::Windows::Storage::Pickers::Provider
{
    ...
    static PyObject* register_AddFileResult(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_FileSelectionMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SetFileNameResult(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_FileOpenPickerUI = "FileOpenPickerUI";
    ...
    constexpr const char* const type_name_FileRemovedEventArgs = "FileRemovedEventArgs";
    ...
    constexpr const char* const type_name_FileSavePickerUI = "FileSavePickerUI";
    ...
    constexpr const char* const type_name_PickerClosingDeferral = "PickerClosingDeferral";
    ...
    constexpr const char* const type_name_PickerClosingEventArgs = "PickerClosingEventArgs";
    ...
    constexpr const char* const type_name_PickerClosingOperation = "PickerClosingOperation";
    ...
    constexpr const char* const type_name_TargetFileRequest = "TargetFileRequest";
    ...
    constexpr const char* const type_name_TargetFileRequestDeferral = "TargetFileRequestDeferral";
    ...
    constexpr const char* const type_name_TargetFileRequestedEventArgs = "TargetFileRequestedEventArgs";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Storage_Pickers_Provider(void) noexcept
{
    ...
    state->type_FileOpenPickerUI = py::register_python_type(module.get(), type_name_FileOpenPickerUI, &type_spec_FileOpenPickerUI, bases.get());
    if (!state->type_FileOpenPickerUI)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FileOpenPickerUI);

    state->type_FileRemovedEventArgs = py::register_python_type(module.get(), type_name_FileRemovedEventArgs, &type_spec_FileRemovedEventArgs, bases.get());
    if (!state->type_FileRemovedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FileRemovedEventArgs);

    state->type_FileSavePickerUI = py::register_python_type(module.get(), type_name_FileSavePickerUI, &type_spec_FileSavePickerUI, bases.get());
    if (!state->type_FileSavePickerUI)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FileSavePickerUI);

    state->type_PickerClosingDeferral = py::register_python_type(module.get(), type_name_PickerClosingDeferral, &type_spec_PickerClosingDeferral, bases.get());
    if (!state->type_PickerClosingDeferral)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PickerClosingDeferral);

    state->type_PickerClosingEventArgs = py::register_python_type(module.get(), type_name_PickerClosingEventArgs, &type_spec_PickerClosingEventArgs, bases.get());
    if (!state->type_PickerClosingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PickerClosingEventArgs);

    state->type_PickerClosingOperation = py::register_python_type(module.get(), type_name_PickerClosingOperation, &type_spec_PickerClosingOperation, bases.get());
    if (!state->type_PickerClosingOperation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PickerClosingOperation);

    state->type_TargetFileRequest = py::register_python_type(module.get(), type_name_TargetFileRequest, &type_spec_TargetFileRequest, bases.get());
    if (!state->type_TargetFileRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_TargetFileRequest);

    state->type_TargetFileRequestDeferral = py::register_python_type(module.get(), type_name_TargetFileRequestDeferral, &type_spec_TargetFileRequestDeferral, bases.get());
    if (!state->type_TargetFileRequestDeferral)
    {
        return nullptr;
    }

    Py_INCREF(state->type_TargetFileRequestDeferral);

    state->type_TargetFileRequestedEventArgs = py::register_python_type(module.get(), type_name_TargetFileRequestedEventArgs, &type_spec_TargetFileRequestedEventArgs, bases.get());
    if (!state->type_TargetFileRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_TargetFileRequestedEventArgs);
