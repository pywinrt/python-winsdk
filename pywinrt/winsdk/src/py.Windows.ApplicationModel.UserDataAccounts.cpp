...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_UserDataAccounts(void) noexcept
{
    ...
    state->type_UserDataAccount = py::register_python_type(module.get(), type_name_UserDataAccount, &type_spec_UserDataAccount, bases.get(), nullptr);
    if (!state->type_UserDataAccount)
    {
        return nullptr;
    }

    state->type_UserDataAccountManager = py::register_python_type(module.get(), type_name_UserDataAccountManager, &type_spec_UserDataAccountManager, nullptr, nullptr);
    if (!state->type_UserDataAccountManager)
    {
        return nullptr;
    }

    state->type_UserDataAccountManagerForUser = py::register_python_type(module.get(), type_name_UserDataAccountManagerForUser, &type_spec_UserDataAccountManagerForUser, bases.get(), nullptr);
    if (!state->type_UserDataAccountManagerForUser)
    {
        return nullptr;
    }

    state->type_UserDataAccountStore = py::register_python_type(module.get(), type_name_UserDataAccountStore, &type_spec_UserDataAccountStore, bases.get(), nullptr);
    if (!state->type_UserDataAccountStore)
    {
        return nullptr;
    }

    state->type_UserDataAccountStoreChangedEventArgs = py::register_python_type(module.get(), type_name_UserDataAccountStoreChangedEventArgs, &type_spec_UserDataAccountStoreChangedEventArgs, bases.get(), nullptr);
