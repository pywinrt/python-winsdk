...
winrt::Windows::Web::Http::HttpProgress py::converter<winrt::Windows::Web::Http::HttpProgress>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Web::Http::HttpProgress or dict");
    ...
    if (!py_Stage) {
        PyErr_SetString(PyExc_KeyError, "Stage");
        throw python_exception();
    }
    ...
    if (!py_BytesSent) {
        PyErr_SetString(PyExc_KeyError, "BytesSent");
        throw python_exception();
    }
    ...
    if (!py_TotalBytesToSend) {
        PyErr_SetString(PyExc_KeyError, "TotalBytesToSend");
        throw python_exception();
    }
    ...
    if (!py_BytesReceived) {
        PyErr_SetString(PyExc_KeyError, "BytesReceived");
        throw python_exception();
    }
    ...
    if (!py_TotalBytesToReceive) {
        PyErr_SetString(PyExc_KeyError, "TotalBytesToReceive");
        throw python_exception();
    }
    ...
    if (!py_Retries) {
        PyErr_SetString(PyExc_KeyError, "Retries");
        throw python_exception();
    }
