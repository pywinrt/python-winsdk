...
PyMODINIT_FUNC PyInit__winsdk_Windows_Phone_PersonalInformation_Provisioning(void) noexcept
{
    ...
    state->type_ContactPartnerProvisioningManager = py::register_python_type(module.get(), type_name_ContactPartnerProvisioningManager, &type_spec_ContactPartnerProvisioningManager, nullptr, nullptr);
    if (!state->type_ContactPartnerProvisioningManager)
    {
        return nullptr;
    }

    state->type_MessagePartnerProvisioningManager = py::register_python_type(module.get(), type_name_MessagePartnerProvisioningManager, &type_spec_MessagePartnerProvisioningManager, nullptr, nullptr);
