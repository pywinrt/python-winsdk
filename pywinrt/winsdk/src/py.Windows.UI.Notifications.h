...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::AdaptiveNotificationContentKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::BadgeTemplateType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::NotificationKinds> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::NotificationMirroring> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::NotificationSetting> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::NotificationUpdateResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::PeriodicUpdateRecurrence> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::TileFlyoutTemplateType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::TileTemplateType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::ToastDismissalReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::ToastHistoryChangedType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::ToastNotificationMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::ToastNotificationPriority> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::ToastTemplateType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Notifications::UserNotificationChangedKind> = "i";
