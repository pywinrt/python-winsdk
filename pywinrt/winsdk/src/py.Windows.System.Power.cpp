...
namespace py::cpp::Windows::System::Power
{
    ...
    static PyType_Slot type_slots_BackgroundEnergyManager_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_BackgroundEnergyManager_Meta },
        { }
    };

    static PyType_Spec type_spec_BackgroundEnergyManager_Meta =
    {
        "_winsdk_Windows_System_Power.BackgroundEnergyManager_Meta",
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_ForegroundEnergyManager_Meta },
        { }
    };

    static PyType_Spec type_spec_ForegroundEnergyManager_Meta =
    {
        "_winsdk_Windows_System_Power.ForegroundEnergyManager_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_PowerManager_Meta },
        { }
    };

    static PyType_Spec type_spec_PowerManager_Meta =
    {
        "_winsdk_Windows_System_Power.PowerManager_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_System_Power(void) noexcept
{
    ...
    state->type_BackgroundEnergyManager = py::register_python_type(module.get(), type_name_BackgroundEnergyManager, &type_spec_BackgroundEnergyManager, nullptr, reinterpret_cast<PyTypeObject*>(type_BackgroundEnergyManager_Meta.get()));
    ...
    state->type_ForegroundEnergyManager = py::register_python_type(module.get(), type_name_ForegroundEnergyManager, &type_spec_ForegroundEnergyManager, nullptr, reinterpret_cast<PyTypeObject*>(type_ForegroundEnergyManager_Meta.get()));
