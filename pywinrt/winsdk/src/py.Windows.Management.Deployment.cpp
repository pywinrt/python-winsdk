...
namespace py::cpp::Windows::Management::Deployment
{
    ...
    static PyObject* register_AddPackageByAppInstallerOptions(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_DeploymentOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DeploymentProgressState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PackageInstallState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PackageState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PackageStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PackageStubPreference(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PackageTypes(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RemovalOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StubPackageOption(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Management_Deployment(void) noexcept
{
    ...
    state->type_AddPackageOptions = py::register_python_type(module.get(), type_name_AddPackageOptions, &type_spec_AddPackageOptions, bases.get());
    if (!state->type_AddPackageOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AddPackageOptions);

    state->type_AppInstallerManager = py::register_python_type(module.get(), type_name_AppInstallerManager, &type_spec_AppInstallerManager, bases.get());
    if (!state->type_AppInstallerManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppInstallerManager);

    state->type_AutoUpdateSettingsOptions = py::register_python_type(module.get(), type_name_AutoUpdateSettingsOptions, &type_spec_AutoUpdateSettingsOptions, bases.get());
    ...
    Py_INCREF(state->type_PackageAllUserProvisioningOptions);

    state->type_PackageManager = py::register_python_type(module.get(), type_name_PackageManager, &type_spec_PackageManager, bases.get());
    if (!state->type_PackageManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageManager);

    state->type_PackageManagerDebugSettings = py::register_python_type(module.get(), type_name_PackageManagerDebugSettings, &type_spec_PackageManagerDebugSettings, bases.get());
    if (!state->type_PackageManagerDebugSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageManagerDebugSettings);

    state->type_PackageUserInformation = py::register_python_type(module.get(), type_name_PackageUserInformation, &type_spec_PackageUserInformation, bases.get());
    if (!state->type_PackageUserInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageUserInformation);

    state->type_PackageVolume = py::register_python_type(module.get(), type_name_PackageVolume, &type_spec_PackageVolume, bases.get());
    if (!state->type_PackageVolume)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageVolume);

    state->type_RegisterPackageOptions = py::register_python_type(module.get(), type_name_RegisterPackageOptions, &type_spec_RegisterPackageOptions, bases.get());
    ...
    Py_INCREF(state->type_DeploymentProgress);
