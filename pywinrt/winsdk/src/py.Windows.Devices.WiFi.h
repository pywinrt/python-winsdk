...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::WiFi::WiFiAccessStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::WiFi::WiFiConnectionMethod> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::WiFi::WiFiConnectionStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::WiFi::WiFiNetworkKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::WiFi::WiFiOnDemandHotspotAvailability> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::WiFi::WiFiOnDemandHotspotCellularBars> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::WiFi::WiFiOnDemandHotspotConnectStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::WiFi::WiFiPhyKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::WiFi::WiFiReconnectionKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::WiFi::WiFiWpsConfigurationStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::WiFi::WiFiWpsKind> = "i";
