...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Input::PointerDeviceType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Input::MouseDelta> = "T{i:x:i:y:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Input::PointerDeviceUsage> = "T{I:usage_page:I:usage:i:min_logical:i:max_logical:i:min_physical:i:max_physical:I:unit:f:physical_multiplier:}";
