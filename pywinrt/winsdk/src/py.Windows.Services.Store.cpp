...
winrt::Windows::Services::Store::StorePackageUpdateStatus py::converter<winrt::Windows::Services::Store::StorePackageUpdateStatus>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Services::Store::StorePackageUpdateStatus or dict");
    ...
    if (!py_PackageFamilyName) {
        PyErr_SetString(PyExc_KeyError, "PackageFamilyName");
        throw python_exception();
    }
    ...
    if (!py_PackageDownloadSizeInBytes) {
        PyErr_SetString(PyExc_KeyError, "PackageDownloadSizeInBytes");
        throw python_exception();
    }
    ...
    if (!py_PackageBytesDownloaded) {
        PyErr_SetString(PyExc_KeyError, "PackageBytesDownloaded");
        throw python_exception();
    }
    ...
    if (!py_PackageDownloadProgress) {
        PyErr_SetString(PyExc_KeyError, "PackageDownloadProgress");
        throw python_exception();
    }
    ...
    if (!py_TotalDownloadProgress) {
        PyErr_SetString(PyExc_KeyError, "TotalDownloadProgress");
        throw python_exception();
    }
    ...
    if (!py_PackageUpdateState) {
        PyErr_SetString(PyExc_KeyError, "PackageUpdateState");
        throw python_exception();
    }
