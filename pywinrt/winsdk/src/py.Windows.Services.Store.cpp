...
namespace py::cpp::Windows::Services::Store
{
    ...
    static PyObject* register_StoreCanLicenseStatus(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_StoreConsumableStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StoreDurationUnit(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StorePackageUpdateState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StorePurchaseStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StoreQueueItemExtendedState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StoreQueueItemKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StoreQueueItemState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StoreRateAndReviewStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StoreUninstallStorePackageStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_StoreAcquireLicenseResult = "StoreAcquireLicenseResult";
    ...
    constexpr const char* const type_name_StoreAppLicense = "StoreAppLicense";
    ...
    constexpr const char* const type_name_StoreAvailability = "StoreAvailability";
    ...
    constexpr const char* const type_name_StoreCanAcquireLicenseResult = "StoreCanAcquireLicenseResult";
    ...
    constexpr const char* const type_name_StoreCollectionData = "StoreCollectionData";
    ...
    constexpr const char* const type_name_StoreConsumableResult = "StoreConsumableResult";
    ...
    // ----- StoreContext class --------------------
    constexpr const char* const type_name_StoreContext = "StoreContext";
    ...
    // ----- StoreImage class --------------------
    constexpr const char* const type_name_StoreImage = "StoreImage";
    ...
    // ----- StoreLicense class --------------------
    constexpr const char* const type_name_StoreLicense = "StoreLicense";
    ...
    constexpr const char* const type_name_StorePackageInstallOptions = "StorePackageInstallOptions";
    ...
    constexpr const char* const type_name_StorePackageLicense = "StorePackageLicense";
    ...
    constexpr const char* const type_name_StorePackageUpdate = "StorePackageUpdate";
    ...
    constexpr const char* const type_name_StorePackageUpdateResult = "StorePackageUpdateResult";
    ...
    // ----- StorePrice class --------------------
    constexpr const char* const type_name_StorePrice = "StorePrice";
    ...
    // ----- StoreProduct class --------------------
    constexpr const char* const type_name_StoreProduct = "StoreProduct";
    ...
    constexpr const char* const type_name_StoreProductOptions = "StoreProductOptions";
    ...
    constexpr const char* const type_name_StoreProductPagedQueryResult = "StoreProductPagedQueryResult";
    ...
    constexpr const char* const type_name_StoreProductQueryResult = "StoreProductQueryResult";
    ...
    constexpr const char* const type_name_StoreProductResult = "StoreProductResult";
    ...
    constexpr const char* const type_name_StorePurchaseProperties = "StorePurchaseProperties";
    ...
    constexpr const char* const type_name_StorePurchaseResult = "StorePurchaseResult";
    ...
    constexpr const char* const type_name_StoreQueueItem = "StoreQueueItem";
    ...
    constexpr const char* const type_name_StoreQueueItemCompletedEventArgs = "StoreQueueItemCompletedEventArgs";
    ...
    constexpr const char* const type_name_StoreQueueItemStatus = "StoreQueueItemStatus";
    ...
    constexpr const char* const type_name_StoreRateAndReviewResult = "StoreRateAndReviewResult";
    ...
    constexpr const char* const type_name_StoreRequestHelper = "StoreRequestHelper";
    ...
    constexpr const char* const type_name_StoreSendRequestResult = "StoreSendRequestResult";
    ...
    // ----- StoreSku class --------------------
    constexpr const char* const type_name_StoreSku = "StoreSku";
    ...
    constexpr const char* const type_name_StoreSubscriptionInfo = "StoreSubscriptionInfo";
    ...
    constexpr const char* const type_name_StoreUninstallStorePackageResult = "StoreUninstallStorePackageResult";
    ...
    // ----- StoreVideo class --------------------
    constexpr const char* const type_name_StoreVideo = "StoreVideo";
    ...
    constexpr const char* const type_name_StorePackageUpdateStatus = "StorePackageUpdateStatus";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Services_Store(void) noexcept
{
    ...
    state->type_StoreAcquireLicenseResult = py::register_python_type(module.get(), type_name_StoreAcquireLicenseResult, &type_spec_StoreAcquireLicenseResult, bases.get());
    if (!state->type_StoreAcquireLicenseResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreAcquireLicenseResult);

    state->type_StoreAppLicense = py::register_python_type(module.get(), type_name_StoreAppLicense, &type_spec_StoreAppLicense, bases.get());
    if (!state->type_StoreAppLicense)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreAppLicense);

    state->type_StoreAvailability = py::register_python_type(module.get(), type_name_StoreAvailability, &type_spec_StoreAvailability, bases.get());
    if (!state->type_StoreAvailability)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreAvailability);

    state->type_StoreCanAcquireLicenseResult = py::register_python_type(module.get(), type_name_StoreCanAcquireLicenseResult, &type_spec_StoreCanAcquireLicenseResult, bases.get());
    if (!state->type_StoreCanAcquireLicenseResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreCanAcquireLicenseResult);

    state->type_StoreCollectionData = py::register_python_type(module.get(), type_name_StoreCollectionData, &type_spec_StoreCollectionData, bases.get());
    if (!state->type_StoreCollectionData)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreCollectionData);

    state->type_StoreConsumableResult = py::register_python_type(module.get(), type_name_StoreConsumableResult, &type_spec_StoreConsumableResult, bases.get());
    if (!state->type_StoreConsumableResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreConsumableResult);

    state->type_StoreContext = py::register_python_type(module.get(), type_name_StoreContext, &type_spec_StoreContext, bases.get());
    if (!state->type_StoreContext)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreContext);

    state->type_StoreImage = py::register_python_type(module.get(), type_name_StoreImage, &type_spec_StoreImage, bases.get());
    if (!state->type_StoreImage)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreImage);

    state->type_StoreLicense = py::register_python_type(module.get(), type_name_StoreLicense, &type_spec_StoreLicense, bases.get());
    if (!state->type_StoreLicense)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreLicense);

    state->type_StorePackageInstallOptions = py::register_python_type(module.get(), type_name_StorePackageInstallOptions, &type_spec_StorePackageInstallOptions, bases.get());
    if (!state->type_StorePackageInstallOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorePackageInstallOptions);

    state->type_StorePackageLicense = py::register_python_type(module.get(), type_name_StorePackageLicense, &type_spec_StorePackageLicense, bases.get());
    if (!state->type_StorePackageLicense)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorePackageLicense);

    state->type_StorePackageUpdate = py::register_python_type(module.get(), type_name_StorePackageUpdate, &type_spec_StorePackageUpdate, bases.get());
    if (!state->type_StorePackageUpdate)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorePackageUpdate);

    state->type_StorePackageUpdateResult = py::register_python_type(module.get(), type_name_StorePackageUpdateResult, &type_spec_StorePackageUpdateResult, bases.get());
    if (!state->type_StorePackageUpdateResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorePackageUpdateResult);

    state->type_StorePrice = py::register_python_type(module.get(), type_name_StorePrice, &type_spec_StorePrice, bases.get());
    if (!state->type_StorePrice)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorePrice);

    state->type_StoreProduct = py::register_python_type(module.get(), type_name_StoreProduct, &type_spec_StoreProduct, bases.get());
    if (!state->type_StoreProduct)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreProduct);

    state->type_StoreProductOptions = py::register_python_type(module.get(), type_name_StoreProductOptions, &type_spec_StoreProductOptions, bases.get());
    if (!state->type_StoreProductOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreProductOptions);

    state->type_StoreProductPagedQueryResult = py::register_python_type(module.get(), type_name_StoreProductPagedQueryResult, &type_spec_StoreProductPagedQueryResult, bases.get());
    if (!state->type_StoreProductPagedQueryResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreProductPagedQueryResult);

    state->type_StoreProductQueryResult = py::register_python_type(module.get(), type_name_StoreProductQueryResult, &type_spec_StoreProductQueryResult, bases.get());
    if (!state->type_StoreProductQueryResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreProductQueryResult);

    state->type_StoreProductResult = py::register_python_type(module.get(), type_name_StoreProductResult, &type_spec_StoreProductResult, bases.get());
    if (!state->type_StoreProductResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreProductResult);

    state->type_StorePurchaseProperties = py::register_python_type(module.get(), type_name_StorePurchaseProperties, &type_spec_StorePurchaseProperties, bases.get());
    if (!state->type_StorePurchaseProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorePurchaseProperties);

    state->type_StorePurchaseResult = py::register_python_type(module.get(), type_name_StorePurchaseResult, &type_spec_StorePurchaseResult, bases.get());
    if (!state->type_StorePurchaseResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorePurchaseResult);

    state->type_StoreQueueItem = py::register_python_type(module.get(), type_name_StoreQueueItem, &type_spec_StoreQueueItem, bases.get());
    if (!state->type_StoreQueueItem)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreQueueItem);

    state->type_StoreQueueItemCompletedEventArgs = py::register_python_type(module.get(), type_name_StoreQueueItemCompletedEventArgs, &type_spec_StoreQueueItemCompletedEventArgs, bases.get());
    if (!state->type_StoreQueueItemCompletedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreQueueItemCompletedEventArgs);

    state->type_StoreQueueItemStatus = py::register_python_type(module.get(), type_name_StoreQueueItemStatus, &type_spec_StoreQueueItemStatus, bases.get());
    if (!state->type_StoreQueueItemStatus)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreQueueItemStatus);

    state->type_StoreRateAndReviewResult = py::register_python_type(module.get(), type_name_StoreRateAndReviewResult, &type_spec_StoreRateAndReviewResult, bases.get());
    if (!state->type_StoreRateAndReviewResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreRateAndReviewResult);

    state->type_StoreRequestHelper = py::register_python_type(module.get(), type_name_StoreRequestHelper, &type_spec_StoreRequestHelper, nullptr);
    if (!state->type_StoreRequestHelper)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreRequestHelper);

    state->type_StoreSendRequestResult = py::register_python_type(module.get(), type_name_StoreSendRequestResult, &type_spec_StoreSendRequestResult, bases.get());
    if (!state->type_StoreSendRequestResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreSendRequestResult);

    state->type_StoreSku = py::register_python_type(module.get(), type_name_StoreSku, &type_spec_StoreSku, bases.get());
    if (!state->type_StoreSku)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreSku);

    state->type_StoreSubscriptionInfo = py::register_python_type(module.get(), type_name_StoreSubscriptionInfo, &type_spec_StoreSubscriptionInfo, bases.get());
    if (!state->type_StoreSubscriptionInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreSubscriptionInfo);

    state->type_StoreUninstallStorePackageResult = py::register_python_type(module.get(), type_name_StoreUninstallStorePackageResult, &type_spec_StoreUninstallStorePackageResult, bases.get());
    if (!state->type_StoreUninstallStorePackageResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreUninstallStorePackageResult);

    state->type_StoreVideo = py::register_python_type(module.get(), type_name_StoreVideo, &type_spec_StoreVideo, bases.get());
    if (!state->type_StoreVideo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreVideo);

    state->type_StorePackageUpdateStatus = py::register_python_type(module.get(), type_name_StorePackageUpdateStatus, &type_spec_StorePackageUpdateStatus, bases.get());
    if (!state->type_StorePackageUpdateStatus)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorePackageUpdateStatus);
