...
namespace py::cpp::Windows::Graphics::Printing3D
{
    ...
    static PyObject* register_Print3DTaskCompletion(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_Print3DTaskDetail(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_Printing3DBufferFormat(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_Printing3DMeshVerificationMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_Printing3DModelUnit(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_Printing3DObjectType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_Printing3DPackageCompression(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_Printing3DTextureEdgeBehavior(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_Print3DManager = "Print3DManager";
    ...
    // ----- Print3DTask class --------------------
    constexpr const char* const type_name_Print3DTask = "Print3DTask";
    ...
    constexpr const char* const type_name_Print3DTaskCompletedEventArgs = "Print3DTaskCompletedEventArgs";
    ...
    constexpr const char* const type_name_Print3DTaskRequest = "Print3DTaskRequest";
    ...
    constexpr const char* const type_name_Print3DTaskRequestedEventArgs = "Print3DTaskRequestedEventArgs";
    ...
    constexpr const char* const type_name_Print3DTaskSourceChangedEventArgs = "Print3DTaskSourceChangedEventArgs";
    ...
    constexpr const char* const type_name_Print3DTaskSourceRequestedArgs = "Print3DTaskSourceRequestedArgs";
    ...
    constexpr const char* const type_name_Printing3D3MFPackage = "Printing3D3MFPackage";
    ...
    constexpr const char* const type_name_Printing3DBaseMaterial = "Printing3DBaseMaterial";
    ...
    constexpr const char* const type_name_Printing3DBaseMaterialGroup = "Printing3DBaseMaterialGroup";
    ...
    constexpr const char* const type_name_Printing3DColorMaterial = "Printing3DColorMaterial";
    ...
    constexpr const char* const type_name_Printing3DColorMaterialGroup = "Printing3DColorMaterialGroup";
    ...
    constexpr const char* const type_name_Printing3DComponent = "Printing3DComponent";
    ...
    constexpr const char* const type_name_Printing3DComponentWithMatrix = "Printing3DComponentWithMatrix";
    ...
    constexpr const char* const type_name_Printing3DCompositeMaterial = "Printing3DCompositeMaterial";
    ...
    constexpr const char* const type_name_Printing3DCompositeMaterialGroup = "Printing3DCompositeMaterialGroup";
    ...
    constexpr const char* const type_name_Printing3DFaceReductionOptions = "Printing3DFaceReductionOptions";
    ...
    constexpr const char* const type_name_Printing3DMaterial = "Printing3DMaterial";
    ...
    constexpr const char* const type_name_Printing3DMesh = "Printing3DMesh";
    ...
    constexpr const char* const type_name_Printing3DMeshVerificationResult = "Printing3DMeshVerificationResult";
    ...
    constexpr const char* const type_name_Printing3DModel = "Printing3DModel";
    ...
    constexpr const char* const type_name_Printing3DModelTexture = "Printing3DModelTexture";
    ...
    constexpr const char* const type_name_Printing3DMultiplePropertyMaterial = "Printing3DMultiplePropertyMaterial";
    ...
    constexpr const char* const type_name_Printing3DMultiplePropertyMaterialGroup = "Printing3DMultiplePropertyMaterialGroup";
    ...
    constexpr const char* const type_name_Printing3DTexture2CoordMaterial = "Printing3DTexture2CoordMaterial";
    ...
    constexpr const char* const type_name_Printing3DTexture2CoordMaterialGroup = "Printing3DTexture2CoordMaterialGroup";
    ...
    constexpr const char* const type_name_Printing3DTextureResource = "Printing3DTextureResource";
    ...
    constexpr const char* const type_name_Printing3DBufferDescription = "Printing3DBufferDescription";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Graphics_Printing3D(void) noexcept
{
    ...
    state->type_Print3DManager = py::register_python_type(module.get(), type_name_Print3DManager, &type_spec_Print3DManager, bases.get());
    if (!state->type_Print3DManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Print3DManager);

    state->type_Print3DTask = py::register_python_type(module.get(), type_name_Print3DTask, &type_spec_Print3DTask, bases.get());
    if (!state->type_Print3DTask)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Print3DTask);

    state->type_Print3DTaskCompletedEventArgs = py::register_python_type(module.get(), type_name_Print3DTaskCompletedEventArgs, &type_spec_Print3DTaskCompletedEventArgs, bases.get());
    if (!state->type_Print3DTaskCompletedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Print3DTaskCompletedEventArgs);

    state->type_Print3DTaskRequest = py::register_python_type(module.get(), type_name_Print3DTaskRequest, &type_spec_Print3DTaskRequest, bases.get());
    if (!state->type_Print3DTaskRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Print3DTaskRequest);

    state->type_Print3DTaskRequestedEventArgs = py::register_python_type(module.get(), type_name_Print3DTaskRequestedEventArgs, &type_spec_Print3DTaskRequestedEventArgs, bases.get());
    if (!state->type_Print3DTaskRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Print3DTaskRequestedEventArgs);

    state->type_Print3DTaskSourceChangedEventArgs = py::register_python_type(module.get(), type_name_Print3DTaskSourceChangedEventArgs, &type_spec_Print3DTaskSourceChangedEventArgs, bases.get());
    if (!state->type_Print3DTaskSourceChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Print3DTaskSourceChangedEventArgs);

    state->type_Print3DTaskSourceRequestedArgs = py::register_python_type(module.get(), type_name_Print3DTaskSourceRequestedArgs, &type_spec_Print3DTaskSourceRequestedArgs, bases.get());
    if (!state->type_Print3DTaskSourceRequestedArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Print3DTaskSourceRequestedArgs);

    state->type_Printing3D3MFPackage = py::register_python_type(module.get(), type_name_Printing3D3MFPackage, &type_spec_Printing3D3MFPackage, bases.get());
    if (!state->type_Printing3D3MFPackage)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3D3MFPackage);

    state->type_Printing3DBaseMaterial = py::register_python_type(module.get(), type_name_Printing3DBaseMaterial, &type_spec_Printing3DBaseMaterial, bases.get());
    if (!state->type_Printing3DBaseMaterial)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DBaseMaterial);

    state->type_Printing3DBaseMaterialGroup = py::register_python_type(module.get(), type_name_Printing3DBaseMaterialGroup, &type_spec_Printing3DBaseMaterialGroup, bases.get());
    if (!state->type_Printing3DBaseMaterialGroup)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DBaseMaterialGroup);

    state->type_Printing3DColorMaterial = py::register_python_type(module.get(), type_name_Printing3DColorMaterial, &type_spec_Printing3DColorMaterial, bases.get());
    if (!state->type_Printing3DColorMaterial)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DColorMaterial);

    state->type_Printing3DColorMaterialGroup = py::register_python_type(module.get(), type_name_Printing3DColorMaterialGroup, &type_spec_Printing3DColorMaterialGroup, bases.get());
    if (!state->type_Printing3DColorMaterialGroup)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DColorMaterialGroup);

    state->type_Printing3DComponent = py::register_python_type(module.get(), type_name_Printing3DComponent, &type_spec_Printing3DComponent, bases.get());
    if (!state->type_Printing3DComponent)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DComponent);

    state->type_Printing3DComponentWithMatrix = py::register_python_type(module.get(), type_name_Printing3DComponentWithMatrix, &type_spec_Printing3DComponentWithMatrix, bases.get());
    if (!state->type_Printing3DComponentWithMatrix)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DComponentWithMatrix);

    state->type_Printing3DCompositeMaterial = py::register_python_type(module.get(), type_name_Printing3DCompositeMaterial, &type_spec_Printing3DCompositeMaterial, bases.get());
    if (!state->type_Printing3DCompositeMaterial)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DCompositeMaterial);

    state->type_Printing3DCompositeMaterialGroup = py::register_python_type(module.get(), type_name_Printing3DCompositeMaterialGroup, &type_spec_Printing3DCompositeMaterialGroup, bases.get());
    if (!state->type_Printing3DCompositeMaterialGroup)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DCompositeMaterialGroup);

    state->type_Printing3DFaceReductionOptions = py::register_python_type(module.get(), type_name_Printing3DFaceReductionOptions, &type_spec_Printing3DFaceReductionOptions, bases.get());
    if (!state->type_Printing3DFaceReductionOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DFaceReductionOptions);

    state->type_Printing3DMaterial = py::register_python_type(module.get(), type_name_Printing3DMaterial, &type_spec_Printing3DMaterial, bases.get());
    if (!state->type_Printing3DMaterial)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DMaterial);

    state->type_Printing3DMesh = py::register_python_type(module.get(), type_name_Printing3DMesh, &type_spec_Printing3DMesh, bases.get());
    if (!state->type_Printing3DMesh)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DMesh);

    state->type_Printing3DMeshVerificationResult = py::register_python_type(module.get(), type_name_Printing3DMeshVerificationResult, &type_spec_Printing3DMeshVerificationResult, bases.get());
    if (!state->type_Printing3DMeshVerificationResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DMeshVerificationResult);

    state->type_Printing3DModel = py::register_python_type(module.get(), type_name_Printing3DModel, &type_spec_Printing3DModel, bases.get());
    if (!state->type_Printing3DModel)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DModel);

    state->type_Printing3DModelTexture = py::register_python_type(module.get(), type_name_Printing3DModelTexture, &type_spec_Printing3DModelTexture, bases.get());
    if (!state->type_Printing3DModelTexture)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DModelTexture);

    state->type_Printing3DMultiplePropertyMaterial = py::register_python_type(module.get(), type_name_Printing3DMultiplePropertyMaterial, &type_spec_Printing3DMultiplePropertyMaterial, bases.get());
    if (!state->type_Printing3DMultiplePropertyMaterial)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DMultiplePropertyMaterial);

    state->type_Printing3DMultiplePropertyMaterialGroup = py::register_python_type(module.get(), type_name_Printing3DMultiplePropertyMaterialGroup, &type_spec_Printing3DMultiplePropertyMaterialGroup, bases.get());
    if (!state->type_Printing3DMultiplePropertyMaterialGroup)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DMultiplePropertyMaterialGroup);

    state->type_Printing3DTexture2CoordMaterial = py::register_python_type(module.get(), type_name_Printing3DTexture2CoordMaterial, &type_spec_Printing3DTexture2CoordMaterial, bases.get());
    if (!state->type_Printing3DTexture2CoordMaterial)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DTexture2CoordMaterial);

    state->type_Printing3DTexture2CoordMaterialGroup = py::register_python_type(module.get(), type_name_Printing3DTexture2CoordMaterialGroup, &type_spec_Printing3DTexture2CoordMaterialGroup, bases.get());
    if (!state->type_Printing3DTexture2CoordMaterialGroup)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DTexture2CoordMaterialGroup);

    state->type_Printing3DTextureResource = py::register_python_type(module.get(), type_name_Printing3DTextureResource, &type_spec_Printing3DTextureResource, bases.get());
    if (!state->type_Printing3DTextureResource)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DTextureResource);

    state->type_Printing3DBufferDescription = py::register_python_type(module.get(), type_name_Printing3DBufferDescription, &type_spec_Printing3DBufferDescription, bases.get());
    if (!state->type_Printing3DBufferDescription)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Printing3DBufferDescription);
