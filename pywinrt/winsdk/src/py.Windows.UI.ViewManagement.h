...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::ApplicationViewBoundsMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::ApplicationViewMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::ApplicationViewOrientation> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::ApplicationViewState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::ApplicationViewSwitchingOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::ApplicationViewWindowingMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::FullScreenSystemOverlayMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::HandPreference> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::ScreenCaptureDisabledBehavior> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::UIColorType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::UIElementType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::UserInteractionMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::ViewSizePreference> = "i";
