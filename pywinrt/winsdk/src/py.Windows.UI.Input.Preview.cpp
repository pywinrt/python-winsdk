...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_Input_Preview(void) noexcept
{
    ...
    state->type_InputActivationListenerPreview = py::register_python_type(module.get(), type_name_InputActivationListenerPreview, &type_spec_InputActivationListenerPreview, nullptr, nullptr);
