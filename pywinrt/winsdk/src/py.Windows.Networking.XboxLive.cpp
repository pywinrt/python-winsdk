...
namespace py::cpp::Windows::Networking::XboxLive
{
    ...
    static PyType_Slot type_slots_XboxLiveDeviceAddress_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_XboxLiveDeviceAddress_Meta },
        { }
    };

    static PyType_Spec type_spec_XboxLiveDeviceAddress_Meta =
    {
        "_winsdk_Windows_Networking_XboxLive.XboxLiveDeviceAddress_Meta",
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_XboxLiveEndpointPairTemplate_Meta },
        { }
    };

    static PyType_Spec type_spec_XboxLiveEndpointPairTemplate_Meta =
    {
        "_winsdk_Windows_Networking_XboxLive.XboxLiveEndpointPairTemplate_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_XboxLiveQualityOfServiceMeasurement_Meta },
        { }
    };

    static PyType_Spec type_spec_XboxLiveQualityOfServiceMeasurement_Meta =
    {
        "_winsdk_Windows_Networking_XboxLive.XboxLiveQualityOfServiceMeasurement_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Networking_XboxLive(void) noexcept
{
    ...
    state->type_XboxLiveDeviceAddress = py::register_python_type(module.get(), type_name_XboxLiveDeviceAddress, &type_spec_XboxLiveDeviceAddress, bases.get(), reinterpret_cast<PyTypeObject*>(type_XboxLiveDeviceAddress_Meta.get()));
    if (!state->type_XboxLiveDeviceAddress)
    {
        return nullptr;
    }

    state->type_XboxLiveEndpointPair = py::register_python_type(module.get(), type_name_XboxLiveEndpointPair, &type_spec_XboxLiveEndpointPair, bases.get(), nullptr);
    if (!state->type_XboxLiveEndpointPair)
    {
        return nullptr;
    }

    state->type_XboxLiveEndpointPairCreationResult = py::register_python_type(module.get(), type_name_XboxLiveEndpointPairCreationResult, &type_spec_XboxLiveEndpointPairCreationResult, bases.get(), nullptr);
    if (!state->type_XboxLiveEndpointPairCreationResult)
    {
        return nullptr;
    }

    state->type_XboxLiveEndpointPairStateChangedEventArgs = py::register_python_type(module.get(), type_name_XboxLiveEndpointPairStateChangedEventArgs, &type_spec_XboxLiveEndpointPairStateChangedEventArgs, bases.get(), nullptr);
    ...
    state->type_XboxLiveEndpointPairTemplate = py::register_python_type(module.get(), type_name_XboxLiveEndpointPairTemplate, &type_spec_XboxLiveEndpointPairTemplate, bases.get(), reinterpret_cast<PyTypeObject*>(type_XboxLiveEndpointPairTemplate_Meta.get()));
    if (!state->type_XboxLiveEndpointPairTemplate)
    {
        return nullptr;
    }

    state->type_XboxLiveInboundEndpointPairCreatedEventArgs = py::register_python_type(module.get(), type_name_XboxLiveInboundEndpointPairCreatedEventArgs, &type_spec_XboxLiveInboundEndpointPairCreatedEventArgs, bases.get(), nullptr);
    ...
    state->type_XboxLiveQualityOfServiceMeasurement = py::register_python_type(module.get(), type_name_XboxLiveQualityOfServiceMeasurement, &type_spec_XboxLiveQualityOfServiceMeasurement, bases.get(), reinterpret_cast<PyTypeObject*>(type_XboxLiveQualityOfServiceMeasurement_Meta.get()));
    if (!state->type_XboxLiveQualityOfServiceMeasurement)
    {
        return nullptr;
    }

    state->type_XboxLiveQualityOfServiceMetricResult = py::register_python_type(module.get(), type_name_XboxLiveQualityOfServiceMetricResult, &type_spec_XboxLiveQualityOfServiceMetricResult, bases.get(), nullptr);
    if (!state->type_XboxLiveQualityOfServiceMetricResult)
    {
        return nullptr;
    }

    state->type_XboxLiveQualityOfServicePrivatePayloadResult = py::register_python_type(module.get(), type_name_XboxLiveQualityOfServicePrivatePayloadResult, &type_spec_XboxLiveQualityOfServicePrivatePayloadResult, bases.get(), nullptr);
