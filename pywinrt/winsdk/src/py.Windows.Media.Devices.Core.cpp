...
namespace py::cpp::Windows::Media::Devices::Core
{
    ...
    static PyObject* register_FrameFlashMode(PyObject* module, PyObject* type)
    {
    ...
    constexpr const char* const type_name_CameraIntrinsics = "CameraIntrinsics";
    ...
    static PyObject* CameraIntrinsics_DistortPoints(py::wrapper::Windows::Media::Devices::Core::CameraIntrinsics* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Media.Devices.Core.CameraIntrinsics", L"DistortPoints", 2))
            {
    ...
    static PyObject* CameraIntrinsics_ProjectManyOntoFrame(py::wrapper::Windows::Media::Devices::Core::CameraIntrinsics* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Media.Devices.Core.CameraIntrinsics", L"ProjectManyOntoFrame", 2))
            {
                PyErr_SetString(PyExc_AttributeError, "method 2 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    static PyObject* CameraIntrinsics_UndistortPoints(py::wrapper::Windows::Media::Devices::Core::CameraIntrinsics* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Media.Devices.Core.CameraIntrinsics", L"UndistortPoints", 2))
            {
                PyErr_SetString(PyExc_AttributeError, "method 2 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    static PyObject* CameraIntrinsics_UnprojectPixelsAtUnitDepth(py::wrapper::Windows::Media::Devices::Core::CameraIntrinsics* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Media.Devices.Core.CameraIntrinsics", L"UnprojectPixelsAtUnitDepth", 2))
            {
                PyErr_SetString(PyExc_AttributeError, "method 2 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    constexpr const char* const type_name_DepthCorrelatedCoordinateMapper = "DepthCorrelatedCoordinateMapper";
    ...
    static PyObject* DepthCorrelatedCoordinateMapper_MapPoints(py::wrapper::Windows::Media::Devices::Core::DepthCorrelatedCoordinateMapper* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 4)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Media.Devices.Core.DepthCorrelatedCoordinateMapper", L"MapPoints", 4))
            {
    ...
    static PyObject* DepthCorrelatedCoordinateMapper_UnprojectPoints(py::wrapper::Windows::Media::Devices::Core::DepthCorrelatedCoordinateMapper* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 3)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Media.Devices.Core.DepthCorrelatedCoordinateMapper", L"UnprojectPoints", 3))
            {
                PyErr_SetString(PyExc_AttributeError, "method 3 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    constexpr const char* const type_name_FrameControlCapabilities = "FrameControlCapabilities";
    ...
    constexpr const char* const type_name_FrameController = "FrameController";
    ...
    constexpr const char* const type_name_FrameExposureCapabilities = "FrameExposureCapabilities";
    ...
    constexpr const char* const type_name_FrameExposureCompensationCapabilities = "FrameExposureCompensationCapabilities";
    ...
    constexpr const char* const type_name_FrameExposureCompensationControl = "FrameExposureCompensationControl";
    ...
    constexpr const char* const type_name_FrameExposureControl = "FrameExposureControl";
    ...
    constexpr const char* const type_name_FrameFlashCapabilities = "FrameFlashCapabilities";
    ...
    constexpr const char* const type_name_FrameFlashControl = "FrameFlashControl";
    ...
    constexpr const char* const type_name_FrameFocusCapabilities = "FrameFocusCapabilities";
    ...
    constexpr const char* const type_name_FrameFocusControl = "FrameFocusControl";
    ...
    constexpr const char* const type_name_FrameIsoSpeedCapabilities = "FrameIsoSpeedCapabilities";
    ...
    constexpr const char* const type_name_FrameIsoSpeedControl = "FrameIsoSpeedControl";
    ...
    constexpr const char* const type_name_VariablePhotoSequenceController = "VariablePhotoSequenceController";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Media_Devices_Core(void) noexcept
{
    ...
    state->type_CameraIntrinsics = py::register_python_type(module.get(), type_name_CameraIntrinsics, &type_spec_CameraIntrinsics, bases.get());
    if (!state->type_CameraIntrinsics)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CameraIntrinsics);

    state->type_DepthCorrelatedCoordinateMapper = py::register_python_type(module.get(), type_name_DepthCorrelatedCoordinateMapper, &type_spec_DepthCorrelatedCoordinateMapper, bases.get());
    if (!state->type_DepthCorrelatedCoordinateMapper)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DepthCorrelatedCoordinateMapper);

    state->type_FrameControlCapabilities = py::register_python_type(module.get(), type_name_FrameControlCapabilities, &type_spec_FrameControlCapabilities, bases.get());
    if (!state->type_FrameControlCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FrameControlCapabilities);

    state->type_FrameController = py::register_python_type(module.get(), type_name_FrameController, &type_spec_FrameController, bases.get());
    if (!state->type_FrameController)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FrameController);

    state->type_FrameExposureCapabilities = py::register_python_type(module.get(), type_name_FrameExposureCapabilities, &type_spec_FrameExposureCapabilities, bases.get());
    if (!state->type_FrameExposureCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FrameExposureCapabilities);

    state->type_FrameExposureCompensationCapabilities = py::register_python_type(module.get(), type_name_FrameExposureCompensationCapabilities, &type_spec_FrameExposureCompensationCapabilities, bases.get());
    if (!state->type_FrameExposureCompensationCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FrameExposureCompensationCapabilities);

    state->type_FrameExposureCompensationControl = py::register_python_type(module.get(), type_name_FrameExposureCompensationControl, &type_spec_FrameExposureCompensationControl, bases.get());
    if (!state->type_FrameExposureCompensationControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FrameExposureCompensationControl);

    state->type_FrameExposureControl = py::register_python_type(module.get(), type_name_FrameExposureControl, &type_spec_FrameExposureControl, bases.get());
    if (!state->type_FrameExposureControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FrameExposureControl);

    state->type_FrameFlashCapabilities = py::register_python_type(module.get(), type_name_FrameFlashCapabilities, &type_spec_FrameFlashCapabilities, bases.get());
    if (!state->type_FrameFlashCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FrameFlashCapabilities);

    state->type_FrameFlashControl = py::register_python_type(module.get(), type_name_FrameFlashControl, &type_spec_FrameFlashControl, bases.get());
    if (!state->type_FrameFlashControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FrameFlashControl);

    state->type_FrameFocusCapabilities = py::register_python_type(module.get(), type_name_FrameFocusCapabilities, &type_spec_FrameFocusCapabilities, bases.get());
    if (!state->type_FrameFocusCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FrameFocusCapabilities);

    state->type_FrameFocusControl = py::register_python_type(module.get(), type_name_FrameFocusControl, &type_spec_FrameFocusControl, bases.get());
    if (!state->type_FrameFocusControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FrameFocusControl);

    state->type_FrameIsoSpeedCapabilities = py::register_python_type(module.get(), type_name_FrameIsoSpeedCapabilities, &type_spec_FrameIsoSpeedCapabilities, bases.get());
    if (!state->type_FrameIsoSpeedCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FrameIsoSpeedCapabilities);

    state->type_FrameIsoSpeedControl = py::register_python_type(module.get(), type_name_FrameIsoSpeedControl, &type_spec_FrameIsoSpeedControl, bases.get());
    if (!state->type_FrameIsoSpeedControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FrameIsoSpeedControl);

    state->type_VariablePhotoSequenceController = py::register_python_type(module.get(), type_name_VariablePhotoSequenceController, &type_spec_VariablePhotoSequenceController, bases.get());
    if (!state->type_VariablePhotoSequenceController)
    {
        return nullptr;
    }

    Py_INCREF(state->type_VariablePhotoSequenceController);
