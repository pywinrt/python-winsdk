...
winrt::Windows::Devices::Display::Core::DisplayPresentationRate py::converter<winrt::Windows::Devices::Display::Core::DisplayPresentationRate>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Devices::Display::Core::DisplayPresentationRate or dict");
    ...
    if (!py_VerticalSyncRate) {
        PyErr_SetString(PyExc_KeyError, "VerticalSyncRate");
        throw python_exception();
    }
    ...
    if (!py_VerticalSyncsPerPresentation) {
        PyErr_SetString(PyExc_KeyError, "VerticalSyncsPerPresentation");
        throw python_exception();
    }
