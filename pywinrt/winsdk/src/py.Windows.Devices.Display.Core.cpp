...
namespace py::cpp::Windows::Devices::Display::Core
{
    ...
    static PyObject* register_DisplayBitsPerChannel(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_DisplayDeviceCapability(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayManagerOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayManagerResult(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayModeQueryOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayPathScaling(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayPathStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayPresentStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayRotation(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayScanoutOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplaySourceStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayStateApplyOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayStateFunctionalizeOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayStateOperationStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayTargetPersistence(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayTaskSignalKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayWireFormatColorSpace(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayWireFormatEotf(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayWireFormatHdrMetadata(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayWireFormatPixelEncoding(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_DisplayAdapter = "DisplayAdapter";
    ...
    // ----- DisplayDevice class --------------------
    constexpr const char* const type_name_DisplayDevice = "DisplayDevice";
    ...
    // ----- DisplayFence class --------------------
    constexpr const char* const type_name_DisplayFence = "DisplayFence";
    ...
    constexpr const char* const type_name_DisplayManager = "DisplayManager";
    ...
    constexpr const char* const type_name_DisplayManagerChangedEventArgs = "DisplayManagerChangedEventArgs";
    ...
    constexpr const char* const type_name_DisplayManagerDisabledEventArgs = "DisplayManagerDisabledEventArgs";
    ...
    constexpr const char* const type_name_DisplayManagerEnabledEventArgs = "DisplayManagerEnabledEventArgs";
    ...
    constexpr const char* const type_name_DisplayManagerPathsFailedOrInvalidatedEventArgs = "DisplayManagerPathsFailedOrInvalidatedEventArgs";
    ...
    constexpr const char* const type_name_DisplayManagerResultWithState = "DisplayManagerResultWithState";
    ...
    constexpr const char* const type_name_DisplayModeInfo = "DisplayModeInfo";
    ...
    // ----- DisplayPath class --------------------
    constexpr const char* const type_name_DisplayPath = "DisplayPath";
    ...
    constexpr const char* const type_name_DisplayPrimaryDescription = "DisplayPrimaryDescription";
    ...
    constexpr const char* const type_name_DisplayScanout = "DisplayScanout";
    ...
    // ----- DisplaySource class --------------------
    constexpr const char* const type_name_DisplaySource = "DisplaySource";
    ...
    // ----- DisplayState class --------------------
    constexpr const char* const type_name_DisplayState = "DisplayState";
    ...
    constexpr const char* const type_name_DisplayStateOperationResult = "DisplayStateOperationResult";
    ...
    constexpr const char* const type_name_DisplaySurface = "DisplaySurface";
    ...
    // ----- DisplayTarget class --------------------
    constexpr const char* const type_name_DisplayTarget = "DisplayTarget";
    ...
    // ----- DisplayTask class --------------------
    constexpr const char* const type_name_DisplayTask = "DisplayTask";
    ...
    constexpr const char* const type_name_DisplayTaskPool = "DisplayTaskPool";
    ...
    constexpr const char* const type_name_DisplayTaskResult = "DisplayTaskResult";
    ...
    // ----- DisplayView class --------------------
    constexpr const char* const type_name_DisplayView = "DisplayView";
    ...
    constexpr const char* const type_name_DisplayWireFormat = "DisplayWireFormat";
    ...
    constexpr const char* const type_name_DisplayPresentationRate = "DisplayPresentationRate";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Display_Core(void) noexcept
{
    ...
    state->type_DisplayAdapter = py::register_python_type(module.get(), type_name_DisplayAdapter, &type_spec_DisplayAdapter, bases.get());
    if (!state->type_DisplayAdapter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayAdapter);

    state->type_DisplayDevice = py::register_python_type(module.get(), type_name_DisplayDevice, &type_spec_DisplayDevice, bases.get());
    if (!state->type_DisplayDevice)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayDevice);

    state->type_DisplayFence = py::register_python_type(module.get(), type_name_DisplayFence, &type_spec_DisplayFence, bases.get());
    if (!state->type_DisplayFence)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayFence);

    state->type_DisplayManager = py::register_python_type(module.get(), type_name_DisplayManager, &type_spec_DisplayManager, bases.get());
    if (!state->type_DisplayManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayManager);

    state->type_DisplayManagerChangedEventArgs = py::register_python_type(module.get(), type_name_DisplayManagerChangedEventArgs, &type_spec_DisplayManagerChangedEventArgs, bases.get());
    if (!state->type_DisplayManagerChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayManagerChangedEventArgs);

    state->type_DisplayManagerDisabledEventArgs = py::register_python_type(module.get(), type_name_DisplayManagerDisabledEventArgs, &type_spec_DisplayManagerDisabledEventArgs, bases.get());
    if (!state->type_DisplayManagerDisabledEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayManagerDisabledEventArgs);

    state->type_DisplayManagerEnabledEventArgs = py::register_python_type(module.get(), type_name_DisplayManagerEnabledEventArgs, &type_spec_DisplayManagerEnabledEventArgs, bases.get());
    if (!state->type_DisplayManagerEnabledEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayManagerEnabledEventArgs);

    state->type_DisplayManagerPathsFailedOrInvalidatedEventArgs = py::register_python_type(module.get(), type_name_DisplayManagerPathsFailedOrInvalidatedEventArgs, &type_spec_DisplayManagerPathsFailedOrInvalidatedEventArgs, bases.get());
    if (!state->type_DisplayManagerPathsFailedOrInvalidatedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayManagerPathsFailedOrInvalidatedEventArgs);

    state->type_DisplayManagerResultWithState = py::register_python_type(module.get(), type_name_DisplayManagerResultWithState, &type_spec_DisplayManagerResultWithState, bases.get());
    if (!state->type_DisplayManagerResultWithState)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayManagerResultWithState);

    state->type_DisplayModeInfo = py::register_python_type(module.get(), type_name_DisplayModeInfo, &type_spec_DisplayModeInfo, bases.get());
    if (!state->type_DisplayModeInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayModeInfo);

    state->type_DisplayPath = py::register_python_type(module.get(), type_name_DisplayPath, &type_spec_DisplayPath, bases.get());
    if (!state->type_DisplayPath)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayPath);

    state->type_DisplayPrimaryDescription = py::register_python_type(module.get(), type_name_DisplayPrimaryDescription, &type_spec_DisplayPrimaryDescription, bases.get());
    if (!state->type_DisplayPrimaryDescription)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayPrimaryDescription);

    state->type_DisplayScanout = py::register_python_type(module.get(), type_name_DisplayScanout, &type_spec_DisplayScanout, bases.get());
    if (!state->type_DisplayScanout)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayScanout);

    state->type_DisplaySource = py::register_python_type(module.get(), type_name_DisplaySource, &type_spec_DisplaySource, bases.get());
    if (!state->type_DisplaySource)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplaySource);

    state->type_DisplayState = py::register_python_type(module.get(), type_name_DisplayState, &type_spec_DisplayState, bases.get());
    if (!state->type_DisplayState)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayState);

    state->type_DisplayStateOperationResult = py::register_python_type(module.get(), type_name_DisplayStateOperationResult, &type_spec_DisplayStateOperationResult, bases.get());
    if (!state->type_DisplayStateOperationResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayStateOperationResult);

    state->type_DisplaySurface = py::register_python_type(module.get(), type_name_DisplaySurface, &type_spec_DisplaySurface, bases.get());
    if (!state->type_DisplaySurface)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplaySurface);

    state->type_DisplayTarget = py::register_python_type(module.get(), type_name_DisplayTarget, &type_spec_DisplayTarget, bases.get());
    if (!state->type_DisplayTarget)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayTarget);

    state->type_DisplayTask = py::register_python_type(module.get(), type_name_DisplayTask, &type_spec_DisplayTask, bases.get());
    if (!state->type_DisplayTask)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayTask);

    state->type_DisplayTaskPool = py::register_python_type(module.get(), type_name_DisplayTaskPool, &type_spec_DisplayTaskPool, bases.get());
    if (!state->type_DisplayTaskPool)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayTaskPool);

    state->type_DisplayTaskResult = py::register_python_type(module.get(), type_name_DisplayTaskResult, &type_spec_DisplayTaskResult, bases.get());
    if (!state->type_DisplayTaskResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayTaskResult);

    state->type_DisplayView = py::register_python_type(module.get(), type_name_DisplayView, &type_spec_DisplayView, bases.get());
    if (!state->type_DisplayView)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayView);

    state->type_DisplayWireFormat = py::register_python_type(module.get(), type_name_DisplayWireFormat, &type_spec_DisplayWireFormat, bases.get());
    if (!state->type_DisplayWireFormat)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayWireFormat);

    state->type_DisplayPresentationRate = py::register_python_type(module.get(), type_name_DisplayPresentationRate, &type_spec_DisplayPresentationRate, bases.get());
    if (!state->type_DisplayPresentationRate)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayPresentationRate);
