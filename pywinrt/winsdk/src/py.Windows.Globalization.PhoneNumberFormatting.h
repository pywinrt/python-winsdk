...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::PhoneNumberFormatting::PhoneNumberFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::PhoneNumberFormatting::PhoneNumberMatchResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::PhoneNumberFormatting::PhoneNumberParseResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::PhoneNumberFormatting::PredictedPhoneNumberKind> = "i";
