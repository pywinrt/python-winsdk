...
namespace py::cpp::Windows::Security::Cryptography
{
    ...
    static PyObject* register_BinaryStringEncoding(PyObject* module, PyObject* type)
    {
    ...
    constexpr const char* const type_name_CryptographicBuffer = "CryptographicBuffer";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Security_Cryptography(void) noexcept
{
    ...
    state->type_CryptographicBuffer = py::register_python_type(module.get(), type_name_CryptographicBuffer, &type_spec_CryptographicBuffer, nullptr);
    if (!state->type_CryptographicBuffer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CryptographicBuffer);
