...
namespace py::cpp::Windows::UI::Input::Inking
{
    ...
    static PyObject* register_HandwritingLineHeight(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_InkDrawingAttributesKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InkHighContrastAdjustment(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InkInputProcessingMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InkInputRightDragAction(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InkManipulationMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InkPersistenceFormat(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InkPresenterPredefinedConfiguration(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InkPresenterStencilKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InkRecognitionTarget(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PenHandedness(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PenTipShape(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_InkDrawingAttributes = "InkDrawingAttributes";
    ...
    constexpr const char* const type_name_InkDrawingAttributesPencilProperties = "InkDrawingAttributesPencilProperties";
    ...
    constexpr const char* const type_name_InkInputConfiguration = "InkInputConfiguration";
    ...
    constexpr const char* const type_name_InkInputProcessingConfiguration = "InkInputProcessingConfiguration";
    ...
    // ----- InkManager class --------------------
    constexpr const char* const type_name_InkManager = "InkManager";
    ...
    constexpr const char* const type_name_InkModelerAttributes = "InkModelerAttributes";
    ...
    // ----- InkPoint class --------------------
    constexpr const char* const type_name_InkPoint = "InkPoint";
    ...
    // ----- InkPresenter class --------------------
    constexpr const char* const type_name_InkPresenter = "InkPresenter";
    ...
    constexpr const char* const type_name_InkPresenterProtractor = "InkPresenterProtractor";
    ...
    constexpr const char* const type_name_InkPresenterRuler = "InkPresenterRuler";
    ...
    constexpr const char* const type_name_InkRecognitionResult = "InkRecognitionResult";
    ...
    // ----- InkRecognizer class --------------------
    constexpr const char* const type_name_InkRecognizer = "InkRecognizer";
    ...
    constexpr const char* const type_name_InkRecognizerContainer = "InkRecognizerContainer";
    ...
    // ----- InkStroke class --------------------
    constexpr const char* const type_name_InkStroke = "InkStroke";
    ...
    constexpr const char* const type_name_InkStrokeBuilder = "InkStrokeBuilder";
    ...
    constexpr const char* const type_name_InkStrokeContainer = "InkStrokeContainer";
    ...
    constexpr const char* const type_name_InkStrokeInput = "InkStrokeInput";
    ...
    constexpr const char* const type_name_InkStrokeRenderingSegment = "InkStrokeRenderingSegment";
    ...
    constexpr const char* const type_name_InkStrokesCollectedEventArgs = "InkStrokesCollectedEventArgs";
    ...
    constexpr const char* const type_name_InkStrokesErasedEventArgs = "InkStrokesErasedEventArgs";
    ...
    constexpr const char* const type_name_InkSynchronizer = "InkSynchronizer";
    ...
    constexpr const char* const type_name_InkUnprocessedInput = "InkUnprocessedInput";
    ...
    constexpr const char* const type_name_PenAndInkSettings = "PenAndInkSettings";
    ...
    constexpr const char* const type_name_IInkPointFactory = "IInkPointFactory";
    ...
    constexpr const char* const type_name_IInkPresenterRulerFactory = "IInkPresenterRulerFactory";
    ...
    constexpr const char* const type_name_IInkPresenterStencil = "IInkPresenterStencil";
    ...
    constexpr const char* const type_name_IInkRecognizerContainer = "IInkRecognizerContainer";
    ...
    constexpr const char* const type_name_IInkStrokeContainer = "IInkStrokeContainer";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_Input_Inking(void) noexcept
{
    ...
    state->type_InkDrawingAttributes = py::register_python_type(module.get(), type_name_InkDrawingAttributes, &type_spec_InkDrawingAttributes, bases.get());
    if (!state->type_InkDrawingAttributes)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkDrawingAttributes);

    state->type_InkDrawingAttributesPencilProperties = py::register_python_type(module.get(), type_name_InkDrawingAttributesPencilProperties, &type_spec_InkDrawingAttributesPencilProperties, bases.get());
    if (!state->type_InkDrawingAttributesPencilProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkDrawingAttributesPencilProperties);

    state->type_InkInputConfiguration = py::register_python_type(module.get(), type_name_InkInputConfiguration, &type_spec_InkInputConfiguration, bases.get());
    if (!state->type_InkInputConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkInputConfiguration);

    state->type_InkInputProcessingConfiguration = py::register_python_type(module.get(), type_name_InkInputProcessingConfiguration, &type_spec_InkInputProcessingConfiguration, bases.get());
    if (!state->type_InkInputProcessingConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkInputProcessingConfiguration);

    state->type_InkManager = py::register_python_type(module.get(), type_name_InkManager, &type_spec_InkManager, bases.get());
    if (!state->type_InkManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkManager);

    state->type_InkModelerAttributes = py::register_python_type(module.get(), type_name_InkModelerAttributes, &type_spec_InkModelerAttributes, bases.get());
    if (!state->type_InkModelerAttributes)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkModelerAttributes);

    state->type_InkPoint = py::register_python_type(module.get(), type_name_InkPoint, &type_spec_InkPoint, bases.get());
    if (!state->type_InkPoint)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkPoint);

    state->type_InkPresenter = py::register_python_type(module.get(), type_name_InkPresenter, &type_spec_InkPresenter, bases.get());
    if (!state->type_InkPresenter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkPresenter);

    state->type_InkPresenterProtractor = py::register_python_type(module.get(), type_name_InkPresenterProtractor, &type_spec_InkPresenterProtractor, bases.get());
    if (!state->type_InkPresenterProtractor)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkPresenterProtractor);

    state->type_InkPresenterRuler = py::register_python_type(module.get(), type_name_InkPresenterRuler, &type_spec_InkPresenterRuler, bases.get());
    if (!state->type_InkPresenterRuler)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkPresenterRuler);

    state->type_InkRecognitionResult = py::register_python_type(module.get(), type_name_InkRecognitionResult, &type_spec_InkRecognitionResult, bases.get());
    if (!state->type_InkRecognitionResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkRecognitionResult);

    state->type_InkRecognizer = py::register_python_type(module.get(), type_name_InkRecognizer, &type_spec_InkRecognizer, bases.get());
    if (!state->type_InkRecognizer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkRecognizer);

    state->type_InkRecognizerContainer = py::register_python_type(module.get(), type_name_InkRecognizerContainer, &type_spec_InkRecognizerContainer, bases.get());
    if (!state->type_InkRecognizerContainer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkRecognizerContainer);

    state->type_InkStroke = py::register_python_type(module.get(), type_name_InkStroke, &type_spec_InkStroke, bases.get());
    if (!state->type_InkStroke)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkStroke);

    state->type_InkStrokeBuilder = py::register_python_type(module.get(), type_name_InkStrokeBuilder, &type_spec_InkStrokeBuilder, bases.get());
    if (!state->type_InkStrokeBuilder)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkStrokeBuilder);

    state->type_InkStrokeContainer = py::register_python_type(module.get(), type_name_InkStrokeContainer, &type_spec_InkStrokeContainer, bases.get());
    if (!state->type_InkStrokeContainer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkStrokeContainer);

    state->type_InkStrokeInput = py::register_python_type(module.get(), type_name_InkStrokeInput, &type_spec_InkStrokeInput, bases.get());
    if (!state->type_InkStrokeInput)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkStrokeInput);

    state->type_InkStrokeRenderingSegment = py::register_python_type(module.get(), type_name_InkStrokeRenderingSegment, &type_spec_InkStrokeRenderingSegment, bases.get());
    if (!state->type_InkStrokeRenderingSegment)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkStrokeRenderingSegment);

    state->type_InkStrokesCollectedEventArgs = py::register_python_type(module.get(), type_name_InkStrokesCollectedEventArgs, &type_spec_InkStrokesCollectedEventArgs, bases.get());
    if (!state->type_InkStrokesCollectedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkStrokesCollectedEventArgs);

    state->type_InkStrokesErasedEventArgs = py::register_python_type(module.get(), type_name_InkStrokesErasedEventArgs, &type_spec_InkStrokesErasedEventArgs, bases.get());
    if (!state->type_InkStrokesErasedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkStrokesErasedEventArgs);

    state->type_InkSynchronizer = py::register_python_type(module.get(), type_name_InkSynchronizer, &type_spec_InkSynchronizer, bases.get());
    if (!state->type_InkSynchronizer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkSynchronizer);

    state->type_InkUnprocessedInput = py::register_python_type(module.get(), type_name_InkUnprocessedInput, &type_spec_InkUnprocessedInput, bases.get());
    if (!state->type_InkUnprocessedInput)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InkUnprocessedInput);

    state->type_PenAndInkSettings = py::register_python_type(module.get(), type_name_PenAndInkSettings, &type_spec_PenAndInkSettings, bases.get());
    if (!state->type_PenAndInkSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PenAndInkSettings);

    state->type_IInkPointFactory = py::register_python_type(module.get(), type_name_IInkPointFactory, &type_spec_IInkPointFactory, bases.get());
    if (!state->type_IInkPointFactory)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IInkPointFactory);

    state->type_IInkPresenterRulerFactory = py::register_python_type(module.get(), type_name_IInkPresenterRulerFactory, &type_spec_IInkPresenterRulerFactory, bases.get());
    if (!state->type_IInkPresenterRulerFactory)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IInkPresenterRulerFactory);

    state->type_IInkPresenterStencil = py::register_python_type(module.get(), type_name_IInkPresenterStencil, &type_spec_IInkPresenterStencil, bases.get());
    if (!state->type_IInkPresenterStencil)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IInkPresenterStencil);

    state->type_IInkRecognizerContainer = py::register_python_type(module.get(), type_name_IInkRecognizerContainer, &type_spec_IInkRecognizerContainer, bases.get());
    if (!state->type_IInkRecognizerContainer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IInkRecognizerContainer);

    state->type_IInkStrokeContainer = py::register_python_type(module.get(), type_name_IInkStrokeContainer, &type_spec_IInkStrokeContainer, bases.get());
    if (!state->type_IInkStrokeContainer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IInkStrokeContainer);
