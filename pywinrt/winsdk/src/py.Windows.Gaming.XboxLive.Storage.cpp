...
namespace py::cpp::Windows::Gaming::XboxLive::Storage
{
    ...
    static PyObject* register_GameSaveErrorStatus(PyObject* module, PyObject* type)
    {
    ...
    constexpr const char* const type_name_GameSaveBlobGetResult = "GameSaveBlobGetResult";
    ...
    constexpr const char* const type_name_GameSaveBlobInfo = "GameSaveBlobInfo";
    ...
    constexpr const char* const type_name_GameSaveBlobInfoGetResult = "GameSaveBlobInfoGetResult";
    ...
    constexpr const char* const type_name_GameSaveBlobInfoQuery = "GameSaveBlobInfoQuery";
    ...
    constexpr const char* const type_name_GameSaveContainer = "GameSaveContainer";
    ...
    constexpr const char* const type_name_GameSaveContainerInfo = "GameSaveContainerInfo";
    ...
    constexpr const char* const type_name_GameSaveContainerInfoGetResult = "GameSaveContainerInfoGetResult";
    ...
    constexpr const char* const type_name_GameSaveContainerInfoQuery = "GameSaveContainerInfoQuery";
    ...
    constexpr const char* const type_name_GameSaveOperationResult = "GameSaveOperationResult";
    ...
    constexpr const char* const type_name_GameSaveProvider = "GameSaveProvider";
    ...
    constexpr const char* const type_name_GameSaveProviderGetResult = "GameSaveProviderGetResult";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Gaming_XboxLive_Storage(void) noexcept
{
    ...
    state->type_GameSaveBlobGetResult = py::register_python_type(module.get(), type_name_GameSaveBlobGetResult, &type_spec_GameSaveBlobGetResult, bases.get());
    if (!state->type_GameSaveBlobGetResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameSaveBlobGetResult);

    state->type_GameSaveBlobInfo = py::register_python_type(module.get(), type_name_GameSaveBlobInfo, &type_spec_GameSaveBlobInfo, bases.get());
    if (!state->type_GameSaveBlobInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameSaveBlobInfo);

    state->type_GameSaveBlobInfoGetResult = py::register_python_type(module.get(), type_name_GameSaveBlobInfoGetResult, &type_spec_GameSaveBlobInfoGetResult, bases.get());
    if (!state->type_GameSaveBlobInfoGetResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameSaveBlobInfoGetResult);

    state->type_GameSaveBlobInfoQuery = py::register_python_type(module.get(), type_name_GameSaveBlobInfoQuery, &type_spec_GameSaveBlobInfoQuery, bases.get());
    if (!state->type_GameSaveBlobInfoQuery)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameSaveBlobInfoQuery);

    state->type_GameSaveContainer = py::register_python_type(module.get(), type_name_GameSaveContainer, &type_spec_GameSaveContainer, bases.get());
    if (!state->type_GameSaveContainer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameSaveContainer);

    state->type_GameSaveContainerInfo = py::register_python_type(module.get(), type_name_GameSaveContainerInfo, &type_spec_GameSaveContainerInfo, bases.get());
    if (!state->type_GameSaveContainerInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameSaveContainerInfo);

    state->type_GameSaveContainerInfoGetResult = py::register_python_type(module.get(), type_name_GameSaveContainerInfoGetResult, &type_spec_GameSaveContainerInfoGetResult, bases.get());
    if (!state->type_GameSaveContainerInfoGetResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameSaveContainerInfoGetResult);

    state->type_GameSaveContainerInfoQuery = py::register_python_type(module.get(), type_name_GameSaveContainerInfoQuery, &type_spec_GameSaveContainerInfoQuery, bases.get());
    if (!state->type_GameSaveContainerInfoQuery)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameSaveContainerInfoQuery);

    state->type_GameSaveOperationResult = py::register_python_type(module.get(), type_name_GameSaveOperationResult, &type_spec_GameSaveOperationResult, bases.get());
    if (!state->type_GameSaveOperationResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameSaveOperationResult);

    state->type_GameSaveProvider = py::register_python_type(module.get(), type_name_GameSaveProvider, &type_spec_GameSaveProvider, bases.get());
    if (!state->type_GameSaveProvider)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameSaveProvider);

    state->type_GameSaveProviderGetResult = py::register_python_type(module.get(), type_name_GameSaveProviderGetResult, &type_spec_GameSaveProviderGetResult, bases.get());
    if (!state->type_GameSaveProviderGetResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameSaveProviderGetResult);
