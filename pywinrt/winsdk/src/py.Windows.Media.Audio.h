...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::AudioDeviceNodeCreationStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::AudioFileNodeCreationStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::AudioGraphCreationStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::AudioGraphUnrecoverableError> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::AudioNodeEmitterDecayKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::AudioNodeEmitterSettings> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::AudioNodeEmitterShapeKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::AudioPlaybackConnectionOpenResultStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::AudioPlaybackConnectionState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::MediaSourceAudioInputNodeCreationStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::MixedRealitySpatialAudioFormatPolicy> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::QuantumSizeSelectionMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::SetDefaultSpatialAudioFormatStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Audio::SpatialAudioModel> = "i";
