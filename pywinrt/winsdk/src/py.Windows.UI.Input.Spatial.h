...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Spatial::SpatialGestureSettings> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Spatial::SpatialInteractionPressKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Spatial::SpatialInteractionSourceHandedness> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Spatial::SpatialInteractionSourceKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Spatial::SpatialInteractionSourcePositionAccuracy> = "i";
