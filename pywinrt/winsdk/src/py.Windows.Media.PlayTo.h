...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::PlayTo::PlayToConnectionError> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::PlayTo::PlayToConnectionState> = "i";
