...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Display::Core::HdmiDisplayColorSpace> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Display::Core::HdmiDisplayHdrOption> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Display::Core::HdmiDisplayPixelEncoding> = "i";
