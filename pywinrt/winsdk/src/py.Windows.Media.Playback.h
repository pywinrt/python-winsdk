...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::AutoLoadedDisplayPropertyKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::FailedMediaStreamKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::MediaBreakInsertionMethod> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::MediaCommandEnablingRule> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::MediaPlaybackItemChangedReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::MediaPlaybackItemErrorCode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::MediaPlaybackSessionVideoConstrictionReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::MediaPlaybackState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::MediaPlayerAudioCategory> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::MediaPlayerAudioDeviceType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::MediaPlayerError> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::MediaPlayerState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::SphericalVideoProjectionMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::StereoscopicVideoRenderMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Playback::TimedMetadataTrackPresentationMode> = "i";
