...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::Custom::GipFirmwareUpdateStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::Custom::GipMessageClass> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::Custom::XusbDeviceSubtype> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::Custom::XusbDeviceType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::Custom::GameControllerVersionInfo> = "T{H:major:H:minor:H:build:H:revision:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::Custom::GipFirmwareUpdateProgress> = "T{d:percent_completed:I:current_component_id:}";
