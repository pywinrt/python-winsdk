...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::CellularApnAuthenticationType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::ConnectionProfileDeleteStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::DataUsageGranularity> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::DomainAuthenticationKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::DomainConnectivityLevel> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::NetworkAuthenticationType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::NetworkConnectivityLevel> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::NetworkCostType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::NetworkEncryptionType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::NetworkTypes> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::RoamingStates> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::TriStates> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::WwanDataClass> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::WwanNetworkIPKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::WwanNetworkRegistrationState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Connectivity::NetworkUsageStates> = "T{i:roaming:i:shared:}";
