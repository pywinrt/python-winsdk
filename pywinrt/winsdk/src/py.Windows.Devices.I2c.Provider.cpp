...
winrt::Windows::Devices::I2c::Provider::ProviderI2cTransferResult py::converter<winrt::Windows::Devices::I2c::Provider::ProviderI2cTransferResult>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Devices::I2c::Provider::ProviderI2cTransferResult or dict");
    ...
    if (!py_Status) {
        PyErr_SetString(PyExc_KeyError, "Status");
        throw python_exception();
    }
    ...
    if (!py_BytesTransferred) {
        PyErr_SetString(PyExc_KeyError, "BytesTransferred");
        throw python_exception();
    }
