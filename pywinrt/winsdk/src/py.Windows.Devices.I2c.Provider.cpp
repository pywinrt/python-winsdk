...
namespace py::cpp::Windows::Devices::I2c::Provider
{
    ...
    static PyObject* II2cDeviceProvider_Read(py::wrapper::Windows::Devices::I2c::Provider::II2cDeviceProvider* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Devices.I2c.Provider.II2cDeviceProvider", L"Read", 1))
            {
                PyErr_SetString(PyExc_AttributeError, "method 1 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    static PyObject* II2cDeviceProvider_ReadPartial(py::wrapper::Windows::Devices::I2c::Provider::II2cDeviceProvider* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Devices.I2c.Provider.II2cDeviceProvider", L"ReadPartial", 1))
            {
                PyErr_SetString(PyExc_AttributeError, "method 1 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    static PyObject* II2cDeviceProvider_WriteRead(py::wrapper::Windows::Devices::I2c::Provider::II2cDeviceProvider* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Devices.I2c.Provider.II2cDeviceProvider", L"WriteRead", 2))
            {
    ...
    static PyObject* II2cDeviceProvider_WriteReadPartial(py::wrapper::Windows::Devices::I2c::Provider::II2cDeviceProvider* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Devices.I2c.Provider.II2cDeviceProvider", L"WriteReadPartial", 2))
            {
                PyErr_SetString(PyExc_AttributeError, "method 2 args is not available in this version of Windows");
                return nullptr;
            }
