...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::HandwritingLineHeight> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::InkDrawingAttributesKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::InkHighContrastAdjustment> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::InkInputProcessingMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::InkInputRightDragAction> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::InkManipulationMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::InkPersistenceFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::InkPresenterPredefinedConfiguration> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::InkPresenterStencilKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::InkRecognitionTarget> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::PenHandedness> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::Inking::PenTipShape> = "i";
