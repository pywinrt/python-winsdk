...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::AsyncStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::PropertyType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::event_token> = "T{q:value:}";

    template<>
    constexpr const char* buffer_format<winrt::hresult> = "T{i:value:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Point> = "T{f:x:f:y:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Rect> = "T{f:x:f:y:f:width:f:height:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Size> = "T{f:width:f:height:}";
