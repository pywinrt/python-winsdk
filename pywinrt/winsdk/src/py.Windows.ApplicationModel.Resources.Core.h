...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Resources::Core::ResourceCandidateKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Resources::Core::ResourceQualifierPersistence> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Resources::Core::ResourceLayoutInfo> = "T{I:major_version:I:minor_version:I:resource_subtree_count:I:named_resource_count:i:checksum:}";
