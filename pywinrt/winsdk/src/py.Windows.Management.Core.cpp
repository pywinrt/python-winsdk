...
PyMODINIT_FUNC PyInit__winsdk_Windows_Management_Core(void) noexcept
{
    ...
    state->type_ApplicationDataManager = py::register_python_type(module.get(), type_name_ApplicationDataManager, &type_spec_ApplicationDataManager, bases.get(), nullptr);
