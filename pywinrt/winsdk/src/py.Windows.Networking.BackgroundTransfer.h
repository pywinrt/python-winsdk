...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::BackgroundTransfer::BackgroundTransferBehavior> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::BackgroundTransfer::BackgroundTransferCostPolicy> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::BackgroundTransfer::BackgroundTransferPriority> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::BackgroundTransfer::BackgroundTransferStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::BackgroundTransfer::BackgroundDownloadProgress> = "T{Q:bytes_received:Q:total_bytes_to_receive:i:status:?:has_response_changed:?:has_restarted:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::BackgroundTransfer::BackgroundTransferFileRange> = "T{Q:offset:Q:length:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::BackgroundTransfer::BackgroundUploadProgress> = "T{Q:bytes_received:Q:bytes_sent:Q:total_bytes_to_receive:Q:total_bytes_to_send:i:status:?:has_response_changed:?:has_restarted:}";
