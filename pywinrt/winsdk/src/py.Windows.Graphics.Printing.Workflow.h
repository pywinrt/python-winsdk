...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::Workflow::PdlConversionHostBasedProcessingOperations> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowAttributesMergePolicy> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobAbortReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlConversionType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPrinterJobStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowSessionStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowSubmittedStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowUICompletionStatus> = "i";
