...
winrt::Windows::UI::Input::CrossSlideThresholds py::converter<winrt::Windows::UI::Input::CrossSlideThresholds>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Input::CrossSlideThresholds or dict");
    ...
    if (!py_SelectionStart) {
        PyErr_SetString(PyExc_KeyError, "SelectionStart");
        throw python_exception();
    }
    ...
    if (!py_SpeedBumpStart) {
        PyErr_SetString(PyExc_KeyError, "SpeedBumpStart");
        throw python_exception();
    }
    ...
    if (!py_SpeedBumpEnd) {
        PyErr_SetString(PyExc_KeyError, "SpeedBumpEnd");
        throw python_exception();
    }
    ...
    if (!py_RearrangeStart) {
        PyErr_SetString(PyExc_KeyError, "RearrangeStart");
        throw python_exception();
    }
...
winrt::Windows::UI::Input::ManipulationDelta py::converter<winrt::Windows::UI::Input::ManipulationDelta>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Input::ManipulationDelta or dict");
        throw python_exception();
    }
    ...
    if (!py_Translation) {
        PyErr_SetString(PyExc_KeyError, "Translation");
        throw python_exception();
    }
    ...
    if (!py_Scale) {
        PyErr_SetString(PyExc_KeyError, "Scale");
        throw python_exception();
    }
    ...
    if (!py_Rotation) {
        PyErr_SetString(PyExc_KeyError, "Rotation");
        throw python_exception();
    }
    ...
    if (!py_Expansion) {
        PyErr_SetString(PyExc_KeyError, "Expansion");
        throw python_exception();
    }
...
winrt::Windows::UI::Input::ManipulationVelocities py::converter<winrt::Windows::UI::Input::ManipulationVelocities>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Input::ManipulationVelocities or dict");
        throw python_exception();
    }
    ...
    if (!py_Linear) {
        PyErr_SetString(PyExc_KeyError, "Linear");
        throw python_exception();
    }
    ...
    if (!py_Angular) {
        PyErr_SetString(PyExc_KeyError, "Angular");
        throw python_exception();
    }
