...
{
    auto type = py::get_python_type<winrt::Windows::UI::Input::CrossSlideThresholds>();
    if (!type)
    {
        return nullptr;
    }
...
winrt::Windows::UI::Input::CrossSlideThresholds py::converter<winrt::Windows::UI::Input::CrossSlideThresholds>::convert_to(PyObject* obj)
{
    ...
    PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Input::CrossSlideThresholds");
    throw python_exception();
}
...
{
    auto type = py::get_python_type<winrt::Windows::UI::Input::ManipulationDelta>();
    if (!type)
    {
        return nullptr;
    }
...
winrt::Windows::UI::Input::ManipulationDelta py::converter<winrt::Windows::UI::Input::ManipulationDelta>::convert_to(PyObject* obj)
{
    ...
    PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Input::ManipulationDelta");
    throw python_exception();
}
...
{
    auto type = py::get_python_type<winrt::Windows::UI::Input::ManipulationVelocities>();
    if (!type)
    {
        return nullptr;
    }
...
winrt::Windows::UI::Input::ManipulationVelocities py::converter<winrt::Windows::UI::Input::ManipulationVelocities>::convert_to(PyObject* obj)
{
    ...
    PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Input::ManipulationVelocities");
    throw python_exception();
}
...
namespace py::cpp::Windows::UI::Input
{
    struct module_state
    {
        PyObject* type_CrossSlidingState;
        PyObject* type_DraggingState;
        PyObject* type_EdgeGestureKind;
        PyObject* type_GazeInputAccessStatus;
        PyObject* type_GestureSettings;
        PyObject* type_HoldingState;
        PyObject* type_InputActivationState;
        PyObject* type_PointerUpdateKind;
        PyObject* type_RadialControllerMenuKnownIcon;
        PyObject* type_RadialControllerSystemMenuItemKind;
    ...
    static PyObject* register_CrossSlidingState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);

        if (state->type_CrossSlidingState)
        {
        ...
        state->type_CrossSlidingState = type;
        Py_INCREF(state->type_CrossSlidingState);


        Py_RETURN_NONE;
    }

    static PyObject* register_DraggingState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);

        if (state->type_DraggingState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_DraggingState = type;
        Py_INCREF(state->type_DraggingState);


        Py_RETURN_NONE;
    }

    static PyObject* register_EdgeGestureKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);

        if (state->type_EdgeGestureKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EdgeGestureKind = type;
        Py_INCREF(state->type_EdgeGestureKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_GazeInputAccessStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);

        if (state->type_GazeInputAccessStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_GazeInputAccessStatus = type;
        Py_INCREF(state->type_GazeInputAccessStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_GestureSettings(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);

        if (state->type_GestureSettings)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_GestureSettings = type;
        Py_INCREF(state->type_GestureSettings);


        Py_RETURN_NONE;
    }

    static PyObject* register_HoldingState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);

        if (state->type_HoldingState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_HoldingState = type;
        Py_INCREF(state->type_HoldingState);


        Py_RETURN_NONE;
    }

    static PyObject* register_InputActivationState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);

        if (state->type_InputActivationState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_InputActivationState = type;
        Py_INCREF(state->type_InputActivationState);


        Py_RETURN_NONE;
    }

    static PyObject* register_PointerUpdateKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);

        if (state->type_PointerUpdateKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PointerUpdateKind = type;
        Py_INCREF(state->type_PointerUpdateKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_RadialControllerMenuKnownIcon(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);

        if (state->type_RadialControllerMenuKnownIcon)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_RadialControllerMenuKnownIcon = type;
        Py_INCREF(state->type_RadialControllerMenuKnownIcon);


        Py_RETURN_NONE;
    }

    static PyObject* register_RadialControllerSystemMenuItemKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);

        if (state->type_RadialControllerSystemMenuItemKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_RadialControllerSystemMenuItemKind = type;
        Py_INCREF(state->type_RadialControllerSystemMenuItemKind);
    ...
    constexpr const char* const type_name_AttachableInputObject = "AttachableInputObject";
    ...
    constexpr const char* const type_name_CrossSlidingEventArgs = "CrossSlidingEventArgs";
    ...
    constexpr const char* const type_name_DraggingEventArgs = "DraggingEventArgs";
    ...
    // ----- EdgeGesture class --------------------
    constexpr const char* const type_name_EdgeGesture = "EdgeGesture";
    ...
    constexpr const char* const type_name_EdgeGestureEventArgs = "EdgeGestureEventArgs";
    ...
    constexpr const char* const type_name_GestureRecognizer = "GestureRecognizer";
    ...
    constexpr const char* const type_name_HoldingEventArgs = "HoldingEventArgs";
    ...
    constexpr const char* const type_name_InputActivationListener = "InputActivationListener";
    ...
    constexpr const char* const type_name_InputActivationListenerActivationChangedEventArgs = "InputActivationListenerActivationChangedEventArgs";
    ...
    constexpr const char* const type_name_KeyboardDeliveryInterceptor = "KeyboardDeliveryInterceptor";
    ...
    constexpr const char* const type_name_ManipulationCompletedEventArgs = "ManipulationCompletedEventArgs";
    ...
    constexpr const char* const type_name_ManipulationInertiaStartingEventArgs = "ManipulationInertiaStartingEventArgs";
    ...
    constexpr const char* const type_name_ManipulationStartedEventArgs = "ManipulationStartedEventArgs";
    ...
    constexpr const char* const type_name_ManipulationUpdatedEventArgs = "ManipulationUpdatedEventArgs";
    ...
    constexpr const char* const type_name_MouseWheelParameters = "MouseWheelParameters";
    ...
    // ----- PointerPoint class --------------------
    constexpr const char* const type_name_PointerPoint = "PointerPoint";
    ...
    constexpr const char* const type_name_PointerPointProperties = "PointerPointProperties";
    ...
    constexpr const char* const type_name_PointerVisualizationSettings = "PointerVisualizationSettings";
    ...
    constexpr const char* const type_name_RadialController = "RadialController";
    ...
    constexpr const char* const type_name_RadialControllerButtonClickedEventArgs = "RadialControllerButtonClickedEventArgs";
    ...
    constexpr const char* const type_name_RadialControllerButtonHoldingEventArgs = "RadialControllerButtonHoldingEventArgs";
    ...
    constexpr const char* const type_name_RadialControllerButtonPressedEventArgs = "RadialControllerButtonPressedEventArgs";
    ...
    constexpr const char* const type_name_RadialControllerButtonReleasedEventArgs = "RadialControllerButtonReleasedEventArgs";
    ...
    constexpr const char* const type_name_RadialControllerConfiguration = "RadialControllerConfiguration";
    ...
    constexpr const char* const type_name_RadialControllerControlAcquiredEventArgs = "RadialControllerControlAcquiredEventArgs";
    ...
    constexpr const char* const type_name_RadialControllerMenu = "RadialControllerMenu";
    ...
    constexpr const char* const type_name_RadialControllerMenuItem = "RadialControllerMenuItem";
    ...
    constexpr const char* const type_name_RadialControllerRotationChangedEventArgs = "RadialControllerRotationChangedEventArgs";
    ...
    constexpr const char* const type_name_RadialControllerScreenContact = "RadialControllerScreenContact";
    ...
    constexpr const char* const type_name_RadialControllerScreenContactContinuedEventArgs = "RadialControllerScreenContactContinuedEventArgs";
    ...
    constexpr const char* const type_name_RadialControllerScreenContactEndedEventArgs = "RadialControllerScreenContactEndedEventArgs";
    ...
    constexpr const char* const type_name_RadialControllerScreenContactStartedEventArgs = "RadialControllerScreenContactStartedEventArgs";
    ...
    constexpr const char* const type_name_RightTappedEventArgs = "RightTappedEventArgs";
    ...
    constexpr const char* const type_name_SystemButtonEventController = "SystemButtonEventController";
    ...
    constexpr const char* const type_name_SystemFunctionButtonEventArgs = "SystemFunctionButtonEventArgs";
    ...
    constexpr const char* const type_name_SystemFunctionLockChangedEventArgs = "SystemFunctionLockChangedEventArgs";
    ...
    constexpr const char* const type_name_SystemFunctionLockIndicatorChangedEventArgs = "SystemFunctionLockIndicatorChangedEventArgs";
    ...
    constexpr const char* const type_name_TappedEventArgs = "TappedEventArgs";
    ...
    constexpr const char* const type_name_IPointerPointTransform = "IPointerPointTransform";
    ...
    constexpr const char* const type_name_CrossSlideThresholds = "CrossSlideThresholds";
    ...
    constexpr const char* const type_name_ManipulationDelta = "ManipulationDelta";
    ...
    constexpr const char* const type_name_ManipulationVelocities = "ManipulationVelocities";
    ...
    static PyMethodDef module_methods[] = {
        {"_register_CrossSlidingState", register_CrossSlidingState, METH_O, "registers type"},
        {"_register_DraggingState", register_DraggingState, METH_O, "registers type"},
        {"_register_EdgeGestureKind", register_EdgeGestureKind, METH_O, "registers type"},
        {"_register_GazeInputAccessStatus", register_GazeInputAccessStatus, METH_O, "registers type"},
        {"_register_GestureSettings", register_GestureSettings, METH_O, "registers type"},
        {"_register_HoldingState", register_HoldingState, METH_O, "registers type"},
        {"_register_InputActivationState", register_InputActivationState, METH_O, "registers type"},
        {"_register_PointerUpdateKind", register_PointerUpdateKind, METH_O, "registers type"},
        {"_register_RadialControllerMenuKnownIcon", register_RadialControllerMenuKnownIcon, METH_O, "registers type"},
        {"_register_RadialControllerSystemMenuItemKind", register_RadialControllerSystemMenuItemKind, METH_O, "registers type"},
        {}};
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_CrossSlidingState);
        Py_VISIT(state->type_DraggingState);
        Py_VISIT(state->type_EdgeGestureKind);
        Py_VISIT(state->type_GazeInputAccessStatus);
        Py_VISIT(state->type_GestureSettings);
        Py_VISIT(state->type_HoldingState);
        Py_VISIT(state->type_InputActivationState);
        Py_VISIT(state->type_PointerUpdateKind);
        Py_VISIT(state->type_RadialControllerMenuKnownIcon);
        Py_VISIT(state->type_RadialControllerSystemMenuItemKind);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_CrossSlidingState);
        Py_CLEAR(state->type_DraggingState);
        Py_CLEAR(state->type_EdgeGestureKind);
        Py_CLEAR(state->type_GazeInputAccessStatus);
        Py_CLEAR(state->type_GestureSettings);
        Py_CLEAR(state->type_HoldingState);
        Py_CLEAR(state->type_InputActivationState);
        Py_CLEAR(state->type_PointerUpdateKind);
        Py_CLEAR(state->type_RadialControllerMenuKnownIcon);
        Py_CLEAR(state->type_RadialControllerSystemMenuItemKind);
...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_Input(void) noexcept
{
    ...
    state->type_AttachableInputObject = py::register_python_type(module.get(), type_name_AttachableInputObject, &type_spec_AttachableInputObject, bases.get());
    if (!state->type_AttachableInputObject)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AttachableInputObject);

    state->type_CrossSlidingEventArgs = py::register_python_type(module.get(), type_name_CrossSlidingEventArgs, &type_spec_CrossSlidingEventArgs, bases.get());
    if (!state->type_CrossSlidingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CrossSlidingEventArgs);

    state->type_DraggingEventArgs = py::register_python_type(module.get(), type_name_DraggingEventArgs, &type_spec_DraggingEventArgs, bases.get());
    if (!state->type_DraggingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DraggingEventArgs);

    state->type_EdgeGesture = py::register_python_type(module.get(), type_name_EdgeGesture, &type_spec_EdgeGesture, bases.get());
    if (!state->type_EdgeGesture)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EdgeGesture);

    state->type_EdgeGestureEventArgs = py::register_python_type(module.get(), type_name_EdgeGestureEventArgs, &type_spec_EdgeGestureEventArgs, bases.get());
    if (!state->type_EdgeGestureEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EdgeGestureEventArgs);

    state->type_GestureRecognizer = py::register_python_type(module.get(), type_name_GestureRecognizer, &type_spec_GestureRecognizer, bases.get());
    if (!state->type_GestureRecognizer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GestureRecognizer);

    state->type_HoldingEventArgs = py::register_python_type(module.get(), type_name_HoldingEventArgs, &type_spec_HoldingEventArgs, bases.get());
    if (!state->type_HoldingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HoldingEventArgs);

    state->type_InputActivationListener = py::register_python_type(module.get(), type_name_InputActivationListener, &type_spec_InputActivationListener, bases.get());
    if (!state->type_InputActivationListener)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InputActivationListener);

    state->type_InputActivationListenerActivationChangedEventArgs = py::register_python_type(module.get(), type_name_InputActivationListenerActivationChangedEventArgs, &type_spec_InputActivationListenerActivationChangedEventArgs, bases.get());
    if (!state->type_InputActivationListenerActivationChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InputActivationListenerActivationChangedEventArgs);

    state->type_KeyboardDeliveryInterceptor = py::register_python_type(module.get(), type_name_KeyboardDeliveryInterceptor, &type_spec_KeyboardDeliveryInterceptor, bases.get());
    if (!state->type_KeyboardDeliveryInterceptor)
    {
        return nullptr;
    }

    Py_INCREF(state->type_KeyboardDeliveryInterceptor);

    state->type_ManipulationCompletedEventArgs = py::register_python_type(module.get(), type_name_ManipulationCompletedEventArgs, &type_spec_ManipulationCompletedEventArgs, bases.get());
    if (!state->type_ManipulationCompletedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ManipulationCompletedEventArgs);

    state->type_ManipulationInertiaStartingEventArgs = py::register_python_type(module.get(), type_name_ManipulationInertiaStartingEventArgs, &type_spec_ManipulationInertiaStartingEventArgs, bases.get());
    if (!state->type_ManipulationInertiaStartingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ManipulationInertiaStartingEventArgs);

    state->type_ManipulationStartedEventArgs = py::register_python_type(module.get(), type_name_ManipulationStartedEventArgs, &type_spec_ManipulationStartedEventArgs, bases.get());
    if (!state->type_ManipulationStartedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ManipulationStartedEventArgs);

    state->type_ManipulationUpdatedEventArgs = py::register_python_type(module.get(), type_name_ManipulationUpdatedEventArgs, &type_spec_ManipulationUpdatedEventArgs, bases.get());
    if (!state->type_ManipulationUpdatedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ManipulationUpdatedEventArgs);

    state->type_MouseWheelParameters = py::register_python_type(module.get(), type_name_MouseWheelParameters, &type_spec_MouseWheelParameters, bases.get());
    if (!state->type_MouseWheelParameters)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MouseWheelParameters);

    state->type_PointerPoint = py::register_python_type(module.get(), type_name_PointerPoint, &type_spec_PointerPoint, bases.get());
    if (!state->type_PointerPoint)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PointerPoint);

    state->type_PointerPointProperties = py::register_python_type(module.get(), type_name_PointerPointProperties, &type_spec_PointerPointProperties, bases.get());
    if (!state->type_PointerPointProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PointerPointProperties);

    state->type_PointerVisualizationSettings = py::register_python_type(module.get(), type_name_PointerVisualizationSettings, &type_spec_PointerVisualizationSettings, bases.get());
    if (!state->type_PointerVisualizationSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PointerVisualizationSettings);

    state->type_RadialController = py::register_python_type(module.get(), type_name_RadialController, &type_spec_RadialController, bases.get());
    if (!state->type_RadialController)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialController);

    state->type_RadialControllerButtonClickedEventArgs = py::register_python_type(module.get(), type_name_RadialControllerButtonClickedEventArgs, &type_spec_RadialControllerButtonClickedEventArgs, bases.get());
    if (!state->type_RadialControllerButtonClickedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerButtonClickedEventArgs);

    state->type_RadialControllerButtonHoldingEventArgs = py::register_python_type(module.get(), type_name_RadialControllerButtonHoldingEventArgs, &type_spec_RadialControllerButtonHoldingEventArgs, bases.get());
    if (!state->type_RadialControllerButtonHoldingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerButtonHoldingEventArgs);

    state->type_RadialControllerButtonPressedEventArgs = py::register_python_type(module.get(), type_name_RadialControllerButtonPressedEventArgs, &type_spec_RadialControllerButtonPressedEventArgs, bases.get());
    if (!state->type_RadialControllerButtonPressedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerButtonPressedEventArgs);

    state->type_RadialControllerButtonReleasedEventArgs = py::register_python_type(module.get(), type_name_RadialControllerButtonReleasedEventArgs, &type_spec_RadialControllerButtonReleasedEventArgs, bases.get());
    if (!state->type_RadialControllerButtonReleasedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerButtonReleasedEventArgs);

    state->type_RadialControllerConfiguration = py::register_python_type(module.get(), type_name_RadialControllerConfiguration, &type_spec_RadialControllerConfiguration, bases.get());
    if (!state->type_RadialControllerConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerConfiguration);

    state->type_RadialControllerControlAcquiredEventArgs = py::register_python_type(module.get(), type_name_RadialControllerControlAcquiredEventArgs, &type_spec_RadialControllerControlAcquiredEventArgs, bases.get());
    if (!state->type_RadialControllerControlAcquiredEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerControlAcquiredEventArgs);

    state->type_RadialControllerMenu = py::register_python_type(module.get(), type_name_RadialControllerMenu, &type_spec_RadialControllerMenu, bases.get());
    if (!state->type_RadialControllerMenu)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerMenu);

    state->type_RadialControllerMenuItem = py::register_python_type(module.get(), type_name_RadialControllerMenuItem, &type_spec_RadialControllerMenuItem, bases.get());
    if (!state->type_RadialControllerMenuItem)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerMenuItem);

    state->type_RadialControllerRotationChangedEventArgs = py::register_python_type(module.get(), type_name_RadialControllerRotationChangedEventArgs, &type_spec_RadialControllerRotationChangedEventArgs, bases.get());
    if (!state->type_RadialControllerRotationChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerRotationChangedEventArgs);

    state->type_RadialControllerScreenContact = py::register_python_type(module.get(), type_name_RadialControllerScreenContact, &type_spec_RadialControllerScreenContact, bases.get());
    if (!state->type_RadialControllerScreenContact)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerScreenContact);

    state->type_RadialControllerScreenContactContinuedEventArgs = py::register_python_type(module.get(), type_name_RadialControllerScreenContactContinuedEventArgs, &type_spec_RadialControllerScreenContactContinuedEventArgs, bases.get());
    if (!state->type_RadialControllerScreenContactContinuedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerScreenContactContinuedEventArgs);

    state->type_RadialControllerScreenContactEndedEventArgs = py::register_python_type(module.get(), type_name_RadialControllerScreenContactEndedEventArgs, &type_spec_RadialControllerScreenContactEndedEventArgs, bases.get());
    if (!state->type_RadialControllerScreenContactEndedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerScreenContactEndedEventArgs);

    state->type_RadialControllerScreenContactStartedEventArgs = py::register_python_type(module.get(), type_name_RadialControllerScreenContactStartedEventArgs, &type_spec_RadialControllerScreenContactStartedEventArgs, bases.get());
    if (!state->type_RadialControllerScreenContactStartedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RadialControllerScreenContactStartedEventArgs);

    state->type_RightTappedEventArgs = py::register_python_type(module.get(), type_name_RightTappedEventArgs, &type_spec_RightTappedEventArgs, bases.get());
    if (!state->type_RightTappedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RightTappedEventArgs);

    state->type_SystemButtonEventController = py::register_python_type(module.get(), type_name_SystemButtonEventController, &type_spec_SystemButtonEventController, bases.get());
    if (!state->type_SystemButtonEventController)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemButtonEventController);

    state->type_SystemFunctionButtonEventArgs = py::register_python_type(module.get(), type_name_SystemFunctionButtonEventArgs, &type_spec_SystemFunctionButtonEventArgs, bases.get());
    if (!state->type_SystemFunctionButtonEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemFunctionButtonEventArgs);

    state->type_SystemFunctionLockChangedEventArgs = py::register_python_type(module.get(), type_name_SystemFunctionLockChangedEventArgs, &type_spec_SystemFunctionLockChangedEventArgs, bases.get());
    if (!state->type_SystemFunctionLockChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemFunctionLockChangedEventArgs);

    state->type_SystemFunctionLockIndicatorChangedEventArgs = py::register_python_type(module.get(), type_name_SystemFunctionLockIndicatorChangedEventArgs, &type_spec_SystemFunctionLockIndicatorChangedEventArgs, bases.get());
    if (!state->type_SystemFunctionLockIndicatorChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemFunctionLockIndicatorChangedEventArgs);

    state->type_TappedEventArgs = py::register_python_type(module.get(), type_name_TappedEventArgs, &type_spec_TappedEventArgs, bases.get());
    if (!state->type_TappedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_TappedEventArgs);

    state->type_IPointerPointTransform = py::register_python_type(module.get(), type_name_IPointerPointTransform, &type_spec_IPointerPointTransform, bases.get());
    if (!state->type_IPointerPointTransform)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IPointerPointTransform);

    state->type_CrossSlideThresholds = py::register_python_type(module.get(), type_name_CrossSlideThresholds, &type_spec_CrossSlideThresholds, bases.get());
    if (!state->type_CrossSlideThresholds)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CrossSlideThresholds);

    state->type_ManipulationDelta = py::register_python_type(module.get(), type_name_ManipulationDelta, &type_spec_ManipulationDelta, bases.get());
    if (!state->type_ManipulationDelta)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ManipulationDelta);

    state->type_ManipulationVelocities = py::register_python_type(module.get(), type_name_ManipulationVelocities, &type_spec_ManipulationVelocities, bases.get());
    if (!state->type_ManipulationVelocities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ManipulationVelocities);


    return module.detach();
}

PyObject* py::py_type<winrt::Windows::UI::Input::CrossSlidingState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input;
    ...
    auto python_type = state->type_CrossSlidingState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::CrossSlidingState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::DraggingState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input;
    ...
    auto python_type = state->type_DraggingState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::DraggingState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::EdgeGestureKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input;
    ...
    auto python_type = state->type_EdgeGestureKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::EdgeGestureKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::GazeInputAccessStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input;
    ...
    auto python_type = state->type_GazeInputAccessStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::GazeInputAccessStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::GestureSettings>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input;
    ...
    auto python_type = state->type_GestureSettings;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::GestureSettings is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::HoldingState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input;
    ...
    auto python_type = state->type_HoldingState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::HoldingState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::InputActivationState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input;
    ...
    auto python_type = state->type_InputActivationState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::InputActivationState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::PointerUpdateKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input;
    ...
    auto python_type = state->type_PointerUpdateKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::PointerUpdateKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::RadialControllerMenuKnownIcon>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input;
    ...
    auto python_type = state->type_RadialControllerMenuKnownIcon;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::RadialControllerMenuKnownIcon is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::RadialControllerSystemMenuItemKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input;
    ...
    auto python_type = state->type_RadialControllerSystemMenuItemKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::RadialControllerSystemMenuItemKind is not registered");
        return nullptr;
    }
