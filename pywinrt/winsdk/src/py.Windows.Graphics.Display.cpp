...
namespace py::cpp::Windows::Graphics::Display
{
    ...
    static PyObject* register_AdvancedColorKind(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_DisplayBrightnessOverrideOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayBrightnessOverrideScenario(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayBrightnessScenario(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayColorOverrideScenario(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DisplayOrientations(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_HdrMetadataFormat(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ResolutionScale(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_AdvancedColorInfo = "AdvancedColorInfo";
    ...
    constexpr const char* const type_name_BrightnessOverride = "BrightnessOverride";
    ...
    constexpr const char* const type_name_BrightnessOverrideSettings = "BrightnessOverrideSettings";
    ...
    constexpr const char* const type_name_ColorOverrideSettings = "ColorOverrideSettings";
    ...
    constexpr const char* const type_name_DisplayEnhancementOverride = "DisplayEnhancementOverride";
    ...
    constexpr const char* const type_name_DisplayEnhancementOverrideCapabilities = "DisplayEnhancementOverrideCapabilities";
    ...
    constexpr const char* const type_name_DisplayEnhancementOverrideCapabilitiesChangedEventArgs = "DisplayEnhancementOverrideCapabilitiesChangedEventArgs";
    ...
    constexpr const char* const type_name_DisplayInformation = "DisplayInformation";
    ...
    constexpr const char* const type_name_DisplayProperties = "DisplayProperties";
    ...
    constexpr const char* const type_name_DisplayServices = "DisplayServices";
    ...
    // ----- NitRange struct --------------------
    constexpr const char* const type_name_NitRange = "NitRange";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Graphics_Display(void) noexcept
{
    ...
    state->type_AdvancedColorInfo = py::register_python_type(module.get(), type_name_AdvancedColorInfo, &type_spec_AdvancedColorInfo, bases.get());
    if (!state->type_AdvancedColorInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AdvancedColorInfo);

    state->type_BrightnessOverride = py::register_python_type(module.get(), type_name_BrightnessOverride, &type_spec_BrightnessOverride, bases.get());
    if (!state->type_BrightnessOverride)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BrightnessOverride);

    state->type_BrightnessOverrideSettings = py::register_python_type(module.get(), type_name_BrightnessOverrideSettings, &type_spec_BrightnessOverrideSettings, bases.get());
    if (!state->type_BrightnessOverrideSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BrightnessOverrideSettings);

    state->type_ColorOverrideSettings = py::register_python_type(module.get(), type_name_ColorOverrideSettings, &type_spec_ColorOverrideSettings, bases.get());
    if (!state->type_ColorOverrideSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ColorOverrideSettings);

    state->type_DisplayEnhancementOverride = py::register_python_type(module.get(), type_name_DisplayEnhancementOverride, &type_spec_DisplayEnhancementOverride, bases.get());
    if (!state->type_DisplayEnhancementOverride)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayEnhancementOverride);

    state->type_DisplayEnhancementOverrideCapabilities = py::register_python_type(module.get(), type_name_DisplayEnhancementOverrideCapabilities, &type_spec_DisplayEnhancementOverrideCapabilities, bases.get());
    if (!state->type_DisplayEnhancementOverrideCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayEnhancementOverrideCapabilities);

    state->type_DisplayEnhancementOverrideCapabilitiesChangedEventArgs = py::register_python_type(module.get(), type_name_DisplayEnhancementOverrideCapabilitiesChangedEventArgs, &type_spec_DisplayEnhancementOverrideCapabilitiesChangedEventArgs, bases.get());
    if (!state->type_DisplayEnhancementOverrideCapabilitiesChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayEnhancementOverrideCapabilitiesChangedEventArgs);

    state->type_DisplayInformation = py::register_python_type(module.get(), type_name_DisplayInformation, &type_spec_DisplayInformation, bases.get());
    if (!state->type_DisplayInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayInformation);

    state->type_DisplayProperties = py::register_python_type(module.get(), type_name_DisplayProperties, &type_spec_DisplayProperties, nullptr);
    if (!state->type_DisplayProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayProperties);

    state->type_DisplayServices = py::register_python_type(module.get(), type_name_DisplayServices, &type_spec_DisplayServices, bases.get());
    if (!state->type_DisplayServices)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayServices);

    state->type_NitRange = py::register_python_type(module.get(), type_name_NitRange, &type_spec_NitRange, bases.get());
    if (!state->type_NitRange)
    {
        return nullptr;
    }

    Py_INCREF(state->type_NitRange);
