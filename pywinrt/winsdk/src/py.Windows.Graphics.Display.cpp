...
namespace py::cpp::Windows::Graphics::Display
{
    ...
    static PyType_Slot type_slots_DisplayInformation_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_DisplayInformation_Meta },
        { }
    };

    static PyType_Spec type_spec_DisplayInformation_Meta =
    {
        "_winsdk_Windows_Graphics_Display.DisplayInformation_Meta",
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_DisplayProperties_Meta },
        { }
    };

    static PyType_Spec type_spec_DisplayProperties_Meta =
    {
        "_winsdk_Windows_Graphics_Display.DisplayProperties_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Graphics_Display(void) noexcept
{
    ...
    state->type_AdvancedColorInfo = py::register_python_type(module.get(), type_name_AdvancedColorInfo, &type_spec_AdvancedColorInfo, bases.get(), nullptr);
    if (!state->type_AdvancedColorInfo)
    {
        return nullptr;
    }

    state->type_BrightnessOverride = py::register_python_type(module.get(), type_name_BrightnessOverride, &type_spec_BrightnessOverride, bases.get(), nullptr);
    if (!state->type_BrightnessOverride)
    {
        return nullptr;
    }

    state->type_BrightnessOverrideSettings = py::register_python_type(module.get(), type_name_BrightnessOverrideSettings, &type_spec_BrightnessOverrideSettings, bases.get(), nullptr);
    if (!state->type_BrightnessOverrideSettings)
    {
        return nullptr;
    }

    state->type_ColorOverrideSettings = py::register_python_type(module.get(), type_name_ColorOverrideSettings, &type_spec_ColorOverrideSettings, bases.get(), nullptr);
    if (!state->type_ColorOverrideSettings)
    {
        return nullptr;
    }

    state->type_DisplayEnhancementOverride = py::register_python_type(module.get(), type_name_DisplayEnhancementOverride, &type_spec_DisplayEnhancementOverride, bases.get(), nullptr);
    if (!state->type_DisplayEnhancementOverride)
    {
        return nullptr;
    }

    state->type_DisplayEnhancementOverrideCapabilities = py::register_python_type(module.get(), type_name_DisplayEnhancementOverrideCapabilities, &type_spec_DisplayEnhancementOverrideCapabilities, bases.get(), nullptr);
    if (!state->type_DisplayEnhancementOverrideCapabilities)
    {
        return nullptr;
    }

    state->type_DisplayEnhancementOverrideCapabilitiesChangedEventArgs = py::register_python_type(module.get(), type_name_DisplayEnhancementOverrideCapabilitiesChangedEventArgs, &type_spec_DisplayEnhancementOverrideCapabilitiesChangedEventArgs, bases.get(), nullptr);
    ...
    state->type_DisplayInformation = py::register_python_type(module.get(), type_name_DisplayInformation, &type_spec_DisplayInformation, bases.get(), reinterpret_cast<PyTypeObject*>(type_DisplayInformation_Meta.get()));
    ...
    state->type_DisplayProperties = py::register_python_type(module.get(), type_name_DisplayProperties, &type_spec_DisplayProperties, nullptr, reinterpret_cast<PyTypeObject*>(type_DisplayProperties_Meta.get()));
    if (!state->type_DisplayProperties)
    {
        return nullptr;
    }

    state->type_DisplayServices = py::register_python_type(module.get(), type_name_DisplayServices, &type_spec_DisplayServices, bases.get(), nullptr);
    if (!state->type_DisplayServices)
    {
        return nullptr;
    }

    state->type_NitRange = py::register_python_type(module.get(), type_name_NitRange, &type_spec_NitRange, bases.get(), nullptr);
