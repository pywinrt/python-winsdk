...
winrt::Windows::Graphics::Display::NitRange py::converter<winrt::Windows::Graphics::Display::NitRange>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Graphics::Display::NitRange or dict");
    ...
    if (!py_MinNits) {
        PyErr_SetString(PyExc_KeyError, "MinNits");
        throw python_exception();
    }
    ...
    if (!py_MaxNits) {
        PyErr_SetString(PyExc_KeyError, "MaxNits");
        throw python_exception();
    }
    ...
    if (!py_StepSizeNits) {
        PyErr_SetString(PyExc_KeyError, "StepSizeNits");
        throw python_exception();
    }
