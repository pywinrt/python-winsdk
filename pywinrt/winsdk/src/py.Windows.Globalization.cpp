...
namespace py::cpp::Windows::Globalization
{
    ...
    static PyObject* register_DayOfWeek(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_LanguageLayoutDirection(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_ApplicationLanguages = "ApplicationLanguages";
    ...
    // ----- Calendar class --------------------
    constexpr const char* const type_name_Calendar = "Calendar";
    ...
    constexpr const char* const type_name_CalendarIdentifiers = "CalendarIdentifiers";
    ...
    constexpr const char* const type_name_ClockIdentifiers = "ClockIdentifiers";
    ...
    constexpr const char* const type_name_CurrencyAmount = "CurrencyAmount";
    ...
    constexpr const char* const type_name_CurrencyIdentifiers = "CurrencyIdentifiers";
    ...
    constexpr const char* const type_name_GeographicRegion = "GeographicRegion";
    ...
    constexpr const char* const type_name_NumeralSystemIdentifiers = "NumeralSystemIdentifiers";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Globalization(void) noexcept
{
    ...
    state->type_ApplicationLanguages = py::register_python_type(module.get(), type_name_ApplicationLanguages, &type_spec_ApplicationLanguages, nullptr);
    if (!state->type_ApplicationLanguages)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ApplicationLanguages);

    state->type_Calendar = py::register_python_type(module.get(), type_name_Calendar, &type_spec_Calendar, bases.get());
    if (!state->type_Calendar)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Calendar);

    state->type_CalendarIdentifiers = py::register_python_type(module.get(), type_name_CalendarIdentifiers, &type_spec_CalendarIdentifiers, nullptr);
    if (!state->type_CalendarIdentifiers)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CalendarIdentifiers);

    state->type_ClockIdentifiers = py::register_python_type(module.get(), type_name_ClockIdentifiers, &type_spec_ClockIdentifiers, nullptr);
    if (!state->type_ClockIdentifiers)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClockIdentifiers);

    state->type_CurrencyAmount = py::register_python_type(module.get(), type_name_CurrencyAmount, &type_spec_CurrencyAmount, bases.get());
    if (!state->type_CurrencyAmount)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CurrencyAmount);

    state->type_CurrencyIdentifiers = py::register_python_type(module.get(), type_name_CurrencyIdentifiers, &type_spec_CurrencyIdentifiers, nullptr);
    if (!state->type_CurrencyIdentifiers)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CurrencyIdentifiers);

    state->type_GeographicRegion = py::register_python_type(module.get(), type_name_GeographicRegion, &type_spec_GeographicRegion, bases.get());
    ...
    Py_INCREF(state->type_Language);

    state->type_NumeralSystemIdentifiers = py::register_python_type(module.get(), type_name_NumeralSystemIdentifiers, &type_spec_NumeralSystemIdentifiers, nullptr);
    if (!state->type_NumeralSystemIdentifiers)
    {
        return nullptr;
    }

    Py_INCREF(state->type_NumeralSystemIdentifiers);
