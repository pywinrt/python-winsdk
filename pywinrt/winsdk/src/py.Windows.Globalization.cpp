...
namespace py::cpp::Windows::Globalization
{
    ...
    static PyType_Slot type_slots_ApplicationLanguages_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_ApplicationLanguages_Meta },
        { }
    };

    static PyType_Spec type_spec_ApplicationLanguages_Meta =
    {
        "_winsdk_Windows_Globalization.ApplicationLanguages_Meta",
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_CalendarIdentifiers_Meta },
        { }
    };

    static PyType_Spec type_spec_CalendarIdentifiers_Meta =
    {
        "_winsdk_Windows_Globalization.CalendarIdentifiers_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_ClockIdentifiers_Meta },
        { }
    };

    static PyType_Spec type_spec_ClockIdentifiers_Meta =
    {
        "_winsdk_Windows_Globalization.ClockIdentifiers_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_CurrencyIdentifiers_Meta },
        { }
    };

    static PyType_Spec type_spec_CurrencyIdentifiers_Meta =
    {
        "_winsdk_Windows_Globalization.CurrencyIdentifiers_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_Language_Meta },
        { }
    };

    static PyType_Spec type_spec_Language_Meta =
    {
        "_winsdk_Windows_Globalization.Language_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_NumeralSystemIdentifiers_Meta },
        { }
    };

    static PyType_Spec type_spec_NumeralSystemIdentifiers_Meta =
    {
        "_winsdk_Windows_Globalization.NumeralSystemIdentifiers_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Globalization(void) noexcept
{
    ...
    state->type_ApplicationLanguages = py::register_python_type(module.get(), type_name_ApplicationLanguages, &type_spec_ApplicationLanguages, nullptr, reinterpret_cast<PyTypeObject*>(type_ApplicationLanguages_Meta.get()));
    if (!state->type_ApplicationLanguages)
    {
        return nullptr;
    }

    state->type_Calendar = py::register_python_type(module.get(), type_name_Calendar, &type_spec_Calendar, bases.get(), nullptr);
    ...
    state->type_CalendarIdentifiers = py::register_python_type(module.get(), type_name_CalendarIdentifiers, &type_spec_CalendarIdentifiers, nullptr, reinterpret_cast<PyTypeObject*>(type_CalendarIdentifiers_Meta.get()));
    ...
    state->type_ClockIdentifiers = py::register_python_type(module.get(), type_name_ClockIdentifiers, &type_spec_ClockIdentifiers, nullptr, reinterpret_cast<PyTypeObject*>(type_ClockIdentifiers_Meta.get()));
    if (!state->type_ClockIdentifiers)
    {
        return nullptr;
    }

    state->type_CurrencyAmount = py::register_python_type(module.get(), type_name_CurrencyAmount, &type_spec_CurrencyAmount, bases.get(), nullptr);
    ...
    state->type_CurrencyIdentifiers = py::register_python_type(module.get(), type_name_CurrencyIdentifiers, &type_spec_CurrencyIdentifiers, nullptr, reinterpret_cast<PyTypeObject*>(type_CurrencyIdentifiers_Meta.get()));
    if (!state->type_CurrencyIdentifiers)
    {
        return nullptr;
    }

    state->type_GeographicRegion = py::register_python_type(module.get(), type_name_GeographicRegion, &type_spec_GeographicRegion, bases.get(), nullptr);
    if (!state->type_GeographicRegion)
    {
        return nullptr;
    }

    state->type_JapanesePhoneme = py::register_python_type(module.get(), type_name_JapanesePhoneme, &type_spec_JapanesePhoneme, bases.get(), nullptr);
    if (!state->type_JapanesePhoneme)
    {
        return nullptr;
    }

    state->type_JapanesePhoneticAnalyzer = py::register_python_type(module.get(), type_name_JapanesePhoneticAnalyzer, &type_spec_JapanesePhoneticAnalyzer, nullptr, nullptr);
    ...
    state->type_Language = py::register_python_type(module.get(), type_name_Language, &type_spec_Language, bases.get(), reinterpret_cast<PyTypeObject*>(type_Language_Meta.get()));
    ...
    state->type_NumeralSystemIdentifiers = py::register_python_type(module.get(), type_name_NumeralSystemIdentifiers, &type_spec_NumeralSystemIdentifiers, nullptr, reinterpret_cast<PyTypeObject*>(type_NumeralSystemIdentifiers_Meta.get()));
