...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Gpio::Provider::ProviderGpioPinDriveMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Gpio::Provider::ProviderGpioPinEdge> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Gpio::Provider::ProviderGpioPinValue> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Gpio::Provider::ProviderGpioSharingMode> = "i";
