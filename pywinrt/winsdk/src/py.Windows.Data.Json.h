...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Data::Json::JsonErrorStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Data::Json::JsonValueType> = "i";
