...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Holographic::HolographicDepthReprojectionMethod> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Holographic::HolographicFramePresentResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Holographic::HolographicFramePresentWaitBehavior> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Holographic::HolographicReprojectionMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Holographic::HolographicSpaceUserPresence> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Holographic::HolographicViewConfigurationKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Holographic::HolographicAdapterId> = "T{I:low_part:i:high_part:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Holographic::HolographicFrameId> = "T{Q:value:}";
