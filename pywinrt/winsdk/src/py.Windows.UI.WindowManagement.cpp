...
namespace py::cpp::Windows::UI::WindowManagement
{
    ...
    static PyObject* register_AppWindowClosedReason(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_AppWindowFrameStyle(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppWindowPresentationKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppWindowTitleBarVisibility(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_WindowingEnvironmentKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    // ----- AppWindow class --------------------
    constexpr const char* const type_name_AppWindow = "AppWindow";
    ...
    constexpr const char* const type_name_AppWindowChangedEventArgs = "AppWindowChangedEventArgs";
    ...
    constexpr const char* const type_name_AppWindowCloseRequestedEventArgs = "AppWindowCloseRequestedEventArgs";
    ...
    constexpr const char* const type_name_AppWindowClosedEventArgs = "AppWindowClosedEventArgs";
    ...
    constexpr const char* const type_name_AppWindowFrame = "AppWindowFrame";
    ...
    constexpr const char* const type_name_AppWindowPlacement = "AppWindowPlacement";
    ...
    constexpr const char* const type_name_AppWindowPresentationConfiguration = "AppWindowPresentationConfiguration";
    ...
    constexpr const char* const type_name_AppWindowPresenter = "AppWindowPresenter";
    ...
    constexpr const char* const type_name_AppWindowTitleBar = "AppWindowTitleBar";
    ...
    constexpr const char* const type_name_AppWindowTitleBarOcclusion = "AppWindowTitleBarOcclusion";
    ...
    constexpr const char* const type_name_CompactOverlayPresentationConfiguration = "CompactOverlayPresentationConfiguration";
    ...
    constexpr const char* const type_name_DefaultPresentationConfiguration = "DefaultPresentationConfiguration";
    ...
    // ----- DisplayRegion class --------------------
    constexpr const char* const type_name_DisplayRegion = "DisplayRegion";
    ...
    constexpr const char* const type_name_FullScreenPresentationConfiguration = "FullScreenPresentationConfiguration";
    ...
    constexpr const char* const type_name_WindowServices = "WindowServices";
    ...
    constexpr const char* const type_name_WindowingEnvironment = "WindowingEnvironment";
    ...
    constexpr const char* const type_name_WindowingEnvironmentAddedEventArgs = "WindowingEnvironmentAddedEventArgs";
    ...
    constexpr const char* const type_name_WindowingEnvironmentChangedEventArgs = "WindowingEnvironmentChangedEventArgs";
    ...
    constexpr const char* const type_name_WindowingEnvironmentRemovedEventArgs = "WindowingEnvironmentRemovedEventArgs";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_WindowManagement(void) noexcept
{
    ...
    state->type_AppWindow = py::register_python_type(module.get(), type_name_AppWindow, &type_spec_AppWindow, bases.get());
    if (!state->type_AppWindow)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppWindow);

    state->type_AppWindowChangedEventArgs = py::register_python_type(module.get(), type_name_AppWindowChangedEventArgs, &type_spec_AppWindowChangedEventArgs, bases.get());
    if (!state->type_AppWindowChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppWindowChangedEventArgs);

    state->type_AppWindowCloseRequestedEventArgs = py::register_python_type(module.get(), type_name_AppWindowCloseRequestedEventArgs, &type_spec_AppWindowCloseRequestedEventArgs, bases.get());
    if (!state->type_AppWindowCloseRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppWindowCloseRequestedEventArgs);

    state->type_AppWindowClosedEventArgs = py::register_python_type(module.get(), type_name_AppWindowClosedEventArgs, &type_spec_AppWindowClosedEventArgs, bases.get());
    if (!state->type_AppWindowClosedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppWindowClosedEventArgs);

    state->type_AppWindowFrame = py::register_python_type(module.get(), type_name_AppWindowFrame, &type_spec_AppWindowFrame, bases.get());
    if (!state->type_AppWindowFrame)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppWindowFrame);

    state->type_AppWindowPlacement = py::register_python_type(module.get(), type_name_AppWindowPlacement, &type_spec_AppWindowPlacement, bases.get());
    if (!state->type_AppWindowPlacement)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppWindowPlacement);

    state->type_AppWindowPresentationConfiguration = py::register_python_type(module.get(), type_name_AppWindowPresentationConfiguration, &type_spec_AppWindowPresentationConfiguration, bases.get());
    if (!state->type_AppWindowPresentationConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppWindowPresentationConfiguration);

    state->type_AppWindowPresenter = py::register_python_type(module.get(), type_name_AppWindowPresenter, &type_spec_AppWindowPresenter, bases.get());
    if (!state->type_AppWindowPresenter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppWindowPresenter);

    state->type_AppWindowTitleBar = py::register_python_type(module.get(), type_name_AppWindowTitleBar, &type_spec_AppWindowTitleBar, bases.get());
    if (!state->type_AppWindowTitleBar)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppWindowTitleBar);

    state->type_AppWindowTitleBarOcclusion = py::register_python_type(module.get(), type_name_AppWindowTitleBarOcclusion, &type_spec_AppWindowTitleBarOcclusion, bases.get());
    if (!state->type_AppWindowTitleBarOcclusion)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppWindowTitleBarOcclusion);

    state->type_CompactOverlayPresentationConfiguration = py::register_python_type(module.get(), type_name_CompactOverlayPresentationConfiguration, &type_spec_CompactOverlayPresentationConfiguration, bases.get());
    if (!state->type_CompactOverlayPresentationConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CompactOverlayPresentationConfiguration);

    state->type_DefaultPresentationConfiguration = py::register_python_type(module.get(), type_name_DefaultPresentationConfiguration, &type_spec_DefaultPresentationConfiguration, bases.get());
    if (!state->type_DefaultPresentationConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DefaultPresentationConfiguration);

    state->type_DisplayRegion = py::register_python_type(module.get(), type_name_DisplayRegion, &type_spec_DisplayRegion, bases.get());
    if (!state->type_DisplayRegion)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayRegion);

    state->type_FullScreenPresentationConfiguration = py::register_python_type(module.get(), type_name_FullScreenPresentationConfiguration, &type_spec_FullScreenPresentationConfiguration, bases.get());
    if (!state->type_FullScreenPresentationConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FullScreenPresentationConfiguration);

    state->type_WindowServices = py::register_python_type(module.get(), type_name_WindowServices, &type_spec_WindowServices, nullptr);
    if (!state->type_WindowServices)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WindowServices);

    state->type_WindowingEnvironment = py::register_python_type(module.get(), type_name_WindowingEnvironment, &type_spec_WindowingEnvironment, bases.get());
    if (!state->type_WindowingEnvironment)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WindowingEnvironment);

    state->type_WindowingEnvironmentAddedEventArgs = py::register_python_type(module.get(), type_name_WindowingEnvironmentAddedEventArgs, &type_spec_WindowingEnvironmentAddedEventArgs, bases.get());
    if (!state->type_WindowingEnvironmentAddedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WindowingEnvironmentAddedEventArgs);

    state->type_WindowingEnvironmentChangedEventArgs = py::register_python_type(module.get(), type_name_WindowingEnvironmentChangedEventArgs, &type_spec_WindowingEnvironmentChangedEventArgs, bases.get());
    if (!state->type_WindowingEnvironmentChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WindowingEnvironmentChangedEventArgs);

    state->type_WindowingEnvironmentRemovedEventArgs = py::register_python_type(module.get(), type_name_WindowingEnvironmentRemovedEventArgs, &type_spec_WindowingEnvironmentRemovedEventArgs, bases.get());
    if (!state->type_WindowingEnvironmentRemovedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WindowingEnvironmentRemovedEventArgs);
