...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::DirectX::Direct3D11::Direct3DBindings> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::DirectX::Direct3D11::Direct3DUsage> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::DirectX::Direct3D11::Direct3DMultisampleDescription> = "T{i:count:i:quality:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::DirectX::Direct3D11::Direct3DSurfaceDescription> = "T{i:width:i:height:i:format:T{i:count:i:quality:}:multisample_description:}";
