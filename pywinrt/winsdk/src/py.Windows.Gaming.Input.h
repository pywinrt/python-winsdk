...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::ArcadeStickButtons> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::FlightStickButtons> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::GameControllerButtonLabel> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::GameControllerSwitchKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::GameControllerSwitchPosition> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::GamepadButtons> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::OptionalUINavigationButtons> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::RacingWheelButtons> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::RequiredUINavigationButtons> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::ArcadeStickReading> = "T{Q:timestamp:I:buttons:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::FlightStickReading> = "T{Q:timestamp:I:buttons:i:hat_switch:d:roll:d:pitch:d:yaw:d:throttle:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::GamepadReading> = "T{Q:timestamp:I:buttons:d:left_trigger:d:right_trigger:d:left_thumbstick_x:d:left_thumbstick_y:d:right_thumbstick_x:d:right_thumbstick_y:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::GamepadVibration> = "T{d:left_motor:d:right_motor:d:left_trigger:d:right_trigger:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::RacingWheelReading> = "T{Q:timestamp:I:buttons:i:pattern_shifter_gear:d:wheel:d:throttle:d:brake:d:clutch:d:handbrake:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::UINavigationReading> = "T{Q:timestamp:I:required_buttons:I:optional_buttons:}";
