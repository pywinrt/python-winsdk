...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::AlarmAccessStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::ApplicationTriggerResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::BackgroundAccessRequestKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::BackgroundAccessStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::BackgroundTaskCancellationReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::BackgroundTaskThrottleCounter> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::BackgroundWorkCostValue> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::CustomSystemEventTriggerRecurrence> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::DeviceTriggerResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::LocationTriggerType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::MediaProcessingTriggerResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::SystemConditionType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Background::SystemTriggerType> = "i";
