...
namespace py::cpp::Windows::System::Display
{
    ...
    constexpr const char* const type_name_DisplayRequest = "DisplayRequest";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_System_Display(void) noexcept
{
    ...
    state->type_DisplayRequest = py::register_python_type(module.get(), type_name_DisplayRequest, &type_spec_DisplayRequest, bases.get());
    if (!state->type_DisplayRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DisplayRequest);
