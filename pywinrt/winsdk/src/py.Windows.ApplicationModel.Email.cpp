...
namespace py::cpp::Windows::ApplicationModel::Email
{
    ...
    static PyObject* register_EmailAttachmentDownloadState(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_EmailBatchStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailCertificateValidationStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailFlagState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailImportance(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMailboxActionKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMailboxAutoReplyMessageResponseKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMailboxChangeType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMailboxCreateFolderStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMailboxDeleteFolderStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMailboxEmptyFolderStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMailboxOtherAppReadAccess(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMailboxOtherAppWriteAccess(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMailboxSmimeEncryptionAlgorithm(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMailboxSmimeSigningAlgorithm(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMailboxSyncStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMeetingResponseType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMessageBodyKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMessageDownloadState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMessageResponseKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailMessageSmimeKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailQueryKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailQuerySearchFields(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailQuerySearchScope(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailQuerySortDirection(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailQuerySortProperty(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailRecipientResolutionStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailSpecialFolderKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EmailStoreAccessType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_EmailAttachment = "EmailAttachment";
    ...
    constexpr const char* const type_name_EmailConversation = "EmailConversation";
    ...
    constexpr const char* const type_name_EmailConversationBatch = "EmailConversationBatch";
    ...
    constexpr const char* const type_name_EmailConversationReader = "EmailConversationReader";
    ...
    // ----- EmailFolder class --------------------
    constexpr const char* const type_name_EmailFolder = "EmailFolder";
    ...
    // ----- EmailIrmInfo class --------------------
    constexpr const char* const type_name_EmailIrmInfo = "EmailIrmInfo";
    ...
    constexpr const char* const type_name_EmailIrmTemplate = "EmailIrmTemplate";
    ...
    constexpr const char* const type_name_EmailItemCounts = "EmailItemCounts";
    ...
    // ----- EmailMailbox class --------------------
    constexpr const char* const type_name_EmailMailbox = "EmailMailbox";
    ...
    constexpr const char* const type_name_EmailMailboxAction = "EmailMailboxAction";
    ...
    constexpr const char* const type_name_EmailMailboxAutoReply = "EmailMailboxAutoReply";
    ...
    constexpr const char* const type_name_EmailMailboxAutoReplySettings = "EmailMailboxAutoReplySettings";
    ...
    constexpr const char* const type_name_EmailMailboxCapabilities = "EmailMailboxCapabilities";
    ...
    constexpr const char* const type_name_EmailMailboxChange = "EmailMailboxChange";
    ...
    constexpr const char* const type_name_EmailMailboxChangeReader = "EmailMailboxChangeReader";
    ...
    constexpr const char* const type_name_EmailMailboxChangeTracker = "EmailMailboxChangeTracker";
    ...
    constexpr const char* const type_name_EmailMailboxChangedDeferral = "EmailMailboxChangedDeferral";
    ...
    constexpr const char* const type_name_EmailMailboxChangedEventArgs = "EmailMailboxChangedEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxCreateFolderResult = "EmailMailboxCreateFolderResult";
    ...
    constexpr const char* const type_name_EmailMailboxPolicies = "EmailMailboxPolicies";
    ...
    constexpr const char* const type_name_EmailMailboxSyncManager = "EmailMailboxSyncManager";
    ...
    // ----- EmailManager class --------------------
    constexpr const char* const type_name_EmailManager = "EmailManager";
    ...
    constexpr const char* const type_name_EmailManagerForUser = "EmailManagerForUser";
    ...
    constexpr const char* const type_name_EmailMeetingInfo = "EmailMeetingInfo";
    ...
    // ----- EmailMessage class --------------------
    constexpr const char* const type_name_EmailMessage = "EmailMessage";
    ...
    constexpr const char* const type_name_EmailMessageBatch = "EmailMessageBatch";
    ...
    constexpr const char* const type_name_EmailMessageReader = "EmailMessageReader";
    ...
    constexpr const char* const type_name_EmailQueryOptions = "EmailQueryOptions";
    ...
    constexpr const char* const type_name_EmailQueryTextSearch = "EmailQueryTextSearch";
    ...
    constexpr const char* const type_name_EmailRecipient = "EmailRecipient";
    ...
    constexpr const char* const type_name_EmailRecipientResolutionResult = "EmailRecipientResolutionResult";
    ...
    // ----- EmailStore class --------------------
    constexpr const char* const type_name_EmailStore = "EmailStore";
    ...
    constexpr const char* const type_name_EmailStoreNotificationTriggerDetails = "EmailStoreNotificationTriggerDetails";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_Email(void) noexcept
{
    ...
    state->type_EmailAttachment = py::register_python_type(module.get(), type_name_EmailAttachment, &type_spec_EmailAttachment, bases.get());
    if (!state->type_EmailAttachment)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailAttachment);

    state->type_EmailConversation = py::register_python_type(module.get(), type_name_EmailConversation, &type_spec_EmailConversation, bases.get());
    if (!state->type_EmailConversation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailConversation);

    state->type_EmailConversationBatch = py::register_python_type(module.get(), type_name_EmailConversationBatch, &type_spec_EmailConversationBatch, bases.get());
    if (!state->type_EmailConversationBatch)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailConversationBatch);

    state->type_EmailConversationReader = py::register_python_type(module.get(), type_name_EmailConversationReader, &type_spec_EmailConversationReader, bases.get());
    if (!state->type_EmailConversationReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailConversationReader);

    state->type_EmailFolder = py::register_python_type(module.get(), type_name_EmailFolder, &type_spec_EmailFolder, bases.get());
    if (!state->type_EmailFolder)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailFolder);

    state->type_EmailIrmInfo = py::register_python_type(module.get(), type_name_EmailIrmInfo, &type_spec_EmailIrmInfo, bases.get());
    if (!state->type_EmailIrmInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailIrmInfo);

    state->type_EmailIrmTemplate = py::register_python_type(module.get(), type_name_EmailIrmTemplate, &type_spec_EmailIrmTemplate, bases.get());
    if (!state->type_EmailIrmTemplate)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailIrmTemplate);

    state->type_EmailItemCounts = py::register_python_type(module.get(), type_name_EmailItemCounts, &type_spec_EmailItemCounts, bases.get());
    if (!state->type_EmailItemCounts)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailItemCounts);

    state->type_EmailMailbox = py::register_python_type(module.get(), type_name_EmailMailbox, &type_spec_EmailMailbox, bases.get());
    if (!state->type_EmailMailbox)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailbox);

    state->type_EmailMailboxAction = py::register_python_type(module.get(), type_name_EmailMailboxAction, &type_spec_EmailMailboxAction, bases.get());
    if (!state->type_EmailMailboxAction)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxAction);

    state->type_EmailMailboxAutoReply = py::register_python_type(module.get(), type_name_EmailMailboxAutoReply, &type_spec_EmailMailboxAutoReply, bases.get());
    if (!state->type_EmailMailboxAutoReply)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxAutoReply);

    state->type_EmailMailboxAutoReplySettings = py::register_python_type(module.get(), type_name_EmailMailboxAutoReplySettings, &type_spec_EmailMailboxAutoReplySettings, bases.get());
    if (!state->type_EmailMailboxAutoReplySettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxAutoReplySettings);

    state->type_EmailMailboxCapabilities = py::register_python_type(module.get(), type_name_EmailMailboxCapabilities, &type_spec_EmailMailboxCapabilities, bases.get());
    if (!state->type_EmailMailboxCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxCapabilities);

    state->type_EmailMailboxChange = py::register_python_type(module.get(), type_name_EmailMailboxChange, &type_spec_EmailMailboxChange, bases.get());
    if (!state->type_EmailMailboxChange)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxChange);

    state->type_EmailMailboxChangeReader = py::register_python_type(module.get(), type_name_EmailMailboxChangeReader, &type_spec_EmailMailboxChangeReader, bases.get());
    if (!state->type_EmailMailboxChangeReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxChangeReader);

    state->type_EmailMailboxChangeTracker = py::register_python_type(module.get(), type_name_EmailMailboxChangeTracker, &type_spec_EmailMailboxChangeTracker, bases.get());
    if (!state->type_EmailMailboxChangeTracker)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxChangeTracker);

    state->type_EmailMailboxChangedDeferral = py::register_python_type(module.get(), type_name_EmailMailboxChangedDeferral, &type_spec_EmailMailboxChangedDeferral, bases.get());
    if (!state->type_EmailMailboxChangedDeferral)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxChangedDeferral);

    state->type_EmailMailboxChangedEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxChangedEventArgs, &type_spec_EmailMailboxChangedEventArgs, bases.get());
    if (!state->type_EmailMailboxChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxChangedEventArgs);

    state->type_EmailMailboxCreateFolderResult = py::register_python_type(module.get(), type_name_EmailMailboxCreateFolderResult, &type_spec_EmailMailboxCreateFolderResult, bases.get());
    if (!state->type_EmailMailboxCreateFolderResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxCreateFolderResult);

    state->type_EmailMailboxPolicies = py::register_python_type(module.get(), type_name_EmailMailboxPolicies, &type_spec_EmailMailboxPolicies, bases.get());
    if (!state->type_EmailMailboxPolicies)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxPolicies);

    state->type_EmailMailboxSyncManager = py::register_python_type(module.get(), type_name_EmailMailboxSyncManager, &type_spec_EmailMailboxSyncManager, bases.get());
    if (!state->type_EmailMailboxSyncManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxSyncManager);

    state->type_EmailManager = py::register_python_type(module.get(), type_name_EmailManager, &type_spec_EmailManager, nullptr);
    if (!state->type_EmailManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailManager);

    state->type_EmailManagerForUser = py::register_python_type(module.get(), type_name_EmailManagerForUser, &type_spec_EmailManagerForUser, bases.get());
    if (!state->type_EmailManagerForUser)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailManagerForUser);

    state->type_EmailMeetingInfo = py::register_python_type(module.get(), type_name_EmailMeetingInfo, &type_spec_EmailMeetingInfo, bases.get());
    if (!state->type_EmailMeetingInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMeetingInfo);

    state->type_EmailMessage = py::register_python_type(module.get(), type_name_EmailMessage, &type_spec_EmailMessage, bases.get());
    if (!state->type_EmailMessage)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMessage);

    state->type_EmailMessageBatch = py::register_python_type(module.get(), type_name_EmailMessageBatch, &type_spec_EmailMessageBatch, bases.get());
    if (!state->type_EmailMessageBatch)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMessageBatch);

    state->type_EmailMessageReader = py::register_python_type(module.get(), type_name_EmailMessageReader, &type_spec_EmailMessageReader, bases.get());
    if (!state->type_EmailMessageReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMessageReader);

    state->type_EmailQueryOptions = py::register_python_type(module.get(), type_name_EmailQueryOptions, &type_spec_EmailQueryOptions, bases.get());
    if (!state->type_EmailQueryOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailQueryOptions);

    state->type_EmailQueryTextSearch = py::register_python_type(module.get(), type_name_EmailQueryTextSearch, &type_spec_EmailQueryTextSearch, bases.get());
    if (!state->type_EmailQueryTextSearch)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailQueryTextSearch);

    state->type_EmailRecipient = py::register_python_type(module.get(), type_name_EmailRecipient, &type_spec_EmailRecipient, bases.get());
    if (!state->type_EmailRecipient)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailRecipient);

    state->type_EmailRecipientResolutionResult = py::register_python_type(module.get(), type_name_EmailRecipientResolutionResult, &type_spec_EmailRecipientResolutionResult, bases.get());
    if (!state->type_EmailRecipientResolutionResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailRecipientResolutionResult);

    state->type_EmailStore = py::register_python_type(module.get(), type_name_EmailStore, &type_spec_EmailStore, bases.get());
    if (!state->type_EmailStore)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailStore);

    state->type_EmailStoreNotificationTriggerDetails = py::register_python_type(module.get(), type_name_EmailStoreNotificationTriggerDetails, &type_spec_EmailStoreNotificationTriggerDetails, bases.get());
    if (!state->type_EmailStoreNotificationTriggerDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailStoreNotificationTriggerDetails);
