...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_Appointments_DataProvider(void) noexcept
{
    ...
    state->type_AppointmentCalendarCancelMeetingRequest = py::register_python_type(module.get(), type_name_AppointmentCalendarCancelMeetingRequest, &type_spec_AppointmentCalendarCancelMeetingRequest, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarCancelMeetingRequest)
    {
        return nullptr;
    }

    state->type_AppointmentCalendarCancelMeetingRequestEventArgs = py::register_python_type(module.get(), type_name_AppointmentCalendarCancelMeetingRequestEventArgs, &type_spec_AppointmentCalendarCancelMeetingRequestEventArgs, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarCancelMeetingRequestEventArgs)
    {
        return nullptr;
    }

    state->type_AppointmentCalendarCreateOrUpdateAppointmentRequest = py::register_python_type(module.get(), type_name_AppointmentCalendarCreateOrUpdateAppointmentRequest, &type_spec_AppointmentCalendarCreateOrUpdateAppointmentRequest, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarCreateOrUpdateAppointmentRequest)
    {
        return nullptr;
    }

    state->type_AppointmentCalendarCreateOrUpdateAppointmentRequestEventArgs = py::register_python_type(module.get(), type_name_AppointmentCalendarCreateOrUpdateAppointmentRequestEventArgs, &type_spec_AppointmentCalendarCreateOrUpdateAppointmentRequestEventArgs, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarCreateOrUpdateAppointmentRequestEventArgs)
    {
        return nullptr;
    }

    state->type_AppointmentCalendarForwardMeetingRequest = py::register_python_type(module.get(), type_name_AppointmentCalendarForwardMeetingRequest, &type_spec_AppointmentCalendarForwardMeetingRequest, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarForwardMeetingRequest)
    {
        return nullptr;
    }

    state->type_AppointmentCalendarForwardMeetingRequestEventArgs = py::register_python_type(module.get(), type_name_AppointmentCalendarForwardMeetingRequestEventArgs, &type_spec_AppointmentCalendarForwardMeetingRequestEventArgs, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarForwardMeetingRequestEventArgs)
    {
        return nullptr;
    }

    state->type_AppointmentCalendarProposeNewTimeForMeetingRequest = py::register_python_type(module.get(), type_name_AppointmentCalendarProposeNewTimeForMeetingRequest, &type_spec_AppointmentCalendarProposeNewTimeForMeetingRequest, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarProposeNewTimeForMeetingRequest)
    {
        return nullptr;
    }

    state->type_AppointmentCalendarProposeNewTimeForMeetingRequestEventArgs = py::register_python_type(module.get(), type_name_AppointmentCalendarProposeNewTimeForMeetingRequestEventArgs, &type_spec_AppointmentCalendarProposeNewTimeForMeetingRequestEventArgs, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarProposeNewTimeForMeetingRequestEventArgs)
    {
        return nullptr;
    }

    state->type_AppointmentCalendarSyncManagerSyncRequest = py::register_python_type(module.get(), type_name_AppointmentCalendarSyncManagerSyncRequest, &type_spec_AppointmentCalendarSyncManagerSyncRequest, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarSyncManagerSyncRequest)
    {
        return nullptr;
    }

    state->type_AppointmentCalendarSyncManagerSyncRequestEventArgs = py::register_python_type(module.get(), type_name_AppointmentCalendarSyncManagerSyncRequestEventArgs, &type_spec_AppointmentCalendarSyncManagerSyncRequestEventArgs, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarSyncManagerSyncRequestEventArgs)
    {
        return nullptr;
    }

    state->type_AppointmentCalendarUpdateMeetingResponseRequest = py::register_python_type(module.get(), type_name_AppointmentCalendarUpdateMeetingResponseRequest, &type_spec_AppointmentCalendarUpdateMeetingResponseRequest, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarUpdateMeetingResponseRequest)
    {
        return nullptr;
    }

    state->type_AppointmentCalendarUpdateMeetingResponseRequestEventArgs = py::register_python_type(module.get(), type_name_AppointmentCalendarUpdateMeetingResponseRequestEventArgs, &type_spec_AppointmentCalendarUpdateMeetingResponseRequestEventArgs, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarUpdateMeetingResponseRequestEventArgs)
    {
        return nullptr;
    }

    state->type_AppointmentDataProviderConnection = py::register_python_type(module.get(), type_name_AppointmentDataProviderConnection, &type_spec_AppointmentDataProviderConnection, bases.get(), nullptr);
    if (!state->type_AppointmentDataProviderConnection)
    {
        return nullptr;
    }

    state->type_AppointmentDataProviderTriggerDetails = py::register_python_type(module.get(), type_name_AppointmentDataProviderTriggerDetails, &type_spec_AppointmentDataProviderTriggerDetails, bases.get(), nullptr);
