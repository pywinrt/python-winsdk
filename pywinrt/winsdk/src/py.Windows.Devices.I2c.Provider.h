...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::I2c::Provider::ProviderI2cBusSpeed> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::I2c::Provider::ProviderI2cSharingMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::I2c::Provider::ProviderI2cTransferStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::I2c::Provider::ProviderI2cTransferResult> = "T{i:status:I:bytes_transferred:}";
