...
namespace py::cpp::Windows::ApplicationModel::Appointments
{
    ...
    static PyObject* register_AppointmentBusyStatus(PyObject* module, PyObject* type) noexcept
    {
    ...
    static PyObject* register_AppointmentCalendarOtherAppReadAccess(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentCalendarOtherAppWriteAccess(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentCalendarSyncStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentConflictType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentDaysOfWeek(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentDetailsKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentParticipantResponse(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentParticipantRole(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentRecurrenceUnit(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentSensitivity(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentStoreAccessType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentStoreChangeType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentSummaryCardView(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppointmentWeekOfMonth(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_FindAppointmentCalendarsOptions(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RecurrenceType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static constexpr const char* const type_name_AppointmentCalendar = "AppointmentCalendar";
    ...
    static constexpr const char* const type_name_AppointmentCalendarSyncManager = "AppointmentCalendarSyncManager";
    ...
    static constexpr const char* const type_name_AppointmentConflictResult = "AppointmentConflictResult";
    ...
    static constexpr const char* const type_name_AppointmentException = "AppointmentException";
    ...
    static constexpr const char* const type_name_AppointmentInvitee = "AppointmentInvitee";
    ...
    static constexpr const char* const type_name_AppointmentManager = "AppointmentManager";
    ...
    static constexpr const char* const type_name_AppointmentManagerForUser = "AppointmentManagerForUser";
    ...
    static constexpr const char* const type_name_AppointmentOrganizer = "AppointmentOrganizer";
    ...
    static constexpr const char* const type_name_AppointmentProperties = "AppointmentProperties";
    ...
    {
        "_winsdk_Windows_ApplicationModel_Appointments.AppointmentProperties_Meta",
    ...
    static constexpr const char* const type_name_AppointmentRecurrence = "AppointmentRecurrence";
    ...
    static constexpr const char* const type_name_AppointmentStore = "AppointmentStore";
    ...
    static constexpr const char* const type_name_AppointmentStoreChange = "AppointmentStoreChange";
    ...
    static constexpr const char* const type_name_AppointmentStoreChangeReader = "AppointmentStoreChangeReader";
    ...
    static constexpr const char* const type_name_AppointmentStoreChangeTracker = "AppointmentStoreChangeTracker";
    ...
    static constexpr const char* const type_name_AppointmentStoreChangedDeferral = "AppointmentStoreChangedDeferral";
    ...
    static constexpr const char* const type_name_AppointmentStoreChangedEventArgs = "AppointmentStoreChangedEventArgs";
    ...
    static constexpr const char* const type_name_AppointmentStoreNotificationTriggerDetails = "AppointmentStoreNotificationTriggerDetails";
    ...
    static constexpr const char* const type_name_FindAppointmentsOptions = "FindAppointmentsOptions";
    ...
    static constexpr const char* const type_name_IAppointmentParticipant = "IAppointmentParticipant";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_Appointments(void) noexcept
{
    ...
    state->type_Appointment = py::register_python_type(module.get(), type_name_Appointment, &type_spec_Appointment, bases.get(), nullptr);
    if (!state->type_Appointment)
    {
        return nullptr;
    }

    state->type_AppointmentCalendar = py::register_python_type(module.get(), type_name_AppointmentCalendar, &type_spec_AppointmentCalendar, bases.get(), nullptr);
    if (!state->type_AppointmentCalendar)
    {
        return nullptr;
    }

    state->type_AppointmentCalendarSyncManager = py::register_python_type(module.get(), type_name_AppointmentCalendarSyncManager, &type_spec_AppointmentCalendarSyncManager, bases.get(), nullptr);
    if (!state->type_AppointmentCalendarSyncManager)
    {
        return nullptr;
    }

    state->type_AppointmentConflictResult = py::register_python_type(module.get(), type_name_AppointmentConflictResult, &type_spec_AppointmentConflictResult, bases.get(), nullptr);
    if (!state->type_AppointmentConflictResult)
    {
        return nullptr;
    }

    state->type_AppointmentException = py::register_python_type(module.get(), type_name_AppointmentException, &type_spec_AppointmentException, bases.get(), nullptr);
    if (!state->type_AppointmentException)
    {
        return nullptr;
    }

    state->type_AppointmentInvitee = py::register_python_type(module.get(), type_name_AppointmentInvitee, &type_spec_AppointmentInvitee, bases.get(), nullptr);
    if (!state->type_AppointmentInvitee)
    {
        return nullptr;
    }

    state->type_AppointmentManager = py::register_python_type(module.get(), type_name_AppointmentManager, &type_spec_AppointmentManager, nullptr, nullptr);
    if (!state->type_AppointmentManager)
    {
        return nullptr;
    }

    state->type_AppointmentManagerForUser = py::register_python_type(module.get(), type_name_AppointmentManagerForUser, &type_spec_AppointmentManagerForUser, bases.get(), nullptr);
    if (!state->type_AppointmentManagerForUser)
    {
        return nullptr;
    }

    state->type_AppointmentOrganizer = py::register_python_type(module.get(), type_name_AppointmentOrganizer, &type_spec_AppointmentOrganizer, bases.get(), nullptr);
    ...
    state->type_AppointmentProperties = py::register_python_type(module.get(), type_name_AppointmentProperties, &type_spec_AppointmentProperties, nullptr, reinterpret_cast<PyTypeObject*>(type_AppointmentProperties_Meta.get()));
    if (!state->type_AppointmentProperties)
    {
        return nullptr;
    }

    state->type_AppointmentRecurrence = py::register_python_type(module.get(), type_name_AppointmentRecurrence, &type_spec_AppointmentRecurrence, bases.get(), nullptr);
    if (!state->type_AppointmentRecurrence)
    {
        return nullptr;
    }

    state->type_AppointmentStore = py::register_python_type(module.get(), type_name_AppointmentStore, &type_spec_AppointmentStore, bases.get(), nullptr);
    if (!state->type_AppointmentStore)
    {
        return nullptr;
    }

    state->type_AppointmentStoreChange = py::register_python_type(module.get(), type_name_AppointmentStoreChange, &type_spec_AppointmentStoreChange, bases.get(), nullptr);
    if (!state->type_AppointmentStoreChange)
    {
        return nullptr;
    }

    state->type_AppointmentStoreChangeReader = py::register_python_type(module.get(), type_name_AppointmentStoreChangeReader, &type_spec_AppointmentStoreChangeReader, bases.get(), nullptr);
    if (!state->type_AppointmentStoreChangeReader)
    {
        return nullptr;
    }

    state->type_AppointmentStoreChangeTracker = py::register_python_type(module.get(), type_name_AppointmentStoreChangeTracker, &type_spec_AppointmentStoreChangeTracker, bases.get(), nullptr);
    if (!state->type_AppointmentStoreChangeTracker)
    {
        return nullptr;
    }

    state->type_AppointmentStoreChangedDeferral = py::register_python_type(module.get(), type_name_AppointmentStoreChangedDeferral, &type_spec_AppointmentStoreChangedDeferral, bases.get(), nullptr);
    if (!state->type_AppointmentStoreChangedDeferral)
    {
        return nullptr;
    }

    state->type_AppointmentStoreChangedEventArgs = py::register_python_type(module.get(), type_name_AppointmentStoreChangedEventArgs, &type_spec_AppointmentStoreChangedEventArgs, bases.get(), nullptr);
    if (!state->type_AppointmentStoreChangedEventArgs)
    {
        return nullptr;
    }

    state->type_AppointmentStoreNotificationTriggerDetails = py::register_python_type(module.get(), type_name_AppointmentStoreNotificationTriggerDetails, &type_spec_AppointmentStoreNotificationTriggerDetails, bases.get(), nullptr);
    if (!state->type_AppointmentStoreNotificationTriggerDetails)
    {
        return nullptr;
    }

    state->type_FindAppointmentsOptions = py::register_python_type(module.get(), type_name_FindAppointmentsOptions, &type_spec_FindAppointmentsOptions, bases.get(), nullptr);
    if (!state->type_FindAppointmentsOptions)
    {
        return nullptr;
    }

    state->type_IAppointmentParticipant = py::register_python_type(module.get(), type_name_IAppointmentParticipant, &type_spec_IAppointmentParticipant, bases.get(), nullptr);
