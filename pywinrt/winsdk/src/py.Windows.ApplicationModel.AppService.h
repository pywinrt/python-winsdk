...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::AppService::AppServiceClosedStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::AppService::AppServiceConnectionStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::AppService::AppServiceResponseStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::AppService::StatelessAppServiceResponseStatus> = "i";
