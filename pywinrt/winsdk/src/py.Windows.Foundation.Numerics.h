...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Numerics::float3x2> = "T{f:m11:f:m12:f:m21:f:m22:f:m31:f:m32:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Numerics::float4x4> = "T{f:m11:f:m12:f:m13:f:m14:f:m21:f:m22:f:m23:f:m24:f:m31:f:m32:f:m33:f:m34:f:m41:f:m42:f:m43:f:m44:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Numerics::plane> = "T{T{f:x:f:y:f:z:}:normal:f:d:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Numerics::quaternion> = "T{f:x:f:y:f:z:f:w:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Numerics::Rational> = "T{I:numerator:I:denominator:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Numerics::float2> = "T{f:x:f:y:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Numerics::float3> = "T{f:x:f:y:f:z:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Numerics::float4> = "T{f:x:f:y:f:z:f:w:}";
