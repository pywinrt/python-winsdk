...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::TargetedContent::TargetedContentAppInstallationState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::TargetedContent::TargetedContentAvailability> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::TargetedContent::TargetedContentInteraction> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::TargetedContent::TargetedContentObjectKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::TargetedContent::TargetedContentValueKind> = "i";
