...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::ControlChannelTriggerResetReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::ControlChannelTriggerResourceType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::ControlChannelTriggerStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::MessageWebSocketReceiveMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::SocketActivityConnectedStandbyAction> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::SocketActivityKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::SocketActivityTriggerReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::SocketErrorStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::SocketMessageType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::SocketProtectionLevel> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::SocketQualityOfService> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::SocketSslErrorSeverity> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::BandwidthStatistics> = "T{Q:outbound_bits_per_second:Q:inbound_bits_per_second:Q:outbound_bits_per_second_instability:Q:inbound_bits_per_second_instability:?:outbound_bandwidth_peaked:?:inbound_bandwidth_peaked:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Sockets::RoundTripTimeStatistics> = "T{I:variance:I:max:I:min:I:sum:}";
