...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Phone::Media::Devices::AudioRoutingEndpoint> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Phone::Media::Devices::AvailableAudioRoutingEndpoints> = "I";
