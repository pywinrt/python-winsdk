...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Web::Http::HttpCompletionOption> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Web::Http::HttpProgressStage> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Web::Http::HttpResponseMessageSource> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Web::Http::HttpStatusCode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Web::Http::HttpVersion> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Web::Http::HttpProgress> = "T{i:stage:Q:bytes_sent:Q:total_bytes_to_send:Q:bytes_received:Q:total_bytes_to_receive:I:retries:}";
