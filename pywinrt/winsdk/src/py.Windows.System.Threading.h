...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Threading::WorkItemOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Threading::WorkItemPriority> = "i";
