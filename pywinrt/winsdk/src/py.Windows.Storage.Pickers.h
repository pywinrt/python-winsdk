...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Pickers::PickerLocationId> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Pickers::PickerViewMode> = "i";
