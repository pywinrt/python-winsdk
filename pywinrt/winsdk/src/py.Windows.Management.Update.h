...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Management::Update::WindowsUpdateAdministratorOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Management::Update::WindowsUpdateAdministratorStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Management::Update::WindowsUpdateAttentionRequiredReason> = "i";
