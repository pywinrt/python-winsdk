...
winrt::Windows::Perception::Spatial::SpatialBoundingBox py::converter<winrt::Windows::Perception::Spatial::SpatialBoundingBox>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Perception::Spatial::SpatialBoundingBox or dict");
    ...
    if (!py_Center) {
        PyErr_SetString(PyExc_KeyError, "Center");
        throw python_exception();
    }
    ...
    if (!py_Extents) {
        PyErr_SetString(PyExc_KeyError, "Extents");
        throw python_exception();
    }
...
winrt::Windows::Perception::Spatial::SpatialBoundingFrustum py::converter<winrt::Windows::Perception::Spatial::SpatialBoundingFrustum>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Perception::Spatial::SpatialBoundingFrustum or dict");
        throw python_exception();
    }
    ...
    if (!py_Near) {
        PyErr_SetString(PyExc_KeyError, "Near");
        throw python_exception();
    }
    ...
    if (!py_Far) {
        PyErr_SetString(PyExc_KeyError, "Far");
        throw python_exception();
    }
    ...
    if (!py_Right) {
        PyErr_SetString(PyExc_KeyError, "Right");
        throw python_exception();
    }
    ...
    if (!py_Left) {
        PyErr_SetString(PyExc_KeyError, "Left");
        throw python_exception();
    }
    ...
    if (!py_Top) {
        PyErr_SetString(PyExc_KeyError, "Top");
        throw python_exception();
    }
    ...
    if (!py_Bottom) {
        PyErr_SetString(PyExc_KeyError, "Bottom");
        throw python_exception();
    }
...
winrt::Windows::Perception::Spatial::SpatialBoundingOrientedBox py::converter<winrt::Windows::Perception::Spatial::SpatialBoundingOrientedBox>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Perception::Spatial::SpatialBoundingOrientedBox or dict");
        throw python_exception();
    }
    ...
    if (!py_Orientation) {
        PyErr_SetString(PyExc_KeyError, "Orientation");
        throw python_exception();
    }
...
winrt::Windows::Perception::Spatial::SpatialBoundingSphere py::converter<winrt::Windows::Perception::Spatial::SpatialBoundingSphere>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Perception::Spatial::SpatialBoundingSphere or dict");
        throw python_exception();
    }
    ...
    if (!py_Radius) {
        PyErr_SetString(PyExc_KeyError, "Radius");
        throw python_exception();
    }
...
winrt::Windows::Perception::Spatial::SpatialRay py::converter<winrt::Windows::Perception::Spatial::SpatialRay>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Perception::Spatial::SpatialRay or dict");
        throw python_exception();
    }
    ...
    if (!py_Origin) {
        PyErr_SetString(PyExc_KeyError, "Origin");
        throw python_exception();
    }
    ...
    if (!py_Direction) {
        PyErr_SetString(PyExc_KeyError, "Direction");
        throw python_exception();
    }
