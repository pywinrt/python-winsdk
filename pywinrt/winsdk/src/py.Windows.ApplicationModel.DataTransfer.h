...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::DataTransfer::ClipboardHistoryItemsResultStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::DataTransfer::DataPackageOperation> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::DataTransfer::SetHistoryItemAsContentStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::DataTransfer::ShareUITheme> = "i";
