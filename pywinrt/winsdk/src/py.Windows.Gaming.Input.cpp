...
winrt::Windows::Gaming::Input::ArcadeStickReading py::converter<winrt::Windows::Gaming::Input::ArcadeStickReading>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Gaming::Input::ArcadeStickReading or dict");
    ...
    if (!py_Timestamp) {
        PyErr_SetString(PyExc_KeyError, "Timestamp");
        throw python_exception();
    }
    ...
    if (!py_Buttons) {
        PyErr_SetString(PyExc_KeyError, "Buttons");
        throw python_exception();
    }
...
winrt::Windows::Gaming::Input::FlightStickReading py::converter<winrt::Windows::Gaming::Input::FlightStickReading>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Gaming::Input::FlightStickReading or dict");
        throw python_exception();
    }
    ...
    if (!py_HatSwitch) {
        PyErr_SetString(PyExc_KeyError, "HatSwitch");
        throw python_exception();
    }
    ...
    if (!py_Roll) {
        PyErr_SetString(PyExc_KeyError, "Roll");
        throw python_exception();
    }
    ...
    if (!py_Pitch) {
        PyErr_SetString(PyExc_KeyError, "Pitch");
        throw python_exception();
    }
    ...
    if (!py_Yaw) {
        PyErr_SetString(PyExc_KeyError, "Yaw");
        throw python_exception();
    }
    ...
    if (!py_Throttle) {
        PyErr_SetString(PyExc_KeyError, "Throttle");
        throw python_exception();
    }
...
winrt::Windows::Gaming::Input::GamepadReading py::converter<winrt::Windows::Gaming::Input::GamepadReading>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Gaming::Input::GamepadReading or dict");
        throw python_exception();
    }
    ...
    if (!py_LeftTrigger) {
        PyErr_SetString(PyExc_KeyError, "LeftTrigger");
        throw python_exception();
    }
    ...
    if (!py_RightTrigger) {
        PyErr_SetString(PyExc_KeyError, "RightTrigger");
        throw python_exception();
    }
    ...
    if (!py_LeftThumbstickX) {
        PyErr_SetString(PyExc_KeyError, "LeftThumbstickX");
        throw python_exception();
    }
    ...
    if (!py_LeftThumbstickY) {
        PyErr_SetString(PyExc_KeyError, "LeftThumbstickY");
        throw python_exception();
    }
    ...
    if (!py_RightThumbstickX) {
        PyErr_SetString(PyExc_KeyError, "RightThumbstickX");
        throw python_exception();
    }
    ...
    if (!py_RightThumbstickY) {
        PyErr_SetString(PyExc_KeyError, "RightThumbstickY");
        throw python_exception();
    }
...
winrt::Windows::Gaming::Input::GamepadVibration py::converter<winrt::Windows::Gaming::Input::GamepadVibration>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Gaming::Input::GamepadVibration or dict");
        throw python_exception();
    }
    ...
    if (!py_LeftMotor) {
        PyErr_SetString(PyExc_KeyError, "LeftMotor");
        throw python_exception();
    }
    ...
    if (!py_RightMotor) {
        PyErr_SetString(PyExc_KeyError, "RightMotor");
        throw python_exception();
    }
...
winrt::Windows::Gaming::Input::RacingWheelReading py::converter<winrt::Windows::Gaming::Input::RacingWheelReading>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Gaming::Input::RacingWheelReading or dict");
        throw python_exception();
    }
    ...
    if (!py_PatternShifterGear) {
        PyErr_SetString(PyExc_KeyError, "PatternShifterGear");
        throw python_exception();
    }
    ...
    if (!py_Wheel) {
        PyErr_SetString(PyExc_KeyError, "Wheel");
        throw python_exception();
    }
    ...
    if (!py_Brake) {
        PyErr_SetString(PyExc_KeyError, "Brake");
        throw python_exception();
    }
    ...
    if (!py_Clutch) {
        PyErr_SetString(PyExc_KeyError, "Clutch");
        throw python_exception();
    }
    ...
    if (!py_Handbrake) {
        PyErr_SetString(PyExc_KeyError, "Handbrake");
        throw python_exception();
    }
...
winrt::Windows::Gaming::Input::UINavigationReading py::converter<winrt::Windows::Gaming::Input::UINavigationReading>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Gaming::Input::UINavigationReading or dict");
        throw python_exception();
    }
    ...
    if (!py_RequiredButtons) {
        PyErr_SetString(PyExc_KeyError, "RequiredButtons");
        throw python_exception();
    }
    ...
    if (!py_OptionalButtons) {
        PyErr_SetString(PyExc_KeyError, "OptionalButtons");
        throw python_exception();
    }
