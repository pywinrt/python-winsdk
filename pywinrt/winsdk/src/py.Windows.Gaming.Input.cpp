...
namespace py::cpp::Windows::Gaming::Input
{
    ...
    static PyType_Slot type_slots_ArcadeStick_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_ArcadeStick_Meta },
        { }
    };

    static PyType_Spec type_spec_ArcadeStick_Meta =
    {
        "_winsdk_Windows_Gaming_Input.ArcadeStick_Meta",
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_FlightStick_Meta },
        { }
    };

    static PyType_Spec type_spec_FlightStick_Meta =
    {
        "_winsdk_Windows_Gaming_Input.FlightStick_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_Gamepad_Meta },
        { }
    };

    static PyType_Spec type_spec_Gamepad_Meta =
    {
        "_winsdk_Windows_Gaming_Input.Gamepad_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_RacingWheel_Meta },
        { }
    };

    static PyType_Spec type_spec_RacingWheel_Meta =
    {
        "_winsdk_Windows_Gaming_Input.RacingWheel_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_RawGameController_Meta },
        { }
    };

    static PyType_Spec type_spec_RawGameController_Meta =
    {
        "_winsdk_Windows_Gaming_Input.RawGameController_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_UINavigationController_Meta },
        { }
    };

    static PyType_Spec type_spec_UINavigationController_Meta =
    {
        "_winsdk_Windows_Gaming_Input.UINavigationController_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Gaming_Input(void) noexcept
{
    ...
    state->type_ArcadeStick = py::register_python_type(module.get(), type_name_ArcadeStick, &type_spec_ArcadeStick, bases.get(), reinterpret_cast<PyTypeObject*>(type_ArcadeStick_Meta.get()));
    ...
    state->type_FlightStick = py::register_python_type(module.get(), type_name_FlightStick, &type_spec_FlightStick, bases.get(), reinterpret_cast<PyTypeObject*>(type_FlightStick_Meta.get()));
    ...
    state->type_Gamepad = py::register_python_type(module.get(), type_name_Gamepad, &type_spec_Gamepad, bases.get(), reinterpret_cast<PyTypeObject*>(type_Gamepad_Meta.get()));
    if (!state->type_Gamepad)
    {
        return nullptr;
    }

    state->type_Headset = py::register_python_type(module.get(), type_name_Headset, &type_spec_Headset, bases.get(), nullptr);
    ...
    state->type_RacingWheel = py::register_python_type(module.get(), type_name_RacingWheel, &type_spec_RacingWheel, bases.get(), reinterpret_cast<PyTypeObject*>(type_RacingWheel_Meta.get()));
    ...
    state->type_RawGameController = py::register_python_type(module.get(), type_name_RawGameController, &type_spec_RawGameController, bases.get(), reinterpret_cast<PyTypeObject*>(type_RawGameController_Meta.get()));
    ...
    state->type_UINavigationController = py::register_python_type(module.get(), type_name_UINavigationController, &type_spec_UINavigationController, bases.get(), reinterpret_cast<PyTypeObject*>(type_UINavigationController_Meta.get()));
    if (!state->type_UINavigationController)
    {
        return nullptr;
    }

    state->type_IGameController = py::register_python_type(module.get(), type_name_IGameController, &type_spec_IGameController, bases.get(), nullptr);
    if (!state->type_IGameController)
    {
        return nullptr;
    }

    state->type_IGameControllerBatteryInfo = py::register_python_type(module.get(), type_name_IGameControllerBatteryInfo, &type_spec_IGameControllerBatteryInfo, bases.get(), nullptr);
    if (!state->type_IGameControllerBatteryInfo)
    {
        return nullptr;
    }

    state->type_ArcadeStickReading = py::register_python_type(module.get(), type_name_ArcadeStickReading, &type_spec_ArcadeStickReading, bases.get(), nullptr);
    if (!state->type_ArcadeStickReading)
    {
        return nullptr;
    }

    state->type_FlightStickReading = py::register_python_type(module.get(), type_name_FlightStickReading, &type_spec_FlightStickReading, bases.get(), nullptr);
    if (!state->type_FlightStickReading)
    {
        return nullptr;
    }

    state->type_GamepadReading = py::register_python_type(module.get(), type_name_GamepadReading, &type_spec_GamepadReading, bases.get(), nullptr);
    if (!state->type_GamepadReading)
    {
        return nullptr;
    }

    state->type_GamepadVibration = py::register_python_type(module.get(), type_name_GamepadVibration, &type_spec_GamepadVibration, bases.get(), nullptr);
    if (!state->type_GamepadVibration)
    {
        return nullptr;
    }

    state->type_RacingWheelReading = py::register_python_type(module.get(), type_name_RacingWheelReading, &type_spec_RacingWheelReading, bases.get(), nullptr);
    if (!state->type_RacingWheelReading)
    {
        return nullptr;
    }

    state->type_UINavigationReading = py::register_python_type(module.get(), type_name_UINavigationReading, &type_spec_UINavigationReading, bases.get(), nullptr);
