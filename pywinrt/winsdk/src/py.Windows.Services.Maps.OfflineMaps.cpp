...
namespace py::cpp::Windows::Services::Maps::OfflineMaps
{
    ...
    static PyObject* register_OfflineMapPackageQueryStatus(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_OfflineMapPackageStartDownloadStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_OfflineMapPackageStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_OfflineMapPackage = "OfflineMapPackage";
    ...
    constexpr const char* const type_name_OfflineMapPackageQueryResult = "OfflineMapPackageQueryResult";
    ...
    constexpr const char* const type_name_OfflineMapPackageStartDownloadResult = "OfflineMapPackageStartDownloadResult";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Services_Maps_OfflineMaps(void) noexcept
{
    ...
    state->type_OfflineMapPackage = py::register_python_type(module.get(), type_name_OfflineMapPackage, &type_spec_OfflineMapPackage, bases.get());
    if (!state->type_OfflineMapPackage)
    {
        return nullptr;
    }

    Py_INCREF(state->type_OfflineMapPackage);

    state->type_OfflineMapPackageQueryResult = py::register_python_type(module.get(), type_name_OfflineMapPackageQueryResult, &type_spec_OfflineMapPackageQueryResult, bases.get());
    if (!state->type_OfflineMapPackageQueryResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_OfflineMapPackageQueryResult);

    state->type_OfflineMapPackageStartDownloadResult = py::register_python_type(module.get(), type_name_OfflineMapPackageStartDownloadResult, &type_spec_OfflineMapPackageStartDownloadResult, bases.get());
    if (!state->type_OfflineMapPackageStartDownloadResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_OfflineMapPackageStartDownloadResult);
