...
namespace py::cpp::Windows::System::RemoteSystems
{
    ...
    static PyObject* register_RemoteSystemAccessStatus(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_RemoteSystemAuthorizationKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RemoteSystemDiscoveryType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RemoteSystemPlatform(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RemoteSystemSessionCreationStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RemoteSystemSessionDisconnectedReason(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RemoteSystemSessionJoinStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RemoteSystemSessionMessageChannelReliability(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RemoteSystemSessionParticipantWatcherStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RemoteSystemSessionWatcherStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RemoteSystemStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RemoteSystemStatusType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RemoteSystemWatcherError(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_KnownRemoteSystemCapabilities = "KnownRemoteSystemCapabilities";
    ...
    // ----- RemoteSystem class --------------------
    constexpr const char* const type_name_RemoteSystem = "RemoteSystem";
    ...
    constexpr const char* const type_name_RemoteSystemAddedEventArgs = "RemoteSystemAddedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemApp = "RemoteSystemApp";
    ...
    constexpr const char* const type_name_RemoteSystemAppRegistration = "RemoteSystemAppRegistration";
    ...
    constexpr const char* const type_name_RemoteSystemAuthorizationKindFilter = "RemoteSystemAuthorizationKindFilter";
    ...
    constexpr const char* const type_name_RemoteSystemConnectionInfo = "RemoteSystemConnectionInfo";
    ...
    constexpr const char* const type_name_RemoteSystemConnectionRequest = "RemoteSystemConnectionRequest";
    ...
    constexpr const char* const type_name_RemoteSystemDiscoveryTypeFilter = "RemoteSystemDiscoveryTypeFilter";
    ...
    constexpr const char* const type_name_RemoteSystemEnumerationCompletedEventArgs = "RemoteSystemEnumerationCompletedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemKindFilter = "RemoteSystemKindFilter";
    ...
    constexpr const char* const type_name_RemoteSystemKinds = "RemoteSystemKinds";
    ...
    constexpr const char* const type_name_RemoteSystemRemovedEventArgs = "RemoteSystemRemovedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemSession = "RemoteSystemSession";
    ...
    constexpr const char* const type_name_RemoteSystemSessionAddedEventArgs = "RemoteSystemSessionAddedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemSessionController = "RemoteSystemSessionController";
    ...
    constexpr const char* const type_name_RemoteSystemSessionCreationResult = "RemoteSystemSessionCreationResult";
    ...
    constexpr const char* const type_name_RemoteSystemSessionDisconnectedEventArgs = "RemoteSystemSessionDisconnectedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemSessionInfo = "RemoteSystemSessionInfo";
    ...
    constexpr const char* const type_name_RemoteSystemSessionInvitation = "RemoteSystemSessionInvitation";
    ...
    constexpr const char* const type_name_RemoteSystemSessionInvitationListener = "RemoteSystemSessionInvitationListener";
    ...
    constexpr const char* const type_name_RemoteSystemSessionInvitationReceivedEventArgs = "RemoteSystemSessionInvitationReceivedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemSessionJoinRequest = "RemoteSystemSessionJoinRequest";
    ...
    constexpr const char* const type_name_RemoteSystemSessionJoinRequestedEventArgs = "RemoteSystemSessionJoinRequestedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemSessionJoinResult = "RemoteSystemSessionJoinResult";
    ...
    constexpr const char* const type_name_RemoteSystemSessionMessageChannel = "RemoteSystemSessionMessageChannel";
    ...
    constexpr const char* const type_name_RemoteSystemSessionOptions = "RemoteSystemSessionOptions";
    ...
    constexpr const char* const type_name_RemoteSystemSessionParticipant = "RemoteSystemSessionParticipant";
    ...
    constexpr const char* const type_name_RemoteSystemSessionParticipantAddedEventArgs = "RemoteSystemSessionParticipantAddedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemSessionParticipantRemovedEventArgs = "RemoteSystemSessionParticipantRemovedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemSessionParticipantWatcher = "RemoteSystemSessionParticipantWatcher";
    ...
    constexpr const char* const type_name_RemoteSystemSessionRemovedEventArgs = "RemoteSystemSessionRemovedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemSessionUpdatedEventArgs = "RemoteSystemSessionUpdatedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemSessionValueSetReceivedEventArgs = "RemoteSystemSessionValueSetReceivedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemSessionWatcher = "RemoteSystemSessionWatcher";
    ...
    constexpr const char* const type_name_RemoteSystemStatusTypeFilter = "RemoteSystemStatusTypeFilter";
    ...
    constexpr const char* const type_name_RemoteSystemUpdatedEventArgs = "RemoteSystemUpdatedEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemWatcher = "RemoteSystemWatcher";
    ...
    constexpr const char* const type_name_RemoteSystemWatcherErrorOccurredEventArgs = "RemoteSystemWatcherErrorOccurredEventArgs";
    ...
    constexpr const char* const type_name_RemoteSystemWebAccountFilter = "RemoteSystemWebAccountFilter";
    ...
    constexpr const char* const type_name_IRemoteSystemFilter = "IRemoteSystemFilter";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_System_RemoteSystems(void) noexcept
{
    ...
    state->type_KnownRemoteSystemCapabilities = py::register_python_type(module.get(), type_name_KnownRemoteSystemCapabilities, &type_spec_KnownRemoteSystemCapabilities, nullptr);
    if (!state->type_KnownRemoteSystemCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_KnownRemoteSystemCapabilities);

    state->type_RemoteSystem = py::register_python_type(module.get(), type_name_RemoteSystem, &type_spec_RemoteSystem, bases.get());
    if (!state->type_RemoteSystem)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystem);

    state->type_RemoteSystemAddedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemAddedEventArgs, &type_spec_RemoteSystemAddedEventArgs, bases.get());
    if (!state->type_RemoteSystemAddedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemAddedEventArgs);

    state->type_RemoteSystemApp = py::register_python_type(module.get(), type_name_RemoteSystemApp, &type_spec_RemoteSystemApp, bases.get());
    if (!state->type_RemoteSystemApp)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemApp);

    state->type_RemoteSystemAppRegistration = py::register_python_type(module.get(), type_name_RemoteSystemAppRegistration, &type_spec_RemoteSystemAppRegistration, bases.get());
    if (!state->type_RemoteSystemAppRegistration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemAppRegistration);

    state->type_RemoteSystemAuthorizationKindFilter = py::register_python_type(module.get(), type_name_RemoteSystemAuthorizationKindFilter, &type_spec_RemoteSystemAuthorizationKindFilter, bases.get());
    if (!state->type_RemoteSystemAuthorizationKindFilter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemAuthorizationKindFilter);

    state->type_RemoteSystemConnectionInfo = py::register_python_type(module.get(), type_name_RemoteSystemConnectionInfo, &type_spec_RemoteSystemConnectionInfo, bases.get());
    if (!state->type_RemoteSystemConnectionInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemConnectionInfo);

    state->type_RemoteSystemConnectionRequest = py::register_python_type(module.get(), type_name_RemoteSystemConnectionRequest, &type_spec_RemoteSystemConnectionRequest, bases.get());
    if (!state->type_RemoteSystemConnectionRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemConnectionRequest);

    state->type_RemoteSystemDiscoveryTypeFilter = py::register_python_type(module.get(), type_name_RemoteSystemDiscoveryTypeFilter, &type_spec_RemoteSystemDiscoveryTypeFilter, bases.get());
    if (!state->type_RemoteSystemDiscoveryTypeFilter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemDiscoveryTypeFilter);

    state->type_RemoteSystemEnumerationCompletedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemEnumerationCompletedEventArgs, &type_spec_RemoteSystemEnumerationCompletedEventArgs, bases.get());
    if (!state->type_RemoteSystemEnumerationCompletedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemEnumerationCompletedEventArgs);

    state->type_RemoteSystemKindFilter = py::register_python_type(module.get(), type_name_RemoteSystemKindFilter, &type_spec_RemoteSystemKindFilter, bases.get());
    if (!state->type_RemoteSystemKindFilter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemKindFilter);

    state->type_RemoteSystemKinds = py::register_python_type(module.get(), type_name_RemoteSystemKinds, &type_spec_RemoteSystemKinds, nullptr);
    if (!state->type_RemoteSystemKinds)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemKinds);

    state->type_RemoteSystemRemovedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemRemovedEventArgs, &type_spec_RemoteSystemRemovedEventArgs, bases.get());
    if (!state->type_RemoteSystemRemovedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemRemovedEventArgs);

    state->type_RemoteSystemSession = py::register_python_type(module.get(), type_name_RemoteSystemSession, &type_spec_RemoteSystemSession, bases.get());
    if (!state->type_RemoteSystemSession)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSession);

    state->type_RemoteSystemSessionAddedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemSessionAddedEventArgs, &type_spec_RemoteSystemSessionAddedEventArgs, bases.get());
    if (!state->type_RemoteSystemSessionAddedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionAddedEventArgs);

    state->type_RemoteSystemSessionController = py::register_python_type(module.get(), type_name_RemoteSystemSessionController, &type_spec_RemoteSystemSessionController, bases.get());
    if (!state->type_RemoteSystemSessionController)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionController);

    state->type_RemoteSystemSessionCreationResult = py::register_python_type(module.get(), type_name_RemoteSystemSessionCreationResult, &type_spec_RemoteSystemSessionCreationResult, bases.get());
    if (!state->type_RemoteSystemSessionCreationResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionCreationResult);

    state->type_RemoteSystemSessionDisconnectedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemSessionDisconnectedEventArgs, &type_spec_RemoteSystemSessionDisconnectedEventArgs, bases.get());
    if (!state->type_RemoteSystemSessionDisconnectedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionDisconnectedEventArgs);

    state->type_RemoteSystemSessionInfo = py::register_python_type(module.get(), type_name_RemoteSystemSessionInfo, &type_spec_RemoteSystemSessionInfo, bases.get());
    if (!state->type_RemoteSystemSessionInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionInfo);

    state->type_RemoteSystemSessionInvitation = py::register_python_type(module.get(), type_name_RemoteSystemSessionInvitation, &type_spec_RemoteSystemSessionInvitation, bases.get());
    if (!state->type_RemoteSystemSessionInvitation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionInvitation);

    state->type_RemoteSystemSessionInvitationListener = py::register_python_type(module.get(), type_name_RemoteSystemSessionInvitationListener, &type_spec_RemoteSystemSessionInvitationListener, bases.get());
    if (!state->type_RemoteSystemSessionInvitationListener)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionInvitationListener);

    state->type_RemoteSystemSessionInvitationReceivedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemSessionInvitationReceivedEventArgs, &type_spec_RemoteSystemSessionInvitationReceivedEventArgs, bases.get());
    if (!state->type_RemoteSystemSessionInvitationReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionInvitationReceivedEventArgs);

    state->type_RemoteSystemSessionJoinRequest = py::register_python_type(module.get(), type_name_RemoteSystemSessionJoinRequest, &type_spec_RemoteSystemSessionJoinRequest, bases.get());
    if (!state->type_RemoteSystemSessionJoinRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionJoinRequest);

    state->type_RemoteSystemSessionJoinRequestedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemSessionJoinRequestedEventArgs, &type_spec_RemoteSystemSessionJoinRequestedEventArgs, bases.get());
    if (!state->type_RemoteSystemSessionJoinRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionJoinRequestedEventArgs);

    state->type_RemoteSystemSessionJoinResult = py::register_python_type(module.get(), type_name_RemoteSystemSessionJoinResult, &type_spec_RemoteSystemSessionJoinResult, bases.get());
    if (!state->type_RemoteSystemSessionJoinResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionJoinResult);

    state->type_RemoteSystemSessionMessageChannel = py::register_python_type(module.get(), type_name_RemoteSystemSessionMessageChannel, &type_spec_RemoteSystemSessionMessageChannel, bases.get());
    if (!state->type_RemoteSystemSessionMessageChannel)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionMessageChannel);

    state->type_RemoteSystemSessionOptions = py::register_python_type(module.get(), type_name_RemoteSystemSessionOptions, &type_spec_RemoteSystemSessionOptions, bases.get());
    if (!state->type_RemoteSystemSessionOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionOptions);

    state->type_RemoteSystemSessionParticipant = py::register_python_type(module.get(), type_name_RemoteSystemSessionParticipant, &type_spec_RemoteSystemSessionParticipant, bases.get());
    if (!state->type_RemoteSystemSessionParticipant)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionParticipant);

    state->type_RemoteSystemSessionParticipantAddedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemSessionParticipantAddedEventArgs, &type_spec_RemoteSystemSessionParticipantAddedEventArgs, bases.get());
    if (!state->type_RemoteSystemSessionParticipantAddedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionParticipantAddedEventArgs);

    state->type_RemoteSystemSessionParticipantRemovedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemSessionParticipantRemovedEventArgs, &type_spec_RemoteSystemSessionParticipantRemovedEventArgs, bases.get());
    if (!state->type_RemoteSystemSessionParticipantRemovedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionParticipantRemovedEventArgs);

    state->type_RemoteSystemSessionParticipantWatcher = py::register_python_type(module.get(), type_name_RemoteSystemSessionParticipantWatcher, &type_spec_RemoteSystemSessionParticipantWatcher, bases.get());
    if (!state->type_RemoteSystemSessionParticipantWatcher)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionParticipantWatcher);

    state->type_RemoteSystemSessionRemovedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemSessionRemovedEventArgs, &type_spec_RemoteSystemSessionRemovedEventArgs, bases.get());
    if (!state->type_RemoteSystemSessionRemovedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionRemovedEventArgs);

    state->type_RemoteSystemSessionUpdatedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemSessionUpdatedEventArgs, &type_spec_RemoteSystemSessionUpdatedEventArgs, bases.get());
    if (!state->type_RemoteSystemSessionUpdatedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionUpdatedEventArgs);

    state->type_RemoteSystemSessionValueSetReceivedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemSessionValueSetReceivedEventArgs, &type_spec_RemoteSystemSessionValueSetReceivedEventArgs, bases.get());
    if (!state->type_RemoteSystemSessionValueSetReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionValueSetReceivedEventArgs);

    state->type_RemoteSystemSessionWatcher = py::register_python_type(module.get(), type_name_RemoteSystemSessionWatcher, &type_spec_RemoteSystemSessionWatcher, bases.get());
    if (!state->type_RemoteSystemSessionWatcher)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemSessionWatcher);

    state->type_RemoteSystemStatusTypeFilter = py::register_python_type(module.get(), type_name_RemoteSystemStatusTypeFilter, &type_spec_RemoteSystemStatusTypeFilter, bases.get());
    if (!state->type_RemoteSystemStatusTypeFilter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemStatusTypeFilter);

    state->type_RemoteSystemUpdatedEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemUpdatedEventArgs, &type_spec_RemoteSystemUpdatedEventArgs, bases.get());
    if (!state->type_RemoteSystemUpdatedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemUpdatedEventArgs);

    state->type_RemoteSystemWatcher = py::register_python_type(module.get(), type_name_RemoteSystemWatcher, &type_spec_RemoteSystemWatcher, bases.get());
    if (!state->type_RemoteSystemWatcher)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemWatcher);

    state->type_RemoteSystemWatcherErrorOccurredEventArgs = py::register_python_type(module.get(), type_name_RemoteSystemWatcherErrorOccurredEventArgs, &type_spec_RemoteSystemWatcherErrorOccurredEventArgs, bases.get());
    if (!state->type_RemoteSystemWatcherErrorOccurredEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemWatcherErrorOccurredEventArgs);

    state->type_RemoteSystemWebAccountFilter = py::register_python_type(module.get(), type_name_RemoteSystemWebAccountFilter, &type_spec_RemoteSystemWebAccountFilter, bases.get());
    if (!state->type_RemoteSystemWebAccountFilter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteSystemWebAccountFilter);

    state->type_IRemoteSystemFilter = py::register_python_type(module.get(), type_name_IRemoteSystemFilter, &type_spec_IRemoteSystemFilter, bases.get());
    if (!state->type_IRemoteSystemFilter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IRemoteSystemFilter);
