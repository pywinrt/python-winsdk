...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::System::UserProfile::AccountPictureKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::System::UserProfile::SetAccountPictureResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::System::UserProfile::SetImageFeedResult> = "i";
