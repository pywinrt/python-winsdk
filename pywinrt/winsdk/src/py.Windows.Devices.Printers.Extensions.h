...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Printers::Extensions::Print3DWorkflowDetail> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Printers::Extensions::Print3DWorkflowStatus> = "i";
