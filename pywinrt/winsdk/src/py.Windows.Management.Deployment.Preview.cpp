...
namespace py::cpp::Windows::Management::Deployment::Preview
{
    ...
    constexpr const char* const type_name_ClassicAppManager = "ClassicAppManager";
    ...
    {
        { Py_tp_new, _new_ClassicAppManager },
        { Py_tp_methods, _methods_ClassicAppManager },
        { Py_tp_getset, _getset_ClassicAppManager },
        { },
    };
    ...
    constexpr const char* const type_name_InstalledClassicAppInfo = "InstalledClassicAppInfo";
    ...
    static void _dealloc_InstalledClassicAppInfo(py::wrapper::Windows::Management::Deployment::Preview::InstalledClassicAppInfo* self)
    {
    ...
    {
        { Py_tp_new, _new_InstalledClassicAppInfo },
        { Py_tp_dealloc, _dealloc_InstalledClassicAppInfo },
        { Py_tp_methods, _methods_InstalledClassicAppInfo },
        { Py_tp_getset, _getset_InstalledClassicAppInfo },
        { },
    };
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Management_Deployment_Preview(void) noexcept
{
    ...
    state->type_ClassicAppManager = py::register_python_type(module.get(), type_name_ClassicAppManager, &type_spec_ClassicAppManager, nullptr);
    if (!state->type_ClassicAppManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClassicAppManager);

    state->type_InstalledClassicAppInfo = py::register_python_type(module.get(), type_name_InstalledClassicAppInfo, &type_spec_InstalledClassicAppInfo, bases.get());
    if (!state->type_InstalledClassicAppInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_InstalledClassicAppInfo);
