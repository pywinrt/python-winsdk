...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Perception::Spatial::SpatialAnchorExportPurpose> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Perception::Spatial::SpatialEntityWatcherStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Perception::Spatial::SpatialLocatability> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Perception::Spatial::SpatialLookDirectionRange> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Perception::Spatial::SpatialMovementRange> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Perception::Spatial::SpatialPerceptionAccessStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Perception::Spatial::SpatialBoundingBox> = "T{T{f:x:f:y:f:z:}:center:T{f:x:f:y:f:z:}:extents:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Perception::Spatial::SpatialBoundingFrustum> = "T{T{T{f:x:f:y:f:z:}:normal:f:d:}:near:T{T{f:x:f:y:f:z:}:normal:f:d:}:far:T{T{f:x:f:y:f:z:}:normal:f:d:}:right:T{T{f:x:f:y:f:z:}:normal:f:d:}:left:T{T{f:x:f:y:f:z:}:normal:f:d:}:top:T{T{f:x:f:y:f:z:}:normal:f:d:}:bottom:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Perception::Spatial::SpatialBoundingOrientedBox> = "T{T{f:x:f:y:f:z:}:center:T{f:x:f:y:f:z:}:extents:T{f:x:f:y:f:z:f:w:}:orientation:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Perception::Spatial::SpatialBoundingSphere> = "T{T{f:x:f:y:f:z:}:center:f:radius:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Perception::Spatial::SpatialRay> = "T{T{f:x:f:y:f:z:}:origin:T{f:x:f:y:f:z:}:direction:}";
