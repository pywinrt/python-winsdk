...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::ForceFeedback::ConditionForceEffectKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::ForceFeedback::ForceFeedbackEffectAxes> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::ForceFeedback::ForceFeedbackEffectState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::ForceFeedback::ForceFeedbackLoadEffectResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Gaming::Input::ForceFeedback::PeriodicForceEffectKind> = "i";
