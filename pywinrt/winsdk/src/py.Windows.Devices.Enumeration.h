...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Enumeration::DeviceAccessStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Enumeration::DeviceClass> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Enumeration::DeviceInformationKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Enumeration::DevicePairingKinds> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Enumeration::DevicePairingProtectionLevel> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Enumeration::DevicePairingResultStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Enumeration::DevicePickerDisplayStatusOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Enumeration::DeviceUnpairingResultStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Enumeration::DeviceWatcherEventKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Enumeration::DeviceWatcherStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Enumeration::Panel> = "i";
