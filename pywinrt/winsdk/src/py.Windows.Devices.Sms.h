...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Sms::CellularClass> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Sms::SmsBroadcastType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Sms::SmsDataFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Sms::SmsDeviceStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Sms::SmsEncoding> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Sms::SmsFilterActionType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Sms::SmsGeographicalScope> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Sms::SmsMessageClass> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Sms::SmsMessageFilter> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Sms::SmsMessageType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Sms::SmsModemErrorCode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Sms::SmsEncodedLength> = "T{I:segment_count:I:character_count_last_segment:I:characters_per_segment:I:byte_count_last_segment:I:bytes_per_segment:}";
