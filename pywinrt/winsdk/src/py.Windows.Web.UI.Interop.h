...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Web::UI::Interop::WebViewControlAcceleratorKeyRoutingStage> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Web::UI::Interop::WebViewControlMoveFocusReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Web::UI::Interop::WebViewControlProcessCapabilityState> = "i";
