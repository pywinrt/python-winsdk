...
PyMODINIT_FUNC PyInit__winsdk_Windows_Gaming_Input_Preview(void) noexcept
{
    ...
    state->type_GameControllerProviderInfo = py::register_python_type(module.get(), type_name_GameControllerProviderInfo, &type_spec_GameControllerProviderInfo, nullptr, nullptr);
