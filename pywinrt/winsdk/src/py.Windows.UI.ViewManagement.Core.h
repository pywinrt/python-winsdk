...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::Core::CoreInputViewKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::Core::CoreInputViewOcclusionKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ViewManagement::Core::CoreInputViewXYFocusTransferDirection> = "i";
