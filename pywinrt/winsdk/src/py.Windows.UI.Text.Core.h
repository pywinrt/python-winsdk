...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Text::Core::CoreTextFormatUpdatingReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Text::Core::CoreTextFormatUpdatingResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Text::Core::CoreTextInputPaneDisplayPolicy> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Text::Core::CoreTextInputScope> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Text::Core::CoreTextSelectionUpdatingResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Text::Core::CoreTextTextUpdatingResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Text::Core::CoreTextRange> = "T{i:start_caret_position:i:end_caret_position:}";
