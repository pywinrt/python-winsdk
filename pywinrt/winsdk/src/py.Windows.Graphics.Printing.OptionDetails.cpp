...
namespace py::cpp::Windows::Graphics::Printing::OptionDetails
{
    ...
    static PyObject* register_PrintOptionStates(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_PrintOptionType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_PrintBindingOptionDetails = "PrintBindingOptionDetails";
    ...
    constexpr const char* const type_name_PrintBorderingOptionDetails = "PrintBorderingOptionDetails";
    ...
    constexpr const char* const type_name_PrintCollationOptionDetails = "PrintCollationOptionDetails";
    ...
    constexpr const char* const type_name_PrintColorModeOptionDetails = "PrintColorModeOptionDetails";
    ...
    constexpr const char* const type_name_PrintCopiesOptionDetails = "PrintCopiesOptionDetails";
    ...
    constexpr const char* const type_name_PrintCustomItemDetails = "PrintCustomItemDetails";
    ...
    constexpr const char* const type_name_PrintCustomItemListOptionDetails = "PrintCustomItemListOptionDetails";
    ...
    constexpr const char* const type_name_PrintCustomTextOptionDetails = "PrintCustomTextOptionDetails";
    ...
    constexpr const char* const type_name_PrintCustomToggleOptionDetails = "PrintCustomToggleOptionDetails";
    ...
    constexpr const char* const type_name_PrintDuplexOptionDetails = "PrintDuplexOptionDetails";
    ...
    constexpr const char* const type_name_PrintHolePunchOptionDetails = "PrintHolePunchOptionDetails";
    ...
    constexpr const char* const type_name_PrintMediaSizeOptionDetails = "PrintMediaSizeOptionDetails";
    ...
    constexpr const char* const type_name_PrintMediaTypeOptionDetails = "PrintMediaTypeOptionDetails";
    ...
    constexpr const char* const type_name_PrintOrientationOptionDetails = "PrintOrientationOptionDetails";
    ...
    constexpr const char* const type_name_PrintPageRangeOptionDetails = "PrintPageRangeOptionDetails";
    ...
    constexpr const char* const type_name_PrintQualityOptionDetails = "PrintQualityOptionDetails";
    ...
    constexpr const char* const type_name_PrintStapleOptionDetails = "PrintStapleOptionDetails";
    ...
    constexpr const char* const type_name_PrintTaskOptionChangedEventArgs = "PrintTaskOptionChangedEventArgs";
    ...
    constexpr const char* const type_name_PrintTaskOptionDetails = "PrintTaskOptionDetails";
    ...
    constexpr const char* const type_name_IPrintCustomOptionDetails = "IPrintCustomOptionDetails";
    ...
    constexpr const char* const type_name_IPrintItemListOptionDetails = "IPrintItemListOptionDetails";
    ...
    constexpr const char* const type_name_IPrintNumberOptionDetails = "IPrintNumberOptionDetails";
    ...
    constexpr const char* const type_name_IPrintOptionDetails = "IPrintOptionDetails";
    ...
    constexpr const char* const type_name_IPrintTextOptionDetails = "IPrintTextOptionDetails";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Graphics_Printing_OptionDetails(void) noexcept
{
    ...
    state->type_PrintBindingOptionDetails = py::register_python_type(module.get(), type_name_PrintBindingOptionDetails, &type_spec_PrintBindingOptionDetails, bases.get());
    if (!state->type_PrintBindingOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintBindingOptionDetails);

    state->type_PrintBorderingOptionDetails = py::register_python_type(module.get(), type_name_PrintBorderingOptionDetails, &type_spec_PrintBorderingOptionDetails, bases.get());
    if (!state->type_PrintBorderingOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintBorderingOptionDetails);

    state->type_PrintCollationOptionDetails = py::register_python_type(module.get(), type_name_PrintCollationOptionDetails, &type_spec_PrintCollationOptionDetails, bases.get());
    if (!state->type_PrintCollationOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintCollationOptionDetails);

    state->type_PrintColorModeOptionDetails = py::register_python_type(module.get(), type_name_PrintColorModeOptionDetails, &type_spec_PrintColorModeOptionDetails, bases.get());
    if (!state->type_PrintColorModeOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintColorModeOptionDetails);

    state->type_PrintCopiesOptionDetails = py::register_python_type(module.get(), type_name_PrintCopiesOptionDetails, &type_spec_PrintCopiesOptionDetails, bases.get());
    if (!state->type_PrintCopiesOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintCopiesOptionDetails);

    state->type_PrintCustomItemDetails = py::register_python_type(module.get(), type_name_PrintCustomItemDetails, &type_spec_PrintCustomItemDetails, bases.get());
    if (!state->type_PrintCustomItemDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintCustomItemDetails);

    state->type_PrintCustomItemListOptionDetails = py::register_python_type(module.get(), type_name_PrintCustomItemListOptionDetails, &type_spec_PrintCustomItemListOptionDetails, bases.get());
    if (!state->type_PrintCustomItemListOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintCustomItemListOptionDetails);

    state->type_PrintCustomTextOptionDetails = py::register_python_type(module.get(), type_name_PrintCustomTextOptionDetails, &type_spec_PrintCustomTextOptionDetails, bases.get());
    if (!state->type_PrintCustomTextOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintCustomTextOptionDetails);

    state->type_PrintCustomToggleOptionDetails = py::register_python_type(module.get(), type_name_PrintCustomToggleOptionDetails, &type_spec_PrintCustomToggleOptionDetails, bases.get());
    if (!state->type_PrintCustomToggleOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintCustomToggleOptionDetails);

    state->type_PrintDuplexOptionDetails = py::register_python_type(module.get(), type_name_PrintDuplexOptionDetails, &type_spec_PrintDuplexOptionDetails, bases.get());
    if (!state->type_PrintDuplexOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintDuplexOptionDetails);

    state->type_PrintHolePunchOptionDetails = py::register_python_type(module.get(), type_name_PrintHolePunchOptionDetails, &type_spec_PrintHolePunchOptionDetails, bases.get());
    if (!state->type_PrintHolePunchOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintHolePunchOptionDetails);

    state->type_PrintMediaSizeOptionDetails = py::register_python_type(module.get(), type_name_PrintMediaSizeOptionDetails, &type_spec_PrintMediaSizeOptionDetails, bases.get());
    if (!state->type_PrintMediaSizeOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintMediaSizeOptionDetails);

    state->type_PrintMediaTypeOptionDetails = py::register_python_type(module.get(), type_name_PrintMediaTypeOptionDetails, &type_spec_PrintMediaTypeOptionDetails, bases.get());
    if (!state->type_PrintMediaTypeOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintMediaTypeOptionDetails);

    state->type_PrintOrientationOptionDetails = py::register_python_type(module.get(), type_name_PrintOrientationOptionDetails, &type_spec_PrintOrientationOptionDetails, bases.get());
    if (!state->type_PrintOrientationOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintOrientationOptionDetails);

    state->type_PrintPageRangeOptionDetails = py::register_python_type(module.get(), type_name_PrintPageRangeOptionDetails, &type_spec_PrintPageRangeOptionDetails, bases.get());
    if (!state->type_PrintPageRangeOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintPageRangeOptionDetails);

    state->type_PrintQualityOptionDetails = py::register_python_type(module.get(), type_name_PrintQualityOptionDetails, &type_spec_PrintQualityOptionDetails, bases.get());
    if (!state->type_PrintQualityOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintQualityOptionDetails);

    state->type_PrintStapleOptionDetails = py::register_python_type(module.get(), type_name_PrintStapleOptionDetails, &type_spec_PrintStapleOptionDetails, bases.get());
    if (!state->type_PrintStapleOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintStapleOptionDetails);

    state->type_PrintTaskOptionChangedEventArgs = py::register_python_type(module.get(), type_name_PrintTaskOptionChangedEventArgs, &type_spec_PrintTaskOptionChangedEventArgs, bases.get());
    if (!state->type_PrintTaskOptionChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintTaskOptionChangedEventArgs);

    state->type_PrintTaskOptionDetails = py::register_python_type(module.get(), type_name_PrintTaskOptionDetails, &type_spec_PrintTaskOptionDetails, bases.get());
    if (!state->type_PrintTaskOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PrintTaskOptionDetails);

    state->type_IPrintCustomOptionDetails = py::register_python_type(module.get(), type_name_IPrintCustomOptionDetails, &type_spec_IPrintCustomOptionDetails, bases.get());
    if (!state->type_IPrintCustomOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IPrintCustomOptionDetails);

    state->type_IPrintItemListOptionDetails = py::register_python_type(module.get(), type_name_IPrintItemListOptionDetails, &type_spec_IPrintItemListOptionDetails, bases.get());
    if (!state->type_IPrintItemListOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IPrintItemListOptionDetails);

    state->type_IPrintNumberOptionDetails = py::register_python_type(module.get(), type_name_IPrintNumberOptionDetails, &type_spec_IPrintNumberOptionDetails, bases.get());
    if (!state->type_IPrintNumberOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IPrintNumberOptionDetails);

    state->type_IPrintOptionDetails = py::register_python_type(module.get(), type_name_IPrintOptionDetails, &type_spec_IPrintOptionDetails, bases.get());
    if (!state->type_IPrintOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IPrintOptionDetails);

    state->type_IPrintTextOptionDetails = py::register_python_type(module.get(), type_name_IPrintTextOptionDetails, &type_spec_IPrintTextOptionDetails, bases.get());
    if (!state->type_IPrintTextOptionDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IPrintTextOptionDetails);
