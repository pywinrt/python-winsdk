...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Update::SystemUpdateAttentionRequiredReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Update::SystemUpdateItemState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Update::SystemUpdateManagerState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Update::SystemUpdateStartInstallAction> = "i";
