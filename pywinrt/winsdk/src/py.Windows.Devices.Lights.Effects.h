...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Lights::Effects::LampArrayEffectCompletionBehavior> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Lights::Effects::LampArrayEffectStartMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Lights::Effects::LampArrayRepetitionMode> = "i";
