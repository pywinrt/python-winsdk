...
namespace py::cpp::Windows::Media::Miracast
{
    ...
    static PyObject* register_MiracastReceiverApplySettingsStatus(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_MiracastReceiverAuthorizationMethod(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MiracastReceiverDisconnectReason(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MiracastReceiverGameControllerDeviceUsageMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MiracastReceiverListeningStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MiracastReceiverSessionStartStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MiracastReceiverWiFiStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MiracastTransmitterAuthorizationStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_MiracastReceiver = "MiracastReceiver";
    ...
    constexpr const char* const type_name_MiracastReceiverApplySettingsResult = "MiracastReceiverApplySettingsResult";
    ...
    constexpr const char* const type_name_MiracastReceiverConnection = "MiracastReceiverConnection";
    ...
    constexpr const char* const type_name_MiracastReceiverConnectionCreatedEventArgs = "MiracastReceiverConnectionCreatedEventArgs";
    ...
    constexpr const char* const type_name_MiracastReceiverCursorImageChannel = "MiracastReceiverCursorImageChannel";
    ...
    constexpr const char* const type_name_MiracastReceiverCursorImageChannelSettings = "MiracastReceiverCursorImageChannelSettings";
    ...
    constexpr const char* const type_name_MiracastReceiverDisconnectedEventArgs = "MiracastReceiverDisconnectedEventArgs";
    ...
    constexpr const char* const type_name_MiracastReceiverGameControllerDevice = "MiracastReceiverGameControllerDevice";
    ...
    constexpr const char* const type_name_MiracastReceiverInputDevices = "MiracastReceiverInputDevices";
    ...
    constexpr const char* const type_name_MiracastReceiverKeyboardDevice = "MiracastReceiverKeyboardDevice";
    ...
    constexpr const char* const type_name_MiracastReceiverMediaSourceCreatedEventArgs = "MiracastReceiverMediaSourceCreatedEventArgs";
    ...
    constexpr const char* const type_name_MiracastReceiverSession = "MiracastReceiverSession";
    ...
    constexpr const char* const type_name_MiracastReceiverSessionStartResult = "MiracastReceiverSessionStartResult";
    ...
    constexpr const char* const type_name_MiracastReceiverSettings = "MiracastReceiverSettings";
    ...
    constexpr const char* const type_name_MiracastReceiverStatus = "MiracastReceiverStatus";
    ...
    constexpr const char* const type_name_MiracastReceiverStreamControl = "MiracastReceiverStreamControl";
    ...
    constexpr const char* const type_name_MiracastReceiverVideoStreamSettings = "MiracastReceiverVideoStreamSettings";
    ...
    constexpr const char* const type_name_MiracastTransmitter = "MiracastTransmitter";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Media_Miracast(void) noexcept
{
    ...
    state->type_MiracastReceiver = py::register_python_type(module.get(), type_name_MiracastReceiver, &type_spec_MiracastReceiver, bases.get());
    if (!state->type_MiracastReceiver)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiver);

    state->type_MiracastReceiverApplySettingsResult = py::register_python_type(module.get(), type_name_MiracastReceiverApplySettingsResult, &type_spec_MiracastReceiverApplySettingsResult, bases.get());
    if (!state->type_MiracastReceiverApplySettingsResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverApplySettingsResult);

    state->type_MiracastReceiverConnection = py::register_python_type(module.get(), type_name_MiracastReceiverConnection, &type_spec_MiracastReceiverConnection, bases.get());
    if (!state->type_MiracastReceiverConnection)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverConnection);

    state->type_MiracastReceiverConnectionCreatedEventArgs = py::register_python_type(module.get(), type_name_MiracastReceiverConnectionCreatedEventArgs, &type_spec_MiracastReceiverConnectionCreatedEventArgs, bases.get());
    if (!state->type_MiracastReceiverConnectionCreatedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverConnectionCreatedEventArgs);

    state->type_MiracastReceiverCursorImageChannel = py::register_python_type(module.get(), type_name_MiracastReceiverCursorImageChannel, &type_spec_MiracastReceiverCursorImageChannel, bases.get());
    if (!state->type_MiracastReceiverCursorImageChannel)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverCursorImageChannel);

    state->type_MiracastReceiverCursorImageChannelSettings = py::register_python_type(module.get(), type_name_MiracastReceiverCursorImageChannelSettings, &type_spec_MiracastReceiverCursorImageChannelSettings, bases.get());
    if (!state->type_MiracastReceiverCursorImageChannelSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverCursorImageChannelSettings);

    state->type_MiracastReceiverDisconnectedEventArgs = py::register_python_type(module.get(), type_name_MiracastReceiverDisconnectedEventArgs, &type_spec_MiracastReceiverDisconnectedEventArgs, bases.get());
    if (!state->type_MiracastReceiverDisconnectedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverDisconnectedEventArgs);

    state->type_MiracastReceiverGameControllerDevice = py::register_python_type(module.get(), type_name_MiracastReceiverGameControllerDevice, &type_spec_MiracastReceiverGameControllerDevice, bases.get());
    if (!state->type_MiracastReceiverGameControllerDevice)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverGameControllerDevice);

    state->type_MiracastReceiverInputDevices = py::register_python_type(module.get(), type_name_MiracastReceiverInputDevices, &type_spec_MiracastReceiverInputDevices, bases.get());
    if (!state->type_MiracastReceiverInputDevices)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverInputDevices);

    state->type_MiracastReceiverKeyboardDevice = py::register_python_type(module.get(), type_name_MiracastReceiverKeyboardDevice, &type_spec_MiracastReceiverKeyboardDevice, bases.get());
    if (!state->type_MiracastReceiverKeyboardDevice)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverKeyboardDevice);

    state->type_MiracastReceiverMediaSourceCreatedEventArgs = py::register_python_type(module.get(), type_name_MiracastReceiverMediaSourceCreatedEventArgs, &type_spec_MiracastReceiverMediaSourceCreatedEventArgs, bases.get());
    if (!state->type_MiracastReceiverMediaSourceCreatedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverMediaSourceCreatedEventArgs);

    state->type_MiracastReceiverSession = py::register_python_type(module.get(), type_name_MiracastReceiverSession, &type_spec_MiracastReceiverSession, bases.get());
    if (!state->type_MiracastReceiverSession)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverSession);

    state->type_MiracastReceiverSessionStartResult = py::register_python_type(module.get(), type_name_MiracastReceiverSessionStartResult, &type_spec_MiracastReceiverSessionStartResult, bases.get());
    if (!state->type_MiracastReceiverSessionStartResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverSessionStartResult);

    state->type_MiracastReceiverSettings = py::register_python_type(module.get(), type_name_MiracastReceiverSettings, &type_spec_MiracastReceiverSettings, bases.get());
    if (!state->type_MiracastReceiverSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverSettings);

    state->type_MiracastReceiverStatus = py::register_python_type(module.get(), type_name_MiracastReceiverStatus, &type_spec_MiracastReceiverStatus, bases.get());
    if (!state->type_MiracastReceiverStatus)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverStatus);

    state->type_MiracastReceiverStreamControl = py::register_python_type(module.get(), type_name_MiracastReceiverStreamControl, &type_spec_MiracastReceiverStreamControl, bases.get());
    if (!state->type_MiracastReceiverStreamControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverStreamControl);

    state->type_MiracastReceiverVideoStreamSettings = py::register_python_type(module.get(), type_name_MiracastReceiverVideoStreamSettings, &type_spec_MiracastReceiverVideoStreamSettings, bases.get());
    if (!state->type_MiracastReceiverVideoStreamSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastReceiverVideoStreamSettings);

    state->type_MiracastTransmitter = py::register_python_type(module.get(), type_name_MiracastTransmitter, &type_spec_MiracastTransmitter, bases.get());
    if (!state->type_MiracastTransmitter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MiracastTransmitter);
