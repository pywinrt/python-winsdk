...
namespace py::cpp::Windows::ApplicationModel::Email::DataProvider
{
    ...
    constexpr const char* const type_name_EmailDataProviderConnection = "EmailDataProviderConnection";
    ...
    constexpr const char* const type_name_EmailDataProviderTriggerDetails = "EmailDataProviderTriggerDetails";
    ...
    constexpr const char* const type_name_EmailMailboxCreateFolderRequest = "EmailMailboxCreateFolderRequest";
    ...
    constexpr const char* const type_name_EmailMailboxCreateFolderRequestEventArgs = "EmailMailboxCreateFolderRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxDeleteFolderRequest = "EmailMailboxDeleteFolderRequest";
    ...
    constexpr const char* const type_name_EmailMailboxDeleteFolderRequestEventArgs = "EmailMailboxDeleteFolderRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxDownloadAttachmentRequest = "EmailMailboxDownloadAttachmentRequest";
    ...
    constexpr const char* const type_name_EmailMailboxDownloadAttachmentRequestEventArgs = "EmailMailboxDownloadAttachmentRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxDownloadMessageRequest = "EmailMailboxDownloadMessageRequest";
    ...
    constexpr const char* const type_name_EmailMailboxDownloadMessageRequestEventArgs = "EmailMailboxDownloadMessageRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxEmptyFolderRequest = "EmailMailboxEmptyFolderRequest";
    ...
    constexpr const char* const type_name_EmailMailboxEmptyFolderRequestEventArgs = "EmailMailboxEmptyFolderRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxForwardMeetingRequest = "EmailMailboxForwardMeetingRequest";
    ...
    constexpr const char* const type_name_EmailMailboxForwardMeetingRequestEventArgs = "EmailMailboxForwardMeetingRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxGetAutoReplySettingsRequest = "EmailMailboxGetAutoReplySettingsRequest";
    ...
    constexpr const char* const type_name_EmailMailboxGetAutoReplySettingsRequestEventArgs = "EmailMailboxGetAutoReplySettingsRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxMoveFolderRequest = "EmailMailboxMoveFolderRequest";
    ...
    constexpr const char* const type_name_EmailMailboxMoveFolderRequestEventArgs = "EmailMailboxMoveFolderRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxProposeNewTimeForMeetingRequest = "EmailMailboxProposeNewTimeForMeetingRequest";
    ...
    constexpr const char* const type_name_EmailMailboxProposeNewTimeForMeetingRequestEventArgs = "EmailMailboxProposeNewTimeForMeetingRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxResolveRecipientsRequest = "EmailMailboxResolveRecipientsRequest";
    ...
    constexpr const char* const type_name_EmailMailboxResolveRecipientsRequestEventArgs = "EmailMailboxResolveRecipientsRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxServerSearchReadBatchRequest = "EmailMailboxServerSearchReadBatchRequest";
    ...
    constexpr const char* const type_name_EmailMailboxServerSearchReadBatchRequestEventArgs = "EmailMailboxServerSearchReadBatchRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxSetAutoReplySettingsRequest = "EmailMailboxSetAutoReplySettingsRequest";
    ...
    constexpr const char* const type_name_EmailMailboxSetAutoReplySettingsRequestEventArgs = "EmailMailboxSetAutoReplySettingsRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxSyncManagerSyncRequest = "EmailMailboxSyncManagerSyncRequest";
    ...
    constexpr const char* const type_name_EmailMailboxSyncManagerSyncRequestEventArgs = "EmailMailboxSyncManagerSyncRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxUpdateMeetingResponseRequest = "EmailMailboxUpdateMeetingResponseRequest";
    ...
    constexpr const char* const type_name_EmailMailboxUpdateMeetingResponseRequestEventArgs = "EmailMailboxUpdateMeetingResponseRequestEventArgs";
    ...
    constexpr const char* const type_name_EmailMailboxValidateCertificatesRequest = "EmailMailboxValidateCertificatesRequest";
    ...
    constexpr const char* const type_name_EmailMailboxValidateCertificatesRequestEventArgs = "EmailMailboxValidateCertificatesRequestEventArgs";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_Email_DataProvider(void) noexcept
{
    ...
    state->type_EmailDataProviderConnection = py::register_python_type(module.get(), type_name_EmailDataProviderConnection, &type_spec_EmailDataProviderConnection, bases.get());
    if (!state->type_EmailDataProviderConnection)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailDataProviderConnection);

    state->type_EmailDataProviderTriggerDetails = py::register_python_type(module.get(), type_name_EmailDataProviderTriggerDetails, &type_spec_EmailDataProviderTriggerDetails, bases.get());
    if (!state->type_EmailDataProviderTriggerDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailDataProviderTriggerDetails);

    state->type_EmailMailboxCreateFolderRequest = py::register_python_type(module.get(), type_name_EmailMailboxCreateFolderRequest, &type_spec_EmailMailboxCreateFolderRequest, bases.get());
    if (!state->type_EmailMailboxCreateFolderRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxCreateFolderRequest);

    state->type_EmailMailboxCreateFolderRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxCreateFolderRequestEventArgs, &type_spec_EmailMailboxCreateFolderRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxCreateFolderRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxCreateFolderRequestEventArgs);

    state->type_EmailMailboxDeleteFolderRequest = py::register_python_type(module.get(), type_name_EmailMailboxDeleteFolderRequest, &type_spec_EmailMailboxDeleteFolderRequest, bases.get());
    if (!state->type_EmailMailboxDeleteFolderRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxDeleteFolderRequest);

    state->type_EmailMailboxDeleteFolderRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxDeleteFolderRequestEventArgs, &type_spec_EmailMailboxDeleteFolderRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxDeleteFolderRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxDeleteFolderRequestEventArgs);

    state->type_EmailMailboxDownloadAttachmentRequest = py::register_python_type(module.get(), type_name_EmailMailboxDownloadAttachmentRequest, &type_spec_EmailMailboxDownloadAttachmentRequest, bases.get());
    if (!state->type_EmailMailboxDownloadAttachmentRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxDownloadAttachmentRequest);

    state->type_EmailMailboxDownloadAttachmentRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxDownloadAttachmentRequestEventArgs, &type_spec_EmailMailboxDownloadAttachmentRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxDownloadAttachmentRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxDownloadAttachmentRequestEventArgs);

    state->type_EmailMailboxDownloadMessageRequest = py::register_python_type(module.get(), type_name_EmailMailboxDownloadMessageRequest, &type_spec_EmailMailboxDownloadMessageRequest, bases.get());
    if (!state->type_EmailMailboxDownloadMessageRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxDownloadMessageRequest);

    state->type_EmailMailboxDownloadMessageRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxDownloadMessageRequestEventArgs, &type_spec_EmailMailboxDownloadMessageRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxDownloadMessageRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxDownloadMessageRequestEventArgs);

    state->type_EmailMailboxEmptyFolderRequest = py::register_python_type(module.get(), type_name_EmailMailboxEmptyFolderRequest, &type_spec_EmailMailboxEmptyFolderRequest, bases.get());
    if (!state->type_EmailMailboxEmptyFolderRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxEmptyFolderRequest);

    state->type_EmailMailboxEmptyFolderRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxEmptyFolderRequestEventArgs, &type_spec_EmailMailboxEmptyFolderRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxEmptyFolderRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxEmptyFolderRequestEventArgs);

    state->type_EmailMailboxForwardMeetingRequest = py::register_python_type(module.get(), type_name_EmailMailboxForwardMeetingRequest, &type_spec_EmailMailboxForwardMeetingRequest, bases.get());
    if (!state->type_EmailMailboxForwardMeetingRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxForwardMeetingRequest);

    state->type_EmailMailboxForwardMeetingRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxForwardMeetingRequestEventArgs, &type_spec_EmailMailboxForwardMeetingRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxForwardMeetingRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxForwardMeetingRequestEventArgs);

    state->type_EmailMailboxGetAutoReplySettingsRequest = py::register_python_type(module.get(), type_name_EmailMailboxGetAutoReplySettingsRequest, &type_spec_EmailMailboxGetAutoReplySettingsRequest, bases.get());
    if (!state->type_EmailMailboxGetAutoReplySettingsRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxGetAutoReplySettingsRequest);

    state->type_EmailMailboxGetAutoReplySettingsRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxGetAutoReplySettingsRequestEventArgs, &type_spec_EmailMailboxGetAutoReplySettingsRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxGetAutoReplySettingsRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxGetAutoReplySettingsRequestEventArgs);

    state->type_EmailMailboxMoveFolderRequest = py::register_python_type(module.get(), type_name_EmailMailboxMoveFolderRequest, &type_spec_EmailMailboxMoveFolderRequest, bases.get());
    if (!state->type_EmailMailboxMoveFolderRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxMoveFolderRequest);

    state->type_EmailMailboxMoveFolderRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxMoveFolderRequestEventArgs, &type_spec_EmailMailboxMoveFolderRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxMoveFolderRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxMoveFolderRequestEventArgs);

    state->type_EmailMailboxProposeNewTimeForMeetingRequest = py::register_python_type(module.get(), type_name_EmailMailboxProposeNewTimeForMeetingRequest, &type_spec_EmailMailboxProposeNewTimeForMeetingRequest, bases.get());
    if (!state->type_EmailMailboxProposeNewTimeForMeetingRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxProposeNewTimeForMeetingRequest);

    state->type_EmailMailboxProposeNewTimeForMeetingRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxProposeNewTimeForMeetingRequestEventArgs, &type_spec_EmailMailboxProposeNewTimeForMeetingRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxProposeNewTimeForMeetingRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxProposeNewTimeForMeetingRequestEventArgs);

    state->type_EmailMailboxResolveRecipientsRequest = py::register_python_type(module.get(), type_name_EmailMailboxResolveRecipientsRequest, &type_spec_EmailMailboxResolveRecipientsRequest, bases.get());
    if (!state->type_EmailMailboxResolveRecipientsRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxResolveRecipientsRequest);

    state->type_EmailMailboxResolveRecipientsRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxResolveRecipientsRequestEventArgs, &type_spec_EmailMailboxResolveRecipientsRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxResolveRecipientsRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxResolveRecipientsRequestEventArgs);

    state->type_EmailMailboxServerSearchReadBatchRequest = py::register_python_type(module.get(), type_name_EmailMailboxServerSearchReadBatchRequest, &type_spec_EmailMailboxServerSearchReadBatchRequest, bases.get());
    if (!state->type_EmailMailboxServerSearchReadBatchRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxServerSearchReadBatchRequest);

    state->type_EmailMailboxServerSearchReadBatchRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxServerSearchReadBatchRequestEventArgs, &type_spec_EmailMailboxServerSearchReadBatchRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxServerSearchReadBatchRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxServerSearchReadBatchRequestEventArgs);

    state->type_EmailMailboxSetAutoReplySettingsRequest = py::register_python_type(module.get(), type_name_EmailMailboxSetAutoReplySettingsRequest, &type_spec_EmailMailboxSetAutoReplySettingsRequest, bases.get());
    if (!state->type_EmailMailboxSetAutoReplySettingsRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxSetAutoReplySettingsRequest);

    state->type_EmailMailboxSetAutoReplySettingsRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxSetAutoReplySettingsRequestEventArgs, &type_spec_EmailMailboxSetAutoReplySettingsRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxSetAutoReplySettingsRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxSetAutoReplySettingsRequestEventArgs);

    state->type_EmailMailboxSyncManagerSyncRequest = py::register_python_type(module.get(), type_name_EmailMailboxSyncManagerSyncRequest, &type_spec_EmailMailboxSyncManagerSyncRequest, bases.get());
    if (!state->type_EmailMailboxSyncManagerSyncRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxSyncManagerSyncRequest);

    state->type_EmailMailboxSyncManagerSyncRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxSyncManagerSyncRequestEventArgs, &type_spec_EmailMailboxSyncManagerSyncRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxSyncManagerSyncRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxSyncManagerSyncRequestEventArgs);

    state->type_EmailMailboxUpdateMeetingResponseRequest = py::register_python_type(module.get(), type_name_EmailMailboxUpdateMeetingResponseRequest, &type_spec_EmailMailboxUpdateMeetingResponseRequest, bases.get());
    if (!state->type_EmailMailboxUpdateMeetingResponseRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxUpdateMeetingResponseRequest);

    state->type_EmailMailboxUpdateMeetingResponseRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxUpdateMeetingResponseRequestEventArgs, &type_spec_EmailMailboxUpdateMeetingResponseRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxUpdateMeetingResponseRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxUpdateMeetingResponseRequestEventArgs);

    state->type_EmailMailboxValidateCertificatesRequest = py::register_python_type(module.get(), type_name_EmailMailboxValidateCertificatesRequest, &type_spec_EmailMailboxValidateCertificatesRequest, bases.get());
    if (!state->type_EmailMailboxValidateCertificatesRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxValidateCertificatesRequest);

    state->type_EmailMailboxValidateCertificatesRequestEventArgs = py::register_python_type(module.get(), type_name_EmailMailboxValidateCertificatesRequestEventArgs, &type_spec_EmailMailboxValidateCertificatesRequestEventArgs, bases.get());
    if (!state->type_EmailMailboxValidateCertificatesRequestEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EmailMailboxValidateCertificatesRequestEventArgs);
