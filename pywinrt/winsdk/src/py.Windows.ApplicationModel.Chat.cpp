...
namespace py::cpp::Windows::ApplicationModel::Chat
{
    ...
    static PyObject* register_ChatConversationThreadingKind(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_ChatItemKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ChatMessageChangeType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ChatMessageKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ChatMessageOperatorKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ChatMessageStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ChatMessageTransportKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ChatMessageValidationStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ChatRestoreHistorySpan(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ChatStoreChangedEventKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ChatTransportErrorCodeCategory(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ChatTransportInterpretedErrorCode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_RcsServiceKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_ChatCapabilities = "ChatCapabilities";
    ...
    constexpr const char* const type_name_ChatCapabilitiesManager = "ChatCapabilitiesManager";
    ...
    constexpr const char* const type_name_ChatConversation = "ChatConversation";
    ...
    constexpr const char* const type_name_ChatConversationReader = "ChatConversationReader";
    ...
    constexpr const char* const type_name_ChatConversationThreadingInfo = "ChatConversationThreadingInfo";
    ...
    // ----- ChatMessage class --------------------
    constexpr const char* const type_name_ChatMessage = "ChatMessage";
    ...
    constexpr const char* const type_name_ChatMessageAttachment = "ChatMessageAttachment";
    ...
    constexpr const char* const type_name_ChatMessageBlocking = "ChatMessageBlocking";
    ...
    constexpr const char* const type_name_ChatMessageChange = "ChatMessageChange";
    ...
    constexpr const char* const type_name_ChatMessageChangeReader = "ChatMessageChangeReader";
    ...
    constexpr const char* const type_name_ChatMessageChangeTracker = "ChatMessageChangeTracker";
    ...
    constexpr const char* const type_name_ChatMessageChangedDeferral = "ChatMessageChangedDeferral";
    ...
    constexpr const char* const type_name_ChatMessageChangedEventArgs = "ChatMessageChangedEventArgs";
    ...
    constexpr const char* const type_name_ChatMessageManager = "ChatMessageManager";
    ...
    constexpr const char* const type_name_ChatMessageNotificationTriggerDetails = "ChatMessageNotificationTriggerDetails";
    ...
    constexpr const char* const type_name_ChatMessageReader = "ChatMessageReader";
    ...
    constexpr const char* const type_name_ChatMessageStore = "ChatMessageStore";
    ...
    constexpr const char* const type_name_ChatMessageStoreChangedEventArgs = "ChatMessageStoreChangedEventArgs";
    ...
    constexpr const char* const type_name_ChatMessageTransport = "ChatMessageTransport";
    ...
    constexpr const char* const type_name_ChatMessageTransportConfiguration = "ChatMessageTransportConfiguration";
    ...
    constexpr const char* const type_name_ChatMessageValidationResult = "ChatMessageValidationResult";
    ...
    constexpr const char* const type_name_ChatQueryOptions = "ChatQueryOptions";
    ...
    constexpr const char* const type_name_ChatRecipientDeliveryInfo = "ChatRecipientDeliveryInfo";
    ...
    constexpr const char* const type_name_ChatSearchReader = "ChatSearchReader";
    ...
    constexpr const char* const type_name_ChatSyncConfiguration = "ChatSyncConfiguration";
    ...
    constexpr const char* const type_name_ChatSyncManager = "ChatSyncManager";
    ...
    constexpr const char* const type_name_RcsEndUserMessage = "RcsEndUserMessage";
    ...
    constexpr const char* const type_name_RcsEndUserMessageAction = "RcsEndUserMessageAction";
    ...
    constexpr const char* const type_name_RcsEndUserMessageAvailableEventArgs = "RcsEndUserMessageAvailableEventArgs";
    ...
    constexpr const char* const type_name_RcsEndUserMessageAvailableTriggerDetails = "RcsEndUserMessageAvailableTriggerDetails";
    ...
    constexpr const char* const type_name_RcsEndUserMessageManager = "RcsEndUserMessageManager";
    ...
    // ----- RcsManager class --------------------
    constexpr const char* const type_name_RcsManager = "RcsManager";
    ...
    constexpr const char* const type_name_RcsServiceKindSupportedChangedEventArgs = "RcsServiceKindSupportedChangedEventArgs";
    ...
    // ----- RcsTransport class --------------------
    constexpr const char* const type_name_RcsTransport = "RcsTransport";
    ...
    constexpr const char* const type_name_RcsTransportConfiguration = "RcsTransportConfiguration";
    ...
    constexpr const char* const type_name_RemoteParticipantComposingChangedEventArgs = "RemoteParticipantComposingChangedEventArgs";
    ...
    // ----- IChatItem interface --------------------
    constexpr const char* const type_name_IChatItem = "IChatItem";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_Chat(void) noexcept
{
    ...
    state->type_ChatCapabilities = py::register_python_type(module.get(), type_name_ChatCapabilities, &type_spec_ChatCapabilities, bases.get());
    if (!state->type_ChatCapabilities)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatCapabilities);

    state->type_ChatCapabilitiesManager = py::register_python_type(module.get(), type_name_ChatCapabilitiesManager, &type_spec_ChatCapabilitiesManager, nullptr);
    if (!state->type_ChatCapabilitiesManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatCapabilitiesManager);

    state->type_ChatConversation = py::register_python_type(module.get(), type_name_ChatConversation, &type_spec_ChatConversation, bases.get());
    if (!state->type_ChatConversation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatConversation);

    state->type_ChatConversationReader = py::register_python_type(module.get(), type_name_ChatConversationReader, &type_spec_ChatConversationReader, bases.get());
    if (!state->type_ChatConversationReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatConversationReader);

    state->type_ChatConversationThreadingInfo = py::register_python_type(module.get(), type_name_ChatConversationThreadingInfo, &type_spec_ChatConversationThreadingInfo, bases.get());
    if (!state->type_ChatConversationThreadingInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatConversationThreadingInfo);

    state->type_ChatMessage = py::register_python_type(module.get(), type_name_ChatMessage, &type_spec_ChatMessage, bases.get());
    if (!state->type_ChatMessage)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessage);

    state->type_ChatMessageAttachment = py::register_python_type(module.get(), type_name_ChatMessageAttachment, &type_spec_ChatMessageAttachment, bases.get());
    if (!state->type_ChatMessageAttachment)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageAttachment);

    state->type_ChatMessageBlocking = py::register_python_type(module.get(), type_name_ChatMessageBlocking, &type_spec_ChatMessageBlocking, nullptr);
    if (!state->type_ChatMessageBlocking)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageBlocking);

    state->type_ChatMessageChange = py::register_python_type(module.get(), type_name_ChatMessageChange, &type_spec_ChatMessageChange, bases.get());
    if (!state->type_ChatMessageChange)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageChange);

    state->type_ChatMessageChangeReader = py::register_python_type(module.get(), type_name_ChatMessageChangeReader, &type_spec_ChatMessageChangeReader, bases.get());
    if (!state->type_ChatMessageChangeReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageChangeReader);

    state->type_ChatMessageChangeTracker = py::register_python_type(module.get(), type_name_ChatMessageChangeTracker, &type_spec_ChatMessageChangeTracker, bases.get());
    if (!state->type_ChatMessageChangeTracker)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageChangeTracker);

    state->type_ChatMessageChangedDeferral = py::register_python_type(module.get(), type_name_ChatMessageChangedDeferral, &type_spec_ChatMessageChangedDeferral, bases.get());
    if (!state->type_ChatMessageChangedDeferral)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageChangedDeferral);

    state->type_ChatMessageChangedEventArgs = py::register_python_type(module.get(), type_name_ChatMessageChangedEventArgs, &type_spec_ChatMessageChangedEventArgs, bases.get());
    if (!state->type_ChatMessageChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageChangedEventArgs);

    state->type_ChatMessageManager = py::register_python_type(module.get(), type_name_ChatMessageManager, &type_spec_ChatMessageManager, nullptr);
    if (!state->type_ChatMessageManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageManager);

    state->type_ChatMessageNotificationTriggerDetails = py::register_python_type(module.get(), type_name_ChatMessageNotificationTriggerDetails, &type_spec_ChatMessageNotificationTriggerDetails, bases.get());
    if (!state->type_ChatMessageNotificationTriggerDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageNotificationTriggerDetails);

    state->type_ChatMessageReader = py::register_python_type(module.get(), type_name_ChatMessageReader, &type_spec_ChatMessageReader, bases.get());
    if (!state->type_ChatMessageReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageReader);

    state->type_ChatMessageStore = py::register_python_type(module.get(), type_name_ChatMessageStore, &type_spec_ChatMessageStore, bases.get());
    if (!state->type_ChatMessageStore)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageStore);

    state->type_ChatMessageStoreChangedEventArgs = py::register_python_type(module.get(), type_name_ChatMessageStoreChangedEventArgs, &type_spec_ChatMessageStoreChangedEventArgs, bases.get());
    if (!state->type_ChatMessageStoreChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageStoreChangedEventArgs);

    state->type_ChatMessageTransport = py::register_python_type(module.get(), type_name_ChatMessageTransport, &type_spec_ChatMessageTransport, bases.get());
    if (!state->type_ChatMessageTransport)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageTransport);

    state->type_ChatMessageTransportConfiguration = py::register_python_type(module.get(), type_name_ChatMessageTransportConfiguration, &type_spec_ChatMessageTransportConfiguration, bases.get());
    if (!state->type_ChatMessageTransportConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageTransportConfiguration);

    state->type_ChatMessageValidationResult = py::register_python_type(module.get(), type_name_ChatMessageValidationResult, &type_spec_ChatMessageValidationResult, bases.get());
    if (!state->type_ChatMessageValidationResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatMessageValidationResult);

    state->type_ChatQueryOptions = py::register_python_type(module.get(), type_name_ChatQueryOptions, &type_spec_ChatQueryOptions, bases.get());
    if (!state->type_ChatQueryOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatQueryOptions);

    state->type_ChatRecipientDeliveryInfo = py::register_python_type(module.get(), type_name_ChatRecipientDeliveryInfo, &type_spec_ChatRecipientDeliveryInfo, bases.get());
    if (!state->type_ChatRecipientDeliveryInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatRecipientDeliveryInfo);

    state->type_ChatSearchReader = py::register_python_type(module.get(), type_name_ChatSearchReader, &type_spec_ChatSearchReader, bases.get());
    if (!state->type_ChatSearchReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatSearchReader);

    state->type_ChatSyncConfiguration = py::register_python_type(module.get(), type_name_ChatSyncConfiguration, &type_spec_ChatSyncConfiguration, bases.get());
    if (!state->type_ChatSyncConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatSyncConfiguration);

    state->type_ChatSyncManager = py::register_python_type(module.get(), type_name_ChatSyncManager, &type_spec_ChatSyncManager, bases.get());
    if (!state->type_ChatSyncManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChatSyncManager);

    state->type_RcsEndUserMessage = py::register_python_type(module.get(), type_name_RcsEndUserMessage, &type_spec_RcsEndUserMessage, bases.get());
    if (!state->type_RcsEndUserMessage)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RcsEndUserMessage);

    state->type_RcsEndUserMessageAction = py::register_python_type(module.get(), type_name_RcsEndUserMessageAction, &type_spec_RcsEndUserMessageAction, bases.get());
    if (!state->type_RcsEndUserMessageAction)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RcsEndUserMessageAction);

    state->type_RcsEndUserMessageAvailableEventArgs = py::register_python_type(module.get(), type_name_RcsEndUserMessageAvailableEventArgs, &type_spec_RcsEndUserMessageAvailableEventArgs, bases.get());
    if (!state->type_RcsEndUserMessageAvailableEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RcsEndUserMessageAvailableEventArgs);

    state->type_RcsEndUserMessageAvailableTriggerDetails = py::register_python_type(module.get(), type_name_RcsEndUserMessageAvailableTriggerDetails, &type_spec_RcsEndUserMessageAvailableTriggerDetails, bases.get());
    if (!state->type_RcsEndUserMessageAvailableTriggerDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RcsEndUserMessageAvailableTriggerDetails);

    state->type_RcsEndUserMessageManager = py::register_python_type(module.get(), type_name_RcsEndUserMessageManager, &type_spec_RcsEndUserMessageManager, bases.get());
    if (!state->type_RcsEndUserMessageManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RcsEndUserMessageManager);

    state->type_RcsManager = py::register_python_type(module.get(), type_name_RcsManager, &type_spec_RcsManager, nullptr);
    if (!state->type_RcsManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RcsManager);

    state->type_RcsServiceKindSupportedChangedEventArgs = py::register_python_type(module.get(), type_name_RcsServiceKindSupportedChangedEventArgs, &type_spec_RcsServiceKindSupportedChangedEventArgs, bases.get());
    if (!state->type_RcsServiceKindSupportedChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RcsServiceKindSupportedChangedEventArgs);

    state->type_RcsTransport = py::register_python_type(module.get(), type_name_RcsTransport, &type_spec_RcsTransport, bases.get());
    if (!state->type_RcsTransport)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RcsTransport);

    state->type_RcsTransportConfiguration = py::register_python_type(module.get(), type_name_RcsTransportConfiguration, &type_spec_RcsTransportConfiguration, bases.get());
    if (!state->type_RcsTransportConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RcsTransportConfiguration);

    state->type_RemoteParticipantComposingChangedEventArgs = py::register_python_type(module.get(), type_name_RemoteParticipantComposingChangedEventArgs, &type_spec_RemoteParticipantComposingChangedEventArgs, bases.get());
    if (!state->type_RemoteParticipantComposingChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteParticipantComposingChangedEventArgs);

    state->type_IChatItem = py::register_python_type(module.get(), type_name_IChatItem, &type_spec_IChatItem, bases.get());
    if (!state->type_IChatItem)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IChatItem);
