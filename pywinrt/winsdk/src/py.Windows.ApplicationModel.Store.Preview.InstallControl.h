...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallationToastNotificationMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Store::Preview::InstallControl::AutoUpdateSetting> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Store::Preview::InstallControl::GetEntitlementStatus> = "i";
