...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Authentication::Web::Core::FindAllWebAccountsStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Authentication::Web::Core::WebTokenRequestPromptType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Authentication::Web::Core::WebTokenRequestStatus> = "i";
