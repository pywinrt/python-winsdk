...
winrt::Windows::UI::Text::Core::CoreTextRange py::converter<winrt::Windows::UI::Text::Core::CoreTextRange>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Text::Core::CoreTextRange or dict");
    ...
    if (!py_StartCaretPosition) {
        PyErr_SetString(PyExc_KeyError, "StartCaretPosition");
        throw python_exception();
    }
    ...
    if (!py_EndCaretPosition) {
        PyErr_SetString(PyExc_KeyError, "EndCaretPosition");
        throw python_exception();
    }
