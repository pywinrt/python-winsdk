...
namespace py::cpp::Windows::UI::Text::Core
{
    ...
    static PyObject* register_CoreTextFormatUpdatingReason(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_CoreTextFormatUpdatingResult(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreTextInputPaneDisplayPolicy(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreTextInputScope(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreTextSelectionUpdatingResult(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CoreTextTextUpdatingResult(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_CoreTextCompositionCompletedEventArgs = "CoreTextCompositionCompletedEventArgs";
    ...
    constexpr const char* const type_name_CoreTextCompositionSegment = "CoreTextCompositionSegment";
    ...
    constexpr const char* const type_name_CoreTextCompositionStartedEventArgs = "CoreTextCompositionStartedEventArgs";
    ...
    constexpr const char* const type_name_CoreTextEditContext = "CoreTextEditContext";
    ...
    constexpr const char* const type_name_CoreTextFormatUpdatingEventArgs = "CoreTextFormatUpdatingEventArgs";
    ...
    constexpr const char* const type_name_CoreTextLayoutBounds = "CoreTextLayoutBounds";
    ...
    constexpr const char* const type_name_CoreTextLayoutRequest = "CoreTextLayoutRequest";
    ...
    constexpr const char* const type_name_CoreTextLayoutRequestedEventArgs = "CoreTextLayoutRequestedEventArgs";
    ...
    constexpr const char* const type_name_CoreTextSelectionRequest = "CoreTextSelectionRequest";
    ...
    constexpr const char* const type_name_CoreTextSelectionRequestedEventArgs = "CoreTextSelectionRequestedEventArgs";
    ...
    constexpr const char* const type_name_CoreTextSelectionUpdatingEventArgs = "CoreTextSelectionUpdatingEventArgs";
    ...
    constexpr const char* const type_name_CoreTextServicesConstants = "CoreTextServicesConstants";
    ...
    constexpr const char* const type_name_CoreTextServicesManager = "CoreTextServicesManager";
    ...
    constexpr const char* const type_name_CoreTextTextRequest = "CoreTextTextRequest";
    ...
    constexpr const char* const type_name_CoreTextTextRequestedEventArgs = "CoreTextTextRequestedEventArgs";
    ...
    constexpr const char* const type_name_CoreTextTextUpdatingEventArgs = "CoreTextTextUpdatingEventArgs";
    ...
    constexpr const char* const type_name_CoreTextRange = "CoreTextRange";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_Text_Core(void) noexcept
{
    ...
    state->type_CoreTextCompositionCompletedEventArgs = py::register_python_type(module.get(), type_name_CoreTextCompositionCompletedEventArgs, &type_spec_CoreTextCompositionCompletedEventArgs, bases.get());
    if (!state->type_CoreTextCompositionCompletedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextCompositionCompletedEventArgs);

    state->type_CoreTextCompositionSegment = py::register_python_type(module.get(), type_name_CoreTextCompositionSegment, &type_spec_CoreTextCompositionSegment, bases.get());
    if (!state->type_CoreTextCompositionSegment)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextCompositionSegment);

    state->type_CoreTextCompositionStartedEventArgs = py::register_python_type(module.get(), type_name_CoreTextCompositionStartedEventArgs, &type_spec_CoreTextCompositionStartedEventArgs, bases.get());
    if (!state->type_CoreTextCompositionStartedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextCompositionStartedEventArgs);

    state->type_CoreTextEditContext = py::register_python_type(module.get(), type_name_CoreTextEditContext, &type_spec_CoreTextEditContext, bases.get());
    if (!state->type_CoreTextEditContext)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextEditContext);

    state->type_CoreTextFormatUpdatingEventArgs = py::register_python_type(module.get(), type_name_CoreTextFormatUpdatingEventArgs, &type_spec_CoreTextFormatUpdatingEventArgs, bases.get());
    if (!state->type_CoreTextFormatUpdatingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextFormatUpdatingEventArgs);

    state->type_CoreTextLayoutBounds = py::register_python_type(module.get(), type_name_CoreTextLayoutBounds, &type_spec_CoreTextLayoutBounds, bases.get());
    if (!state->type_CoreTextLayoutBounds)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextLayoutBounds);

    state->type_CoreTextLayoutRequest = py::register_python_type(module.get(), type_name_CoreTextLayoutRequest, &type_spec_CoreTextLayoutRequest, bases.get());
    if (!state->type_CoreTextLayoutRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextLayoutRequest);

    state->type_CoreTextLayoutRequestedEventArgs = py::register_python_type(module.get(), type_name_CoreTextLayoutRequestedEventArgs, &type_spec_CoreTextLayoutRequestedEventArgs, bases.get());
    if (!state->type_CoreTextLayoutRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextLayoutRequestedEventArgs);

    state->type_CoreTextSelectionRequest = py::register_python_type(module.get(), type_name_CoreTextSelectionRequest, &type_spec_CoreTextSelectionRequest, bases.get());
    if (!state->type_CoreTextSelectionRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextSelectionRequest);

    state->type_CoreTextSelectionRequestedEventArgs = py::register_python_type(module.get(), type_name_CoreTextSelectionRequestedEventArgs, &type_spec_CoreTextSelectionRequestedEventArgs, bases.get());
    if (!state->type_CoreTextSelectionRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextSelectionRequestedEventArgs);

    state->type_CoreTextSelectionUpdatingEventArgs = py::register_python_type(module.get(), type_name_CoreTextSelectionUpdatingEventArgs, &type_spec_CoreTextSelectionUpdatingEventArgs, bases.get());
    if (!state->type_CoreTextSelectionUpdatingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextSelectionUpdatingEventArgs);

    state->type_CoreTextServicesConstants = py::register_python_type(module.get(), type_name_CoreTextServicesConstants, &type_spec_CoreTextServicesConstants, nullptr);
    if (!state->type_CoreTextServicesConstants)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextServicesConstants);

    state->type_CoreTextServicesManager = py::register_python_type(module.get(), type_name_CoreTextServicesManager, &type_spec_CoreTextServicesManager, bases.get());
    if (!state->type_CoreTextServicesManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextServicesManager);

    state->type_CoreTextTextRequest = py::register_python_type(module.get(), type_name_CoreTextTextRequest, &type_spec_CoreTextTextRequest, bases.get());
    if (!state->type_CoreTextTextRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextTextRequest);

    state->type_CoreTextTextRequestedEventArgs = py::register_python_type(module.get(), type_name_CoreTextTextRequestedEventArgs, &type_spec_CoreTextTextRequestedEventArgs, bases.get());
    if (!state->type_CoreTextTextRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextTextRequestedEventArgs);

    state->type_CoreTextTextUpdatingEventArgs = py::register_python_type(module.get(), type_name_CoreTextTextUpdatingEventArgs, &type_spec_CoreTextTextUpdatingEventArgs, bases.get());
    if (!state->type_CoreTextTextUpdatingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextTextUpdatingEventArgs);

    state->type_CoreTextRange = py::register_python_type(module.get(), type_name_CoreTextRange, &type_spec_CoreTextRange, bases.get());
    if (!state->type_CoreTextRange)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreTextRange);
