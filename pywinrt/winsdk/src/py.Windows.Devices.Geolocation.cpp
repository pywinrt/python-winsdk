...
winrt::Windows::Devices::Geolocation::BasicGeoposition py::converter<winrt::Windows::Devices::Geolocation::BasicGeoposition>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Devices::Geolocation::BasicGeoposition or dict");
    ...
    if (!py_Latitude) {
        PyErr_SetString(PyExc_KeyError, "Latitude");
        throw python_exception();
    }
    ...
    if (!py_Longitude) {
        PyErr_SetString(PyExc_KeyError, "Longitude");
        throw python_exception();
    }
    ...
    if (!py_Altitude) {
        PyErr_SetString(PyExc_KeyError, "Altitude");
        throw python_exception();
    }
