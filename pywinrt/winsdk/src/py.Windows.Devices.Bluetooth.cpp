...
namespace py::cpp::Windows::Devices::Bluetooth
{
    ...
    static PyType_Slot type_slots_BluetoothLEAppearanceCategories_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_BluetoothLEAppearanceCategories_Meta },
        { }
    };

    static PyType_Spec type_spec_BluetoothLEAppearanceCategories_Meta =
    {
        "_winsdk_Windows_Devices_Bluetooth.BluetoothLEAppearanceCategories_Meta",
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_BluetoothLEAppearanceSubcategories_Meta },
        { }
    };

    static PyType_Spec type_spec_BluetoothLEAppearanceSubcategories_Meta =
    {
        "_winsdk_Windows_Devices_Bluetooth.BluetoothLEAppearanceSubcategories_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_BluetoothLEPreferredConnectionParameters_Meta },
        { }
    };

    static PyType_Spec type_spec_BluetoothLEPreferredConnectionParameters_Meta =
    {
        "_winsdk_Windows_Devices_Bluetooth.BluetoothLEPreferredConnectionParameters_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Bluetooth(void) noexcept
{
    ...
    state->type_BluetoothAdapter = py::register_python_type(module.get(), type_name_BluetoothAdapter, &type_spec_BluetoothAdapter, bases.get(), nullptr);
    if (!state->type_BluetoothAdapter)
    {
        return nullptr;
    }

    state->type_BluetoothClassOfDevice = py::register_python_type(module.get(), type_name_BluetoothClassOfDevice, &type_spec_BluetoothClassOfDevice, bases.get(), nullptr);
    if (!state->type_BluetoothClassOfDevice)
    {
        return nullptr;
    }

    state->type_BluetoothDevice = py::register_python_type(module.get(), type_name_BluetoothDevice, &type_spec_BluetoothDevice, bases.get(), nullptr);
    if (!state->type_BluetoothDevice)
    {
        return nullptr;
    }

    state->type_BluetoothDeviceId = py::register_python_type(module.get(), type_name_BluetoothDeviceId, &type_spec_BluetoothDeviceId, bases.get(), nullptr);
    if (!state->type_BluetoothDeviceId)
    {
        return nullptr;
    }

    state->type_BluetoothLEAppearance = py::register_python_type(module.get(), type_name_BluetoothLEAppearance, &type_spec_BluetoothLEAppearance, bases.get(), nullptr);
    ...
    state->type_BluetoothLEAppearanceCategories = py::register_python_type(module.get(), type_name_BluetoothLEAppearanceCategories, &type_spec_BluetoothLEAppearanceCategories, nullptr, reinterpret_cast<PyTypeObject*>(type_BluetoothLEAppearanceCategories_Meta.get()));
    ...
    state->type_BluetoothLEAppearanceSubcategories = py::register_python_type(module.get(), type_name_BluetoothLEAppearanceSubcategories, &type_spec_BluetoothLEAppearanceSubcategories, nullptr, reinterpret_cast<PyTypeObject*>(type_BluetoothLEAppearanceSubcategories_Meta.get()));
    if (!state->type_BluetoothLEAppearanceSubcategories)
    {
        return nullptr;
    }

    state->type_BluetoothLEConnectionParameters = py::register_python_type(module.get(), type_name_BluetoothLEConnectionParameters, &type_spec_BluetoothLEConnectionParameters, bases.get(), nullptr);
    if (!state->type_BluetoothLEConnectionParameters)
    {
        return nullptr;
    }

    state->type_BluetoothLEConnectionPhy = py::register_python_type(module.get(), type_name_BluetoothLEConnectionPhy, &type_spec_BluetoothLEConnectionPhy, bases.get(), nullptr);
    if (!state->type_BluetoothLEConnectionPhy)
    {
        return nullptr;
    }

    state->type_BluetoothLEConnectionPhyInfo = py::register_python_type(module.get(), type_name_BluetoothLEConnectionPhyInfo, &type_spec_BluetoothLEConnectionPhyInfo, bases.get(), nullptr);
    if (!state->type_BluetoothLEConnectionPhyInfo)
    {
        return nullptr;
    }

    state->type_BluetoothLEDevice = py::register_python_type(module.get(), type_name_BluetoothLEDevice, &type_spec_BluetoothLEDevice, bases.get(), nullptr);
    ...
    state->type_BluetoothLEPreferredConnectionParameters = py::register_python_type(module.get(), type_name_BluetoothLEPreferredConnectionParameters, &type_spec_BluetoothLEPreferredConnectionParameters, bases.get(), reinterpret_cast<PyTypeObject*>(type_BluetoothLEPreferredConnectionParameters_Meta.get()));
    if (!state->type_BluetoothLEPreferredConnectionParameters)
    {
        return nullptr;
    }

    state->type_BluetoothLEPreferredConnectionParametersRequest = py::register_python_type(module.get(), type_name_BluetoothLEPreferredConnectionParametersRequest, &type_spec_BluetoothLEPreferredConnectionParametersRequest, bases.get(), nullptr);
    if (!state->type_BluetoothLEPreferredConnectionParametersRequest)
    {
        return nullptr;
    }

    state->type_BluetoothSignalStrengthFilter = py::register_python_type(module.get(), type_name_BluetoothSignalStrengthFilter, &type_spec_BluetoothSignalStrengthFilter, bases.get(), nullptr);
    if (!state->type_BluetoothSignalStrengthFilter)
    {
        return nullptr;
    }

    state->type_BluetoothUuidHelper = py::register_python_type(module.get(), type_name_BluetoothUuidHelper, &type_spec_BluetoothUuidHelper, nullptr, nullptr);
