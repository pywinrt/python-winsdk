...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::DateTimeFormatting::DayFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::DateTimeFormatting::DayOfWeekFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::DateTimeFormatting::HourFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::DateTimeFormatting::MinuteFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::DateTimeFormatting::MonthFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::DateTimeFormatting::SecondFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Globalization::DateTimeFormatting::YearFormat> = "i";
