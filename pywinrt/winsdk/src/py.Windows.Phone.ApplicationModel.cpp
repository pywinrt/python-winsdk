...
namespace py::cpp::Windows::Phone::ApplicationModel
{
    ...
    static PyType_Slot type_slots_ApplicationProfile_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_ApplicationProfile_Meta },
        { }
    };

    static PyType_Spec type_spec_ApplicationProfile_Meta =
    {
        "_winsdk_Windows_Phone_ApplicationModel.ApplicationProfile_Meta",
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Phone_ApplicationModel(void) noexcept
{
    ...
    state->type_ApplicationProfile = py::register_python_type(module.get(), type_name_ApplicationProfile, &type_spec_ApplicationProfile, nullptr, reinterpret_cast<PyTypeObject*>(type_ApplicationProfile_Meta.get()));
