...
namespace py::cpp::Windows::Security::Cryptography::Certificates
{
    ...
    static PyObject* register_CertificateChainPolicy(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_ChainValidationResult(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_EnrollKeyUsages(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ExportOption(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_InstallOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_KeyProtectionLevel(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_KeySize(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SignatureValidationResult(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    // ----- Certificate class --------------------
    constexpr const char* const type_name_Certificate = "Certificate";
    ...
    constexpr const char* const type_name_CertificateChain = "CertificateChain";
    ...
    constexpr const char* const type_name_CertificateEnrollmentManager = "CertificateEnrollmentManager";
    ...
    constexpr const char* const type_name_CertificateExtension = "CertificateExtension";
    ...
    constexpr const char* const type_name_CertificateKeyUsages = "CertificateKeyUsages";
    ...
    constexpr const char* const type_name_CertificateQuery = "CertificateQuery";
    ...
    constexpr const char* const type_name_CertificateRequestProperties = "CertificateRequestProperties";
    ...
    constexpr const char* const type_name_CertificateStore = "CertificateStore";
    ...
    constexpr const char* const type_name_CertificateStores = "CertificateStores";
    ...
    constexpr const char* const type_name_ChainBuildingParameters = "ChainBuildingParameters";
    ...
    constexpr const char* const type_name_ChainValidationParameters = "ChainValidationParameters";
    ...
    constexpr const char* const type_name_CmsAttachedSignature = "CmsAttachedSignature";
    ...
    constexpr const char* const type_name_CmsDetachedSignature = "CmsDetachedSignature";
    ...
    // ----- CmsSignerInfo class --------------------
    constexpr const char* const type_name_CmsSignerInfo = "CmsSignerInfo";
    ...
    constexpr const char* const type_name_CmsTimestampInfo = "CmsTimestampInfo";
    ...
    constexpr const char* const type_name_KeyAlgorithmNames = "KeyAlgorithmNames";
    ...
    constexpr const char* const type_name_KeyAttestationHelper = "KeyAttestationHelper";
    ...
    constexpr const char* const type_name_KeyStorageProviderNames = "KeyStorageProviderNames";
    ...
    constexpr const char* const type_name_PfxImportParameters = "PfxImportParameters";
    ...
    constexpr const char* const type_name_StandardCertificateStoreNames = "StandardCertificateStoreNames";
    ...
    constexpr const char* const type_name_SubjectAlternativeNameInfo = "SubjectAlternativeNameInfo";
    ...
    constexpr const char* const type_name_UserCertificateEnrollmentManager = "UserCertificateEnrollmentManager";
    ...
    constexpr const char* const type_name_UserCertificateStore = "UserCertificateStore";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Security_Cryptography_Certificates(void) noexcept
{
    ...
    state->type_Certificate = py::register_python_type(module.get(), type_name_Certificate, &type_spec_Certificate, bases.get());
    if (!state->type_Certificate)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Certificate);

    state->type_CertificateChain = py::register_python_type(module.get(), type_name_CertificateChain, &type_spec_CertificateChain, bases.get());
    if (!state->type_CertificateChain)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CertificateChain);

    state->type_CertificateEnrollmentManager = py::register_python_type(module.get(), type_name_CertificateEnrollmentManager, &type_spec_CertificateEnrollmentManager, nullptr);
    if (!state->type_CertificateEnrollmentManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CertificateEnrollmentManager);

    state->type_CertificateExtension = py::register_python_type(module.get(), type_name_CertificateExtension, &type_spec_CertificateExtension, bases.get());
    if (!state->type_CertificateExtension)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CertificateExtension);

    state->type_CertificateKeyUsages = py::register_python_type(module.get(), type_name_CertificateKeyUsages, &type_spec_CertificateKeyUsages, bases.get());
    if (!state->type_CertificateKeyUsages)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CertificateKeyUsages);

    state->type_CertificateQuery = py::register_python_type(module.get(), type_name_CertificateQuery, &type_spec_CertificateQuery, bases.get());
    if (!state->type_CertificateQuery)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CertificateQuery);

    state->type_CertificateRequestProperties = py::register_python_type(module.get(), type_name_CertificateRequestProperties, &type_spec_CertificateRequestProperties, bases.get());
    if (!state->type_CertificateRequestProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CertificateRequestProperties);

    state->type_CertificateStore = py::register_python_type(module.get(), type_name_CertificateStore, &type_spec_CertificateStore, bases.get());
    if (!state->type_CertificateStore)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CertificateStore);

    state->type_CertificateStores = py::register_python_type(module.get(), type_name_CertificateStores, &type_spec_CertificateStores, nullptr);
    if (!state->type_CertificateStores)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CertificateStores);

    state->type_ChainBuildingParameters = py::register_python_type(module.get(), type_name_ChainBuildingParameters, &type_spec_ChainBuildingParameters, bases.get());
    if (!state->type_ChainBuildingParameters)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChainBuildingParameters);

    state->type_ChainValidationParameters = py::register_python_type(module.get(), type_name_ChainValidationParameters, &type_spec_ChainValidationParameters, bases.get());
    if (!state->type_ChainValidationParameters)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ChainValidationParameters);

    state->type_CmsAttachedSignature = py::register_python_type(module.get(), type_name_CmsAttachedSignature, &type_spec_CmsAttachedSignature, bases.get());
    if (!state->type_CmsAttachedSignature)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CmsAttachedSignature);

    state->type_CmsDetachedSignature = py::register_python_type(module.get(), type_name_CmsDetachedSignature, &type_spec_CmsDetachedSignature, bases.get());
    if (!state->type_CmsDetachedSignature)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CmsDetachedSignature);

    state->type_CmsSignerInfo = py::register_python_type(module.get(), type_name_CmsSignerInfo, &type_spec_CmsSignerInfo, bases.get());
    if (!state->type_CmsSignerInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CmsSignerInfo);

    state->type_CmsTimestampInfo = py::register_python_type(module.get(), type_name_CmsTimestampInfo, &type_spec_CmsTimestampInfo, bases.get());
    if (!state->type_CmsTimestampInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CmsTimestampInfo);

    state->type_KeyAlgorithmNames = py::register_python_type(module.get(), type_name_KeyAlgorithmNames, &type_spec_KeyAlgorithmNames, nullptr);
    if (!state->type_KeyAlgorithmNames)
    {
        return nullptr;
    }

    Py_INCREF(state->type_KeyAlgorithmNames);

    state->type_KeyAttestationHelper = py::register_python_type(module.get(), type_name_KeyAttestationHelper, &type_spec_KeyAttestationHelper, nullptr);
    if (!state->type_KeyAttestationHelper)
    {
        return nullptr;
    }

    Py_INCREF(state->type_KeyAttestationHelper);

    state->type_KeyStorageProviderNames = py::register_python_type(module.get(), type_name_KeyStorageProviderNames, &type_spec_KeyStorageProviderNames, nullptr);
    if (!state->type_KeyStorageProviderNames)
    {
        return nullptr;
    }

    Py_INCREF(state->type_KeyStorageProviderNames);

    state->type_PfxImportParameters = py::register_python_type(module.get(), type_name_PfxImportParameters, &type_spec_PfxImportParameters, bases.get());
    if (!state->type_PfxImportParameters)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PfxImportParameters);

    state->type_StandardCertificateStoreNames = py::register_python_type(module.get(), type_name_StandardCertificateStoreNames, &type_spec_StandardCertificateStoreNames, nullptr);
    if (!state->type_StandardCertificateStoreNames)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StandardCertificateStoreNames);

    state->type_SubjectAlternativeNameInfo = py::register_python_type(module.get(), type_name_SubjectAlternativeNameInfo, &type_spec_SubjectAlternativeNameInfo, bases.get());
    if (!state->type_SubjectAlternativeNameInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SubjectAlternativeNameInfo);

    state->type_UserCertificateEnrollmentManager = py::register_python_type(module.get(), type_name_UserCertificateEnrollmentManager, &type_spec_UserCertificateEnrollmentManager, bases.get());
    if (!state->type_UserCertificateEnrollmentManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_UserCertificateEnrollmentManager);

    state->type_UserCertificateStore = py::register_python_type(module.get(), type_name_UserCertificateStore, &type_spec_UserCertificateStore, bases.get());
    if (!state->type_UserCertificateStore)
    {
        return nullptr;
    }

    Py_INCREF(state->type_UserCertificateStore);
