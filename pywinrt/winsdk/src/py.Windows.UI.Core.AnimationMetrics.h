...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::AnimationMetrics::AnimationEffect> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::AnimationMetrics::AnimationEffectTarget> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::AnimationMetrics::PropertyAnimationType> = "i";
