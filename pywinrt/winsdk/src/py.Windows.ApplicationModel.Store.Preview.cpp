...
namespace py::cpp::Windows::ApplicationModel::Store::Preview
{
    ...
    static PyObject* register_DeliveryOptimizationDownloadMode(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_DeliveryOptimizationDownloadModeSource(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StoreLogOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StorePreviewProductPurchaseStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StoreSystemFeature(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_DeliveryOptimizationSettings = "DeliveryOptimizationSettings";
    ...
    constexpr const char* const type_name_StoreConfiguration = "StoreConfiguration";
    ...
    constexpr const char* const type_name_StoreHardwareManufacturerInfo = "StoreHardwareManufacturerInfo";
    ...
    // ----- StorePreview class --------------------
    constexpr const char* const type_name_StorePreview = "StorePreview";
    ...
    constexpr const char* const type_name_StorePreviewProductInfo = "StorePreviewProductInfo";
    ...
    constexpr const char* const type_name_StorePreviewPurchaseResults = "StorePreviewPurchaseResults";
    ...
    constexpr const char* const type_name_StorePreviewSkuInfo = "StorePreviewSkuInfo";
    ...
    constexpr const char* const type_name_WebAuthenticationCoreManagerHelper = "WebAuthenticationCoreManagerHelper";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_Store_Preview(void) noexcept
{
    ...
    state->type_DeliveryOptimizationSettings = py::register_python_type(module.get(), type_name_DeliveryOptimizationSettings, &type_spec_DeliveryOptimizationSettings, bases.get());
    if (!state->type_DeliveryOptimizationSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DeliveryOptimizationSettings);

    state->type_StoreConfiguration = py::register_python_type(module.get(), type_name_StoreConfiguration, &type_spec_StoreConfiguration, nullptr);
    if (!state->type_StoreConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreConfiguration);

    state->type_StoreHardwareManufacturerInfo = py::register_python_type(module.get(), type_name_StoreHardwareManufacturerInfo, &type_spec_StoreHardwareManufacturerInfo, bases.get());
    if (!state->type_StoreHardwareManufacturerInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StoreHardwareManufacturerInfo);

    state->type_StorePreview = py::register_python_type(module.get(), type_name_StorePreview, &type_spec_StorePreview, nullptr);
    if (!state->type_StorePreview)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorePreview);

    state->type_StorePreviewProductInfo = py::register_python_type(module.get(), type_name_StorePreviewProductInfo, &type_spec_StorePreviewProductInfo, bases.get());
    if (!state->type_StorePreviewProductInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorePreviewProductInfo);

    state->type_StorePreviewPurchaseResults = py::register_python_type(module.get(), type_name_StorePreviewPurchaseResults, &type_spec_StorePreviewPurchaseResults, bases.get());
    if (!state->type_StorePreviewPurchaseResults)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorePreviewPurchaseResults);

    state->type_StorePreviewSkuInfo = py::register_python_type(module.get(), type_name_StorePreviewSkuInfo, &type_spec_StorePreviewSkuInfo, bases.get());
    if (!state->type_StorePreviewSkuInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorePreviewSkuInfo);

    state->type_WebAuthenticationCoreManagerHelper = py::register_python_type(module.get(), type_name_WebAuthenticationCoreManagerHelper, &type_spec_WebAuthenticationCoreManagerHelper, nullptr);
    if (!state->type_WebAuthenticationCoreManagerHelper)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WebAuthenticationCoreManagerHelper);
