...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::ExchangeActiveSyncProvisioning::EasDisallowConvenienceLogonResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::ExchangeActiveSyncProvisioning::EasEncryptionProviderType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::ExchangeActiveSyncProvisioning::EasMaxInactivityTimeLockResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::ExchangeActiveSyncProvisioning::EasMaxPasswordFailedAttemptsResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::ExchangeActiveSyncProvisioning::EasMinPasswordComplexCharactersResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::ExchangeActiveSyncProvisioning::EasMinPasswordLengthResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::ExchangeActiveSyncProvisioning::EasPasswordExpirationResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::ExchangeActiveSyncProvisioning::EasPasswordHistoryResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::ExchangeActiveSyncProvisioning::EasRequireEncryptionResult> = "i";
