...
winrt::Windows::Web::Syndication::RetrievalProgress py::converter<winrt::Windows::Web::Syndication::RetrievalProgress>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Web::Syndication::RetrievalProgress or dict");
    ...
    if (!py_BytesRetrieved) {
        PyErr_SetString(PyExc_KeyError, "BytesRetrieved");
        throw python_exception();
    }
    ...
    if (!py_TotalBytesToRetrieve) {
        PyErr_SetString(PyExc_KeyError, "TotalBytesToRetrieve");
        throw python_exception();
    }
...
winrt::Windows::Web::Syndication::TransferProgress py::converter<winrt::Windows::Web::Syndication::TransferProgress>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Web::Syndication::TransferProgress or dict");
        throw python_exception();
    }
