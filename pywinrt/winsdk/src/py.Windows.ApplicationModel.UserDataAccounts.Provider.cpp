...
namespace py::cpp::Windows::ApplicationModel::UserDataAccounts::Provider
{
    ...
    static PyObject* register_UserDataAccountProviderOperationKind(PyObject* module, PyObject* type) noexcept
    {
    ...
    static PyObject* register_UserDataAccountProviderPartnerAccountKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_UserDataAccounts_Provider(void) noexcept
{
    ...
    state->type_UserDataAccountPartnerAccountInfo = py::register_python_type(module.get(), type_name_UserDataAccountPartnerAccountInfo, &type_spec_UserDataAccountPartnerAccountInfo, bases.get(), nullptr);
    if (!state->type_UserDataAccountPartnerAccountInfo)
    {
        return nullptr;
    }

    state->type_UserDataAccountProviderAddAccountOperation = py::register_python_type(module.get(), type_name_UserDataAccountProviderAddAccountOperation, &type_spec_UserDataAccountProviderAddAccountOperation, bases.get(), nullptr);
    if (!state->type_UserDataAccountProviderAddAccountOperation)
    {
        return nullptr;
    }

    state->type_UserDataAccountProviderResolveErrorsOperation = py::register_python_type(module.get(), type_name_UserDataAccountProviderResolveErrorsOperation, &type_spec_UserDataAccountProviderResolveErrorsOperation, bases.get(), nullptr);
    if (!state->type_UserDataAccountProviderResolveErrorsOperation)
    {
        return nullptr;
    }

    state->type_UserDataAccountProviderSettingsOperation = py::register_python_type(module.get(), type_name_UserDataAccountProviderSettingsOperation, &type_spec_UserDataAccountProviderSettingsOperation, bases.get(), nullptr);
    if (!state->type_UserDataAccountProviderSettingsOperation)
    {
        return nullptr;
    }

    state->type_IUserDataAccountProviderOperation = py::register_python_type(module.get(), type_name_IUserDataAccountProviderOperation, &type_spec_IUserDataAccountProviderOperation, bases.get(), nullptr);
