...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_PointOfService_Provider(void) noexcept
{
    ...
    state->type_BarcodeScannerDisableScannerRequest = py::register_python_type(module.get(), type_name_BarcodeScannerDisableScannerRequest, &type_spec_BarcodeScannerDisableScannerRequest, bases.get(), nullptr);
    if (!state->type_BarcodeScannerDisableScannerRequest)
    {
        return nullptr;
    }

    state->type_BarcodeScannerDisableScannerRequestEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerDisableScannerRequestEventArgs, &type_spec_BarcodeScannerDisableScannerRequestEventArgs, bases.get(), nullptr);
    if (!state->type_BarcodeScannerDisableScannerRequestEventArgs)
    {
        return nullptr;
    }

    state->type_BarcodeScannerEnableScannerRequest = py::register_python_type(module.get(), type_name_BarcodeScannerEnableScannerRequest, &type_spec_BarcodeScannerEnableScannerRequest, bases.get(), nullptr);
    if (!state->type_BarcodeScannerEnableScannerRequest)
    {
        return nullptr;
    }

    state->type_BarcodeScannerEnableScannerRequestEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerEnableScannerRequestEventArgs, &type_spec_BarcodeScannerEnableScannerRequestEventArgs, bases.get(), nullptr);
    if (!state->type_BarcodeScannerEnableScannerRequestEventArgs)
    {
        return nullptr;
    }

    state->type_BarcodeScannerFrameReader = py::register_python_type(module.get(), type_name_BarcodeScannerFrameReader, &type_spec_BarcodeScannerFrameReader, bases.get(), nullptr);
    if (!state->type_BarcodeScannerFrameReader)
    {
        return nullptr;
    }

    state->type_BarcodeScannerFrameReaderFrameArrivedEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerFrameReaderFrameArrivedEventArgs, &type_spec_BarcodeScannerFrameReaderFrameArrivedEventArgs, bases.get(), nullptr);
    if (!state->type_BarcodeScannerFrameReaderFrameArrivedEventArgs)
    {
        return nullptr;
    }

    state->type_BarcodeScannerGetSymbologyAttributesRequest = py::register_python_type(module.get(), type_name_BarcodeScannerGetSymbologyAttributesRequest, &type_spec_BarcodeScannerGetSymbologyAttributesRequest, bases.get(), nullptr);
    if (!state->type_BarcodeScannerGetSymbologyAttributesRequest)
    {
        return nullptr;
    }

    state->type_BarcodeScannerGetSymbologyAttributesRequestEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerGetSymbologyAttributesRequestEventArgs, &type_spec_BarcodeScannerGetSymbologyAttributesRequestEventArgs, bases.get(), nullptr);
    if (!state->type_BarcodeScannerGetSymbologyAttributesRequestEventArgs)
    {
        return nullptr;
    }

    state->type_BarcodeScannerHideVideoPreviewRequest = py::register_python_type(module.get(), type_name_BarcodeScannerHideVideoPreviewRequest, &type_spec_BarcodeScannerHideVideoPreviewRequest, bases.get(), nullptr);
    if (!state->type_BarcodeScannerHideVideoPreviewRequest)
    {
        return nullptr;
    }

    state->type_BarcodeScannerHideVideoPreviewRequestEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerHideVideoPreviewRequestEventArgs, &type_spec_BarcodeScannerHideVideoPreviewRequestEventArgs, bases.get(), nullptr);
    if (!state->type_BarcodeScannerHideVideoPreviewRequestEventArgs)
    {
        return nullptr;
    }

    state->type_BarcodeScannerProviderConnection = py::register_python_type(module.get(), type_name_BarcodeScannerProviderConnection, &type_spec_BarcodeScannerProviderConnection, bases.get(), nullptr);
    if (!state->type_BarcodeScannerProviderConnection)
    {
        return nullptr;
    }

    state->type_BarcodeScannerProviderTriggerDetails = py::register_python_type(module.get(), type_name_BarcodeScannerProviderTriggerDetails, &type_spec_BarcodeScannerProviderTriggerDetails, bases.get(), nullptr);
    if (!state->type_BarcodeScannerProviderTriggerDetails)
    {
        return nullptr;
    }

    state->type_BarcodeScannerSetActiveSymbologiesRequest = py::register_python_type(module.get(), type_name_BarcodeScannerSetActiveSymbologiesRequest, &type_spec_BarcodeScannerSetActiveSymbologiesRequest, bases.get(), nullptr);
    if (!state->type_BarcodeScannerSetActiveSymbologiesRequest)
    {
        return nullptr;
    }

    state->type_BarcodeScannerSetActiveSymbologiesRequestEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerSetActiveSymbologiesRequestEventArgs, &type_spec_BarcodeScannerSetActiveSymbologiesRequestEventArgs, bases.get(), nullptr);
    if (!state->type_BarcodeScannerSetActiveSymbologiesRequestEventArgs)
    {
        return nullptr;
    }

    state->type_BarcodeScannerSetSymbologyAttributesRequest = py::register_python_type(module.get(), type_name_BarcodeScannerSetSymbologyAttributesRequest, &type_spec_BarcodeScannerSetSymbologyAttributesRequest, bases.get(), nullptr);
    if (!state->type_BarcodeScannerSetSymbologyAttributesRequest)
    {
        return nullptr;
    }

    state->type_BarcodeScannerSetSymbologyAttributesRequestEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerSetSymbologyAttributesRequestEventArgs, &type_spec_BarcodeScannerSetSymbologyAttributesRequestEventArgs, bases.get(), nullptr);
    if (!state->type_BarcodeScannerSetSymbologyAttributesRequestEventArgs)
    {
        return nullptr;
    }

    state->type_BarcodeScannerStartSoftwareTriggerRequest = py::register_python_type(module.get(), type_name_BarcodeScannerStartSoftwareTriggerRequest, &type_spec_BarcodeScannerStartSoftwareTriggerRequest, bases.get(), nullptr);
    if (!state->type_BarcodeScannerStartSoftwareTriggerRequest)
    {
        return nullptr;
    }

    state->type_BarcodeScannerStartSoftwareTriggerRequestEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerStartSoftwareTriggerRequestEventArgs, &type_spec_BarcodeScannerStartSoftwareTriggerRequestEventArgs, bases.get(), nullptr);
    if (!state->type_BarcodeScannerStartSoftwareTriggerRequestEventArgs)
    {
        return nullptr;
    }

    state->type_BarcodeScannerStopSoftwareTriggerRequest = py::register_python_type(module.get(), type_name_BarcodeScannerStopSoftwareTriggerRequest, &type_spec_BarcodeScannerStopSoftwareTriggerRequest, bases.get(), nullptr);
    if (!state->type_BarcodeScannerStopSoftwareTriggerRequest)
    {
        return nullptr;
    }

    state->type_BarcodeScannerStopSoftwareTriggerRequestEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerStopSoftwareTriggerRequestEventArgs, &type_spec_BarcodeScannerStopSoftwareTriggerRequestEventArgs, bases.get(), nullptr);
    if (!state->type_BarcodeScannerStopSoftwareTriggerRequestEventArgs)
    {
        return nullptr;
    }

    state->type_BarcodeScannerVideoFrame = py::register_python_type(module.get(), type_name_BarcodeScannerVideoFrame, &type_spec_BarcodeScannerVideoFrame, bases.get(), nullptr);
    if (!state->type_BarcodeScannerVideoFrame)
    {
        return nullptr;
    }

    state->type_BarcodeSymbologyAttributesBuilder = py::register_python_type(module.get(), type_name_BarcodeSymbologyAttributesBuilder, &type_spec_BarcodeSymbologyAttributesBuilder, bases.get(), nullptr);
