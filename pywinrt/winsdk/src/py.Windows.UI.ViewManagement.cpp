...
namespace py::cpp::Windows::UI::ViewManagement
{
    ...
    static PyObject* register_ApplicationViewBoundsMode(PyObject* module, PyObject* type) noexcept
    {
    ...
    static PyObject* register_ApplicationViewMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ApplicationViewOrientation(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ApplicationViewState(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ApplicationViewSwitchingOptions(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ApplicationViewWindowingMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_FullScreenSystemOverlayMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_HandPreference(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ScreenCaptureDisabledBehavior(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_UIColorType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_UIElementType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_UserInteractionMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ViewSizePreference(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyType_Slot type_slots_ApplicationView_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_ApplicationView_Meta },
        { }
    };

    static PyType_Spec type_spec_ApplicationView_Meta =
    {
        "_winsdk_Windows_UI_ViewManagement.ApplicationView_Meta",
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_ApplicationViewScaling_Meta },
        { }
    };

    static PyType_Spec type_spec_ApplicationViewScaling_Meta =
    {
        "_winsdk_Windows_UI_ViewManagement.ApplicationViewScaling_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_ApplicationViewTransferContext_Meta },
        { }
    };

    static PyType_Spec type_spec_ApplicationViewTransferContext_Meta =
    {
        "_winsdk_Windows_UI_ViewManagement.ApplicationViewTransferContext_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_ProjectionManager_Meta },
        { }
    };

    static PyType_Spec type_spec_ProjectionManager_Meta =
    {
        "_winsdk_Windows_UI_ViewManagement.ProjectionManager_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_ViewManagement(void) noexcept
{
    ...
    state->type_AccessibilitySettings = py::register_python_type(module.get(), type_name_AccessibilitySettings, &type_spec_AccessibilitySettings, bases.get(), nullptr);
    if (!state->type_AccessibilitySettings)
    {
        return nullptr;
    }

    state->type_ActivationViewSwitcher = py::register_python_type(module.get(), type_name_ActivationViewSwitcher, &type_spec_ActivationViewSwitcher, bases.get(), nullptr);
    ...
    state->type_ApplicationView = py::register_python_type(module.get(), type_name_ApplicationView, &type_spec_ApplicationView, bases.get(), reinterpret_cast<PyTypeObject*>(type_ApplicationView_Meta.get()));
    if (!state->type_ApplicationView)
    {
        return nullptr;
    }

    state->type_ApplicationViewConsolidatedEventArgs = py::register_python_type(module.get(), type_name_ApplicationViewConsolidatedEventArgs, &type_spec_ApplicationViewConsolidatedEventArgs, bases.get(), nullptr);
    ...
    state->type_ApplicationViewScaling = py::register_python_type(module.get(), type_name_ApplicationViewScaling, &type_spec_ApplicationViewScaling, bases.get(), reinterpret_cast<PyTypeObject*>(type_ApplicationViewScaling_Meta.get()));
    if (!state->type_ApplicationViewScaling)
    {
        return nullptr;
    }

    state->type_ApplicationViewSwitcher = py::register_python_type(module.get(), type_name_ApplicationViewSwitcher, &type_spec_ApplicationViewSwitcher, nullptr, nullptr);
    if (!state->type_ApplicationViewSwitcher)
    {
        return nullptr;
    }

    state->type_ApplicationViewTitleBar = py::register_python_type(module.get(), type_name_ApplicationViewTitleBar, &type_spec_ApplicationViewTitleBar, bases.get(), nullptr);
    ...
    state->type_ApplicationViewTransferContext = py::register_python_type(module.get(), type_name_ApplicationViewTransferContext, &type_spec_ApplicationViewTransferContext, bases.get(), reinterpret_cast<PyTypeObject*>(type_ApplicationViewTransferContext_Meta.get()));
    if (!state->type_ApplicationViewTransferContext)
    {
        return nullptr;
    }

    state->type_InputPane = py::register_python_type(module.get(), type_name_InputPane, &type_spec_InputPane, bases.get(), nullptr);
    if (!state->type_InputPane)
    {
        return nullptr;
    }

    state->type_InputPaneVisibilityEventArgs = py::register_python_type(module.get(), type_name_InputPaneVisibilityEventArgs, &type_spec_InputPaneVisibilityEventArgs, bases.get(), nullptr);
    ...
    state->type_ProjectionManager = py::register_python_type(module.get(), type_name_ProjectionManager, &type_spec_ProjectionManager, nullptr, reinterpret_cast<PyTypeObject*>(type_ProjectionManager_Meta.get()));
    if (!state->type_ProjectionManager)
    {
        return nullptr;
    }

    state->type_StatusBar = py::register_python_type(module.get(), type_name_StatusBar, &type_spec_StatusBar, bases.get(), nullptr);
    if (!state->type_StatusBar)
    {
        return nullptr;
    }

    state->type_StatusBarProgressIndicator = py::register_python_type(module.get(), type_name_StatusBarProgressIndicator, &type_spec_StatusBarProgressIndicator, bases.get(), nullptr);
    if (!state->type_StatusBarProgressIndicator)
    {
        return nullptr;
    }

    state->type_UISettings = py::register_python_type(module.get(), type_name_UISettings, &type_spec_UISettings, bases.get(), nullptr);
    if (!state->type_UISettings)
    {
        return nullptr;
    }

    state->type_UISettingsAnimationsEnabledChangedEventArgs = py::register_python_type(module.get(), type_name_UISettingsAnimationsEnabledChangedEventArgs, &type_spec_UISettingsAnimationsEnabledChangedEventArgs, bases.get(), nullptr);
    if (!state->type_UISettingsAnimationsEnabledChangedEventArgs)
    {
        return nullptr;
    }

    state->type_UISettingsAutoHideScrollBarsChangedEventArgs = py::register_python_type(module.get(), type_name_UISettingsAutoHideScrollBarsChangedEventArgs, &type_spec_UISettingsAutoHideScrollBarsChangedEventArgs, bases.get(), nullptr);
    if (!state->type_UISettingsAutoHideScrollBarsChangedEventArgs)
    {
        return nullptr;
    }

    state->type_UISettingsMessageDurationChangedEventArgs = py::register_python_type(module.get(), type_name_UISettingsMessageDurationChangedEventArgs, &type_spec_UISettingsMessageDurationChangedEventArgs, bases.get(), nullptr);
    if (!state->type_UISettingsMessageDurationChangedEventArgs)
    {
        return nullptr;
    }

    state->type_UIViewSettings = py::register_python_type(module.get(), type_name_UIViewSettings, &type_spec_UIViewSettings, bases.get(), nullptr);
    if (!state->type_UIViewSettings)
    {
        return nullptr;
    }

    state->type_ViewModePreferences = py::register_python_type(module.get(), type_name_ViewModePreferences, &type_spec_ViewModePreferences, bases.get(), nullptr);
