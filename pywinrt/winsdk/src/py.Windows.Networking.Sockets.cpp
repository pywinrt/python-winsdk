...
namespace py::cpp::Windows::Networking::Sockets
{
    ...
    static PyObject* register_ControlChannelTriggerResetReason(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_ControlChannelTriggerResourceType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ControlChannelTriggerStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_MessageWebSocketReceiveMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SocketActivityConnectedStandbyAction(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SocketActivityKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SocketActivityTriggerReason(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SocketErrorStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SocketMessageType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SocketProtectionLevel(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SocketQualityOfService(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SocketSslErrorSeverity(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_ControlChannelTrigger = "ControlChannelTrigger";
    ...
    constexpr const char* const type_name_DatagramSocket = "DatagramSocket";
    ...
    constexpr const char* const type_name_DatagramSocketControl = "DatagramSocketControl";
    ...
    constexpr const char* const type_name_DatagramSocketInformation = "DatagramSocketInformation";
    ...
    constexpr const char* const type_name_DatagramSocketMessageReceivedEventArgs = "DatagramSocketMessageReceivedEventArgs";
    ...
    constexpr const char* const type_name_MessageWebSocket = "MessageWebSocket";
    ...
    constexpr const char* const type_name_MessageWebSocketControl = "MessageWebSocketControl";
    ...
    constexpr const char* const type_name_MessageWebSocketInformation = "MessageWebSocketInformation";
    ...
    constexpr const char* const type_name_MessageWebSocketMessageReceivedEventArgs = "MessageWebSocketMessageReceivedEventArgs";
    ...
    constexpr const char* const type_name_ServerMessageWebSocket = "ServerMessageWebSocket";
    ...
    constexpr const char* const type_name_ServerMessageWebSocketControl = "ServerMessageWebSocketControl";
    ...
    constexpr const char* const type_name_ServerMessageWebSocketInformation = "ServerMessageWebSocketInformation";
    ...
    constexpr const char* const type_name_ServerStreamWebSocket = "ServerStreamWebSocket";
    ...
    constexpr const char* const type_name_ServerStreamWebSocketInformation = "ServerStreamWebSocketInformation";
    ...
    constexpr const char* const type_name_SocketActivityContext = "SocketActivityContext";
    ...
    constexpr const char* const type_name_SocketActivityInformation = "SocketActivityInformation";
    ...
    constexpr const char* const type_name_SocketActivityTriggerDetails = "SocketActivityTriggerDetails";
    ...
    // ----- SocketError class --------------------
    constexpr const char* const type_name_SocketError = "SocketError";
    ...
    // ----- StreamSocket class --------------------
    constexpr const char* const type_name_StreamSocket = "StreamSocket";
    ...
    constexpr const char* const type_name_StreamSocketControl = "StreamSocketControl";
    ...
    constexpr const char* const type_name_StreamSocketInformation = "StreamSocketInformation";
    ...
    constexpr const char* const type_name_StreamSocketListener = "StreamSocketListener";
    ...
    constexpr const char* const type_name_StreamSocketListenerConnectionReceivedEventArgs = "StreamSocketListenerConnectionReceivedEventArgs";
    ...
    constexpr const char* const type_name_StreamSocketListenerControl = "StreamSocketListenerControl";
    ...
    constexpr const char* const type_name_StreamSocketListenerInformation = "StreamSocketListenerInformation";
    ...
    constexpr const char* const type_name_StreamWebSocket = "StreamWebSocket";
    ...
    constexpr const char* const type_name_StreamWebSocketControl = "StreamWebSocketControl";
    ...
    constexpr const char* const type_name_StreamWebSocketInformation = "StreamWebSocketInformation";
    ...
    constexpr const char* const type_name_WebSocketClosedEventArgs = "WebSocketClosedEventArgs";
    ...
    constexpr const char* const type_name_WebSocketError = "WebSocketError";
    ...
    constexpr const char* const type_name_WebSocketKeepAlive = "WebSocketKeepAlive";
    ...
    constexpr const char* const type_name_WebSocketServerCustomValidationRequestedEventArgs = "WebSocketServerCustomValidationRequestedEventArgs";
    ...
    constexpr const char* const type_name_IControlChannelTriggerEventDetails = "IControlChannelTriggerEventDetails";
    ...
    constexpr const char* const type_name_IControlChannelTriggerResetEventDetails = "IControlChannelTriggerResetEventDetails";
    ...
    constexpr const char* const type_name_IWebSocket = "IWebSocket";
    ...
    constexpr const char* const type_name_IWebSocketControl = "IWebSocketControl";
    ...
    constexpr const char* const type_name_IWebSocketControl2 = "IWebSocketControl2";
    ...
    constexpr const char* const type_name_IWebSocketInformation = "IWebSocketInformation";
    ...
    constexpr const char* const type_name_IWebSocketInformation2 = "IWebSocketInformation2";
    ...
    constexpr const char* const type_name_BandwidthStatistics = "BandwidthStatistics";
    ...
    constexpr const char* const type_name_RoundTripTimeStatistics = "RoundTripTimeStatistics";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Networking_Sockets(void) noexcept
{
    ...
    state->type_ControlChannelTrigger = py::register_python_type(module.get(), type_name_ControlChannelTrigger, &type_spec_ControlChannelTrigger, bases.get());
    if (!state->type_ControlChannelTrigger)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ControlChannelTrigger);

    state->type_DatagramSocket = py::register_python_type(module.get(), type_name_DatagramSocket, &type_spec_DatagramSocket, bases.get());
    if (!state->type_DatagramSocket)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DatagramSocket);

    state->type_DatagramSocketControl = py::register_python_type(module.get(), type_name_DatagramSocketControl, &type_spec_DatagramSocketControl, bases.get());
    if (!state->type_DatagramSocketControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DatagramSocketControl);

    state->type_DatagramSocketInformation = py::register_python_type(module.get(), type_name_DatagramSocketInformation, &type_spec_DatagramSocketInformation, bases.get());
    if (!state->type_DatagramSocketInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DatagramSocketInformation);

    state->type_DatagramSocketMessageReceivedEventArgs = py::register_python_type(module.get(), type_name_DatagramSocketMessageReceivedEventArgs, &type_spec_DatagramSocketMessageReceivedEventArgs, bases.get());
    if (!state->type_DatagramSocketMessageReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DatagramSocketMessageReceivedEventArgs);

    state->type_MessageWebSocket = py::register_python_type(module.get(), type_name_MessageWebSocket, &type_spec_MessageWebSocket, bases.get());
    if (!state->type_MessageWebSocket)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MessageWebSocket);

    state->type_MessageWebSocketControl = py::register_python_type(module.get(), type_name_MessageWebSocketControl, &type_spec_MessageWebSocketControl, bases.get());
    if (!state->type_MessageWebSocketControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MessageWebSocketControl);

    state->type_MessageWebSocketInformation = py::register_python_type(module.get(), type_name_MessageWebSocketInformation, &type_spec_MessageWebSocketInformation, bases.get());
    if (!state->type_MessageWebSocketInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MessageWebSocketInformation);

    state->type_MessageWebSocketMessageReceivedEventArgs = py::register_python_type(module.get(), type_name_MessageWebSocketMessageReceivedEventArgs, &type_spec_MessageWebSocketMessageReceivedEventArgs, bases.get());
    if (!state->type_MessageWebSocketMessageReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_MessageWebSocketMessageReceivedEventArgs);

    state->type_ServerMessageWebSocket = py::register_python_type(module.get(), type_name_ServerMessageWebSocket, &type_spec_ServerMessageWebSocket, bases.get());
    if (!state->type_ServerMessageWebSocket)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ServerMessageWebSocket);

    state->type_ServerMessageWebSocketControl = py::register_python_type(module.get(), type_name_ServerMessageWebSocketControl, &type_spec_ServerMessageWebSocketControl, bases.get());
    if (!state->type_ServerMessageWebSocketControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ServerMessageWebSocketControl);

    state->type_ServerMessageWebSocketInformation = py::register_python_type(module.get(), type_name_ServerMessageWebSocketInformation, &type_spec_ServerMessageWebSocketInformation, bases.get());
    if (!state->type_ServerMessageWebSocketInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ServerMessageWebSocketInformation);

    state->type_ServerStreamWebSocket = py::register_python_type(module.get(), type_name_ServerStreamWebSocket, &type_spec_ServerStreamWebSocket, bases.get());
    if (!state->type_ServerStreamWebSocket)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ServerStreamWebSocket);

    state->type_ServerStreamWebSocketInformation = py::register_python_type(module.get(), type_name_ServerStreamWebSocketInformation, &type_spec_ServerStreamWebSocketInformation, bases.get());
    if (!state->type_ServerStreamWebSocketInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ServerStreamWebSocketInformation);

    state->type_SocketActivityContext = py::register_python_type(module.get(), type_name_SocketActivityContext, &type_spec_SocketActivityContext, bases.get());
    if (!state->type_SocketActivityContext)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SocketActivityContext);

    state->type_SocketActivityInformation = py::register_python_type(module.get(), type_name_SocketActivityInformation, &type_spec_SocketActivityInformation, bases.get());
    if (!state->type_SocketActivityInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SocketActivityInformation);

    state->type_SocketActivityTriggerDetails = py::register_python_type(module.get(), type_name_SocketActivityTriggerDetails, &type_spec_SocketActivityTriggerDetails, bases.get());
    if (!state->type_SocketActivityTriggerDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SocketActivityTriggerDetails);

    state->type_SocketError = py::register_python_type(module.get(), type_name_SocketError, &type_spec_SocketError, nullptr);
    if (!state->type_SocketError)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SocketError);

    state->type_StreamSocket = py::register_python_type(module.get(), type_name_StreamSocket, &type_spec_StreamSocket, bases.get());
    if (!state->type_StreamSocket)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StreamSocket);

    state->type_StreamSocketControl = py::register_python_type(module.get(), type_name_StreamSocketControl, &type_spec_StreamSocketControl, bases.get());
    if (!state->type_StreamSocketControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StreamSocketControl);

    state->type_StreamSocketInformation = py::register_python_type(module.get(), type_name_StreamSocketInformation, &type_spec_StreamSocketInformation, bases.get());
    if (!state->type_StreamSocketInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StreamSocketInformation);

    state->type_StreamSocketListener = py::register_python_type(module.get(), type_name_StreamSocketListener, &type_spec_StreamSocketListener, bases.get());
    if (!state->type_StreamSocketListener)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StreamSocketListener);

    state->type_StreamSocketListenerConnectionReceivedEventArgs = py::register_python_type(module.get(), type_name_StreamSocketListenerConnectionReceivedEventArgs, &type_spec_StreamSocketListenerConnectionReceivedEventArgs, bases.get());
    if (!state->type_StreamSocketListenerConnectionReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StreamSocketListenerConnectionReceivedEventArgs);

    state->type_StreamSocketListenerControl = py::register_python_type(module.get(), type_name_StreamSocketListenerControl, &type_spec_StreamSocketListenerControl, bases.get());
    if (!state->type_StreamSocketListenerControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StreamSocketListenerControl);

    state->type_StreamSocketListenerInformation = py::register_python_type(module.get(), type_name_StreamSocketListenerInformation, &type_spec_StreamSocketListenerInformation, bases.get());
    if (!state->type_StreamSocketListenerInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StreamSocketListenerInformation);

    state->type_StreamWebSocket = py::register_python_type(module.get(), type_name_StreamWebSocket, &type_spec_StreamWebSocket, bases.get());
    if (!state->type_StreamWebSocket)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StreamWebSocket);

    state->type_StreamWebSocketControl = py::register_python_type(module.get(), type_name_StreamWebSocketControl, &type_spec_StreamWebSocketControl, bases.get());
    if (!state->type_StreamWebSocketControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StreamWebSocketControl);

    state->type_StreamWebSocketInformation = py::register_python_type(module.get(), type_name_StreamWebSocketInformation, &type_spec_StreamWebSocketInformation, bases.get());
    if (!state->type_StreamWebSocketInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StreamWebSocketInformation);

    state->type_WebSocketClosedEventArgs = py::register_python_type(module.get(), type_name_WebSocketClosedEventArgs, &type_spec_WebSocketClosedEventArgs, bases.get());
    if (!state->type_WebSocketClosedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WebSocketClosedEventArgs);

    state->type_WebSocketError = py::register_python_type(module.get(), type_name_WebSocketError, &type_spec_WebSocketError, nullptr);
    if (!state->type_WebSocketError)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WebSocketError);

    state->type_WebSocketKeepAlive = py::register_python_type(module.get(), type_name_WebSocketKeepAlive, &type_spec_WebSocketKeepAlive, bases.get());
    if (!state->type_WebSocketKeepAlive)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WebSocketKeepAlive);

    state->type_WebSocketServerCustomValidationRequestedEventArgs = py::register_python_type(module.get(), type_name_WebSocketServerCustomValidationRequestedEventArgs, &type_spec_WebSocketServerCustomValidationRequestedEventArgs, bases.get());
    if (!state->type_WebSocketServerCustomValidationRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_WebSocketServerCustomValidationRequestedEventArgs);

    state->type_IControlChannelTriggerEventDetails = py::register_python_type(module.get(), type_name_IControlChannelTriggerEventDetails, &type_spec_IControlChannelTriggerEventDetails, bases.get());
    if (!state->type_IControlChannelTriggerEventDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IControlChannelTriggerEventDetails);

    state->type_IControlChannelTriggerResetEventDetails = py::register_python_type(module.get(), type_name_IControlChannelTriggerResetEventDetails, &type_spec_IControlChannelTriggerResetEventDetails, bases.get());
    if (!state->type_IControlChannelTriggerResetEventDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IControlChannelTriggerResetEventDetails);

    state->type_IWebSocket = py::register_python_type(module.get(), type_name_IWebSocket, &type_spec_IWebSocket, bases.get());
    if (!state->type_IWebSocket)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IWebSocket);

    state->type_IWebSocketControl = py::register_python_type(module.get(), type_name_IWebSocketControl, &type_spec_IWebSocketControl, bases.get());
    if (!state->type_IWebSocketControl)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IWebSocketControl);

    state->type_IWebSocketControl2 = py::register_python_type(module.get(), type_name_IWebSocketControl2, &type_spec_IWebSocketControl2, bases.get());
    if (!state->type_IWebSocketControl2)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IWebSocketControl2);

    state->type_IWebSocketInformation = py::register_python_type(module.get(), type_name_IWebSocketInformation, &type_spec_IWebSocketInformation, bases.get());
    if (!state->type_IWebSocketInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IWebSocketInformation);

    state->type_IWebSocketInformation2 = py::register_python_type(module.get(), type_name_IWebSocketInformation2, &type_spec_IWebSocketInformation2, bases.get());
    if (!state->type_IWebSocketInformation2)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IWebSocketInformation2);

    state->type_BandwidthStatistics = py::register_python_type(module.get(), type_name_BandwidthStatistics, &type_spec_BandwidthStatistics, bases.get());
    if (!state->type_BandwidthStatistics)
    {
        return nullptr;
    }

    Py_INCREF(state->type_BandwidthStatistics);

    state->type_RoundTripTimeStatistics = py::register_python_type(module.get(), type_name_RoundTripTimeStatistics, &type_spec_RoundTripTimeStatistics, bases.get());
    if (!state->type_RoundTripTimeStatistics)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RoundTripTimeStatistics);
