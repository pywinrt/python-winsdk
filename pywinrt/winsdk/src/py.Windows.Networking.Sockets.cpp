...
winrt::Windows::Networking::Sockets::BandwidthStatistics py::converter<winrt::Windows::Networking::Sockets::BandwidthStatistics>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Networking::Sockets::BandwidthStatistics or dict");
    ...
    if (!py_OutboundBitsPerSecond) {
        PyErr_SetString(PyExc_KeyError, "OutboundBitsPerSecond");
        throw python_exception();
    }
    ...
    if (!py_InboundBitsPerSecond) {
        PyErr_SetString(PyExc_KeyError, "InboundBitsPerSecond");
        throw python_exception();
    }
    ...
    if (!py_OutboundBitsPerSecondInstability) {
        PyErr_SetString(PyExc_KeyError, "OutboundBitsPerSecondInstability");
        throw python_exception();
    }
    ...
    if (!py_InboundBitsPerSecondInstability) {
        PyErr_SetString(PyExc_KeyError, "InboundBitsPerSecondInstability");
        throw python_exception();
    }
    ...
    if (!py_OutboundBandwidthPeaked) {
        PyErr_SetString(PyExc_KeyError, "OutboundBandwidthPeaked");
        throw python_exception();
    }
    ...
    if (!py_InboundBandwidthPeaked) {
        PyErr_SetString(PyExc_KeyError, "InboundBandwidthPeaked");
        throw python_exception();
    }
...
winrt::Windows::Networking::Sockets::RoundTripTimeStatistics py::converter<winrt::Windows::Networking::Sockets::RoundTripTimeStatistics>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Networking::Sockets::RoundTripTimeStatistics or dict");
        throw python_exception();
    }
    ...
    if (!py_Variance) {
        PyErr_SetString(PyExc_KeyError, "Variance");
        throw python_exception();
    }
    ...
    if (!py_Max) {
        PyErr_SetString(PyExc_KeyError, "Max");
        throw python_exception();
    }
    ...
    if (!py_Min) {
        PyErr_SetString(PyExc_KeyError, "Min");
        throw python_exception();
    }
    ...
    if (!py_Sum) {
        PyErr_SetString(PyExc_KeyError, "Sum");
        throw python_exception();
    }
