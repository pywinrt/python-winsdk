...
winrt::Windows::Graphics::Printing::PrintPageDescription py::converter<winrt::Windows::Graphics::Printing::PrintPageDescription>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Graphics::Printing::PrintPageDescription or dict");
    ...
    if (!py_PageSize) {
        PyErr_SetString(PyExc_KeyError, "PageSize");
        throw python_exception();
    }
    ...
    if (!py_ImageableRect) {
        PyErr_SetString(PyExc_KeyError, "ImageableRect");
        throw python_exception();
    }
    ...
    if (!py_DpiX) {
        PyErr_SetString(PyExc_KeyError, "DpiX");
        throw python_exception();
    }
    ...
    if (!py_DpiY) {
        PyErr_SetString(PyExc_KeyError, "DpiY");
        throw python_exception();
    }
