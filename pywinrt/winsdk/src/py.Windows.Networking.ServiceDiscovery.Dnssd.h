...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::ServiceDiscovery::Dnssd::DnssdRegistrationStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceWatcherStatus> = "i";
