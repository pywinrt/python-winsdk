...
winrt::Windows::Networking::NetworkOperators::ESimProfileInstallProgress py::converter<winrt::Windows::Networking::NetworkOperators::ESimProfileInstallProgress>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Networking::NetworkOperators::ESimProfileInstallProgress or dict");
    ...
    if (!py_TotalSizeInBytes) {
        PyErr_SetString(PyExc_KeyError, "TotalSizeInBytes");
        throw python_exception();
    }
    ...
    if (!py_InstalledSizeInBytes) {
        PyErr_SetString(PyExc_KeyError, "InstalledSizeInBytes");
        throw python_exception();
    }
...
winrt::Windows::Networking::NetworkOperators::ProfileUsage py::converter<winrt::Windows::Networking::NetworkOperators::ProfileUsage>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Networking::NetworkOperators::ProfileUsage or dict");
        throw python_exception();
    }
    ...
    if (!py_UsageInMegabytes) {
        PyErr_SetString(PyExc_KeyError, "UsageInMegabytes");
        throw python_exception();
    }
    ...
    if (!py_LastSyncTime) {
        PyErr_SetString(PyExc_KeyError, "LastSyncTime");
        throw python_exception();
    }
