...
namespace py::cpp::Windows::Phone::System
{
    ...
    constexpr const char* const type_name_SystemProtection = "SystemProtection";
    ...
    static PyMethodDef _methods_SystemProtection[] = {
        ...
        { "get_screen_locked", reinterpret_cast<PyCFunction>(SystemProtection_get_ScreenLocked), METH_NOARGS | METH_STATIC, nullptr },
        { }
    };
    ...
    {
        { Py_tp_new, _new_SystemProtection },
        { Py_tp_methods, _methods_SystemProtection },
        { Py_tp_getset, _getset_SystemProtection },
        { },
    };
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Phone_System(void) noexcept
{
    ...
    state->type_SystemProtection = py::register_python_type(module.get(), type_name_SystemProtection, &type_spec_SystemProtection, nullptr);
    if (!state->type_SystemProtection)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemProtection);
