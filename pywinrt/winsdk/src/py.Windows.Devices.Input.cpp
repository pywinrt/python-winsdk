...
winrt::Windows::Devices::Input::MouseDelta py::converter<winrt::Windows::Devices::Input::MouseDelta>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Devices::Input::MouseDelta or dict");
...
winrt::Windows::Devices::Input::PointerDeviceUsage py::converter<winrt::Windows::Devices::Input::PointerDeviceUsage>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Devices::Input::PointerDeviceUsage or dict");
        throw python_exception();
    }
    ...
    if (!py_UsagePage) {
        PyErr_SetString(PyExc_KeyError, "UsagePage");
        throw python_exception();
    }
    ...
    if (!py_Usage) {
        PyErr_SetString(PyExc_KeyError, "Usage");
        throw python_exception();
    }
    ...
    if (!py_MinLogical) {
        PyErr_SetString(PyExc_KeyError, "MinLogical");
        throw python_exception();
    }
    ...
    if (!py_MaxLogical) {
        PyErr_SetString(PyExc_KeyError, "MaxLogical");
        throw python_exception();
    }
    ...
    if (!py_MinPhysical) {
        PyErr_SetString(PyExc_KeyError, "MinPhysical");
        throw python_exception();
    }
    ...
    if (!py_MaxPhysical) {
        PyErr_SetString(PyExc_KeyError, "MaxPhysical");
        throw python_exception();
    }
    ...
    if (!py_PhysicalMultiplier) {
        PyErr_SetString(PyExc_KeyError, "PhysicalMultiplier");
        throw python_exception();
    }
