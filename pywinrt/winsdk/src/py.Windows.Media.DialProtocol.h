...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::DialProtocol::DialAppLaunchResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::DialProtocol::DialAppState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::DialProtocol::DialAppStopResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::DialProtocol::DialDeviceDisplayStatus> = "i";
