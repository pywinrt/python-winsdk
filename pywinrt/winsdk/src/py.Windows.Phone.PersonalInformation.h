...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Phone::PersonalInformation::ContactChangeType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Phone::PersonalInformation::ContactQueryResultOrdering> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Phone::PersonalInformation::ContactStoreApplicationAccessMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Phone::PersonalInformation::ContactStoreSystemAccessMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Phone::PersonalInformation::VCardFormat> = "i";
