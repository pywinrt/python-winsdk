...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Power::BatteryStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Power::EnergySaverStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::System::Power::PowerSupplyStatus> = "i";
