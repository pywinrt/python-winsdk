...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Gpio::GpioChangePolarity> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Gpio::GpioOpenStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Gpio::GpioPinDriveMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Gpio::GpioPinEdge> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Gpio::GpioPinValue> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Gpio::GpioSharingMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Gpio::GpioChangeCount> = "T{Q:count:T{q:duration:}:relative_time:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Gpio::GpioChangeRecord> = "T{T{q:duration:}:relative_time:i:edge:}";
