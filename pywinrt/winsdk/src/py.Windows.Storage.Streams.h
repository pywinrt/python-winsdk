...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Streams::ByteOrder> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Streams::FileOpenDisposition> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Streams::InputStreamOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Streams::UnicodeEncoding> = "i";
