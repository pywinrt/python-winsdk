...
namespace py::cpp::Windows::ApplicationModel::AppService
{
    ...
    static PyObject* register_AppServiceClosedStatus(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_AppServiceConnectionStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppServiceResponseStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StatelessAppServiceResponseStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_AppServiceCatalog = "AppServiceCatalog";
    ...
    constexpr const char* const type_name_AppServiceClosedEventArgs = "AppServiceClosedEventArgs";
    ...
    constexpr const char* const type_name_AppServiceConnection = "AppServiceConnection";
    ...
    constexpr const char* const type_name_AppServiceDeferral = "AppServiceDeferral";
    ...
    constexpr const char* const type_name_AppServiceRequest = "AppServiceRequest";
    ...
    constexpr const char* const type_name_AppServiceRequestReceivedEventArgs = "AppServiceRequestReceivedEventArgs";
    ...
    constexpr const char* const type_name_AppServiceResponse = "AppServiceResponse";
    ...
    constexpr const char* const type_name_AppServiceTriggerDetails = "AppServiceTriggerDetails";
    ...
    constexpr const char* const type_name_StatelessAppServiceResponse = "StatelessAppServiceResponse";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_AppService(void) noexcept
{
    ...
    state->type_AppServiceCatalog = py::register_python_type(module.get(), type_name_AppServiceCatalog, &type_spec_AppServiceCatalog, nullptr);
    if (!state->type_AppServiceCatalog)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppServiceCatalog);

    state->type_AppServiceClosedEventArgs = py::register_python_type(module.get(), type_name_AppServiceClosedEventArgs, &type_spec_AppServiceClosedEventArgs, bases.get());
    if (!state->type_AppServiceClosedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppServiceClosedEventArgs);

    state->type_AppServiceConnection = py::register_python_type(module.get(), type_name_AppServiceConnection, &type_spec_AppServiceConnection, bases.get());
    if (!state->type_AppServiceConnection)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppServiceConnection);

    state->type_AppServiceDeferral = py::register_python_type(module.get(), type_name_AppServiceDeferral, &type_spec_AppServiceDeferral, bases.get());
    if (!state->type_AppServiceDeferral)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppServiceDeferral);

    state->type_AppServiceRequest = py::register_python_type(module.get(), type_name_AppServiceRequest, &type_spec_AppServiceRequest, bases.get());
    if (!state->type_AppServiceRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppServiceRequest);

    state->type_AppServiceRequestReceivedEventArgs = py::register_python_type(module.get(), type_name_AppServiceRequestReceivedEventArgs, &type_spec_AppServiceRequestReceivedEventArgs, bases.get());
    if (!state->type_AppServiceRequestReceivedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppServiceRequestReceivedEventArgs);

    state->type_AppServiceResponse = py::register_python_type(module.get(), type_name_AppServiceResponse, &type_spec_AppServiceResponse, bases.get());
    if (!state->type_AppServiceResponse)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppServiceResponse);

    state->type_AppServiceTriggerDetails = py::register_python_type(module.get(), type_name_AppServiceTriggerDetails, &type_spec_AppServiceTriggerDetails, bases.get());
    if (!state->type_AppServiceTriggerDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppServiceTriggerDetails);

    state->type_StatelessAppServiceResponse = py::register_python_type(module.get(), type_name_StatelessAppServiceResponse, &type_spec_StatelessAppServiceResponse, bases.get());
    if (!state->type_StatelessAppServiceResponse)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StatelessAppServiceResponse);
