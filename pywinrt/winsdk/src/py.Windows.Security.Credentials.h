...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Credentials::KeyCredentialAttestationStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Credentials::KeyCredentialCreationOption> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Credentials::KeyCredentialStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Credentials::WebAccountPictureSize> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Credentials::WebAccountState> = "i";
