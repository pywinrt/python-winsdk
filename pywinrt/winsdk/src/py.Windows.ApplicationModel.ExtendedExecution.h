...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::ExtendedExecution::ExtendedExecutionReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::ExtendedExecution::ExtendedExecutionResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::ExtendedExecution::ExtendedExecutionRevokedReason> = "i";
