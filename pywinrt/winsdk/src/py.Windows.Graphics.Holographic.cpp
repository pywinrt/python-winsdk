...
winrt::Windows::Graphics::Holographic::HolographicAdapterId py::converter<winrt::Windows::Graphics::Holographic::HolographicAdapterId>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Graphics::Holographic::HolographicAdapterId or dict");
    ...
    if (!py_LowPart) {
        PyErr_SetString(PyExc_KeyError, "LowPart");
        throw python_exception();
    }
    ...
    if (!py_HighPart) {
        PyErr_SetString(PyExc_KeyError, "HighPart");
        throw python_exception();
    }
...
winrt::Windows::Graphics::Holographic::HolographicFrameId py::converter<winrt::Windows::Graphics::Holographic::HolographicFrameId>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Graphics::Holographic::HolographicFrameId or dict");
        throw python_exception();
    }
...
winrt::Windows::Graphics::Holographic::HolographicStereoTransform py::converter<winrt::Windows::Graphics::Holographic::HolographicStereoTransform>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Graphics::Holographic::HolographicStereoTransform or dict");
        throw python_exception();
    }
...
PyMODINIT_FUNC
PyInit__winsdk_Windows_Graphics_Holographic (void) noexcept
{
