...
namespace py::cpp::Windows::Gaming::Input::Custom
{
    ...
    static PyObject* register_GipFirmwareUpdateStatus(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_GipMessageClass(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_XusbDeviceSubtype(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_XusbDeviceType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_GameControllerFactoryManager = "GameControllerFactoryManager";
    ...
    constexpr const char* const type_name_GipFirmwareUpdateResult = "GipFirmwareUpdateResult";
    ...
    constexpr const char* const type_name_GipGameControllerProvider = "GipGameControllerProvider";
    ...
    static PyObject* GipGameControllerProvider_SendReceiveMessage(py::wrapper::Windows::Gaming::Input::Custom::GipGameControllerProvider* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 4)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Gaming.Input.Custom.GipGameControllerProvider", L"SendReceiveMessage", 4))
            {
    ...
    constexpr const char* const type_name_HidGameControllerProvider = "HidGameControllerProvider";
    ...
    static PyObject* HidGameControllerProvider_GetFeatureReport(py::wrapper::Windows::Gaming::Input::Custom::HidGameControllerProvider* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Gaming.Input.Custom.HidGameControllerProvider", L"GetFeatureReport", 2))
            {
                PyErr_SetString(PyExc_AttributeError, "method 2 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    constexpr const char* const type_name_XusbGameControllerProvider = "XusbGameControllerProvider";
    ...
    constexpr const char* const type_name_ICustomGameControllerFactory = "ICustomGameControllerFactory";
    ...
    constexpr const char* const type_name_IGameControllerInputSink = "IGameControllerInputSink";
    ...
    constexpr const char* const type_name_IGameControllerProvider = "IGameControllerProvider";
    ...
    constexpr const char* const type_name_IGipGameControllerInputSink = "IGipGameControllerInputSink";
    ...
    constexpr const char* const type_name_IHidGameControllerInputSink = "IHidGameControllerInputSink";
    ...
    constexpr const char* const type_name_IXusbGameControllerInputSink = "IXusbGameControllerInputSink";
    ...
    constexpr const char* const type_name_GameControllerVersionInfo = "GameControllerVersionInfo";
    ...
    constexpr const char* const type_name_GipFirmwareUpdateProgress = "GipFirmwareUpdateProgress";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Gaming_Input_Custom(void) noexcept
{
    ...
    state->type_GameControllerFactoryManager = py::register_python_type(module.get(), type_name_GameControllerFactoryManager, &type_spec_GameControllerFactoryManager, nullptr);
    if (!state->type_GameControllerFactoryManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameControllerFactoryManager);

    state->type_GipFirmwareUpdateResult = py::register_python_type(module.get(), type_name_GipFirmwareUpdateResult, &type_spec_GipFirmwareUpdateResult, bases.get());
    if (!state->type_GipFirmwareUpdateResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GipFirmwareUpdateResult);

    state->type_GipGameControllerProvider = py::register_python_type(module.get(), type_name_GipGameControllerProvider, &type_spec_GipGameControllerProvider, bases.get());
    if (!state->type_GipGameControllerProvider)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GipGameControllerProvider);

    state->type_HidGameControllerProvider = py::register_python_type(module.get(), type_name_HidGameControllerProvider, &type_spec_HidGameControllerProvider, bases.get());
    if (!state->type_HidGameControllerProvider)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HidGameControllerProvider);

    state->type_XusbGameControllerProvider = py::register_python_type(module.get(), type_name_XusbGameControllerProvider, &type_spec_XusbGameControllerProvider, bases.get());
    if (!state->type_XusbGameControllerProvider)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XusbGameControllerProvider);

    state->type_ICustomGameControllerFactory = py::register_python_type(module.get(), type_name_ICustomGameControllerFactory, &type_spec_ICustomGameControllerFactory, bases.get());
    if (!state->type_ICustomGameControllerFactory)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ICustomGameControllerFactory);

    state->type_IGameControllerInputSink = py::register_python_type(module.get(), type_name_IGameControllerInputSink, &type_spec_IGameControllerInputSink, bases.get());
    if (!state->type_IGameControllerInputSink)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IGameControllerInputSink);

    state->type_IGameControllerProvider = py::register_python_type(module.get(), type_name_IGameControllerProvider, &type_spec_IGameControllerProvider, bases.get());
    if (!state->type_IGameControllerProvider)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IGameControllerProvider);

    state->type_IGipGameControllerInputSink = py::register_python_type(module.get(), type_name_IGipGameControllerInputSink, &type_spec_IGipGameControllerInputSink, bases.get());
    if (!state->type_IGipGameControllerInputSink)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IGipGameControllerInputSink);

    state->type_IHidGameControllerInputSink = py::register_python_type(module.get(), type_name_IHidGameControllerInputSink, &type_spec_IHidGameControllerInputSink, bases.get());
    if (!state->type_IHidGameControllerInputSink)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IHidGameControllerInputSink);

    state->type_IXusbGameControllerInputSink = py::register_python_type(module.get(), type_name_IXusbGameControllerInputSink, &type_spec_IXusbGameControllerInputSink, bases.get());
    if (!state->type_IXusbGameControllerInputSink)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IXusbGameControllerInputSink);

    state->type_GameControllerVersionInfo = py::register_python_type(module.get(), type_name_GameControllerVersionInfo, &type_spec_GameControllerVersionInfo, bases.get());
    if (!state->type_GameControllerVersionInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GameControllerVersionInfo);

    state->type_GipFirmwareUpdateProgress = py::register_python_type(module.get(), type_name_GipFirmwareUpdateProgress, &type_spec_GipFirmwareUpdateProgress, bases.get());
    if (!state->type_GipFirmwareUpdateProgress)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GipFirmwareUpdateProgress);
