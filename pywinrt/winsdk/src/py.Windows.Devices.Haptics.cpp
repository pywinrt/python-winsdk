...
namespace py::cpp::Windows::Devices::Haptics
{
    ...
    static PyType_Slot type_slots_KnownSimpleHapticsControllerWaveforms_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_KnownSimpleHapticsControllerWaveforms_Meta },
        { }
    };

    static PyType_Spec type_spec_KnownSimpleHapticsControllerWaveforms_Meta =
    {
        "_winsdk_Windows_Devices_Haptics.KnownSimpleHapticsControllerWaveforms_Meta",
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Haptics(void) noexcept
{
    ...
    state->type_KnownSimpleHapticsControllerWaveforms = py::register_python_type(module.get(), type_name_KnownSimpleHapticsControllerWaveforms, &type_spec_KnownSimpleHapticsControllerWaveforms, nullptr, reinterpret_cast<PyTypeObject*>(type_KnownSimpleHapticsControllerWaveforms_Meta.get()));
    if (!state->type_KnownSimpleHapticsControllerWaveforms)
    {
        return nullptr;
    }

    state->type_SimpleHapticsController = py::register_python_type(module.get(), type_name_SimpleHapticsController, &type_spec_SimpleHapticsController, bases.get(), nullptr);
    if (!state->type_SimpleHapticsController)
    {
        return nullptr;
    }

    state->type_SimpleHapticsControllerFeedback = py::register_python_type(module.get(), type_name_SimpleHapticsControllerFeedback, &type_spec_SimpleHapticsControllerFeedback, bases.get(), nullptr);
    if (!state->type_SimpleHapticsControllerFeedback)
    {
        return nullptr;
    }

    state->type_VibrationDevice = py::register_python_type(module.get(), type_name_VibrationDevice, &type_spec_VibrationDevice, bases.get(), nullptr);
