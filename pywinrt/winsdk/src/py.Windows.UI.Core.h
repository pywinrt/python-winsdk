...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::AppViewBackButtonVisibility> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CoreAcceleratorKeyEventType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CoreCursorType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CoreDispatcherPriority> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CoreIndependentInputFilters> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CoreInputDeviceTypes> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CoreProcessEventsOption> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CoreProximityEvaluationScore> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CoreVirtualKeyStates> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CoreWindowActivationMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CoreWindowActivationState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CoreWindowFlowDirection> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CorePhysicalKeyStatus> = "T{I:repeat_count:I:scan_code:?:is_extended_key:?:is_menu_key_down:?:was_key_down:?:is_key_released:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::CoreProximityEvaluation> = "T{i:score:T{f:x:f:y:}:adjusted_point:}";
