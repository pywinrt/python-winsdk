...
namespace py::cpp::Windows::System::Diagnostics::TraceReporting
{
    ...
    static PyObject* register_PlatformDiagnosticActionState(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_PlatformDiagnosticEscalationType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PlatformDiagnosticEventBufferLatencies(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PlatformDiagnosticTracePriority(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PlatformDiagnosticTraceSlotState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PlatformDiagnosticTraceSlotType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_PlatformDiagnosticActions = "PlatformDiagnosticActions";
    ...
    constexpr const char* const type_name_PlatformDiagnosticTraceInfo = "PlatformDiagnosticTraceInfo";
    ...
    constexpr const char* const type_name_PlatformDiagnosticTraceRuntimeInfo = "PlatformDiagnosticTraceRuntimeInfo";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_System_Diagnostics_TraceReporting(void) noexcept
{
    ...
    state->type_PlatformDiagnosticActions = py::register_python_type(module.get(), type_name_PlatformDiagnosticActions, &type_spec_PlatformDiagnosticActions, nullptr);
    if (!state->type_PlatformDiagnosticActions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlatformDiagnosticActions);

    state->type_PlatformDiagnosticTraceInfo = py::register_python_type(module.get(), type_name_PlatformDiagnosticTraceInfo, &type_spec_PlatformDiagnosticTraceInfo, bases.get());
    if (!state->type_PlatformDiagnosticTraceInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlatformDiagnosticTraceInfo);

    state->type_PlatformDiagnosticTraceRuntimeInfo = py::register_python_type(module.get(), type_name_PlatformDiagnosticTraceRuntimeInfo, &type_spec_PlatformDiagnosticTraceRuntimeInfo, bases.get());
    if (!state->type_PlatformDiagnosticTraceRuntimeInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PlatformDiagnosticTraceRuntimeInfo);
