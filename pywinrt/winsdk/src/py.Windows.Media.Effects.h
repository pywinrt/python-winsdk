...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Effects::AudioEffectType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Effects::MediaEffectClosedReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Effects::MediaMemoryTypes> = "i";
