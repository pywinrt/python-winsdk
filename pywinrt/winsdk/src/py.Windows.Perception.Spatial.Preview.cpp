...
PyMODINIT_FUNC PyInit__winsdk_Windows_Perception_Spatial_Preview(void) noexcept
{
    ...
    state->type_SpatialGraphInteropFrameOfReferencePreview = py::register_python_type(module.get(), type_name_SpatialGraphInteropFrameOfReferencePreview, &type_spec_SpatialGraphInteropFrameOfReferencePreview, bases.get(), nullptr);
    if (!state->type_SpatialGraphInteropFrameOfReferencePreview)
    {
        return nullptr;
    }

    state->type_SpatialGraphInteropPreview = py::register_python_type(module.get(), type_name_SpatialGraphInteropPreview, &type_spec_SpatialGraphInteropPreview, nullptr, nullptr);
