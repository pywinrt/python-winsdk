...
namespace py::cpp::Windows::ApplicationModel
{
    ...
    static PyObject* register_AddResourcePackageOptions(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_AppExecutionContext(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_AppInstallerPolicySource(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LimitedAccessFeatureStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PackageContentGroupState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PackageSignatureKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PackageUpdateAvailability(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StartupTaskState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_AppDisplayInfo = "AppDisplayInfo";
    ...
    // ----- AppInfo class --------------------
    constexpr const char* const type_name_AppInfo = "AppInfo";
    ...
    constexpr const char* const type_name_AppInstallerInfo = "AppInstallerInfo";
    ...
    // ----- AppInstance class --------------------
    constexpr const char* const type_name_AppInstance = "AppInstance";
    ...
    constexpr const char* const type_name_LimitedAccessFeatureRequestResult = "LimitedAccessFeatureRequestResult";
    ...
    constexpr const char* const type_name_LimitedAccessFeatures = "LimitedAccessFeatures";
    ...
    // ----- Package class --------------------
    constexpr const char* const type_name_Package = "Package";
    ...
    constexpr const char* const type_name_PackageCatalog = "PackageCatalog";
    ...
    constexpr const char* const type_name_PackageCatalogAddOptionalPackageResult = "PackageCatalogAddOptionalPackageResult";
    ...
    constexpr const char* const type_name_PackageCatalogAddResourcePackageResult = "PackageCatalogAddResourcePackageResult";
    ...
    constexpr const char* const type_name_PackageCatalogRemoveOptionalPackagesResult = "PackageCatalogRemoveOptionalPackagesResult";
    ...
    constexpr const char* const type_name_PackageCatalogRemoveResourcePackagesResult = "PackageCatalogRemoveResourcePackagesResult";
    ...
    constexpr const char* const type_name_PackageContentGroup = "PackageContentGroup";
    ...
    constexpr const char* const type_name_PackageContentGroupStagingEventArgs = "PackageContentGroupStagingEventArgs";
    ...
    // ----- PackageId class --------------------
    constexpr const char* const type_name_PackageId = "PackageId";
    ...
    constexpr const char* const type_name_PackageInstallingEventArgs = "PackageInstallingEventArgs";
    ...
    constexpr const char* const type_name_PackageStagingEventArgs = "PackageStagingEventArgs";
    ...
    // ----- PackageStatus class --------------------
    constexpr const char* const type_name_PackageStatus = "PackageStatus";
    ...
    constexpr const char* const type_name_PackageStatusChangedEventArgs = "PackageStatusChangedEventArgs";
    ...
    constexpr const char* const type_name_PackageUninstallingEventArgs = "PackageUninstallingEventArgs";
    ...
    constexpr const char* const type_name_PackageUpdateAvailabilityResult = "PackageUpdateAvailabilityResult";
    ...
    constexpr const char* const type_name_PackageUpdatingEventArgs = "PackageUpdatingEventArgs";
    ...
    // ----- StartupTask class --------------------
    constexpr const char* const type_name_StartupTask = "StartupTask";
    ...
    constexpr const char* const type_name_IEnteredBackgroundEventArgs = "IEnteredBackgroundEventArgs";
    ...
    constexpr const char* const type_name_ILeavingBackgroundEventArgs = "ILeavingBackgroundEventArgs";
    ...
    constexpr const char* const type_name_ISuspendingEventArgs = "ISuspendingEventArgs";
    ...
    constexpr const char* const type_name_ISuspendingOperation = "ISuspendingOperation";
    ...
    constexpr const char* const type_name_PackageInstallProgress = "PackageInstallProgress";
    ...
    constexpr const char* const type_name_PackageVersion = "PackageVersion";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel(void) noexcept
{
    ...
    state->type_AppDisplayInfo = py::register_python_type(module.get(), type_name_AppDisplayInfo, &type_spec_AppDisplayInfo, bases.get());
    if (!state->type_AppDisplayInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppDisplayInfo);

    state->type_AppInfo = py::register_python_type(module.get(), type_name_AppInfo, &type_spec_AppInfo, bases.get());
    if (!state->type_AppInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppInfo);

    state->type_AppInstallerInfo = py::register_python_type(module.get(), type_name_AppInstallerInfo, &type_spec_AppInstallerInfo, bases.get());
    if (!state->type_AppInstallerInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppInstallerInfo);

    state->type_AppInstance = py::register_python_type(module.get(), type_name_AppInstance, &type_spec_AppInstance, bases.get());
    ...
    Py_INCREF(state->type_DesignMode);
    ...
    state->type_LimitedAccessFeatureRequestResult = py::register_python_type(module.get(), type_name_LimitedAccessFeatureRequestResult, &type_spec_LimitedAccessFeatureRequestResult, bases.get());
    if (!state->type_LimitedAccessFeatureRequestResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LimitedAccessFeatureRequestResult);

    state->type_LimitedAccessFeatures = py::register_python_type(module.get(), type_name_LimitedAccessFeatures, &type_spec_LimitedAccessFeatures, nullptr);
    if (!state->type_LimitedAccessFeatures)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LimitedAccessFeatures);

    state->type_Package = py::register_python_type(module.get(), type_name_Package, &type_spec_Package, bases.get());
    if (!state->type_Package)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Package);

    state->type_PackageCatalog = py::register_python_type(module.get(), type_name_PackageCatalog, &type_spec_PackageCatalog, bases.get());
    if (!state->type_PackageCatalog)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageCatalog);

    state->type_PackageCatalogAddOptionalPackageResult = py::register_python_type(module.get(), type_name_PackageCatalogAddOptionalPackageResult, &type_spec_PackageCatalogAddOptionalPackageResult, bases.get());
    if (!state->type_PackageCatalogAddOptionalPackageResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageCatalogAddOptionalPackageResult);

    state->type_PackageCatalogAddResourcePackageResult = py::register_python_type(module.get(), type_name_PackageCatalogAddResourcePackageResult, &type_spec_PackageCatalogAddResourcePackageResult, bases.get());
    if (!state->type_PackageCatalogAddResourcePackageResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageCatalogAddResourcePackageResult);

    state->type_PackageCatalogRemoveOptionalPackagesResult = py::register_python_type(module.get(), type_name_PackageCatalogRemoveOptionalPackagesResult, &type_spec_PackageCatalogRemoveOptionalPackagesResult, bases.get());
    if (!state->type_PackageCatalogRemoveOptionalPackagesResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageCatalogRemoveOptionalPackagesResult);

    state->type_PackageCatalogRemoveResourcePackagesResult = py::register_python_type(module.get(), type_name_PackageCatalogRemoveResourcePackagesResult, &type_spec_PackageCatalogRemoveResourcePackagesResult, bases.get());
    if (!state->type_PackageCatalogRemoveResourcePackagesResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageCatalogRemoveResourcePackagesResult);

    state->type_PackageContentGroup = py::register_python_type(module.get(), type_name_PackageContentGroup, &type_spec_PackageContentGroup, bases.get());
    if (!state->type_PackageContentGroup)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageContentGroup);

    state->type_PackageContentGroupStagingEventArgs = py::register_python_type(module.get(), type_name_PackageContentGroupStagingEventArgs, &type_spec_PackageContentGroupStagingEventArgs, bases.get());
    if (!state->type_PackageContentGroupStagingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageContentGroupStagingEventArgs);

    state->type_PackageId = py::register_python_type(module.get(), type_name_PackageId, &type_spec_PackageId, bases.get());
    if (!state->type_PackageId)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageId);

    state->type_PackageInstallingEventArgs = py::register_python_type(module.get(), type_name_PackageInstallingEventArgs, &type_spec_PackageInstallingEventArgs, bases.get());
    if (!state->type_PackageInstallingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageInstallingEventArgs);

    state->type_PackageStagingEventArgs = py::register_python_type(module.get(), type_name_PackageStagingEventArgs, &type_spec_PackageStagingEventArgs, bases.get());
    if (!state->type_PackageStagingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageStagingEventArgs);

    state->type_PackageStatus = py::register_python_type(module.get(), type_name_PackageStatus, &type_spec_PackageStatus, bases.get());
    ...
    state->type_PackageStatusChangedEventArgs = py::register_python_type(module.get(), type_name_PackageStatusChangedEventArgs, &type_spec_PackageStatusChangedEventArgs, bases.get());
    if (!state->type_PackageStatusChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageStatusChangedEventArgs);

    state->type_PackageUninstallingEventArgs = py::register_python_type(module.get(), type_name_PackageUninstallingEventArgs, &type_spec_PackageUninstallingEventArgs, bases.get());
    if (!state->type_PackageUninstallingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageUninstallingEventArgs);

    state->type_PackageUpdateAvailabilityResult = py::register_python_type(module.get(), type_name_PackageUpdateAvailabilityResult, &type_spec_PackageUpdateAvailabilityResult, bases.get());
    if (!state->type_PackageUpdateAvailabilityResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageUpdateAvailabilityResult);

    state->type_PackageUpdatingEventArgs = py::register_python_type(module.get(), type_name_PackageUpdatingEventArgs, &type_spec_PackageUpdatingEventArgs, bases.get());
    if (!state->type_PackageUpdatingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageUpdatingEventArgs);

    state->type_StartupTask = py::register_python_type(module.get(), type_name_StartupTask, &type_spec_StartupTask, bases.get());
    if (!state->type_StartupTask)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StartupTask);
    ...
    state->type_IEnteredBackgroundEventArgs = py::register_python_type(module.get(), type_name_IEnteredBackgroundEventArgs, &type_spec_IEnteredBackgroundEventArgs, bases.get());
    if (!state->type_IEnteredBackgroundEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IEnteredBackgroundEventArgs);

    state->type_ILeavingBackgroundEventArgs = py::register_python_type(module.get(), type_name_ILeavingBackgroundEventArgs, &type_spec_ILeavingBackgroundEventArgs, bases.get());
    ...
    Py_INCREF(state->type_ISuspendingDeferral);

    state->type_ISuspendingEventArgs = py::register_python_type(module.get(), type_name_ISuspendingEventArgs, &type_spec_ISuspendingEventArgs, bases.get());
    if (!state->type_ISuspendingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ISuspendingEventArgs);

    state->type_ISuspendingOperation = py::register_python_type(module.get(), type_name_ISuspendingOperation, &type_spec_ISuspendingOperation, bases.get());
    if (!state->type_ISuspendingOperation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ISuspendingOperation);

    state->type_PackageInstallProgress = py::register_python_type(module.get(), type_name_PackageInstallProgress, &type_spec_PackageInstallProgress, bases.get());
    if (!state->type_PackageInstallProgress)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageInstallProgress);

    state->type_PackageVersion = py::register_python_type(module.get(), type_name_PackageVersion, &type_spec_PackageVersion, bases.get());
    if (!state->type_PackageVersion)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PackageVersion);
