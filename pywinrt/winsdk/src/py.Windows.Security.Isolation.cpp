...
winrt::Windows::Security::Isolation::IsolatedWindowsEnvironmentCreateProgress py::converter<winrt::Windows::Security::Isolation::IsolatedWindowsEnvironmentCreateProgress>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Security::Isolation::IsolatedWindowsEnvironmentCreateProgress or dict");
    ...
    if (!py_State) {
        PyErr_SetString(PyExc_KeyError, "State");
        throw python_exception();
    }
    ...
    if (!py_PercentComplete) {
        PyErr_SetString(PyExc_KeyError, "PercentComplete");
        throw python_exception();
    }
...
PyMODINIT_FUNC
PyInit__winsdk_Windows_Security_Isolation (void) noexcept
{
