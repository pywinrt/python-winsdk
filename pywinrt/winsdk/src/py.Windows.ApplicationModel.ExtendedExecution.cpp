...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_ExtendedExecution(void) noexcept
{
    ...
    state->type_ExtendedExecutionRevokedEventArgs = py::register_python_type(module.get(), type_name_ExtendedExecutionRevokedEventArgs, &type_spec_ExtendedExecutionRevokedEventArgs, object_bases.get(), nullptr);
    if (!state->type_ExtendedExecutionRevokedEventArgs)
    {
        return nullptr;
    }

    state->type_ExtendedExecutionSession = py::register_python_type(module.get(), type_name_ExtendedExecutionSession, &type_spec_ExtendedExecutionSession, object_bases.get(), nullptr);
