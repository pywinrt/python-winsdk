...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnAppIdType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnAuthenticationMethod> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnChannelActivityEventType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnChannelRequestCredentialsOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnCredentialType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnDataPathType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnDomainNameType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnIPProtocol> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnManagementConnectionStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnManagementErrorStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnNativeProtocolType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnPacketBufferStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Networking::Vpn::VpnRoutingPolicyType> = "i";
