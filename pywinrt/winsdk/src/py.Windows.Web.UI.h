...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Web::UI::WebViewControlPermissionState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Web::UI::WebViewControlPermissionType> = "i";
