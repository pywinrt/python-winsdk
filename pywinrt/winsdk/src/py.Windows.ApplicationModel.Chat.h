...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::ChatConversationThreadingKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::ChatItemKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::ChatMessageChangeType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::ChatMessageKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::ChatMessageOperatorKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::ChatMessageStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::ChatMessageTransportKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::ChatMessageValidationStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::ChatRestoreHistorySpan> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::ChatStoreChangedEventKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::ChatTransportErrorCodeCategory> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::ChatTransportInterpretedErrorCode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Chat::RcsServiceKind> = "i";
