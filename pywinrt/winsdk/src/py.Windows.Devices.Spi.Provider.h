...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Spi::Provider::ProviderSpiMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Spi::Provider::ProviderSpiSharingMode> = "i";
