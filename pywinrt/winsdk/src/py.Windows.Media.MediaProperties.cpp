...
namespace py::cpp::Windows::Media::MediaProperties
{
    ...
    static PyType_Slot type_slots_H264ProfileIds_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_H264ProfileIds_Meta },
        { }
    };

    static PyType_Spec type_spec_H264ProfileIds_Meta =
    {
        "_winsdk_Windows_Media_MediaProperties.H264ProfileIds_Meta",
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_MediaEncodingSubtypes_Meta },
        { }
    };

    static PyType_Spec type_spec_MediaEncodingSubtypes_Meta =
    {
        "_winsdk_Windows_Media_MediaProperties.MediaEncodingSubtypes_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_Mpeg2ProfileIds_Meta },
        { }
    };

    static PyType_Spec type_spec_Mpeg2ProfileIds_Meta =
    {
        "_winsdk_Windows_Media_MediaProperties.Mpeg2ProfileIds_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Media_MediaProperties(void) noexcept
{
    ...
    state->type_AudioEncodingProperties = py::register_python_type(module.get(), type_name_AudioEncodingProperties, &type_spec_AudioEncodingProperties, bases.get(), nullptr);
    if (!state->type_AudioEncodingProperties)
    {
        return nullptr;
    }

    state->type_ContainerEncodingProperties = py::register_python_type(module.get(), type_name_ContainerEncodingProperties, &type_spec_ContainerEncodingProperties, bases.get(), nullptr);
    ...
    state->type_H264ProfileIds = py::register_python_type(module.get(), type_name_H264ProfileIds, &type_spec_H264ProfileIds, nullptr, reinterpret_cast<PyTypeObject*>(type_H264ProfileIds_Meta.get()));
    if (!state->type_H264ProfileIds)
    {
        return nullptr;
    }

    state->type_ImageEncodingProperties = py::register_python_type(module.get(), type_name_ImageEncodingProperties, &type_spec_ImageEncodingProperties, bases.get(), nullptr);
    if (!state->type_ImageEncodingProperties)
    {
        return nullptr;
    }

    state->type_MediaEncodingProfile = py::register_python_type(module.get(), type_name_MediaEncodingProfile, &type_spec_MediaEncodingProfile, bases.get(), nullptr);
    ...
    state->type_MediaEncodingSubtypes = py::register_python_type(module.get(), type_name_MediaEncodingSubtypes, &type_spec_MediaEncodingSubtypes, nullptr, reinterpret_cast<PyTypeObject*>(type_MediaEncodingSubtypes_Meta.get()));
    if (!state->type_MediaEncodingSubtypes)
    {
        return nullptr;
    }

    state->type_MediaPropertySet = py::register_python_type(module.get(), type_name_MediaPropertySet, &type_spec_MediaPropertySet, mutable_mapping_bases.get(), nullptr);
    if (!state->type_MediaPropertySet)
    {
        return nullptr;
    }

    state->type_MediaRatio = py::register_python_type(module.get(), type_name_MediaRatio, &type_spec_MediaRatio, bases.get(), nullptr);
    ...
    state->type_Mpeg2ProfileIds = py::register_python_type(module.get(), type_name_Mpeg2ProfileIds, &type_spec_Mpeg2ProfileIds, nullptr, reinterpret_cast<PyTypeObject*>(type_Mpeg2ProfileIds_Meta.get()));
    if (!state->type_Mpeg2ProfileIds)
    {
        return nullptr;
    }

    state->type_TimedMetadataEncodingProperties = py::register_python_type(module.get(), type_name_TimedMetadataEncodingProperties, &type_spec_TimedMetadataEncodingProperties, bases.get(), nullptr);
    if (!state->type_TimedMetadataEncodingProperties)
    {
        return nullptr;
    }

    state->type_VideoEncodingProperties = py::register_python_type(module.get(), type_name_VideoEncodingProperties, &type_spec_VideoEncodingProperties, bases.get(), nullptr);
    if (!state->type_VideoEncodingProperties)
    {
        return nullptr;
    }

    state->type_IMediaEncodingProperties = py::register_python_type(module.get(), type_name_IMediaEncodingProperties, &type_spec_IMediaEncodingProperties, bases.get(), nullptr);
