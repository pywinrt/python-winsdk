...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Phone::System::UserProfile::GameServices::Core::GameServiceGameOutcome> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Phone::System::UserProfile::GameServices::Core::GameServiceScoreKind> = "i";
