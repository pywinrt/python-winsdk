...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Lights::LampArrayKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Lights::LampPurposes> = "I";
