...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Authentication::Web::Provider::WebAccountClientViewType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Authentication::Web::Provider::WebAccountProviderOperationKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Authentication::Web::Provider::WebAccountScope> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::Authentication::Web::Provider::WebAccountSelectionOptions> = "I";
