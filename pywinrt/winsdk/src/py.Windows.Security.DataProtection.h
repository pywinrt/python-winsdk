...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::DataProtection::UserDataAvailability> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::DataProtection::UserDataBufferUnprotectStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::DataProtection::UserDataStorageItemProtectionStatus> = "i";
