...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::StartScreen::ForegroundText> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::StartScreen::JumpListItemKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::StartScreen::JumpListSystemGroupKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::StartScreen::TileMixedRealityModelActivationBehavior> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::StartScreen::TileOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::StartScreen::TileSize> = "i";
