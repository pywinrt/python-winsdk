...
namespace py::cpp::Windows::Security::Authentication::Identity::Provider
{
    ...
    static PyObject* register_SecondaryAuthenticationFactorAuthenticationMessage(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_SecondaryAuthenticationFactorAuthenticationScenario(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SecondaryAuthenticationFactorAuthenticationStage(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SecondaryAuthenticationFactorAuthenticationStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SecondaryAuthenticationFactorDeviceCapabilities(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SecondaryAuthenticationFactorDeviceFindScope(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SecondaryAuthenticationFactorDevicePresence(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SecondaryAuthenticationFactorDevicePresenceMonitoringMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SecondaryAuthenticationFactorDevicePresenceMonitoringRegistrationStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SecondaryAuthenticationFactorFinishAuthenticationStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SecondaryAuthenticationFactorRegistrationStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_SecondaryAuthenticationFactorAuthentication = "SecondaryAuthenticationFactorAuthentication";
    ...
    constexpr const char* const type_name_SecondaryAuthenticationFactorAuthenticationResult = "SecondaryAuthenticationFactorAuthenticationResult";
    ...
    constexpr const char* const type_name_SecondaryAuthenticationFactorAuthenticationStageChangedEventArgs = "SecondaryAuthenticationFactorAuthenticationStageChangedEventArgs";
    ...
    constexpr const char* const type_name_SecondaryAuthenticationFactorAuthenticationStageInfo = "SecondaryAuthenticationFactorAuthenticationStageInfo";
    ...
    constexpr const char* const type_name_SecondaryAuthenticationFactorInfo = "SecondaryAuthenticationFactorInfo";
    ...
    constexpr const char* const type_name_SecondaryAuthenticationFactorRegistration = "SecondaryAuthenticationFactorRegistration";
    ...
    constexpr const char* const type_name_SecondaryAuthenticationFactorRegistrationResult = "SecondaryAuthenticationFactorRegistrationResult";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Security_Authentication_Identity_Provider(void) noexcept
{
    ...
    state->type_SecondaryAuthenticationFactorAuthentication = py::register_python_type(module.get(), type_name_SecondaryAuthenticationFactorAuthentication, &type_spec_SecondaryAuthenticationFactorAuthentication, bases.get());
    if (!state->type_SecondaryAuthenticationFactorAuthentication)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SecondaryAuthenticationFactorAuthentication);

    state->type_SecondaryAuthenticationFactorAuthenticationResult = py::register_python_type(module.get(), type_name_SecondaryAuthenticationFactorAuthenticationResult, &type_spec_SecondaryAuthenticationFactorAuthenticationResult, bases.get());
    if (!state->type_SecondaryAuthenticationFactorAuthenticationResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SecondaryAuthenticationFactorAuthenticationResult);

    state->type_SecondaryAuthenticationFactorAuthenticationStageChangedEventArgs = py::register_python_type(module.get(), type_name_SecondaryAuthenticationFactorAuthenticationStageChangedEventArgs, &type_spec_SecondaryAuthenticationFactorAuthenticationStageChangedEventArgs, bases.get());
    if (!state->type_SecondaryAuthenticationFactorAuthenticationStageChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SecondaryAuthenticationFactorAuthenticationStageChangedEventArgs);

    state->type_SecondaryAuthenticationFactorAuthenticationStageInfo = py::register_python_type(module.get(), type_name_SecondaryAuthenticationFactorAuthenticationStageInfo, &type_spec_SecondaryAuthenticationFactorAuthenticationStageInfo, bases.get());
    if (!state->type_SecondaryAuthenticationFactorAuthenticationStageInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SecondaryAuthenticationFactorAuthenticationStageInfo);

    state->type_SecondaryAuthenticationFactorInfo = py::register_python_type(module.get(), type_name_SecondaryAuthenticationFactorInfo, &type_spec_SecondaryAuthenticationFactorInfo, bases.get());
    if (!state->type_SecondaryAuthenticationFactorInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SecondaryAuthenticationFactorInfo);

    state->type_SecondaryAuthenticationFactorRegistration = py::register_python_type(module.get(), type_name_SecondaryAuthenticationFactorRegistration, &type_spec_SecondaryAuthenticationFactorRegistration, bases.get());
    if (!state->type_SecondaryAuthenticationFactorRegistration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SecondaryAuthenticationFactorRegistration);

    state->type_SecondaryAuthenticationFactorRegistrationResult = py::register_python_type(module.get(), type_name_SecondaryAuthenticationFactorRegistrationResult, &type_spec_SecondaryAuthenticationFactorRegistrationResult, bases.get());
    if (!state->type_SecondaryAuthenticationFactorRegistrationResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SecondaryAuthenticationFactorRegistrationResult);
