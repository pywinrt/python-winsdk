...
namespace py::cpp::Windows::Perception::People
{
    ...
    static PyObject* register_HandJointKind(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_JointPoseAccuracy(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    // ----- EyesPose class --------------------
    constexpr const char* const type_name_EyesPose = "EyesPose";
    ...
    constexpr const char* const type_name_HandMeshObserver = "HandMeshObserver";
    ...
    static PyObject* HandMeshObserver_GetTriangleIndices(py::wrapper::Windows::Perception::People::HandMeshObserver* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Perception.People.HandMeshObserver", L"GetTriangleIndices", 1))
            {
    ...
    constexpr const char* const type_name_HandMeshVertexState = "HandMeshVertexState";
    ...
    static PyObject* HandMeshVertexState_GetVertices(py::wrapper::Windows::Perception::People::HandMeshVertexState* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Perception.People.HandMeshVertexState", L"GetVertices", 1))
            {
                PyErr_SetString(PyExc_AttributeError, "method 1 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    // ----- HandPose class --------------------
    constexpr const char* const type_name_HandPose = "HandPose";
    ...
    static PyObject* HandPose_GetRelativeJoints(py::wrapper::Windows::Perception::People::HandPose* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 3)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Perception.People.HandPose", L"GetRelativeJoints", 3))
            {
    ...
    static PyObject* HandPose_TryGetJoints(py::wrapper::Windows::Perception::People::HandPose* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 3)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Perception.People.HandPose", L"TryGetJoints", 3))
            {
                PyErr_SetString(PyExc_AttributeError, "method 3 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    // ----- HeadPose class --------------------
    constexpr const char* const type_name_HeadPose = "HeadPose";
    ...
    constexpr const char* const type_name_HandMeshVertex = "HandMeshVertex";
    ...
    // ----- JointPose struct --------------------
    constexpr const char* const type_name_JointPose = "JointPose";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Perception_People(void) noexcept
{
    ...
    state->type_EyesPose = py::register_python_type(module.get(), type_name_EyesPose, &type_spec_EyesPose, bases.get());
    if (!state->type_EyesPose)
    {
        return nullptr;
    }

    Py_INCREF(state->type_EyesPose);

    state->type_HandMeshObserver = py::register_python_type(module.get(), type_name_HandMeshObserver, &type_spec_HandMeshObserver, bases.get());
    if (!state->type_HandMeshObserver)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HandMeshObserver);

    state->type_HandMeshVertexState = py::register_python_type(module.get(), type_name_HandMeshVertexState, &type_spec_HandMeshVertexState, bases.get());
    if (!state->type_HandMeshVertexState)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HandMeshVertexState);

    state->type_HandPose = py::register_python_type(module.get(), type_name_HandPose, &type_spec_HandPose, bases.get());
    if (!state->type_HandPose)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HandPose);

    state->type_HeadPose = py::register_python_type(module.get(), type_name_HeadPose, &type_spec_HeadPose, bases.get());
    if (!state->type_HeadPose)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HeadPose);

    state->type_HandMeshVertex = py::register_python_type(module.get(), type_name_HandMeshVertex, &type_spec_HandMeshVertex, bases.get());
    if (!state->type_HandMeshVertex)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HandMeshVertex);

    state->type_JointPose = py::register_python_type(module.get(), type_name_JointPose, &type_spec_JointPose, bases.get());
    if (!state->type_JointPose)
    {
        return nullptr;
    }

    Py_INCREF(state->type_JointPose);
