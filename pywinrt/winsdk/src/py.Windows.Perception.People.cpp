...
winrt::Windows::Perception::People::HandMeshVertex py::converter<winrt::Windows::Perception::People::HandMeshVertex>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Perception::People::HandMeshVertex or dict");
    ...
    if (!py_Position) {
        PyErr_SetString(PyExc_KeyError, "Position");
        throw python_exception();
    }
...
winrt::Windows::Perception::People::JointPose py::converter<winrt::Windows::Perception::People::JointPose>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Perception::People::JointPose or dict");
        throw python_exception();
    }
    ...
    if (!py_Accuracy) {
        PyErr_SetString(PyExc_KeyError, "Accuracy");
        throw python_exception();
    }
