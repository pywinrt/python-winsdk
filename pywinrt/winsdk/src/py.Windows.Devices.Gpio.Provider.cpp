...
namespace py::cpp::Windows::Devices::Gpio::Provider
{
    ...
    static PyObject* register_ProviderGpioPinDriveMode(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_ProviderGpioPinEdge(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ProviderGpioPinValue(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ProviderGpioSharingMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_GpioPinProviderValueChangedEventArgs = "GpioPinProviderValueChangedEventArgs";
    ...
    constexpr const char* const type_name_IGpioControllerProvider = "IGpioControllerProvider";
    ...
    constexpr const char* const type_name_IGpioPinProvider = "IGpioPinProvider";
    ...
    constexpr const char* const type_name_IGpioProvider = "IGpioProvider";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Gpio_Provider(void) noexcept
{
    ...
    state->type_GpioPinProviderValueChangedEventArgs = py::register_python_type(module.get(), type_name_GpioPinProviderValueChangedEventArgs, &type_spec_GpioPinProviderValueChangedEventArgs, bases.get());
    if (!state->type_GpioPinProviderValueChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GpioPinProviderValueChangedEventArgs);

    state->type_IGpioControllerProvider = py::register_python_type(module.get(), type_name_IGpioControllerProvider, &type_spec_IGpioControllerProvider, bases.get());
    if (!state->type_IGpioControllerProvider)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IGpioControllerProvider);

    state->type_IGpioPinProvider = py::register_python_type(module.get(), type_name_IGpioPinProvider, &type_spec_IGpioPinProvider, bases.get());
    if (!state->type_IGpioPinProvider)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IGpioPinProvider);

    state->type_IGpioProvider = py::register_python_type(module.get(), type_name_IGpioProvider, &type_spec_IGpioProvider, bases.get());
    if (!state->type_IGpioProvider)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IGpioProvider);
