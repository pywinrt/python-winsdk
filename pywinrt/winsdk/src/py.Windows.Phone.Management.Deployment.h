...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Phone::Management::Deployment::EnterpriseEnrollmentStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Phone::Management::Deployment::EnterpriseStatus> = "i";
