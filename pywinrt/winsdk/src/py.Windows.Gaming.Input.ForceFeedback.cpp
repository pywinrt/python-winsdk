...
namespace py::cpp::Windows::Gaming::Input::ForceFeedback
{
    ...
    static PyObject* register_ConditionForceEffectKind(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_ForceFeedbackEffectAxes(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ForceFeedbackEffectState(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ForceFeedbackLoadEffectResult(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PeriodicForceEffectKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_ConditionForceEffect = "ConditionForceEffect";
    ...
    constexpr const char* const type_name_ConstantForceEffect = "ConstantForceEffect";
    ...
    constexpr const char* const type_name_ForceFeedbackMotor = "ForceFeedbackMotor";
    ...
    constexpr const char* const type_name_PeriodicForceEffect = "PeriodicForceEffect";
    ...
    static PyObject* PeriodicForceEffect_SetParametersWithEnvelope(py::wrapper::Windows::Gaming::Input::ForceFeedback::PeriodicForceEffect* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 12)
        {
            ...
            {
                PyErr_SetString(PyExc_AttributeError, "method 12 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    constexpr const char* const type_name_RampForceEffect = "RampForceEffect";
    ...
    constexpr const char* const type_name_IForceFeedbackEffect = "IForceFeedbackEffect";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Gaming_Input_ForceFeedback(void) noexcept
{
    ...
    state->type_ConditionForceEffect = py::register_python_type(module.get(), type_name_ConditionForceEffect, &type_spec_ConditionForceEffect, bases.get());
    if (!state->type_ConditionForceEffect)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ConditionForceEffect);

    state->type_ConstantForceEffect = py::register_python_type(module.get(), type_name_ConstantForceEffect, &type_spec_ConstantForceEffect, bases.get());
    if (!state->type_ConstantForceEffect)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ConstantForceEffect);

    state->type_ForceFeedbackMotor = py::register_python_type(module.get(), type_name_ForceFeedbackMotor, &type_spec_ForceFeedbackMotor, bases.get());
    if (!state->type_ForceFeedbackMotor)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ForceFeedbackMotor);

    state->type_PeriodicForceEffect = py::register_python_type(module.get(), type_name_PeriodicForceEffect, &type_spec_PeriodicForceEffect, bases.get());
    if (!state->type_PeriodicForceEffect)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PeriodicForceEffect);

    state->type_RampForceEffect = py::register_python_type(module.get(), type_name_RampForceEffect, &type_spec_RampForceEffect, bases.get());
    if (!state->type_RampForceEffect)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RampForceEffect);

    state->type_IForceFeedbackEffect = py::register_python_type(module.get(), type_name_IForceFeedbackEffect, &type_spec_IForceFeedbackEffect, bases.get());
    if (!state->type_IForceFeedbackEffect)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IForceFeedbackEffect);
