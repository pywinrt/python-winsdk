...
namespace py::cpp::Windows::Devices
{
    ...
    static constexpr const char* const type_name_LowLevelDevicesController = "LowLevelDevicesController";
    ...
    {
        "_winsdk_Windows_Devices.LowLevelDevicesController_Meta",
    ...
    static constexpr const char* const type_name_ILowLevelDevicesAggregateProvider = "ILowLevelDevicesAggregateProvider";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices(void) noexcept
{
    ...
    state->type_LowLevelDevicesAggregateProvider = py::register_python_type(module.get(), type_name_LowLevelDevicesAggregateProvider, &type_spec_LowLevelDevicesAggregateProvider, bases.get(), nullptr);
    ...
    state->type_LowLevelDevicesController = py::register_python_type(module.get(), type_name_LowLevelDevicesController, &type_spec_LowLevelDevicesController, bases.get(), reinterpret_cast<PyTypeObject*>(type_LowLevelDevicesController_Meta.get()));
    if (!state->type_LowLevelDevicesController)
    {
        return nullptr;
    }

    state->type_ILowLevelDevicesAggregateProvider = py::register_python_type(module.get(), type_name_ILowLevelDevicesAggregateProvider, &type_spec_ILowLevelDevicesAggregateProvider, bases.get(), nullptr);
