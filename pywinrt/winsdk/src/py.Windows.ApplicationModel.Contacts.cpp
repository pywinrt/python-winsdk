...
namespace py::cpp::Windows::ApplicationModel::Contacts
{
    ...
    static PyObject* register_ContactAddressKind(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_ContactAnnotationOperations(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactAnnotationStoreAccessType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactBatchStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactCardHeaderKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactCardTabKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactChangeType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactDateKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactEmailKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactFieldCategory(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactFieldType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactListOtherAppReadAccess(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactListOtherAppWriteAccess(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactListSyncStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactMatchReasonKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactNameOrder(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactPhoneKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactQueryDesiredFields(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactQuerySearchFields(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactQuerySearchScope(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactRelationship(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactSelectionMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ContactStoreAccessType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_PinnedContactSurface(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_AggregateContactManager = "AggregateContactManager";
    ...
    // ----- Contact class --------------------
    constexpr const char* const type_name_Contact = "Contact";
    ...
    constexpr const char* const type_name_ContactAddress = "ContactAddress";
    ...
    constexpr const char* const type_name_ContactAnnotation = "ContactAnnotation";
    ...
    constexpr const char* const type_name_ContactAnnotationList = "ContactAnnotationList";
    ...
    constexpr const char* const type_name_ContactAnnotationStore = "ContactAnnotationStore";
    ...
    // ----- ContactBatch class --------------------
    constexpr const char* const type_name_ContactBatch = "ContactBatch";
    ...
    constexpr const char* const type_name_ContactCardDelayedDataLoader = "ContactCardDelayedDataLoader";
    ...
    constexpr const char* const type_name_ContactCardOptions = "ContactCardOptions";
    ...
    // ----- ContactChange class --------------------
    constexpr const char* const type_name_ContactChange = "ContactChange";
    ...
    constexpr const char* const type_name_ContactChangeReader = "ContactChangeReader";
    ...
    constexpr const char* const type_name_ContactChangeTracker = "ContactChangeTracker";
    ...
    constexpr const char* const type_name_ContactChangedDeferral = "ContactChangedDeferral";
    ...
    constexpr const char* const type_name_ContactChangedEventArgs = "ContactChangedEventArgs";
    ...
    constexpr const char* const type_name_ContactConnectedServiceAccount = "ContactConnectedServiceAccount";
    ...
    // ----- ContactDate class --------------------
    constexpr const char* const type_name_ContactDate = "ContactDate";
    ...
    // ----- ContactEmail class --------------------
    constexpr const char* const type_name_ContactEmail = "ContactEmail";
    ...
    // ----- ContactField class --------------------
    constexpr const char* const type_name_ContactField = "ContactField";
    ...
    constexpr const char* const type_name_ContactFieldFactory = "ContactFieldFactory";
    ...
    static PyObject* ContactFieldFactory_CreateLocation(py::wrapper::Windows::ApplicationModel::Contacts::ContactFieldFactory* self, PyObject* args) noexcept
    {
        ...
        else if (arg_count == 7)
        {
            ...
            {
                PyErr_SetString(PyExc_AttributeError, "method 7 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    // ----- ContactGroup class --------------------
    constexpr const char* const type_name_ContactGroup = "ContactGroup";
    ...
    constexpr const char* const type_name_ContactInformation = "ContactInformation";
    ...
    constexpr const char* const type_name_ContactInstantMessageField = "ContactInstantMessageField";
    ...
    constexpr const char* const type_name_ContactJobInfo = "ContactJobInfo";
    ...
    constexpr const char* const type_name_ContactLaunchActionVerbs = "ContactLaunchActionVerbs";
    ...
    // ----- ContactList class --------------------
    constexpr const char* const type_name_ContactList = "ContactList";
    ...
    constexpr const char* const type_name_ContactListLimitedWriteOperations = "ContactListLimitedWriteOperations";
    ...
    constexpr const char* const type_name_ContactListSyncConstraints = "ContactListSyncConstraints";
    ...
    constexpr const char* const type_name_ContactListSyncManager = "ContactListSyncManager";
    ...
    constexpr const char* const type_name_ContactLocationField = "ContactLocationField";
    ...
    constexpr const char* const type_name_ContactManager = "ContactManager";
    ...
    constexpr const char* const type_name_ContactManagerForUser = "ContactManagerForUser";
    ...
    constexpr const char* const type_name_ContactMatchReason = "ContactMatchReason";
    ...
    // ----- ContactPanel class --------------------
    constexpr const char* const type_name_ContactPanel = "ContactPanel";
    ...
    constexpr const char* const type_name_ContactPanelClosingEventArgs = "ContactPanelClosingEventArgs";
    ...
    constexpr const char* const type_name_ContactPanelLaunchFullAppRequestedEventArgs = "ContactPanelLaunchFullAppRequestedEventArgs";
    ...
    // ----- ContactPhone class --------------------
    constexpr const char* const type_name_ContactPhone = "ContactPhone";
    ...
    // ----- ContactPicker class --------------------
    constexpr const char* const type_name_ContactPicker = "ContactPicker";
    ...
    constexpr const char* const type_name_ContactQueryOptions = "ContactQueryOptions";
    ...
    constexpr const char* const type_name_ContactQueryTextSearch = "ContactQueryTextSearch";
    ...
    // ----- ContactReader class --------------------
    constexpr const char* const type_name_ContactReader = "ContactReader";
    ...
    constexpr const char* const type_name_ContactSignificantOther = "ContactSignificantOther";
    ...
    // ----- ContactStore class --------------------
    constexpr const char* const type_name_ContactStore = "ContactStore";
    ...
    constexpr const char* const type_name_ContactStoreNotificationTriggerDetails = "ContactStoreNotificationTriggerDetails";
    ...
    constexpr const char* const type_name_ContactWebsite = "ContactWebsite";
    ...
    constexpr const char* const type_name_FullContactCardOptions = "FullContactCardOptions";
    ...
    constexpr const char* const type_name_KnownContactField = "KnownContactField";
    ...
    constexpr const char* const type_name_PinnedContactIdsQueryResult = "PinnedContactIdsQueryResult";
    ...
    constexpr const char* const type_name_PinnedContactManager = "PinnedContactManager";
    ...
    constexpr const char* const type_name_IContactField = "IContactField";
    ...
    constexpr const char* const type_name_IContactFieldFactory = "IContactFieldFactory";
    ...
    constexpr const char* const type_name_IContactInstantMessageFieldFactory = "IContactInstantMessageFieldFactory";
    ...
    constexpr const char* const type_name_IContactLocationFieldFactory = "IContactLocationFieldFactory";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_Contacts(void) noexcept
{
    ...
    state->type_AggregateContactManager = py::register_python_type(module.get(), type_name_AggregateContactManager, &type_spec_AggregateContactManager, bases.get());
    if (!state->type_AggregateContactManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AggregateContactManager);

    state->type_Contact = py::register_python_type(module.get(), type_name_Contact, &type_spec_Contact, bases.get());
    if (!state->type_Contact)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Contact);

    state->type_ContactAddress = py::register_python_type(module.get(), type_name_ContactAddress, &type_spec_ContactAddress, bases.get());
    if (!state->type_ContactAddress)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactAddress);

    state->type_ContactAnnotation = py::register_python_type(module.get(), type_name_ContactAnnotation, &type_spec_ContactAnnotation, bases.get());
    if (!state->type_ContactAnnotation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactAnnotation);

    state->type_ContactAnnotationList = py::register_python_type(module.get(), type_name_ContactAnnotationList, &type_spec_ContactAnnotationList, bases.get());
    if (!state->type_ContactAnnotationList)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactAnnotationList);

    state->type_ContactAnnotationStore = py::register_python_type(module.get(), type_name_ContactAnnotationStore, &type_spec_ContactAnnotationStore, bases.get());
    if (!state->type_ContactAnnotationStore)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactAnnotationStore);

    state->type_ContactBatch = py::register_python_type(module.get(), type_name_ContactBatch, &type_spec_ContactBatch, bases.get());
    if (!state->type_ContactBatch)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactBatch);

    state->type_ContactCardDelayedDataLoader = py::register_python_type(module.get(), type_name_ContactCardDelayedDataLoader, &type_spec_ContactCardDelayedDataLoader, bases.get());
    if (!state->type_ContactCardDelayedDataLoader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactCardDelayedDataLoader);

    state->type_ContactCardOptions = py::register_python_type(module.get(), type_name_ContactCardOptions, &type_spec_ContactCardOptions, bases.get());
    if (!state->type_ContactCardOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactCardOptions);

    state->type_ContactChange = py::register_python_type(module.get(), type_name_ContactChange, &type_spec_ContactChange, bases.get());
    if (!state->type_ContactChange)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactChange);

    state->type_ContactChangeReader = py::register_python_type(module.get(), type_name_ContactChangeReader, &type_spec_ContactChangeReader, bases.get());
    if (!state->type_ContactChangeReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactChangeReader);

    state->type_ContactChangeTracker = py::register_python_type(module.get(), type_name_ContactChangeTracker, &type_spec_ContactChangeTracker, bases.get());
    if (!state->type_ContactChangeTracker)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactChangeTracker);

    state->type_ContactChangedDeferral = py::register_python_type(module.get(), type_name_ContactChangedDeferral, &type_spec_ContactChangedDeferral, bases.get());
    if (!state->type_ContactChangedDeferral)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactChangedDeferral);

    state->type_ContactChangedEventArgs = py::register_python_type(module.get(), type_name_ContactChangedEventArgs, &type_spec_ContactChangedEventArgs, bases.get());
    if (!state->type_ContactChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactChangedEventArgs);

    state->type_ContactConnectedServiceAccount = py::register_python_type(module.get(), type_name_ContactConnectedServiceAccount, &type_spec_ContactConnectedServiceAccount, bases.get());
    if (!state->type_ContactConnectedServiceAccount)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactConnectedServiceAccount);

    state->type_ContactDate = py::register_python_type(module.get(), type_name_ContactDate, &type_spec_ContactDate, bases.get());
    if (!state->type_ContactDate)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactDate);

    state->type_ContactEmail = py::register_python_type(module.get(), type_name_ContactEmail, &type_spec_ContactEmail, bases.get());
    if (!state->type_ContactEmail)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactEmail);

    state->type_ContactField = py::register_python_type(module.get(), type_name_ContactField, &type_spec_ContactField, bases.get());
    if (!state->type_ContactField)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactField);

    state->type_ContactFieldFactory = py::register_python_type(module.get(), type_name_ContactFieldFactory, &type_spec_ContactFieldFactory, bases.get());
    if (!state->type_ContactFieldFactory)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactFieldFactory);

    state->type_ContactGroup = py::register_python_type(module.get(), type_name_ContactGroup, &type_spec_ContactGroup, bases.get());
    if (!state->type_ContactGroup)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactGroup);

    state->type_ContactInformation = py::register_python_type(module.get(), type_name_ContactInformation, &type_spec_ContactInformation, bases.get());
    if (!state->type_ContactInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactInformation);

    state->type_ContactInstantMessageField = py::register_python_type(module.get(), type_name_ContactInstantMessageField, &type_spec_ContactInstantMessageField, bases.get());
    if (!state->type_ContactInstantMessageField)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactInstantMessageField);

    state->type_ContactJobInfo = py::register_python_type(module.get(), type_name_ContactJobInfo, &type_spec_ContactJobInfo, bases.get());
    if (!state->type_ContactJobInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactJobInfo);

    state->type_ContactLaunchActionVerbs = py::register_python_type(module.get(), type_name_ContactLaunchActionVerbs, &type_spec_ContactLaunchActionVerbs, nullptr);
    if (!state->type_ContactLaunchActionVerbs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactLaunchActionVerbs);

    state->type_ContactList = py::register_python_type(module.get(), type_name_ContactList, &type_spec_ContactList, bases.get());
    if (!state->type_ContactList)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactList);

    state->type_ContactListLimitedWriteOperations = py::register_python_type(module.get(), type_name_ContactListLimitedWriteOperations, &type_spec_ContactListLimitedWriteOperations, bases.get());
    if (!state->type_ContactListLimitedWriteOperations)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactListLimitedWriteOperations);

    state->type_ContactListSyncConstraints = py::register_python_type(module.get(), type_name_ContactListSyncConstraints, &type_spec_ContactListSyncConstraints, bases.get());
    if (!state->type_ContactListSyncConstraints)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactListSyncConstraints);

    state->type_ContactListSyncManager = py::register_python_type(module.get(), type_name_ContactListSyncManager, &type_spec_ContactListSyncManager, bases.get());
    if (!state->type_ContactListSyncManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactListSyncManager);

    state->type_ContactLocationField = py::register_python_type(module.get(), type_name_ContactLocationField, &type_spec_ContactLocationField, bases.get());
    if (!state->type_ContactLocationField)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactLocationField);

    state->type_ContactManager = py::register_python_type(module.get(), type_name_ContactManager, &type_spec_ContactManager, nullptr);
    if (!state->type_ContactManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactManager);

    state->type_ContactManagerForUser = py::register_python_type(module.get(), type_name_ContactManagerForUser, &type_spec_ContactManagerForUser, bases.get());
    if (!state->type_ContactManagerForUser)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactManagerForUser);

    state->type_ContactMatchReason = py::register_python_type(module.get(), type_name_ContactMatchReason, &type_spec_ContactMatchReason, bases.get());
    if (!state->type_ContactMatchReason)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactMatchReason);

    state->type_ContactPanel = py::register_python_type(module.get(), type_name_ContactPanel, &type_spec_ContactPanel, bases.get());
    if (!state->type_ContactPanel)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactPanel);

    state->type_ContactPanelClosingEventArgs = py::register_python_type(module.get(), type_name_ContactPanelClosingEventArgs, &type_spec_ContactPanelClosingEventArgs, bases.get());
    if (!state->type_ContactPanelClosingEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactPanelClosingEventArgs);

    state->type_ContactPanelLaunchFullAppRequestedEventArgs = py::register_python_type(module.get(), type_name_ContactPanelLaunchFullAppRequestedEventArgs, &type_spec_ContactPanelLaunchFullAppRequestedEventArgs, bases.get());
    if (!state->type_ContactPanelLaunchFullAppRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactPanelLaunchFullAppRequestedEventArgs);

    state->type_ContactPhone = py::register_python_type(module.get(), type_name_ContactPhone, &type_spec_ContactPhone, bases.get());
    if (!state->type_ContactPhone)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactPhone);

    state->type_ContactPicker = py::register_python_type(module.get(), type_name_ContactPicker, &type_spec_ContactPicker, bases.get());
    if (!state->type_ContactPicker)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactPicker);

    state->type_ContactQueryOptions = py::register_python_type(module.get(), type_name_ContactQueryOptions, &type_spec_ContactQueryOptions, bases.get());
    if (!state->type_ContactQueryOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactQueryOptions);

    state->type_ContactQueryTextSearch = py::register_python_type(module.get(), type_name_ContactQueryTextSearch, &type_spec_ContactQueryTextSearch, bases.get());
    if (!state->type_ContactQueryTextSearch)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactQueryTextSearch);

    state->type_ContactReader = py::register_python_type(module.get(), type_name_ContactReader, &type_spec_ContactReader, bases.get());
    if (!state->type_ContactReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactReader);

    state->type_ContactSignificantOther = py::register_python_type(module.get(), type_name_ContactSignificantOther, &type_spec_ContactSignificantOther, bases.get());
    if (!state->type_ContactSignificantOther)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactSignificantOther);

    state->type_ContactStore = py::register_python_type(module.get(), type_name_ContactStore, &type_spec_ContactStore, bases.get());
    if (!state->type_ContactStore)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactStore);

    state->type_ContactStoreNotificationTriggerDetails = py::register_python_type(module.get(), type_name_ContactStoreNotificationTriggerDetails, &type_spec_ContactStoreNotificationTriggerDetails, bases.get());
    if (!state->type_ContactStoreNotificationTriggerDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactStoreNotificationTriggerDetails);

    state->type_ContactWebsite = py::register_python_type(module.get(), type_name_ContactWebsite, &type_spec_ContactWebsite, bases.get());
    if (!state->type_ContactWebsite)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ContactWebsite);

    state->type_FullContactCardOptions = py::register_python_type(module.get(), type_name_FullContactCardOptions, &type_spec_FullContactCardOptions, bases.get());
    if (!state->type_FullContactCardOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FullContactCardOptions);

    state->type_KnownContactField = py::register_python_type(module.get(), type_name_KnownContactField, &type_spec_KnownContactField, nullptr);
    if (!state->type_KnownContactField)
    {
        return nullptr;
    }

    Py_INCREF(state->type_KnownContactField);

    state->type_PinnedContactIdsQueryResult = py::register_python_type(module.get(), type_name_PinnedContactIdsQueryResult, &type_spec_PinnedContactIdsQueryResult, bases.get());
    if (!state->type_PinnedContactIdsQueryResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PinnedContactIdsQueryResult);

    state->type_PinnedContactManager = py::register_python_type(module.get(), type_name_PinnedContactManager, &type_spec_PinnedContactManager, bases.get());
    if (!state->type_PinnedContactManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PinnedContactManager);

    state->type_IContactField = py::register_python_type(module.get(), type_name_IContactField, &type_spec_IContactField, bases.get());
    if (!state->type_IContactField)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IContactField);

    state->type_IContactFieldFactory = py::register_python_type(module.get(), type_name_IContactFieldFactory, &type_spec_IContactFieldFactory, bases.get());
    if (!state->type_IContactFieldFactory)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IContactFieldFactory);

    state->type_IContactInstantMessageFieldFactory = py::register_python_type(module.get(), type_name_IContactInstantMessageFieldFactory, &type_spec_IContactInstantMessageFieldFactory, bases.get());
    if (!state->type_IContactInstantMessageFieldFactory)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IContactInstantMessageFieldFactory);

    state->type_IContactLocationFieldFactory = py::register_python_type(module.get(), type_name_IContactLocationFieldFactory, &type_spec_IContactLocationFieldFactory, bases.get());
    if (!state->type_IContactLocationFieldFactory)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IContactLocationFieldFactory);
