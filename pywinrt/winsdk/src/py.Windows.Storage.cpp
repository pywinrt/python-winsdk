...
namespace py::cpp::Windows::Storage
{
    ...
    static PyObject* register_ApplicationDataCreateDisposition(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_ApplicationDataLocality(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CreationCollisionOption(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_FileAccessMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_FileAttributes(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_KnownFolderId(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_KnownFoldersAccessStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_KnownLibraryId(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_NameCollisionOption(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StorageDeleteOption(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StorageItemTypes(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StorageLibraryChangeType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StorageOpenOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_StreamedFileFailureMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    // ----- AppDataPaths class --------------------
    constexpr const char* const type_name_AppDataPaths = "AppDataPaths";
    ...
    constexpr const char* const type_name_ApplicationData = "ApplicationData";
    ...
    constexpr const char* const type_name_ApplicationDataCompositeValue = "ApplicationDataCompositeValue";
    ...
    constexpr const char* const type_name_ApplicationDataContainer = "ApplicationDataContainer";
    ...
    constexpr const char* const type_name_ApplicationDataContainerSettings = "ApplicationDataContainerSettings";
    ...
    constexpr const char* const type_name_CachedFileManager = "CachedFileManager";
    ...
    constexpr const char* const type_name_DownloadsFolder = "DownloadsFolder";
    ...
    // ----- FileIO class --------------------
    constexpr const char* const type_name_FileIO = "FileIO";
    ...
    // ----- KnownFolders class --------------------
    constexpr const char* const type_name_KnownFolders = "KnownFolders";
    ...
    // ----- PathIO class --------------------
    constexpr const char* const type_name_PathIO = "PathIO";
    ...
    constexpr const char* const type_name_SetVersionDeferral = "SetVersionDeferral";
    ...
    constexpr const char* const type_name_SetVersionRequest = "SetVersionRequest";
    ...
    // ----- StorageFile class --------------------
    constexpr const char* const type_name_StorageFile = "StorageFile";
    ...
    // ----- StorageFolder class --------------------
    constexpr const char* const type_name_StorageFolder = "StorageFolder";
    ...
    constexpr const char* const type_name_StorageLibrary = "StorageLibrary";
    ...
    constexpr const char* const type_name_StorageLibraryChange = "StorageLibraryChange";
    ...
    constexpr const char* const type_name_StorageLibraryChangeReader = "StorageLibraryChangeReader";
    ...
    constexpr const char* const type_name_StorageLibraryChangeTracker = "StorageLibraryChangeTracker";
    ...
    constexpr const char* const type_name_StorageLibraryChangeTrackerOptions = "StorageLibraryChangeTrackerOptions";
    ...
    constexpr const char* const type_name_StorageLibraryLastChangeId = "StorageLibraryLastChangeId";
    ...
    constexpr const char* const type_name_StorageProvider = "StorageProvider";
    ...
    constexpr const char* const type_name_StorageStreamTransaction = "StorageStreamTransaction";
    ...
    constexpr const char* const type_name_StreamedFileDataRequest = "StreamedFileDataRequest";
    ...
    constexpr const char* const type_name_SystemAudioProperties = "SystemAudioProperties";
    ...
    constexpr const char* const type_name_SystemDataPaths = "SystemDataPaths";
    ...
    constexpr const char* const type_name_SystemGPSProperties = "SystemGPSProperties";
    ...
    constexpr const char* const type_name_SystemImageProperties = "SystemImageProperties";
    ...
    constexpr const char* const type_name_SystemMediaProperties = "SystemMediaProperties";
    ...
    constexpr const char* const type_name_SystemMusicProperties = "SystemMusicProperties";
    ...
    constexpr const char* const type_name_SystemPhotoProperties = "SystemPhotoProperties";
    ...
    constexpr const char* const type_name_SystemProperties = "SystemProperties";
    ...
    constexpr const char* const type_name_SystemVideoProperties = "SystemVideoProperties";
    ...
    // ----- UserDataPaths class --------------------
    constexpr const char* const type_name_UserDataPaths = "UserDataPaths";
    ...
    constexpr const char* const type_name_IStorageFile = "IStorageFile";
    ...
    constexpr const char* const type_name_IStorageFile2 = "IStorageFile2";
    ...
    constexpr const char* const type_name_IStorageFilePropertiesWithAvailability = "IStorageFilePropertiesWithAvailability";
    ...
    constexpr const char* const type_name_IStorageFolder = "IStorageFolder";
    ...
    constexpr const char* const type_name_IStorageFolder2 = "IStorageFolder2";
    ...
    constexpr const char* const type_name_IStorageItem = "IStorageItem";
    ...
    constexpr const char* const type_name_IStorageItem2 = "IStorageItem2";
    ...
    constexpr const char* const type_name_IStorageItemProperties = "IStorageItemProperties";
    ...
    constexpr const char* const type_name_IStorageItemProperties2 = "IStorageItemProperties2";
    ...
    constexpr const char* const type_name_IStorageItemPropertiesWithProvider = "IStorageItemPropertiesWithProvider";
    ...
    constexpr const char* const type_name_IStreamedFileDataRequest = "IStreamedFileDataRequest";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Storage(void) noexcept
{
    ...
    state->type_AppDataPaths = py::register_python_type(module.get(), type_name_AppDataPaths, &type_spec_AppDataPaths, bases.get());
    if (!state->type_AppDataPaths)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AppDataPaths);

    state->type_ApplicationData = py::register_python_type(module.get(), type_name_ApplicationData, &type_spec_ApplicationData, bases.get());
    if (!state->type_ApplicationData)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ApplicationData);

    state->type_ApplicationDataCompositeValue = py::register_python_type(module.get(), type_name_ApplicationDataCompositeValue, &type_spec_ApplicationDataCompositeValue, mutable_mapping_bases.get());
    if (!state->type_ApplicationDataCompositeValue)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ApplicationDataCompositeValue);

    state->type_ApplicationDataContainer = py::register_python_type(module.get(), type_name_ApplicationDataContainer, &type_spec_ApplicationDataContainer, bases.get());
    if (!state->type_ApplicationDataContainer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ApplicationDataContainer);

    state->type_ApplicationDataContainerSettings = py::register_python_type(module.get(), type_name_ApplicationDataContainerSettings, &type_spec_ApplicationDataContainerSettings, mutable_mapping_bases.get());
    if (!state->type_ApplicationDataContainerSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ApplicationDataContainerSettings);

    state->type_CachedFileManager = py::register_python_type(module.get(), type_name_CachedFileManager, &type_spec_CachedFileManager, nullptr);
    if (!state->type_CachedFileManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CachedFileManager);

    state->type_DownloadsFolder = py::register_python_type(module.get(), type_name_DownloadsFolder, &type_spec_DownloadsFolder, nullptr);
    if (!state->type_DownloadsFolder)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DownloadsFolder);

    state->type_FileIO = py::register_python_type(module.get(), type_name_FileIO, &type_spec_FileIO, nullptr);
    if (!state->type_FileIO)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FileIO);

    state->type_KnownFolders = py::register_python_type(module.get(), type_name_KnownFolders, &type_spec_KnownFolders, nullptr);
    if (!state->type_KnownFolders)
    {
        return nullptr;
    }

    Py_INCREF(state->type_KnownFolders);

    state->type_PathIO = py::register_python_type(module.get(), type_name_PathIO, &type_spec_PathIO, nullptr);
    if (!state->type_PathIO)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PathIO);

    state->type_SetVersionDeferral = py::register_python_type(module.get(), type_name_SetVersionDeferral, &type_spec_SetVersionDeferral, bases.get());
    if (!state->type_SetVersionDeferral)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SetVersionDeferral);

    state->type_SetVersionRequest = py::register_python_type(module.get(), type_name_SetVersionRequest, &type_spec_SetVersionRequest, bases.get());
    if (!state->type_SetVersionRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SetVersionRequest);

    state->type_StorageFile = py::register_python_type(module.get(), type_name_StorageFile, &type_spec_StorageFile, bases.get());
    if (!state->type_StorageFile)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorageFile);

    state->type_StorageFolder = py::register_python_type(module.get(), type_name_StorageFolder, &type_spec_StorageFolder, bases.get());
    if (!state->type_StorageFolder)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorageFolder);

    state->type_StorageLibrary = py::register_python_type(module.get(), type_name_StorageLibrary, &type_spec_StorageLibrary, bases.get());
    if (!state->type_StorageLibrary)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorageLibrary);

    state->type_StorageLibraryChange = py::register_python_type(module.get(), type_name_StorageLibraryChange, &type_spec_StorageLibraryChange, bases.get());
    if (!state->type_StorageLibraryChange)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorageLibraryChange);

    state->type_StorageLibraryChangeReader = py::register_python_type(module.get(), type_name_StorageLibraryChangeReader, &type_spec_StorageLibraryChangeReader, bases.get());
    if (!state->type_StorageLibraryChangeReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorageLibraryChangeReader);

    state->type_StorageLibraryChangeTracker = py::register_python_type(module.get(), type_name_StorageLibraryChangeTracker, &type_spec_StorageLibraryChangeTracker, bases.get());
    if (!state->type_StorageLibraryChangeTracker)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorageLibraryChangeTracker);

    state->type_StorageLibraryChangeTrackerOptions = py::register_python_type(module.get(), type_name_StorageLibraryChangeTrackerOptions, &type_spec_StorageLibraryChangeTrackerOptions, bases.get());
    if (!state->type_StorageLibraryChangeTrackerOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorageLibraryChangeTrackerOptions);

    state->type_StorageLibraryLastChangeId = py::register_python_type(module.get(), type_name_StorageLibraryLastChangeId, &type_spec_StorageLibraryLastChangeId, bases.get());
    if (!state->type_StorageLibraryLastChangeId)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorageLibraryLastChangeId);

    state->type_StorageProvider = py::register_python_type(module.get(), type_name_StorageProvider, &type_spec_StorageProvider, bases.get());
    if (!state->type_StorageProvider)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorageProvider);

    state->type_StorageStreamTransaction = py::register_python_type(module.get(), type_name_StorageStreamTransaction, &type_spec_StorageStreamTransaction, bases.get());
    if (!state->type_StorageStreamTransaction)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StorageStreamTransaction);

    state->type_StreamedFileDataRequest = py::register_python_type(module.get(), type_name_StreamedFileDataRequest, &type_spec_StreamedFileDataRequest, bases.get());
    if (!state->type_StreamedFileDataRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StreamedFileDataRequest);

    state->type_SystemAudioProperties = py::register_python_type(module.get(), type_name_SystemAudioProperties, &type_spec_SystemAudioProperties, bases.get());
    if (!state->type_SystemAudioProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemAudioProperties);

    state->type_SystemDataPaths = py::register_python_type(module.get(), type_name_SystemDataPaths, &type_spec_SystemDataPaths, bases.get());
    if (!state->type_SystemDataPaths)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemDataPaths);

    state->type_SystemGPSProperties = py::register_python_type(module.get(), type_name_SystemGPSProperties, &type_spec_SystemGPSProperties, bases.get());
    if (!state->type_SystemGPSProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemGPSProperties);

    state->type_SystemImageProperties = py::register_python_type(module.get(), type_name_SystemImageProperties, &type_spec_SystemImageProperties, bases.get());
    if (!state->type_SystemImageProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemImageProperties);

    state->type_SystemMediaProperties = py::register_python_type(module.get(), type_name_SystemMediaProperties, &type_spec_SystemMediaProperties, bases.get());
    if (!state->type_SystemMediaProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemMediaProperties);

    state->type_SystemMusicProperties = py::register_python_type(module.get(), type_name_SystemMusicProperties, &type_spec_SystemMusicProperties, bases.get());
    if (!state->type_SystemMusicProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemMusicProperties);

    state->type_SystemPhotoProperties = py::register_python_type(module.get(), type_name_SystemPhotoProperties, &type_spec_SystemPhotoProperties, bases.get());
    if (!state->type_SystemPhotoProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemPhotoProperties);

    state->type_SystemProperties = py::register_python_type(module.get(), type_name_SystemProperties, &type_spec_SystemProperties, nullptr);
    if (!state->type_SystemProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemProperties);

    state->type_SystemVideoProperties = py::register_python_type(module.get(), type_name_SystemVideoProperties, &type_spec_SystemVideoProperties, bases.get());
    if (!state->type_SystemVideoProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SystemVideoProperties);

    state->type_UserDataPaths = py::register_python_type(module.get(), type_name_UserDataPaths, &type_spec_UserDataPaths, bases.get());
    if (!state->type_UserDataPaths)
    {
        return nullptr;
    }

    Py_INCREF(state->type_UserDataPaths);

    state->type_IStorageFile = py::register_python_type(module.get(), type_name_IStorageFile, &type_spec_IStorageFile, bases.get());
    if (!state->type_IStorageFile)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IStorageFile);

    state->type_IStorageFile2 = py::register_python_type(module.get(), type_name_IStorageFile2, &type_spec_IStorageFile2, bases.get());
    if (!state->type_IStorageFile2)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IStorageFile2);

    state->type_IStorageFilePropertiesWithAvailability = py::register_python_type(module.get(), type_name_IStorageFilePropertiesWithAvailability, &type_spec_IStorageFilePropertiesWithAvailability, bases.get());
    if (!state->type_IStorageFilePropertiesWithAvailability)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IStorageFilePropertiesWithAvailability);

    state->type_IStorageFolder = py::register_python_type(module.get(), type_name_IStorageFolder, &type_spec_IStorageFolder, bases.get());
    if (!state->type_IStorageFolder)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IStorageFolder);

    state->type_IStorageFolder2 = py::register_python_type(module.get(), type_name_IStorageFolder2, &type_spec_IStorageFolder2, bases.get());
    if (!state->type_IStorageFolder2)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IStorageFolder2);

    state->type_IStorageItem = py::register_python_type(module.get(), type_name_IStorageItem, &type_spec_IStorageItem, bases.get());
    if (!state->type_IStorageItem)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IStorageItem);

    state->type_IStorageItem2 = py::register_python_type(module.get(), type_name_IStorageItem2, &type_spec_IStorageItem2, bases.get());
    if (!state->type_IStorageItem2)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IStorageItem2);

    state->type_IStorageItemProperties = py::register_python_type(module.get(), type_name_IStorageItemProperties, &type_spec_IStorageItemProperties, bases.get());
    if (!state->type_IStorageItemProperties)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IStorageItemProperties);

    state->type_IStorageItemProperties2 = py::register_python_type(module.get(), type_name_IStorageItemProperties2, &type_spec_IStorageItemProperties2, bases.get());
    if (!state->type_IStorageItemProperties2)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IStorageItemProperties2);

    state->type_IStorageItemPropertiesWithProvider = py::register_python_type(module.get(), type_name_IStorageItemPropertiesWithProvider, &type_spec_IStorageItemPropertiesWithProvider, bases.get());
    if (!state->type_IStorageItemPropertiesWithProvider)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IStorageItemPropertiesWithProvider);

    state->type_IStreamedFileDataRequest = py::register_python_type(module.get(), type_name_IStreamedFileDataRequest, &type_spec_IStreamedFileDataRequest, bases.get());
    if (!state->type_IStreamedFileDataRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IStreamedFileDataRequest);
