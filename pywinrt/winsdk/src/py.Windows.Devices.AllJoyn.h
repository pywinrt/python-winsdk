...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::AllJoyn::AllJoynAuthenticationMechanism> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::AllJoyn::AllJoynBusAttachmentState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::AllJoyn::AllJoynSessionLostReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::AllJoyn::AllJoynTrafficType> = "i";
