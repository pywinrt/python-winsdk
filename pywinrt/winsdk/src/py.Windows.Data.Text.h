...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Data::Text::AlternateNormalizationFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Data::Text::TextPredictionOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Data::Text::UnicodeGeneralCategory> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Data::Text::UnicodeNumericType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Data::Text::TextSegment> = "T{I:start_position:I:length:}";
