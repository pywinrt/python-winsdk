...
winrt::Windows::Graphics::Display::Core::HdmiDisplayHdr2086Metadata py::converter<winrt::Windows::Graphics::Display::Core::HdmiDisplayHdr2086Metadata>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Graphics::Display::Core::HdmiDisplayHdr2086Metadata or dict");
    ...
    if (!py_RedPrimaryX) {
        PyErr_SetString(PyExc_KeyError, "RedPrimaryX");
        throw python_exception();
    }
    ...
    if (!py_RedPrimaryY) {
        PyErr_SetString(PyExc_KeyError, "RedPrimaryY");
        throw python_exception();
    }
    ...
    if (!py_GreenPrimaryX) {
        PyErr_SetString(PyExc_KeyError, "GreenPrimaryX");
        throw python_exception();
    }
    ...
    if (!py_GreenPrimaryY) {
        PyErr_SetString(PyExc_KeyError, "GreenPrimaryY");
        throw python_exception();
    }
    ...
    if (!py_BluePrimaryX) {
        PyErr_SetString(PyExc_KeyError, "BluePrimaryX");
        throw python_exception();
    }
    ...
    if (!py_BluePrimaryY) {
        PyErr_SetString(PyExc_KeyError, "BluePrimaryY");
        throw python_exception();
    }
    ...
    if (!py_WhitePointX) {
        PyErr_SetString(PyExc_KeyError, "WhitePointX");
        throw python_exception();
    }
    ...
    if (!py_WhitePointY) {
        PyErr_SetString(PyExc_KeyError, "WhitePointY");
        throw python_exception();
    }
    ...
    if (!py_MaxMasteringLuminance) {
        PyErr_SetString(PyExc_KeyError, "MaxMasteringLuminance");
        throw python_exception();
    }
    ...
    if (!py_MinMasteringLuminance) {
        PyErr_SetString(PyExc_KeyError, "MinMasteringLuminance");
        throw python_exception();
    }
    ...
    if (!py_MaxContentLightLevel) {
        PyErr_SetString(PyExc_KeyError, "MaxContentLightLevel");
        throw python_exception();
    }
    ...
    if (!py_MaxFrameAverageLightLevel) {
        PyErr_SetString(PyExc_KeyError, "MaxFrameAverageLightLevel");
        throw python_exception();
    }
