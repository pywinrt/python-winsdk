...
namespace py::cpp::Windows::Graphics::Display::Core
{
    ...
    static PyObject* register_HdmiDisplayColorSpace(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_HdmiDisplayHdrOption(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_HdmiDisplayPixelEncoding(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_HdmiDisplayInformation = "HdmiDisplayInformation";
    ...
    constexpr const char* const type_name_HdmiDisplayMode = "HdmiDisplayMode";
    ...
    constexpr const char* const type_name_HdmiDisplayHdr2086Metadata = "HdmiDisplayHdr2086Metadata";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Graphics_Display_Core(void) noexcept
{
    ...
    state->type_HdmiDisplayInformation = py::register_python_type(module.get(), type_name_HdmiDisplayInformation, &type_spec_HdmiDisplayInformation, bases.get());
    if (!state->type_HdmiDisplayInformation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HdmiDisplayInformation);

    state->type_HdmiDisplayMode = py::register_python_type(module.get(), type_name_HdmiDisplayMode, &type_spec_HdmiDisplayMode, bases.get());
    if (!state->type_HdmiDisplayMode)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HdmiDisplayMode);

    state->type_HdmiDisplayHdr2086Metadata = py::register_python_type(module.get(), type_name_HdmiDisplayHdr2086Metadata, &type_spec_HdmiDisplayHdr2086Metadata, bases.get());
    if (!state->type_HdmiDisplayHdr2086Metadata)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HdmiDisplayHdr2086Metadata);
