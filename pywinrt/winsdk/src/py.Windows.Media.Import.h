...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportAccessMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportConnectionTransport> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportContentType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportContentTypeFilter> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportImportMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportItemSelectionMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportPowerSource> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportSourceType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportStage> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportStorageMediumType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportSubfolderCreationMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportSubfolderDateFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Import::PhotoImportProgress> = "T{I:items_imported:I:total_items_to_import:Q:bytes_imported:Q:total_bytes_to_import:d:import_progress:}";
