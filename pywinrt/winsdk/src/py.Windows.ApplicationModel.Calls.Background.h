...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Calls::Background::PhoneCallBlockedReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Calls::Background::PhoneIncomingCallDismissedReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Calls::Background::PhoneLineChangeKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Calls::Background::PhoneLineProperties> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Calls::Background::PhoneTriggerType> = "i";
