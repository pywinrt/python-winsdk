...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Diagnostics::CausalityRelation> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Diagnostics::CausalitySource> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Diagnostics::CausalitySynchronousWork> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Diagnostics::CausalityTraceLevel> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Diagnostics::ErrorOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Diagnostics::LoggingFieldFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Diagnostics::LoggingLevel> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Foundation::Diagnostics::LoggingOpcode> = "i";
