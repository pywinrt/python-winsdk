...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Display::AdvancedColorKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Display::DisplayBrightnessOverrideOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Display::DisplayBrightnessOverrideScenario> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Display::DisplayBrightnessScenario> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Display::DisplayColorOverrideScenario> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Display::DisplayOrientations> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Display::HdrMetadataFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Display::ResolutionScale> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::Display::NitRange> = "T{f:min_nits:f:max_nits:f:step_size_nits:}";
