...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Maps::OfflineMaps::OfflineMapPackageQueryStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Maps::OfflineMaps::OfflineMapPackageStartDownloadStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Services::Maps::OfflineMaps::OfflineMapPackageStatus> = "i";
