...
namespace py::cpp::Windows::Devices::Lights::Effects
{
    ...
    static PyType_Slot _type_slots_LampArrayEffectPlaylist[] = 
    {
        ...
        { Py_mp_subscript, _seq_subscript_LampArrayEffectPlaylist },
        { },
    };
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Lights_Effects(void) noexcept
{
    ...
    state->type_LampArrayBitmapEffect = py::register_python_type(module.get(), type_name_LampArrayBitmapEffect, &type_spec_LampArrayBitmapEffect, bases.get(), nullptr);
    if (!state->type_LampArrayBitmapEffect)
    {
        return nullptr;
    }

    state->type_LampArrayBitmapRequestedEventArgs = py::register_python_type(module.get(), type_name_LampArrayBitmapRequestedEventArgs, &type_spec_LampArrayBitmapRequestedEventArgs, bases.get(), nullptr);
    if (!state->type_LampArrayBitmapRequestedEventArgs)
    {
        return nullptr;
    }

    state->type_LampArrayBlinkEffect = py::register_python_type(module.get(), type_name_LampArrayBlinkEffect, &type_spec_LampArrayBlinkEffect, bases.get(), nullptr);
    if (!state->type_LampArrayBlinkEffect)
    {
        return nullptr;
    }

    state->type_LampArrayColorRampEffect = py::register_python_type(module.get(), type_name_LampArrayColorRampEffect, &type_spec_LampArrayColorRampEffect, bases.get(), nullptr);
    if (!state->type_LampArrayColorRampEffect)
    {
        return nullptr;
    }

    state->type_LampArrayCustomEffect = py::register_python_type(module.get(), type_name_LampArrayCustomEffect, &type_spec_LampArrayCustomEffect, bases.get(), nullptr);
    if (!state->type_LampArrayCustomEffect)
    {
        return nullptr;
    }

    state->type_LampArrayEffectPlaylist = py::register_python_type(module.get(), type_name_LampArrayEffectPlaylist, &type_spec_LampArrayEffectPlaylist, sequence_bases.get(), nullptr);
    if (!state->type_LampArrayEffectPlaylist)
    {
        return nullptr;
    }

    state->type_LampArraySolidEffect = py::register_python_type(module.get(), type_name_LampArraySolidEffect, &type_spec_LampArraySolidEffect, bases.get(), nullptr);
    if (!state->type_LampArraySolidEffect)
    {
        return nullptr;
    }

    state->type_LampArrayUpdateRequestedEventArgs = py::register_python_type(module.get(), type_name_LampArrayUpdateRequestedEventArgs, &type_spec_LampArrayUpdateRequestedEventArgs, bases.get(), nullptr);
    if (!state->type_LampArrayUpdateRequestedEventArgs)
    {
        return nullptr;
    }

    state->type_ILampArrayEffect = py::register_python_type(module.get(), type_name_ILampArrayEffect, &type_spec_ILampArrayEffect, bases.get(), nullptr);
