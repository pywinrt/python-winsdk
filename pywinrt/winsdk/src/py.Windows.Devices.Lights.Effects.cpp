...
namespace py::cpp::Windows::Devices::Lights::Effects
{
    ...
    static PyObject* register_LampArrayEffectCompletionBehavior(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_LampArrayEffectStartMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LampArrayRepetitionMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_LampArrayBitmapEffect = "LampArrayBitmapEffect";
    ...
    constexpr const char* const type_name_LampArrayBitmapRequestedEventArgs = "LampArrayBitmapRequestedEventArgs";
    ...
    constexpr const char* const type_name_LampArrayBlinkEffect = "LampArrayBlinkEffect";
    ...
    constexpr const char* const type_name_LampArrayColorRampEffect = "LampArrayColorRampEffect";
    ...
    constexpr const char* const type_name_LampArrayCustomEffect = "LampArrayCustomEffect";
    ...
    constexpr const char* const type_name_LampArrayEffectPlaylist = "LampArrayEffectPlaylist";
    ...
    static PyObject* LampArrayEffectPlaylist_GetMany(py::wrapper::Windows::Devices::Lights::Effects::LampArrayEffectPlaylist* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Devices.Lights.Effects.LampArrayEffectPlaylist", L"GetMany", 2))
            {
    ...
    static PyObject* LampArrayEffectPlaylist_get_insert(PyObject* self) noexcept
    {
    ...
    constexpr const char* const type_name_LampArraySolidEffect = "LampArraySolidEffect";
    ...
    constexpr const char* const type_name_LampArrayUpdateRequestedEventArgs = "LampArrayUpdateRequestedEventArgs";
    ...
    constexpr const char* const type_name_ILampArrayEffect = "ILampArrayEffect";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Lights_Effects(void) noexcept
{
    ...
    state->type_LampArrayBitmapEffect = py::register_python_type(module.get(), type_name_LampArrayBitmapEffect, &type_spec_LampArrayBitmapEffect, bases.get());
    if (!state->type_LampArrayBitmapEffect)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LampArrayBitmapEffect);

    state->type_LampArrayBitmapRequestedEventArgs = py::register_python_type(module.get(), type_name_LampArrayBitmapRequestedEventArgs, &type_spec_LampArrayBitmapRequestedEventArgs, bases.get());
    if (!state->type_LampArrayBitmapRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LampArrayBitmapRequestedEventArgs);

    state->type_LampArrayBlinkEffect = py::register_python_type(module.get(), type_name_LampArrayBlinkEffect, &type_spec_LampArrayBlinkEffect, bases.get());
    if (!state->type_LampArrayBlinkEffect)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LampArrayBlinkEffect);

    state->type_LampArrayColorRampEffect = py::register_python_type(module.get(), type_name_LampArrayColorRampEffect, &type_spec_LampArrayColorRampEffect, bases.get());
    if (!state->type_LampArrayColorRampEffect)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LampArrayColorRampEffect);

    state->type_LampArrayCustomEffect = py::register_python_type(module.get(), type_name_LampArrayCustomEffect, &type_spec_LampArrayCustomEffect, bases.get());
    if (!state->type_LampArrayCustomEffect)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LampArrayCustomEffect);

    state->type_LampArrayEffectPlaylist = py::register_python_type(module.get(), type_name_LampArrayEffectPlaylist, &type_spec_LampArrayEffectPlaylist, sequence_bases.get());
    if (!state->type_LampArrayEffectPlaylist)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LampArrayEffectPlaylist);

    state->type_LampArraySolidEffect = py::register_python_type(module.get(), type_name_LampArraySolidEffect, &type_spec_LampArraySolidEffect, bases.get());
    if (!state->type_LampArraySolidEffect)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LampArraySolidEffect);

    state->type_LampArrayUpdateRequestedEventArgs = py::register_python_type(module.get(), type_name_LampArrayUpdateRequestedEventArgs, &type_spec_LampArrayUpdateRequestedEventArgs, bases.get());
    if (!state->type_LampArrayUpdateRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LampArrayUpdateRequestedEventArgs);

    state->type_ILampArrayEffect = py::register_python_type(module.get(), type_name_ILampArrayEffect, &type_spec_ILampArrayEffect, bases.get());
    if (!state->type_ILampArrayEffect)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ILampArrayEffect);
