...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_Activation(void) noexcept
{
    ...
    state->type_AppointmentsProviderAddAppointmentActivatedEventArgs = py::register_python_type(module.get(), type_name_AppointmentsProviderAddAppointmentActivatedEventArgs, &type_spec_AppointmentsProviderAddAppointmentActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_AppointmentsProviderAddAppointmentActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_AppointmentsProviderRemoveAppointmentActivatedEventArgs = py::register_python_type(module.get(), type_name_AppointmentsProviderRemoveAppointmentActivatedEventArgs, &type_spec_AppointmentsProviderRemoveAppointmentActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_AppointmentsProviderRemoveAppointmentActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_AppointmentsProviderReplaceAppointmentActivatedEventArgs = py::register_python_type(module.get(), type_name_AppointmentsProviderReplaceAppointmentActivatedEventArgs, &type_spec_AppointmentsProviderReplaceAppointmentActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_AppointmentsProviderReplaceAppointmentActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_AppointmentsProviderShowAppointmentDetailsActivatedEventArgs = py::register_python_type(module.get(), type_name_AppointmentsProviderShowAppointmentDetailsActivatedEventArgs, &type_spec_AppointmentsProviderShowAppointmentDetailsActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_AppointmentsProviderShowAppointmentDetailsActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_AppointmentsProviderShowTimeFrameActivatedEventArgs = py::register_python_type(module.get(), type_name_AppointmentsProviderShowTimeFrameActivatedEventArgs, &type_spec_AppointmentsProviderShowTimeFrameActivatedEventArgs, bases.get(), nullptr);
    ...
    state->type_BarcodeScannerPreviewActivatedEventArgs = py::register_python_type(module.get(), type_name_BarcodeScannerPreviewActivatedEventArgs, &type_spec_BarcodeScannerPreviewActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_BarcodeScannerPreviewActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_CachedFileUpdaterActivatedEventArgs = py::register_python_type(module.get(), type_name_CachedFileUpdaterActivatedEventArgs, &type_spec_CachedFileUpdaterActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_CachedFileUpdaterActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_CameraSettingsActivatedEventArgs = py::register_python_type(module.get(), type_name_CameraSettingsActivatedEventArgs, &type_spec_CameraSettingsActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_CameraSettingsActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_CommandLineActivatedEventArgs = py::register_python_type(module.get(), type_name_CommandLineActivatedEventArgs, &type_spec_CommandLineActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_CommandLineActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_CommandLineActivationOperation = py::register_python_type(module.get(), type_name_CommandLineActivationOperation, &type_spec_CommandLineActivationOperation, bases.get(), nullptr);
    if (!state->type_CommandLineActivationOperation)
    {
        return nullptr;
    }

    state->type_ContactCallActivatedEventArgs = py::register_python_type(module.get(), type_name_ContactCallActivatedEventArgs, &type_spec_ContactCallActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ContactCallActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ContactMapActivatedEventArgs = py::register_python_type(module.get(), type_name_ContactMapActivatedEventArgs, &type_spec_ContactMapActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ContactMapActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ContactMessageActivatedEventArgs = py::register_python_type(module.get(), type_name_ContactMessageActivatedEventArgs, &type_spec_ContactMessageActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ContactMessageActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ContactPanelActivatedEventArgs = py::register_python_type(module.get(), type_name_ContactPanelActivatedEventArgs, &type_spec_ContactPanelActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ContactPanelActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ContactPickerActivatedEventArgs = py::register_python_type(module.get(), type_name_ContactPickerActivatedEventArgs, &type_spec_ContactPickerActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ContactPickerActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ContactPostActivatedEventArgs = py::register_python_type(module.get(), type_name_ContactPostActivatedEventArgs, &type_spec_ContactPostActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ContactPostActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ContactVideoCallActivatedEventArgs = py::register_python_type(module.get(), type_name_ContactVideoCallActivatedEventArgs, &type_spec_ContactVideoCallActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ContactVideoCallActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_DeviceActivatedEventArgs = py::register_python_type(module.get(), type_name_DeviceActivatedEventArgs, &type_spec_DeviceActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_DeviceActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_DevicePairingActivatedEventArgs = py::register_python_type(module.get(), type_name_DevicePairingActivatedEventArgs, &type_spec_DevicePairingActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_DevicePairingActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_DialReceiverActivatedEventArgs = py::register_python_type(module.get(), type_name_DialReceiverActivatedEventArgs, &type_spec_DialReceiverActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_DialReceiverActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_FileActivatedEventArgs = py::register_python_type(module.get(), type_name_FileActivatedEventArgs, &type_spec_FileActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_FileActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_FileOpenPickerActivatedEventArgs = py::register_python_type(module.get(), type_name_FileOpenPickerActivatedEventArgs, &type_spec_FileOpenPickerActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_FileOpenPickerActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_FileOpenPickerContinuationEventArgs = py::register_python_type(module.get(), type_name_FileOpenPickerContinuationEventArgs, &type_spec_FileOpenPickerContinuationEventArgs, bases.get(), nullptr);
    if (!state->type_FileOpenPickerContinuationEventArgs)
    {
        return nullptr;
    }

    state->type_FileSavePickerActivatedEventArgs = py::register_python_type(module.get(), type_name_FileSavePickerActivatedEventArgs, &type_spec_FileSavePickerActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_FileSavePickerActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_FileSavePickerContinuationEventArgs = py::register_python_type(module.get(), type_name_FileSavePickerContinuationEventArgs, &type_spec_FileSavePickerContinuationEventArgs, bases.get(), nullptr);
    if (!state->type_FileSavePickerContinuationEventArgs)
    {
        return nullptr;
    }

    state->type_FolderPickerContinuationEventArgs = py::register_python_type(module.get(), type_name_FolderPickerContinuationEventArgs, &type_spec_FolderPickerContinuationEventArgs, bases.get(), nullptr);
    if (!state->type_FolderPickerContinuationEventArgs)
    {
        return nullptr;
    }

    state->type_LaunchActivatedEventArgs = py::register_python_type(module.get(), type_name_LaunchActivatedEventArgs, &type_spec_LaunchActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_LaunchActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_LockScreenActivatedEventArgs = py::register_python_type(module.get(), type_name_LockScreenActivatedEventArgs, &type_spec_LockScreenActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_LockScreenActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_LockScreenCallActivatedEventArgs = py::register_python_type(module.get(), type_name_LockScreenCallActivatedEventArgs, &type_spec_LockScreenCallActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_LockScreenCallActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_LockScreenComponentActivatedEventArgs = py::register_python_type(module.get(), type_name_LockScreenComponentActivatedEventArgs, &type_spec_LockScreenComponentActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_LockScreenComponentActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_PhoneCallActivatedEventArgs = py::register_python_type(module.get(), type_name_PhoneCallActivatedEventArgs, &type_spec_PhoneCallActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_PhoneCallActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_PickerReturnedActivatedEventArgs = py::register_python_type(module.get(), type_name_PickerReturnedActivatedEventArgs, &type_spec_PickerReturnedActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_PickerReturnedActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_Print3DWorkflowActivatedEventArgs = py::register_python_type(module.get(), type_name_Print3DWorkflowActivatedEventArgs, &type_spec_Print3DWorkflowActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_Print3DWorkflowActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_PrintTaskSettingsActivatedEventArgs = py::register_python_type(module.get(), type_name_PrintTaskSettingsActivatedEventArgs, &type_spec_PrintTaskSettingsActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_PrintTaskSettingsActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ProtocolActivatedEventArgs = py::register_python_type(module.get(), type_name_ProtocolActivatedEventArgs, &type_spec_ProtocolActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ProtocolActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ProtocolForResultsActivatedEventArgs = py::register_python_type(module.get(), type_name_ProtocolForResultsActivatedEventArgs, &type_spec_ProtocolForResultsActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ProtocolForResultsActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_RestrictedLaunchActivatedEventArgs = py::register_python_type(module.get(), type_name_RestrictedLaunchActivatedEventArgs, &type_spec_RestrictedLaunchActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_RestrictedLaunchActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_SearchActivatedEventArgs = py::register_python_type(module.get(), type_name_SearchActivatedEventArgs, &type_spec_SearchActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_SearchActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ShareTargetActivatedEventArgs = py::register_python_type(module.get(), type_name_ShareTargetActivatedEventArgs, &type_spec_ShareTargetActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ShareTargetActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_SplashScreen = py::register_python_type(module.get(), type_name_SplashScreen, &type_spec_SplashScreen, bases.get(), nullptr);
    if (!state->type_SplashScreen)
    {
        return nullptr;
    }

    state->type_StartupTaskActivatedEventArgs = py::register_python_type(module.get(), type_name_StartupTaskActivatedEventArgs, &type_spec_StartupTaskActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_StartupTaskActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_TileActivatedInfo = py::register_python_type(module.get(), type_name_TileActivatedInfo, &type_spec_TileActivatedInfo, bases.get(), nullptr);
    if (!state->type_TileActivatedInfo)
    {
        return nullptr;
    }

    state->type_ToastNotificationActivatedEventArgs = py::register_python_type(module.get(), type_name_ToastNotificationActivatedEventArgs, &type_spec_ToastNotificationActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ToastNotificationActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_UserDataAccountProviderActivatedEventArgs = py::register_python_type(module.get(), type_name_UserDataAccountProviderActivatedEventArgs, &type_spec_UserDataAccountProviderActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_UserDataAccountProviderActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_VoiceCommandActivatedEventArgs = py::register_python_type(module.get(), type_name_VoiceCommandActivatedEventArgs, &type_spec_VoiceCommandActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_VoiceCommandActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_WalletActionActivatedEventArgs = py::register_python_type(module.get(), type_name_WalletActionActivatedEventArgs, &type_spec_WalletActionActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_WalletActionActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_WebAccountProviderActivatedEventArgs = py::register_python_type(module.get(), type_name_WebAccountProviderActivatedEventArgs, &type_spec_WebAccountProviderActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_WebAccountProviderActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_WebAuthenticationBrokerContinuationEventArgs = py::register_python_type(module.get(), type_name_WebAuthenticationBrokerContinuationEventArgs, &type_spec_WebAuthenticationBrokerContinuationEventArgs, bases.get(), nullptr);
    if (!state->type_WebAuthenticationBrokerContinuationEventArgs)
    {
        return nullptr;
    }

    state->type_IActivatedEventArgs = py::register_python_type(module.get(), type_name_IActivatedEventArgs, &type_spec_IActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IActivatedEventArgsWithUser = py::register_python_type(module.get(), type_name_IActivatedEventArgsWithUser, &type_spec_IActivatedEventArgsWithUser, bases.get(), nullptr);
    if (!state->type_IActivatedEventArgsWithUser)
    {
        return nullptr;
    }

    state->type_IApplicationViewActivatedEventArgs = py::register_python_type(module.get(), type_name_IApplicationViewActivatedEventArgs, &type_spec_IApplicationViewActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IApplicationViewActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IAppointmentsProviderActivatedEventArgs = py::register_python_type(module.get(), type_name_IAppointmentsProviderActivatedEventArgs, &type_spec_IAppointmentsProviderActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IAppointmentsProviderActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IAppointmentsProviderAddAppointmentActivatedEventArgs = py::register_python_type(module.get(), type_name_IAppointmentsProviderAddAppointmentActivatedEventArgs, &type_spec_IAppointmentsProviderAddAppointmentActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IAppointmentsProviderAddAppointmentActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IAppointmentsProviderRemoveAppointmentActivatedEventArgs = py::register_python_type(module.get(), type_name_IAppointmentsProviderRemoveAppointmentActivatedEventArgs, &type_spec_IAppointmentsProviderRemoveAppointmentActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IAppointmentsProviderRemoveAppointmentActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IAppointmentsProviderReplaceAppointmentActivatedEventArgs = py::register_python_type(module.get(), type_name_IAppointmentsProviderReplaceAppointmentActivatedEventArgs, &type_spec_IAppointmentsProviderReplaceAppointmentActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IAppointmentsProviderReplaceAppointmentActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IAppointmentsProviderShowAppointmentDetailsActivatedEventArgs = py::register_python_type(module.get(), type_name_IAppointmentsProviderShowAppointmentDetailsActivatedEventArgs, &type_spec_IAppointmentsProviderShowAppointmentDetailsActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IAppointmentsProviderShowAppointmentDetailsActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IAppointmentsProviderShowTimeFrameActivatedEventArgs = py::register_python_type(module.get(), type_name_IAppointmentsProviderShowTimeFrameActivatedEventArgs, &type_spec_IAppointmentsProviderShowTimeFrameActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IAppointmentsProviderShowTimeFrameActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IBackgroundActivatedEventArgs = py::register_python_type(module.get(), type_name_IBackgroundActivatedEventArgs, &type_spec_IBackgroundActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IBackgroundActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IBarcodeScannerPreviewActivatedEventArgs = py::register_python_type(module.get(), type_name_IBarcodeScannerPreviewActivatedEventArgs, &type_spec_IBarcodeScannerPreviewActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IBarcodeScannerPreviewActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ICachedFileUpdaterActivatedEventArgs = py::register_python_type(module.get(), type_name_ICachedFileUpdaterActivatedEventArgs, &type_spec_ICachedFileUpdaterActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ICachedFileUpdaterActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ICameraSettingsActivatedEventArgs = py::register_python_type(module.get(), type_name_ICameraSettingsActivatedEventArgs, &type_spec_ICameraSettingsActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ICameraSettingsActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ICommandLineActivatedEventArgs = py::register_python_type(module.get(), type_name_ICommandLineActivatedEventArgs, &type_spec_ICommandLineActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ICommandLineActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IContactActivatedEventArgs = py::register_python_type(module.get(), type_name_IContactActivatedEventArgs, &type_spec_IContactActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IContactActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IContactCallActivatedEventArgs = py::register_python_type(module.get(), type_name_IContactCallActivatedEventArgs, &type_spec_IContactCallActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IContactCallActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IContactMapActivatedEventArgs = py::register_python_type(module.get(), type_name_IContactMapActivatedEventArgs, &type_spec_IContactMapActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IContactMapActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IContactMessageActivatedEventArgs = py::register_python_type(module.get(), type_name_IContactMessageActivatedEventArgs, &type_spec_IContactMessageActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IContactMessageActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IContactPanelActivatedEventArgs = py::register_python_type(module.get(), type_name_IContactPanelActivatedEventArgs, &type_spec_IContactPanelActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IContactPanelActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IContactPickerActivatedEventArgs = py::register_python_type(module.get(), type_name_IContactPickerActivatedEventArgs, &type_spec_IContactPickerActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IContactPickerActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IContactPostActivatedEventArgs = py::register_python_type(module.get(), type_name_IContactPostActivatedEventArgs, &type_spec_IContactPostActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IContactPostActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IContactVideoCallActivatedEventArgs = py::register_python_type(module.get(), type_name_IContactVideoCallActivatedEventArgs, &type_spec_IContactVideoCallActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IContactVideoCallActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IContactsProviderActivatedEventArgs = py::register_python_type(module.get(), type_name_IContactsProviderActivatedEventArgs, &type_spec_IContactsProviderActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IContactsProviderActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IContinuationActivatedEventArgs = py::register_python_type(module.get(), type_name_IContinuationActivatedEventArgs, &type_spec_IContinuationActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IContinuationActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IDeviceActivatedEventArgs = py::register_python_type(module.get(), type_name_IDeviceActivatedEventArgs, &type_spec_IDeviceActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IDeviceActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IDevicePairingActivatedEventArgs = py::register_python_type(module.get(), type_name_IDevicePairingActivatedEventArgs, &type_spec_IDevicePairingActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IDevicePairingActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IDialReceiverActivatedEventArgs = py::register_python_type(module.get(), type_name_IDialReceiverActivatedEventArgs, &type_spec_IDialReceiverActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IDialReceiverActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IFileActivatedEventArgs = py::register_python_type(module.get(), type_name_IFileActivatedEventArgs, &type_spec_IFileActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IFileActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IFileActivatedEventArgsWithCallerPackageFamilyName = py::register_python_type(module.get(), type_name_IFileActivatedEventArgsWithCallerPackageFamilyName, &type_spec_IFileActivatedEventArgsWithCallerPackageFamilyName, bases.get(), nullptr);
    if (!state->type_IFileActivatedEventArgsWithCallerPackageFamilyName)
    {
        return nullptr;
    }

    state->type_IFileActivatedEventArgsWithNeighboringFiles = py::register_python_type(module.get(), type_name_IFileActivatedEventArgsWithNeighboringFiles, &type_spec_IFileActivatedEventArgsWithNeighboringFiles, bases.get(), nullptr);
    if (!state->type_IFileActivatedEventArgsWithNeighboringFiles)
    {
        return nullptr;
    }

    state->type_IFileOpenPickerActivatedEventArgs = py::register_python_type(module.get(), type_name_IFileOpenPickerActivatedEventArgs, &type_spec_IFileOpenPickerActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IFileOpenPickerActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IFileOpenPickerActivatedEventArgs2 = py::register_python_type(module.get(), type_name_IFileOpenPickerActivatedEventArgs2, &type_spec_IFileOpenPickerActivatedEventArgs2, bases.get(), nullptr);
    if (!state->type_IFileOpenPickerActivatedEventArgs2)
    {
        return nullptr;
    }

    state->type_IFileOpenPickerContinuationEventArgs = py::register_python_type(module.get(), type_name_IFileOpenPickerContinuationEventArgs, &type_spec_IFileOpenPickerContinuationEventArgs, bases.get(), nullptr);
    if (!state->type_IFileOpenPickerContinuationEventArgs)
    {
        return nullptr;
    }

    state->type_IFileSavePickerActivatedEventArgs = py::register_python_type(module.get(), type_name_IFileSavePickerActivatedEventArgs, &type_spec_IFileSavePickerActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IFileSavePickerActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IFileSavePickerActivatedEventArgs2 = py::register_python_type(module.get(), type_name_IFileSavePickerActivatedEventArgs2, &type_spec_IFileSavePickerActivatedEventArgs2, bases.get(), nullptr);
    if (!state->type_IFileSavePickerActivatedEventArgs2)
    {
        return nullptr;
    }

    state->type_IFileSavePickerContinuationEventArgs = py::register_python_type(module.get(), type_name_IFileSavePickerContinuationEventArgs, &type_spec_IFileSavePickerContinuationEventArgs, bases.get(), nullptr);
    if (!state->type_IFileSavePickerContinuationEventArgs)
    {
        return nullptr;
    }

    state->type_IFolderPickerContinuationEventArgs = py::register_python_type(module.get(), type_name_IFolderPickerContinuationEventArgs, &type_spec_IFolderPickerContinuationEventArgs, bases.get(), nullptr);
    if (!state->type_IFolderPickerContinuationEventArgs)
    {
        return nullptr;
    }

    state->type_ILaunchActivatedEventArgs = py::register_python_type(module.get(), type_name_ILaunchActivatedEventArgs, &type_spec_ILaunchActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ILaunchActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ILaunchActivatedEventArgs2 = py::register_python_type(module.get(), type_name_ILaunchActivatedEventArgs2, &type_spec_ILaunchActivatedEventArgs2, bases.get(), nullptr);
    if (!state->type_ILaunchActivatedEventArgs2)
    {
        return nullptr;
    }

    state->type_ILockScreenActivatedEventArgs = py::register_python_type(module.get(), type_name_ILockScreenActivatedEventArgs, &type_spec_ILockScreenActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ILockScreenActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ILockScreenCallActivatedEventArgs = py::register_python_type(module.get(), type_name_ILockScreenCallActivatedEventArgs, &type_spec_ILockScreenCallActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ILockScreenCallActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IPhoneCallActivatedEventArgs = py::register_python_type(module.get(), type_name_IPhoneCallActivatedEventArgs, &type_spec_IPhoneCallActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IPhoneCallActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IPickerReturnedActivatedEventArgs = py::register_python_type(module.get(), type_name_IPickerReturnedActivatedEventArgs, &type_spec_IPickerReturnedActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IPickerReturnedActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IPrelaunchActivatedEventArgs = py::register_python_type(module.get(), type_name_IPrelaunchActivatedEventArgs, &type_spec_IPrelaunchActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IPrelaunchActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IPrint3DWorkflowActivatedEventArgs = py::register_python_type(module.get(), type_name_IPrint3DWorkflowActivatedEventArgs, &type_spec_IPrint3DWorkflowActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IPrint3DWorkflowActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IPrintTaskSettingsActivatedEventArgs = py::register_python_type(module.get(), type_name_IPrintTaskSettingsActivatedEventArgs, &type_spec_IPrintTaskSettingsActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IPrintTaskSettingsActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IProtocolActivatedEventArgs = py::register_python_type(module.get(), type_name_IProtocolActivatedEventArgs, &type_spec_IProtocolActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IProtocolActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IProtocolActivatedEventArgsWithCallerPackageFamilyNameAndData = py::register_python_type(module.get(), type_name_IProtocolActivatedEventArgsWithCallerPackageFamilyNameAndData, &type_spec_IProtocolActivatedEventArgsWithCallerPackageFamilyNameAndData, bases.get(), nullptr);
    if (!state->type_IProtocolActivatedEventArgsWithCallerPackageFamilyNameAndData)
    {
        return nullptr;
    }

    state->type_IProtocolForResultsActivatedEventArgs = py::register_python_type(module.get(), type_name_IProtocolForResultsActivatedEventArgs, &type_spec_IProtocolForResultsActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IProtocolForResultsActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IRestrictedLaunchActivatedEventArgs = py::register_python_type(module.get(), type_name_IRestrictedLaunchActivatedEventArgs, &type_spec_IRestrictedLaunchActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IRestrictedLaunchActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ISearchActivatedEventArgs = py::register_python_type(module.get(), type_name_ISearchActivatedEventArgs, &type_spec_ISearchActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_ISearchActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_ISearchActivatedEventArgsWithLinguisticDetails = py::register_python_type(module.get(), type_name_ISearchActivatedEventArgsWithLinguisticDetails, &type_spec_ISearchActivatedEventArgsWithLinguisticDetails, bases.get(), nullptr);
    if (!state->type_ISearchActivatedEventArgsWithLinguisticDetails)
    {
        return nullptr;
    }

    state->type_IShareTargetActivatedEventArgs = py::register_python_type(module.get(), type_name_IShareTargetActivatedEventArgs, &type_spec_IShareTargetActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IShareTargetActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IStartupTaskActivatedEventArgs = py::register_python_type(module.get(), type_name_IStartupTaskActivatedEventArgs, &type_spec_IStartupTaskActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IStartupTaskActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IToastNotificationActivatedEventArgs = py::register_python_type(module.get(), type_name_IToastNotificationActivatedEventArgs, &type_spec_IToastNotificationActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IToastNotificationActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IUserDataAccountProviderActivatedEventArgs = py::register_python_type(module.get(), type_name_IUserDataAccountProviderActivatedEventArgs, &type_spec_IUserDataAccountProviderActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IUserDataAccountProviderActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IViewSwitcherProvider = py::register_python_type(module.get(), type_name_IViewSwitcherProvider, &type_spec_IViewSwitcherProvider, bases.get(), nullptr);
    if (!state->type_IViewSwitcherProvider)
    {
        return nullptr;
    }

    state->type_IVoiceCommandActivatedEventArgs = py::register_python_type(module.get(), type_name_IVoiceCommandActivatedEventArgs, &type_spec_IVoiceCommandActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IVoiceCommandActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IWalletActionActivatedEventArgs = py::register_python_type(module.get(), type_name_IWalletActionActivatedEventArgs, &type_spec_IWalletActionActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IWalletActionActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IWebAccountProviderActivatedEventArgs = py::register_python_type(module.get(), type_name_IWebAccountProviderActivatedEventArgs, &type_spec_IWebAccountProviderActivatedEventArgs, bases.get(), nullptr);
    if (!state->type_IWebAccountProviderActivatedEventArgs)
    {
        return nullptr;
    }

    state->type_IWebAuthenticationBrokerContinuationEventArgs = py::register_python_type(module.get(), type_name_IWebAuthenticationBrokerContinuationEventArgs, &type_spec_IWebAuthenticationBrokerContinuationEventArgs, bases.get(), nullptr);
