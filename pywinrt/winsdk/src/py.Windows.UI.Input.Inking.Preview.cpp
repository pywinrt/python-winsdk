...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_Input_Inking_Preview(void) noexcept
{
    ...
    state->type_PalmRejectionDelayZonePreview = py::register_python_type(module.get(), type_name_PalmRejectionDelayZonePreview, &type_spec_PalmRejectionDelayZonePreview, bases.get(), nullptr);
