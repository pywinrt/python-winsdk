...
namespace py::cpp::Windows::Devices::Bluetooth::GenericAttributeProfile
{
    ...
    static PyType_Slot type_slots_GattCharacteristicUuids_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_GattCharacteristicUuids_Meta },
        { }
    };

    static PyType_Spec type_spec_GattCharacteristicUuids_Meta =
    {
        "_winsdk_Windows_Devices_Bluetooth_GenericAttributeProfile.GattCharacteristicUuids_Meta",
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_GattDescriptorUuids_Meta },
        { }
    };

    static PyType_Spec type_spec_GattDescriptorUuids_Meta =
    {
        "_winsdk_Windows_Devices_Bluetooth_GenericAttributeProfile.GattDescriptorUuids_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_GattPresentationFormat_Meta },
        { }
    };

    static PyType_Spec type_spec_GattPresentationFormat_Meta =
    {
        "_winsdk_Windows_Devices_Bluetooth_GenericAttributeProfile.GattPresentationFormat_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_GattPresentationFormatTypes_Meta },
        { }
    };

    static PyType_Spec type_spec_GattPresentationFormatTypes_Meta =
    {
        "_winsdk_Windows_Devices_Bluetooth_GenericAttributeProfile.GattPresentationFormatTypes_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_GattProtocolError_Meta },
        { }
    };

    static PyType_Spec type_spec_GattProtocolError_Meta =
    {
        "_winsdk_Windows_Devices_Bluetooth_GenericAttributeProfile.GattProtocolError_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_GattServiceUuids_Meta },
        { }
    };

    static PyType_Spec type_spec_GattServiceUuids_Meta =
    {
        "_winsdk_Windows_Devices_Bluetooth_GenericAttributeProfile.GattServiceUuids_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Bluetooth_GenericAttributeProfile(void) noexcept
{
    ...
    state->type_GattCharacteristic = py::register_python_type(module.get(), type_name_GattCharacteristic, &type_spec_GattCharacteristic, bases.get(), nullptr);
    ...
    state->type_GattCharacteristicUuids = py::register_python_type(module.get(), type_name_GattCharacteristicUuids, &type_spec_GattCharacteristicUuids, nullptr, reinterpret_cast<PyTypeObject*>(type_GattCharacteristicUuids_Meta.get()));
    if (!state->type_GattCharacteristicUuids)
    {
        return nullptr;
    }

    state->type_GattCharacteristicsResult = py::register_python_type(module.get(), type_name_GattCharacteristicsResult, &type_spec_GattCharacteristicsResult, bases.get(), nullptr);
    if (!state->type_GattCharacteristicsResult)
    {
        return nullptr;
    }

    state->type_GattClientNotificationResult = py::register_python_type(module.get(), type_name_GattClientNotificationResult, &type_spec_GattClientNotificationResult, bases.get(), nullptr);
    if (!state->type_GattClientNotificationResult)
    {
        return nullptr;
    }

    state->type_GattDescriptor = py::register_python_type(module.get(), type_name_GattDescriptor, &type_spec_GattDescriptor, bases.get(), nullptr);
    ...
    state->type_GattDescriptorUuids = py::register_python_type(module.get(), type_name_GattDescriptorUuids, &type_spec_GattDescriptorUuids, nullptr, reinterpret_cast<PyTypeObject*>(type_GattDescriptorUuids_Meta.get()));
    if (!state->type_GattDescriptorUuids)
    {
        return nullptr;
    }

    state->type_GattDescriptorsResult = py::register_python_type(module.get(), type_name_GattDescriptorsResult, &type_spec_GattDescriptorsResult, bases.get(), nullptr);
    if (!state->type_GattDescriptorsResult)
    {
        return nullptr;
    }

    state->type_GattDeviceService = py::register_python_type(module.get(), type_name_GattDeviceService, &type_spec_GattDeviceService, bases.get(), nullptr);
    if (!state->type_GattDeviceService)
    {
        return nullptr;
    }

    state->type_GattDeviceServicesResult = py::register_python_type(module.get(), type_name_GattDeviceServicesResult, &type_spec_GattDeviceServicesResult, bases.get(), nullptr);
    if (!state->type_GattDeviceServicesResult)
    {
        return nullptr;
    }

    state->type_GattLocalCharacteristic = py::register_python_type(module.get(), type_name_GattLocalCharacteristic, &type_spec_GattLocalCharacteristic, bases.get(), nullptr);
    if (!state->type_GattLocalCharacteristic)
    {
        return nullptr;
    }

    state->type_GattLocalCharacteristicParameters = py::register_python_type(module.get(), type_name_GattLocalCharacteristicParameters, &type_spec_GattLocalCharacteristicParameters, bases.get(), nullptr);
    if (!state->type_GattLocalCharacteristicParameters)
    {
        return nullptr;
    }

    state->type_GattLocalCharacteristicResult = py::register_python_type(module.get(), type_name_GattLocalCharacteristicResult, &type_spec_GattLocalCharacteristicResult, bases.get(), nullptr);
    if (!state->type_GattLocalCharacteristicResult)
    {
        return nullptr;
    }

    state->type_GattLocalDescriptor = py::register_python_type(module.get(), type_name_GattLocalDescriptor, &type_spec_GattLocalDescriptor, bases.get(), nullptr);
    if (!state->type_GattLocalDescriptor)
    {
        return nullptr;
    }

    state->type_GattLocalDescriptorParameters = py::register_python_type(module.get(), type_name_GattLocalDescriptorParameters, &type_spec_GattLocalDescriptorParameters, bases.get(), nullptr);
    if (!state->type_GattLocalDescriptorParameters)
    {
        return nullptr;
    }

    state->type_GattLocalDescriptorResult = py::register_python_type(module.get(), type_name_GattLocalDescriptorResult, &type_spec_GattLocalDescriptorResult, bases.get(), nullptr);
    if (!state->type_GattLocalDescriptorResult)
    {
        return nullptr;
    }

    state->type_GattLocalService = py::register_python_type(module.get(), type_name_GattLocalService, &type_spec_GattLocalService, bases.get(), nullptr);
    ...
    state->type_GattPresentationFormat = py::register_python_type(module.get(), type_name_GattPresentationFormat, &type_spec_GattPresentationFormat, bases.get(), reinterpret_cast<PyTypeObject*>(type_GattPresentationFormat_Meta.get()));
    ...
    state->type_GattPresentationFormatTypes = py::register_python_type(module.get(), type_name_GattPresentationFormatTypes, &type_spec_GattPresentationFormatTypes, nullptr, reinterpret_cast<PyTypeObject*>(type_GattPresentationFormatTypes_Meta.get()));
    ...
    state->type_GattProtocolError = py::register_python_type(module.get(), type_name_GattProtocolError, &type_spec_GattProtocolError, nullptr, reinterpret_cast<PyTypeObject*>(type_GattProtocolError_Meta.get()));
    if (!state->type_GattProtocolError)
    {
        return nullptr;
    }

    state->type_GattReadClientCharacteristicConfigurationDescriptorResult = py::register_python_type(module.get(), type_name_GattReadClientCharacteristicConfigurationDescriptorResult, &type_spec_GattReadClientCharacteristicConfigurationDescriptorResult, bases.get(), nullptr);
    if (!state->type_GattReadClientCharacteristicConfigurationDescriptorResult)
    {
        return nullptr;
    }

    state->type_GattReadRequest = py::register_python_type(module.get(), type_name_GattReadRequest, &type_spec_GattReadRequest, bases.get(), nullptr);
    if (!state->type_GattReadRequest)
    {
        return nullptr;
    }

    state->type_GattReadRequestedEventArgs = py::register_python_type(module.get(), type_name_GattReadRequestedEventArgs, &type_spec_GattReadRequestedEventArgs, bases.get(), nullptr);
    if (!state->type_GattReadRequestedEventArgs)
    {
        return nullptr;
    }

    state->type_GattReadResult = py::register_python_type(module.get(), type_name_GattReadResult, &type_spec_GattReadResult, bases.get(), nullptr);
    if (!state->type_GattReadResult)
    {
        return nullptr;
    }

    state->type_GattReliableWriteTransaction = py::register_python_type(module.get(), type_name_GattReliableWriteTransaction, &type_spec_GattReliableWriteTransaction, bases.get(), nullptr);
    if (!state->type_GattReliableWriteTransaction)
    {
        return nullptr;
    }

    state->type_GattRequestStateChangedEventArgs = py::register_python_type(module.get(), type_name_GattRequestStateChangedEventArgs, &type_spec_GattRequestStateChangedEventArgs, bases.get(), nullptr);
    if (!state->type_GattRequestStateChangedEventArgs)
    {
        return nullptr;
    }

    state->type_GattServiceProvider = py::register_python_type(module.get(), type_name_GattServiceProvider, &type_spec_GattServiceProvider, bases.get(), nullptr);
    if (!state->type_GattServiceProvider)
    {
        return nullptr;
    }

    state->type_GattServiceProviderAdvertisementStatusChangedEventArgs = py::register_python_type(module.get(), type_name_GattServiceProviderAdvertisementStatusChangedEventArgs, &type_spec_GattServiceProviderAdvertisementStatusChangedEventArgs, bases.get(), nullptr);
    if (!state->type_GattServiceProviderAdvertisementStatusChangedEventArgs)
    {
        return nullptr;
    }

    state->type_GattServiceProviderAdvertisingParameters = py::register_python_type(module.get(), type_name_GattServiceProviderAdvertisingParameters, &type_spec_GattServiceProviderAdvertisingParameters, bases.get(), nullptr);
    if (!state->type_GattServiceProviderAdvertisingParameters)
    {
        return nullptr;
    }

    state->type_GattServiceProviderResult = py::register_python_type(module.get(), type_name_GattServiceProviderResult, &type_spec_GattServiceProviderResult, bases.get(), nullptr);
    ...
    state->type_GattServiceUuids = py::register_python_type(module.get(), type_name_GattServiceUuids, &type_spec_GattServiceUuids, nullptr, reinterpret_cast<PyTypeObject*>(type_GattServiceUuids_Meta.get()));
    if (!state->type_GattServiceUuids)
    {
        return nullptr;
    }

    state->type_GattSession = py::register_python_type(module.get(), type_name_GattSession, &type_spec_GattSession, bases.get(), nullptr);
    if (!state->type_GattSession)
    {
        return nullptr;
    }

    state->type_GattSessionStatusChangedEventArgs = py::register_python_type(module.get(), type_name_GattSessionStatusChangedEventArgs, &type_spec_GattSessionStatusChangedEventArgs, bases.get(), nullptr);
    if (!state->type_GattSessionStatusChangedEventArgs)
    {
        return nullptr;
    }

    state->type_GattSubscribedClient = py::register_python_type(module.get(), type_name_GattSubscribedClient, &type_spec_GattSubscribedClient, bases.get(), nullptr);
    if (!state->type_GattSubscribedClient)
    {
        return nullptr;
    }

    state->type_GattValueChangedEventArgs = py::register_python_type(module.get(), type_name_GattValueChangedEventArgs, &type_spec_GattValueChangedEventArgs, bases.get(), nullptr);
    if (!state->type_GattValueChangedEventArgs)
    {
        return nullptr;
    }

    state->type_GattWriteRequest = py::register_python_type(module.get(), type_name_GattWriteRequest, &type_spec_GattWriteRequest, bases.get(), nullptr);
    if (!state->type_GattWriteRequest)
    {
        return nullptr;
    }

    state->type_GattWriteRequestedEventArgs = py::register_python_type(module.get(), type_name_GattWriteRequestedEventArgs, &type_spec_GattWriteRequestedEventArgs, bases.get(), nullptr);
    if (!state->type_GattWriteRequestedEventArgs)
    {
        return nullptr;
    }

    state->type_GattWriteResult = py::register_python_type(module.get(), type_name_GattWriteResult, &type_spec_GattWriteResult, bases.get(), nullptr);
