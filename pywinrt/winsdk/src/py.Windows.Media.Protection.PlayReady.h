...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::PlayReady::NDCertificateFeature> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::PlayReady::NDCertificatePlatformID> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::PlayReady::NDCertificateType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::PlayReady::NDClosedCaptionFormat> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::PlayReady::NDContentIDType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::PlayReady::NDMediaStreamType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::PlayReady::NDProximityDetectionType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::PlayReady::NDStartAsyncOptions> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::PlayReady::PlayReadyDecryptorSetup> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::PlayReady::PlayReadyEncryptionAlgorithm> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::PlayReady::PlayReadyHardwareDRMFeatures> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Protection::PlayReady::PlayReadyITADataFormat> = "i";
