...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::ApplicationDataCreateDisposition> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::ApplicationDataLocality> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::CreationCollisionOption> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::FileAccessMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::FileAttributes> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::KnownFolderId> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::KnownFoldersAccessStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::KnownLibraryId> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::NameCollisionOption> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::StorageDeleteOption> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::StorageItemTypes> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::StorageLibraryChangeType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::StorageOpenOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::StreamedFileFailureMode> = "i";
