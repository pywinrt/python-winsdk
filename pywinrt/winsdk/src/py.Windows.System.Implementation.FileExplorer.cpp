...
PyMODINIT_FUNC PyInit__winsdk_Windows_System_Implementation_FileExplorer(void) noexcept
{
    ...
    state->type_SysStorageProviderEventReceivedEventArgs = py::register_python_type(module.get(), type_name_SysStorageProviderEventReceivedEventArgs, &type_spec_SysStorageProviderEventReceivedEventArgs, bases.get(), nullptr);
    if (!state->type_SysStorageProviderEventReceivedEventArgs)
    {
        return nullptr;
    }

    state->type_ISysStorageProviderEventSource = py::register_python_type(module.get(), type_name_ISysStorageProviderEventSource, &type_spec_ISysStorageProviderEventSource, bases.get(), nullptr);
    if (!state->type_ISysStorageProviderEventSource)
    {
        return nullptr;
    }

    state->type_ISysStorageProviderHandlerFactory = py::register_python_type(module.get(), type_name_ISysStorageProviderHandlerFactory, &type_spec_ISysStorageProviderHandlerFactory, bases.get(), nullptr);
    if (!state->type_ISysStorageProviderHandlerFactory)
    {
        return nullptr;
    }

    state->type_ISysStorageProviderHttpRequestProvider = py::register_python_type(module.get(), type_name_ISysStorageProviderHttpRequestProvider, &type_spec_ISysStorageProviderHttpRequestProvider, bases.get(), nullptr);
