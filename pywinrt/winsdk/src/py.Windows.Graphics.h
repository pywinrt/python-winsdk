...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::DisplayAdapterId> = "T{I:low_part:i:high_part:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::DisplayId> = "T{Q:value:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::PointInt32> = "T{i:x:i:y:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::RectInt32> = "T{i:x:i:y:i:width:i:height:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Graphics::SizeInt32> = "T{i:width:i:height:}";
