...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::UserDataAccounts::Provider::UserDataAccountProviderOperationKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::UserDataAccounts::Provider::UserDataAccountProviderPartnerAccountKind> = "i";
