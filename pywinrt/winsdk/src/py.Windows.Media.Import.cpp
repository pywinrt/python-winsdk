...
winrt::Windows::Media::Import::PhotoImportProgress py::converter<winrt::Windows::Media::Import::PhotoImportProgress>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Media::Import::PhotoImportProgress or dict");
    ...
    if (!py_ItemsImported) {
        PyErr_SetString(PyExc_KeyError, "ItemsImported");
        throw python_exception();
    }
    ...
    if (!py_TotalItemsToImport) {
        PyErr_SetString(PyExc_KeyError, "TotalItemsToImport");
        throw python_exception();
    }
    ...
    if (!py_BytesImported) {
        PyErr_SetString(PyExc_KeyError, "BytesImported");
        throw python_exception();
    }
    ...
    if (!py_TotalBytesToImport) {
        PyErr_SetString(PyExc_KeyError, "TotalBytesToImport");
        throw python_exception();
    }
    ...
    if (!py_ImportProgress) {
        PyErr_SetString(PyExc_KeyError, "ImportProgress");
        throw python_exception();
    }
...
PyMODINIT_FUNC
PyInit__winsdk_Windows_Media_Import (void) noexcept
{
