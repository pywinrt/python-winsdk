...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::EnterpriseData::DataProtectionStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::EnterpriseData::EnforcementLevel> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::EnterpriseData::FileProtectionStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::EnterpriseData::ProtectedImportExportStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::EnterpriseData::ProtectionPolicyAuditAction> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior> = "i";
