...
namespace py::cpp::Windows::Foundation::Diagnostics
{
    ...
    static PyObject* register_CausalityRelation(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_CausalitySource(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CausalitySynchronousWork(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_CausalityTraceLevel(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ErrorOptions(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LoggingFieldFormat(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LoggingLevel(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_LoggingOpcode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_AsyncCausalityTracer = "AsyncCausalityTracer";
    ...
    // ----- ErrorDetails class --------------------
    constexpr const char* const type_name_ErrorDetails = "ErrorDetails";
    ...
    constexpr const char* const type_name_FileLoggingSession = "FileLoggingSession";
    ...
    constexpr const char* const type_name_LogFileGeneratedEventArgs = "LogFileGeneratedEventArgs";
    ...
    constexpr const char* const type_name_LoggingActivity = "LoggingActivity";
    ...
    constexpr const char* const type_name_LoggingChannel = "LoggingChannel";
    ...
    constexpr const char* const type_name_LoggingChannelOptions = "LoggingChannelOptions";
    ...
    // ----- LoggingFields class --------------------
    constexpr const char* const type_name_LoggingFields = "LoggingFields";
    ...
    constexpr const char* const type_name_LoggingOptions = "LoggingOptions";
    ...
    constexpr const char* const type_name_LoggingSession = "LoggingSession";
    ...
    constexpr const char* const type_name_RuntimeBrokerErrorSettings = "RuntimeBrokerErrorSettings";
    ...
    constexpr const char* const type_name_TracingStatusChangedEventArgs = "TracingStatusChangedEventArgs";
    ...
    constexpr const char* const type_name_IErrorReportingSettings = "IErrorReportingSettings";
    ...
    constexpr const char* const type_name_IFileLoggingSession = "IFileLoggingSession";
    ...
    constexpr const char* const type_name_ILoggingChannel = "ILoggingChannel";
    ...
    constexpr const char* const type_name_ILoggingSession = "ILoggingSession";
    ...
    constexpr const char* const type_name_ILoggingTarget = "ILoggingTarget";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Foundation_Diagnostics(void) noexcept
{
    ...
    state->type_AsyncCausalityTracer = py::register_python_type(module.get(), type_name_AsyncCausalityTracer, &type_spec_AsyncCausalityTracer, nullptr);
    if (!state->type_AsyncCausalityTracer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_AsyncCausalityTracer);

    state->type_ErrorDetails = py::register_python_type(module.get(), type_name_ErrorDetails, &type_spec_ErrorDetails, bases.get());
    if (!state->type_ErrorDetails)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ErrorDetails);

    state->type_FileLoggingSession = py::register_python_type(module.get(), type_name_FileLoggingSession, &type_spec_FileLoggingSession, bases.get());
    if (!state->type_FileLoggingSession)
    {
        return nullptr;
    }

    Py_INCREF(state->type_FileLoggingSession);

    state->type_LogFileGeneratedEventArgs = py::register_python_type(module.get(), type_name_LogFileGeneratedEventArgs, &type_spec_LogFileGeneratedEventArgs, bases.get());
    if (!state->type_LogFileGeneratedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LogFileGeneratedEventArgs);

    state->type_LoggingActivity = py::register_python_type(module.get(), type_name_LoggingActivity, &type_spec_LoggingActivity, bases.get());
    if (!state->type_LoggingActivity)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LoggingActivity);

    state->type_LoggingChannel = py::register_python_type(module.get(), type_name_LoggingChannel, &type_spec_LoggingChannel, bases.get());
    if (!state->type_LoggingChannel)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LoggingChannel);

    state->type_LoggingChannelOptions = py::register_python_type(module.get(), type_name_LoggingChannelOptions, &type_spec_LoggingChannelOptions, bases.get());
    if (!state->type_LoggingChannelOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LoggingChannelOptions);

    state->type_LoggingFields = py::register_python_type(module.get(), type_name_LoggingFields, &type_spec_LoggingFields, bases.get());
    if (!state->type_LoggingFields)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LoggingFields);

    state->type_LoggingOptions = py::register_python_type(module.get(), type_name_LoggingOptions, &type_spec_LoggingOptions, bases.get());
    if (!state->type_LoggingOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LoggingOptions);

    state->type_LoggingSession = py::register_python_type(module.get(), type_name_LoggingSession, &type_spec_LoggingSession, bases.get());
    if (!state->type_LoggingSession)
    {
        return nullptr;
    }

    Py_INCREF(state->type_LoggingSession);

    state->type_RuntimeBrokerErrorSettings = py::register_python_type(module.get(), type_name_RuntimeBrokerErrorSettings, &type_spec_RuntimeBrokerErrorSettings, bases.get());
    if (!state->type_RuntimeBrokerErrorSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RuntimeBrokerErrorSettings);

    state->type_TracingStatusChangedEventArgs = py::register_python_type(module.get(), type_name_TracingStatusChangedEventArgs, &type_spec_TracingStatusChangedEventArgs, bases.get());
    if (!state->type_TracingStatusChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_TracingStatusChangedEventArgs);

    state->type_IErrorReportingSettings = py::register_python_type(module.get(), type_name_IErrorReportingSettings, &type_spec_IErrorReportingSettings, bases.get());
    if (!state->type_IErrorReportingSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IErrorReportingSettings);

    state->type_IFileLoggingSession = py::register_python_type(module.get(), type_name_IFileLoggingSession, &type_spec_IFileLoggingSession, bases.get());
    if (!state->type_IFileLoggingSession)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IFileLoggingSession);

    state->type_ILoggingChannel = py::register_python_type(module.get(), type_name_ILoggingChannel, &type_spec_ILoggingChannel, bases.get());
    if (!state->type_ILoggingChannel)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ILoggingChannel);

    state->type_ILoggingSession = py::register_python_type(module.get(), type_name_ILoggingSession, &type_spec_ILoggingSession, bases.get());
    if (!state->type_ILoggingSession)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ILoggingSession);

    state->type_ILoggingTarget = py::register_python_type(module.get(), type_name_ILoggingTarget, &type_spec_ILoggingTarget, bases.get());
    if (!state->type_ILoggingTarget)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ILoggingTarget);
