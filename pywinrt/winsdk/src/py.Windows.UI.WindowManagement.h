...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::WindowManagement::AppWindowClosedReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::WindowManagement::AppWindowFrameStyle> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::WindowManagement::AppWindowPresentationKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::WindowManagement::AppWindowTitleBarVisibility> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::WindowManagement::WindowingEnvironmentKind> = "i";
