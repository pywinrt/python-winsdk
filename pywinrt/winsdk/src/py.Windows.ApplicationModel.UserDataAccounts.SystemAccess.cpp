...
namespace py::cpp::Windows::ApplicationModel::UserDataAccounts::SystemAccess
{
    ...
    static PyObject* register_DeviceAccountAuthenticationType(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_DeviceAccountIconId(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DeviceAccountMailAgeFilter(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DeviceAccountServerType(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_DeviceAccountSyncScheduleKind(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_DeviceAccountConfiguration = "DeviceAccountConfiguration";
    ...
    {
        "_winsdk_Windows_ApplicationModel_UserDataAccounts_SystemAccess.DeviceAccountConfiguration",
    ...
    constexpr const char* const type_name_UserDataAccountSystemAccessManager = "UserDataAccountSystemAccessManager";
    ...
    {
        "_winsdk_Windows_ApplicationModel_UserDataAccounts_SystemAccess.UserDataAccountSystemAccessManager",
        0,
        0,
        Py_TPFLAGS_DEFAULT,
    ...
    static PyModuleDef module_def
        = {PyModuleDef_HEAD_INIT,
           "_winsdk_Windows_ApplicationModel_UserDataAccounts_SystemAccess",
           module_doc,
           sizeof(module_state),
           module_methods,
           nullptr,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_UserDataAccounts_SystemAccess(void) noexcept
{
    ...
    state->type_DeviceAccountConfiguration = py::register_python_type(module.get(), type_name_DeviceAccountConfiguration, &type_spec_DeviceAccountConfiguration, bases.get());
    if (!state->type_DeviceAccountConfiguration)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DeviceAccountConfiguration);

    state->type_UserDataAccountSystemAccessManager = py::register_python_type(module.get(), type_name_UserDataAccountSystemAccessManager, &type_spec_UserDataAccountSystemAccessManager, nullptr);
    if (!state->type_UserDataAccountSystemAccessManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_UserDataAccountSystemAccessManager);
