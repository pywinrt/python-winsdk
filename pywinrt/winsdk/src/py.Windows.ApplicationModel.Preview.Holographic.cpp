...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_Preview_Holographic(void) noexcept
{
    ...
    state->type_HolographicApplicationPreview = py::register_python_type(module.get(), type_name_HolographicApplicationPreview, &type_spec_HolographicApplicationPreview, object_bases.get(), nullptr);
    if (!state->type_HolographicApplicationPreview)
    {
        return nullptr;
    }

    state->type_HolographicKeyboardPlacementOverridePreview = py::register_python_type(module.get(), type_name_HolographicKeyboardPlacementOverridePreview, &type_spec_HolographicKeyboardPlacementOverridePreview, object_bases.get(), nullptr);
