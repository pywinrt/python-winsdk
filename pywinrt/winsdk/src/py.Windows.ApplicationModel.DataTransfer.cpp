...
namespace py::cpp::Windows::ApplicationModel::DataTransfer
{
    ...
    static PyObject* register_ClipboardHistoryItemsResultStatus(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_DataPackageOperation(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_SetHistoryItemAsContentStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_ShareUITheme(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    // ----- Clipboard class --------------------
    constexpr const char* const type_name_Clipboard = "Clipboard";
    ...
    constexpr const char* const type_name_ClipboardContentOptions = "ClipboardContentOptions";
    ...
    constexpr const char* const type_name_ClipboardHistoryChangedEventArgs = "ClipboardHistoryChangedEventArgs";
    ...
    constexpr const char* const type_name_ClipboardHistoryItem = "ClipboardHistoryItem";
    ...
    constexpr const char* const type_name_ClipboardHistoryItemsResult = "ClipboardHistoryItemsResult";
    ...
    // ----- DataPackage class --------------------
    constexpr const char* const type_name_DataPackage = "DataPackage";
    ...
    constexpr const char* const type_name_DataPackagePropertySet = "DataPackagePropertySet";
    ...
    static PyType_Slot _type_slots_DataPackagePropertySet[] = 
    {
        ...
        { Py_sq_contains, _map_contains_DataPackagePropertySet },
    ...
    constexpr const char* const type_name_DataPackagePropertySetView = "DataPackagePropertySetView";
    ...
    static PyType_Slot _type_slots_DataPackagePropertySetView[] = 
    {
        ...
        { Py_sq_contains, _map_contains_DataPackagePropertySetView },
    ...
    constexpr const char* const type_name_DataPackageView = "DataPackageView";
    ...
    constexpr const char* const type_name_DataProviderDeferral = "DataProviderDeferral";
    ...
    constexpr const char* const type_name_DataProviderRequest = "DataProviderRequest";
    ...
    // ----- DataRequest class --------------------
    constexpr const char* const type_name_DataRequest = "DataRequest";
    ...
    constexpr const char* const type_name_DataRequestDeferral = "DataRequestDeferral";
    ...
    constexpr const char* const type_name_DataRequestedEventArgs = "DataRequestedEventArgs";
    ...
    constexpr const char* const type_name_DataTransferManager = "DataTransferManager";
    ...
    constexpr const char* const type_name_HtmlFormatHelper = "HtmlFormatHelper";
    ...
    constexpr const char* const type_name_OperationCompletedEventArgs = "OperationCompletedEventArgs";
    ...
    constexpr const char* const type_name_ShareCompletedEventArgs = "ShareCompletedEventArgs";
    ...
    // ----- ShareProvider class --------------------
    constexpr const char* const type_name_ShareProvider = "ShareProvider";
    ...
    constexpr const char* const type_name_ShareProviderOperation = "ShareProviderOperation";
    ...
    constexpr const char* const type_name_ShareProvidersRequestedEventArgs = "ShareProvidersRequestedEventArgs";
    ...
    constexpr const char* const type_name_ShareTargetInfo = "ShareTargetInfo";
    ...
    constexpr const char* const type_name_ShareUIOptions = "ShareUIOptions";
    ...
    constexpr const char* const type_name_SharedStorageAccessManager = "SharedStorageAccessManager";
    ...
    constexpr const char* const type_name_StandardDataFormats = "StandardDataFormats";
    ...
    constexpr const char* const type_name_TargetApplicationChosenEventArgs = "TargetApplicationChosenEventArgs";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_DataTransfer(void) noexcept
{
    ...
    state->type_Clipboard = py::register_python_type(module.get(), type_name_Clipboard, &type_spec_Clipboard, nullptr);
    if (!state->type_Clipboard)
    {
        return nullptr;
    }

    Py_INCREF(state->type_Clipboard);

    state->type_ClipboardContentOptions = py::register_python_type(module.get(), type_name_ClipboardContentOptions, &type_spec_ClipboardContentOptions, bases.get());
    if (!state->type_ClipboardContentOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClipboardContentOptions);

    state->type_ClipboardHistoryChangedEventArgs = py::register_python_type(module.get(), type_name_ClipboardHistoryChangedEventArgs, &type_spec_ClipboardHistoryChangedEventArgs, bases.get());
    if (!state->type_ClipboardHistoryChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClipboardHistoryChangedEventArgs);

    state->type_ClipboardHistoryItem = py::register_python_type(module.get(), type_name_ClipboardHistoryItem, &type_spec_ClipboardHistoryItem, bases.get());
    if (!state->type_ClipboardHistoryItem)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClipboardHistoryItem);

    state->type_ClipboardHistoryItemsResult = py::register_python_type(module.get(), type_name_ClipboardHistoryItemsResult, &type_spec_ClipboardHistoryItemsResult, bases.get());
    if (!state->type_ClipboardHistoryItemsResult)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ClipboardHistoryItemsResult);

    state->type_DataPackage = py::register_python_type(module.get(), type_name_DataPackage, &type_spec_DataPackage, bases.get());
    if (!state->type_DataPackage)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DataPackage);

    state->type_DataPackagePropertySet = py::register_python_type(module.get(), type_name_DataPackagePropertySet, &type_spec_DataPackagePropertySet, mutable_mapping_bases.get());
    if (!state->type_DataPackagePropertySet)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DataPackagePropertySet);

    state->type_DataPackagePropertySetView = py::register_python_type(module.get(), type_name_DataPackagePropertySetView, &type_spec_DataPackagePropertySetView, mapping_bases.get());
    if (!state->type_DataPackagePropertySetView)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DataPackagePropertySetView);

    state->type_DataPackageView = py::register_python_type(module.get(), type_name_DataPackageView, &type_spec_DataPackageView, bases.get());
    if (!state->type_DataPackageView)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DataPackageView);

    state->type_DataProviderDeferral = py::register_python_type(module.get(), type_name_DataProviderDeferral, &type_spec_DataProviderDeferral, bases.get());
    if (!state->type_DataProviderDeferral)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DataProviderDeferral);

    state->type_DataProviderRequest = py::register_python_type(module.get(), type_name_DataProviderRequest, &type_spec_DataProviderRequest, bases.get());
    if (!state->type_DataProviderRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DataProviderRequest);

    state->type_DataRequest = py::register_python_type(module.get(), type_name_DataRequest, &type_spec_DataRequest, bases.get());
    if (!state->type_DataRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DataRequest);

    state->type_DataRequestDeferral = py::register_python_type(module.get(), type_name_DataRequestDeferral, &type_spec_DataRequestDeferral, bases.get());
    if (!state->type_DataRequestDeferral)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DataRequestDeferral);

    state->type_DataRequestedEventArgs = py::register_python_type(module.get(), type_name_DataRequestedEventArgs, &type_spec_DataRequestedEventArgs, bases.get());
    if (!state->type_DataRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DataRequestedEventArgs);

    state->type_DataTransferManager = py::register_python_type(module.get(), type_name_DataTransferManager, &type_spec_DataTransferManager, bases.get());
    if (!state->type_DataTransferManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DataTransferManager);

    state->type_HtmlFormatHelper = py::register_python_type(module.get(), type_name_HtmlFormatHelper, &type_spec_HtmlFormatHelper, nullptr);
    if (!state->type_HtmlFormatHelper)
    {
        return nullptr;
    }

    Py_INCREF(state->type_HtmlFormatHelper);

    state->type_OperationCompletedEventArgs = py::register_python_type(module.get(), type_name_OperationCompletedEventArgs, &type_spec_OperationCompletedEventArgs, bases.get());
    if (!state->type_OperationCompletedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_OperationCompletedEventArgs);

    state->type_ShareCompletedEventArgs = py::register_python_type(module.get(), type_name_ShareCompletedEventArgs, &type_spec_ShareCompletedEventArgs, bases.get());
    if (!state->type_ShareCompletedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ShareCompletedEventArgs);

    state->type_ShareProvider = py::register_python_type(module.get(), type_name_ShareProvider, &type_spec_ShareProvider, bases.get());
    if (!state->type_ShareProvider)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ShareProvider);

    state->type_ShareProviderOperation = py::register_python_type(module.get(), type_name_ShareProviderOperation, &type_spec_ShareProviderOperation, bases.get());
    if (!state->type_ShareProviderOperation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ShareProviderOperation);

    state->type_ShareProvidersRequestedEventArgs = py::register_python_type(module.get(), type_name_ShareProvidersRequestedEventArgs, &type_spec_ShareProvidersRequestedEventArgs, bases.get());
    if (!state->type_ShareProvidersRequestedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ShareProvidersRequestedEventArgs);

    state->type_ShareTargetInfo = py::register_python_type(module.get(), type_name_ShareTargetInfo, &type_spec_ShareTargetInfo, bases.get());
    if (!state->type_ShareTargetInfo)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ShareTargetInfo);

    state->type_ShareUIOptions = py::register_python_type(module.get(), type_name_ShareUIOptions, &type_spec_ShareUIOptions, bases.get());
    if (!state->type_ShareUIOptions)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ShareUIOptions);

    state->type_SharedStorageAccessManager = py::register_python_type(module.get(), type_name_SharedStorageAccessManager, &type_spec_SharedStorageAccessManager, nullptr);
    if (!state->type_SharedStorageAccessManager)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SharedStorageAccessManager);

    state->type_StandardDataFormats = py::register_python_type(module.get(), type_name_StandardDataFormats, &type_spec_StandardDataFormats, nullptr);
    if (!state->type_StandardDataFormats)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StandardDataFormats);

    state->type_TargetApplicationChosenEventArgs = py::register_python_type(module.get(), type_name_TargetApplicationChosenEventArgs, &type_spec_TargetApplicationChosenEventArgs, bases.get());
    if (!state->type_TargetApplicationChosenEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_TargetApplicationChosenEventArgs);
