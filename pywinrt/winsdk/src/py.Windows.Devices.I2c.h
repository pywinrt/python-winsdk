...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::I2c::I2cBusSpeed> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::I2c::I2cSharingMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::I2c::I2cTransferStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::I2c::I2cTransferResult> = "T{i:status:I:bytes_transferred:}";
