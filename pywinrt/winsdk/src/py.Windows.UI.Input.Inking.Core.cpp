...
namespace py::cpp::Windows::UI::Input::Inking::Core
{
    ...
    static PyObject* register_CoreWetStrokeDisposition(PyObject* module, PyObject* type)
    {
    ...
    constexpr const char* const type_name_CoreIncrementalInkStroke = "CoreIncrementalInkStroke";
    ...
    {
        "_winsdk_Windows_UI_Input_Inking_Core.CoreIncrementalInkStroke",
    ...
    constexpr const char* const type_name_CoreInkIndependentInputSource = "CoreInkIndependentInputSource";
    ...
    {
        "_winsdk_Windows_UI_Input_Inking_Core.CoreInkIndependentInputSource",
    ...
    constexpr const char* const type_name_CoreInkPresenterHost = "CoreInkPresenterHost";
    ...
    {
        "_winsdk_Windows_UI_Input_Inking_Core.CoreInkPresenterHost",
    ...
    constexpr const char* const type_name_CoreWetStrokeUpdateEventArgs = "CoreWetStrokeUpdateEventArgs";
    ...
    {
        "_winsdk_Windows_UI_Input_Inking_Core.CoreWetStrokeUpdateEventArgs",
    ...
    constexpr const char* const type_name_CoreWetStrokeUpdateSource = "CoreWetStrokeUpdateSource";
    ...
    {
        "_winsdk_Windows_UI_Input_Inking_Core.CoreWetStrokeUpdateSource",
    ...
    static PyModuleDef module_def
        = {PyModuleDef_HEAD_INIT,
           "_winsdk_Windows_UI_Input_Inking_Core",
           module_doc,
           sizeof(module_state),
           module_methods,
           nullptr,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_UI_Input_Inking_Core(void) noexcept
{
    ...
    state->type_CoreIncrementalInkStroke = py::register_python_type(module.get(), type_name_CoreIncrementalInkStroke, &type_spec_CoreIncrementalInkStroke, bases.get());
    if (!state->type_CoreIncrementalInkStroke)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreIncrementalInkStroke);

    state->type_CoreInkIndependentInputSource = py::register_python_type(module.get(), type_name_CoreInkIndependentInputSource, &type_spec_CoreInkIndependentInputSource, bases.get());
    if (!state->type_CoreInkIndependentInputSource)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreInkIndependentInputSource);

    state->type_CoreInkPresenterHost = py::register_python_type(module.get(), type_name_CoreInkPresenterHost, &type_spec_CoreInkPresenterHost, bases.get());
    if (!state->type_CoreInkPresenterHost)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreInkPresenterHost);

    state->type_CoreWetStrokeUpdateEventArgs = py::register_python_type(module.get(), type_name_CoreWetStrokeUpdateEventArgs, &type_spec_CoreWetStrokeUpdateEventArgs, bases.get());
    if (!state->type_CoreWetStrokeUpdateEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreWetStrokeUpdateEventArgs);

    state->type_CoreWetStrokeUpdateSource = py::register_python_type(module.get(), type_name_CoreWetStrokeUpdateSource, &type_spec_CoreWetStrokeUpdateSource, bases.get());
    if (!state->type_CoreWetStrokeUpdateSource)
    {
        return nullptr;
    }

    Py_INCREF(state->type_CoreWetStrokeUpdateSource);
