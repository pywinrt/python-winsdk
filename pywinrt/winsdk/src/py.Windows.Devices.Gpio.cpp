...
namespace py::cpp::Windows::Devices::Gpio
{
    ...
    static PyObject* register_GpioChangePolarity(PyObject* module, PyObject* type)
    {
    ...
    static PyObject* register_GpioOpenStatus(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_GpioPinDriveMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_GpioPinEdge(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_GpioPinValue(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    static PyObject* register_GpioSharingMode(PyObject* module, PyObject* type)
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        assert(state);
    ...
    constexpr const char* const type_name_GpioChangeCounter = "GpioChangeCounter";
    ...
    constexpr const char* const type_name_GpioChangeReader = "GpioChangeReader";
    ...
    constexpr const char* const type_name_GpioController = "GpioController";
    ...
    // ----- GpioPin class --------------------
    constexpr const char* const type_name_GpioPin = "GpioPin";
    ...
    constexpr const char* const type_name_GpioPinValueChangedEventArgs = "GpioPinValueChangedEventArgs";
    ...
    constexpr const char* const type_name_GpioChangeCount = "GpioChangeCount";
    ...
    constexpr const char* const type_name_GpioChangeRecord = "GpioChangeRecord";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Gpio(void) noexcept
{
    ...
    state->type_GpioChangeCounter = py::register_python_type(module.get(), type_name_GpioChangeCounter, &type_spec_GpioChangeCounter, bases.get());
    if (!state->type_GpioChangeCounter)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GpioChangeCounter);

    state->type_GpioChangeReader = py::register_python_type(module.get(), type_name_GpioChangeReader, &type_spec_GpioChangeReader, bases.get());
    if (!state->type_GpioChangeReader)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GpioChangeReader);

    state->type_GpioController = py::register_python_type(module.get(), type_name_GpioController, &type_spec_GpioController, bases.get());
    if (!state->type_GpioController)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GpioController);

    state->type_GpioPin = py::register_python_type(module.get(), type_name_GpioPin, &type_spec_GpioPin, bases.get());
    if (!state->type_GpioPin)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GpioPin);

    state->type_GpioPinValueChangedEventArgs = py::register_python_type(module.get(), type_name_GpioPinValueChangedEventArgs, &type_spec_GpioPinValueChangedEventArgs, bases.get());
    if (!state->type_GpioPinValueChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GpioPinValueChangedEventArgs);

    state->type_GpioChangeCount = py::register_python_type(module.get(), type_name_GpioChangeCount, &type_spec_GpioChangeCount, bases.get());
    if (!state->type_GpioChangeCount)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GpioChangeCount);

    state->type_GpioChangeRecord = py::register_python_type(module.get(), type_name_GpioChangeRecord, &type_spec_GpioChangeRecord, bases.get());
    if (!state->type_GpioChangeRecord)
    {
        return nullptr;
    }

    Py_INCREF(state->type_GpioChangeRecord);
