...
winrt::Windows::Devices::Gpio::GpioChangeCount py::converter<winrt::Windows::Devices::Gpio::GpioChangeCount>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Devices::Gpio::GpioChangeCount or dict");
    ...
    if (!py_RelativeTime) {
        PyErr_SetString(PyExc_KeyError, "RelativeTime");
        throw python_exception();
    }
...
winrt::Windows::Devices::Gpio::GpioChangeRecord py::converter<winrt::Windows::Devices::Gpio::GpioChangeRecord>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Devices::Gpio::GpioChangeRecord or dict");
        throw python_exception();
    }
    ...
    if (!py_Edge) {
        PyErr_SetString(PyExc_KeyError, "Edge");
        throw python_exception();
    }
