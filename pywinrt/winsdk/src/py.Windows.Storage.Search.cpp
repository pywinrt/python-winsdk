...
winrt::Windows::Storage::Search::SortEntry py::converter<winrt::Windows::Storage::Search::SortEntry>::convert_to(PyObject* obj)
{
    ...
    if (!PyDict_Check(obj))
    {
        PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Storage::Search::SortEntry or dict");
    ...
    if (!py_PropertyName) {
        PyErr_SetString(PyExc_KeyError, "PropertyName");
        throw python_exception();
    }
    ...
    if (!py_AscendingOrder) {
        PyErr_SetString(PyExc_KeyError, "AscendingOrder");
        throw python_exception();
    }
...
PyMODINIT_FUNC
PyInit__winsdk_Windows_Storage_Search (void) noexcept
{
