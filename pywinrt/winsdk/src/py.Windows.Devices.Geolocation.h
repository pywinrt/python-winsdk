...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::AltitudeReferenceSystem> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::GeolocationAccessStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::GeoshapeType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::PositionAccuracy> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::PositionSource> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::PositionStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::VisitMonitoringScope> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::VisitStateChange> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Devices::Geolocation::BasicGeoposition> = "T{d:latitude:d:longitude:d:altitude:}";
