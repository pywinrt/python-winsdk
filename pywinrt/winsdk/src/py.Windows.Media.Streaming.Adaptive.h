...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceCreationStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDiagnosticType> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadBitrateChangedReason> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceResourceType> = "i";
