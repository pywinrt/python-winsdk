...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ApplicationSettings::SettingsEdgeLocation> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ApplicationSettings::SupportedWebAccountActions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::ApplicationSettings::WebAccountAction> = "i";
