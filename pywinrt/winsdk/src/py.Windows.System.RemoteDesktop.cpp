...
namespace py::cpp::Windows::System::RemoteDesktop
{
    ...
    static PyType_Slot type_slots_InteractiveSession_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_InteractiveSession_Meta },
        { }
    };

    static PyType_Spec type_spec_InteractiveSession_Meta =
    {
        "_winsdk_Windows_System_RemoteDesktop.InteractiveSession_Meta",
...
PyMODINIT_FUNC PyInit__winsdk_Windows_System_RemoteDesktop(void) noexcept
{
    ...
    state->type_InteractiveSession = py::register_python_type(module.get(), type_name_InteractiveSession, &type_spec_InteractiveSession, nullptr, reinterpret_cast<PyTypeObject*>(type_InteractiveSession_Meta.get()));
