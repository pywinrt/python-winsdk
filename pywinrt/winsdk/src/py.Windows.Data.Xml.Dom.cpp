...
namespace py::cpp::Windows::Data::Xml::Dom
{
    ...
    static PyObject* register_NodeType(PyObject* module, PyObject* type)
    {
    ...
    // ----- DtdEntity class --------------------
    constexpr const char* const type_name_DtdEntity = "DtdEntity";
    ...
    // ----- DtdNotation class --------------------
    constexpr const char* const type_name_DtdNotation = "DtdNotation";
    ...
    // ----- XmlAttribute class --------------------
    constexpr const char* const type_name_XmlAttribute = "XmlAttribute";
    ...
    constexpr const char* const type_name_XmlCDataSection = "XmlCDataSection";
    ...
    // ----- XmlComment class --------------------
    constexpr const char* const type_name_XmlComment = "XmlComment";
    ...
    // ----- XmlDocument class --------------------
    constexpr const char* const type_name_XmlDocument = "XmlDocument";
    ...
    constexpr const char* const type_name_XmlDocumentFragment = "XmlDocumentFragment";
    ...
    constexpr const char* const type_name_XmlDocumentType = "XmlDocumentType";
    ...
    constexpr const char* const type_name_XmlDomImplementation = "XmlDomImplementation";
    ...
    // ----- XmlElement class --------------------
    constexpr const char* const type_name_XmlElement = "XmlElement";
    ...
    constexpr const char* const type_name_XmlEntityReference = "XmlEntityReference";
    ...
    constexpr const char* const type_name_XmlLoadSettings = "XmlLoadSettings";
    ...
    constexpr const char* const type_name_XmlNamedNodeMap = "XmlNamedNodeMap";
    ...
    static PyObject* XmlNamedNodeMap_GetMany(py::wrapper::Windows::Data::Xml::Dom::XmlNamedNodeMap* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Data.Xml.Dom.XmlNamedNodeMap", L"GetMany", 2))
            {
                PyErr_SetString(PyExc_AttributeError, "method 2 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    static PyObject* XmlNamedNodeMap_get_insert(PyObject* self) noexcept
    {
    ...
    // ----- XmlNodeList class --------------------
    constexpr const char* const type_name_XmlNodeList = "XmlNodeList";
    ...
    static PyObject* XmlNodeList_GetMany(py::wrapper::Windows::Data::Xml::Dom::XmlNodeList* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Data.Xml.Dom.XmlNodeList", L"GetMany", 2))
            {
                PyErr_SetString(PyExc_AttributeError, "method 2 args is not available in this version of Windows");
                return nullptr;
            }
    ...
    static PyObject* XmlNodeList_get_insert(PyObject* self) noexcept
    {
        return PyObject_GetAttrString(self, "insert_at");
    }
    ...
    constexpr const char* const type_name_XmlProcessingInstruction = "XmlProcessingInstruction";
    ...
    // ----- XmlText class --------------------
    constexpr const char* const type_name_XmlText = "XmlText";
    ...
    constexpr const char* const type_name_IXmlCharacterData = "IXmlCharacterData";
    ...
    // ----- IXmlNode interface --------------------
    constexpr const char* const type_name_IXmlNode = "IXmlNode";
    ...
    constexpr const char* const type_name_IXmlNodeSelector = "IXmlNodeSelector";
    ...
    constexpr const char* const type_name_IXmlNodeSerializer = "IXmlNodeSerializer";
    ...
    // ----- IXmlText interface --------------------
    constexpr const char* const type_name_IXmlText = "IXmlText";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Data_Xml_Dom(void) noexcept
{
    ...
    state->type_DtdEntity = py::register_python_type(module.get(), type_name_DtdEntity, &type_spec_DtdEntity, bases.get());
    if (!state->type_DtdEntity)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DtdEntity);

    state->type_DtdNotation = py::register_python_type(module.get(), type_name_DtdNotation, &type_spec_DtdNotation, bases.get());
    if (!state->type_DtdNotation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DtdNotation);

    state->type_XmlAttribute = py::register_python_type(module.get(), type_name_XmlAttribute, &type_spec_XmlAttribute, bases.get());
    if (!state->type_XmlAttribute)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlAttribute);

    state->type_XmlCDataSection = py::register_python_type(module.get(), type_name_XmlCDataSection, &type_spec_XmlCDataSection, bases.get());
    if (!state->type_XmlCDataSection)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlCDataSection);

    state->type_XmlComment = py::register_python_type(module.get(), type_name_XmlComment, &type_spec_XmlComment, bases.get());
    if (!state->type_XmlComment)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlComment);

    state->type_XmlDocument = py::register_python_type(module.get(), type_name_XmlDocument, &type_spec_XmlDocument, bases.get());
    if (!state->type_XmlDocument)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlDocument);

    state->type_XmlDocumentFragment = py::register_python_type(module.get(), type_name_XmlDocumentFragment, &type_spec_XmlDocumentFragment, bases.get());
    if (!state->type_XmlDocumentFragment)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlDocumentFragment);

    state->type_XmlDocumentType = py::register_python_type(module.get(), type_name_XmlDocumentType, &type_spec_XmlDocumentType, bases.get());
    if (!state->type_XmlDocumentType)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlDocumentType);

    state->type_XmlDomImplementation = py::register_python_type(module.get(), type_name_XmlDomImplementation, &type_spec_XmlDomImplementation, bases.get());
    if (!state->type_XmlDomImplementation)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlDomImplementation);

    state->type_XmlElement = py::register_python_type(module.get(), type_name_XmlElement, &type_spec_XmlElement, bases.get());
    if (!state->type_XmlElement)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlElement);

    state->type_XmlEntityReference = py::register_python_type(module.get(), type_name_XmlEntityReference, &type_spec_XmlEntityReference, bases.get());
    if (!state->type_XmlEntityReference)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlEntityReference);

    state->type_XmlLoadSettings = py::register_python_type(module.get(), type_name_XmlLoadSettings, &type_spec_XmlLoadSettings, bases.get());
    if (!state->type_XmlLoadSettings)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlLoadSettings);

    state->type_XmlNamedNodeMap = py::register_python_type(module.get(), type_name_XmlNamedNodeMap, &type_spec_XmlNamedNodeMap, sequence_bases.get());
    if (!state->type_XmlNamedNodeMap)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlNamedNodeMap);

    state->type_XmlNodeList = py::register_python_type(module.get(), type_name_XmlNodeList, &type_spec_XmlNodeList, sequence_bases.get());
    if (!state->type_XmlNodeList)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlNodeList);

    state->type_XmlProcessingInstruction = py::register_python_type(module.get(), type_name_XmlProcessingInstruction, &type_spec_XmlProcessingInstruction, bases.get());
    if (!state->type_XmlProcessingInstruction)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlProcessingInstruction);

    state->type_XmlText = py::register_python_type(module.get(), type_name_XmlText, &type_spec_XmlText, bases.get());
    if (!state->type_XmlText)
    {
        return nullptr;
    }

    Py_INCREF(state->type_XmlText);

    state->type_IXmlCharacterData = py::register_python_type(module.get(), type_name_IXmlCharacterData, &type_spec_IXmlCharacterData, bases.get());
    if (!state->type_IXmlCharacterData)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IXmlCharacterData);

    state->type_IXmlNode = py::register_python_type(module.get(), type_name_IXmlNode, &type_spec_IXmlNode, bases.get());
    if (!state->type_IXmlNode)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IXmlNode);

    state->type_IXmlNodeSelector = py::register_python_type(module.get(), type_name_IXmlNodeSelector, &type_spec_IXmlNodeSelector, bases.get());
    if (!state->type_IXmlNodeSelector)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IXmlNodeSelector);

    state->type_IXmlNodeSerializer = py::register_python_type(module.get(), type_name_IXmlNodeSerializer, &type_spec_IXmlNodeSerializer, bases.get());
    if (!state->type_IXmlNodeSerializer)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IXmlNodeSerializer);

    state->type_IXmlText = py::register_python_type(module.get(), type_name_IXmlText, &type_spec_IXmlText, bases.get());
    if (!state->type_IXmlText)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IXmlText);
