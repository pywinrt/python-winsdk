...
namespace py::cpp::Windows::System::RemoteDesktop::Input
{
    ...
    constexpr const char* const type_name_RemoteTextConnection = "RemoteTextConnection";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_System_RemoteDesktop_Input(void) noexcept
{
    ...
    state->type_RemoteTextConnection = py::register_python_type(module.get(), type_name_RemoteTextConnection, &type_spec_RemoteTextConnection, bases.get());
    if (!state->type_RemoteTextConnection)
    {
        return nullptr;
    }

    Py_INCREF(state->type_RemoteTextConnection);
