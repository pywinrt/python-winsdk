...
PyMODINIT_FUNC PyInit__winsdk_Windows_System_RemoteDesktop_Input(void) noexcept
{
    ...
    state->type_RemoteTextConnection = py::register_python_type(module.get(), type_name_RemoteTextConnection, &type_spec_RemoteTextConnection, object_bases.get(), nullptr);
