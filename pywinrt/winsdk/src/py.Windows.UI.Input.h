...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::CrossSlidingState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::DraggingState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::EdgeGestureKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::GazeInputAccessStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::GestureSettings> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::HoldingState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::InputActivationState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::PointerUpdateKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::RadialControllerMenuKnownIcon> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::RadialControllerSystemMenuItemKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::CrossSlideThresholds> = "T{f:selection_start:f:speed_bump_start:f:speed_bump_end:f:rearrange_start:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::ManipulationDelta> = "T{T{f:x:f:y:}:translation:f:scale:f:rotation:f:expansion:}";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Input::ManipulationVelocities> = "T{T{f:x:f:y:}:linear:f:angular:f:expansion:}";
