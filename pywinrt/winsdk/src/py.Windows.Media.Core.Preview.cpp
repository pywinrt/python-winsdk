...
namespace py::cpp::Windows::Media::Core::Preview
{
    ...
    static PyType_Slot type_slots_SoundLevelBroker_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_SoundLevelBroker_Meta },
        { }
    };

    static PyType_Spec type_spec_SoundLevelBroker_Meta =
    {
        "_winsdk_Windows_Media_Core_Preview.SoundLevelBroker_Meta",
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Media_Core_Preview(void) noexcept
{
    ...
    state->type_SoundLevelBroker = py::register_python_type(module.get(), type_name_SoundLevelBroker, &type_spec_SoundLevelBroker, nullptr, reinterpret_cast<PyTypeObject*>(type_SoundLevelBroker_Meta.get()));
