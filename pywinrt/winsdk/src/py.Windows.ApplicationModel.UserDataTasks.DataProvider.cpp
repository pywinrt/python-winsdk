...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_UserDataTasks_DataProvider(void) noexcept
{
    ...
    state->type_UserDataTaskDataProviderConnection = py::register_python_type(module.get(), type_name_UserDataTaskDataProviderConnection, &type_spec_UserDataTaskDataProviderConnection, bases.get(), nullptr);
    if (!state->type_UserDataTaskDataProviderConnection)
    {
        return nullptr;
    }

    state->type_UserDataTaskDataProviderTriggerDetails = py::register_python_type(module.get(), type_name_UserDataTaskDataProviderTriggerDetails, &type_spec_UserDataTaskDataProviderTriggerDetails, bases.get(), nullptr);
    if (!state->type_UserDataTaskDataProviderTriggerDetails)
    {
        return nullptr;
    }

    state->type_UserDataTaskListCompleteTaskRequest = py::register_python_type(module.get(), type_name_UserDataTaskListCompleteTaskRequest, &type_spec_UserDataTaskListCompleteTaskRequest, bases.get(), nullptr);
    if (!state->type_UserDataTaskListCompleteTaskRequest)
    {
        return nullptr;
    }

    state->type_UserDataTaskListCompleteTaskRequestEventArgs = py::register_python_type(module.get(), type_name_UserDataTaskListCompleteTaskRequestEventArgs, &type_spec_UserDataTaskListCompleteTaskRequestEventArgs, bases.get(), nullptr);
    if (!state->type_UserDataTaskListCompleteTaskRequestEventArgs)
    {
        return nullptr;
    }

    state->type_UserDataTaskListCreateOrUpdateTaskRequest = py::register_python_type(module.get(), type_name_UserDataTaskListCreateOrUpdateTaskRequest, &type_spec_UserDataTaskListCreateOrUpdateTaskRequest, bases.get(), nullptr);
    if (!state->type_UserDataTaskListCreateOrUpdateTaskRequest)
    {
        return nullptr;
    }

    state->type_UserDataTaskListCreateOrUpdateTaskRequestEventArgs = py::register_python_type(module.get(), type_name_UserDataTaskListCreateOrUpdateTaskRequestEventArgs, &type_spec_UserDataTaskListCreateOrUpdateTaskRequestEventArgs, bases.get(), nullptr);
    if (!state->type_UserDataTaskListCreateOrUpdateTaskRequestEventArgs)
    {
        return nullptr;
    }

    state->type_UserDataTaskListDeleteTaskRequest = py::register_python_type(module.get(), type_name_UserDataTaskListDeleteTaskRequest, &type_spec_UserDataTaskListDeleteTaskRequest, bases.get(), nullptr);
    if (!state->type_UserDataTaskListDeleteTaskRequest)
    {
        return nullptr;
    }

    state->type_UserDataTaskListDeleteTaskRequestEventArgs = py::register_python_type(module.get(), type_name_UserDataTaskListDeleteTaskRequestEventArgs, &type_spec_UserDataTaskListDeleteTaskRequestEventArgs, bases.get(), nullptr);
    if (!state->type_UserDataTaskListDeleteTaskRequestEventArgs)
    {
        return nullptr;
    }

    state->type_UserDataTaskListSkipOccurrenceRequest = py::register_python_type(module.get(), type_name_UserDataTaskListSkipOccurrenceRequest, &type_spec_UserDataTaskListSkipOccurrenceRequest, bases.get(), nullptr);
    if (!state->type_UserDataTaskListSkipOccurrenceRequest)
    {
        return nullptr;
    }

    state->type_UserDataTaskListSkipOccurrenceRequestEventArgs = py::register_python_type(module.get(), type_name_UserDataTaskListSkipOccurrenceRequestEventArgs, &type_spec_UserDataTaskListSkipOccurrenceRequestEventArgs, bases.get(), nullptr);
    if (!state->type_UserDataTaskListSkipOccurrenceRequestEventArgs)
    {
        return nullptr;
    }

    state->type_UserDataTaskListSyncManagerSyncRequest = py::register_python_type(module.get(), type_name_UserDataTaskListSyncManagerSyncRequest, &type_spec_UserDataTaskListSyncManagerSyncRequest, bases.get(), nullptr);
    if (!state->type_UserDataTaskListSyncManagerSyncRequest)
    {
        return nullptr;
    }

    state->type_UserDataTaskListSyncManagerSyncRequestEventArgs = py::register_python_type(module.get(), type_name_UserDataTaskListSyncManagerSyncRequestEventArgs, &type_spec_UserDataTaskListSyncManagerSyncRequestEventArgs, bases.get(), nullptr);
