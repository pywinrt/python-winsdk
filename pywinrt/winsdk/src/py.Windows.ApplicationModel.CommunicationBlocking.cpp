...
namespace py::cpp::Windows::ApplicationModel::CommunicationBlocking
{
    ...
    static PyType_Slot type_slots_CommunicationBlockingAccessManager_Meta[] = 
    {
        ...
        { Py_tp_getset, getset_CommunicationBlockingAccessManager_Meta },
        { }
    };
    ...
    {
        { Py_tp_base, &PyType_Type },
        { Py_tp_getset, getset_CommunicationBlockingAppManager_Meta },
        { }
    };
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_CommunicationBlocking(void) noexcept
{
    ...
    state->type_CommunicationBlockingAccessManager = py::register_python_type(module.get(), type_name_CommunicationBlockingAccessManager, &type_spec_CommunicationBlockingAccessManager, nullptr, reinterpret_cast<PyTypeObject*>(type_CommunicationBlockingAccessManager_Meta.get()));
    ...
    state->type_CommunicationBlockingAppManager = py::register_python_type(module.get(), type_name_CommunicationBlockingAppManager, &type_spec_CommunicationBlockingAppManager, nullptr, reinterpret_cast<PyTypeObject*>(type_CommunicationBlockingAppManager_Meta.get()));
