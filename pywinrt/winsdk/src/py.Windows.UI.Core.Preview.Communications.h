...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::Preview::Communications::PreviewMeetingInfoDisplayKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::Preview::Communications::PreviewSystemState> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::Preview::Communications::PreviewTeamEndMeetingKind> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::UI::Core::Preview::Communications::PreviewTeamViewCommand> = "i";
