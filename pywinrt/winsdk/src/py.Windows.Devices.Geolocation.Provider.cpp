...
PyMODINIT_FUNC PyInit__winsdk_Windows_Devices_Geolocation_Provider(void) noexcept
{
    ...
    state->type_GeolocationProvider = py::register_python_type(module.get(), type_name_GeolocationProvider, &type_spec_GeolocationProvider, object_bases.get(), nullptr);
