...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Store::Preview::DeliveryOptimizationDownloadMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Store::Preview::DeliveryOptimizationDownloadModeSource> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Store::Preview::StoreLogOptions> = "I";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Store::Preview::StorePreviewProductPurchaseStatus> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::ApplicationModel::Store::Preview::StoreSystemFeature> = "i";
