...
{
    auto type = py::get_python_type<winrt::Windows::Foundation::DateTime>();
    if (!type)
    {
        return nullptr;
    }
...
winrt::Windows::Foundation::DateTime py::converter<winrt::Windows::Foundation::DateTime>::convert_to(PyObject* obj)
{
    ...
    PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Foundation::DateTime");
    throw python_exception();
}
...
{
    auto type = py::get_python_type<winrt::Windows::Foundation::TimeSpan>();
    if (!type)
    {
        return nullptr;
    }
...
winrt::Windows::Foundation::TimeSpan py::converter<winrt::Windows::Foundation::TimeSpan>::convert_to(PyObject* obj)
{
    ...
    PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Foundation::TimeSpan");
    throw python_exception();
}
...
namespace py::cpp::Windows::Foundation
{
    ...
    // ----- DateTime struct --------------------
    constexpr const char* const type_name_DateTime = "DateTime";
    ...
    static PyGetSetDef _getset_DateTime[] = {
        { "universal_time", reinterpret_cast<getter>(DateTime_get_UniversalTime), reinterpret_cast<setter>(DateTime_set_UniversalTime), nullptr, nullptr },
        { }
    };
    ...
    static PyType_Spec type_spec_DateTime =
    {
        "_winsdk_Windows_Foundation.DateTime",
    ...
    // ----- TimeSpan struct --------------------
    constexpr const char* const type_name_TimeSpan = "TimeSpan";
    ...
    static PyGetSetDef _getset_TimeSpan[] = {
        { "duration", reinterpret_cast<getter>(TimeSpan_get_Duration), reinterpret_cast<setter>(TimeSpan_set_Duration), nullptr, nullptr },
        { }
    };
    ...
    static PyType_Spec type_spec_TimeSpan =
    {
        "_winsdk_Windows_Foundation.TimeSpan",
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Foundation(void) noexcept
{
    ...
    state->type_DateTime = py::register_python_type(module.get(), type_name_DateTime, &type_spec_DateTime, bases.get());
    if (!state->type_DateTime)
    {
        return nullptr;
    }

    Py_INCREF(state->type_DateTime);
    ...
    state->type_TimeSpan = py::register_python_type(module.get(), type_name_TimeSpan, &type_spec_TimeSpan, bases.get());
    if (!state->type_TimeSpan)
    {
        return nullptr;
    }

    Py_INCREF(state->type_TimeSpan);
...
PyTypeObject* py::winrt_type<winrt::Windows::Foundation::DateTime>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Foundation;
    ...
    auto python_type = state->type_DateTime;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Foundation::DateTime is not registered");
        return nullptr;
    }
...
PyTypeObject* py::winrt_type<winrt::Windows::Foundation::TimeSpan>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Foundation;
    ...
    auto python_type = state->type_TimeSpan;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Foundation::TimeSpan is not registered");
        return nullptr;
    }
