...
{
    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Pickers::Provider::AddFileResult> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Pickers::Provider::FileSelectionMode> = "i";

    template<>
    constexpr const char* buffer_format<winrt::Windows::Storage::Pickers::Provider::SetFileNameResult> = "i";
