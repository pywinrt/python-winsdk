...
namespace py::cpp::Windows::Storage::Streams
{
    ...
    {
        "_winsdk_Windows_Storage_Streams.Buffer",
    ...
    {
        "_winsdk_Windows_Storage_Streams.DataReader",
    ...
    static PyType_Slot _type_slots_DataReaderLoadOperation[] = 
    {
        ...
        { Py_am_await, reinterpret_cast<unaryfunc>(_await_DataReaderLoadOperation) },
        { },
    };

    static PyType_Spec type_spec_DataReaderLoadOperation =
    {
        "_winsdk_Windows_Storage_Streams.DataReaderLoadOperation",
    ...
    {
        "_winsdk_Windows_Storage_Streams.DataWriter",
    ...
    static PyType_Slot _type_slots_DataWriterStoreOperation[] = 
    {
        ...
        { Py_am_await, reinterpret_cast<unaryfunc>(_await_DataWriterStoreOperation) },
        { },
    };

    static PyType_Spec type_spec_DataWriterStoreOperation =
    {
        "_winsdk_Windows_Storage_Streams.DataWriterStoreOperation",
    ...
    {
        "_winsdk_Windows_Storage_Streams.FileInputStream",
    ...
    {
        "_winsdk_Windows_Storage_Streams.FileOutputStream",
    ...
    {
        "_winsdk_Windows_Storage_Streams.FileRandomAccessStream",
    ...
    {
        "_winsdk_Windows_Storage_Streams.InMemoryRandomAccessStream",
    ...
    {
        "_winsdk_Windows_Storage_Streams.InputStreamOverStream",
    ...
    {
        "_winsdk_Windows_Storage_Streams.OutputStreamOverStream",
    ...
    {
        "_winsdk_Windows_Storage_Streams.RandomAccessStream",
        0,
        0,
        Py_TPFLAGS_DEFAULT,
    ...
    {
        "_winsdk_Windows_Storage_Streams.RandomAccessStreamOverStream",
    ...
    {
        "_winsdk_Windows_Storage_Streams.RandomAccessStreamReference",
    ...
    {
        "_winsdk_Windows_Storage_Streams.IBuffer",
    ...
    {
        "_winsdk_Windows_Storage_Streams.IContentTypeProvider",
    ...
    {
        "_winsdk_Windows_Storage_Streams.IDataReader",
    ...
    {
        "_winsdk_Windows_Storage_Streams.IDataWriter",
    ...
    {
        "_winsdk_Windows_Storage_Streams.IInputStream",
    ...
    {
        "_winsdk_Windows_Storage_Streams.IInputStreamReference",
    ...
    {
        "_winsdk_Windows_Storage_Streams.IOutputStream",
    ...
    {
        "_winsdk_Windows_Storage_Streams.IPropertySetSerializer",
    ...
    {
        "_winsdk_Windows_Storage_Streams.IRandomAccessStream",
    ...
    {
        "_winsdk_Windows_Storage_Streams.IRandomAccessStreamReference",
    ...
    {
        "_winsdk_Windows_Storage_Streams.IRandomAccessStreamWithContentType",
    ...
    static PyModuleDef module_def
        = {PyModuleDef_HEAD_INIT,
           "_winsdk_Windows_Storage_Streams",
           module_doc,
           sizeof(module_state),
           module_methods,
           nullptr,
...
PyMODINIT_FUNC PyInit__winsdk_Windows_Storage_Streams(void) noexcept
{
    ...
    state->type_Buffer = py::register_python_type(module.get(), type_name_Buffer, &type_spec_Buffer, bases.get(), nullptr);
    ...
    state->type_DataReader = py::register_python_type(module.get(), type_name_DataReader, &type_spec_DataReader, bases.get(), nullptr);
    if (!state->type_DataReader)
    {
        return nullptr;
    }

    state->type_DataReaderLoadOperation = py::register_python_type(module.get(), type_name_DataReaderLoadOperation, &type_spec_DataReaderLoadOperation, bases.get(), nullptr);
    if (!state->type_DataReaderLoadOperation)
    {
        return nullptr;
    }

    state->type_DataWriter = py::register_python_type(module.get(), type_name_DataWriter, &type_spec_DataWriter, bases.get(), nullptr);
    if (!state->type_DataWriter)
    {
        return nullptr;
    }

    state->type_DataWriterStoreOperation = py::register_python_type(module.get(), type_name_DataWriterStoreOperation, &type_spec_DataWriterStoreOperation, bases.get(), nullptr);
    if (!state->type_DataWriterStoreOperation)
    {
        return nullptr;
    }

    state->type_FileInputStream = py::register_python_type(module.get(), type_name_FileInputStream, &type_spec_FileInputStream, bases.get(), nullptr);
    if (!state->type_FileInputStream)
    {
        return nullptr;
    }

    state->type_FileOutputStream = py::register_python_type(module.get(), type_name_FileOutputStream, &type_spec_FileOutputStream, bases.get(), nullptr);
    if (!state->type_FileOutputStream)
    {
        return nullptr;
    }

    state->type_FileRandomAccessStream = py::register_python_type(module.get(), type_name_FileRandomAccessStream, &type_spec_FileRandomAccessStream, bases.get(), nullptr);
    if (!state->type_FileRandomAccessStream)
    {
        return nullptr;
    }

    state->type_InMemoryRandomAccessStream = py::register_python_type(module.get(), type_name_InMemoryRandomAccessStream, &type_spec_InMemoryRandomAccessStream, bases.get(), nullptr);
    if (!state->type_InMemoryRandomAccessStream)
    {
        return nullptr;
    }

    state->type_InputStreamOverStream = py::register_python_type(module.get(), type_name_InputStreamOverStream, &type_spec_InputStreamOverStream, bases.get(), nullptr);
    if (!state->type_InputStreamOverStream)
    {
        return nullptr;
    }

    state->type_OutputStreamOverStream = py::register_python_type(module.get(), type_name_OutputStreamOverStream, &type_spec_OutputStreamOverStream, bases.get(), nullptr);
    if (!state->type_OutputStreamOverStream)
    {
        return nullptr;
    }

    state->type_RandomAccessStream = py::register_python_type(module.get(), type_name_RandomAccessStream, &type_spec_RandomAccessStream, nullptr, nullptr);
    if (!state->type_RandomAccessStream)
    {
        return nullptr;
    }

    state->type_RandomAccessStreamOverStream = py::register_python_type(module.get(), type_name_RandomAccessStreamOverStream, &type_spec_RandomAccessStreamOverStream, bases.get(), nullptr);
    if (!state->type_RandomAccessStreamOverStream)
    {
        return nullptr;
    }

    state->type_RandomAccessStreamReference = py::register_python_type(module.get(), type_name_RandomAccessStreamReference, &type_spec_RandomAccessStreamReference, bases.get(), nullptr);
    if (!state->type_RandomAccessStreamReference)
    {
        return nullptr;
    }

    state->type_IBuffer = py::register_python_type(module.get(), type_name_IBuffer, &type_spec_IBuffer, bases.get(), nullptr);
    ...
    state->type_IContentTypeProvider = py::register_python_type(module.get(), type_name_IContentTypeProvider, &type_spec_IContentTypeProvider, bases.get(), nullptr);
    if (!state->type_IContentTypeProvider)
    {
        return nullptr;
    }

    state->type_IDataReader = py::register_python_type(module.get(), type_name_IDataReader, &type_spec_IDataReader, bases.get(), nullptr);
    if (!state->type_IDataReader)
    {
        return nullptr;
    }

    state->type_IDataWriter = py::register_python_type(module.get(), type_name_IDataWriter, &type_spec_IDataWriter, bases.get(), nullptr);
    if (!state->type_IDataWriter)
    {
        return nullptr;
    }

    state->type_IInputStream = py::register_python_type(module.get(), type_name_IInputStream, &type_spec_IInputStream, bases.get(), nullptr);
    if (!state->type_IInputStream)
    {
        return nullptr;
    }

    state->type_IInputStreamReference = py::register_python_type(module.get(), type_name_IInputStreamReference, &type_spec_IInputStreamReference, bases.get(), nullptr);
    if (!state->type_IInputStreamReference)
    {
        return nullptr;
    }

    state->type_IOutputStream = py::register_python_type(module.get(), type_name_IOutputStream, &type_spec_IOutputStream, bases.get(), nullptr);
    if (!state->type_IOutputStream)
    {
        return nullptr;
    }

    state->type_IPropertySetSerializer = py::register_python_type(module.get(), type_name_IPropertySetSerializer, &type_spec_IPropertySetSerializer, bases.get(), nullptr);
    if (!state->type_IPropertySetSerializer)
    {
        return nullptr;
    }

    state->type_IRandomAccessStream = py::register_python_type(module.get(), type_name_IRandomAccessStream, &type_spec_IRandomAccessStream, bases.get(), nullptr);
    if (!state->type_IRandomAccessStream)
    {
        return nullptr;
    }

    state->type_IRandomAccessStreamReference = py::register_python_type(module.get(), type_name_IRandomAccessStreamReference, &type_spec_IRandomAccessStreamReference, bases.get(), nullptr);
    if (!state->type_IRandomAccessStreamReference)
    {
        return nullptr;
    }

    state->type_IRandomAccessStreamWithContentType = py::register_python_type(module.get(), type_name_IRandomAccessStreamWithContentType, &type_spec_IRandomAccessStreamWithContentType, bases.get(), nullptr);
