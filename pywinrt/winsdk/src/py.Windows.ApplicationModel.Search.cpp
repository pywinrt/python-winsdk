...
namespace py::cpp::Windows::ApplicationModel::Search
{
    ...
    constexpr const char* const type_name_LocalContentSuggestionSettings = "LocalContentSuggestionSettings";
    ...
    constexpr const char* const type_name_SearchQueryLinguisticDetails = "SearchQueryLinguisticDetails";
    ...
    constexpr const char* const type_name_SearchSuggestionCollection = "SearchSuggestionCollection";
    ...
    constexpr const char* const type_name_SearchSuggestionsRequest = "SearchSuggestionsRequest";
    ...
    constexpr const char* const type_name_SearchSuggestionsRequestDeferral = "SearchSuggestionsRequestDeferral";
...
PyMODINIT_FUNC PyInit__winsdk_Windows_ApplicationModel_Search(void) noexcept
{
    ...
    state->type_LocalContentSuggestionSettings = py::register_python_type(module.get(), type_name_LocalContentSuggestionSettings, &type_spec_LocalContentSuggestionSettings, bases.get());
    ...
    Py_INCREF(state->type_SearchQueryLinguisticDetails);

    state->type_SearchSuggestionCollection = py::register_python_type(module.get(), type_name_SearchSuggestionCollection, &type_spec_SearchSuggestionCollection, bases.get());
    if (!state->type_SearchSuggestionCollection)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SearchSuggestionCollection);

    state->type_SearchSuggestionsRequest = py::register_python_type(module.get(), type_name_SearchSuggestionsRequest, &type_spec_SearchSuggestionsRequest, bases.get());
    if (!state->type_SearchSuggestionsRequest)
    {
        return nullptr;
    }

    Py_INCREF(state->type_SearchSuggestionsRequest);

    state->type_SearchSuggestionsRequestDeferral = py::register_python_type(module.get(), type_name_SearchSuggestionsRequestDeferral, &type_spec_SearchSuggestionsRequestDeferral, bases.get());
